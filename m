...
Received: from lb1-smtp-cloud3.xs4all.net ([194.109.24.22]:42543 "EHLO
        lb1-smtp-cloud3.xs4all.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1754712AbdC1I0X (ORCPT
...
Subject: [PATCHv6 07/14] atmel-isi: remove dependency of the soc-camera framework
Date: Tue, 28 Mar 2017 10:23:40 +0200
Message-Id: <20170328082347.11159-8-hverkuil@xs4all.nl>
...
---
 ...
 drivers/media/platform/soc_camera/atmel-isi.c | 1193 +++++++++++++++----------
 2 files changed, 698 insertions(+), 498 deletions(-)
...
index 46de657c3e6d..e4867f84514c 100644
...
@@ -65,9 +69,34 @@ struct frame_buffer {
...
@@ -102,107 +144,33 @@ static u32 isi_readl(struct atmel_isi *isi, u32 reg)
...
@@ -214,6 +182,7 @@ static irqreturn_t atmel_isi_handle_streaming(struct atmel_isi *isi)
...
@@ -247,7 +216,7 @@ static irqreturn_t isi_interrupt(int irq, void *dev_id)
...
@@ -267,7 +236,7 @@ static irqreturn_t isi_interrupt(int irq, void *dev_id)
...
@@ -305,26 +274,21 @@ static int queue_setup(struct vb2_queue *vq,
...
+	dev_dbg(isi->dev, "%s, count=%d, size=%ld\n", __func__,
 	...
 	return 0;
@@ -344,17 +308,15 @@ static int buffer_init(struct vb2_buffer *vb)
...
@@ -363,7 +325,7 @@ static int buffer_prepare(struct vb2_buffer *vb)
...
@@ -387,9 +349,7 @@ static int buffer_prepare(struct vb2_buffer *vb)
...
@@ -409,7 +369,7 @@ static void start_dma(struct atmel_isi *isi, struct frame_buffer *buffer)
...
@@ -443,13 +403,11 @@ static void start_dma(struct atmel_isi *isi, struct frame_buffer *buffer)
...
+	spin_lock_irqsave(&isi->irqlock, flags);
 	...
 	if (isi->active == NULL) {
@@ -457,60 +415,83 @@ static void buffer_queue(struct vb2_buffer *vb)
...
@@ -520,7 +501,7 @@ static void stop_streaming(struct vb2_queue *vq)
 			msleep(1);
...
@@ -531,9 +512,9 @@ static void stop_streaming(struct vb2_queue *vq)
...
@@ -548,380 +529,257 @@ static const struct vb2_ops isi_video_qops = {
...
@@ -930,50 +788,19 @@ static int isi_camera_set_bus_param(struct soc_camera_device *icd)
...
@@ -1021,13 +848,335 @@ static int atmel_isi_parse_dt(struct atmel_isi *isi,
 	return 0;
 }
...
-	struct soc_camera_host *soc_host;
 	...
 	if (!isi) {
@@ -1044,20 +1193,65 @@ static int atmel_isi_probe(struct platform_device *pdev)
 		return ret;
...
+	for (i = 0; i < VIDEO_MAX_FRAME; i++) {
 		...
 		isi->dma_desc[i].fbd_phys = isi->fb_descriptors_phys +
 					i * sizeof(struct fbd);
@@ -1089,41 +1283,49 @@ static int atmel_isi_probe(struct platform_device *pdev)
 	}
 	isi->irq = irq;
...
@@ -1131,9 +1333,7 @@ static int atmel_isi_runtime_suspend(struct device *dev)
 }
...
@@ -1151,15 +1351,16 @@ static const struct of_device_id atmel_isi_of_match[] = {
