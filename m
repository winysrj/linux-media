...
Received: from mga01.intel.com ([192.55.52.88]:59531 "EHLO mga01.intel.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1751966AbbFSBnM (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Thu, 18 Jun 2015 21:43:12 -0400
Date: Fri, 19 Jun 2015 09:42:56 +0800
From: kbuild test robot <fengguang.wu@intel.com>
To: Josh Wu <josh.wu@atmel.com>
Cc: kbuild-all@01.org, Mauro Carvalho Chehab <m.chehab@samsung.com>,
	linux-media@vger.kernel.org,
	Guennadi Liakhovetski <g.liakhovetski@gmx.de>
Subject: [linuxtv-media:devel 1293/1307]
 drivers/media/platform/soc_camera/atmel-isi.c:1089:12: warning:
 'atmel_isi_runtime_suspend' defined but not used
Message-ID: <201506190954.SCNrlatH%fengguang.wu@intel.com>
MIME-Version: 1.0
...
head:   52ba832bf1f82ec40a5ab33b6e0e041ede3706d7
commit: 00dad965bbc358ec49d0d0c860b0402fdb7a3dc6 [1293/1307] [media] atmel-isi: add runtime pm support
config: microblaze-allyesconfig (attached as .config)
reproduce:
  wget https://git.kernel.org/cgit/linux/kernel/git/wfg/lkp-tests.git/plain/sbin/make.cross -O ~/bin/make.cross
  chmod +x ~/bin/make.cross
  git checkout 00dad965bbc358ec49d0d0c860b0402fdb7a3dc6
  # save the attached .config to linux build tree
  make.cross ARCH=microblaze 

All warnings (new ones prefixed by >>):

>> drivers/media/platform/soc_camera/atmel-isi.c:1089:12: warning: 'atmel_isi_runtime_suspend' defined but not used [-Wunused-function]
    static int atmel_isi_runtime_suspend(struct device *dev)
               ^
>> drivers/media/platform/soc_camera/atmel-isi.c:1099:12: warning: 'atmel_isi_runtime_resume' defined but not used [-Wunused-function]
    static int atmel_isi_runtime_resume(struct device *dev)
               ^

vim +/atmel_isi_runtime_suspend +1089 drivers/media/platform/soc_camera/atmel-isi.c

  1083				isi->p_fb_descriptors,
  1084				isi->fb_descriptors_phys);
  1085	
  1086		return ret;
  1087	}
  1088	
> 1089	static int atmel_isi_runtime_suspend(struct device *dev)
  1090	{
  1091		struct soc_camera_host *soc_host = to_soc_camera_host(dev);
  1092		struct atmel_isi *isi = container_of(soc_host,
  1093						struct atmel_isi, soc_host);
  1094	
  1095		clk_disable_unprepare(isi->pclk);
  1096	
  1097		return 0;
  1098	}
> 1099	static int atmel_isi_runtime_resume(struct device *dev)
  1100	{
  1101		struct soc_camera_host *soc_host = to_soc_camera_host(dev);
  1102		struct atmel_isi *isi = container_of(soc_host,
...
# Linux/microblaze 4.1.0-rc3 Kernel Configuration
#
CONFIG_MICROBLAZE=y
CONFIG_SWAP=y
