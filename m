...
Received: from smtp.codeaurora.org ([198.145.29.96]:46546 "EHLO
        ...
        with ESMTP id S1729736AbeISDeY (ORCPT
...
Subject: [PATCH v8 1/5] venus: firmware: add routine to reset ARM9
Date: Wed, 19 Sep 2018 03:29:09 +0530
Message-Id: <1537307954-9729-2-git-send-email-vgarodia@codeaurora.org>
