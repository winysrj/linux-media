...
Received: from lb1-smtp-cloud6.xs4all.net ([194.109.24.24]:57030 "EHLO
	...
	by vger.kernel.org with ESMTP id S1753333AbcGVK2c (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 22 Jul 2016 06:28:32 -0400
Subject: Re: [PATCH v3 3/5] media: Refactor copying IOCTL arguments from and
 to user space
To: Sakari Ailus <sakari.ailus@linux.intel.com>,
	linux-media@vger.kernel.org
References: <1469099686-10938-1-git-send-email-sakari.ailus@linux.intel.com>
 <1469099686-10938-4-git-send-email-sakari.ailus@linux.intel.com>
Cc: laurent.pinchart@ideasonboard.com, mchehab@osg.samsung.com
From: Hans Verkuil <hverkuil@xs4all.nl>
Message-ID: <573bca2d-1408-839a-7294-6e3692a1c94b@xs4all.nl>
Date: Fri, 22 Jul 2016 12:28:27 +0200
MIME-Version: 1.0
In-Reply-To: <1469099686-10938-4-git-send-email-sakari.ailus@linux.intel.com>
