...
Received: from mail-wm0-f44.google.com ([74.125.82.44]:37324 "EHLO
        mail-wm0-f44.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S932134AbdBQKrG (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Fri, 17 Feb 2017 05:47:06 -0500
Received: by mail-wm0-f44.google.com with SMTP id v77so7249196wmv.0
        for <linux-media@vger.kernel.org>; Fri, 17 Feb 2017 02:47:05 -0800 (PST)
...
Subject: [PATCH v3 2/3] stih-cec: add HPD notifier support
Date: Fri, 17 Feb 2017 11:46:51 +0100
Message-Id: <1487328412-8305-3-git-send-email-benjamin.gaignard@linaro.org>
...
+		return -ENOMEM;
+
+	np = of_parse_phandle(pdev->dev.of_node, "hdmi-handle", 0);
+
+	if (!np) {
