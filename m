...
Received: from lb3-smtp-cloud9.xs4all.net ([194.109.24.30]:39618 "EHLO
        ...
        by vger.kernel.org with ESMTP id S1753577AbeGEQDk (ORCPT
...
Subject: [PATCHv16 01/34] Documentation: v4l: document request API
Date: Thu,  5 Jul 2018 18:03:04 +0200
Message-Id: <20180705160337.54379-2-hverkuil@xs4all.nl>
...
+    Or an attempt is made to queue a CAPTURE buffer to a request for a
