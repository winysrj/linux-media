...
Received: from lb3-smtp-cloud9.xs4all.net ([194.109.24.30]:33458 "EHLO
        ...
        by vger.kernel.org with ESMTP id S1751933AbeFDLrC (ORCPT
...
Subject: [PATCHv15 09/35] v4l2-ctrls: v4l2_ctrl_add_handler: add from_other_dev
Date: Mon,  4 Jun 2018 13:46:22 +0200
Message-Id: <20180604114648.26159-10-hverkuil@xs4all.nl>
