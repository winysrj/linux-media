...
Received: from mailout4.w1.samsung.com ([210.118.77.14]:39708 "EHLO
        ...
        with ESMTP id S1751635AbdBNHwU (ORCPT
...
Subject: [PATCH 05/15] media: s5p-mfc: Simplify alloc/release private buffer
 functions
Date: Tue, 14 Feb 2017 08:51:58 +0100
Message-id: <1487058728-16501-6-git-send-email-m.szyprowski@samsung.com>
