...
Received: from arroyo.ext.ti.com ([192.94.94.40]:53520 "EHLO arroyo.ext.ti.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1749667AbZGOEQu (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Wed, 15 Jul 2009 00:16:50 -0400
...
Cc: <mchehab@infradead.org>, <hverkuil@xs4all.nl>,
	...
	<linux@arm.linux.org.uk>, "'Manjunath Hadli'" <mrh@ti.com>,
...
Date: Wed, 15 Jul 2009 09:45:05 +0530
Message-ID: <002e01ca0502$d5353d30$7f9fb790$@com>
MIME-Version: 1.0
...
specific clock setup function that can be accessed by the driver to
configure the clock and CPLD.
> 
...
>  };
>  
>  static struct davinci_i2c_platform_data i2c_pdata = { @@ -254,10 +304,84
...
>  }
>  
>  static void __init davinci_map_io(void) @@ -276,6 +400,7 @@ static __init
void evm_init(void)
>  
...
>  }
>  
>  static __init void davinci_dm646x_evm_irq_init(void) diff --git
a/arch/arm/mach-davinci/dm646x.c b/arch/arm/mach-davinci/dm646x.c index
df82ee5..c5e2788 100644
...
/*----------------------------------------------------------------------*/
>  
>  static struct map_desc dm646x_io_desc[] = { @@ -770,6 +810,28 @@ void
__init dm646x_init_mcasp1(struct snd_platform_data *pdata)
...
> +++ b/arch/arm/mach-davinci/include/mach/dm646x.h
> @@ -26,4 +26,28 @@ void __init dm646x_init(void);  void __init
dm646x_init_mcasp0(struct snd_platform_data *pdata);  void __init
dm646x_init_mcasp1(struct snd_platform_data *pdata);
>  
