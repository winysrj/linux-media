...
Received: from mail0.scram.de ([78.47.204.202]:41629 "EHLO mail.scram.de"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1763001AbZANPj0 (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Wed, 14 Jan 2009 10:39:26 -0500
Message-ID: <496E0731.20900@scram.de>
Date: Wed, 14 Jan 2009 16:39:29 +0100
From: Jochen Friedrich <jochen@scram.de>
MIME-Version: 1.0
To: linux-media@vger.kernel.org
CC: Antti Palosaari <crope@iki.fi>
Subject: [PATCH] Add Freescale MC44S803 tuner driver
...
index bee5690..6bcbc40 100644
--- a/drivers/media/common/tuners/Kconfig
+++ b/drivers/media/common/tuners/Kconfig
@@ -32,6 +32,7 @@ config MEDIA_TUNER
 	select MEDIA_TUNER_AT76C651 if !MEDIA_TUNER_CUSTOMIZE
 	select MEDIA_TUNER_SQC6100 if !MEDIA_TUNER_CUSTOMIZE
 	select MEDIA_TUNER_TDA80XX if !MEDIA_TUNER_CUSTOMIZE
+	select MEDIA_TUNER_MC44S803 if !MEDIA_TUNER_CUSTOMIZE
 
 menuconfig MEDIA_TUNER_CUSTOMIZE
 	bool "Customize analog and hybrid tuner modules to build"
@@ -188,4 +189,11 @@ config MEDIA_TUNER_TDA80XX
 	help
...
index 5450ff1..f3542b0 100644
--- a/drivers/media/common/tuners/Makefile
+++ b/drivers/media/common/tuners/Makefile
@@ -25,6 +25,7 @@ obj-$(CONFIG_MEDIA_TUNER_MXL5007T) += mxl5007t.o
 obj-$(CONFIG_MEDIA_TUNER_AT76C651) += at76c651.o
 obj-$(CONFIG_MEDIA_TUNER_SQC6100) += sqc6100.o
 obj-$(CONFIG_MEDIA_TUNER_TDA80XX) += tda80xx.o
