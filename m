...
Received: from mail.gmx.net ([213.165.64.20]:46014 "HELO mail.gmx.net"
	...
	id S1757652AbZBEIES (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Thu, 5 Feb 2009 03:04:18 -0500
Date: Thu, 5 Feb 2009 09:04:20 +0100 (CET)
From: Guennadi Liakhovetski <g.liakhovetski@gmx.de>
To: Kuninori Morimoto <morimoto.kuninori@renesas.com>
cc: Magnus <magnus.damm@gmail.com>,
	Linux Media <linux-media@vger.kernel.org>
Subject: Re: [PATCH v2 2/2] sh_mobile_ceu: Add field signal operation
In-Reply-To: <ubpthwd06.wl%morimoto.kuninori@renesas.com>
Message-ID: <Pine.LNX.4.64.0902050846080.5553@axis700.grange>
