...
Received: from mx3.redhat.com (mx3.redhat.com [172.16.48.32])
	by int-mx1.corp.redhat.com (8.13.1/8.13.1) with ESMTP id n0U0s0ej032227
	for <video4linux-list@redhat.com>; Thu, 29 Jan 2009 19:54:00 -0500
Received: from bear.ext.ti.com (bear.ext.ti.com [192.94.94.41])
	by mx3.redhat.com (8.13.8/8.13.8) with ESMTP id n0U0ricF014678
	for <video4linux-list@redhat.com>; Thu, 29 Jan 2009 19:53:44 -0500
From: Dominic Curran <dcurran@ti.com>
To: "linux-omap" <linux-omap@vger.kernel.org>, video4linux-list@redhat.com
Date: Thu, 29 Jan 2009 18:53:38 -0600
MIME-Version: 1.0
Content-Type: text/plain;
  charset="us-ascii"
Content-Transfer-Encoding: 7bit
Content-Disposition: inline
Message-Id: <200901291853.38538.dcurran@ti.com>
...
+					" the legal range.\n", exp_time);
+			dev_err(&client->dev, "Exposure time must be between"
+					" %d us and %d us\n",
...
+
+	if (err) {
+		dev_err(&client->dev, "Error setting exposure time: %d", err);
+	} else {
...
+				>> 1);
+		dev_dbg(&client->dev, "set_gain: lineargain=%d reg_gain=%d\n",
+				lineargain, reg_gain);
+
...
+
+	if (err) {
+		dev_err(&client->dev, "Error setting analog gain: %d", err);
+	} else {
