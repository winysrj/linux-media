...
Received: from smtp5-g21.free.fr ([212.27.42.5]:57566 "EHLO smtp5-g21.free.fr"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S965200AbdIYQHx (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Mon, 25 Sep 2017 12:07:53 -0400
Subject: [PATCH v5 2/2] media: rc: Add driver for tango HW IR decoder
...
Message-ID: <893874ee-a6e0-e4be-5b4f-a49e60197e92@free.fr>
Date: Mon, 25 Sep 2017 18:07:14 +0200
MIME-Version: 1.0
...
* Restore inits in same order as original driver
	(except for devm_rc_allocate_device before clk_prepare_enable)
* Delete two writes clearing interrupts in probe (cleared is reset value)
---
 drivers/media/rc/Kconfig    |  10 ++
 drivers/media/rc/Makefile   |   1 +
 drivers/media/rc/tango-ir.c | 273 ++++++++++++++++++++++++++++++++++++++++++++
...
index 000000000000..34f38a9602f6
--- /dev/null
