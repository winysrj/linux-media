...
Received: from arroyo.ext.ti.com ([192.94.94.40]:43384 "EHLO arroyo.ext.ti.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S934400Ab0HMN4Z (ORCPT <rfc822;linux-media@vger.kernel.org>);
...
Subject: [PATCH/RFC 4/6] drivers:staging:ti-st: Sources for FM V4L2 interfaces
Date: Fri, 13 Aug 2010 10:14:42 -0400
Message-Id: <1281708884-15462-5-git-send-email-raja_mani@ti.com>
In-Reply-To: <1281708884-15462-4-git-send-email-raja_mani@ti.com>
...
+	tuner->rangelow = (bottom_frequency * 10) / 625;
+	tuner->rangehigh = (top_frequency * 10) / 625;
...
+	fmdev = video_drvdata(file);
+
+	freq->frequency = (unsigned int)((freq->frequency * 625)/10);
