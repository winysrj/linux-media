...
Received: from smtp-vbr8.xs4all.nl ([194.109.24.28]:3745 "EHLO
	smtp-vbr8.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753250AbaCSHth (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 19 Mar 2014 03:49:37 -0400
Message-ID: <53294BF8.6090708@xs4all.nl>
Date: Wed, 19 Mar 2014 08:49:12 +0100
...
Subject: Re: [PATCH v6 3/4] [media] exynos-scaler: Add m2m functionality for
 the SCALER driver
References: <1395213196-25972-1-git-send-email-shaik.ameer@samsung.com> <1395213196-25972-4-git-send-email-shaik.ameer@samsung.com>
In-Reply-To: <1395213196-25972-4-git-send-email-shaik.ameer@samsung.com>
