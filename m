...
Received: from smtp-vbr8.xs4all.nl ([194.109.24.28]:1370 "EHLO
	smtp-vbr8.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1754273AbZF0MIX (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sat, 27 Jun 2009 08:08:23 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: m-karicheri2@ti.com
Subject: Re: [PATCH 1/3 - v0] V4L: vpfe capture driver -  adding support for camera capture
Date: Sat, 27 Jun 2009 14:08:20 +0200
Cc: davinci-linux-open-source@linux.davincidsp.com,
	linux-media@vger.kernel.org
References: <1246053885-8302-1-git-send-email-m-karicheri2@ti.com>
In-Reply-To: <1246053885-8302-1-git-send-email-m-karicheri2@ti.com>
MIME-Version: 1.0
Content-Type: text/plain;
  charset="iso-8859-15"
Content-Transfer-Encoding: 7bit
Content-Disposition: inline
Message-Id: <200906271408.20822.hverkuil@xs4all.nl>
