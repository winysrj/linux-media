...
Received: from lb2-smtp-cloud8.xs4all.net ([194.109.24.25]:37424 "EHLO
        lb2-smtp-cloud8.xs4all.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1753635AbdHWKvb (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Wed, 23 Aug 2017 06:51:31 -0400
To: Linux Media Mailing List <linux-media@vger.kernel.org>
From: Hans Verkuil <hverkuil@xs4all.nl>
Subject: [GIT PULL FOR v4.14] More constify, some fixes
Message-ID: <35bb0538-a8e7-53be-defb-83cd26b092ea@xs4all.nl>
Date: Wed, 23 Aug 2017 12:51:26 +0200
MIME-Version: 1.0
...
for you to fetch changes up to af7a17a9428fc520e6c9e4df5d7d7074236a4da1:

  em28xx: calculate left volume level correctly (2017-08-23 12:05:30 +0200)
