...
Received: from perceval.ideasonboard.com ([213.167.242.64]:48368 "EHLO
        ...
        with ESMTP id S1755521AbeEAMtd (ORCPT
        <rfc822;linux-media@vger.kernel.org>); Tue, 1 May 2018 08:49:33 -0400
From: Kieran Bingham <kieran.bingham+renesas@ideasonboard.com>
To: Laurent Pinchart <laurent.pinchart@ideasonboard.com>,
        linux-renesas-soc@vger.kernel.org, linux-media@vger.kernel.org
Cc: mchehab@kernel.org,
        Kieran Bingham <kieran.bingham+renesas@ideasonboard.com>
Subject: [PATCH v8 7/8] media: vsp1: Adapt entities to configure into a body
Date: Tue,  1 May 2018 13:49:19 +0100
Message-Id: <1c8222bd76f3d5cf3e67b8d9026e06e07620f156.1525178613.git-series.kieran.bingham+renesas@ideasonboard.com>
...
index 0a978980d447..f197b3705e64 100644
...
+				 struct vsp1_dl_body *dlb)
 {
 	...
 	struct v4l2_mbus_framefmt *format;
@@ -187,10 +187,11 @@ static void clu_configure_stream(struct vsp1_entity *entity,
...
@@ -200,18 +201,18 @@ static void clu_configure_frame(struct vsp1_entity *entity,
...
index e07ed3a2acda..ce6cb210adcd 100644
...
index 99db8a418f9d..ed612f84e5f1 100644
...
index 73f6611ec279..7b29ef3532fc 100644
...
@@ -66,31 +66,32 @@ void vsp1_entity_route_setup(struct vsp1_entity *entity,
 	 */
...
index c29676671b1a..f329c69731d1 100644
...
@@ -149,19 +150,20 @@ int vsp1_entity_init_cfg(struct v4l2_subdev *subdev,
...
index deb86cc235ef..a948670121a4 100644
...
@@ -163,28 +164,29 @@ static void rpf_configure_stream(struct vsp1_entity *entity,
 		rpf->mult_alpha = mult;
 	}
...
@@ -192,7 +194,6 @@ static void rpf_configure_partition(struct vsp1_entity *entity,
 	const struct vsp1_format_info *fmtinfo = rpf->fmtinfo;
...
-
 	 ...
 	 *
@@ -218,10 +219,10 @@ static void rpf_configure_partition(struct vsp1_entity *entity,
...
@@ -246,9 +247,9 @@ static void rpf_configure_partition(struct vsp1_entity *entity,
 	    fmtinfo->swap_uv)
...
index c81ce9e5bff3..35f99844c19c 100644
...
@@ -286,25 +286,25 @@ static void uds_configure_stream(struct vsp1_entity *entity,
 	else
 		multitap = true;
...
index b96717f58a72..bdd9e30ed417 100644
--- a/drivers/media/platform/vsp1/vsp1_video.c
+++ b/drivers/media/platform/vsp1/vsp1_video.c
@@ -379,24 +379,28 @@ static void vsp1_video_pipeline_run_partition(struct vsp1_pipeline *pipe,
...
index da287c27b324..80b4f8ba141e 100644
...
+				struct vsp1_dl_body *dlb)
 {
 	struct vsp1_rwpf *wpf = to_rwpf(&entity->subdev);
 	unsigned long flags;
@@ -346,12 +347,12 @@ static void wpf_configure_frame(struct vsp1_entity *entity,
...
+				    struct vsp1_dl_body *dlb)
 {
 	struct vsp1_rwpf *wpf = to_rwpf(&entity->subdev);
 	struct vsp1_device *vsp1 = wpf->entity.vsp1;
@@ -378,10 +379,10 @@ static void wpf_configure_partition(struct vsp1_entity *entity,
...
@@ -473,9 +474,9 @@ static void wpf_configure_partition(struct vsp1_entity *entity,
 	    fmtinfo->swap_uv)
 		swap(mem.addr[1], mem.addr[2]);
