...
Received: from mail.kapsi.fi ([217.30.184.167]:41261 "EHLO mail.kapsi.fi"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1755776Ab2IRWnV (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Tue, 18 Sep 2012 18:43:21 -0400
Message-ID: <5058F8F2.90106@iki.fi>
Date: Wed, 19 Sep 2012 01:42:58 +0300
From: Antti Palosaari <crope@iki.fi>
MIME-Version: 1.0
To: oliver@schinagl.nl
CC: linux-media@vger.kernel.org
Subject: Re: [PATCH] Support for Asus MyCinema U3100Mini Plus (attempt 2)
References: <1348006936-6334-1-git-send-email-oliver+list@schinagl.nl>
In-Reply-To: <1348006936-6334-1-git-send-email-oliver+list@schinagl.nl>
...
> @@ -655,6 +691,8 @@ static int af9035_tuner_callback(struct dvb_usb_device *d, int cmd, int arg)
...
>   		break;
>   	}
> @@ -750,6 +788,11 @@ static struct tda18218_config af9035_tda18218_config = {
>   	.i2c_wr_max = 21,
>   };
>
...
> @@ -851,6 +894,11 @@ static int af9035_tuner_attach(struct dvb_usb_adapter *adap)
...
>   		fe = NULL;
>   	}
> @@ -1075,6 +1123,8 @@ static const struct usb_device_id af9035_id_table[] = {
