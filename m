...
Received: from metis.ext.4.pengutronix.de ([92.198.50.35]:34435 "EHLO
        ...
        by vger.kernel.org with ESMTP id S1751887AbdEQPPR (ORCPT
...
Subject: [PATCH v5 2/3] platform: add video-multiplexer subdevice driver
Date: Wed, 17 May 2017 17:15:06 +0200
Message-Id: <1495034107-21407-2-git-send-email-p.zabel@pengutronix.de>
