...
Received: from mx07-00178001.pphosted.com ([62.209.51.94]:51738 "EHLO
	mx07-00178001.pphosted.com" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1751649AbaHDIt2 convert rfc822-to-8bit
	(ORCPT <rfc822;linux-media@vger.kernel.org>);
	Mon, 4 Aug 2014 04:49:28 -0400
From: Jean-Marc VOLLE <jean-marc.volle@st.com>
To: Hans Verkuil <hverkuil@xs4all.nl>,
	"linux-media@vger.kernel.org" <linux-media@vger.kernel.org>
Cc: Divneil Rai WADHAWAN <divneil.wadhawan@st.com>
Date: Mon, 4 Aug 2014 10:49:22 +0200
Subject: RE: [PATCH] ITU BT2020 support in v4l2_colorspace
Message-ID: <1BBEE2BA50AFBB41BDCE56494A11093A011116AA6852@SAFEX1MAIL2.st.com>
References: <1406905371-17609-1-git-send-email-jean-marc.volle@st.com>
 <53DBADBD.7060407@xs4all.nl>
 <1BBEE2BA50AFBB41BDCE56494A11093A0111169DDEA3@SAFEX1MAIL2.st.com>
 <53DBC215.3070006@xs4all.nl>
In-Reply-To: <53DBC215.3070006@xs4all.nl>
...
Do you mean there is some ongoing discussions on making independent color space, pixel format range and bit depth?
I have seen this issue for HDMI (1.4) where the standard allows independant coding for color space, range (reduce/full) and bit depth.
