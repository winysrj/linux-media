...
Received: from lb3-smtp-cloud3.xs4all.net ([194.109.24.30]:32963 "EHLO
	...
	by vger.kernel.org with ESMTP id S1753729AbaLDJz6 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 4 Dec 2014 04:55:58 -0500
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: g.liakhovetski@gmx.de, laurent.pinchart@ideasonboard.com,
	prabhakar.csengg@gmail.com, Hans Verkuil <hans.verkuil@cisco.com>
Subject: [RFC PATCH 4/8] v4l2-subdev: replace v4l2_subdev_fh by v4l2_subdev_pad_config
Date: Thu,  4 Dec 2014 10:54:55 +0100
Message-Id: <1417686899-30149-5-git-send-email-hverkuil@xs4all.nl>
...
index e43dd2e..342ddb9 100644
--- a/drivers/media/i2c/adv7604.c
+++ b/drivers/media/i2c/adv7604.c
@@ -1807,7 +1807,7 @@ static int adv7604_s_routing(struct v4l2_subdev *sd,
 }
...
@@ -1884,7 +1884,8 @@ static void adv7604_setup_format(struct adv7604_state *state)
...
+			      struct v4l2_subdev_pad_config *cfg,
 ...
 {
 	struct adv7604_state *state = to_state(sd);
@@ -1897,7 +1898,7 @@ static int adv7604_get_format(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh,
 	if (format->which == V4L2_SUBDEV_FORMAT_TRY) {
 		struct v4l2_mbus_framefmt *fmt;
...
@@ -1906,7 +1907,8 @@ static int adv7604_get_format(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh,
 	return 0;
 }
...
+			      struct v4l2_subdev_pad_config *cfg,
 ...
 {
 	struct adv7604_state *state = to_state(sd);
@@ -1925,7 +1927,7 @@ static int adv7604_set_format(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh,
 	if (format->which == V4L2_SUBDEV_FORMAT_TRY) {
 		struct v4l2_mbus_framefmt *fmt;
...
index 2820f7c..e1b2b94 100644
--- a/drivers/media/i2c/m5mols/m5mols_core.c
+++ b/drivers/media/i2c/m5mols/m5mols_core.c
@@ -536,17 +536,17 @@ static int __find_resolution(struct v4l2_subdev *sd,
 }
...
@@ -555,7 +555,7 @@ static int m5mols_get_fmt(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh,
...
@@ -565,7 +565,7 @@ static int m5mols_get_fmt(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh,
 	return ret;
 }
...
+static int m5mols_set_fmt(struct v4l2_subdev *sd, struct v4l2_subdev_pad_config *cfg,
 ...
 {
 	struct m5mols_info *info = to_m5mols(sd);
@@ -579,7 +579,7 @@ static int m5mols_set_fmt(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh,
 	if (ret < 0)
 		return ret;
...
@@ -645,7 +645,7 @@ static int m5mols_set_frame_desc(struct v4l2_subdev *sd, unsigned int pad,
...
@@ -900,7 +900,7 @@ static const struct v4l2_subdev_core_ops m5mols_core_ops = {
  */
...
index 60a74d8..a3fc544 100644
--- a/drivers/media/i2c/s5k5baf.c
+++ b/drivers/media/i2c/s5k5baf.c
@@ -1181,7 +1181,7 @@ static int s5k5baf_s_frame_interval(struct v4l2_subdev *sd,
...
@@ -1200,7 +1200,7 @@ static int s5k5baf_enum_frame_interval(struct v4l2_subdev *sd,
 }
...
+				 struct v4l2_subdev_pad_config *cfg,
 ...
 {
 	if (code->pad == PAD_CIS) {
@@ -1218,7 +1218,7 @@ static int s5k5baf_enum_mbus_code(struct v4l2_subdev *sd,
 }
...
@@ -1283,7 +1283,7 @@ static int s5k5baf_get_fmt(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh,
 	struct v4l2_mbus_framefmt *mf;
...
@@ -1305,7 +1305,7 @@ static int s5k5baf_get_fmt(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh,
 	return 0;
 }
...
@@ -1316,7 +1316,7 @@ static int s5k5baf_set_fmt(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh,
...
@@ -1368,7 +1368,7 @@ static int s5k5baf_is_bound_target(u32 target)
 }
...
@@ -1388,9 +1388,9 @@ static int s5k5baf_get_selection(struct v4l2_subdev *sd,
...
@@ -1459,7 +1459,7 @@ static bool s5k5baf_cmp_rect(const struct v4l2_rect *r1,
 }
...
+				 struct v4l2_subdev_pad_config *cfg,
 ...
 {
 	static enum selection_rect rtype;
@@ -1480,9 +1480,9 @@ static int s5k5baf_set_selection(struct v4l2_subdev *sd,
 	if (sel->which == V4L2_SUBDEV_FORMAT_TRY) {
...
+				v4l2_subdev_get_try_crop(sd, cfg, PAD_OUT)
 		...
 		return 0;
@@ -1700,22 +1700,22 @@ static int s5k5baf_open(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh)
 {
 	struct v4l2_mbus_framefmt *mf;
...
@@ -1731,7 +1731,7 @@ static const struct smiapp_csi_data_format
 }
...
+				    struct v4l2_subdev_pad_config *cfg,
 ...
 {
 	struct smiapp_sensor *sensor = to_smiapp_sensor(subdev);
@@ -1742,7 +1742,7 @@ static int smiapp_set_format_source(struct v4l2_subdev *subdev,
 	unsigned int i;
 	int rval;
...
@@ -1784,7 +1784,7 @@ static int smiapp_set_format_source(struct v4l2_subdev *subdev,
 }
...
+			     struct v4l2_subdev_pad_config *cfg,
 ...
 {
 	struct smiapp_sensor *sensor = to_smiapp_sensor(subdev);
@@ -1796,7 +1796,7 @@ static int smiapp_set_format(struct v4l2_subdev *subdev,
...
+	smiapp_propagate(subdev, cfg, sel->which,
 	...
 	if (sel->which == V4L2_SUBDEV_FORMAT_ACTIVE)
@@ -2109,7 +2109,7 @@ static int __smiapp_sel_supported(struct v4l2_subdev *subdev,
 }
...
+			   struct v4l2_subdev_pad_config *cfg,
 ...
 {
 	struct smiapp_sensor *sensor = to_smiapp_sensor(subdev);
@@ -2117,7 +2117,7 @@ static int smiapp_set_crop(struct v4l2_subdev *subdev,
...
@@ -2128,15 +2128,15 @@ static int smiapp_set_crop(struct v4l2_subdev *subdev,
 		if (sel->pad == ssd->sink_pad) {
 			_r.left = 0;
 			_r.top = 0;
...
@@ -2154,14 +2154,14 @@ static int smiapp_set_crop(struct v4l2_subdev *subdev,
 	*crops[sel->pad] = sel->r;
...
+				  struct v4l2_subdev_pad_config *cfg,
 ...
 {
 	struct smiapp_sensor *sensor = to_smiapp_sensor(subdev);
@@ -2174,13 +2174,13 @@ static int __smiapp_get_selection(struct v4l2_subdev *subdev,
 	if (ret)
 		return ret;
...
+			v4l2_subdev_get_try_format(subdev, cfg, ssd->sink_pad);
 		...
 		sink_fmt.left = 0;
 		sink_fmt.top = 0;
@@ -2214,20 +2214,20 @@ static int __smiapp_get_selection(struct v4l2_subdev *subdev,
 }
...
+				struct v4l2_subdev_pad_config *cfg,
 ...
 {
 	struct smiapp_sensor *sensor = to_smiapp_sensor(subdev);
@@ -2253,10 +2253,10 @@ static int smiapp_set_selection(struct v4l2_subdev *subdev,
...
+		ret = smiapp_set_compose(subdev, cfg, sel);
 	...
 	default:
 		BUG();
@@ -2789,8 +2789,8 @@ static int smiapp_open(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh)
...
@@ -2806,7 +2806,7 @@ static int smiapp_open(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh)
...
index aa40c82..2ea5e2b 100644
--- a/drivers/media/platform/s3c-camif/camif-capture.c
+++ b/drivers/media/platform/s3c-camif/camif-capture.c
@@ -1230,7 +1230,7 @@ static const u32 camif_mbus_formats[] = {
  */
...
@@ -1241,14 +1241,14 @@ static int s3c_camif_subdev_enum_mbus_code(struct v4l2_subdev *sd,
 }
...
@@ -1308,7 +1308,7 @@ static void __camif_subdev_try_format(struct camif_dev *camif,
 }
...
+				    struct v4l2_subdev_pad_config *cfg,
 ...
 {
 	struct camif_dev *camif = v4l2_get_subdevdata(sd);
@@ -1336,7 +1336,7 @@ static int s3c_camif_subdev_set_fmt(struct v4l2_subdev *sd,
...
+		mf = v4l2_subdev_get_try_format(sd, cfg, fmt->pad);
 		*mf = fmt->format;
 		...
 		return 0;
@@ -1375,7 +1375,7 @@ static int s3c_camif_subdev_set_fmt(struct v4l2_subdev *sd,
 }
...
+					  struct v4l2_subdev_pad_config *cfg,
 ...
 {
 	struct camif_dev *camif = v4l2_get_subdevdata(sd);
@@ -1388,7 +1388,7 @@ static int s3c_camif_subdev_get_selection(struct v4l2_subdev *sd,
 		return -EINVAL;
...
@@ -1462,7 +1462,7 @@ static void __camif_try_crop(struct camif_dev *camif, struct v4l2_rect *r)
 }
...
index 80bedc5..89c230d 100644
--- a/drivers/media/platform/vsp1/vsp1_hsit.c
+++ b/drivers/media/platform/vsp1/vsp1_hsit.c
@@ -60,7 +60,7 @@ static int hsit_s_stream(struct v4l2_subdev *subdev, int enable)
  */
...
@@ -78,12 +78,12 @@ static int hsit_enum_mbus_code(struct v4l2_subdev *subdev,
 }
...
+	format = v4l2_subdev_get_try_format(subdev, cfg, fse->pad);
 	...
 	if (fse->index || fse->code != format->code)
 		return -EINVAL;
@@ -107,25 +107,25 @@ static int hsit_enum_frame_size(struct v4l2_subdev *subdev,
 }
...
@@ -148,7 +148,7 @@ static int hsit_set_format(struct v4l2_subdev *subdev,
 	fmt->format = *format;
...
index 28dd9e7..21560e0 100644
--- a/drivers/media/platform/vsp1/vsp1_rwpf.h
+++ b/drivers/media/platform/vsp1/vsp1_rwpf.h
@@ -50,20 +50,20 @@ struct vsp1_rwpf *vsp1_rpf_create(struct vsp1_device *vsp1, unsigned int index);
...
+		       struct v4l2_subdev_pad_config *cfg,
 ...
 {
 	struct vpfe_isif_device *vpfe_isif = v4l2_get_subdevdata(sd);
@@ -1604,7 +1604,7 @@ isif_pad_get_selection(struct v4l2_subdev *sd,
...
@@ -1618,9 +1618,8 @@ isif_pad_get_selection(struct v4l2_subdev *sd,
  * @sd: VPFE isif V4L2 subdevice
  * @fh: V4L2 subdev file handle
  *
- * Initialize all pad formats with default values. If fh is not NULL, try
...
@@ -1631,27 +1630,27 @@ isif_init_formats(struct v4l2_subdev *sd,
...
@@ -1531,16 +1531,15 @@ static int resizer_enum_mbus_code(struct v4l2_subdev *sd,
 /*
...
index 7dbf68c..d829614 100644
--- a/drivers/staging/media/omap4iss/iss_csi2.c
+++ b/drivers/staging/media/omap4iss/iss_csi2.c
@@ -803,17 +803,17 @@ static const struct iss_video_operations csi2_issvideo_ops = {
  */
...
+csi2_try_format(struct iss_csi2_device *csi2, struct v4l2_subdev_pad_config *cfg,
 		...
 		enum v4l2_subdev_format_whence which)
 {
@@ -843,7 +843,7 @@ csi2_try_format(struct iss_csi2_device *csi2, struct v4l2_subdev_fh *fh,
 		 * compression.
 		 */
 		pixelcode = fmt->code;
-		format = __csi2_get_format(csi2, fh, CSI2_PAD_SINK, which);
+		format = __csi2_get_format(csi2, cfg, CSI2_PAD_SINK, which);
 		...
 		/*
@@ -864,12 +864,12 @@ csi2_try_format(struct iss_csi2_device *csi2, struct v4l2_subdev_fh *fh,
 /*
  * csi2_enum_mbus_code - Handle pixel format enumeration
  * @sd     : pointer to v4l2 subdev structure
- * @fh     : V4L2 subdev file handle
...
@@ -882,7 +882,7 @@ static int csi2_enum_mbus_code(struct v4l2_subdev *sd,
...
+		format = __csi2_get_format(csi2, cfg, CSI2_PAD_SINK,
 		...
 		switch (code->index) {
 		case 0:
@@ -906,7 +906,7 @@ static int csi2_enum_mbus_code(struct v4l2_subdev *sd,
 }
...
@@ -938,17 +938,17 @@ static int csi2_enum_frame_size(struct v4l2_subdev *sd,
 /*
  * csi2_get_format - Handle get format by pads subdev method
  * @sd : pointer to v4l2 subdev structure
- * @fh : V4L2 subdev file handle
...
@@ -959,29 +959,29 @@ static int csi2_get_format(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh,
 /*
  * csi2_set_format - Handle set format by pads subdev method
  * @sd : pointer to v4l2 subdev structure
- * @fh : V4L2 subdev file handle
...
+		csi2_try_format(csi2, cfg, CSI2_PAD_SOURCE, format, fmt->which);
 	...
 	return 0;
@@ -1007,23 +1007,23 @@ static int csi2_link_validate(struct v4l2_subdev *sd, struct media_link *link,
 /*
...
+static int csi2_init_formats(struct v4l2_subdev *sd, struct v4l2_subdev_pad_config *cfg)
 {
 	struct v4l2_subdev_format format;
...
+	format.which = cfg ? V4L2_SUBDEV_FORMAT_TRY : V4L2_SUBDEV_FORMAT_ACTIVE;
 	...
 	format.format.height = 4096;
-	csi2_set_format(sd, fh, &format);
+	csi2_set_format(sd, cfg, &format);
 
 	return 0;
 }
diff --git a/drivers/staging/media/omap4iss/iss_ipipe.c b/drivers/staging/media/omap4iss/iss_ipipe.c
index a1a46ef..4e49620 100644
...
@@ -372,23 +372,23 @@ static int ipipe_link_validate(struct v4l2_subdev *sd, struct media_link *link,
 /*
...
+static int ipipe_init_formats(struct v4l2_subdev *sd, struct v4l2_subdev_pad_config *cfg)
 {
 	struct v4l2_subdev_format format;
...
+	format.which = cfg ? V4L2_SUBDEV_FORMAT_TRY : V4L2_SUBDEV_FORMAT_ACTIVE;
 	...
 	format.format.height = 4096;
-	ipipe_set_format(sd, fh, &format);
+	ipipe_set_format(sd, cfg, &format);
 
 	return 0;
 }
diff --git a/drivers/staging/media/omap4iss/iss_ipipeif.c b/drivers/staging/media/omap4iss/iss_ipipeif.c
index 32a7483..4e4cbb8 100644
--- a/drivers/staging/media/omap4iss/iss_ipipeif.c
+++ b/drivers/staging/media/omap4iss/iss_ipipeif.c
@@ -377,24 +377,24 @@ static int ipipeif_set_stream(struct v4l2_subdev *sd, int enable)
...
+		   struct v4l2_subdev_pad_config *cfg, unsigned int pad,
 		   ...
 		   enum v4l2_subdev_format_whence which)
 {
@@ -423,7 +423,7 @@ ipipeif_try_format(struct iss_ipipeif_device *ipipeif,
 		break;
...
@@ -438,7 +438,7 @@ ipipeif_try_format(struct iss_ipipeif_device *ipipeif,
 		break;
...
@@ -457,12 +457,12 @@ ipipeif_try_format(struct iss_ipipeif_device *ipipeif,
 /*
  * ipipeif_enum_mbus_code - Handle pixel format enumeration
  * @sd     : pointer to v4l2 subdev structure
- * @fh : V4L2 subdev file handle
...
@@ -482,7 +482,7 @@ static int ipipeif_enum_mbus_code(struct v4l2_subdev *sd,
 		if (code->index != 0)
 			return -EINVAL;
...
+		format = __ipipeif_get_format(ipipeif, cfg, IPIPEIF_PAD_SINK,
 		...
 		code->code = format->code;
@@ -496,7 +496,7 @@ static int ipipeif_enum_mbus_code(struct v4l2_subdev *sd,
 }
...
+				struct v4l2_subdev_pad_config *cfg,
 ...
 {
 	struct iss_ipipeif_device *ipipeif = v4l2_get_subdevdata(sd);
@@ -508,7 +508,7 @@ static int ipipeif_enum_frame_size(struct v4l2_subdev *sd,
 	format.code = fse->code;
 	format.width = 1;
 	format.height = 1;
-	ipipeif_try_format(ipipeif, fh, fse->pad, &format,
+	ipipeif_try_format(ipipeif, cfg, fse->pad, &format,
 	...
 	fse->min_width = format.width;
 	fse->min_height = format.height;
@@ -519,7 +519,7 @@ static int ipipeif_enum_frame_size(struct v4l2_subdev *sd,
 	format.code = fse->code;
 	format.width = -1;
 	format.height = -1;
-	ipipeif_try_format(ipipeif, fh, fse->pad, &format,
+	ipipeif_try_format(ipipeif, cfg, fse->pad, &format,
 	...
 	fse->max_width = format.width;
 	fse->max_height = format.height;
@@ -530,19 +530,19 @@ static int ipipeif_enum_frame_size(struct v4l2_subdev *sd,
 /*
...
@@ -553,39 +553,39 @@ static int ipipeif_get_format(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh,
 /*
...
@@ -611,24 +611,24 @@ static int ipipeif_link_validate(struct v4l2_subdev *sd,
 /*
...
+	format.which = cfg ? V4L2_SUBDEV_FORMAT_TRY : V4L2_SUBDEV_FORMAT_ACTIVE;
 	...
 	format.format.height = 4096;
-	ipipeif_set_format(sd, fh, &format);
+	ipipeif_set_format(sd, cfg, &format);
 
 	return 0;
 }
diff --git a/drivers/staging/media/omap4iss/iss_resizer.c b/drivers/staging/media/omap4iss/iss_resizer.c
index 88522a8..779a1c2 100644
--- a/drivers/staging/media/omap4iss/iss_resizer.c
+++ b/drivers/staging/media/omap4iss/iss_resizer.c
@@ -436,24 +436,24 @@ static int resizer_set_stream(struct v4l2_subdev *sd, int enable)
...
+		   struct v4l2_subdev_pad_config *cfg, unsigned int pad,
 		   ...
 		   enum v4l2_subdev_format_whence which)
 {
@@ -481,7 +481,7 @@ resizer_try_format(struct iss_resizer_device *resizer,
...
@@ -508,12 +508,12 @@ resizer_try_format(struct iss_resizer_device *resizer,
 /*
  * resizer_enum_mbus_code - Handle pixel format enumeration
  * @sd     : pointer to v4l2 subdev structure
- * @fh : V4L2 subdev file handle
...
@@ -528,7 +528,7 @@ static int resizer_enum_mbus_code(struct v4l2_subdev *sd,
 		break;
...
+		format = __resizer_get_format(resizer, cfg, RESIZER_PAD_SINK,
 		...
 		if (code->index == 0) {
@@ -558,7 +558,7 @@ static int resizer_enum_mbus_code(struct v4l2_subdev *sd,
 }
...
+				struct v4l2_subdev_pad_config *cfg,
 ...
 {
 	struct iss_resizer_device *resizer = v4l2_get_subdevdata(sd);
@@ -570,7 +570,7 @@ static int resizer_enum_frame_size(struct v4l2_subdev *sd,
 	format.code = fse->code;
 	format.width = 1;
 	format.height = 1;
...
+	resizer_try_format(resizer, cfg, fse->pad, &format,
 	...
 	fse->min_width = format.width;
 	fse->min_height = format.height;
@@ -581,7 +581,7 @@ static int resizer_enum_frame_size(struct v4l2_subdev *sd,
 	format.code = fse->code;
 	format.width = -1;
 	format.height = -1;
-	resizer_try_format(resizer, fh, fse->pad, &format,
+	resizer_try_format(resizer, cfg, fse->pad, &format,
 	...
 	fse->max_width = format.width;
 	fse->max_height = format.height;
@@ -592,19 +592,19 @@ static int resizer_enum_frame_size(struct v4l2_subdev *sd,
 /*
  * resizer_get_format - Retrieve the video format on a pad
  * @sd : ISP RESIZER V4L2 subdevice
- * @fh : V4L2 subdev file handle
...
@@ -615,32 +615,32 @@ static int resizer_get_format(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh,
 /*
...
@@ -666,24 +666,24 @@ static int resizer_link_validate(struct v4l2_subdev *sd,
 /*
  * resizer_init_formats - Initialize formats on all pads
  * @sd: ISP RESIZER V4L2 subdevice
- * @fh: V4L2 subdev file handle
...
+	format.which = cfg ? V4L2_SUBDEV_FORMAT_TRY : V4L2_SUBDEV_FORMAT_ACTIVE;
 	...
 	format.format.height = 4096;
-	resizer_set_format(sd, fh, &format);
+	resizer_set_format(sd, cfg, &format);
