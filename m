...
Received: from metis.ext.pengutronix.de ([92.198.50.35]:36297 "EHLO
	metis.ext.pengutronix.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1750849AbbGQODG (ORCPT
...
Subject: [PATCH v3 3/4] [media] tc358743: support probe from device tree
Date: Fri, 17 Jul 2015 16:02:55 +0200
Message-Id: <1437141776-8967-3-git-send-email-p.zabel@pengutronix.de>
...
---
Changes since v2:
 - Fixed #ifdef CONFIG_OF and state->bus assignment
