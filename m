...
Received: from galahad.ideasonboard.com ([185.26.127.97]:53850 "EHLO
        galahad.ideasonboard.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1751552AbeA2LAs (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Mon, 29 Jan 2018 06:00:48 -0500
...
Date: Mon, 29 Jan 2018 13:01:01 +0200
Message-ID: <1735356.2kmgrjUaxx@avalon>
In-Reply-To: <1516974930-11713-8-git-send-email-jacopo+renesas@jmondi.org>
References: <1516974930-11713-1-git-send-email-jacopo+renesas@jmondi.org> <1516974930-11713-8-git-send-email-jacopo+renesas@jmondi.org>
MIME-Version: 1.0
...
> @@ -574,6 +753,102 @@ static int ov772x_s_stream(struct v4l2_subdev *sd, int
> enable) return 0;
>  }
> 
> +/*
...
>  	 * set COM8
>  	 */
> @@ -1040,6 +1323,24 @@ static const struct v4l2_subdev_core_ops
...
> @@ -1052,14 +1353,17 @@ static int ov772x_enum_mbus_code(struct v4l2_subdev
> *sd, }
> 
