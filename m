...
Received: from vps-vb.mhejs.net ([37.28.154.113]:50142 "EHLO vps-vb.mhejs.net"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1755515AbdJJVxt (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Tue, 10 Oct 2017 17:53:49 -0400
From: "Maciej S. Szmigiero" <mail@maciej.szmigiero.name>
Subject: [PATCH v2 1/6] cx25840: add pin to pad mapping and output format
 configuration
...
Message-ID: <0bccfd81-e224-ffcc-bc95-d23ddd7d00b9@maciej.szmigiero.name>
Date: Tue, 10 Oct 2017 23:34:45 +0200
MIME-Version: 1.0
