...
Received: from mailout2.w1.samsung.com ([210.118.77.12]:65529 "EHLO
	mailout2.w1.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751167Ab0LUODq (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 21 Dec 2010 09:03:46 -0500
Date: Tue, 21 Dec 2010 15:03:43 +0100
From: Sylwester Nawrocki <s.nawrocki@samsung.com>
Subject: Re: [PATCH v2] [media] s5p-fimc: Configure scaler registers depending
 on FIMC version
In-reply-to: <1292931682-5148-1-git-send-email-khw0178.kim@samsung.com>
To: Hyunwoong Kim <khw0178.kim@samsung.com>
Cc: linux-media@vger.kernel.org, linux-samsung-soc@vger.kernel.org
Message-id: <4D10B3BF.6050803@samsung.com>
MIME-version: 1.0
Content-type: text/plain; charset=ISO-8859-1
Content-transfer-encoding: 7BIT
References: <1292931682-5148-1-git-send-email-khw0178.kim@samsung.com>
...
> ---
> This patch is depended on Hyunwoong's patch.
...
>  		fimc_hw_set_rotation(ctx);
>  		fimc_hw_set_effect(ctx);
> @@ -1722,6 +1735,7 @@ static struct samsung_fimc_variant fimc1_variant_s5pv210 = {
>  	.pix_hoff	 = 1,
>  	.has_inp_rot	 = 1,
>  	.has_out_rot	 = 1,
...
>  	.min_out_pixsize = 16,
>  	.hor_offs_align	 = 1,
> @@ -1743,6 +1757,7 @@ static struct samsung_fimc_variant fimc0_variant_s5pv310 = {
>  	.has_inp_rot	 = 1,
>  	.has_out_rot	 = 1,
>  	.has_cistatus2	 = 1,
> +	.has_mainscaler_ext = 1,
...
>  	.min_out_pixsize = 16,
>  	.hor_offs_align	 = 1,
> @@ -1753,6 +1768,7 @@ static struct samsung_fimc_variant fimc0_variant_s5pv310 = {
...
> index 92cca62..259157b 100644
> --- a/drivers/media/video/s5p-fimc/fimc-core.h
> +++ b/drivers/media/video/s5p-fimc/fimc-core.h
> @@ -357,6 +357,8 @@ struct fimc_pix_limit {
>   * @has_inp_rot: set if has input rotator
>   * @has_out_rot: set if has output rotator
>   * @has_cistatus2: 1 if CISTATUS2 register is present in this IP revision
> + * @has_mainscaler_ext: 1 if extended mainscaler ratios in CIEXTEN register is
> + *			present in this IP revision
>   * @pix_limit: pixel size constraints for the scaler
>   * @min_inp_pixsize: minimum input pixel size
>   * @min_out_pixsize: minimum output pixel size
> @@ -368,6 +370,7 @@ struct samsung_fimc_variant {
...
>  	u16		min_inp_pixsize;
>  	u16		min_out_pixsize;
> @@ -563,7 +566,9 @@ void fimc_hw_set_target_format(struct fimc_ctx *ctx);
...
Thanks, it looks OK to me. I will add it to my patch queue.
