...
Received: from aer-iport-3.cisco.com ([173.38.203.53]:34874 "EHLO
	aer-iport-3.cisco.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1755187AbcBPMwv (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 16 Feb 2016 07:52:51 -0500
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hans.verkuil@cisco.com>,
	Kyungmin Park <kyungmin.park@samsung.com>,
	Sylwester Nawrocki <s.nawrocki@samsung.com>
Subject: [PATCH 11/12] media/platform: convert drivers to use the new vb2_queue dev field
Date: Tue, 16 Feb 2016 13:43:06 +0100
Message-Id: <1455626587-8051-12-git-send-email-hverkuil@xs4all.nl>
...
@@ -1308,6 +1304,7 @@ static int fimc_lite_subdev_registered(struct v4l2_subdev *sd)
 	q->drv_priv = fimc;
 	q->timestamp_flags = V4L2_BUF_FLAG_TIMESTAMP_MONOTONIC;
 	q->lock = &fimc->lock;
+	q->dev = &fimc->pdev->dev;
 	...
 	ret = vb2_queue_init(q);
 	if (ret < 0)
@@ -1559,21 +1556,12 @@ static int fimc_lite_probe(struct platform_device *pdev)
 			goto err_sd;
 	}
...
-		clk_disable(fimc->clock);
 ...
 err_clk_put:
@@ -1659,7 +1647,6 @@ static int fimc_lite_remove(struct platform_device *pdev)
