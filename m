...
Received: from mail-lf0-f51.google.com ([209.85.215.51]:36420 "EHLO
        mail-lf0-f51.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1755008AbdFWUfD (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Fri, 23 Jun 2017 16:35:03 -0400
Received: by mail-lf0-f51.google.com with SMTP id h22so36785027lfk.3
        for <linux-media@vger.kernel.org>; Fri, 23 Jun 2017 13:35:02 -0700 (PDT)
From: Sergei Shtylyov <sergei.shtylyov@cogentembedded.com>
Message-Id: <20170623203456.503714406@cogentembedded.com>
Date: Fri, 23 Jun 2017 23:34:44 +0300
...
Subject: [PATCH v6] media: platform: Renesas IMR driver
MIME-Version: 1.0
Content-Type: text/plain; charset=ISO-8859-15
Content-Disposition: inline; filename=media-platform-Renesas-IMR-driver-v6.patch
...
- updated the patch description.
 ...
 Documentation/media/v4l-drivers/rcar_imr.rst         |   86 
 drivers/media/platform/Kconfig                       |   13 
 drivers/media/platform/Makefile                      |    1 
 drivers/media/platform/rcar_imr.c                    | 1877 +++++++++++++++++++
...
@@ -51,6 +51,7 @@ For more details see the file COPYING in
 	pxa_camera
 	radiotrack
 	rcar-fdp1
+	rcar_imr
...
@@ -437,6 +437,19 @@ config VIDEO_RENESAS_FCP
