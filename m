...
Received: from mailout3.w1.samsung.com ([210.118.77.13]:28519 "EHLO
	...
	with ESMTP id S1753499Ab0L2RdA (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 29 Dec 2010 12:33:00 -0500
MIME-version: 1.0
Content-transfer-encoding: 7BIT
Content-type: TEXT/PLAIN
Date: Wed, 29 Dec 2010 18:32:49 +0100
From: Sylwester Nawrocki <s.nawrocki@samsung.com>
Subject: [PATCH 07/15 v2] [media] s5p-fimc: Rename s3c_fimc* to s5p_fimc*
In-reply-to: <1293643975-4528-1-git-send-email-s.nawrocki@samsung.com>
To: linux-media@vger.kernel.org, linux-samsung-soc@vger.kernel.org
Cc: m.szyprowski@samsung.com, kyungmin.park@samsung.com,
	s.nawrocki@samsung.com
Message-id: <1293643975-4528-8-git-send-email-s.nawrocki@samsung.com>
...
@@ -222,7 +222,7 @@ static int start_streaming(struct vb2_queue *q)
 {
...
@@ -571,8 +571,8 @@ static int fimc_cap_enum_input(struct file *file, void *priv,
 				     struct v4l2_input *i)
 {
...
+	struct s5p_fimc_isp_info *isp_info;
 	...
 	if (i->index >= FIMC_MAX_CAMIF_CLIENTS)
 		return -EINVAL;
@@ -591,7 +591,7 @@ static int fimc_cap_s_input(struct file *file, void *priv,
 {
 	struct fimc_ctx *ctx = priv;
 	struct fimc_dev *fimc = ctx->fimc_dev;
-	struct s3c_platform_fimc *pdata = fimc->pdata;
