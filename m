...
Received: from mail.kapsi.fi ([217.30.184.167]:38252 "EHLO mail.kapsi.fi"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1751772Ab3KJRPe (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Sun, 10 Nov 2013 12:15:34 -0500
From: Antti Palosaari <crope@iki.fi>
To: linux-media@vger.kernel.org
Cc: Antti Palosaari <crope@iki.fi>
Subject: [PATCH RFC 2/2] rtl2832_sdr: implement FMT IOCTLs
Date: Sun, 10 Nov 2013 19:15:16 +0200
Message-Id: <1384103716-4690-3-git-send-email-crope@iki.fi>
...
+
+	f->flags = 0;
+	strcpy(f->description, "BB 8-bit unsigned");
+	f->pixelformat = V4L2_PIX_FMT_U8;
+
+	return 0;
+}
+
...
+	f->fmt.pix.pixelformat = V4L2_PIX_FMT_U8;
+
+	return 0;
+}
+
