...
Received: from moutng.kundenserver.de ([212.227.17.8]:56307 "EHLO
	moutng.kundenserver.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1754030Ab2K0PyH (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 27 Nov 2012 10:54:07 -0500
Date: Tue, 27 Nov 2012 16:54:04 +0100 (CET)
...
Subject: Re: [PATCH 12/15] [media] marvell-ccic: add soc_camera support in
 mmp driver
In-Reply-To: <1353677666-24361-1-git-send-email-twang13@marvell.com>
Message-ID: <Pine.LNX.4.64.1211271620370.22273@axis700.grange>
...
Actually you don't really have to copy everything from platform data to 
your private driver object during probing. You can access your platform 
data also at run-time. So, maybe you can survive without adding these 
...
Also the choice of the videobuf2 implementation can be a runtime 
parameter.
...
Have you considered splitting the .probe() function into 3: common, MMP 
and SOC? Like
