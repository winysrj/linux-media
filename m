...
Received: from vps-vb.mhejs.net ([37.28.154.113]:41196 "EHLO vps-vb.mhejs.net"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1752151AbeCYV1O (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Sun, 25 Mar 2018 17:27:14 -0400
From: "Maciej S. Szmigiero" <mail@maciej.szmigiero.name>
Subject: [PATCH v6 0/6] [media] Add analog mode support for Medion MD95700
To: Michael Krufky <mkrufky@linuxtv.org>,
        Mauro Carvalho Chehab <mchehab@kernel.org>
Cc: Andy Walls <awalls@md.metrocast.net>,
        linux-kernel <linux-kernel@vger.kernel.org>,
        linux-media@vger.kernel.org, Hans Verkuil <hverkuil@xs4all.nl>
Message-ID: <389c2690-2b37-e6f3-30ac-21f13a2ad398@maciej.szmigiero.name>
Date: Sun, 25 Mar 2018 23:27:10 +0200
MIME-Version: 1.0
