...
Received: from nblzone-211-213.nblnetworks.fi ([83.145.211.213]:58368 "EHLO
	hillosipuli.retiisi.org.uk" rhost-flags-OK-OK-OK-FAIL)
	by vger.kernel.org with ESMTP id S1161217Ab2JXVs0 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 24 Oct 2012 17:48:26 -0400
Date: Thu, 25 Oct 2012 00:48:18 +0300
...
Subject: Re: [PATCH 2/2] drivers: media: video: Add support for Aptina
 ar0130 sensor
Message-ID: <20121024214818.GE23933@valkosipuli.retiisi.org.uk>
...
Many of the registers are called the same as in SMIA, but the address is
different. Are there more of such sensors, and are the limit / capability
registers defined in SMIA valid for them?

Is the sensor datasheet public?
...
Unless I'm mistaken, the sensor would support much more.

Is the digital crop supported before binning btw.?

What I'm thinking is whether it'd make sense to use the smiapp driver for
this sensor. There's a lot in common, but also much is different, such as
...
msleep(), please. Or usleep_range(). mdelay() is a busy loop.
...
You should always return the error you've gotten if you do get one.

This is done elsewhere, too.
...
Uh, why? Shouln't this line be at the end of the file?
...
Wouldn't a gpio number suffice?
