...
Received: from mx1.redhat.com ([209.132.183.28]:61955 "EHLO mx1.redhat.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1753243Ab0IHTJf (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Wed, 8 Sep 2010 15:09:35 -0400
Message-ID: <4C87DF68.7070900@redhat.com>
Date: Wed, 08 Sep 2010 16:09:28 -0300
From: Mauro Carvalho Chehab <mchehab@redhat.com>
MIME-Version: 1.0
To: "Matti J. Aaltonen" <matti.j.aaltonen@nokia.com>
CC: linux-media@vger.kernel.org, hverkuil@xs4all.nl,
	eduardo.valentin@nokia.com
Subject: Re: [PATCH v9 3/4] V4L2: WL1273 FM Radio: Controls for the FM radio.
References: <1283168302-19111-1-git-send-email-matti.j.aaltonen@nokia.com> <1283168302-19111-2-git-send-email-matti.j.aaltonen@nokia.com> <1283168302-19111-3-git-send-email-matti.j.aaltonen@nokia.com> <1283168302-19111-4-git-send-email-matti.j.aaltonen@nokia.com>
...
>From what I saw, wl1273-core and radio-wl1273 are just part of the same radio driver.
So, the better would be to just merge them into one driver module, with something like:
...
Small CodingStyle issue: please use spaces between "*" operator:
	msgs = kmalloc((packet_num + 1) * sizeof(struct i2c_msg), GFP_KERNEL);
...
Why the "magic" value of 3? Instead, please define a constant, naming it in a way
that a casual code reviewer could understand why you're multiplying/dividing by 3.
...
> +		V4L2_CAP_RDS_OUTPUT | V4L2_CAP_RAW_RDS_ONLY;
> +
> +	return 0;
> +}
> +
...
Please do the registration of the device at the end. Applications may try to open
(and udev, in fact does it) the device while you're still initializing it. If you
need to do it earlier, you'll need a lock protecting open/close/init, to avoid
race conditions.
