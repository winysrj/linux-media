...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id 00D69C43387
	for <linux-media@archiver.kernel.org>; Mon, 17 Dec 2018 02:28:19 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id 8738C206BA
	for <linux-media@archiver.kernel.org>; Mon, 17 Dec 2018 02:28:19 +0000 (UTC)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726275AbeLQC2S (ORCPT <rfc822;linux-media@archiver.kernel.org>);
        Sun, 16 Dec 2018 21:28:18 -0500
Received: from mga07.intel.com ([134.134.136.100]:5075 "EHLO mga07.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726259AbeLQC2S (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Sun, 16 Dec 2018 21:28:18 -0500
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from orsmga001.jf.intel.com ([10.7.209.18])
  by orsmga105.jf.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 16 Dec 2018 18:28:13 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.56,363,1539673200"; 
   d="scan'208";a="119352125"
Received: from ipu5-build.bj.intel.com (HELO [10.238.232.171]) ([10.238.232.171])
  by orsmga001.jf.intel.com with ESMTP; 16 Dec 2018 18:28:09 -0800
Subject: Re: [PATCH v9 16/22] media: staging/intel-ipu3: Add dual pipe support
...
References: <20181213095107.14894-1-sakari.ailus@linux.intel.com>
 <20181213095107.14894-17-sakari.ailus@linux.intel.com>
From:   Bingbu Cao <bingbu.cao@linux.intel.com>
Message-ID: <3d430eee-ce06-677e-04c4-cae207ec25e5@linux.intel.com>
Date:   Mon, 17 Dec 2018 10:33:24 +0800
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:52.0) Gecko/20100101
 Thunderbird/52.9.1
MIME-Version: 1.0
In-Reply-To: <20181213095107.14894-17-sakari.ailus@linux.intel.com>
...
On 12/13/2018 05:51 PM, Sakari Ailus wrote:
...
>   drivers/staging/media/ipu3/ipu3-css-fw.c        |  11 +-
>   drivers/staging/media/ipu3/ipu3-css-fw.h        |   6 +-
>   drivers/staging/media/ipu3/ipu3-css-params.c    | 316 +++++----
>   drivers/staging/media/ipu3/ipu3-css-params.h    |   9 +-
>   drivers/staging/media/ipu3/ipu3-css.c           | 850 ++++++++++++++----------
>   drivers/staging/media/ipu3/ipu3-css.h           |  83 ++-
>   drivers/staging/media/ipu3/ipu3-v4l2.c          | 773 +++++++++++++++------
>   drivers/staging/media/ipu3/ipu3.c               | 284 ++++----
>   drivers/staging/media/ipu3/ipu3.h               |  56 +-
>   10 files changed, 1450 insertions(+), 948 deletions(-)
>
> diff --git a/drivers/staging/media/ipu3/include/intel-ipu3.h b/drivers/staging/media/ipu3/include/intel-ipu3.h
> index 07fd668173589..ec0b748293512 100644
...
> index ba459e98d77d2..55861aa8fb037 100644
...
> index 954bb31307f55..d1ffe5170e74a 100644
...
> index 747352c089ddf..776206ded83bf 100644
...
> index f93ed027f04d0..f3a0a47117a49 100644
...
> index 3811ad752e8d9..44c55639389aa 100644
...
>   	return r;
>   }
> @@ -1372,13 +1399,14 @@ int ipu3_css_start_streaming(struct ipu3_css *css)
...
>   	return 0;
>   
> @@ -1915,7 +1994,6 @@ int ipu3_css_buf_queue(struct ipu3_css *css, struct ipu3_css_buffer *b)
>    */
...
>   					(queue_id));
>   		if (r < 0) {
> @@ -2214,19 +2326,21 @@ int ipu3_css_set_parameters(struct ipu3_css *css,
...
> index 12d80f87fcb42..e88d60f1a0c37 100644
...
> index 038ee749cb75c..c7936032beb97 100644
...
> index 3d0a34b86ff4c..b7886edeb01b7 100644
...
> index 2e0c756a9e650..04fc99f47ebb5 100644
