...
Received: from gateway02.websitewelcome.com ([69.56.236.20]:42492 "EHLO
	gateway02.websitewelcome.com" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S934564AbaBDVgl (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 4 Feb 2014 16:36:41 -0500
Received: from gator3086.hostgator.com (ns6171.hostgator.com [50.87.144.121])
	by gateway02.websitewelcome.com (Postfix) with ESMTP id A40BD561808DD
	for <linux-media@vger.kernel.org>; Tue,  4 Feb 2014 15:11:47 -0600 (CST)
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8;
 format=flowed
Content-Transfer-Encoding: 7bit
Date: Tue, 04 Feb 2014 15:11:46 -0600
From: Dean Anderson <linux-dev@sensoray.com>
To: <hverkuil@xs4all.nl>, <linux-dev@sensoray.com>,
	<linux-media@vger.kernel.org>
Subject: Re: [PATCH] s2255drv: refactoring =?UTF-8?Q?s=32=32=35=35=5Fchann?=
 =?UTF-8?Q?el=20to=20s=32=32=35=35=5Fvc?=
In-Reply-To: <1391547898-7593-1-git-send-email-linux-dev@sensoray.com>
References: <1391547898-7593-1-git-send-email-linux-dev@sensoray.com>
Message-ID: <3a6c478d68f50ec0bfd98714c35624ed@sensoray.com>
...
> @@ -652,7 +653,7 @@ static void s2255_fillbuff(struct s2255_channel 
> *channel,
>  		default:
...
>  		return;
> @@ -660,7 +661,7 @@ static void s2255_fillbuff(struct s2255_channel 
> *channel,
...
>  }
> @@ -674,8 +675,8 @@ static int buffer_setup(struct videobuf_queue
...
> @@ -696,29 +697,29 @@ static int buffer_prepare(struct videobuf_queue
...
>  	buf->vb.height = h;
>  	buf->vb.field = field;
> @@ -740,10 +741,10 @@ static void buffer_queue(struct videobuf_queue
> *vq, struct videobuf_buffer *vb)
>  {
>  	struct s2255_buffer *buf = container_of(vb, struct s2255_buffer, 
> vb);
...
> @@ -751,7 +752,7 @@ static void buffer_release(struct videobuf_queue 
> *vq,
>  {
>  	struct s2255_buffer *buf = container_of(vb, struct s2255_buffer, 
> vb);
...
>  }
> 
> @@ -765,12 +766,12 @@ static struct videobuf_queue_ops 
> s2255_video_qops = {
> 
...
>  }
> 
> @@ -827,18 +828,18 @@ static int vidioc_g_fmt_vid_cap(struct file
> *file, void *priv,
...
>  	f->fmt.pix.priv = 0;
> @@ -851,8 +852,8 @@ static int vidioc_try_fmt_vid_cap(struct file
> *file, void *priv,
...
> 
> @@ -912,7 +913,7 @@ static int vidioc_s_fmt_vid_cap(struct file
> *file, void *priv,
>  			    struct v4l2_format *f)
>  {
>  	struct s2255_fh *fh = priv;
...
> @@ -941,15 +942,15 @@ static int vidioc_s_fmt_vid_cap(struct file
> *file, void *priv,
>  		ret = -EBUSY;
>  		goto out_s_fmt;
>  	}
...
>  			else
> @@ -961,7 +962,7 @@ static int vidioc_s_fmt_vid_cap(struct file
> *file, void *priv,
...
>  		mode.color |= COLOR_Y8;
> @@ -970,7 +971,7 @@ static int vidioc_s_fmt_vid_cap(struct file
> *file, void *priv,
...
>  		mode.color &= ~MASK_COLOR;
> @@ -983,14 +984,14 @@ static int vidioc_s_fmt_vid_cap(struct file
> *file, void *priv,
...
> @@ -1126,28 +1127,28 @@ static void s2255_print_cfg(struct s2255_dev
> *sdev, struct s2255_mode *mode)
>   * When the restart parameter is set, we sleep for ONE frame to allow 
> the
...
> @@ -1158,36 +1159,36 @@ static int s2255_set_mode(struct s2255_channel 
> *channel,
...
>  	if (buffer == NULL) {
>  		dev_err(&dev->udev->dev, "out of mem\n");
> @@ -1198,17 +1199,17 @@ static int s2255_cmd_status(struct
...
>  	return res;
>  }
> @@ -1218,7 +1219,7 @@ static int vidioc_streamon(struct file *file,
...
> @@ -1234,18 +1235,18 @@ static int vidioc_streamon(struct file *file,
> void *priv, enum v4l2_buf_type i)
...
>  		res_free(fh);
> 
> @@ -1255,14 +1256,14 @@ static int vidioc_streamon(struct file *file,
> void *priv, enum v4l2_buf_type i)
...
>  	res_free(fh);
>  	return 0;
> @@ -1273,7 +1274,7 @@ static int vidioc_s_std(struct file *file, void
> *priv, v4l2_std_id i)
>  	struct s2255_fh *fh = priv;
>  	struct s2255_mode mode;
>  	struct videobuf_queue *q = &fh->vb_vidq;
...
> @@ -1282,7 +1283,7 @@ static int vidioc_s_std(struct file *file, void
> *priv, v4l2_std_id i)
>  		ret = -EBUSY;
>  		goto out_s_std;
>  	}
...
> @@ -1290,8 +1291,8 @@ static int vidioc_s_std(struct file *file, void
> *priv, v4l2_std_id i)
>  			mode.restart = 1;
...
> @@ -1299,16 +1300,16 @@ static int vidioc_s_std(struct file *file,
...
>  	mutex_unlock(&q->vb_lock);
>  	return ret;
> @@ -1318,7 +1319,7 @@ static int vidioc_g_std(struct file *file, void
> *priv, v4l2_std_id *i)
>  {
>  	struct s2255_fh *fh = priv;
> 
...
>  }
> 
> @@ -1334,7 +1335,7 @@ static int vidioc_enum_input(struct file *file,
> void *priv,
>  {
>  	struct s2255_fh *fh = priv;
>  	struct s2255_dev *dev = fh->dev;
...
>  	if (inp->index != 0)
>  		return -EINVAL;
> @@ -1343,7 +1344,7 @@ static int vidioc_enum_input(struct file *file,
> void *priv,
>  	inp->status = 0;
...
>  			rc, status);
>  		if (rc == 0)
> @@ -1356,7 +1357,7 @@ static int vidioc_enum_input(struct file *file,
> void *priv,
...
>  		break;
>  	}
> @@ -1377,10 +1378,10 @@ static int vidioc_s_input(struct file *file,
...
>  }
> 
> @@ -1418,10 +1419,10 @@ static int vidioc_g_jpegcomp(struct file
> *file, void *priv,
...
>  	return 0;
>  }
> @@ -1430,10 +1431,10 @@ static int vidioc_s_jpegcomp(struct file
> *file, void *priv,
...
>  	return 0;
>  }
> @@ -1443,15 +1444,15 @@ static int vidioc_g_parm(struct file *file, 
> void *priv,
>  {
>  	struct s2255_fh *fh = priv;
...
> @@ -1478,15 +1479,15 @@ static int vidioc_s_parm(struct file *file, 
> void *priv,
...
> @@ -1507,7 +1508,7 @@ static int vidioc_s_parm(struct file *file, void 
> *priv,
>  	}
>  	mode.fdec = fdec;
>  	sp->parm.capture.timeperframe.denominator = def_dem;
...
> @@ -1532,8 +1533,8 @@ static int vidioc_enum_framesizes(struct file
> *file, void *priv,
...
> @@ -1551,10 +1552,10 @@ static int vidioc_enum_frameintervals(struct
> file *file, void *priv,
...
>  	int i;
> @@ -1586,7 +1587,7 @@ static int vidioc_enum_frameintervals(struct
> file *file, void *priv,
...
>  		res_free(fh);
>  	}
> @@ -1820,13 +1821,13 @@ static const struct v4l2_ioctl_ops 
> s2255_ioctl_ops = {
...
>  		s2255_destroy(dev);
> @@ -1860,52 +1861,52 @@ static int s2255_probe_v4l(struct s2255_dev 
> *dev)
>  	int ret;
>  	int i;
>  	int cur_nr = video_nr;
...
>  						    cur_nr + i);
> 
> @@ -1916,7 +1917,7 @@ static int s2255_probe_v4l(struct s2255_dev 
> *dev)
>  		}
...
> @@ -1953,9 +1954,9 @@ static int save_frame(struct s2255_dev *dev,
...
> @@ -1981,7 +1982,7 @@ static int save_frame(struct s2255_dev *dev,
> struct s2255_pipeinfo *pipe_info)
>  				}
>  				/* reverse it */
>  				dev->cc = G_chnmap[cc];
...
>  					ch->bad_payload++;
> @@ -2000,7 +2001,7 @@ static int save_frame(struct s2255_dev *dev,
> struct s2255_pipeinfo *pipe_info)
...
> @@ -2039,7 +2040,7 @@ static int save_frame(struct s2255_dev *dev,
> struct s2255_pipeinfo *pipe_info)
>  		if (!bframe)
>  			return -EINVAL;
>  	}
...
> */
> @@ -2162,11 +2163,11 @@ static int s2255_get_fx2fw(struct s2255_dev 
> *dev)
...
> 
> @@ -2175,33 +2176,33 @@ static int s2255_create_sys_buffers(struct
...
>  	return 0;
>  }
> @@ -2235,21 +2236,21 @@ static int s2255_board_init(struct s2255_dev 
> *dev)
...
> @@ -2263,12 +2264,12 @@ static int s2255_board_shutdown(struct 
> s2255_dev *dev)
...
>  	return 0;
> @@ -2357,26 +2358,26 @@ static int s2255_start_readpipe(struct 
> s2255_dev *dev)
>  }
> 
...
> @@ -2387,18 +2388,18 @@ static int s2255_start_acquire(struct
> s2255_channel *channel)
>  	if (res != 0)
...
>  	if (buffer == NULL) {
>  		dev_err(&dev->udev->dev, "out of mem\n");
> @@ -2412,8 +2413,8 @@ static int s2255_stop_acquire(struct
> s2255_channel *channel)
>  	if (res != 0)
...
>  }
> 
> @@ -2503,11 +2504,11 @@ static int s2255_probe(struct usb_interface 
> *interface,
...
> @@ -2595,15 +2596,15 @@ static void s2255_disconnect(struct
