...
Received: from lb3-smtp-cloud6.xs4all.net ([194.109.24.31]:47907 "EHLO
	lb3-smtp-cloud6.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1751528AbaLSPCm (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 19 Dec 2014 10:02:42 -0500
...
Subject: [RFCv2 PATCH 10/11] v4l2-subdev: remove enum_framesizes/intervals
Date: Fri, 19 Dec 2014 15:51:35 +0100
Message-Id: <1419000696-25202-11-git-send-email-hverkuil@xs4all.nl>
...
index f4be2a1..fccfa45 100644
--- a/drivers/media/platform/soc_camera/soc_camera.c
+++ b/drivers/media/platform/soc_camera/soc_camera.c
@@ -1906,22 +1906,34 @@ static int default_enum_framesizes(struct soc_camera_device *icd,
 	int ret;
