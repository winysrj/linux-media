...
Received: from hqemgate03.nvidia.com ([216.228.121.140]:18197 "EHLO
	hqemgate03.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751758Ab1BPXx1 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 16 Feb 2011 18:53:27 -0500
...
Subject: [PATCH v3 1/1] [media] ov9740: Initial submit of OV9740 driver.
Date: Wed, 16 Feb 2011 15:52:40 -0800
Message-ID: <1297900360-2457-1-git-send-email-achew@nvidia.com>
MIME-Version: 1.0
...
+		return ret;
+
+	ret = ov9740_set_res(client, mf->width, code);
+	if (ret < 0)
+		return ret;
+
+	mf->code	= code;
