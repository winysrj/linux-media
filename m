...
Received: from mout0.freenet.de ([195.4.92.90])
	...
	(envelope-from <hofrichter@freenet.de>) id 1K74s5-0008LS-1w
	for linux-dvb@linuxtv.org; Fri, 13 Jun 2008 10:43:02 +0200
Received: from [195.4.92.15] (helo=5.mx.freenet.de)
	by mout0.freenet.de with esmtpa (ID hofrichter@freenet.de) (port 25)
	(Exim 4.69 #19) id 1K74rb-00082Z-Ou
	for linux-dvb@linuxtv.org; Fri, 13 Jun 2008 10:42:27 +0200
Received: from p4fdb7f3b.dip.t-dialin.net ([79.219.127.59]:63456 helo=voidlap)
	by 5.mx.freenet.de with esmtpsa (ID hofrichter@freenet.de)
	(TLSv1:AES256-SHA:256) (port 587) (Exim 4.69 #12) id 1K74rb-000329-ES
	for linux-dvb@linuxtv.org; Fri, 13 Jun 2008 10:42:27 +0200
From: Christian Hofrichter <hofrichter@freenet.de>
To: linux-dvb@linuxtv.org
Date: Fri, 13 Jun 2008 10:42:40 +0200
MIME-Version: 1.0
Content-Disposition: inline
Message-Id: <200806131042.41038.hofrichter@freenet.de>
Subject: [linux-dvb] irq overflow with pluto2 driver
...
Hello,
I have a weird problem with my dvb-t satelco easywatch mobile set. When I tune 
the card to a tv channel and receive the signal I get an irq overflow exactly 
every 30 seconds. The overflow is accompanied by picture and sound 
distortions and happens in a interval of exactly 30 seconds. It is a pcmcia 
card running with kernel 2.6.25 and the pluto2 module. Can anyone give some 
hints how to get rid of this annoying overflow ? Might it be a hardware 
problem with my laptop (hp nx6125).
