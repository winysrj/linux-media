...
Received: from mail-wr0-f196.google.com ([209.85.128.196]:45105 "EHLO
        mail-wr0-f196.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S935833AbeFMPJZ (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Wed, 13 Jun 2018 11:09:25 -0400
Received: by mail-wr0-f196.google.com with SMTP id o12-v6so3129344wrm.12
        for <linux-media@vger.kernel.org>; Wed, 13 Jun 2018 08:09:24 -0700 (PDT)
...
Subject: [PATCH v3 12/27] venus: hfi_parser: add common capability parser
Date: Wed, 13 Jun 2018 18:07:46 +0300
Message-Id: <20180613150801.11702-13-stanimir.varbanov@linaro.org>
...
---
 ...
 drivers/media/platform/qcom/venus/hfi_parser.c | 282 ++++++++++++++++++++
 ...
 10 files changed, 521 insertions(+), 439 deletions(-)
...
index c0f3bef8299f..d3cbb062e1cf 100644
...
@@ -217,81 +218,30 @@ static void hfi_sys_init_done(struct venus_core *core, struct venus_inst *inst,
 			      void *packet)
 {
...
@@ -369,51 +319,6 @@ static void hfi_sys_pc_prepare_done(struct venus_core *core,
...
@@ -503,238 +408,11 @@ static void hfi_session_prop_info(struct venus_core *core,
 	complete(&inst->done);
 }
...
+	u32 rem_bytes, error;
 	...
 	error = pkt->error_type;
 	if (error != HFI_ERR_NONE)
@@ -743,8 +421,14 @@ static void hfi_session_init_done(struct venus_core *core,
 	if (core->res->hfi_version != HFI_VERSION_1XX)
 		goto done;
...
index 000000000000..e8e41811db80
--- /dev/null
...
new file mode 100644
index 000000000000..59bcd7c3a4d8
--- /dev/null
...
index 3cf243ddcdb8..31a240ab142b 100644
...
index 2cd7b342b208..aa6b0026d79d 100644
