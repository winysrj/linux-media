...
Received: from mx3.redhat.com (mx3.redhat.com [172.16.48.32])
	by int-mx1.corp.redhat.com (8.13.1/8.13.1) with ESMTP id m514kvAW022510
	for <video4linux-list@redhat.com>; Sun, 1 Jun 2008 00:46:57 -0400
Received: from mail-in-06.arcor-online.net (mail-in-06.arcor-online.net
	[151.189.21.46])
	by mx3.redhat.com (8.13.8/8.13.8) with ESMTP id m514jlXo005002
	for <video4linux-list@redhat.com>; Sun, 1 Jun 2008 00:45:47 -0400
From: hermann pitton <hermann-pitton@arcor.de>
To: Nigel Henry <cave.dnb2m97pp@aliceadsl.fr>
In-Reply-To: <200805312311.25073.cave.dnb2m97pp@aliceadsl.fr>
References: <200805312311.25073.cave.dnb2m97pp@aliceadsl.fr>
Content-Type: text/plain
Date: Sun, 01 Jun 2008 06:32:50 +0200
Message-Id: <1212294770.8234.20.camel@pc10.localdom.local>
Mime-Version: 1.0
Content-Transfer-Encoding: 7bit
Cc: video4linux-list@redhat.com
Subject: Re: Problems inserting tuner module with options set on 2.6.25
	kernel
...
Am Samstag, den 31.05.2008, 23:11 +0200 schrieb Nigel Henry:
...
maybe we should have some v4l2 release notes per kernel, but I don't
know how to create them in a proper way under current conditions.

However, from a development point of view, you could have such "trouble"
already one year back and more, but it is moving in the right direction,
even it looks like only reverted now, there are new targets to do so.

But user notification is an issue, I hate it myself too, if something
comes over seemingly for nothing out of the blue skies.

You don't need to set tda9887/tuner port options anymore, the drivers
are good enough now to do it for you, because so many people helped and
jumped in. Thanks to all.

The tda9887 is out of the tuner module again, and for any remaining
issue you might have, you still can override the default settings and
can easily see what you have with tda9887 debug=2.
