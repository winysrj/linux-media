...
Received: from smtp.nokia.com ([147.243.1.48]:28039 "EHLO mgw-sa02.nokia.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S932433Ab2CBRc7 (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Fri, 2 Mar 2012 12:32:59 -0500
...
Cc: laurent.pinchart@ideasonboard.com, dacohen@gmail.com,
	...
	teturtia@gmail.com
Subject: [PATCH v4 33/34] smiapp: Add driver.
Date: Fri,  2 Mar 2012 19:30:41 +0200
Message-Id: <1330709442-16654-33-git-send-email-sakari.ailus@iki.fi>
...
---
 ...
 drivers/media/video/smiapp/smiapp-core.c     | 2704 ++++++++++++++++++++++++++
 ...
 drivers/media/video/smiapp/smiapp.h          |  267 +++
 include/media/smiapp.h                       |   83 +
 17 files changed, 5166 insertions(+), 0 deletions(-)
...
+	int pixel_order = smiapp_pixel_order(sensor);
+
...
+
+out:
+	rval = smiapp_write(client, SMIAPP_REG_U8_DATA_TRANSFER_IF_1_CTRL, 0);
+	return rval;
+}
+
+/*
...
+	if (fmt->format.width > sensor->limits[SMIAPP_LIMIT_MAX_X_OUTPUT_SIZE])
+		fmt->format.width =
...
+			sensor->limits[SMIAPP_LIMIT_MAX_Y_OUTPUT_SIZE];
+
+	crops[SMIAPP_PAD_SINK]->left = 0;
+	crops[SMIAPP_PAD_SINK]->top = 0;
...
+		sel->r.left = src_size->width - sel->r.width;
