...
Received: from lb3-smtp-cloud2.xs4all.net ([194.109.24.29]:50605 "EHLO
	lb3-smtp-cloud2.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1754177AbbAPKUo (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 16 Jan 2015 05:20:44 -0500
Message-ID: <54B8E5E9.8080207@xs4all.nl>
Date: Fri, 16 Jan 2015 11:20:25 +0100
From: Hans Verkuil <hverkuil@xs4all.nl>
MIME-Version: 1.0
To: Lars-Peter Clausen <lars@metafoo.de>
CC: linux-media@vger.kernel.org
Subject: Re: [PATCH 15/16] [media] adv7180: Add free run mode controls
References: <1421150481-30230-1-git-send-email-lars@metafoo.de> <1421150481-30230-16-git-send-email-lars@metafoo.de>
In-Reply-To: <1421150481-30230-16-git-send-email-lars@metafoo.de>
