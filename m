...
Received: from smtp-vbr1.xs4all.nl ([194.109.24.21]:1483 "EHLO
	...
	with ESMTP id S1753929Ab1EGMrA convert rfc822-to-8bit (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Sat, 7 May 2011 08:47:00 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: Sakari Ailus <sakari.ailus@maxwell.research.nokia.com>
Subject: Re: [RFC v4] V4L2 API for flash devices
Date: Sat, 7 May 2011 14:46:56 +0200
...
In-Reply-To: <4DC2F131.6090407@maxwell.research.nokia.com>
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="iso-8859-1"
Content-Transfer-Encoding: 8BIT
Message-Id: <201105071446.56843.hverkuil@xs4all.nl>
...
> 2, 3] is very coarse.
> 
> A standard unit such as ms or 탎 should be used.
> 
> 
...
> useful to have standard unit on this control, like ms or 탎.

This should be standardized. The question is how flexible we want this.
I would definitely go for 탎 or perhaps even ns. But what should the
...
> standard SI units should be used. In the sensor's case, this could be 탎.
