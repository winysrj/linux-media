...
Received: from nblzone-211-213.nblnetworks.fi ([83.145.211.213]:60786 "EHLO
        hillosipuli.retiisi.org.uk" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1751443AbdGRTnF (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Tue, 18 Jul 2017 15:43:05 -0400
From: Sakari Ailus <sakari.ailus@linux.intel.com>
To: laurent.pinchart@ideasonboard.com
Cc: linux-media@vger.kernel.org, pavel@ucw.cz
Subject: [PATCH v1.1 1/1] omap3isp: Skip CSI-2 receiver initialisation in CCP2 configuration
Date: Tue, 18 Jul 2017 22:43:03 +0300
Message-Id: <20170718194303.20436-1-sakari.ailus@linux.intel.com>
...
- Store the receiver entity per PHY. This way the function to obtain the
 ...
 drivers/media/platform/omap3isp/ispcsiphy.c | 33 +++++++++++++++--------------
...
index 2028bb519108..4a245d51e432 100644
...
@@ -302,7 +305,7 @@ int omap3isp_csiphy_acquire(struct isp_csiphy *phy)
...
@@ -312,10 +315,8 @@ int omap3isp_csiphy_acquire(struct isp_csiphy *phy)
...
@@ -325,7 +326,7 @@ void omap3isp_csiphy_release(struct isp_csiphy *phy)
