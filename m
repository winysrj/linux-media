...
Received: from smtp-vbr12.xs4all.nl ([194.109.24.32]:2174 "EHLO
	smtp-vbr12.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S965093Ab3FTNoy (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 20 Jun 2013 09:44:54 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hans.verkuil@cisco.com>
Subject: [RFCv2 PATCH 03/15] saa7134: cleanup radio/video/empress ioctl handling
Date: Thu, 20 Jun 2013 15:44:19 +0200
Message-Id: <1371735871-2658-4-git-send-email-hverkuil@xs4all.nl>
...
+EXPORT_SYMBOL_GPL(saa7134_s_frequency);
 ...
 static int saa7134_enum_fmt_vid_cap(struct file *file, void  *priv,
 					struct v4l2_fmtdesc *f)
@@ -2075,34 +2071,6 @@ static int radio_s_tuner(struct file *file, void *priv,
 	return 0;
 }
...
-
 ...
 {
 	.owner	  = THIS_MODULE,
@@ -2166,11 +2134,7 @@ static const struct v4l2_file_operations radio_fops = {
