...
Received: from mx3.redhat.com (mx3.redhat.com [172.16.48.32])
	by int-mx1.corp.redhat.com (8.13.1/8.13.1) with ESMTP id m6JM8Oxk015556
	for <video4linux-list@redhat.com>; Sat, 19 Jul 2008 18:08:24 -0400
Received: from nf-out-0910.google.com (nf-out-0910.google.com [64.233.182.185])
	by mx3.redhat.com (8.13.8/8.13.8) with ESMTP id m6JM89G6016638
	for <video4linux-list@redhat.com>; Sat, 19 Jul 2008 18:08:09 -0400
Received: by nf-out-0910.google.com with SMTP id d3so295394nfc.21
	for <video4linux-list@redhat.com>; Sat, 19 Jul 2008 15:08:08 -0700 (PDT)
Message-ID: <412bdbff0807191508wcecc78ahf73b9b10595b392d@mail.gmail.com>
Date: Sat, 19 Jul 2008 18:08:07 -0400
...
On Sat, Jul 19, 2008 at 4:17 PM,  <interpont@interpont.hu> wrote:
>
>
> Hi,
>
...
The errors you are seeing is because some manufacturers use the Empia
chipset but don't bother to get their own USB vendor ID, leaving it as
Empia's default vendor.  Because of this, the driver doesn't know what
other chips are in your device.

>From the i2c scan it looks like the device is using a saa7113 decoder.
 We need to also know what tuner chip is used and what types of inputs
it supports (tuner, S-video, composite).

If you could pop the unit apart and take digital photos of both sides
of the PCB, we could identify the tuner and see what driver changes
are required to support the device in the v4l-dvb driver.
