...
Received: from galahad.ideasonboard.com ([185.26.127.97]:50586 "EHLO
        galahad.ideasonboard.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1751291AbdCAKTi (ORCPT
        <rfc822;linux-media@vger.kernel.org>); Wed, 1 Mar 2017 05:19:38 -0500
From: Laurent Pinchart <laurent.pinchart+renesas@ideasonboard.com>
To: linux-media@vger.kernel.org
Cc: linux-renesas-soc@vger.kernel.org,
        =?UTF-8?q?Niklas=20S=C3=B6derlund?= <niklas.soderlund@ragnatech.se>
Subject: [PATCH v3 3/8] v4l: vsp1: Support histogram generators in pipeline configuration
Date: Tue, 28 Feb 2017 17:56:43 +0200
Message-Id: <20170228155648.12051-4-laurent.pinchart+renesas@ideasonboard.com>
...
index 3f1acf68dc6e..1c74f86d1d43 100644
--- a/drivers/media/platform/vsp1/vsp1_pipe.c
+++ b/drivers/media/platform/vsp1/vsp1_pipe.c
@@ -246,6 +246,7 @@ bool vsp1_pipeline_stopped(struct vsp1_pipeline *pipe)
...
+	struct vsp1_device *vsp1 = pipe->output->entity.vsp1;
 	...
 	unsigned long flags;
 	int ret;
@@ -255,8 +256,7 @@ int vsp1_pipeline_stop(struct vsp1_pipeline *pipe)
...
@@ -276,7 +276,7 @@ int vsp1_pipeline_stop(struct vsp1_pipeline *pipe)
