...
Received: from mailout.easymail.ca ([64.68.200.34]:32789 "EHLO
        mailout.easymail.ca" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727499AbeJEDIs (ORCPT
        <rfc822;linux-media@vger.kernel.org>); Thu, 4 Oct 2018 23:08:48 -0400
Subject: Re: [PATCH 2/2] media: rc: self test for IR encoders and decoders
To: "Sean Young (by way of Mauro Carvalho Chehab
        <mchehab+samsung@kernel.org>)" <sean@mess.org>
...
Message-ID: <3ff03c90-a64a-fd28-7924-57f70417f51f@kernel.org>
Date: Thu, 4 Oct 2018 14:13:51 -0600
MIME-Version: 1.0
In-Reply-To: <20180717213306.22799-3-sean@mess.org>
