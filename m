...
Received: from mailout3.samsung.com ([203.254.224.33]:22699 "EHLO
	mailout3.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S932674Ab2GKODN (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 11 Jul 2012 10:03:13 -0400
Received: from epcpsbgm1.samsung.com (mailout3.samsung.com [203.254.224.33])
 ...
 linux-media@vger.kernel.org; Wed, 11 Jul 2012 23:03:12 +0900 (KST)
Received: from localhost.localdomain ([107.108.73.106])
 by mmp2.samsung.com (Oracle Communications Messaging Server 7u4-24.01
 (7.0.4.24.0) 64bit (built Nov 17 2011))
 with ESMTPA id <0M7000LFC1OYVM10@mmp2.samsung.com> for
 linux-media@vger.kernel.org; Wed, 11 Jul 2012 23:03:11 +0900 (KST)
...
Subject: [PATCH v1 2/2] [media] v4l: Add control definitions for new H264
 encoder features
Date: Wed, 11 Jul 2012 19:47:10 +0530
Message-id: <1342016230-14278-3-git-send-email-arun.kk@samsung.com>
...
index 676bc46..a25582a 100644
--- a/Documentation/DocBook/media/v4l/controls.xml
+++ b/Documentation/DocBook/media/v4l/controls.xml
@@ -1581,7 +1581,6 @@ frame counter of the frame that is currently displayed (decoded). This value is
...
@@ -2265,6 +2264,14 @@ Applicable to the MPEG1, MPEG2, MPEG4 encoders.</entry>
 	      </row>
...
+	      <row><entry></entry></row>
 		...
 		<entry>integer</entry>
@@ -2329,6 +2336,265 @@ Applicable to the MPEG4 decoder.</entry>
...
@@ -825,6 +865,8 @@ void v4l2_ctrl_fill(u32 id, const char **name, enum v4l2_ctrl_type *type,
...
index e23e6a7..4db4e7c 100644
--- a/include/linux/videodev2.h
+++ b/include/linux/videodev2.h
@@ -1614,6 +1614,7 @@ enum v4l2_mpeg_video_multi_slice_mode {
...
@@ -1704,6 +1705,46 @@ enum v4l2_mpeg_video_h264_vui_sar_idc {
