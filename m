...
Received: from ams-iport-1.cisco.com ([144.254.224.140]:29304 "EHLO
	...
	with ESMTP id S932627Ab2GEOgG (ORCPT
...
Subject: [RFCv1 PATCH 6/7] adv7604: driver for the Analog Devices ADV7604 video decoder.
Date: Thu,  5 Jul 2012 16:26:14 +0200
Message-Id: <6c895e6ac2a8271c1526e12aab6dca06c36f929f.1341497271.git.hans.verkuil@cisco.com>
...
---
 ...
 drivers/media/video/adv7604.c   | 1958 +++++++++++++++++++++++++++++++++++++++
...
index 99937c9..b5a40f3 100644
--- a/drivers/media/video/Kconfig
+++ b/drivers/media/video/Kconfig
@@ -283,6 +283,18 @@ config VIDEO_ADV7183
...
+
+	/* private controls */
+	state->detect_tx_5v_ctrl = v4l2_ctrl_new_std(hdl, &adv7604_ctrl_ops,
+			V4L2_CID_DV_RX_POWER_PRESENT, 0, 1, 0, 0);
+	state->detect_tx_5v_ctrl->is_private = true;
+	state->rgb_quantization_range_ctrl =
+		v4l2_ctrl_new_std_menu(hdl, &adv7604_ctrl_ops,
+			V4L2_CID_DV_RX_RGB_RANGE, V4L2_DV_RGB_RANGE_AUTO,
