...
Received: from wx-out-0506.google.com ([66.249.82.224])
	...
	(envelope-from <lucastim@gmail.com>) id 1Kcq4W-0005vf-Ax
	for linux-dvb@linuxtv.org; Tue, 09 Sep 2008 01:23:05 +0200
Received: by wx-out-0506.google.com with SMTP id t16so345344wxc.17
	for <linux-dvb@linuxtv.org>; Mon, 08 Sep 2008 16:22:59 -0700 (PDT)
Message-ID: <e32e0e5d0809081622j3472a684r2a2cb814aec25120@mail.gmail.com>
Date: Mon, 8 Sep 2008 16:22:58 -0700
From: "Tim Lucas" <lucastim@gmail.com>
To: "Steven Toth" <stoth@linuxtv.org>, "linux dvb" <linux-dvb@linuxtv.org>
In-Reply-To: <e32e0e5d0809061424t5ff14414pe5a2357b9b6f983@mail.gmail.com>
MIME-Version: 1.0
References: <e32e0e5d0809050731h17e18aeao786011bc8775e12c@mail.gmail.com>
	<e32e0e5d0809061424t5ff14414pe5a2357b9b6f983@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============1020096499=="
Mime-version: 1.0
...
Content-Type: multipart/alternative;
	boundary="----=_Part_12382_32145763.1220916178407"

------=_Part_12382_32145763.1220916178407
...
<div dir="ltr">On Fri, Sep 5, 2008 at 7:31 AM, Tim Lucas <span dir="ltr">&lt;<a href="mailto:lucastim@gmail.com" target="_blank">lucastim@gmail.com</a>&gt;</span> wrote:<br>
<div class="gmail_quote"><blockquote class="gmail_quote" style="border-left: 1px solid rgb(204, 204, 204); margin: 0pt 0pt 0pt 0.8ex; padding-left: 1ex;"><div dir="ltr"><div><div class="Wj3C7c"><div class="gmail_quote"><blockquote class="gmail_quote" style="border-left: 1px solid rgb(204, 204, 204); margin: 0pt 0pt 0pt 0.8ex; padding-left: 1ex;">
<div dir="ltr"><span style="border-collapse: collapse; font-family: Times; font-size: 16px;"><div><div><span style="font-family: arial; font-size: 13px;">&gt; Why doesn&#39;t the driver load if you force it with card=X? What does dmesg show?<br>


&gt;&nbsp;<br>&gt; - Steve</span><br></div><div><br></div></div><div><div>I followed your instructions&nbsp;<span style="font-family: Times; font-size: 16px;">modprobe cx23885 debug=1 says operation not permitted<br>Then I tried sudo&nbsp;</span><span style="font-family: Times; font-size: 16px;"><span style="font-family: Times; font-size: 16px;">modprobe cx23885 debug=1</span></span>&nbsp;and it says the process was killed<br>


</div></div><div>This is the output from dmeg.</div><div><div></div><div><div><br></div>589.243831] cx23885: no version for &quot;snd_pcm_new&quot; found: kernel tainted.<br>[&nbsp; 589.245284] cx23885 driver version 0.0.1 loaded<br>
...
</div></span></div></blockquote></div></div></div></div></blockquote><div><br>&gt; &gt; On Sat, Sep 6, 2008 at 2:24 PM, Tim Lucas <span dir="ltr">&lt;<a href="mailto:lucastim@gmail.com">lucastim@gmail.com</a>&gt;</span> wrote:<br>
&gt; &gt; Did you get this message? &nbsp;I didn&#39;t know if you or anyone else had any insight into this problem.<br>&nbsp;</div></div>I am still trying to resolve this issue.&nbsp; Loading the HVR1500 driver does not work.&nbsp; You can check the dmesg above and I think the problems start at the line<br>
<br><span style="border-collapse: collapse; font-family: Times; font-size: 16px;">[&nbsp; 589.382427] tveeprom 5-0050: Encountered bad packet header [ff]. Corrupt or not a Hauppauge eeprom.</span><br clear="all"><br>I would still like to try to get analog support working for my DViCO FusionHDTV7 Dual Express.&nbsp; This seemed like my best prospect.<br>
<br><br>-- <br> --Tim<br>
</div>
