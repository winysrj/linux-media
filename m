...
Received: from mail-wr1-f65.google.com ([209.85.221.65]:44441 "EHLO
        ...
        with ESMTP id S1727519AbeHJQvk (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Fri, 10 Aug 2018 12:51:40 -0400
Received: by mail-wr1-f65.google.com with SMTP id r16-v6so8439805wrt.11
        for <linux-media@vger.kernel.org>; Fri, 10 Aug 2018 07:21:30 -0700 (PDT)
...
Subject: [PATCH v7 00/12] media: staging/imx7: add i.MX7 media driver
Date: Fri, 10 Aug 2018 15:20:33 +0100
Message-Id: <20180810142045.27657-1-rui.silva@linaro.org>
...
Sub-Device ioctls (Source Pad 2):
	test Try VIDIOC_SUBDEV_ENUM_MBUS_CODE/FRAME_SIZE/FRAME_INTERVAL: OK (Not Supported)
		fail: v4l2-test-subdevs.cpp(370): s_fmt.format.width != fmt.format.width
...
Rui Miguel Silva (12):
 ...
 20 files changed, 3049 insertions(+), 122 deletions(-)
