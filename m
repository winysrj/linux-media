...
Received: from smtp-vbr1.xs4all.nl ([194.109.24.21]:4727 "EHLO
	smtp-vbr1.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S965153Ab3FTPPA (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 20 Jun 2013 11:15:00 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: Scott Jiang <scott.jiang.linux@gmail.com>
Subject: Re: [PATCH RFC v3] [media] blackfin: add video display device driver
Date: Thu, 20 Jun 2013 17:14:14 +0200
Cc: mchehab@redhat.com, s.nawrocki@samsung.com,
	linux-media@vger.kernel.org,
	uclinux-dist-devel@blackfin.uclinux.org
References: <1370382048-23480-1-git-send-email-scott.jiang.linux@gmail.com>
In-Reply-To: <1370382048-23480-1-git-send-email-scott.jiang.linux@gmail.com>
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="iso-8859-15"
Content-Transfer-Encoding: 7bit
Message-Id: <201306201714.14282.hverkuil@xs4all.nl>
...
On Tue June 4 2013 23:40:48 Scott Jiang wrote:
...
Drop this header, it's no longer needed. VIDIOC_DBG_G_CHIP_IDENT has been
superseded by VIDIOC_DBG_G_CHIP_INFO, which means that both the chip-ident
header and the g_chip_ident operation can be dropped.
...
pixfmt->priv should be set to 0 by the driver.
...
bus_info for platform devices should start with the "platform:" prefix.
So "platform:bfin_display" is a good name to use in this case.
