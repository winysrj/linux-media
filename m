...
Received: from lb1-smtp-cloud2.xs4all.net ([194.109.24.21]:34227 "EHLO
	lb1-smtp-cloud2.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1752593AbbFHKoI (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 8 Jun 2015 06:44:08 -0400
Message-ID: <557571F0.90109@xs4all.nl>
Date: Mon, 08 Jun 2015 12:44:00 +0200
...
Subject: Re: [RFC PATCH] v4l2-dv-timings: add support for reduced blanking
 v2
References: <1433494358-29050-1-git-send-email-prladdha@cisco.com> <1433494358-29050-2-git-send-email-prladdha@cisco.com>
