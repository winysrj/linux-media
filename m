...
Received: from mailout-de.gmx.net ([213.165.64.22]:54823 "HELO
	mailout-de.gmx.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with SMTP id S1755599Ab2CTWOq (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 20 Mar 2012 18:14:46 -0400
From: "Hans-Frieder Vogt" <hfvogt@gmx.net>
To: linux-media@vger.kernel.org
Subject: [PATCH] v0.3 Support for tuner FC0012
Date: Tue, 20 Mar 2012 23:14:35 +0100
Cc: Mauro Carvalho Chehab <mchehab@redhat.com>
References: <201202222321.35533.hfvogt@gmx.net> <4F67CED1.407@redhat.com>
In-Reply-To: <4F67CED1.407@redhat.com>
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="us-ascii"
Content-Transfer-Encoding: 7bit
Message-Id: <201203202314.35920.hfvogt@gmx.net>
Sender: linux-media-owner@vger.kernel.org
List-ID: <linux-media.vger.kernel.org>

Support for tuner Fitipower FC0012, revised version 0.3. This primarily addresses comments in particular from Mauro 
(removal of #include <linux/version.h>, replacement of potentially large static field in fc0012_writeregs). The patch is 
...
Signed-off-by: Hans-Frieder Vogt <hfvogt@gmx.net>
 ...
 drivers/media/common/tuners/fc0012-priv.h |   50 +++
 drivers/media/common/tuners/fc0012.c      |  391 ++++++++++++++++++++++++++++++
...
+++ b/drivers/media/common/tuners/fc0012.c	2012-03-20 22:11:39.807043991 +0100
@@ -0,0 +1,391 @@
+/*
...
+	reg[0] = 0x01;
+	ret = fc0012_writeregs(priv, reg, sizeof(reg));
+
+	if (ret)
+		deb_info("%s: failed:%d\n", __func__, ret);
+
...
+	reg[5] |= 0x07;
+
+	/* write registers 1 to 6
+	   start with register 1 */
+	reg[0] = 1;
+	ret = fc0012_writeregs(priv, reg, 7);
+	if (ret)
+		goto error_out;
+
+	/* VCO Calibration */
...
+++ b/drivers/media/common/tuners/Kconfig	2012-03-20 22:14:32.859173127 +0100
...
+++ b/drivers/media/common/tuners/Makefile	2012-03-20 22:15:26.718822278 +0100
