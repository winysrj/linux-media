...
Received: from mail962c35.nsolutionszone.com ([209.235.152.152])
	...
	(envelope-from <ebauer71@centurytel.net>) id 1LJZqA-0004a0-3x
	for linux-dvb@linuxtv.org; Sun, 04 Jan 2009 21:44:56 +0100
Message-ID: <49611FB9.2080409@centurytel.net>
Date: Sun, 04 Jan 2009 14:44:41 -0600
...
Content-Type: multipart/mixed; boundary="===============1800375268=="
Mime-version: 1.0
...
Content-Type: multipart/alternative;
 boundary="------------010705020908040708050702"

This is a multi-part message in MIME format.
--------------010705020908040708050702
...
<a class="moz-txt-link-freetext" href="http://linuxtv.og/hg/v4l-dvb">http://linuxtv.og/hg/v4l-dvb</a>
...
<a class="moz-txt-link-freetext" href="http://www.ivtvdriver.org/index.php/Cx18">http://www.ivtvdriver.org/index.php/Cx18</a>


Make sure you have a good clean signal coming in:

<a class="moz-txt-link-freetext" href="http://www.ivtvdriver.org/index.php/Howto:Improve_signal_quality">http://www.ivtvdriver.org/index.php/Howto:Improve_signal_quality</a>
