...
Received: from smtp-vbr10.xs4all.nl ([194.109.24.30]:2542 "EHLO
	smtp-vbr10.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752978Ab2EEKzq convert rfc822-to-8bit (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Sat, 5 May 2012 06:55:46 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: Sakari Ailus <sakari.ailus@iki.fi>
Subject: Re: [PATCH 1/1] v4l2: use __u32 rather than enums in ioctl() structs
Date: Sat, 5 May 2012 12:55:01 +0200
Cc: linux-kernel@vger.kernel.org, linux-media@vger.kernel.org,
	mchehab@redhat.com, remi@remlab.net
References: <1336213545-8549-1-git-send-email-sakari.ailus@iki.fi>
In-Reply-To: <1336213545-8549-1-git-send-email-sakari.ailus@iki.fi>
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="iso-8859-1"
Content-Transfer-Encoding: 8BIT
Message-Id: <201205051255.01321.hverkuil@xs4all.nl>
