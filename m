...
Received: from aer-iport-1.cisco.com ([173.38.203.51]:20676 "EHLO
	aer-iport-1.cisco.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S933353AbcCROQy (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 18 Mar 2016 10:16:54 -0400
From: Hans Verkuil <hans.verkuil@cisco.com>
To: linux-media@vger.kernel.org
Cc: dri-devel@lists.freedesktop.org, linux-samsung-soc@vger.kernel.org,
	linux-input@vger.kernel.org, lars@opdenkamp.eu,
	linux@arm.linux.org.uk, Hans Verkuil <hans.verkuil@cisco.com>
Subject: [PATCHv13 13/17] cec: adv7842: add cec support
Date: Fri, 18 Mar 2016 15:07:12 +0100
Message-Id: <1458310036-19252-14-git-send-email-hans.verkuil@cisco.com>
...
@@ -816,24 +807,30 @@ static int edid_write_hdmi_segment(struct v4l2_subdev *sd, u8 port)
...
@@ -2170,6 +2163,196 @@ static void adv7842_irq_enable(struct v4l2_subdev *sd, bool enable)
 	}
 }
...
+
 ...
 {
 	struct adv7842_state *state = to_state(sd);
@@ -2241,6 +2424,9 @@ static int adv7842_isr(struct v4l2_subdev *sd, u32 status, bool *handled)
 			*handled = true;
 	}
...
@@ -2321,10 +2507,12 @@ static int adv7842_set_edid(struct v4l2_subdev *sd, struct v4l2_edid *e)
...
@@ -3061,6 +3260,13 @@ static const struct v4l2_subdev_video_ops adv7842_video_ops = {
