...
Received: from mailout2.samsung.com ([203.254.224.25]:33027 "EHLO
	mailout2.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1760077AbbIWFI1 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 23 Sep 2015 01:08:27 -0400
Received: from epcpsbgr2.samsung.com
 (u142.gpu120.samsung.co.kr [203.254.230.142])
 by mailout2.samsung.com (Oracle Communications Messaging Server 7.0.5.31.0
 64bit (built May  5 2014))
 with ESMTP id <0NV4006W56A0B160@mailout2.samsung.com> for
 linux-media@vger.kernel.org; Wed, 23 Sep 2015 14:08:24 +0900 (KST)
Message-id: <560233C8.6080806@samsung.com>
Date: Wed, 23 Sep 2015 14:08:24 +0900
...
References: <1442928636-3589-1-git-send-email-jh1009.sung@samsung.com>
 <56016F17.2070007@xs4all.nl>
In-reply-to: <56016F17.2070007@xs4all.nl>
Content-type: multipart/mixed; boundary=------------040506060507040904000906
Sender: linux-media-owner@vger.kernel.org
List-ID: <linux-media.vger.kernel.org>

This is a multi-part message in MIME format.
--------------040506060507040904000906
...
Content-Type: text/x-patch;
 name="0001-media-videobuf2-fix-build-errors.patch"
Content-Transfer-Encoding: 7bit
Content-Disposition: attachment;
 filename="0001-media-videobuf2-fix-build-errors.patch"

>From 3afc926a7b5af8e4ada9b9e2933c7035093880c0 Mon Sep 17 00:00:00 2001
From: Junghak Sung <jh1009.sung@samsung.com>
Date: Wed, 23 Sep 2015 11:27:01 +0900
Subject: [PATCH] media: videobuf2: fix build errors

temporarily patch to fix build errors
...
index cca487b..83f102e 100644
--- a/drivers/media/pci/sta2x11/sta2x11_vip.c
+++ b/drivers/media/pci/sta2x11/sta2x11_vip.c
@@ -92,7 +92,7 @@ struct vip_buffer {
...
@@ -287,7 +287,8 @@ static int queue_setup(struct vb2_queue *vq, const struct vb2_format *fmt,
 };
...
@@ -308,7 +311,7 @@ static void process_progressive_mode(struct common_obj *common)
