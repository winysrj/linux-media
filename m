...
Received: from mailout1.samsung.com ([203.254.224.24]:26208 "EHLO
	mailout1.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753442Ab2HaNuw (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 31 Aug 2012 09:50:52 -0400
Received: from epcpsbgm2.samsung.com (epcpsbgm2 [203.254.230.27])
 by mailout1.samsung.com
 (Oracle Communications Messaging Server 7u4-24.01(7.0.4.24.0) 64bit (built Nov
 17 2011)) with ESMTP id <0M9M00N10GP73Y70@mailout1.samsung.com> for
 linux-media@vger.kernel.org; Fri, 31 Aug 2012 22:50:50 +0900 (KST)
...
Message-id: <1346432862-14242-7-git-send-email-arun.kk@samsung.com>
...
+
 	dev->mem_dev_r = device_find_child(&dev->plat_dev->dev, "s5p-mfc-r",
 					   match_child);
 	if (!dev->mem_dev_r) {
@@ -1226,12 +1247,47 @@ static struct s5p_mfc_variant mfc_drvdata_v5 = {
