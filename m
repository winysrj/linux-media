...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id AAB5AC43381
	for <linux-media@archiver.kernel.org>; Sun, 24 Feb 2019 09:03:13 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id 6B62E20652
	for <linux-media@archiver.kernel.org>; Sun, 24 Feb 2019 09:03:13 +0000 (UTC)
Authentication-Results: mail.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="ZqNnQxrs"
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728217AbfBXJDM (ORCPT <rfc822;linux-media@archiver.kernel.org>);
        Sun, 24 Feb 2019 04:03:12 -0500
Received: from mail-wr1-f67.google.com ([209.85.221.67]:44144 "EHLO
        mail-wr1-f67.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728213AbfBXJDM (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Sun, 24 Feb 2019 04:03:12 -0500
Received: by mail-wr1-f67.google.com with SMTP id w2so6640835wrt.11
        for <linux-media@vger.kernel.org>; Sun, 24 Feb 2019 01:03:10 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=0n0JOcVgHUmh7iUAz/fGEYYbpPvEjaTVNYnApm8HpcI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=0n0JOcVgHUmh7iUAz/fGEYYbpPvEjaTVNYnApm8HpcI=;
        b=
X-Gm-Message-State: AHQUAubiRkfMFWncJQP50CFDzxKSM8bbq5cGwpeGgX72woaAvbNMwJqK
        vpVhShyvpUqirZafDLQwEEcAwT166tI=
X-Google-Smtp-Source: AHgI3IZSsLMvtDsJKj1kYASfDRb/cj3YgVxlLVvmvvmxjR0g838VXgsLh6+jaQj7lQXnFmA0QfLM1g==
X-Received: by 2002:adf:fc12:: with SMTP id i18mr8571116wrr.201.1550998989508;
        Sun, 24 Feb 2019 01:03:09 -0800 (PST)
Received: from ubuntu.home ([77.127.107.32])
        by smtp.gmail.com with ESMTPSA id e75sm8701971wmg.32.2019.02.24.01.03.08
...
Subject: [PATCH v3 14/18] media: vicodec: add struct for encoder/decoder instance
Date:   Sun, 24 Feb 2019 01:02:31 -0800
Message-Id: <20190224090234.19723-15-dafna3@gmail.com>
...
index d20e829274ae..2b71b723862a 100644
