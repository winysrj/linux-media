...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id EC5E9C65BAE
	for <linux-media@archiver.kernel.org>; Thu, 13 Dec 2018 18:01:25 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id 9DB2E20870
	for <linux-media@archiver.kernel.org>; Thu, 13 Dec 2018 18:01:25 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=default; t=1544724085;
	bh=v/OU2Lf0KzAgrkchfm7MR6T9kvAcE5qQiwLaojyYOBs=;
	h=Date:From:To:Cc:Subject:In-Reply-To:References:List-ID:From;
	b=fHmnxvyxdlKl6/yfwWmRd/CtoS/Bwq/UH64WQR/pHLbVBcntZmzwQ0QrKLG6t89YJ
	 WS9O/8+kbMptg/VVtcC1meu485mng6O5416rj4qLM8Y3pleILwk7uBRWJ+fE9Y/Jwl
	 zC1x5XWWwi8KKQi7f/8oJM/6grVZ6uSLtRjK+fTE=
DMARC-Filter: OpenDMARC Filter v1.3.2 mail.kernel.org 9DB2E20870
Authentication-Results: mail.kernel.org; dmarc=fail (p=none dis=none) header.from=kernel.org
Authentication-Results: mail.kernel.org; spf=none smtp.mailfrom=linux-media-owner@vger.kernel.org
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729272AbeLMSBY (ORCPT <rfc822;linux-media@archiver.kernel.org>);
        Thu, 13 Dec 2018 13:01:24 -0500
Received: from casper.infradead.org ([85.118.1.10]:38368 "EHLO
        casper.infradead.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727815AbeLMSBY (ORCPT
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        ...
        bh=WpI/snh6OUQ1Y1q+3f9uCplucDRNbJGQp/BBhdAkJCI=; b=MzgDlkLaOBH7sGHYzZVPdZaXjq
        ;
Received: from 177.43.150.95.dynamic.adsl.gvt.net.br ([177.43.150.95] helo=coco.lan)
        by casper.infradead.org with esmtpsa (Exim 4.90_1 #2 (Red Hat Linux))
        id 1gXVIY-0004eO-Bx; Thu, 13 Dec 2018 18:01:22 +0000
Date:   Thu, 13 Dec 2018 16:01:18 -0200
From:   Mauro Carvalho Chehab <mchehab+samsung@kernel.org>
To:     Hans Verkuil <hverkuil-cisco@xs4all.nl>
Cc:     linux-media@vger.kernel.org
Subject: Re: [RFCv5 PATCH 2/4] media controller: add properties support
Message-ID: <20181213160118.79c60eb1@coco.lan>
...
References: <20181213134113.15247-1-hverkuil-cisco@xs4all.nl>
        ...
        <94fd2d33-7888-d2c9-019a-81d765ae5c81@xs4all.nl>
