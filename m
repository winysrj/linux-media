...
Received: from mail-in-06.arcor-online.net ([151.189.21.46]:40939 "EHLO
	mail-in-06.arcor-online.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1753802Ab0BVQWY (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 22 Feb 2010 11:22:24 -0500
From: stefan.ringel@arcor.de
To: linux-media@vger.kernel.org
Cc: mchehab@redhat.com, dheitmueller@kernellabs.com,
	Stefan Ringel <stefan.ringel@arcor.de>
Subject: [PATCH 3/3] tm6000: bugfix i2c addr
Date: Mon, 22 Feb 2010 17:21:33 +0100
Message-Id: <1266855693-5554-3-git-send-email-stefan.ringel@arcor.de>
In-Reply-To: <1266855693-5554-2-git-send-email-stefan.ringel@arcor.de>
References: <1266855693-5554-1-git-send-email-stefan.ringel@arcor.de>
 <1266855693-5554-2-git-send-email-stefan.ringel@arcor.de>
