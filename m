...
Received: from lb3-smtp-cloud8.xs4all.net ([194.109.24.29]:56653 "EHLO
        lb3-smtp-cloud8.xs4all.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726961AbeICMvy (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Mon, 3 Sep 2018 08:51:54 -0400
Subject: Re: [PATCH v8 1/8] media: v4l: Add definitions for MPEG2 slice format
 and metadata
...
Message-ID: <d85861e6-c3ff-d3c2-e42b-88d6181fd5cf@xs4all.nl>
Date: Mon, 3 Sep 2018 10:32:35 +0200
MIME-Version: 1.0
In-Reply-To: <20180828073424.30247-2-paul.kocialkowski@bootlin.com>
...
Use references to the corresponding sections in the spec so the reader can just
click on the link.
