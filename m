...
Received: from mga02.intel.com ([134.134.136.20]:31729 "EHLO mga02.intel.com"
	...
	id S932266AbbBZO0o (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Thu, 26 Feb 2015 09:26:44 -0500
Date: Thu, 26 Feb 2015 22:26:03 +0800
From: kbuild test robot <fengguang.wu@intel.com>
To: Mauro Carvalho Chehab <m.chehab@samsung.com>
Cc: kbuild-all@01.org, linux-media@vger.kernel.org
Subject: [linuxtv-media:master 372/374]
 drivers/media/usb/dvb-usb-v2/dvb_usb_core.c:531:25: warning: unused variable
 'd'
Message-ID: <201502262202.XwkLx9J1%fengguang.wu@intel.com>
MIME-Version: 1.0
...
commit: 823b460ee76d0e4e1a9d50e7c1d4aebc0e9e467b [372/374] [media] dvb-usb-v2: create one media_dev per adapter
config: x86_64-allmodconfig (attached as .config)
reproduce:
  git checkout 823b460ee76d0e4e1a9d50e7c1d4aebc0e9e467b
...
vim +/d +531 drivers/media/usb/dvb-usb-v2/dvb_usb_core.c

41a0abf7 drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-19  515  
41a0abf7 drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-19  516  	return 0;
831511bd drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-20  517  err_dvb_net_init:
41a0abf7 drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-19  518  	dvb_dmxdev_release(&adap->dmxdev);
831511bd drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-20  519  err_dvb_dmxdev_init:
41a0abf7 drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-19  520  	dvb_dmx_release(&adap->demux);
831511bd drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-20  521  err_dvb_dmx_init:
823b460e drivers/media/usb/dvb-usb-v2/dvb_usb_core.c Mauro Carvalho Chehab          2015-02-25  522  	dvb_usbv2_media_device_unregister(adap);
41a0abf7 drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-19  523  	dvb_unregister_adapter(&adap->dvb_adap);
831511bd drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-20  524  err_dvb_register_adapter:
41a0abf7 drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-19  525  	adap->dvb_adap.priv = NULL;
41a0abf7 drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-19  526  	return ret;
41a0abf7 drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-19  527  }
41a0abf7 drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-19  528  
691a5502 drivers/media/usb/dvb-usb-v2/dvb_usb_core.c Mauro Carvalho Chehab          2012-10-27  529  static int dvb_usbv2_adapter_dvb_exit(struct dvb_usb_adapter *adap)
41a0abf7 drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-19  530  {
6f6c77d8 drivers/media/usb/dvb-usb-v2/dvb_usb_core.c Rafael Lourenço de Lima Chehab 2015-02-12 @531  	struct dvb_usb_device *d = adap_to_d(adap);
6f6c77d8 drivers/media/usb/dvb-usb-v2/dvb_usb_core.c Rafael Lourenço de Lima Chehab 2015-02-12  532  
d10d1b9a drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-26  533  	dev_dbg(&adap_to_d(adap)->udev->dev, "%s: adap=%d\n", __func__,
d10d1b9a drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-26  534  			adap->id);
41a0abf7 drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-19  535  
41a0abf7 drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-19  536  	if (adap->dvb_adap.priv) {
41a0abf7 drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-19  537  		dvb_net_release(&adap->dvb_net);
41a0abf7 drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-19  538  		adap->demux.dmx.close(&adap->demux.dmx);
41a0abf7 drivers/media/dvb/dvb-usb/dvb_usb_core.c    Antti Palosaari                2012-06-19  539  		dvb_dmxdev_release(&adap->dmxdev);

:::::: The code at line 531 was first introduced by commit
:::::: 6f6c77d8d2e2fc77395d6bb9ed670161f18b6bd4 [media] dvb-usb-v2: add support for the media controller at USB driver

:::::: TO: Rafael Lourenço de Lima Chehab <chehabrafael@gmail.com>
