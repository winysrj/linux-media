...
Received: from mailrelay117.isp.belgacom.be ([195.238.20.144]:27092 "EHLO
	mailrelay117.isp.belgacom.be" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1751105AbcHFUEK (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sat, 6 Aug 2016 16:04:10 -0400
From: "Gerard H. Pille" <g.h.p@skynet.be>
To: linux-media@vger.kernel.org
Cc: "Gerard H. Pille" <g.h.p@skynet.be>
Subject: [PATCH] This patch allows the Terratec Cinergy HTC Stick HD (0ccb:0101) to be used to watch DVB-T.
Date: Sat,  6 Aug 2016 17:03:28 +0200
Message-Id: <1470495808-7250-1-git-send-email-g.h.p@skynet.be>
