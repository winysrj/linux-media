...
Received: from lb1-smtp-cloud9.xs4all.net ([194.109.24.22]:42858 "EHLO
        lb1-smtp-cloud9.xs4all.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1728609AbeKOUoP (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Thu, 15 Nov 2018 15:44:15 -0500
...
Message-ID: <fc531f42-9d87-8dcc-eb3a-e62085ff08e3@xs4all.nl>
Date: Thu, 15 Nov 2018 11:36:53 +0100
MIME-Version: 1.0
...
:ref:`VIDIOC_REQBUFS` can only succeed if the ``V4L2_BUF_CAP_SUPPORTS_ORPHANED_BUFS``
capability is set. Otherwise :ref:`VIDIOC_REQBUFS` will return the ``EBUSY`` error code.

If ``V4L2_BUF_CAP_SUPPORTS_ORPHANED_BUFS`` is set, then these buffers are orphaned
and will be freed when they are unmapped or when the exported DMABUF fds are closed.
