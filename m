...
Received: from mailout3.w1.samsung.com ([210.118.77.13]:8478 "EHLO
	mailout3.w1.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1754289Ab0LQNTT (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 17 Dec 2010 08:19:19 -0500
MIME-version: 1.0
Content-transfer-encoding: 7BIT
Content-type: text/plain; charset=ISO-8859-1
Date: Fri, 17 Dec 2010 14:19:15 +0100
From: Sylwester Nawrocki <s.nawrocki@samsung.com>
Subject: Re: [PATCH] [media] s5p-fimc: fix main scaler SFRs depends on FIMC
 version
...
Message-id: <4D0B6353.4000403@samsung.com>
...
Please add a short description for this new field, e.g.

@has_mainscaler_ext: 1 if the extended main scaler ratios register is available
...
x need to be enclosed in brackets. Also the names are getting long,
so although we have S5P_CISCCTRL_SC_HORRATIO and S5P_CISCCTRL_SC_VERRATIO,
how about?

+#define S5P_CISCCTRL_SC_HRATIO_MASK	(0x1ff << 16)
+#define S5P_CISCCTRL_SC_VRATIO_MASK	(0x1ff << 0)
+#define S5P_CISCCTRL_SC_HRATIO_EXT(x)	(((x) >> 6) << 16)
+#define S5P_CISCCTRL_SC_VRATIO_EXT(x)	(((x) >> 6) << 0)
...
No need to enclose 0x3f in brackets. How about:
...
Please also consider Kyungmin's remarks about negations in conditional
expressions, it's also my preference.
