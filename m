...
Received: from eastrmmtao101.cox.net ([68.230.240.7]:62826 "EHLO
	eastrmmtao101.cox.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1756993AbZHNT1f (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 14 Aug 2009 15:27:35 -0400
Received: from eastrmimpo02.cox.net ([68.1.16.120])
          ...
          id <20090814190118.DTCA6358.eastrmmtao101.cox.net@eastrmimpo02.cox.net>
          for <linux-media@vger.kernel.org>;
          Fri, 14 Aug 2009 15:01:18 -0400
Message-ID: <7AD95D0006B94C7B8BB06781842AA6BC@flipsideprime>
From: "Kevin Smith" <flipside@cox.net>
To: <linux-media@vger.kernel.org>
Subject: Fw: error in compiled v4l cx88_alsa
Date: Fri, 14 Aug 2009 14:01:17 -0500
MIME-Version: 1.0
...
> cannot get sound working in compiled modules as follows.  Sound in DVB 
> works just not v4l (tvtime/myth) - thanks
>
> using
> v4l-dvb-0db4331fd64a modules and kernel 2.6.29
...
> Aug  7 18:11:42 flipside pulseaudio[4278]: alsa-source.c: ALSA woke us up 
...
> Aug  7 18:10:50 flipside kernel: IRQ 16/cx88[0]: IRQF_DISABLED is not 
> guaranteed on shared IRQs
> Aug  7 18:10:50 flipside kernel: cx88[0]/0: registered device video0 
> [v4l2]
