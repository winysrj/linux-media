...
Received: from nblzone-211-213.nblnetworks.fi ([83.145.211.213]:39771 "EHLO
	...
	by vger.kernel.org with ESMTP id S1752473AbbK2TWr (ORCPT
...
Subject: [PATCH v2 19/22] staging: v4l: omap4iss: Use the new media_entity_graph_walk_start() interface
Date: Sun, 29 Nov 2015 21:20:20 +0200
Message-Id: <1448824823-10372-20-git-send-email-sakari.ailus@iki.fi>
