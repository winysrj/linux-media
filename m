...
Received: from smtp.nokia.com ([192.100.122.230]:43981 "EHLO
	mgw-mx03.nokia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S932160Ab0GTLQe (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 20 Jul 2010 07:16:34 -0400
From: "Matti J. Aaltonen" <matti.j.aaltonen@nokia.com>
To: linux-media@vger.kernel.org, hverkuil@xs4all.nl,
	eduardo.valentin@nokia.com, mchehab@redhat.com
Cc: "Matti J. Aaltonen" <matti.j.aaltonen@nokia.com>
Subject: [PATCH v6 4/5] V4L2: WL1273 FM Radio: Controls for the FM radio.
Date: Tue, 20 Jul 2010 14:16:01 +0300
Message-Id: <1279624562-14125-5-git-send-email-matti.j.aaltonen@nokia.com>
In-Reply-To: <1279624562-14125-4-git-send-email-matti.j.aaltonen@nokia.com>
...
index 9da0e50..e086210 100644
--- a/drivers/mfd/Kconfig
+++ b/drivers/mfd/Kconfig
@@ -188,6 +188,12 @@ config MFD_TC35892
...
index fb503e7..c236366 100644
--- a/drivers/mfd/Makefile
+++ b/drivers/mfd/Makefile
@@ -37,6 +37,8 @@ obj-$(CONFIG_TWL4030_CORE)	+= twl-core.o twl4030-irq.o twl6030-irq.o
