...
Received: from mail-pw0-f42.google.com ([209.85.160.42]:39262 "EHLO
	mail-pw0-f42.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753982AbZLTAV4 convert rfc822-to-8bit (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sat, 19 Dec 2009 19:21:56 -0500
Received: by pwj9 with SMTP id 9so2574454pwj.21
        for <linux-media@vger.kernel.org>; Sat, 19 Dec 2009 16:21:56 -0800 (PST)
MIME-Version: 1.0
In-Reply-To: <1261156068-25869-1-git-send-email-santiago.nunez@ridgerun.com>
References: <1261156068-25869-1-git-send-email-santiago.nunez@ridgerun.com>
Date: Sun, 20 Dec 2009 03:21:55 +0300
Message-ID: <208cbae30912191621t660da273mb8e10c3a4117e42b@mail.gmail.com>
Subject: Re: [PATCH 3/4 v13] TVP7002 driver for DM365
...
On Fri, Dec 18, 2009 at 8:07 PM,  <santiago.nunez@ridgerun.com> wrote:
...
It can also return -EPERM. (after if (!capable(CAP_SYS_ADMIN)) ). Right?
...
It also can return -EIO (after i2c_check_functionality() )
...
I'm sorry, maybe i miss something but why you don't free memory after
tvp7002_write(),  tvp7002_write_inittab(), tvp7002_read() on error
paths?
...
This comment looks strange. Do you really return something after
tvp7002_exit()? Looks like it will return void on failure and success.
