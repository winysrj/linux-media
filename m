...
Received: from mga01.intel.com ([192.55.52.88]:60528 "EHLO mga01.intel.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1752631AbbHULvb (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Fri, 21 Aug 2015 07:51:31 -0400
Date: Fri, 21 Aug 2015 19:54:34 +0800
From: kbuild test robot <fengguang.wu@intel.com>
To: Geert Uytterhoeven <geert@linux-m68k.org>
Cc: kbuild-all@01.org, Mauro Carvalho Chehab <m.chehab@samsung.com>,
	linux-media@vger.kernel.org
Subject: [linux-next:master 7079/10086]
...
Message-ID: <201508211930.bz91zNW6%fengguang.wu@intel.com>
MIME-Version: 1.0
...
commit: 6df34051d8bd8807c873e1bb92b905e370ff3f5b [7079/10086] [media] dvb-frontends: Make all DVB Frontends visible if COMPILE_TEST=y
...
All warnings (new ones prefixed by >>):
   ...
   include/linux/dynamic_debug.h:64:16: warning: format '%zu' expects argument of type 'size_t', but argument 4 has type 'unsigned int' [-Wformat=]
   ...
   include/linux/printk.h:283:2: note: in expansion of macro 'dynamic_pr_debug'
     ...
     ^
>> drivers/media/dvb-frontends/or51211.c:49:18: note: in expansion of macro 'pr_debug'
     do { if (debug) pr_debug(args); } while (0)
                     ^
>> drivers/media/dvb-frontends/or51211.c:114:2: note: in expansion of macro 'dprintk'
     dprintk("Firmware is %zu bytes\n", fw->size);
     ^
--
   drivers/media/dvb-frontends/or51132.c: In function 'or51132_load_firmware':
>> drivers/media/dvb-frontends/or51132.c:140:2: warning: format '%Zd' expects argument of type 'signed size_t', but argument 2 has type 'size_t' [-Wformat=]
...
--
   ...
   include/linux/dynamic_debug.h:64:16: warning: format '%zu' expects argument of type 'size_t', but argument 6 has type 'unsigned int' [-Wformat=]
     static struct _ddebug  __aligned(8)   \
                   ^
   ...
   include/linux/device.h:1146:2: note: in expansion of macro 'dynamic_dev_dbg'
     ...
     ^
>> drivers/media/dvb-frontends/cx24117.c:562:2: note: in expansion of macro 'dev_dbg'
     dev_dbg(&state->priv->i2c->dev,
     ^

vim +140 drivers/media/dvb-frontends/or51132.c

d9e54324 drivers/media/dvb/frontends/or51132.c Trent Piepho        2007-03-02  124  	if ((err = i2c_transfer(state->i2c, msg, 2)) != 2) {
d9e54324 drivers/media/dvb/frontends/or51132.c Trent Piepho        2007-03-02  125  		printk(KERN_WARNING "or51132: I2C error reading register %d: %d\n",
d9e54324 drivers/media/dvb/frontends/or51132.c Trent Piepho        2007-03-02  126  		       reg, err);
d9e54324 drivers/media/dvb/frontends/or51132.c Trent Piepho        2007-03-02  127  		return -EREMOTEIO;
d9e54324 drivers/media/dvb/frontends/or51132.c Trent Piepho        2007-03-02  128  	}
18dcd55a drivers/media/dvb/frontends/or51132.c Al Viro             2008-05-21  129  	return buf[0] | (buf[1] << 8);
d9e54324 drivers/media/dvb/frontends/or51132.c Trent Piepho        2007-03-02  130  }
d9e54324 drivers/media/dvb/frontends/or51132.c Trent Piepho        2007-03-02  131  
^1da177e drivers/media/dvb/frontends/or51132.c Linus Torvalds      2005-04-16  132  static int or51132_load_firmware (struct dvb_frontend* fe, const struct firmware *fw)
^1da177e drivers/media/dvb/frontends/or51132.c Linus Torvalds      2005-04-16  133  {
b8742700 drivers/media/dvb/frontends/or51132.c Johannes Stezenbach 2005-05-16  134  	struct or51132_state* state = fe->demodulator_priv;
cbfa6f2a drivers/media/dvb/frontends/or51132.c Tobias Klauser      2008-04-21  135  	static const u8 run_buf[] = {0x7F,0x01};
0ead0918 drivers/media/dvb/frontends/or51132.c Trent Piepho        2006-04-02  136  	u8 rec_buf[8];
^1da177e drivers/media/dvb/frontends/or51132.c Linus Torvalds      2005-04-16  137  	u32 firmwareAsize, firmwareBsize;
^1da177e drivers/media/dvb/frontends/or51132.c Linus Torvalds      2005-04-16  138  	int i,ret;
^1da177e drivers/media/dvb/frontends/or51132.c Linus Torvalds      2005-04-16  139  
^1da177e drivers/media/dvb/frontends/or51132.c Linus Torvalds      2005-04-16 @140  	dprintk("Firmware is %Zd bytes\n",fw->size);
^1da177e drivers/media/dvb/frontends/or51132.c Linus Torvalds      2005-04-16  141  
^1da177e drivers/media/dvb/frontends/or51132.c Linus Torvalds      2005-04-16  142  	/* Get size of firmware A and B */
18dcd55a drivers/media/dvb/frontends/or51132.c Al Viro             2008-05-21  143  	firmwareAsize = le32_to_cpu(*((__le32*)fw->data));
^1da177e drivers/media/dvb/frontends/or51132.c Linus Torvalds      2005-04-16  144  	dprintk("FirmwareA is %i bytes\n",firmwareAsize);
18dcd55a drivers/media/dvb/frontends/or51132.c Al Viro             2008-05-21  145  	firmwareBsize = le32_to_cpu(*((__le32*)(fw->data+4)));
^1da177e drivers/media/dvb/frontends/or51132.c Linus Torvalds      2005-04-16  146  	dprintk("FirmwareB is %i bytes\n",firmwareBsize);
^1da177e drivers/media/dvb/frontends/or51132.c Linus Torvalds      2005-04-16  147  
^1da177e drivers/media/dvb/frontends/or51132.c Linus Torvalds      2005-04-16  148  	/* Upload firmware */
