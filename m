...
Received: from mx07-00178001.pphosted.com ([62.209.51.94]:39979 "EHLO
        mx07-00178001.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S933300AbcH2NWG (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Mon, 29 Aug 2016 09:22:06 -0400
...
Subject: [PATCH v5 3/3] st-hva: add H.264 video encoding support
Date: Mon, 29 Aug 2016 15:21:08 +0200
Message-ID: <1472476868-10322-4-git-send-email-jean-christophe.trotin@st.com>
...
---
 ...
 4 files changed, 1189 insertions(+), 7 deletions(-)
...
@@ -598,6 +600,49 @@ static int hva_s_ctrl(struct v4l2_ctrl *ctrl)
...
+		break;
 	default:
 		dev_dbg(dev, "%s S_CTRL: invalid control (id = %d)\n",
 			ctx->name, ctrl->id);
@@ -616,8 +661,10 @@ static int hva_ctrls_setup(struct hva_ctx *ctx)
 {
...
@@ -640,6 +687,66 @@ static int hva_ctrls_setup(struct hva_ctx *ctx)
 			       mask,
