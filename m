...
Received: from mga02.intel.com ([134.134.136.20]:64927 "EHLO mga02.intel.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S933814AbbFJThv (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Wed, 10 Jun 2015 15:37:51 -0400
Date: Thu, 11 Jun 2015 03:36:34 +0800
From: kbuild test robot <fengguang.wu@intel.com>
To: David Howells <dhowells@redhat.com>
Cc: kbuild-all@01.org, Mauro Carvalho Chehab <m.chehab@samsung.com>,
	linux-media@vger.kernel.org, Antti Palosaari <crope@iki.fi>
Subject: [linuxtv-media:master 1248/1267] ts2020.c:undefined reference to
 `__divdi3'
Message-ID: <201506110322.H1gxIdiN%fengguang.wu@intel.com>
MIME-Version: 1.0
...
head:   e42c8c6eb456f8978de417ea349eef676ef4385c
commit: 0f91c9d6bab956fe55c32f143b21cbcc3538f699 [1248/1267] [media] TS2020: Calculate tuner gain correctly
config: i386-allyesconfig (attached as .config)
reproduce:
  git checkout 0f91c9d6bab956fe55c32f143b21cbcc3538f699
  # save the attached .config to linux build tree
  make ARCH=i386 

Note: the linuxtv-media/master HEAD e42c8c6eb456f8978de417ea349eef676ef4385c builds fine.
      It only hurts bisectibility.

All error/warnings (new ones prefixed by >>):

   drivers/built-in.o: In function `ts2020_read_signal_strength':
>> ts2020.c:(.text+0x2814d2f): undefined reference to `__divdi3'
