...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id 3987BC43444
	for <linux-media@archiver.kernel.org>; Tue,  8 Jan 2019 11:42:23 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id ACED22087F
	for <linux-media@archiver.kernel.org>; Tue,  8 Jan 2019 11:42:22 +0000 (UTC)
Authentication-Results: mail.kernel.org;
	dkim=pass (1024-bit key) header.d=xilinx.onmicrosoft.com header.i=@xilinx.onmicrosoft.com header.b="thggtjoa"
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728687AbfAHLmP (ORCPT <rfc822;linux-media@archiver.kernel.org>);
        Tue, 8 Jan 2019 06:42:15 -0500
Received: from mail-eopbgr750042.outbound.protection.outlook.com ([40.107.75.42]:63616
        "EHLO NAM02-BL2-obe.outbound.protection.outlook.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1727107AbfAHLmP (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Tue, 8 Jan 2019 06:42:15 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
 d=xilinx.onmicrosoft.com; s=selector1-xilinx-com;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-SenderADCheck;
 bh=ONCg+Ao+SzmXNVNThM45fiImF9XgTyfPu9B1krvIu4Y=;
 b=thggtjoacKGKXHxfK1f0G7mfRrSio64cF7seNGZOvZz2idDXaaiCfPWuCXzejo81YLfdR/ocKDJVgg+S0o/l00orGT0VvMDcbWVq2JB2UKxHgbik/cir0/uPRLzVkp06UFL2/AmMqil8NZw2c53KL7KZNBpbty/iFJ7KQDSiv7I=
Received: from CY4PR02MB2709.namprd02.prod.outlook.com (10.175.59.19) by
 ...
 15.20.1495.9; Tue, 8 Jan 2019 11:42:06 +0000
...
Thread-Topic: [PATCH 2/2] media: v4l: xilinx: Add Xilinx MIPI CSI-2 Rx
 Subsystem driver
Thread-Index: AdSnMxXSuBhbxNnCQim2Fj+wv2KI7Q==
Date:   Tue, 8 Jan 2019 11:42:04 +0000
Message-ID: <CY4PR02MB270934F0B68BA19770F48188A78A0@CY4PR02MB2709.namprd02.prod.outlook.com>
...
x-microsoft-exchange-diagnostics: 1;CY4PR02MB2583;6:;5:h7uC0SHR6fUUtiC2D6Rp5sa3eUIIWRWYQw9o0RCHF2mQ5slBgbnJFmipfONKm+SRfFkISiEjj+7gM08yToqgfAPdAFrcIxLip9rACT4WuPwOej6ikljMMMl6CFbLM5av9wu3Mn+Xd2uH4FDnBoAhS9zUgTISieqHfr1IAaIRP0Nepena79cu3FNeCzUgwFaFgsK2QhhOjyD51rIPIKdg8A==;7:4eQMQ9wbQIQ5fKTnWab+YR1S4BgWb3IIowy4UGEK4GKMzqdE2xjHD7dwYmKX1eZe/dsWVINm+s5+WWpWYBQo+9Ungv4U/paVEJSrjJZusUyYxKBMBmUw5HxrfuSV176WWw3MpifbpvMbS7YJqdKE9Q==
x-ms-exchange-antispam-srfa-diagnostics: SOS;SOR;
x-forefront-antispam-report: SFV:SKI;SCL:-1;SFV:NSPM;SFS:(10009020)(136003)(376002)(366004)(346002)(39860400002)(396003)(189003)(199004)(13464003)(45074003)(51914003)(107886003)(25786009)(229853002)(478600001)(74316002)(14444005)(14454004)(316002)(256004)(9686003)(33656002)(81166006)(26005)(476003)(4326008)(53946003)(7736002)(55016002)(53936002)(6436002)(305945005)(486006)(8936002)(110136005)(54906003)(6246003)(99286004)(106356001)(6636002)(8676002)(3846002)(6116002)(7416002)(105586002)(71200400001)(53546011)(6506007)(66066001)(71190400001)(81156014)(97736004)(86362001)(575784001)(2906002)(4744004)(5660300001)(7696005)(68736007)(186003)(102836004)(579004)(559001)(569006);DIR:OUT;SFP:1101;SCL:1;SRVR:CY4PR02MB2583;H:CY4PR02MB2709.namprd02.prod.outlook.com;FPR:;SPF:None;LANG:en;PTR:InfoNoRecords;MX:1;A:1;
x-ms-office365-filtering-correlation-id: e8df88a7-b37d-4679-7c5e-08d6755e4ffe
...
x-microsoft-antispam-prvs: <CY4PR02MB25835E16272412E7A51759F9A78A0@CY4PR02MB2583.namprd02.prod.outlook.com>
x-forefront-prvs: 0911D5CE78
received-spf: None (protection.outlook.com: xilinx.com does not designate
 permitted sender hosts)
x-ms-exchange-senderadcheck: 1
x-microsoft-antispam-message-info: 
...
X-MS-Exchange-CrossTenant-Network-Message-Id: e8df88a7-b37d-4679-7c5e-08d6755e4ffe
X-MS-Exchange-CrossTenant-originalarrivaltime: 08 Jan 2019 11:42:04.6835
 (UTC)
...
>=20
> Single bit field doesn't have to be called as '_MASK', and thus the shift=
 is not
> needed. So,
>=20
...
>=20
> You can OR maskes below to get this too, at least to be consistent with b=
elow.
> But up to you.
>=20
...
>=20
> This is simply repeatation of above, XCSI_ISR_*. One common one can be us=
ed.
>=20
...
Since only 2 registers of DPHY are being used here, I would prefer to acces=
s and modify in this driver itself.
...
>=20
> Where do we get this value from? If not specified in any spec, this deser=
ves
> a comment how this value is derived.
>=20

The core takes less than 100 video clock cycles to reset.=20
...
Short packets will contain non image data usually for a frame like timing i=
nformation for
opening and closing of shutters, triggering flashes, etc. It's a 16 bit dat=
a which needs to be
sent to application layer.
I don't know how many of them come across for a frame though.
Hence used a larger number here.=20
...
Correct. But these are standard values from the MIPI CSI2 specification.=20
...
The lock serializes the calls to v4l2 subdev operations like start/stop str=
eaming.
...
Ok I keep it like this so that it is known that there are 3 parameters for =
this function.=20
...
A better way I think is to pass the pixel format through a pointer and retu=
rn 0 (for Success) or EINVAL for failure.
...
> > +}
>=20
> It would be cleaner if enable / disable functions are split. But up to yo=
u.
...
This control is created only if the enable_active_lanes parameter is set in=
 design.
So no need to check.
...
> > +				modestr);
>=20
> I'd do an array of strings, and do modestr[dphyclkstat]. But the dphyclks=
tate
...
The write and read paths to the number of active lanes is different in the =
HW.
...
>=20
Ok will change to dev_info.=20

> > +		}
> > +
> > +		dev_dbg(core->dev, "Set active lanes: requested =3D %d, active =3D
> %d\n",
...
> > +		.name	=3D "MIPI CSI2 Rx Subsystem: Frames Received Counter",
> > +		.type	=3D V4L2_CTRL_TYPE_INTEGER,
> > +		.min	=3D 0,
> > +		.max	=3D 0xFFFFFFFF,
> > +		.step	=3D 1,
...
>=20
> Isn't it needed to store and restore the register values? The registers w=
ill be
...
Table 2-2 Sub-Core Address Offsets in Section Register Space page 18 mentio=
ns this.
...
> > +				 core->ppc =3D=3D 4)) {
> > +			dev_err(core->dev, "Invalid xlnx,ppc property ret =3D %d
> ppc =3D %d\n",
> > +				ret, core->ppc);
> > +			return -EINVAL;
> > +		}
...
Right. Will update it in next revision.=20
...
> > +
> > +	ret =3D devm_request_irq(core->dev, core->irq, xcsi2rxss_irq_handler,
...
> > +	int num_ctrls;
> > +
> > +	xcsi2rxss =3D devm_kzalloc(&pdev->dev, sizeof(*xcsi2rxss), GFP_KERNEL=
);
> > +	if (!xcsi2rxss)
> > +		return -ENOMEM;
> > +
...
> > +
> > +	xcsi2rxss->core.events =3D  (struct xcsi2rxss_event *)&xcsi2rxss_even=
ts;
>=20
...
> 		continue;
> 	}
> 	xcsi2rxss_ctrls[i].max =3D xcsi2rxss->core.max_num_lanes;
>=20
> > +		}
> > +
