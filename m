...
Received: from mail-pa0-f52.google.com ([209.85.220.52]:53741 "EHLO
	mail-pa0-f52.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1750765AbaJPGNS (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 16 Oct 2014 02:13:18 -0400
From: Yoshihiro Kaneko <ykaneko0929@gmail.com>
To: linux-media@vger.kernel.org
Cc: Guennadi Liakhovetski <g.liakhovetski@gmx.de>,
	Simon Horman <horms@verge.net.au>,
	Magnus Damm <magnus.damm@gmail.com>, linux-sh@vger.kernel.org
Subject: [PATCH v2 1/3] media: soc_camera: rcar_vin: Add scaling support
Date: Thu, 16 Oct 2014 15:12:46 +0900
Message-Id: <1413439968-6349-2-git-send-email-ykaneko0929@gmail.com>
...
+
 enum rcar_vin_state {
 	STOPPED = 0,
 	RUNNING,
@@ -164,6 +506,9 @@ struct rcar_vin_cam {
...
@@ -677,6 +1022,61 @@ static void rcar_vin_clock_stop(struct soc_camera_host *ici)
...
+
 ...
 {
@@ -686,6 +1086,7 @@ static int rcar_vin_set_rect(struct soc_camera_device *icd)
...
@@ -705,40 +1106,65 @@ static int rcar_vin_set_rect(struct soc_camera_device *icd)
...
@@ -1017,6 +1443,8 @@ static int rcar_vin_get_formats(struct soc_camera_device *icd, unsigned int idx,
 		cam->subrect = rect;
 		cam->width = mf.width;
...
@@ -1273,6 +1701,9 @@ static int rcar_vin_set_fmt(struct soc_camera_device *icd,
...
+
 	...
 	priv->field = field;
@@ -1324,8 +1755,12 @@ static int rcar_vin_try_fmt(struct soc_camera_device *icd,
 	if (ret < 0)
 		return ret;
