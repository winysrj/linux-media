...
Received: from ch-smtp03.sth.basefarm.net ([80.76.149.214]:51380 "EHLO
	ch-smtp03.sth.basefarm.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S932829Ab0BCUkx (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 3 Feb 2010 15:40:53 -0500
Received: from c83-251-238-7.bredband.comhem.se ([83.251.238.7]:37474 helo=orresta.no-ip.com)
	by ch-smtp03.sth.basefarm.net with esmtps (TLSv1:AES256-SHA:256)
	(Exim 4.68)
	(envelope-from <lists@orresta.no-ip.com>)
	id 1Ncm1M-00020o-BG
	for linux-media@vger.kernel.org; Wed, 03 Feb 2010 21:40:23 +0100
Received: from [127.0.1.1] (orresta [127.0.1.1])
	(using TLSv1 with cipher DHE-RSA-AES256-SHA (256/256 bits))
	(Client did not present a certificate)
	(Authenticated sender: jakob)
	by orresta.no-ip.com (Postfix) with ESMTPSA id 5DA66C0B
	for <linux-media@vger.kernel.org>; Wed,  3 Feb 2010 21:40:17 +0100 (CET)
Message-ID: <4B69DF30.8080400@orresta.no-ip.com>
Date: Wed, 03 Feb 2010 21:40:16 +0100
From: listor <lists@orresta.no-ip.com>
MIME-Version: 1.0
...
> make[2]: *** [_module_/home/niklas/Hämtningar/mantis-5292a47772ad/v4l] 
> Error 2
> make[2]: Leaving directory `/usr/src/linux-headers-2.6.31-17-generic'
> make[1]: *** [default] Fel 2
> make[1]: Lämnar katalogen 
> "/home/niklas/Hämtningar/mantis-5292a47772ad/v4l"
> make: *** [all] Fel 2
>
