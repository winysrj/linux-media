...
Received: from mail-pa0-f54.google.com ([209.85.220.54]:34951 "EHLO
	mail-pa0-f54.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1757071AbcB1NPx (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sun, 28 Feb 2016 08:15:53 -0500
Received: by mail-pa0-f54.google.com with SMTP id bj10so6869831pad.2
        for <linux-media@vger.kernel.org>; Sun, 28 Feb 2016 05:15:53 -0800 (PST)
From: Tim Connors <tim.w.connors@gmail.com>
Date: Mon, 29 Feb 2016 00:15:44 +1100 (AEDT)
...
In-Reply-To: <56D1CEC2.7010308@iki.fi>
Message-ID: <alpine.DEB.2.02.1602290014340.28756@dirac.rather.puzzling.org>
References: <alpine.DEB.2.02.1602272221340.22807@dirac.rather.puzzling.org> <56D1CEC2.7010308@iki.fi>
MIME-Version: 1.0
...
That's just cold state/warm state, isn't it?

I didn't see anything obvious in the changelogs between 3.16 and 4.3
saying that data structures were migrated in a way that would make this
start failing.

On Sat, 27 Feb 2016, Antti Palosaari wrote:

> I think it is because of your device disconnects itself from the usb bus after
> the firmware download (and then reconnects with different usb id) and
...
> > Feb 15 00:09:54 fs kernel: [11927.220440] usb 1-3.2: New USB device strings:
...
> > file. Exiting
> > Feb 15 00:09:54 fs kernel: [11927.254648] dvb-usb: found a 'DViCO FusionHDTV
...
> > Feb 15 00:09:54 fs kernel: [11927.254749] dvb-usb: downloading firmware from
> > file 'dvb-usb-bluebird-01.fw'
> > Feb 15 00:09:54 fs kernel: [11927.318141] usbcore: registered new interface
> > driver dvb_usb_cxusb
> > Feb 15 00:09:54 fs laptop-mode: Warning: Configuration file
> > /etc/laptop-mode/conf.d/board-specific/*.conf is not readable, skipping.
> > Feb 15 00:09:54 fs laptop-mode: laptop-mode-tools is disabled in config
> > file. Exiting
> > Feb 15 00:09:54 fs kernel: [11927.397296] usb 1-3.2: USB disconnect, device
> > number 9
...
> > snd_timer snd soundcore shpchp 8250_fintek button acpi_c!
...
> > Feb 15 00:09:54 fs kernel: [11927.401277] CPU: 0 PID: 8965 Comm: kworker/0:0
> > Tainted: P           O    4.4.0-trunk-amd64 #1 Debian 4.4-1~exp1
...
> > Feb 15 00:09:54 fs kernel: [11927.401277]  ffff88007f057030 ffff88007f057000
> > ffffffffa0051380 ffffffffa003c429
> > Feb 15 00:09:54 fs kernel: [11927.401277]  ffff8800b90a8000 0000000000000000
> > ffff8800b90a8090 ffff88007f0570e0
> > Feb 15 00:09:54 fs kernel: [11927.401277]  ffff88007f057030 ffffffffa0d390a8
> > ffffffffa0051380 ffff88007f057040
