...
Received: from smtp-vbr8.xs4all.nl ([194.109.24.28]:3687 "EHLO
	smtp-vbr8.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1754268AbaDQKjh (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 17 Apr 2014 06:39:37 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hans.verkuil@cisco.com>
Subject: [REVIEWv2 PATCH 10/11] saa7134: convert to vb2
Date: Thu, 17 Apr 2014 12:39:13 +0200
Message-Id: <1397731154-34337-11-git-send-email-hverkuil@xs4all.nl>
...
---
 ...
 drivers/media/pci/saa7134/saa7134-core.c    |  86 ++--
 drivers/media/pci/saa7134/saa7134-dvb.c     |  43 +-
 drivers/media/pci/saa7134/saa7134-empress.c | 175 +++------
 drivers/media/pci/saa7134/saa7134-ts.c      | 171 ++++----
 drivers/media/pci/saa7134/saa7134-vbi.c     | 108 +++--
 drivers/media/pci/saa7134/saa7134-video.c   | 590 ++++++++++------------------
 drivers/media/pci/saa7134/saa7134.h         |  94 +++--
...
@@ -316,6 +255,7 @@ static bool empress_ctrl_filter(const struct v4l2_ctrl *ctrl)
...
+	struct vb2_queue *q;
 	...
 	dprintk("%s: %s\n",dev->name,__func__);
@@ -325,6 +265,7 @@ static int empress_init(struct saa7134_dev *dev)
...
@@ -341,6 +282,26 @@ static int empress_init(struct saa7134_dev *dev)
...
+
 	...
 	err = video_register_device(dev->empress_dev,VFL_TYPE_GRABBER,
 				    empress_nr[dev->nr]);
@@ -354,13 +315,6 @@ static int empress_init(struct saa7134_dev *dev)
...
@@ -373,6 +327,7 @@ static int empress_fini(struct saa7134_dev *dev)
 		return 0;
...
@@ -817,15 +781,15 @@ static int buffer_activate(struct saa7134_dev *dev,
 			   struct saa7134_buf *buf,
 			   struct saa7134_buf *next)
 {
+	struct saa7134_dmaqueue *dmaq = buf->vb2.vb2_queue->drv_priv;
...
@@ -835,17 +799,17 @@ static int buffer_activate(struct saa7134_dev *dev,
...
@@ -861,14 +825,14 @@ static int buffer_activate(struct saa7134_dev *dev,
 	if (dev->fmt->planar) {
...
@@ -891,23 +855,61 @@ static int buffer_activate(struct saa7134_dev *dev,
...
@@ -915,82 +917,88 @@ static int buffer_prepare(struct videobuf_queue *q,
...
+	.stop_streaming = saa7134_vb2_stop_streaming,
 ...
 /* ------------------------------------------------------------------ */
@@ -1068,7 +1076,7 @@ static int saa7134_s_ctrl(struct v4l2_ctrl *ctrl)
 	default:
 		return -EINVAL;
 	}
...
+	if (restart_overlay && dev->overlay_owner) {
 		...
 		stop_preview(dev);
 		start_preview(dev);
@@ -1079,55 +1087,21 @@ static int saa7134_s_ctrl(struct v4l2_ctrl *ctrl)
...
@@ -1136,127 +1110,34 @@ static int video_open(struct file *file)
...
@@ -1267,19 +1148,11 @@ static int video_release(struct file *file)
...
-
 ...
 {
@@ -1292,7 +1165,9 @@ static ssize_t radio_read(struct file *file, char __user *data,
 	cmd.instance = file;
 	cmd.result = -ENODEV;
...
@@ -1306,7 +1181,9 @@ static unsigned int radio_poll(struct file *file, poll_table *wait)
 	cmd.instance = file;
 	cmd.event_list = wait;
 	cmd.result = 0;
+	mutex_lock(&dev->lock);
...
@@ -1340,7 +1217,7 @@ static int saa7134_g_fmt_vid_cap(struct file *file, void *priv,
...
@@ -1364,7 +1241,6 @@ static int saa7134_g_fmt_vid_overlay(struct file *file, void *priv,
...
-	mutex_lock(&dev->lock);
 	...
 	if (clips == NULL)
@@ -1378,7 +1254,6 @@ static int saa7134_g_fmt_vid_overlay(struct file *file, void *priv,
...
@@ -1462,7 +1337,7 @@ static int saa7134_s_fmt_vid_cap(struct file *file, void *priv,
...
@@ -1483,25 +1358,20 @@ static int saa7134_s_fmt_vid_overlay(struct file *file, void *priv,
 	if (0 != err)
 		return err;
...
@@ -1553,9 +1423,7 @@ int saa7134_s_input(struct file *file, void *priv, unsigned int i)
 		return -EINVAL;
...
@@ -1565,7 +1433,6 @@ int saa7134_querycap(struct file *file, void *priv,
 {
 	struct saa7134_dev *dev = video_drvdata(file);
 	struct video_device *vdev = video_devdata(file);
...
@@ -1584,7 +1451,7 @@ int saa7134_querycap(struct file *file, void *priv,
...
@@ -1615,12 +1482,12 @@ EXPORT_SYMBOL_GPL(saa7134_querycap);
...
+	if (is_empress(file) && dev->overlay_owner) {
 		...
 		return -EBUSY;
@@ -1659,8 +1526,7 @@ int saa7134_s_std(struct file *file, void *priv, v4l2_std_id id)
...
+	if (!is_empress(file) && fh == dev->overlay_owner) {
 		...
 		stop_preview(dev);
 		spin_unlock_irqrestore(&dev->slock, flags);
@@ -1674,7 +1540,6 @@ int saa7134_s_std(struct file *file, void *priv, v4l2_std_id id)
...
@@ -1732,9 +1597,9 @@ static int saa7134_s_crop(struct file *file, void *f, const struct v4l2_crop *cr
...
+	if (vb2_is_streaming(&dev->video_vbq))
 	...
 	*c = crop->c;
@@ -1828,12 +1693,10 @@ int saa7134_s_frequency(struct file *file, void *priv,
...
@@ -1917,87 +1780,24 @@ static int saa7134_overlay(struct file *file, void *priv, unsigned int on)
 			return -EINVAL;
 		}
...
@@ -2055,10 +1855,10 @@ static const struct v4l2_file_operations video_fops =
 	.owner	  = THIS_MODULE,
 	.open	  = video_open,
...
@@ -2075,17 +1875,17 @@ static const struct v4l2_ioctl_ops video_ioctl_ops = {
...
@@ -2109,7 +1909,7 @@ static const struct v4l2_file_operations radio_fops = {
 	.open	  = video_open,
 	.read     = radio_read,
 	.release  = video_release,
-	.ioctl	  = video_ioctl2,
...
@@ -2187,6 +1987,8 @@ static const struct v4l2_ctrl_config saa7134_ctrl_automute = {
...
@@ -2238,6 +2040,7 @@ int saa7134_video_init1(struct saa7134_dev *dev)
...
@@ -2249,19 +2052,40 @@ int saa7134_video_init1(struct saa7134_dev *dev)
...
+		return ret;
 	...
 	return 0;
@@ -2270,7 +2094,9 @@ int saa7134_video_init1(struct saa7134_dev *dev)
...
+	vb2_queue_release(&dev->vbi_vbq);
 	...
 	if (card_has_radio(dev))
@@ -2364,8 +2190,7 @@ void saa7134_irq_video_done(struct saa7134_dev *dev, unsigned long status)
...
+		field = dev->field;
 		if (V4L2_FIELD_HAS_BOTH(field)) {
 			/* make sure we have seen both fields */
 			if ((status & 0x10) == 0x00) {
@@ -2381,8 +2206,7 @@ void saa7134_irq_video_done(struct saa7134_dev *dev, unsigned long status)
 			if ((status & 0x10) != 0x00)
 				goto done;
 		}
...
@@ -790,16 +789,6 @@ int saa7134_g_frequency(struct file *file, void *priv,
...
@@ -816,7 +805,16 @@ void saa7134_video_fini(struct saa7134_dev *dev);
...
@@ -833,7 +831,7 @@ int saa7134_ts_stop(struct saa7134_dev *dev);
 /* ----------------------------------------------------------- */
 /* saa7134-vbi.c                                               */
