...
Received: from smtp-vbr1.xs4all.nl ([194.109.24.21]:3844 "EHLO
	smtp-vbr1.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752229AbaCJNL1 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 10 Mar 2014 09:11:27 -0400
Message-ID: <531DB9EB.1000505@xs4all.nl>
Date: Mon, 10 Mar 2014 14:11:07 +0100
...
Subject: Re: [RFC/PATCH] v4l: vb2: Add a function to discard all DONE buffers
References: <1394456681-8948-1-git-send-email-laurent.pinchart@ideasonboard.com>
In-Reply-To: <1394456681-8948-1-git-send-email-laurent.pinchart@ideasonboard.com>
