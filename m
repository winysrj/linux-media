...
Received: from smtp.nokia.com ([192.100.105.134]:38862 "EHLO
	mgw-mx09.nokia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1758978AbZE0Jkn (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 27 May 2009 05:40:43 -0400
...
Subject: [PATCHv4 5 of 8] FMTx: si4713: Add files to handle si4713 i2c device
Date: Wed, 27 May 2009 12:35:52 +0300
Message-Id: <1243416955-29748-6-git-send-email-eduardo.valentin@nokia.com>
In-Reply-To: <1243416955-29748-5-git-send-email-eduardo.valentin@nokia.com>
...
---
 drivers/media/linux/radio/si4713-subdev.c | 1008 +++++++++++++++++
 drivers/media/linux/radio/si4713.c        | 2100 +++++++++++++++++++++++++++++++++++
 drivers/media/linux/radio/si4713.h        |  282 +++++
 3 files changed, 3390 insertions(+), 0 deletions(-)
 create mode 100644 drivers/media/linux/radio/si4713-subdev.c
 create mode 100644 drivers/media/linux/radio/si4713.c
 create mode 100644 drivers/media/linux/radio/si4713.h

diff -r 85b64a6cc67c -r 94b5043b692a linux/drivers/media/linux/radio/si4713-subdev.c
--- /dev/null	Thu Jan 01 00:00:00 1970 +0000
+++ b/linux/drivers/media/linux/radio/si4713-subdev.c	Wed May 27 11:56:46 2009 +0300
@@ -0,0 +1,1008 @@
+/*
...
diff -r 85b64a6cc67c -r 94b5043b692a linux/drivers/media/linux/radio/si4713.c
--- /dev/null	Thu Jan 01 00:00:00 1970 +0000
+++ b/linux/drivers/media/linux/radio/si4713.c	Wed May 27 11:56:46 2009 +0300
@@ -0,0 +1,2100 @@
+/*
+ * drivers/media/linux/radio/si4713.c
+ *
...
+	return rval;
+}
diff -r 85b64a6cc67c -r 94b5043b692a linux/drivers/media/linux/radio/si4713.h
--- /dev/null	Thu Jan 01 00:00:00 1970 +0000
+++ b/linux/drivers/media/linux/radio/si4713.h	Wed May 27 11:56:46 2009 +0300
@@ -0,0 +1,282 @@
+/*
