...
Received: from smtp-vbr8.xs4all.nl ([194.109.24.28]:3642 "EHLO
	smtp-vbr8.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752898Ab3KWOIK (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sat, 23 Nov 2013 09:08:10 -0500
Received: from tschai.lan (209.80-203-20.nextgentel.com [80.203.20.209] (may be forged))
	(authenticated bits=0)
	by smtp-vbr8.xs4all.nl (8.13.8/8.13.8) with ESMTP id rANE86Tc027731
	for <linux-media@vger.kernel.org>; Sat, 23 Nov 2013 15:08:08 +0100 (CET)
	(envelope-from hverkuil@xs4all.nl)
Received: from [127.0.0.1] (localhost [127.0.0.1])
	by tschai.lan (Postfix) with ESMTPSA id A86A52A221E
	for <linux-media@vger.kernel.org>; Sat, 23 Nov 2013 15:07:55 +0100 (CET)
Message-ID: <5290B6BB.7080102@xs4all.nl>
Date: Sat, 23 Nov 2013 15:07:55 +0100
From: Hans Verkuil <hverkuil@xs4all.nl>
MIME-Version: 1.0
To: Linux Media Mailing List <linux-media@vger.kernel.org>
Subject: Re: RFC: Properties, Configuration Storage, Selections and Matrices
References: <52862D55.8010406@xs4all.nl> <528B1CEC.5060308@xs4all.nl>
In-Reply-To: <528B1CEC.5060308@xs4all.nl>
