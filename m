...
Received: from mail.kapsi.fi ([217.30.184.167]:57840 "EHLO mail.kapsi.fi"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1751037AbcENFO5 (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Sat, 14 May 2016 01:14:57 -0400
From: Antti Palosaari <crope@iki.fi>
To: linux-media@vger.kernel.org
Cc: Antti Palosaari <crope@iki.fi>
Subject: [PATCH 2/3] mn88472: finalize driver
Date: Sat, 14 May 2016 08:14:35 +0300
Message-Id: <1463202876-18381-2-git-send-email-crope@iki.fi>
...
-
 ...
 err:
 	dev_dbg(&client->dev, "failed=%d\n", ret);
@@ -279,93 +280,101 @@ static int mn88472_init(struct dvb_frontend *fe)
 {
 	struct i2c_client *client = fe->demodulator_priv;
 	struct mn88472_dev *dev = i2c_get_clientdata(client);
...
+	release_firmware(firmware);
 err:
 	dev_dbg(&client->dev, "failed=%d\n", ret);
 	return ret;
@@ -379,18 +388,17 @@ static int mn88472_sleep(struct dvb_frontend *fe)
...
-
 ...
 err:
 	dev_dbg(&client->dev, "failed=%d\n", ret);
@@ -434,10 +442,19 @@ static struct dvb_frontend_ops mn88472_ops = {
...
+	struct mn88472_config *pdata = client->dev.platform_data;
 	...
 	int ret;
 	unsigned int utmp;
@@ -448,23 +465,16 @@ static int mn88472_probe(struct i2c_client *client,
...
@@ -472,15 +482,25 @@ static int mn88472_probe(struct i2c_client *client,
 		goto err_kfree;
 	}
...
+	 * register write or read is allowed to that bank.
 	...
 	if (!dev->client[1]) {
@@ -510,15 +530,25 @@ static int mn88472_probe(struct i2c_client *client,
 	}
...
@@ -561,11 +591,12 @@ MODULE_DEVICE_TABLE(i2c, mn88472_id_table);
