...
Received: from nblzone-211-213.nblnetworks.fi ([83.145.211.213]:40202 "EHLO
	...
	by vger.kernel.org with ESMTP id S1753404AbbDIV0E (ORCPT
...
Subject: [PATCH v4 4/4] smiapp: Use v4l2_of_alloc_parse_endpoint()
Date: Fri, 10 Apr 2015 00:25:06 +0300
Message-Id: <1428614706-8367-5-git-send-email-sakari.ailus@iki.fi>
