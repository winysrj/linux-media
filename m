...
Received: from lb3-smtp-cloud2.xs4all.net ([194.109.24.29]:35313 "EHLO
        lb3-smtp-cloud2.xs4all.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1752234AbdGCKTP (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Mon, 3 Jul 2017 06:19:15 -0400
Subject: Re: [PATCH RFC 1/2] media: V3s: Add support for Allwinner CSI.
To: Yong Deng <yong.deng@magewell.com>, mchehab@kernel.org,
...
Message-ID: <667c858b-2655-88c5-6bbc-9d70d06c1ff1@xs4all.nl>
Date: Mon, 3 Jul 2017 12:18:55 +0200
MIME-Version: 1.0
In-Reply-To: <1498561654-14658-2-git-send-email-yong.deng@magewell.com>
