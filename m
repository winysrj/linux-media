...
Received: from mail-pa0-f44.google.com ([209.85.220.44]:45245 "EHLO
	mail-pa0-f44.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753160AbbAGNqZ (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Wed, 7 Jan 2015 08:46:25 -0500
Received: by mail-pa0-f44.google.com with SMTP id et14so4981159pad.3
        for <linux-media@vger.kernel.org>; Wed, 07 Jan 2015 05:46:25 -0800 (PST)
From: tskd08@gmail.com
To: linux-media@vger.kernel.org
Cc: m.chehab@samsung.com, Akihiro Tsukada <tskd08@gmail.com>,
	Antti Palosaari <crope@iki.fi>
Subject: [PATCH 2/2] dvb-usb-friio: split and merge into dvb-usbv2-gl861
Date: Wed,  7 Jan 2015 22:45:33 +0900
Message-Id: <1420638333-7002-3-git-send-email-tskd08@gmail.com>
In-Reply-To: <1420638333-7002-1-git-send-email-tskd08@gmail.com>
References: <1420638333-7002-1-git-send-email-tskd08@gmail.com>
...
+		int ret;
+
+		ret = i2c_master_send(fe->fe_i2c_client, demod_init[i], 2);
+		if (ret < 0)
+			return ret;
+	}
+	msleep(100);
...
+
+	d = adap_to_d(adap);
+	fe = dvb_i2c_attach_fe(&d->i2c_adap, &friio_config.demod_info,
