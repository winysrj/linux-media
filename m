...
Received: from multi.imgtec.com ([194.200.65.239]:48368 "EHLO multi.imgtec.com"
	...
	id S1752661AbaAQOAH (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Fri, 17 Jan 2014 09:00:07 -0500
From: James Hogan <james.hogan@imgtec.com>
To: Mauro Carvalho Chehab <m.chehab@samsung.com>,
	<linux-media@vger.kernel.org>
CC: James Hogan <james.hogan@imgtec.com>,
	Rob Landley <rob@landley.net>, <linux-doc@vger.kernel.org>
Subject: [PATCH v2 04/15] media: rc: add sysfs scancode filtering interface
Date: Fri, 17 Jan 2014 13:58:49 +0000
Message-ID: <1389967140-20704-5-git-send-email-james.hogan@imgtec.com>
...
@@ -996,9 +1120,21 @@ static int rc_dev_uevent(struct device *device, struct kobj_uevent_env *env)
  */
