...
Received: from smtp-vbr6.xs4all.nl ([194.109.24.26]:2052 "EHLO
	smtp-vbr6.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1757846Ab3FTNow (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 20 Jun 2013 09:44:52 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hans.verkuil@cisco.com>
Subject: [RFCv2 PATCH 02/15] saa7134: convert to the control framework.
Date: Thu, 20 Jun 2013 15:44:18 +0200
Message-Id: <1371735871-2658-3-git-send-email-hverkuil@xs4all.nl>
...
+	struct v4l2_ctrl_handler *hdl = &dev->empress_ctrl_handler;
 	...
 	dprintk("%s: %s\n",dev->name,__func__);
@@ -511,11 +415,20 @@ static int empress_init(struct saa7134_dev *dev)
...
@@ -2318,22 +2103,6 @@ static int radio_s_std(struct file *file, void *fh, v4l2_std_id norm)
 	return 0;
 }
...
-
 ...
 {
 	.owner	  = THIS_MODULE,
@@ -2368,9 +2137,6 @@ static const struct v4l2_ioctl_ops video_ioctl_ops = {
...
@@ -2404,10 +2170,7 @@ static const struct v4l2_ioctl_ops radio_ioctl_ops = {
...
@@ -2428,8 +2191,55 @@ struct video_device saa7134_radio_template = {
...
+
 	...
 	if (gbuffers < 2 || gbuffers > VIDEO_MAX_FRAME)
 		gbuffers = 2;
@@ -2437,17 +2247,38 @@ int saa7134_video_init1(struct saa7134_dev *dev)
...
@@ -2493,6 +2324,9 @@ void saa7134_video_fini(struct saa7134_dev *dev)
 	/* free stuff */
...
@@ -2536,6 +2370,7 @@ int saa7134_video_init2(struct saa7134_dev *dev)
 	/* init video hw */
