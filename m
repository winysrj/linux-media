...
Received: from mga04.intel.com ([192.55.52.120]:5235 "EHLO mga04.intel.com"
        ...
        id S1750992AbeAYRJp (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Thu, 25 Jan 2018 12:09:45 -0500
...
Date: Fri, 26 Jan 2018 01:11:58 +0800
Message-Id: <1516900318-22380-1-git-send-email-andy.yeh@intel.com>
...
- enabled sequential write to update 2 registers in a single transaction.
 ...
 drivers/media/i2c/dw9807.c                         | 369 +++++++++++++++++++++
