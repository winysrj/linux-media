...
Received: from mail-ie0-f172.google.com ([209.85.223.172]:37222 "EHLO
	mail-ie0-f172.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S935140Ab3DINgi (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Tue, 9 Apr 2013 09:36:38 -0400
Received: by mail-ie0-f172.google.com with SMTP id c10so8490149ieb.3
        for <linux-media@vger.kernel.org>; Tue, 09 Apr 2013 06:36:38 -0700 (PDT)
MIME-Version: 1.0
In-Reply-To: <201304091526.52486.hverkuil@xs4all.nl>
References: <CAFW1BFxJ-fe8N-=LSKUfRP=-R+XUY_it3miEUKKJ6twkZa1wZA@mail.gmail.com>
	<201304091211.30037.hverkuil@xs4all.nl>
	<CAFW1BFxU8EkHCfgBEgQk=aNpJu0fgbqSmyXkUB8bA-Ahkbn2TQ@mail.gmail.com>
	<201304091526.52486.hverkuil@xs4all.nl>
Date: Tue, 9 Apr 2013 15:36:37 +0200
Message-ID: <CAFW1BFwMWOC0YoKP50pZXLE4Nv4a0M7Opzia1jJWeGJQxQat2Q@mail.gmail.com>
...
On Tue, Apr 9, 2013 at 3:26 PM, Hans Verkuil <hverkuil@xs4all.nl> wrote:
...
>
> Try this: just comment out the memcpy and see what that does to your CPU load.
> If that doesn't help, then comment out ioremap/iounmap, and finally start
> commenting out the get/put/canvas_read code. Basically strip down the code
> until you find what causes the load.
>
> USB camera drivers will typically have to do a memcpy since they have to strip
> off USB packet headers.
>
> But if it is not needed, then you should certainly avoid having to memcpy
> 30 MB per second.
>
> Regards,
>
