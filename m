...
Received: from mga02.intel.com ([134.134.136.20]:50927 "EHLO mga02.intel.com"
        ...
        id S1751468AbdJTOvJ (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Fri, 20 Oct 2017 10:51:09 -0400
...
Date: Fri, 20 Oct 2017 14:51:07 +0000
Message-ID: <C193D76D23A22742993887E6D207B54D1AE2AF59@ORSMSX106.amr.corp.intel.com>
...
In-Reply-To: <20171020095800.iapx2v3uukeohq2f@valkosipuli.retiisi.org.uk>
...
> <rajmohan.mani@intel.com>; Yang, Hyungwoo
> <hyungwoo.yang@intel.com>; Hu, Jerry W <jerry.w.hu@intel.com>
> Subject: Re: [PATCH v3 08/12] intel-ipu3: params: compute and program ccs
> 
> Hi Yong,
> 
...
> > +		phase_sum_right / phase_step - 1 : phase_sum_right /
> phase_step;
...
> > +
> > +/*
> > + * Calculates the exact output image width/height, based on
> > +phase_step setting
...
> > +	unsigned int arg2 = ((IMGU_SCALER_TAPS_Y / 2) *
...
> > +	memset(&cfg->scaler_coeffs_luma, 0, sizeof(*cfg-
> >scaler_coeffs_luma));
> > +	do {
...
> > +							       info_luma);
> > +		out_height =
> ipu3_css_scaler_calc_scaled_output(input_height,
> > +								info_luma);
...
> > + */
> 
> I think the switch below is entirely reasonable, no need for such a comment.
> 

Agree, removed in v4 update. 

> > +static void ipu3_css_osys_set_format(enum imgu_abi_frame_format
> host_format,
