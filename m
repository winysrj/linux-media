...
Received: from mailout1.w1.samsung.com ([210.118.77.11]:29698 "EHLO
	...
	with ESMTP id S1757174Ab0JLM3Z (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 12 Oct 2010 08:29:25 -0400
...
Received: from linux.samsung.com ([106.116.38.10])
 ...
 2004)) with ESMTPA id <0LA6007XZG0XF1@spt1.w1.samsung.com> for
 linux-media@vger.kernel.org; Tue, 12 Oct 2010 13:29:22 +0100 (BST)
Date: Tue, 12 Oct 2010 14:29:00 +0200
From: Marek Szyprowski <m.szyprowski@samsung.com>
Subject: [PATCH/RFC v2 0/6] Videobuf2 framework
To: linux-media@vger.kernel.org
Cc: m.szyprowski@samsung.com, pawel@osciak.com,
	kyungmin.park@samsung.com, p.osciak@samsung.com
Message-id: <1286886546-18058-1-git-send-email-m.szyprowski@samsung.com>
MIME-version: 1.0
...
I've decided to continue development of the VideoBuf2 at Samsung until
Pawel finds some spare time to help us (currently he is very busy in his
new work). I have updated the patches with suggestions from Hans.
Support for read() is planned but requires a bit more work. Now I would
like to discuss other parts of the videobuf2 framework.

The main change since V1 is the removal of drv_lock. This required
introducing start_streaming and stop_streaming callbacks, but simplified
significantly the code of both the driver and the framework. It will also
simplify adding a read() support a bit.
