...
Received: from perceval.ideasonboard.com ([95.142.166.194]:59046 "EHLO
	...
	with ESMTP id S1754362AbaFEAH3 (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Wed, 4 Jun 2014 20:07:29 -0400
From: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
To: Philipp Zabel <p.zabel@pengutronix.de>
Cc: Mauro Carvalho Chehab <m.chehab@samsung.com>,
	linux-media@vger.kernel.org, kernel@pengutronix.de
Subject: Re: [PATCH v3 2/2] [media] mt9v032: use regmap
Date: Thu, 05 Jun 2014 02:07:56 +0200
Message-ID: <5819408.DnE9aLxUvH@avalon>
In-Reply-To: <1401901023-18213-2-git-send-email-p.zabel@pengutronix.de>
References: <1401901023-18213-1-git-send-email-p.zabel@pengutronix.de> <1401901023-18213-2-git-send-email-p.zabel@pengutronix.de>
MIME-Version: 1.0
...
On Wednesday 04 June 2014 18:57:03 Philipp Zabel wrote:
...
> 
>  	if (!on) {
> @@ -381,14 +352,14 @@ static int __mt9v032_set_power(struct mt9v032
> *mt9v032, bool on)
> 
...
>  		return ret;
> 
> @@ -432,43 +403,39 @@ static int mt9v032_s_stream(struct v4l2_subdev
...
>  		return ret;
> 
> @@ -477,7 +444,7 @@ static int mt9v032_s_stream(struct v4l2_subdev *subdev,
...
> 
>  	return 0;
> @@ -790,7 +757,7 @@ static int mt9v032_registered(struct v4l2_subdev
...
> @@ -803,10 +770,10 @@ static int mt9v032_registered(struct v4l2_subdev
> *subdev) }
> 
...
> @@ -893,6 +860,13 @@ static const struct v4l2_subdev_internal_ops
