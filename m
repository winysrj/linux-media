...
Received: from mail1-out1.atlantis.sk ([80.94.52.55]:35026 "EHLO
	mail.atlantis.sk" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
	with ESMTP id S932446Ab1EQVpZ (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 17 May 2011 17:45:25 -0400
From: Ondrej Zary <linux@rainbow-software.org>
To: Hans Verkuil <hverkuil@xs4all.nl>
Subject: [PATCH RFC v3] radio-sf16fmr2: convert to generic TEA575x interface
Date: Tue, 17 May 2011 23:45:15 +0200
...
Message-Id: <201105172345.18582.linux@rainbow-software.org>
...
+++ linux-2.6.39-rc2/drivers/media/radio/radio-sf16fmr2.c	2011-05-17 23:24:37.000000000 +0200
@@ -1,441 +1,184 @@
...
+		tc9154a_set_volume(fmr2, abs(ctrl->val - 68));
 		return 0;
 	}
-	return -EINVAL;
-}
...
+		v4l2_ctrl_new_std(&tea->ctrl_handler, &fmr2_ctrl_ops, V4L2_CID_AUDIO_VOLUME, 0, 68, 2, 50);
...
@@ -443,22 +186,9 @@ static void __exit fmr2_exit(void)
 {
 	struct fmr2 *fmr2 = &fmr2_card;
