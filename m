...
Received: from nblzone-211-213.nblnetworks.fi ([83.145.211.213]:41926 "EHLO
        hillosipuli.retiisi.org.uk" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1752906AbdHKLcN (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Fri, 11 Aug 2017 07:32:13 -0400
Date: Fri, 11 Aug 2017 14:32:10 +0300
...
Subject: Re: [PATCH v1.2 1/1] omap3isp: Skip CSI-2 receiver initialisation in
 CCP2 configuration
Message-ID: <20170811113209.k2uvhrjljq4tmj5u@valkosipuli.retiisi.org.uk>
References: <20170811095709.3069-1-sakari.ailus@linux.intel.com>
 <20170811104605.GA5657@amd>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20170811104605.GA5657@amd>
...
I'll still send a new version; this one sets phy->entity NULL independently
of whether everything goes well...

There's something wrong somewhere else, I can't capture images on master
branch anymore. I'm trying to figure out what's wrong.
