...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id DF5D4C43387
	for <linux-media@archiver.kernel.org>; Fri, 21 Dec 2018 19:40:42 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id A4F3E21929
	for <linux-media@archiver.kernel.org>; Fri, 21 Dec 2018 19:40:42 +0000 (UTC)
Authentication-Results: mail.kernel.org;
	dkim=pass (1024-bit key) header.d=nextdimension.cc header.i=@nextdimension.cc header.b="XZmz0oeL"
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2390020AbeLUTkm (ORCPT <rfc822;linux-media@archiver.kernel.org>);
        Fri, 21 Dec 2018 14:40:42 -0500
Received: from goldenrod.birch.relay.mailchannels.net ([23.83.209.74]:15231
        "EHLO goldenrod.birch.relay.mailchannels.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S2389698AbeLUTkl (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Fri, 21 Dec 2018 14:40:41 -0500
X-Sender-Id: dreamhost|x-authsender|brad@nextdimension.ws
Received: from relay.mailchannels.net (localhost [127.0.0.1])
        by relay.mailchannels.net (Postfix) with ESMTP id 249DB5C44A6;
        Fri, 21 Dec 2018 19:40:39 +0000 (UTC)
Received: from pdx1-sub0-mail-a63.g.dreamhost.com (unknown [100.96.36.160])
        (Authenticated sender: dreamhost)
        by relay.mailchannels.net (Postfix) with ESMTPA id AC4C45C3A38;
        Fri, 21 Dec 2018 19:40:38 +0000 (UTC)
X-Sender-Id: dreamhost|x-authsender|brad@nextdimension.ws
Received: from pdx1-sub0-mail-a63.g.dreamhost.com (pop.dreamhost.com
 [64.90.62.162])
        (using TLSv1.2 with cipher DHE-RSA-AES256-GCM-SHA384)
        by 0.0.0.0:2500 (trex/5.16.2);
        Fri, 21 Dec 2018 19:40:39 +0000
X-MC-Relay: Neutral
X-MailChannels-SenderId: dreamhost|x-authsender|brad@nextdimension.ws
X-MailChannels-Auth-Id: dreamhost
X-Power-Interest: 319aa8b454443f5f_1545421239016_3679865813
X-MC-Loop-Signature: 1545421239016:2060623058
X-MC-Ingress-Time: 1545421239015
Received: from pdx1-sub0-mail-a63.g.dreamhost.com (localhost [127.0.0.1])
        by pdx1-sub0-mail-a63.g.dreamhost.com (Postfix) with ESMTP id 63F4E81EF2;
        Fri, 21 Dec 2018 11:40:37 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha1; c=relaxed; d=nextdimension.cc; h=from
        :to:cc:subject:date:message-id:in-reply-to:references; s=
        nextdimension.cc; bh=dRHWzqi5Zm/58j1WRS7rHRLS708=; b=XZmz0oeLY/G
        KRQyCsE/geIIlFEszaSqHfFql0o1W5NA7uPl11HRAEAWQIe4T9Q46ZHJ4rlrJdKq
        citNEiAdascw5gPCejV/c1ilSTSBDb3EAWBKS6pOYsfvtQ5e7x4jvbYi9gdcVU9C
        FJ6gP4H3G1p14z5Yc4zKoTjoNYObGgTU=
Received: from localhost.localdomain (66-90-189-166.dyn.grandenetworks.net [66.90.189.166])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-SHA256 (128/128 bits))
        (No client certificate requested)
        (Authenticated sender: brad@nextdimension.ws)
        by pdx1-sub0-mail-a63.g.dreamhost.com (Postfix) with ESMTPSA id AE66E81EFB;
        Fri, 21 Dec 2018 11:40:36 -0800 (PST)
X-DH-BACKEND: pdx1-sub0-mail-a63
From:   Brad Love <brad@nextdimension.cc>
To:     linux-media@vger.kernel.org, mchehab@kernel.org
Cc:     Brad Love <brad@nextdimension.cc>
Subject: [PATCH v2 4/4] pvrusb2: Add Hauppauge HVR1955/1975 devices
Date:   Fri, 21 Dec 2018 13:40:23 -0600
Message-Id: <1545421223-3577-5-git-send-email-brad@nextdimension.cc>
...
X-VR-OUT-STATUS: OK
X-VR-OUT-SCORE: 30
X-VR-OUT-SPAMCAUSE: 
