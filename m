...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id 60550C43381
	for <linux-media@archiver.kernel.org>; Wed, 13 Mar 2019 11:09:24 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id C24432177E
	for <linux-media@archiver.kernel.org>; Wed, 13 Mar 2019 11:09:23 +0000 (UTC)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726011AbfCMLJW (ORCPT <rfc822;linux-media@archiver.kernel.org>);
        Wed, 13 Mar 2019 07:09:22 -0400
Received: from mailgw01.mediatek.com ([210.61.82.183]:30178 "EHLO
        mailgw01.mediatek.com" rhost-flags-OK-FAIL-OK-FAIL) by vger.kernel.org
        with ESMTP id S1725832AbfCMLJW (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Wed, 13 Mar 2019 07:09:22 -0400
X-UUID: 154aece7401042e9b5fd57f374d53d8d-20190313
X-UUID: 154aece7401042e9b5fd57f374d53d8d-20190313
Received: from mtkcas09.mediatek.inc [(172.21.101.178)] by mailgw01.mediatek.com
        (envelope-from <louis.kuo@mediatek.com>)
        (mhqrelay.mediatek.com ESMTP with TLS)
        with ESMTP id 1467003533; Wed, 13 Mar 2019 19:08:42 +0800
Received: from mtkcas08.mediatek.inc (172.21.101.126) by
 mtkmbs08n2.mediatek.inc (172.21.101.56) with Microsoft SMTP Server (TLS) id
 15.0.1395.4; Wed, 13 Mar 2019 19:08:39 +0800
Received: from [172.21.84.99] (172.21.84.99) by mtkcas08.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.0.1395.4 via Frontend
 Transport; Wed, 13 Mar 2019 19:08:39 +0800
Message-ID: <1552475320.14351.60.camel@mtksdccf07>
Subject: Re: [RFC PATCH V0 1/4] media: platform: mtk-isp: Add Mediatek
...
Date:   Wed, 13 Mar 2019 19:08:40 +0800
In-Reply-To: <1552383463.14351.50.camel@mtksdccf07>
References: <1550733718-31702-1-git-send-email-louis.kuo@mediatek.com>
         ...
         <CAD90Vca5xV65gnv92n1Cn00megUiP2=Fc4bUnhLjb5UvyyOVZQ@mail.gmail.com>
         <1552380583.14351.43.camel@mtksdccf07>
         <CAD90VcZ1_v1+QmFDQZD3=vic4B2pfL_QsTUfpsU8=iBeFYyVjA@mail.gmail.com>
         <1552383463.14351.50.camel@mtksdccf07>
Content-Type: text/plain; charset="UTF-8"
X-Mailer: Evolution 3.2.3-0ubuntu6 
Content-Transfer-Encoding: 7bit
MIME-Version: 1.0
X-TM-SNTS-SMTP: 51930F1FE5DBFE25114747DFE816288B9E24F98396D96086673F2D90ED4D52662000:8
X-MTK:  N
...
Hi Keiichi,
About your comment, I agree your idea to remove virtual channel function
in this patch and have wrote a note below your comment already.

If you have any other suggestion about this patch, please let me know.

BRs
Louis


On Tue, 2019-03-12 at 17:37 +0800, Louis Kuo wrote:
> Hi Keiichi,
> 
> Thanks,
> I reply your one inline comment below.
> 
> BRs
> Louis
> 
> 
> On Tue, 2019-03-12 at 18:11 +0900, Keiichi Watanabe wrote:
> > Hi Louis,
> > 
...
Ok, I will remove this function from this patch and create a new patch
later.
> > 
> > > >
> > > > > > +
