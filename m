...
Received: from lb3-smtp-cloud3.xs4all.net ([194.109.24.30]:53686 "EHLO
	...
	by vger.kernel.org with ESMTP id S1751781AbcDWLEP (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sat, 23 Apr 2016 07:04:15 -0400
...
Subject: [PATCHv4 13/13] vb2: replace void *alloc_ctxs by struct device *alloc_devs
Date: Sat, 23 Apr 2016 13:03:49 +0200
Message-Id: <1461409429-24995-14-git-send-email-hverkuil@xs4all.nl>
...
index 118e9fa..c56544a 100644
--- a/drivers/media/pci/tw686x/tw686x-video.c
+++ b/drivers/media/pci/tw686x/tw686x-video.c
@@ -95,7 +95,7 @@ static const struct tw686x_format *format_by_fourcc(unsigned int fourcc)
...
@@ -397,7 +397,7 @@ struct vb2_buf_ops {
...
index a9e6d74..6df8790 100644
--- a/include/media/videobuf2-dma-contig.h
+++ b/include/media/videobuf2-dma-contig.h
@@ -26,9 +26,6 @@ vb2_dma_contig_plane_dma_addr(struct vb2_buffer *vb, unsigned int plane_no)
 	return *addr;
 }
