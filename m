...
Received: from mx07-00178001.pphosted.com ([62.209.51.94]:43531 "EHLO
	mx07-00178001.pphosted.com" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1751911AbbFKM3U convert rfc822-to-8bit
	(ORCPT <rfc822;linux-media@vger.kernel.org>);
	Thu, 11 Jun 2015 08:29:20 -0400
From: Fabien DESSENNE <fabien.dessenne@st.com>
To: Mauro Carvalho Chehab <mchehab@osg.samsung.com>
CC: Linux Media Mailing List <linux-media@vger.kernel.org>,
	Mauro Carvalho Chehab <mchehab@infradead.org>
Date: Thu, 11 Jun 2015 14:27:46 +0200
Subject: RE: [PATCH 2/2] [media] bdisp-debug: don't try to divide by s64
Message-ID: <15ED7CB7B68B4D4C96C7D27A1A23941201B9F8D972@SAFEX1MAIL2.st.com>
References: <bc5e66bd2591424f0e08d5478a36a8074fe739f5.1433969944.git.mchehab@osg.samsung.com>
 ...
 <20150611073725.7282c63a@recife.lan>
In-Reply-To: <20150611073725.7282c63a@recife.lan>
...
> @@ -584,17 +586,26 @@ static int bdisp_dbg_perf(struct seq_file *s, void
> *data)
>  		return 0;
>  	}
> 
...
> -	do_div(max_fps, bdisp->dbg.max_duration);
> -	do_div(last_fps, bdisp->dbg.last_duration);
> +	avg_time_us = div64_s64(bdisp->dbg.tot_duration, request-
> >nb_req);
> +	if (avg_time_us > SECOND)
> +		avg_fps = 0;
> +	else
