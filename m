...
Received: from mail1.matrix-vision.com ([78.47.19.71]:52066 "EHLO
	mail1.matrix-vision.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1755726Ab1CYKLo (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 25 Mar 2011 06:11:44 -0400
Message-ID: <4D8C6A5E.1070309@matrix-vision.de>
Date: Fri, 25 Mar 2011 11:11:42 +0100
...
References: <4D889C61.905@matrix-vision.de> <4D89C2ED.5080803@maxwell.research.nokia.com> <4D89D460.7000808@matrix-vision.de> <4D8AFB0C.803@maxwell.research.nokia.com>
In-Reply-To: <4D8AFB0C.803@maxwell.research.nokia.com>
...
I don't know of others, but surely the same would apply to them as to
GStreamer- you _could_ change them so they don't need it.  But they
conform to the V4L2 spec as is.
...
Good quesion, I guess -EINVAL.  At that point you're talking about a V4L
device which can't provide data anyway.
