...
Received: from anke-und-chris.de ([89.110.150.28]:45710 "EHLO v1544.ncsrv.de"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1750881AbaLPMpk (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Tue, 16 Dec 2014 07:45:40 -0500
MIME-Version: 1.0
Content-Type: text/plain;
 charset=UTF-8
Content-Transfer-Encoding: 7bit
Date: Tue, 16 Dec 2014 12:45:29 +0000
From: Christopher Scheuring <chris@anke-und-chris.de>
To: Nibble Max <nibble.max@gmail.com>
Cc: <linux-media@vger.kernel.org>, Antti Palosaari <crope@iki.fi>
Subject: Re: Re: Fwd: Re: Re: Problems with Linux drivers (Debian Jessie
 kernel3.16.0-4)
In-Reply-To: <201411211030324214078@gmail.com>
References: <201411191028007188819@dvbsky.net>,
 <546CEF67.9060803@anke-und-chris.de>, <546D91C3.4070500@iki.fi>
 <201411211030324214078@gmail.com>
Message-ID: <5f3a355f854e92480b28794c3096435d@localhost>
Sender: linux-media-owner@vger.kernel.org
List-ID: <linux-media.vger.kernel.org>

Hello Max,

sorry for the delayed answer - I'm currently busy.

About your question where I have the issues: It concerns to all
transponders using dvb-s or dvb-s2.


Currently I have no chance for testing. Around Christmas I'll have some
more time for testing. I'll check out the current drivers and play around
with the firmeware versions. Hope to provide after testing more useful
information.
...
On Fri, 21 Nov 2014 10:30:35 +0800, "Nibble Max" <nibble.max@gmail.com>
wrote:
> Hello Chris,
> 
> Do all of your transponders have such issue or only some special
> transponders?
> Could you list the parameters for them? for example, dvb-s or dvb-s2
type,
...
> But we test both firmwares work well. You can change one to the other's
> file name for check.
> 
> Best Regards,
> Max
> 
> On 2014-11-20 20:56:07, Christopher Scheuring <chris@anke-und-chris.de>
> wrote:
>>Hello,
>>
...
>>
>>
>>On Thu, 20 Nov 2014 09:01:23 +0200, Antti Palosaari <crope@iki.fi>
wrote:
>>> Moikka
>>> According to logs, everything seems to be fine. You could not compare 
>>> statistics numbers between two drivers. SNR 0096 is 150DEC, which
means 
>>> 15dB, IIRC it was max chip could return for DVB-S.
>>> 
>>> No idea about sync etc. problems, are you sure about those? I am
pretty 
...
>>>> TT-Budget card works fine. But the signal from the DVDBSky S952 is
very
>>>> worse: Sync problems, bad SNR, drops on video and audio... If I use
the
>>>> driver dvbsky.net provides (media_build-bst-14-141106), the signal on
>>>> booth tuners is fine - but then my TT-Budget doesn't works anymore
(see
...
>>>>
>>>>
>>>> Here the dmesg output of the loaded drivers and firmware of the
DVBSky
>>>> Card:
>>>>
...
>>>> [   17.518086] cx25840 4-0044: loaded v4l-cx23885-avcore-01.fw
firmware
>>>> (16382 bytes)
...
>>cold
>>>> state
>>>> [   51.818948] cx23885 0000:04:00.0: firmware: direct-loading
firmware
...
>>cold
>>>> state
>>>> [   52.734618] cx23885 0000:04:00.0: firmware: direct-loading
firmware
>>>> dvb-demod-m88ds3103.fw
...
>>>>> *To:* tech<tech@dvbsky.net <mailto:tech@dvbsky.net>>
>>>>> *Cc:* <>
>>>>> *Subject:* Problems with Linux drivers (Debian Jessie kernel
3.16.0-4)
>>>>> Hi,
>>>>>
>>>>> I reinstalled after updating my system with the Linux drivers for
the
...
>>>>> SAA7146 (TT-Budget C-1501) card doesn't runs anymore - the card
worked
...
>>>>> [   14.916904] budget_core: Unknown symbol dvb_unregister_adapter
(err
>>>>> -22)
...
>>>>> drivers where overwritten, and some necessary not... I couldn't
found
