...
Received: from mx3.redhat.com (mx3.redhat.com [172.16.48.32])
	by int-mx1.corp.redhat.com (8.13.1/8.13.1) with ESMTP id mBB0iRCa021533
	for <video4linux-list@redhat.com>; Wed, 10 Dec 2008 19:44:27 -0500
Received: from mail03.idc.renesas.com (mail.renesas.com [202.234.163.13])
	by mx3.redhat.com (8.13.8/8.13.8) with ESMTP id mBB0iDFH019095
	for <video4linux-list@redhat.com>; Wed, 10 Dec 2008 19:44:14 -0500
Date: Thu, 11 Dec 2008 09:31:15 +0900
From: Kuninori Morimoto <morimoto.kuninori@renesas.com>
To: Guennadi Liakhovetski <g.liakhovetski@gmx.de>
Message-id: <utz9bmtgn.wl%morimoto.kuninori@renesas.com>
MIME-version: 1.0 (generated by SEMI 1.14.6 - "Maruoka")
Content-type: text/plain; charset=US-ASCII
Cc: V4L-Linux <video4linux-list@redhat.com>
Subject: [PATCH] Add tw9910 driver
...
---
 ...
 drivers/media/video/tw9910.c    |  910 +++++++++++++++++++++++++++++++++++++++
...
+tw9910_select_norm(struct soc_camera_device *icd)
+{
+	const struct tw9910_scale_ctrl *scale;
+	int i;
+
...
+			if (scale[i].width  == icd->width &&
+			    scale[i].height == icd->height) {
+				return scale + i;
+			}
+		}
+	} else if (icd->vdev->current_norm & V4L2_STD_PAL) {
