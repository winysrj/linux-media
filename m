...
Received: from mailout-de.gmx.net ([213.165.64.23]:38735 "HELO
	mailout-de.gmx.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with SMTP id S1750934Ab1HZRYF (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 26 Aug 2011 13:24:05 -0400
Message-ID: <4E57D6B2.40001@gmx.de>
Date: Fri, 26 Aug 2011 17:24:02 +0000
...
Subject: Re: [PATCH/RFC v2 3/3] fbdev: sh_mobile_lcdc: Support FOURCC-based
 format API
References: <1313746626-23845-1-git-send-email-laurent.pinchart@ideasonboard.com> <1313746626-23845-4-git-send-email-laurent.pinchart@ideasonboard.com>
