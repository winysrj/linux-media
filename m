...
Received: from smtp-vbr1.xs4all.nl ([194.109.24.21]:1194 "EHLO
	smtp-vbr1.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1762091AbZLQHYZ (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 17 Dec 2009 02:24:25 -0500
From: Hans Verkuil <hverkuil@xs4all.nl>
To: santiago.nunez@ridgerun.com
Subject: Re: [PATCH 3/4 v12] TVP7002 driver for DM365
Date: Thu, 17 Dec 2009 08:24:38 +0100
...
Message-Id: <200912170824.38833.hverkuil@xs4all.nl>
...
On Wednesday 16 December 2009 22:32:02 santiago.nunez@ridgerun.com wrote:
...
Please propagate the error from v4l_fill_dv_preset_info instead of replacing it
with -EINVAL.
...
This should be v4l_err. The v4l_* functions are used when the first argument
is an i2c_client pointer. And I agree that this is not an ideal situation,
