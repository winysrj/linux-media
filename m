...
Received: from vps-vb.mhejs.net ([37.28.154.113]:50304 "EHLO vps-vb.mhejs.net"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1756708AbdJJVx7 (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Tue, 10 Oct 2017 17:53:59 -0400
From: "Maciej S. Szmigiero" <mail@maciej.szmigiero.name>
Subject: [PATCH v2 5/6] [media] cxusb: implement Medion MD95700 digital /
 analog coexistence
...
Message-ID: <f80a8f9e-f142-086e-9160-aea829eac9dc@maciej.szmigiero.name>
Date: Tue, 10 Oct 2017 23:36:55 +0200
MIME-Version: 1.0
...
+		   u8 cmd, u8 *wbuf, int wlen, u8 *rbuf, int rlen)
 {
 	...
 	int ret;
@@ -88,7 +121,8 @@ static void cxusb_gpio_tuner(struct dvb_usb_device *d, int onoff)
 	struct cxusb_state *st = d->priv;
 	u8 o[2], i;
...
+	    !st->gpio_write_refresh[GPIO_TUNER])
 	...
 	o[0] = GPIO_TUNER;
@@ -99,6 +133,7 @@ static void cxusb_gpio_tuner(struct dvb_usb_device *d, int onoff)
...
@@ -258,7 +293,7 @@ static int cxusb_i2c_xfer(struct i2c_adapter *adap, struct i2c_msg msg[],
...
+
 ...
 {
 	int ret;
@@ -351,11 +419,26 @@ static int cxusb_d680_dmb_power_ctrl(struct dvb_usb_device *d, int onoff)
...
@@ -630,9 +713,21 @@ static struct max2165_config mygica_d689_max2165_cfg = {
...
@@ -734,20 +829,105 @@ static int cxusb_mygica_d689_tuner_attach(struct dvb_usb_adapter *adap)
...
@@ -1383,6 +1563,101 @@ static int bluebird_patch_dvico_firmware_download(struct usb_device *udev,
 	return -EINVAL;
 }
...
@@ -1399,12 +1674,101 @@ static struct dvb_usb_device_properties cxusb_mygica_d689_properties;
...
+	} else if (0 == dvb_usb_device_init(intf, &cxusb_bluebird_lgh064f_properties,
 	    ...
 	    0 == dvb_usb_device_init(intf, &cxusb_bluebird_dee1601_properties,
 				     THIS_MODULE, NULL, adapter_nr) ||
@@ -1436,6 +1800,11 @@ static int cxusb_probe(struct usb_interface *intf,
 		return 0;
...
@@ -1444,6 +1813,9 @@ static void cxusb_disconnect(struct usb_interface *intf)
 	struct cxusb_state *st = d->priv;
...
+
 	...
 	if (client) {
@@ -1461,32 +1833,6 @@ static void cxusb_disconnect(struct usb_interface *intf)
 	dvb_usb_device_exit(intf);
 }
...
@@ -1563,13 +1909,16 @@ static struct dvb_usb_device_properties cxusb_medion_properties = {
...
@@ -2330,6 +2679,7 @@ module_usb_driver(cxusb_driver);
...
index 66429d7f69b5..52c7cd43ac26 100644
...
index 1da9e47553f5..3bf114e713e9 100644
...
@@ -233,6 +234,11 @@ enum dvb_usb_mode {
  *
...
@@ -274,6 +280,8 @@ struct dvb_usb_device_properties {
 	int        no_reconnect;
