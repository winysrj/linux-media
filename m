...
Received: from mail.free-electrons.com ([62.4.15.54]:52966 "EHLO
        mail.free-electrons.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1031551AbeBONcO (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Thu, 15 Feb 2018 08:32:14 -0500
...
Subject: [PATCH v4 2/2] v4l: cadence: Add Cadence MIPI-CSI2 TX driver
Date: Thu, 15 Feb 2018 14:31:57 +0100
Message-Id: <20180215133157.8043-3-maxime.ripard@bootlin.com>
In-Reply-To: <20180215133157.8043-1-maxime.ripard@bootlin.com>
References: <20180215133157.8043-1-maxime.ripard@bootlin.com>
...
index 000000000000..6d37b64db46f
--- /dev/null
...
+	int ret;
+
+	ret = v4l2_subdev_call(csi2tx->sink_subdev, video, s_stream, true);
+	if (ret)
+		return ret;
+
+	csi2tx_reset(csi2tx);
...
+	csi2tx->asd.match.fwnode = fwnode_graph_get_remote_port_parent(fwh);
