...
Received: from lb2-smtp-cloud2.xs4all.net ([194.109.24.25]:55500 "EHLO
	...
	by vger.kernel.org with ESMTP id S1752772AbcCYNK6 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 25 Mar 2016 09:10:58 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: dri-devel@lists.freedesktop.org, linux-samsung-soc@vger.kernel.org,
	linux-input@vger.kernel.org, lars@opdenkamp.eu,
	linux@arm.linux.org.uk, Hans Verkuil <hansverk@cisco.com>
Subject: [PATCHv14 12/18] cec: adv7604: add cec support.
Date: Fri, 25 Mar 2016 14:10:10 +0100
Message-Id: <1458911416-47981-13-git-send-email-hverkuil@xs4all.nl>
...
@@ -872,9 +886,9 @@ static int adv76xx_s_detect_tx_5v_ctrl(struct v4l2_subdev *sd)
 {
 	struct adv76xx_state *state = to_state(sd);
...
+
 ...
 {
 	struct adv76xx_state *state = to_state(sd);
@@ -1945,6 +2153,9 @@ static int adv76xx_isr(struct v4l2_subdev *sd, u32 status, bool *handled)
 			*handled = true;
 	}
...
+
 	...
 	if (tx_5v) {
@@ -1994,39 +2205,11 @@ static int adv76xx_get_edid(struct v4l2_subdev *sd, struct v4l2_edid *edid)
 	return 0;
 }
...
@@ -2066,9 +2249,13 @@ static int adv76xx_set_edid(struct v4l2_subdev *sd, struct v4l2_edid *edid)
...
@@ -2252,8 +2439,19 @@ static int adv76xx_log_status(struct v4l2_subdev *sd)
...
@@ -2389,6 +2587,13 @@ static const struct v4l2_subdev_video_ops adv76xx_video_ops = {
...
@@ -2404,6 +2609,7 @@ static const struct v4l2_subdev_ops adv76xx_ops = {
...
+	.cec = &adv76xx_cec_ops,
 ...
 /* -------------------------- custom ctrls ---------------------------------- */
@@ -3248,6 +3454,14 @@ static int adv76xx_remove(struct i2c_client *client)
