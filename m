...
Received: from smtp08.acens.net ([86.109.99.132]:61567 "EHLO smtp.movistar.es"
	rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
	id S1751461AbbAAVK4 (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Thu, 1 Jan 2015 16:10:56 -0500
Received: from ElGrande (83.56.11.105) by smtp.movistar.es (8.6.122.03) (authenticated as dcrypt$telefonica.net)
        id 549C742B003129D3 for linux-media@vger.kernel.org; Thu, 1 Jan 2015 21:04:24 +0000
From: "dCrypt" <dcrypt@telefonica.net>
To: <linux-media@vger.kernel.org>
Subject: [BUG] Dual tuner TV card, works using one tuner only, doesn't work if both tuners are used
Date: Thu, 1 Jan 2015 22:04:27 +0100
Message-ID: <007d01d02606$87552d70$95ff8850$@net>
MIME-Version: 1.0
