...
Received: from bear.ext.ti.com ([192.94.94.41]:53928 "EHLO bear.ext.ti.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1758100AbZFLQEj convert rfc822-to-8bit (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 12 Jun 2009 12:04:39 -0400
Received: from dlep36.itg.ti.com ([157.170.170.91])
	by bear.ext.ti.com (8.13.7/8.13.7) with ESMTP id n5CG4Zqp013208
	for <linux-media@vger.kernel.org>; Fri, 12 Jun 2009 11:04:40 -0500
Received: from dlep20.itg.ti.com (localhost [127.0.0.1])
	by dlep36.itg.ti.com (8.13.8/8.13.8) with ESMTP id n5CG4Z0L019099
	for <linux-media@vger.kernel.org>; Fri, 12 Jun 2009 11:04:35 -0500 (CDT)
Received: from dsbe71.ent.ti.com (localhost [127.0.0.1])
	by dlep20.itg.ti.com (8.12.11/8.12.11) with ESMTP id n5CG4ZB5028434
	for <linux-media@vger.kernel.org>; Fri, 12 Jun 2009 11:04:35 -0500 (CDT)
From: "Karicheri, Muralidharan" <m-karicheri2@ti.com>
To: "linux-media@vger.kernel.org" <linux-media@vger.kernel.org>
Date: Fri, 12 Jun 2009 11:04:34 -0500
Subject: [PATCH (V2)] TVP514x: Migration to sub-device framework - Is it
 approved ???
Message-ID: <A69FA2915331DC488A831521EAE36FE40139A0963F@dlee06.ent.ti.com>
...
This patch is sent for review last month. I have posted a vpfe capture driver patch that is dependent on this one. Is this one close to approval or
what is the plan?

I see some updates required to this patch based on my patch for supporting bus parameter which is being reviewed currently.
...
>Subject: [PATCH (V2)] TVP514x: Migration to sub-device framework
>
...
>               }
>       }
>@@ -339,17 +326,15 @@ static int tvp514x_write_regs(struct i2c_client
>*client,
...
>@@ -369,70 +354,71 @@ static enum tvp514x_std
>tvp514x_get_current_std(struct tvp514x_decoder
> /*
...
>       return 0;
> }
>@@ -445,15 +431,17 @@ static int tvp514x_configure(struct tvp514x_decoder
>*decoder)
...
>@@ -462,19 +450,16 @@ static int tvp514x_detect(struct tvp514x_decoder
>*decoder)
...
> }
>
>@@ -483,17 +468,17 @@ static int tvp514x_detect(struct tvp514x_decoder
>*decoder)
>  * TVP5146/47 decoder driver.
>  */
>
>-/**
>- * ioctl_querystd - V4L2 decoder interface handler for VIDIOC_QUERYSTD
>ioctl
>- * @s: pointer to standard V4L2 device structure
>+/*
>+ * tvp514x_querystd - V4L2 decoder interface handler for VIDIOC_QUERYSTD
>ioctl
>+ * @sd: pointer to standard V4L2 sub-device structure
>  * @std_id: standard V4L2 std_id ioctl enum
>  *
>  * Returns the current standard detected by TVP5146/47. If no active input
>is
...
>@@ -502,11 +487,11 @@ static int ioctl_querystd(struct v4l2_int_device *s,
>v4l2_std_id *std_id)
>               return -EINVAL;
>
...
>@@ -544,42 +529,39 @@ static int ioctl_querystd(struct v4l2_int_device *s,
>v4l2_std_id *std_id)
>               return -EINVAL;
>       }
...
>       if (err)
>               return err;
>@@ -588,24 +570,24 @@ static int ioctl_s_std(struct v4l2_int_device *s,
>v4l2_std_id *std_id)
...
>
>-/**
>- * ioctl_s_routing - V4L2 decoder interface handler for VIDIOC_S_INPUT
>ioctl
>- * @s: pointer to standard V4L2 device structure
>+/*
>+ * tvp514x_s_routing - V4L2 decoder interface handler for VIDIOC_S_INPUT
>ioctl
>+ * @sd: pointer to standard V4L2 sub-device structure
>  * @index: number of the input
>  *
>  * If index is valid, selects the requested input. Otherwise, returns -
>EINVAL if
...
>
>-/**
>- * ioctl_queryctrl - V4L2 decoder interface handler for VIDIOC_QUERYCTRL
>ioctl
>- * @s: pointer to standard V4L2 device structure
>+/*
>+ * tvp514x_queryctrl - V4L2 decoder interface handler for VIDIOC_QUERYCTRL
>ioctl
>+ * @sd: pointer to standard V4L2 sub-device structure
...
>
>       if (qctrl == NULL)
>@@ -744,30 +724,27 @@ ioctl_queryctrl(struct v4l2_int_device *s, struct
...
>@@ -775,9 +752,9 @@ ioctl_queryctrl(struct v4l2_int_device *s, struct
>v4l2_queryctrl *qctrl)
>  * supported.
>  */
> static int
...
>       if (ctrl == NULL)
>               return -EINVAL;
>@@ -811,74 +788,70 @@ ioctl_g_ctrl(struct v4l2_int_device *s, struct
>v4l2_control *ctrl)
>
>               break;
>       default:
...
>               break;
>       case V4L2_CID_HUE:
>@@ -889,15 +862,13 @@ ioctl_s_ctrl(struct v4l2_int_device *s, struct
>v4l2_control *ctrl)
>               else if (value == 0)
>                       value = 0;
>               else {
...
>               break;
>       case V4L2_CID_AUTOGAIN:
>@@ -906,41 +877,38 @@ ioctl_s_ctrl(struct v4l2_int_device *s, struct
>v4l2_control *ctrl)
>               else if (value == 0)
>                       value = 0x0C;
>               else {
...
>- * @s: pointer to standard V4L2 device structure
>+/*
>+ * tvp514x_enum_fmt_cap - Implement the CAPTURE buffer VIDIOC_ENUM_FMT
>ioctl
>+ * @sd: pointer to standard V4L2 sub-device structure
...
>
>       if (fmt == NULL)
>@@ -956,16 +924,15 @@ ioctl_enum_fmt_cap(struct v4l2_int_device *s, struct
>v4l2_fmtdesc *fmt)
...
>@@ -973,9 +940,9 @@ ioctl_enum_fmt_cap(struct v4l2_int_device *s, struct
>v4l2_fmtdesc *fmt)
...
>       struct v4l2_pix_format *pix;
>       enum tvp514x_std current_std;
>@@ -989,7 +956,7 @@ ioctl_try_fmt_cap(struct v4l2_int_device *s, struct
>v4l2_format *f)
>       pix = &f->fmt.pix;
>
...
>               return -EINVAL;
>
>@@ -1012,17 +979,16 @@ ioctl_try_fmt_cap(struct v4l2_int_device *s, struct
>v4l2_format *f)
...
>- * @s: pointer to standard V4L2 device structure
>+/*
>+ * tvp514x_s_fmt_cap - V4L2 decoder interface handler for VIDIOC_S_FMT
>ioctl
>+ * @sd: pointer to standard V4L2 sub-device structure
>  * @f: pointer to standard V4L2 VIDIOC_S_FMT ioctl structure
>  *
>  * If the requested format is supported, configures the HW to use that
>@@ -1030,9 +996,9 @@ ioctl_try_fmt_cap(struct v4l2_int_device *s, struct
>v4l2_format *f)
...
>       int rval;
>
>@@ -1043,7 +1009,7 @@ ioctl_s_fmt_cap(struct v4l2_int_device *s, struct
>v4l2_format *f)
...
>               return rval;
>
>@@ -1052,18 +1018,18 @@ ioctl_s_fmt_cap(struct v4l2_int_device *s, struct
>v4l2_format *f)
>       return rval;
> }
>
...
>       if (f == NULL)
>               return -EINVAL;
>@@ -1073,25 +1039,24 @@ ioctl_g_fmt_cap(struct v4l2_int_device *s, struct
>v4l2_format *f)
>
...
>       enum tvp514x_std current_std;
>
>@@ -1105,7 +1070,7 @@ ioctl_g_parm(struct v4l2_int_device *s, struct
>v4l2_streamparm *a)
...
>               return -EINVAL;
>
>@@ -1119,18 +1084,18 @@ ioctl_g_parm(struct v4l2_int_device *s, struct
>v4l2_streamparm *a)
>       return 0;
> }
>
...
>       enum tvp514x_std current_std;
>
>@@ -1143,7 +1108,7 @@ ioctl_s_parm(struct v4l2_int_device *s, struct
>v4l2_streamparm *a)
...
>               return -EINVAL;
>
>@@ -1155,112 +1120,59 @@ ioctl_s_parm(struct v4l2_int_device *s, struct
>v4l2_streamparm *a)
>       return 0;
> }
>
...
>- * parameter.
>- */
>-static int ioctl_g_ifparm(struct v4l2_int_device *s, struct v4l2_ifparm
>*p)
>-{
>-      struct tvp514x_decoder *decoder = s->priv;
>-      int rval;
...
>- * @s: pointer to standard V4L2 device structure
>+/*
>+ * tvp514x_s_stream - V4L2 decoder interface handler for
>vidioc_int_s_power_num
>+ * @sd: pointer to standard V4L2 sub-device structure
...
>               err = -ENODEV;
>               break;
>@@ -1269,93 +1181,37 @@ static int ioctl_s_power(struct v4l2_int_device *s,
>enum v4l2_power on)
>       return err;
> }
>
