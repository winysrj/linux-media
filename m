...
Received: from hqemgate14.nvidia.com ([216.228.121.143]:19720 "EHLO
	hqemgate14.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751743AbbKKTuu (ORCPT
...
Date: Wed, 11 Nov 2015 11:50:46 -0800
Message-ID: <1447271448-30056-2-git-send-email-pengw@nvidia.com>
...
+	vb2_buffer_done(&vb->vb2_buf, ret < 0 ? VB2_BUF_STATE_ERROR : VB2_BUF_STATE_DONE);
+
+	return ret;
+}
+
...
+
+
+static int tegra_vi_graph_parse_one(struct tegra_vi *vi,
