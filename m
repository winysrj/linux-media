...
Received: from smtp-vbr9.xs4all.nl ([194.109.24.29]:2760 "EHLO
	smtp-vbr9.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751447Ab2JAO1r (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Mon, 1 Oct 2012 10:27:47 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: Arun Kumar K <arun.kk@samsung.com>
Subject: Re: [PATCH v8 2/6] [media] v4l: Add control definitions for new H264 encoder features
Date: Mon, 1 Oct 2012 16:27:26 +0200
...
References: <1349129099-6480-1-git-send-email-arun.kk@samsung.com> <1349129099-6480-3-git-send-email-arun.kk@samsung.com>
In-Reply-To: <1349129099-6480-3-git-send-email-arun.kk@samsung.com>
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="iso-8859-15"
Content-Transfer-Encoding: 7bit
Message-Id: <201210011627.26644.hverkuil@xs4all.nl>
