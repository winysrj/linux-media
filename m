...
Received: from mail.gmx.net ([213.165.64.20]:52851 "HELO mail.gmx.net"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with SMTP
	id S1754478Ab0C2HpC (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Mon, 29 Mar 2010 03:45:02 -0400
Date: Mon, 29 Mar 2010 09:45:02 +0200 (CEST)
From: Guennadi Liakhovetski <g.liakhovetski@gmx.de>
To: Linux Media Mailing List <linux-media@vger.kernel.org>
cc: Hans Verkuil <hverkuil@xs4all.nl>,
	Magnus Damm <damm@opensource.se>,
	"linux-sh@vger.kernel.org" <linux-sh@vger.kernel.org>
Subject: [PATCH 1/3 v3] V4L: SuperH Video Output Unit (VOU) driver
Message-ID: <Pine.LNX.4.64.1003290936280.4417@axis700.grange>
MIME-Version: 1.0
Content-Type: TEXT/PLAIN; charset=US-ASCII
Sender: linux-media-owner@vger.kernel.org
List-ID: <linux-media.vger.kernel.org>

>From 3d5844cb025a6489c80a17aa78f54efceadd03b1 Mon Sep 17 00:00:00 2001
From: Guennadi Liakhovetski <g.liakhovetski@gmx.de>
Date: Wed, 17 Mar 2010 15:21:13 +0100
Subject: [PATCH 1/3] V4L: SuperH Video Output Unit (VOU) driver
...
1. Added "Mobile" in the patch description

2. Changed Kconfig to only depend on ARCH_SHMOBILE, instead of (SUPERH || 
   ARCH_SHMOBILE)

3. Added an Acked-by from Paul Mundt
...
index b88b617..ed52b6b 100644
--- a/drivers/media/video/Makefile
+++ b/drivers/media/video/Makefile
@@ -162,6 +162,8 @@ obj-$(CONFIG_VIDEO_SH_MOBILE_CEU)	+= sh_mobile_ceu_camera.o
