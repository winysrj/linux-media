...
Received: from el-out-1112.google.com ([209.85.162.179])
	...
	(envelope-from <bvidinli@gmail.com>) id 1JzSQT-0005nL-VV
	for linux-dvb@linuxtv.org; Fri, 23 May 2008 10:15:03 +0200
Received: by el-out-1112.google.com with SMTP id v27so302392ele.14
	for <linux-dvb@linuxtv.org>; Fri, 23 May 2008 01:14:53 -0700 (PDT)
Message-ID: <36e8a7020805230114t2db02c90yd5ba372dce9fe417@mail.gmail.com>
Date: Fri, 23 May 2008 11:14:51 +0300
From: bvidinli <bvidinli@gmail.com>
To: stev391@email.com, linux-dvb@linuxtv.org
MIME-Version: 1.0
Content-Disposition: inline
Subject: [linux-dvb] PartialSuccess: Avermedia DVB-S Hybrid+FM A700 on
	ubuntu 8.04, kernel 2.6.24-16-generic (bvidinli)
...
i fixed what you said, i did not know before that modules directory is
scanned for all files..

now, i removed all old files from modules directory, rerun depmod -a
modprobe saa7134 i2c_scan=3D1

logs are as below, i see in logs nm_hal_device_added() ... this means
something happened, some dvb devices recognized by system.
But when i run tvtime, only two inputs present... svideo and composit...

Question: do you have any idea to use dvb or air-tv in inputs...  ?

Thanks..

i also modified the script i sent before for whoever needs... below logs...

May 23 11:04:18 bvidinli-desktop kernel: [34757.661135] saa7130/34:
v4l2 driver version 0.2.14 loaded
May 23 11:04:18 bvidinli-desktop kernel: [34757.662512] saa7133[0]:
found at 0000:00:14.0, rev: 209, irq: 10, latency: 32, mmio:
0xde003000
May 23 11:04:18 bvidinli-desktop kernel: [34757.662537] saa7133[0]:
subsystem: 1461:a7a2, board: Avermedia DVB-S Hybrid+FM A700
[card=3D141,autodetected]
May 23 11:04:18 bvidinli-desktop kernel: [34757.662565] saa7133[0]:
board init: gpio is 6fb00
May 23 11:04:18 bvidinli-desktop kernel: [34757.811083] saa7133[0]:
i2c eeprom 00: 61 14 a2 a7 ff ff ff ff ff ff ff ff ff ff ff ff
May 23 11:04:18 bvidinli-desktop kernel: [34757.811119] saa7133[0]:
i2c eeprom 10: ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff
May 23 11:04:18 bvidinli-desktop kernel: [34757.811142] saa7133[0]:
i2c eeprom 20: ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff
May 23 11:04:18 bvidinli-desktop kernel: [34757.811166] saa7133[0]:
i2c eeprom 30: ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff
May 23 11:04:18 bvidinli-desktop kernel: [34757.811189] saa7133[0]:
i2c eeprom 40: ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff
May 23 11:04:18 bvidinli-desktop kernel: [34757.811213] saa7133[0]:
i2c eeprom 50: ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff
May 23 11:04:18 bvidinli-desktop kernel: [34757.811236] saa7133[0]:
i2c eeprom 60: ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff
May 23 11:04:18 bvidinli-desktop kernel: [34757.811260] saa7133[0]:
i2c eeprom 70: ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff
May 23 11:04:18 bvidinli-desktop kernel: [34757.811283] saa7133[0]:
i2c eeprom 80: ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff
May 23 11:04:18 bvidinli-desktop kernel: [34757.811307] saa7133[0]:
i2c eeprom 90: ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff
May 23 11:04:18 bvidinli-desktop kernel: [34757.811330] saa7133[0]:
i2c eeprom a0: ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff
May 23 11:04:18 bvidinli-desktop kernel: [34757.811354] saa7133[0]:
i2c eeprom b0: ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff
May 23 11:04:18 bvidinli-desktop kernel: [34757.811377] saa7133[0]:
i2c eeprom c0: ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff
May 23 11:04:18 bvidinli-desktop kernel: [34757.811401] saa7133[0]:
i2c eeprom d0: ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff
May 23 11:04:18 bvidinli-desktop kernel: [34757.811424] saa7133[0]:
i2c eeprom e0: 00 01 81 af fe f6 ff ff ff ff ff ff ff ff ff ff
May 23 11:04:18 bvidinli-desktop kernel: [34757.811447] saa7133[0]:
i2c eeprom f0: ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff ff
May 23 11:04:19 bvidinli-desktop kernel: [34757.842981] saa7133[0]:
i2c scan: found device @ 0x1c  [???]
May 23 11:04:19 bvidinli-desktop kernel: [34757.862993] saa7133[0]:
i2c scan: found device @ 0xa0  [eeprom]
May 23 11:04:19 bvidinli-desktop kernel: [34757.874976] saa7133[0]:
i2c scan: found device @ 0xc2  [???]
May 23 11:04:19 bvidinli-desktop kernel: [34757.921147] saa7133[0]:
registered device video0 [v4l2]
May 23 11:04:19 bvidinli-desktop kernel: [34757.922529] saa7133[0]:
registered device vbi0
May 23 11:04:19 bvidinli-desktop NetworkManager: <debug>
[1211529859.309776] nm_hal_device_added(): New device added (hal udi
is '/org/freedesktop/Hal/devices/pci_1131_7133_video4linux').
May 23 11:04:19 bvidinli-desktop kernel: [34758.234914]
zl10036_attach: tuner initialization (Zarlink ZL10036 addr=3D0x60) ok
May 23 11:04:19 bvidinli-desktop kernel: [34758.234935] DVB:
registering new adapter (saa7133[0])
May 23 11:04:19 bvidinli-desktop kernel: [34758.234948] DVB:
registering frontend 0 (Zarlink ZL10313 DVB-S)...
May 23 11:04:19 bvidinli-desktop NetworkManager: <debug>
[1211529859.562150] nm_hal_device_added(): New device added (hal udi
is '/org/freedesktop/Hal/devices/pci_1131_7133_dvb').
May 23 11:04:19 bvidinli-desktop NetworkManager: <debug>
[1211529859.704262] nm_hal_device_added(): New device added (hal udi
is '/org/freedesktop/Hal/devices/pci_1131_7133_dvb_0').
May 23 11:04:19 bvidinli-desktop NetworkManager: <debug>
[1211529859.806147] nm_hal_device_added(): New device added (hal udi
is '/org/freedesktop/Hal/devices/pci_1131_7133_dvb_1').
May 23 11:04:19 bvidinli-desktop NetworkManager: <debug>
[1211529859.892382] nm_hal_device_added(): New device added (hal udi
is '/org/freedesktop/Hal/devices/pci_1131_7133_dvb_2').


script to install new dvb drivers on ubuntu:
...
# first, backup all in case we need them...
cd /lib/modules/`uname -r`/kernel/drivers/
sudo cp -rvf media /root/backup/media.bck

cd /lib/modules/`uname -r`/ubuntu/media
sudo cp -rvf saa7134 /root/backup/saa7134.bck
...
2008/5/23  <stev391@email.com>:
>
> One obvious error in you script is that it just moves the old modules aro=
und
> in the modules directory.  You have to move them completely out of the
> modules directory, else depmod will still find them and possible use them
...
> # goto where you got your v4l files by hg
> cd ~/v4l-dvb/v4l
> sudo cp -f ir-common.ko /lib/modules/`uname -r`/kernel/drivers/media/comm=
on/
> sudo cp -f saa7146.ko /lib/modules/`uname -r`/kernel/drivers/media/common/
...
> sudo cp -f saa7134-empress.ko /lib/modules/`uname -r`/ubuntu/media/saa713=
4/
...
>>> [ 4261.605140] saa7134: disagrees about version of symbol videobuf_wait=
on
...
>>> [ 4261.610871] saa7134: disagrees about version of symbol videobuf_iolo=
ck
...
>>> [ 4261.612426] saa7134: disagrees about version of symbol videobuf_cgmb=
uf
>>> [ 4261.612434] saa7134: Unknown symbol videobuf_cgmbuf
>>> [ 4261.612908] saa7134: disagrees about version of symbol videobuf_to_d=
ma
...
>>>> bvidibli,
>>>>
>>>> To get this working try removing all modules(all files) in the followi=
ng
>>>> directories:
...
>>>> [ 48.939134] saa7134: disagrees about version of symbol videobuf_reqbu=
fs
...
>>>> [ 2023.528438] saa7134: disagrees about version of symbol videobuf_dqb=
uf
