...
Received: from mail.bootlin.com ([62.4.15.54]:46935 "EHLO mail.bootlin.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1751150AbeFUI6b (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Thu, 21 Jun 2018 04:58:31 -0400
Message-ID: <518c9c9297e2f0e62961b20f2a6d161d6ab1ddc3.camel@bootlin.com>
...
Date: Thu, 21 Jun 2018 10:58:18 +0200
...
Content-Type: multipart/signed; micalg="pgp-sha256";
        protocol="application/pgp-signature"; boundary="=-M9YpxwFOIMjR4kfT+gGN"
Mime-Version: 1.0
Sender: linux-media-owner@vger.kernel.org
List-ID: <linux-media.vger.kernel.org>


--=-M9YpxwFOIMjR4kfT+gGN
...
>  	case V4L2_CID_MPEG_VIDEO_H264_HIERARCHICAL_CODING_LAYER:return "H264 Nu=
mber of HC Layers";
...
rix";
> +	case V4L2_CID_MPEG_VIDEO_H264_SLICE_PARAM:		return "H264 Slice Paramete=
rs";
...
> +	case V4L2_CID_MPEG_VIDEO_H264_DECODE_PARAM:		return "H264 Decode Parame=
ters";
...
lue";
>  	case V4L2_CID_MPEG_VIDEO_MPEG4_P_FRAME_QP:		return "MPEG4 P-Frame QP Va=
lue";
>  	case V4L2_CID_MPEG_VIDEO_MPEG4_B_FRAME_QP:		return "MPEG4 B-Frame QP Va=
lue";
> @@ -1272,6 +1277,21 @@ void v4l2_ctrl_fill(u32 id, const char **name, enu=
...
> +		*type =3D V4L2_CTRL_TYPE_H264_SLICE_PARAM;
> +		break;
> +	case V4L2_CID_MPEG_VIDEO_H264_DECODE_PARAM:
> +		*type =3D V4L2_CTRL_TYPE_H264_DECODE_PARAM;
> +		break;
>  	case V4L2_CID_MPEG_VIDEO_MPEG2_FRAME_HDR:
>  		*type =3D V4L2_CTRL_TYPE_MPEG2_FRAME_HDR;
>  		break;
> @@ -1598,6 +1618,13 @@ static int std_validate(const struct v4l2_ctrl *ct=
rl, u32 idx,
...
>  		return -EINVAL;
>  	}
> @@ -2172,6 +2199,21 @@ static struct v4l2_ctrl *v4l2_ctrl_new(struct v4l2=
_ctrl_handler *hdl,
...
>  };
>  #define V4L2_CID_MPEG_VIDEO_H264_HIERARCHICAL_CODING_LAYER	(V4L2_CID_MPE=
G_BASE+381)
>  #define V4L2_CID_MPEG_VIDEO_H264_HIERARCHICAL_CODING_LAYER_QP	(V4L2_CID_=
MPEG_BASE+382)
...
> +#define V4L2_H264_PPS_FLAG_BOTTOM_FIELD_PIC_ORDER_IN_FRAME_PRESENT	0x000=
2
...
> +	V4L2_H264_SLICE_TYPE_P			=3D 0,
> +	V4L2_H264_SLICE_TYPE_B			=3D 1,
> +	V4L2_H264_SLICE_TYPE_I			=3D 2,
> +	V4L2_H264_SLICE_TYPE_SP			=3D 3,
> +	V4L2_H264_SLICE_TYPE_SI			=3D 4,
> +};
>
...
> +	V4L2_CTRL_TYPE_H264_SPS      =3D 0x0103,
> +	V4L2_CTRL_TYPE_H264_PPS      =3D 0x0104,
> +	V4L2_CTRL_TYPE_H264_SCALING_MATRIX =3D 0x0105,
> +	V4L2_CTRL_TYPE_H264_SLICE_PARAM =3D 0x0106,
> +	V4L2_CTRL_TYPE_H264_DECODE_PARAM =3D 0x0107,
...

=9CIn
-----END PGP SIGNATURE-----
