...
Received: from smtp-vbr4.xs4all.nl ([194.109.24.24]:4453 "EHLO
	smtp-vbr4.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753196Ab0EPNUV (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sun, 16 May 2010 09:20:21 -0400
Message-Id: <88eeb1dc4209ee894a9995b0a1befbfe4240bf82.1274015085.git.hverkuil@xs4all.nl>
In-Reply-To: <cover.1274015084.git.hverkuil@xs4all.nl>
References: <cover.1274015084.git.hverkuil@xs4all.nl>
From: Hans Verkuil <hverkuil@xs4all.nl>
Date: Sun, 16 May 2010 15:21:55 +0200
Subject: [PATCH 14/15] [RFCv2] ivtv: convert gpio subdev to new control framework.
