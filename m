...
Received: from perceval.ideasonboard.com ([95.142.166.194]:51318 "EHLO
	...
	with ESMTP id S1757457Ab0LTLiB (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 20 Dec 2010 06:38:01 -0500
From: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
To: linux-media@vger.kernel.org
Cc: sakari.ailus@maxwell.research.nokia.com
Subject: [RFC/PATCH v5 13/13] v4l: v4l2_subdev userspace crop API
Date: Mon, 20 Dec 2010 12:37:25 +0100
Message-Id: <1292845045-7945-14-git-send-email-laurent.pinchart@ideasonboard.com>
...
index 8f9001c..09d1db0 100644
--- a/drivers/media/video/v4l2-subdev.c
+++ b/drivers/media/video/v4l2-subdev.c
@@ -215,6 +215,32 @@ static long subdev_do_ioctl(struct file *file, unsigned int cmd, void *arg)
