...
Received: from devils.ext.ti.com ([198.47.26.153]:39048 "EHLO
	devils.ext.ti.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752727AbbLKWQo (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 11 Dec 2015 17:16:44 -0500
Date: Fri, 11 Dec 2015 16:16:33 -0600
...
Subject: Re: [Patch v5 1/2] media: v4l: ti-vpe: Add CAL v4l2 camera capture
 driver
Message-ID: <20151211221633.GF1517@ti.com>
...
In-Reply-To: <20151203111922.7b9bb226@recife.lan>
...
This in invoke as part start_streaming() so it cannot really be split.
I'll add a loop counter to prevent the infinite loop case.
...
Understood but it is not used anywhere else so I was going for
...
Thanks for this, I'll be removing the crap code.
> 
> > +
...
Yep left over code, will remove.
> 
> > +
