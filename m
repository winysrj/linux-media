...
Received: from vps-vb.mhejs.net ([37.28.154.113]:50072 "EHLO vps-vb.mhejs.net"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1756635AbdJJVxo (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Tue, 10 Oct 2017 17:53:44 -0400
From: "Maciej S. Szmigiero" <mail@maciej.szmigiero.name>
Subject: [PATCH v2 6/6] [media] cxusb: add analog mode support for Medion
 MD95700
...
Message-ID: <97e2593b-02c9-5195-ed67-0dd1c5130907@maciej.szmigiero.name>
Date: Tue, 10 Oct 2017 23:37:51 +0200
MIME-Version: 1.0
...
index 000000000000..c04c7c0493a9
--- /dev/null
...
+			unsigned int idx;
+			unsigned int tocheck = clamp_t(size_t,
+						       maxlinesamples / 4,
+						       3, sizeof(buf));
+
+			if (!cxusb_auxbuf_copy(auxbuf, bt656->pos + 1,
...
index f73ffa13d177..a232b22162d6 100644
...
@@ -2681,5 +2680,5 @@ MODULE_AUTHOR("Michael Krufky <mkrufky@linuxtv.org>");
...
index 52c7cd43ac26..895aba88d9c8 100644
...
@@ -53,6 +82,29 @@ enum cxusb_open_type {
...
@@ -62,31 +114,67 @@ struct cxusb_medion_dev {
