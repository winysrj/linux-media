...
Received: from mail.gmx.net ([213.165.64.20]:50063 "HELO mail.gmx.net"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with SMTP
	id S1751046AbZKIUnZ (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Mon, 9 Nov 2009 15:43:25 -0500
Received: from lyakh (helo=localhost)
	by axis700.grange with local-esmtp (Exim 4.63)
	(envelope-from <g.liakhovetski@gmx.de>)
	id 1N7b54-0002bj-42
	for linux-media@vger.kernel.org; Mon, 09 Nov 2009 21:43:18 +0100
Date: Mon, 9 Nov 2009 21:43:18 +0100 (CET)
From: Guennadi Liakhovetski <g.liakhovetski@gmx.de>
To: Linux Media Mailing List <linux-media@vger.kernel.org>
Subject: [PATCH] sh_mobile_ceu_camera: document the scaling and cropping
 algorithm
Message-ID: <Pine.LNX.4.64.0911092141180.4289@axis700.grange>
MIME-Version: 1.0
