...
Received: from perceval.ideasonboard.com ([95.142.166.194]:57091 "EHLO
	perceval.ideasonboard.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752953Ab1GaKzR (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sun, 31 Jul 2011 06:55:17 -0400
From: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
To: linux-media@vger.kernel.org
Cc: javier.martin@vista-silicon.com
Subject: [PATCH v2] mt9p031: Aptina (Micron) MT9P031 5MP sensor driver
Date: Sun, 31 Jul 2011 12:55:22 +0200
Message-Id: <1312109722-30331-1-git-send-email-laurent.pinchart@ideasonboard.com>
...
- store a pointer to struct mt9p031_pll_divs in struct mt9p031
- replace swab16() with be16_to_cpu()/cpu_to_be16()
- replace mdelay()/msleep() with usleep_range()
- use ARRAY_SIZE instead of hardcoding the number of controls
- return an error from probe() if pdata is NULL
- clean up properly if an error occurs in probe()
- call v4l2_ctrl_handler_free() in remove()
