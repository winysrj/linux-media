...
Received: from lb3-smtp-cloud2.xs4all.net ([194.109.24.29]:55973 "EHLO
	...
	by vger.kernel.org with ESMTP id S1754560AbcBEP2a (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 5 Feb 2016 10:28:30 -0500
...
Subject: [PATCHv11 10/17] DocBook/media: add CEC documentation
Date: Fri,  5 Feb 2016 16:27:53 +0100
Message-Id: <1454686080-39018-11-git-send-email-hverkuil@xs4all.nl>
...
---
 ...
 19 files changed, 1857 insertions(+), 1 deletion(-)
...
index cdd8b24..bd4dc59 100644
--- a/Documentation/DocBook/device-drivers.tmpl
+++ b/Documentation/DocBook/device-drivers.tmpl
@@ -268,6 +268,9 @@ X!Isound/sound_firmware.c
...
+	    for that filehandle with the CEC Adapter's state at that time.</entry>
+	  </row>
+	  <row>
...
+	  <row>
+	    <entry>__u8</entry>
+	    <entry><structfield>reserved</structfield>[34]</entry>
+	    <entry>Reserved for future extensions. Drivers and applications must
+	    set this array to zero.</entry>
+	  </row>
+	</tbody>
