...
Received: from mx3.redhat.com (mx3.redhat.com [172.16.48.32])
	by int-mx1.corp.redhat.com (8.13.1/8.13.1) with ESMTP id mASCi8UD010408
	for <video4linux-list@redhat.com>; Fri, 28 Nov 2008 07:44:08 -0500
Received: from devils.ext.ti.com (devils.ext.ti.com [198.47.26.153])
	by mx3.redhat.com (8.13.8/8.13.8) with ESMTP id mASCi4Su015673
	for <video4linux-list@redhat.com>; Fri, 28 Nov 2008 07:44:04 -0500
From: hvaibhav@ti.com
To: video4linux-list@redhat.com
Date: Fri, 28 Nov 2008 18:13:48 +0530
Message-Id: <1227876228-16553-1-git-send-email-hvaibhav@ti.com>
...
FIXSES:
    No need for TVP514X_DEBUG macro:
        Removed this macro and the level of debugging
        made boolean.

    Use v4l_ macros for debug/error messages:
        Done.

    Seperation of header file:
        Created tvp514x_regs.h header file locally.

    input/output ioctls:
        For V4L2-int interface we do need these ioctls,
        may not required with the new "sub-devices"
        framework.
        Talking to Hans on this to get aligned on this.
...
---
 ...
 drivers/media/video/tvp514x.c      | 1520 ++++++++++++++++++++++++++++++++++++
 drivers/media/video/tvp514x_regs.h |  270 +++++++
 include/media/tvp514x.h            |  240 ++++++
...
+						REG_OPERATION_MODE, 0x01);
+			err |=
+				tvp514x_write_reg(decoder->client,
+						REG_OPERATION_MODE, 0x00);
