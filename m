...
Received: from atrey.karlin.mff.cuni.cz ([195.113.26.193]:40588 "EHLO
        atrey.karlin.mff.cuni.cz" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S933605AbcLVKBH (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Thu, 22 Dec 2016 05:01:07 -0500
Date: Thu, 22 Dec 2016 11:01:04 +0100
...
Message-ID: <20161222100104.GA30917@amd>
...
---
=46rom v5: fix 16bit writing so that swab() is not neccessary.
...
+			  1, 0);
+
+	max_rows =3D sensor->current_reglist->mode.max_exp;
+	{
+		u32 min =3D 1, max =3D max_rows;
+
+		sensor->exposure =3D
+			v4l2_ctrl_new_std(&sensor->ctrl_handler, &et8ek8_ctrl_ops,
...
iEYEARECAAYFAlhbpGAACgkQMOfwapXb+vJtdwCaAp26AjzNdOgtIIv6xkNp7+TM
w50An13RiYt4jQjx/lGg9N/RoRoBhsLw
=WR5Y
-----END PGP SIGNATURE-----
