...
Received: from mailout4.w1.samsung.com ([210.118.77.14]:8574 "EHLO
	...
	with ESMTP id S1755361Ab0G3Itv (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 30 Jul 2010 04:49:51 -0400
MIME-version: 1.0
...
Received: from linux.samsung.com ([106.116.38.10])
 ...
 2004)) with ESMTPA id <0L6D00JUV4IZCD@spt2.w1.samsung.com> for
 linux-media@vger.kernel.org; Fri, 30 Jul 2010 09:49:48 +0100 (BST)
Date: Fri, 30 Jul 2010 10:49:41 +0200
From: Pawel Osciak <p.osciak@samsung.com>
Subject: [PATCH v5 1/3] v4l: Add multi-planar API definitions to the V4L2 API
...
Message-id: <1280479783-23945-2-git-send-email-p.osciak@samsung.com>
