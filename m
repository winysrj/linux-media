...
Received: from lb3-smtp-cloud2.xs4all.net ([194.109.24.29]:50712 "EHLO
	lb3-smtp-cloud2.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1753162AbcBEPfF (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 5 Feb 2016 10:35:05 -0500
...
Subject: [PATCHv11 15/17] cec: s5p-cec: Add s5p-cec driver
Date: Fri,  5 Feb 2016 16:27:58 +0100
Message-Id: <1454686080-39018-16-git-send-email-hverkuil@xs4all.nl>
...
index df1f4bf..5405876 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -1533,6 +1533,13 @@ L:	linux-media@vger.kernel.org
 S:	Maintained
...
+}
+
+static int s5p_cec_adap_transmit(struct cec_adapter *adap, u8 *retries,
...
+		break;
+	case STATE_ERROR:
+		cec_transmit_done(cec->adap, CEC_TX_STATUS_MAX_RETRIES, 0, 0, 0);
+		cec->tx = STATE_IDLE;
+		break;
+	case STATE_BUSY:
