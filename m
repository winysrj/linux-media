...
Received: from mx3.redhat.com (mx3.redhat.com [172.16.48.32])
	by int-mx1.corp.redhat.com (8.13.1/8.13.1) with ESMTP id m9GBkWqL009673
	for <video4linux-list@redhat.com>; Thu, 16 Oct 2008 07:46:32 -0400
Received: from mail01.idc.renesas.com (mail.renesas.com [202.234.163.13])
	by mx3.redhat.com (8.13.8/8.13.8) with ESMTP id m9GBkK0e027563
	for <video4linux-list@redhat.com>; Thu, 16 Oct 2008 07:46:21 -0400
Date: Thu, 16 Oct 2008 20:33:04 +0900
From: Kuninori Morimoto <morimoto.kuninori@renesas.com>
To: V4L <video4linux-list@redhat.com>
Message-id: <uzll4930b.wl%morimoto.kuninori@renesas.com>
MIME-version: 1.0 (generated by SEMI 1.14.6 - "Maruoka")
Content-type: text/plain; charset=US-ASCII
Cc: mchehab@infradead.org
Subject: [PATCH v3] Add ov772x driver
...
---
PATCH v3
remove color_bar mode
add ov772x_get/set_register fucntion
add V4L2_IDENT_OV772X in v4l2-chip-ident.h
it use struct soc_camera_link

 drivers/media/video/Kconfig     |    6 +
 drivers/media/video/Makefile    |    1 +
 drivers/media/video/ov772x.c    |  982 +++++++++++++++++++++++++++++++++++++++
