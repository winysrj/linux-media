...
Received: from mail-pd0-f177.google.com ([209.85.192.177]:63640 "EHLO
	mail-pd0-f177.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751014AbaJUFKl (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 21 Oct 2014 01:10:41 -0400
From: Yoshihiro Kaneko <ykaneko0929@gmail.com>
To: linux-media@vger.kernel.org
Cc: Guennadi Liakhovetski <g.liakhovetski@gmx.de>,
	Simon Horman <horms@verge.net.au>,
	Magnus Damm <magnus.damm@gmail.com>, linux-sh@vger.kernel.org
Subject: [PATCH v3 1/3] media: soc_camera: rcar_vin: Add scaling support
Date: Tue, 21 Oct 2014 14:10:27 +0900
Message-Id: <1413868229-22205-2-git-send-email-ykaneko0929@gmail.com>
...
+
 enum rcar_vin_state {
 	STOPPED = 0,
 	RUNNING,
@@ -163,6 +505,9 @@ struct rcar_vin_cam {
...
@@ -676,6 +1021,61 @@ static void rcar_vin_clock_stop(struct soc_camera_host *ici)
...
+
 ...
 {
@@ -685,6 +1085,7 @@ static int rcar_vin_set_rect(struct soc_camera_device *icd)
...
@@ -704,40 +1105,65 @@ static int rcar_vin_set_rect(struct soc_camera_device *icd)
...
@@ -1016,6 +1442,8 @@ static int rcar_vin_get_formats(struct soc_camera_device *icd, unsigned int idx,
 		cam->subrect = rect;
 		cam->width = mf.width;
...
@@ -1272,6 +1700,9 @@ static int rcar_vin_set_fmt(struct soc_camera_device *icd,
...
+
 	...
 	priv->field = field;
@@ -1323,8 +1754,12 @@ static int rcar_vin_try_fmt(struct soc_camera_device *icd,
 	if (ret < 0)
 		return ret;
