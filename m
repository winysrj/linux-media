...
Received: from service87.mimecast.com ([91.220.42.44]:52946 "EHLO
	service87.mimecast.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S936119Ab3DRRdk (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 18 Apr 2013 13:33:40 -0400
...
Date: Thu, 18 Apr 2013 18:33:21 +0100
Message-Id: <1366306402-21651-1-git-send-email-pawel.moll@arm.com>
In-Reply-To: <20130418102444.GL14496@n2100.arm.linux.org.uk>
References: <20130418102444.GL14496@n2100.arm.linux.org.uk>
...
+=09=09panel->caps &=3D ~CLCD_CAP_RGB;
+=09else
+=09=09panel->caps &=3D ~CLCD_CAP_BGR;
+
+=09return 0;
+}
+
...
@@ -549,6 +793,9 @@ static int clcdfb_probe(struct amba_device *dev, const =
struct amba_id *id)
 =09int ret;
=20
 =09if (!board)
