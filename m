...
Received: from lb1-smtp-cloud2.xs4all.net ([194.109.24.21]:58825 "EHLO
	lb1-smtp-cloud2.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1750969AbbCTMR0 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 20 Mar 2015 08:17:26 -0400
Message-ID: <550C0FCF.4030302@xs4all.nl>
Date: Fri, 20 Mar 2015 13:17:19 +0100
From: Hans Verkuil <hverkuil@xs4all.nl>
MIME-Version: 1.0
To: "linux-media@vger.kernel.org" <linux-media@vger.kernel.org>,
	Philipp Zabel <p.zabel@pengutronix.de>,
	Laurent Pinchart <laurent.pinchart@ideasonboard.com>
Subject: [RFC PATCH] v4l2-ioctl: fill in the description for VIDIOC_ENUM_FMT
...
+
 ...
 {
@@ -1110,34 +1309,43 @@ static int v4l_enum_fmt(const struct v4l2_ioctl_ops *ops,
