...
Received: from mail-pa0-f47.google.com ([209.85.220.47]:48121 "EHLO
	mail-pa0-f47.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1754419AbaJNG1M (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 14 Oct 2014 02:27:12 -0400
From: Yoshihiro Kaneko <ykaneko0929@gmail.com>
To: linux-media@vger.kernel.org
Cc: Guennadi Liakhovetski <g.liakhovetski@gmx.de>,
	Simon Horman <horms@verge.net.au>,
	Magnus Damm <magnus.damm@gmail.com>, linux-sh@vger.kernel.org
Subject: [PATCH 1/3] media: soc_camera: rcar_vin: Add scaling support
Date: Tue, 14 Oct 2014 15:26:51 +0900
Message-Id: <1413268013-8437-2-git-send-email-ykaneko0929@gmail.com>
...
+
 enum rcar_vin_state {
 	STOPPED = 0,
 	RUNNING,
@@ -164,6 +508,9 @@ struct rcar_vin_cam {
...
@@ -705,40 +1108,65 @@ static int rcar_vin_set_rect(struct soc_camera_device *icd)
...
@@ -1017,6 +1445,8 @@ static int rcar_vin_get_formats(struct soc_camera_device *icd, unsigned int idx,
 		cam->subrect = rect;
 		cam->width = mf.width;
...
@@ -1273,6 +1703,9 @@ static int rcar_vin_set_fmt(struct soc_camera_device *icd,
...
+
 	...
 	priv->field = field;
@@ -1324,8 +1757,12 @@ static int rcar_vin_try_fmt(struct soc_camera_device *icd,
 	if (ret < 0)
 		return ret;
