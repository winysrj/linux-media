...
Received: from mga01.intel.com ([192.55.52.88]:44197 "EHLO mga01.intel.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1750863AbbFRU74 (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Thu, 18 Jun 2015 16:59:56 -0400
Date: Fri, 19 Jun 2015 04:59:08 +0800
From: kbuild test robot <fengguang.wu@intel.com>
To: Mauro Carvalho Chehab <m.chehab@samsung.com>
Cc: kbuild-all@01.org, linux-media@vger.kernel.org
Subject: [linuxtv-media:media-controller 1277/1277]
 drivers/media/usb/au0828/au0828-cards.c:231:5: warning:
 "CONFIG_MEDIA_CONTROLLER" is not defined
Message-ID: <201506190406.72o5Wpyf%fengguang.wu@intel.com>
MIME-Version: 1.0
...
head:   61891e24706322835582f8b6b184be9adbf78427
commit: 61891e24706322835582f8b6b184be9adbf78427 [1277/1277] [media] au0828: Cache the decoder info at au0828 dev structure
...
vim +/CONFIG_MEDIA_CONTROLLER +231 drivers/media/usb/au0828/au0828-cards.c
 ...
 > 231	#if CONFIG_MEDIA_CONTROLLER
   232			if (sd)
   ...
   236	
   237		/* Setup tuners */
   238		if (dev->board.tuner_type != TUNER_ABSENT && dev->board.has_analog) {
   239			/* Load the tuner module, which does the attach */
