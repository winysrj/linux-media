...
Received: from smtp-vbr9.xs4all.nl ([194.109.24.29]:4755 "EHLO
	smtp-vbr9.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753015AbaB1Rmv (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 28 Feb 2014 12:42:51 -0500
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: pawel@osciak.com, s.nawrocki@samsung.com, m.szyprowski@samsung.com,
	laurent.pinchart@ideasonboard.com,
	Hans Verkuil <hans.verkuil@cisco.com>
Subject: [REVIEWv3 PATCH 11/17] vb2: only call start_streaming if sufficient buffers are queued
Date: Fri, 28 Feb 2014 18:42:09 +0100
Message-Id: <1393609335-12081-12-git-send-email-hverkuil@xs4all.nl>
...
@@ -1934,7 +1988,6 @@ static void __vb2_queue_cancel(struct vb2_queue *q)
...
-	struct vb2_buffer *vb;
 	...
 	if (type != q->type) {
@@ -1951,19 +2004,22 @@ static int vb2_internal_streamon(struct vb2_queue *q, enum v4l2_buf_type type)
