...
Received: from lb3-smtp-cloud2.xs4all.net ([194.109.24.29]:37570 "EHLO
	...
	by vger.kernel.org with ESMTP id S1751244AbcFYNGt (ORCPT
...
Subject: [PATCHv19 01/14] DocBook/media: add CEC documentation
Date: Sat, 25 Jun 2016 15:06:25 +0200
Message-Id: <1466859998-17640-2-git-send-email-hverkuil@xs4all.nl>
...
---
 ...
 15 files changed, 1732 insertions(+), 1 deletion(-)
