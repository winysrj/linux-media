...
Received: from mail.kernel.org ([198.145.29.99]:37450 "EHLO mail.kernel.org"
        ...
        id S1752397AbdIMLS7 (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Wed, 13 Sep 2017 07:18:59 -0400
From: Kieran Bingham <kieran.bingham+renesas@ideasonboard.com>
To: laurent.pinchart@ideasonboard.com,
        linux-renesas-soc@vger.kernel.org
Cc: linux-media@vger.kernel.org,
        Kieran Bingham <kieran.bingham+renesas@ideasonboard.com>
Subject: [PATCH v3 4/9] v4l: vsp1: Convert display lists to use new body pool
Date: Wed, 13 Sep 2017 12:18:43 +0100
Message-Id: <54f59e3f02937b94ae035c9375313c5bcae0d66e.1505299165.git-series.kieran.bingham+renesas@ideasonboard.com>
...
-	struct list_head gc_bodies;
 ...
 /* -----------------------------------------------------------------------------
@@ -284,89 +279,6 @@ void vsp1_dl_body_put(struct vsp1_dl_body *dlb)
...
-
  ...
  * @dlb: The body
@@ -392,11 +304,10 @@ void vsp1_dl_body_write(struct vsp1_dl_body *dlb, u32 reg, u32 data)
...
-	int ret;
 	...
 	if (!dl)
@@ -405,41 +316,39 @@ static struct vsp1_dl_list *vsp1_dl_list_alloc(struct vsp1_dl_manager *dlm)
...
@@ -493,18 +402,13 @@ static void __vsp1_dl_list_put(struct vsp1_dl_list *dl)
...
@@ -541,7 +445,7 @@ void vsp1_dl_list_put(struct vsp1_dl_list *dl)
  */
...
+	vsp1_dl_body_write(dl->body0, reg, data);
 ...
 /**
@@ -554,8 +458,7 @@ void vsp1_dl_list_write(struct vsp1_dl_list *dl, u32 reg, u32 data)
...
@@ -613,7 +516,7 @@ static void vsp1_dl_list_fill_header(struct vsp1_dl_list *dl, bool is_last)
 	 * list was allocated.
 	 */
...
@@ -686,9 +589,9 @@ static void vsp1_dl_list_hw_enqueue(struct vsp1_dl_list *dl)
...
@@ -871,45 +774,12 @@ void vsp1_dlm_reset(struct vsp1_dl_manager *dlm)
 	dlm->pending = NULL;
 }
...
@@ -924,13 +794,26 @@ struct vsp1_dl_manager *vsp1_dlm_create(struct vsp1_device *vsp1,
...
@@ -947,12 +830,10 @@ void vsp1_dlm_destroy(struct vsp1_dl_manager *dlm)
 	if (!dlm)
 		return;
