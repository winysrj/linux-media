...
Received: from mailout2.w1.samsung.com ([210.118.77.12]:17598 "EHLO
	...
	with ESMTP id S1758359Ab1GDRzt (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Mon, 4 Jul 2011 13:55:49 -0400
Date: Mon, 04 Jul 2011 19:55:06 +0200
From: Sylwester Nawrocki <s.nawrocki@samsung.com>
Subject: [PATCH v3 15/19] s5p-fimc: Add subdev for the FIMC processing block
In-reply-to: <1309802110-16682-1-git-send-email-s.nawrocki@samsung.com>
To: linux-media@vger.kernel.org, linux-samsung-soc@vger.kernel.org
Cc: m.szyprowski@samsung.com, kyungmin.park@samsung.com,
	s.nawrocki@samsung.com, sw0312.kim@samsung.com,
	riverful.kim@samsung.com
Message-id: <1309802110-16682-16-git-send-email-s.nawrocki@samsung.com>
MIME-version: 1.0
...
@@ -358,7 +386,6 @@ static int fimc_capture_mmap(struct file *file, struct vm_area_struct *vma)
...
@@ -368,6 +395,143 @@ static const struct v4l2_file_operations fimc_capture_fops = {
...
+ */
 ...
 {
@@ -398,11 +562,86 @@ static int fimc_cap_enum_fmt_mplane(struct file *file, void *priv,
 	return 0;
 }
...
@@ -419,53 +658,98 @@ static int fimc_cap_g_fmt_mplane(struct file *file, void *fh,
...
@@ -496,12 +780,70 @@ static int fimc_cap_g_input(struct file *file, void *priv, unsigned int *i)
 	return 0;
 }
...
+	int ret;
 	...
 	if (fimc_capture_active(fimc))
 		return -EBUSY;
@@ -512,6 +854,11 @@ static int fimc_cap_streamon(struct file *file, void *priv,
 	}
...
@@ -598,35 +945,16 @@ static int fimc_cap_s_crop(struct file *file, void *fh, struct v4l2_crop *cr)
 {
 	struct fimc_dev *fimc = video_drvdata(file);
 	struct fimc_ctx *ctx = fimc->vid_cap.ctx;
-	struct fimc_frame *f;
...
@@ -688,6 +1016,235 @@ static const struct media_entity_operations fimc_media_ops = {
...
+
 ...
 int fimc_register_capture_device(struct fimc_dev *fimc,
 				 struct v4l2_device *v4l2_dev)
@@ -695,7 +1252,6 @@ int fimc_register_capture_device(struct fimc_dev *fimc,
...
@@ -708,11 +1264,7 @@ int fimc_register_capture_device(struct fimc_dev *fimc,
...
+	fimc_cap_set_default_fmt(ctx);
 	...
 	if (!vfd) {
@@ -757,6 +1309,9 @@ int fimc_register_capture_device(struct fimc_dev *fimc,
...
@@ -771,6 +1326,8 @@ int fimc_register_capture_device(struct fimc_dev *fimc,
 	return 0;
...
@@ -787,6 +1344,7 @@ void fimc_unregister_capture_device(struct fimc_dev *fimc)
 		media_entity_cleanup(&vfd->entity);
...
index 7a10fea..4b9f471 100644
--- a/drivers/media/video/s5p-fimc/fimc-core.c
+++ b/drivers/media/video/s5p-fimc/fimc-core.c
@@ -371,6 +371,10 @@ void fimc_capture_irq_handler(struct fimc_dev *fimc)
 	} else {
...
@@ -1195,12 +1199,11 @@ static int fimc_m2m_g_crop(struct file *file, void *fh, struct v4l2_crop *cr)
 	return 0;
 }
...
@@ -1208,13 +1211,9 @@ int fimc_try_crop(struct fimc_ctx *ctx, struct v4l2_crop *cr)
...
+	else if (cr->type == V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE)
 		...
 		return -EINVAL;
@@ -1223,15 +1222,10 @@ int fimc_try_crop(struct fimc_ctx *ctx, struct v4l2_crop *cr)
...
+		halign = ffs(min_size) - 1;
 	...
 	for (i = 0; i < f->fmt->colplanes; i++)
 		depth += f->fmt->depth[i];
@@ -1248,7 +1242,7 @@ int fimc_try_crop(struct fimc_ctx *ctx, struct v4l2_crop *cr)
...
@@ -1264,7 +1258,7 @@ static int fimc_m2m_s_crop(struct file *file, void *fh, struct v4l2_crop *cr)
 	struct fimc_frame *f;
 	int ret;
...
@@ -316,8 +326,10 @@ struct fimc_vid_cap {
 	struct fimc_ctx			*ctx;
...
+
 ...
 {
 	unsigned long flags;
@@ -650,7 +689,6 @@ int fimc_hw_set_camera_type(struct fimc_dev *fimc,
 /* fimc-core.c */
...
@@ -685,6 +723,7 @@ int fimc_vid_cap_buf_queue(struct fimc_dev *fimc,
...
index 91f57d6..d425b65 100644
--- a/drivers/media/video/s5p-fimc/fimc-mdevice.c
+++ b/drivers/media/video/s5p-fimc/fimc-mdevice.c
@@ -408,8 +408,9 @@ static int __fimc_md_create_fimc_links(struct fimc_md *fmd,
 			continue;
...
@@ -446,10 +447,10 @@ static int fimc_md_create_links(struct fimc_md *fmd)
...
@@ -505,6 +506,24 @@ static int fimc_md_create_links(struct fimc_md *fmd)
...
@@ -613,15 +632,15 @@ int fimc_md_set_camclk(struct v4l2_subdev *sd, bool on)
