...
Received: from smtp-68.nebula.fi ([83.145.220.68]:49744 "EHLO
	smtp-68.nebula.fi" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1031568Ab2CFXQm (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Tue, 6 Mar 2012 18:16:42 -0500
Date: Wed, 7 Mar 2012 01:16:33 +0200
From: Sakari Ailus <sakari.ailus@iki.fi>
To: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
Cc: linux-media@vger.kernel.org,
	Martin Hostettler <martin@neutronstar.dyndns.org>
Subject: Re: [PATCH v3 5/5] v4l: Add driver for Micron MT9M032 camera sensor
Message-ID: <20120306231633.GO1075@valkosipuli.localdomain>
...
In-Reply-To: <1331051559-13841-6-git-send-email-laurent.pinchart@ideasonboard.com>
...
> +}
> +
v> +static int mt9m032_set_frame_interval(struct v4l2_subdev *subdev,
> +				      struct v4l2_subdev_frame_interval *fi)
> +{
> +	struct mt9m032 *sensor = to_mt9m032(subdev);
> +	int ret;
