...
Received: from metis.ext.4.pengutronix.de ([92.198.50.35]:50973 "EHLO
        metis.ext.4.pengutronix.de" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S933014AbdABNYR (ORCPT
...
Subject: [PATCH v3 7/7] [media] coda: support YUYV output if VDOA is used
Date: Mon,  2 Jan 2017 14:23:52 +0100
Message-Id: <20170102132352.23669-8-m.tretter@pengutronix.de>
