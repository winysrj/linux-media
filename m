...
Received: from static.135.41.46.78.clients.your-server.de ([78.46.41.135]
	...
	(envelope-from <bas@kompasmedia.nl>) id 1Jnelz-00024n-Ok
	for linux-dvb@linuxtv.org; Sun, 20 Apr 2008 21:00:29 +0200
To: Tim Hewett <tghewett2@onetel.com>
MIME-Version: 1.0
Date: Sun, 20 Apr 2008 21:00:18 +0200
From: Bas v.d. Wiel <bas@kompasmedia.nl>
In-Reply-To: <11E5EC6B-6658-4703-A2B1-F39EB49ED318@onetel.com>
References: <11E5EC6B-6658-4703-A2B1-F39EB49ED318@onetel.com>
Message-ID: <65417d9de0a860b3b76c58263d4e4112@localhost>
...
Linux driver on their website, which is why I bought this specific card in
the first place. I'm about to give up on this card completely. I'll leave
it in my machine for now and use Windows to watch TV. If anyone knows of a
*working* alternative that supports the capture of encrypted DVB-C on
Linux, PLEASE let me know. If anyone feels like debugging my setup, mail me
