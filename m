...
Received: from lb3-smtp-cloud2.xs4all.net ([194.109.24.29]:48539 "EHLO
	lb3-smtp-cloud2.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1751836AbcCYNUF (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 25 Mar 2016 09:20:05 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: dri-devel@lists.freedesktop.org, linux-samsung-soc@vger.kernel.org,
	linux-input@vger.kernel.org, lars@opdenkamp.eu,
	linux@arm.linux.org.uk, Hans Verkuil <hans.verkuil@cisco.com>
Subject: [PATCHv14 17/18] vivid: add CEC emulation
Date: Fri, 25 Mar 2016 14:10:15 +0100
Message-Id: <1458911416-47981-18-git-send-email-hverkuil@xs4all.nl>
...
+	unsigned i, j;
 	...
 	for (i = 0; i < n_devs; i++) {
 		dev = vivid_devs[i];
@@ -1388,6 +1717,13 @@ static int vivid_remove(struct platform_device *pdev)
...
index b84f081..931c7e2 100644
--- a/drivers/media/platform/vivid/vivid-vid-cap.c
+++ b/drivers/media/platform/vivid/vivid-vid-cap.c
@@ -1700,6 +1700,8 @@ int vidioc_s_edid(struct file *file, void *_fh,
...
@@ -1708,14 +1710,30 @@ int vidioc_s_edid(struct file *file, void *_fh,
 		return -EINVAL;
 	if (edid->blocks == 0) {
 		dev->edid_blocks = 0;
-		return 0;
