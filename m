...
Received: from smtp.nokia.com ([147.243.128.26]:44515 "EHLO mgw-da02.nokia.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1753805Ab2BBXzD (ORCPT <rfc822;linux-media@vger.kernel.org>);
...
Cc: laurent.pinchart@ideasonboard.com, dacohen@gmail.com,
	...
	teturtia@gmail.com
Subject: [PATCH v2 10/31] v4l: Image processing control class
Date: Fri,  3 Feb 2012 01:54:30 +0200
Message-Id: <1328226891-8968-10-git-send-email-sakari.ailus@iki.fi>
...
index 6842e80..b79a744 100644
--- a/Documentation/DocBook/media/v4l/controls.xml
+++ b/Documentation/DocBook/media/v4l/controls.xml
@@ -3465,4 +3465,86 @@ interface and may change in the future.</para>
...
+	  </row>
+	  <row>
+	    <entry spanname="id"><constant>V4L2_CID_IMAGE_PROC_LINK_FREQ</constant></entry>
...
+	    (<constant>V4L2_CID_IMAGE_PROC_PIXEL_RATE</constant>) in the
...
+	  </row>
+	  <row>
+	    <entry spanname="id"><constant>V4L2_CID_IMAGE_PROC_PIXEL_RATE</constant></entry>
...
index 37249b7..6860fa0 100644
--- a/drivers/media/video/v4l2-ctrls.c
+++ b/drivers/media/video/v4l2-ctrls.c
@@ -613,6 +613,11 @@ const char *v4l2_ctrl_get_name(u32 id)
...
@@ -701,6 +706,9 @@ void v4l2_ctrl_fill(u32 id, const char **name, enum v4l2_ctrl_type *type,
...
@@ -711,6 +719,7 @@ void v4l2_ctrl_fill(u32 id, const char **name, enum v4l2_ctrl_type *type,
...
@@ -731,6 +740,10 @@ void v4l2_ctrl_fill(u32 id, const char **name, enum v4l2_ctrl_type *type,
...
@@ -1758,6 +1759,13 @@ enum v4l2_flash_strobe_source {
