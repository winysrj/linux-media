...
Received: from o1.7nn.fshared.sendgrid.net ([167.89.55.65]:31463 "EHLO
        o1.7nn.fshared.sendgrid.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S966869AbeAOQio (ORCPT
...
Subject: [PATCH v5 7/9] v4l: vsp1: Adapt entities to configure into a body
Date: Mon, 15 Jan 2018 16:38:43 +0000 (UTC)
Message-Id: <4989f3f0ce18cb3de1fb103b20af9cc885f1d6ea.1516028582.git-series.kieran.bingham+renesas@ideasonboard.com>
...
index 006ad94bbe57..69d3ea2c46dd 100644
...
+	vsp1_dl_body_write(dlb, reg, data);
 ...
 /* -----------------------------------------------------------------------------
@@ -174,7 +174,7 @@ static const struct v4l2_subdev_ops clu_ops = {
  */
...
@@ -193,14 +193,14 @@ static void clu_prepare(struct vsp1_entity *entity,
...
@@ -208,18 +208,18 @@ static void clu_configure(struct vsp1_entity *entity,
...
index 2784d3b48b02..1fc52496fc13 100644
...
index f53658075540..734884489b50 100644
--- a/drivers/media/platform/vsp1/vsp1_drm.c
+++ b/drivers/media/platform/vsp1/vsp1_drm.c
@@ -94,6 +94,7 @@ int vsp1_du_setup_lif(struct device *dev, unsigned int pipe_index,
...
+	struct vsp1_dl_body *dlb;
 	...
 	const char *bru_name;
 	unsigned long flags;
@@ -263,12 +264,13 @@ int vsp1_du_setup_lif(struct device *dev, unsigned int pipe_index,
...
@@ -587,6 +589,7 @@ void vsp1_du_atomic_flush(struct device *dev, unsigned int pipe_index,
 	struct vsp1_entity *next;
...
+	struct vsp1_dl_body *dlb;
 	...
 	unsigned int i;
 	int ret;
@@ -596,6 +599,9 @@ void vsp1_du_atomic_flush(struct device *dev, unsigned int pipe_index,
...
@@ -671,7 +677,7 @@ void vsp1_du_atomic_flush(struct device *dev, unsigned int pipe_index,
...
+		vsp1_dl_body_write(dlb, drm_pipe->uif->route->reg,
 	...
 	/* Configure all entities in the pipeline. */
@@ -679,17 +685,17 @@ void vsp1_du_atomic_flush(struct device *dev, unsigned int pipe_index,
...
index 329ba23755d1..7c7822770e48 100644
...
index 948145e145e0..f7afdd0cf415 100644
...
@@ -148,12 +150,12 @@ int vsp1_entity_init_cfg(struct v4l2_subdev *subdev,
...
index 45293dde6b19..5762df472a42 100644
...
+			       data);
 ...
 /* -----------------------------------------------------------------------------
@@ -87,7 +88,7 @@ static const struct v4l2_subdev_ops lif_ops = {
...
@@ -100,11 +101,11 @@ static void lif_prepare(struct vsp1_entity *entity,
...
index 0bf9e70910d4..b04620727f6f 100644
...
+	vsp1_dl_body_write(dlb, reg, data);
 ...
 /* -----------------------------------------------------------------------------
@@ -151,33 +151,34 @@ static const struct v4l2_subdev_ops lut_ops = {
...
index 6f314c01acd4..1c9eb8160304 100644
...
@@ -167,21 +168,20 @@ static void rpf_prepare(struct vsp1_entity *entity,
 		rpf->mult_alpha = mult;
 	}
...
@@ -191,15 +191,14 @@ static void rpf_configure(struct vsp1_entity *entity,
...
-
 	 ...
 	 *
@@ -225,10 +224,10 @@ static void rpf_configure(struct vsp1_entity *entity,
...
@@ -253,9 +252,9 @@ static void rpf_configure(struct vsp1_entity *entity,
 	    fmtinfo->swap_uv)
...
index 3b99081628bd..f6808b0c6a93 100644
--- a/drivers/media/platform/vsp1/vsp1_uif.c
+++ b/drivers/media/platform/vsp1/vsp1_uif.c
@@ -35,10 +35,10 @@ static inline u32 vsp1_uif_read(struct vsp1_uif *uif, u32 reg)
...
@@ -199,14 +199,14 @@ static const struct v4l2_subdev_ops uif_ops = {
  */
...
@@ -221,12 +221,12 @@ static void uif_prepare(struct vsp1_entity *entity,
 		width = crop->width;
 	}
