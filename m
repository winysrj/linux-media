...
Received: from mail-bk0-f46.google.com ([209.85.214.46]:39464 "EHLO
	...
	with ESMTP id S1756481Ab2GaUPa (ORCPT
...
Subject: [PATCH 3/3] [media] sta2x11_vip: convert to videobuf2 and control framework
Date: Tue, 31 Jul 2012 22:17:09 +0200
Message-Id: <1343765829-6006-4-git-send-email-federico.vaga@gmail.com>
...
- */
 ...
 {
 	struct video_device *dev = priv;
@@ -628,72 +528,6 @@ static int vidioc_querystd(struct file *file, void *priv, v4l2_std_id *std)
...
+	return vb2_streamoff(&vip->vb_vidq, type);
 }
...
+static void sta2x11_vip_init_buffer(struct sta2x11_vip *vip)
+{
...
- */
 ...
 {
@@ -1212,10 +911,17 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
...
@@ -1223,6 +929,7 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
 		goto disable;
 	}
...
+	/* Power configuration */
 	ret = vip_gpio_reserve(&pdev->dev, config->pwr_pin, 0,
 			       config->pwr_name);
 	if (ret)
@@ -1237,7 +944,6 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
 			goto disable;
 		}
 	}
-
...
@@ -1251,17 +957,20 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
 	}
 	usleep_range(5000, 25000);
