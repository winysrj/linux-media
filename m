...
Received: from fg-out-1718.google.com ([72.14.220.158]:37116 "EHLO
	fg-out-1718.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753689AbZIUUGj convert rfc822-to-8bit (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 21 Sep 2009 16:06:39 -0400
Received: by fg-out-1718.google.com with SMTP id 22so1235173fge.1
        for <linux-media@vger.kernel.org>; Mon, 21 Sep 2009 13:06:42 -0700 (PDT)
MIME-Version: 1.0
In-Reply-To: <200909212158.25357.martin@marsark.sytes.net>
References: <200909212134.48829.martin@marsark.sytes.net>
	 <829197380909211247s6a4c5c56l8f8df51cfdf0da7c@mail.gmail.com>
	 <200909212158.25357.martin@marsark.sytes.net>
Date: Mon, 21 Sep 2009 16:01:12 -0400
Message-ID: <829197380909211301v3733ca51rcfc3c9ab811851fd@mail.gmail.com>
...
On Mon, Sep 21, 2009 at 3:58 PM, MarSarK <martin@marsark.sytes.net> wrote:
> Dne Po 21. zברם 2009 21:47:04 jste napsal(a): > On Mon, Sep 21, 2009 at 3:34
> PM, MarSarK <martin@marsark.sytes.net> wrote:
>> > hi, my brand new Gigabyte U8000-RG USB tv oops kernel.
>> >
>> > I have tried kernels from 2.6.27 to 2.6.31 everytime with same result
>> > (also at my notebook).
>> >
>> > uname -a:
>> > Linux vertigo 2.6.31-gentoo #2 SMP PREEMPT Mon Sep 14 20:20:59 CEST 2009
...
>> >
>> > This output is from 2.6.31 kernel and last mercurial snapshot of linuxtv
>> > tree. Error occure when I try to scan channels in Kaffeine.
>> >
>> > dmesg:
...
>> > firmware usb 1-4: firmware: requesting dvb-usb-dib0700-1.20.fw
...
>> >
>> > Pid: 9533, comm: kdvb-ad-0-fe-0 Tainted: P           (2.6.31-gentoo #2)
>> > P5Q DELUXE
...
>> > Process kdvb-ad-0-fe-0 (pid: 9533, ti=f4932000 task=f4aa6cb0
>> > task.ti=f4932000) Stack:
>> >  f4933d88 00000000 00000000 e8024090 00000000 f4933e54 e8024098 f62f5300
>> > <0> f67f3000 00000000 f62f5300 c11f9adf 00000001 f89d3107 c12550b0
>> > 00069400 <0> 00000000 00000000 00000003 80000400 f4949400 00000006
>> > 00000006 00000006 Call Trace:
...
>> > Code: d0 e8 02 7a ff ff 89 5c 24 08 c7 44 24 0c a0 c4 38 c1 89 44 24 04
>> > c7 04 24 52 e6 40 c1 e8 7f df 16 00 e9 2e ff ff ff 8b 44 24 10 <8b> 58 08
>> > e8 d5 79 ff ff 89 7c 24 0c 89 5c 24 08 89 44 24 04 c7
...
>>
>
> Thanks for quick answer. Yes, I added that single line and it works for me.
> Martin
>

Martin,

If you want to send me the patch with your SOB, I will push a patch
upstream that at least fixes the regression.  The "right" fix can come
later.
