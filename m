...
Received: from smtp-vbr6.xs4all.nl ([194.109.24.26]:4707 "EHLO
	smtp-vbr6.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1030182Ab3DKSKJ (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 11 Apr 2013 14:10:09 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: "Tzu-Jung Lee" <roylee17@gmail.com>
Subject: Re: [PATCH] v4l2-ctl: add is_compressed_format() helper
Date: Thu, 11 Apr 2013 20:09:50 +0200
Cc: linux-media@vger.kernel.org, hans.verkuil@cisco.com,
	k.debski@samsung.com, "Tzu-Jung Lee" <tjlee@ambarella.com>
References: <1365699247-32351-1-git-send-email-tjlee@ambarella.com> <1365703621-7783-1-git-send-email-tjlee@ambarella.com>
In-Reply-To: <1365703621-7783-1-git-send-email-tjlee@ambarella.com>
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="iso-8859-15"
Content-Transfer-Encoding: 7bit
Message-Id: <201304112009.50586.hverkuil@xs4all.nl>
