...
Received: from mail-yx0-f187.google.com ([209.85.210.187]:42167 "EHLO
	mail-yx0-f187.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1760312AbZLOOHp (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 15 Dec 2009 09:07:45 -0500
Received: by yxe17 with SMTP id 17so3647149yxe.33
        for <linux-media@vger.kernel.org>; Tue, 15 Dec 2009 06:07:43 -0800 (PST)
MIME-Version: 1.0
In-Reply-To: <1260885686-8478-1-git-send-email-acassis@gmail.com>
References: <1260885686-8478-1-git-send-email-acassis@gmail.com>
Date: Tue, 15 Dec 2009 12:07:43 -0200
Message-ID: <37367b3a0912150607v713edc32y3578fa2a0c8c61db@mail.gmail.com>
...
On 12/15/09, Alan Carvalho de Assis <acassis@gmail.com> wrote:
...
> @@ -152,6 +154,7 @@ obj-$(CONFIG_SOC_CAMERA_PLATFORM)	+=
...
>
> diff --git a/drivers/media/video/mx27_camera.c
...
> + *  Videobuf operations
> + */
> +static int mx27_videobuf_setup(struct videobuf_queue *vq, unsigned int
> *count,
> +			      unsigned int *size)
> +{
...
> +}
> +
> +static void mx27_camera_frame_done(struct mx27_camera_dev *pcdev, int
> state)
> +{
> +	struct videobuf_buffer *vb;
