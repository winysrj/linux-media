...
Received: from smtp.nokia.com ([147.243.1.47]:38999 "EHLO mgw-sa01.nokia.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1751185Ab2BNGWW (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Tue, 14 Feb 2012 01:22:22 -0500
Message-ID: <4F39FD85.8080007@iki.fi>
Date: Tue, 14 Feb 2012 08:21:57 +0200
...
Subject: Re: [PATCH v2 27/31] omap3isp: Configure CSI-2 phy based on platform
 data
References: <20120202235231.GC841@valkosipuli.localdomain> <1328226891-8968-27-git-send-email-sakari.ailus@iki.fi> <CAKnK67RzAZ1Lq+xFe3dOhtwF7qg_mYJYC-maiORsKeZ5FZOx0w@mail.gmail.com> <4F357EDD.2010804@iki.fi> <CAKnK67Srr3LFF6d12nmvqn=at-Pa+PMD=60r8jv06uDRERQAzA@mail.gmail.com> <CAKnK67TGn9LWj7M5HOdz5cxG6Vu=uuU-47VAUmham3O3YTEK7A@mail.gmail.com>
In-Reply-To: <CAKnK67TGn9LWj7M5HOdz5cxG6Vu=uuU-47VAUmham3O3YTEK7A@mail.gmail.com>
...
> On Sat, Feb 11, 2012 at 11:17 AM, Aguirre, Sergio <saaguirre@ti.com> wrote:
>> Hi Sakari,
>>
...
Actually not. omap_ctrl_writel() is defined in mach/control.c but it's
not exported, which I believe is correct. Accessing these registers in
the ISP driver is a bit of a hack, and should be eventually replaced by
a proper solution. My understanding is that such is in preparation.
...
Right; I thought this information already was there but it was the
number of lanes related to the CSI-2 interface instead.
...
> 
>        if (lanes->clk.pol > 1 || lanes->clk.pos >
> (csi2->phy->max_data_lanes + 1))
> 
> To correctly allow a position in between 1 and 3, as there's 3 lanes in total,
> 1 for clock and max_data_lanes for data.
> 
> Apologies for the confusion

After looking at the code for CSI2 phy configuration previously, I
decided it needed a cleanup. I'll send a fixed patch later on.
