...
Received: from lb1-smtp-cloud3.xs4all.net ([194.109.24.22]:38208 "EHLO
	lb1-smtp-cloud3.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1751594AbcBHKVD (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 8 Feb 2016 05:21:03 -0500
Subject: Re: [PATCH v2 1/9] [media] tvp5150: convert register access to regmap
...
Message-ID: <56B86C09.9050301@xs4all.nl>
Date: Mon, 8 Feb 2016 11:20:57 +0100
MIME-Version: 1.0
...
Can you rebase and repost this patch series? Quite a few changes were made
to this driver since you posted it and this series no longer applies.

I'm to blame since I shouldn't have delegated this series to me. Mauro is the
maintainer of this driver and he would have been much better placed to
look at these patches. Combined with lack of time from my side it wasn't until
now that I could look at it and by now it is obvious that this needs to be
rebased first.
...
On 11/25/2015 06:38 PM, Lucas Stach wrote:
