...
Received: from 7of9.schinagl.nl ([88.159.158.68]:45260 "EHLO 7of9.schinagl.nl"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S937609Ab3DIK0l (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Tue, 9 Apr 2013 06:26:41 -0400
Message-ID: <51630545.7060403@schinagl.nl>
Date: Mon, 08 Apr 2013 19:58:29 +0200
From: Oliver Schinagl <oliver+list@schinagl.nl>
MIME-Version: 1.0
To: Jan Saris <jan.saris@gmail.com>
CC: linux-media@vger.kernel.org
Subject: Re: No Signal with TerraTec Cinergy T PCIe dual
References: <CAK2FuSnQxgc2hvtgb=COH0BGaJVqY5Cg=4fYWpB_BwOn8TYE_w@mail.gmail.com> <516193FF.50709@schinagl.nl> <CAK2FuSnprxO78R1u6mSVXJX7WQ0Q_nnr+3vkW7x_y2YuYwHR9Q@mail.gmail.com>
...
I watch via DVB-T so I always have to set that to my second tuner (to 
have dual tuner possibility).

dvb-fe-tool -a 0 -d DVB-T
dvb-fe-tool -a 1 -d DVB-T

for adapter 0 and 1.

In your case however, you do not use DVB-T. The first tuner thus is 
useless (It can only function as Analog tuner, but I have no idea what 
the status for that is atm), I can't 'choose' it as delivery system.

As for adapter 1, You can swap between DVBT, DVBC/ANNEX_A and 
DVBC/ANNEX_C. So that's DVBT and DVBC, but two flavors. I don't know 
what it means, but you can try switching between those two?

dvb-fe-tool -a 1 -d DVBC/ANNEX_C
