...
Received: from moutng.kundenserver.de ([212.227.17.8]:55807 "EHLO
	moutng.kundenserver.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753328Ab3ACQNT (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Thu, 3 Jan 2013 11:13:19 -0500
Date: Thu, 3 Jan 2013 17:13:15 +0100 (CET)
From: Guennadi Liakhovetski <g.liakhovetski@gmx.de>
To: linux-media@vger.kernel.org
cc: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
Subject: [PATCH v2 4/6] media: soc-camera: split struct soc_camera_link into
 host and subdevice parts
In-Reply-To: <1356543358-6180-5-git-send-email-g.liakhovetski@gmx.de>
Message-ID: <Pine.LNX.4.64.1301031710470.17494@axis700.grange>
References: <1356543358-6180-1-git-send-email-g.liakhovetski@gmx.de>
 <1356543358-6180-5-git-send-email-g.liakhovetski@gmx.de>
MIME-Version: 1.0
