...
Received: from mail-ua0-f194.google.com ([209.85.217.194]:34532 "EHLO
        mail-ua0-f194.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1751668AbdF3Jhh (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Fri, 30 Jun 2017 05:37:37 -0400
MIME-Version: 1.0
In-Reply-To: <CAK8P3a0Jd4Eh_CGK4FPGzw5Q3J0hZPD6GASbgCNFi01xwYwV3w@mail.gmail.com>
References: <20170609213616.410415-1-arnd@arndb.de> <CA+V-a8vFYtOc1tARPL1tH3XafXY30p0pAeJjy7qEzF0RkL9cNQ@mail.gmail.com>
 <1b0671fa-fec7-11fa-6b91-0afad904c651@ti.com> <CAK8P3a0Jd4Eh_CGK4FPGzw5Q3J0hZPD6GASbgCNFi01xwYwV3w@mail.gmail.com>
From: "Lad, Prabhakar" <prabhakar.csengg@gmail.com>
Date: Fri, 30 Jun 2017 10:37:06 +0100
Message-ID: <CA+V-a8vBhzENd_5LZ9kG_K1ks=ansf59c_0t4JV1X26yptWYRA@mail.gmail.com>
...
On Tue, Jun 27, 2017 at 12:08 PM, Arnd Bergmann <arnd@arndb.de> wrote:
...
>>>>
>>>> drivers/media/platform/davinci/dm644x_ccdc.c: In function 'ccdc_update=
_raw_params':
>>>> drivers/media/platform/davinci/dm644x_ccdc.c:279:7: error: cast to poi=
...
>>>>   described as an 'experimental ioctl that will change in future kerne=
ls',
>>>>   but if we have users that probably won't happen.
>>>> - The code to allocate the table never gets called after we copy_from_=
user
>>>>   the user input over the kernel settings, and then compare them
>>>>   for inequality.
>>>> - We then go on to use an address provided by user space as both the
>>>>   __user pointer for input and pass it through phys_to_virt to come up
>>>>   with a kernel pointer to copy the data to. This looks like a trivial=
ly
...
>>>>
>>> I suspect there shouldn=E2=80=99t  be possible users of this IOCTL, bet=
ter of  removing
>>> the IOCTL itself.
>>>
