...
Received: from mga09.intel.com ([134.134.136.24]:32726 "EHLO mga09.intel.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1752660AbbFSC1M (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Thu, 18 Jun 2015 22:27:12 -0400
Date: Fri, 19 Jun 2015 10:26:43 +0800
From: kbuild test robot <fengguang.wu@intel.com>
To: Mauro Carvalho Chehab <m.chehab@samsung.com>
Cc: kbuild-all@01.org, linux-media@vger.kernel.org
Subject: [linuxtv-media:media-controller 1277/1278]
 drivers/media/usb/au0828/au0828-video.c:674:7: warning: 'entity' may be used
 uninitialized in this function
Message-ID: <201506191040.HQPlxgtq%fengguang.wu@intel.com>
MIME-Version: 1.0
...
commit: 61891e24706322835582f8b6b184be9adbf78427 [1277/1278] [media] au0828: Cache the decoder info at au0828 dev structure
config: blackfin-allyesconfig (attached as .config)
reproduce:
  wget https://git.kernel.org/cgit/linux/kernel/git/wfg/lkp-tests.git/plain/sbin/make.cross -O ~/bin/make.cross
  chmod +x ~/bin/make.cross
  git checkout 61891e24706322835582f8b6b184be9adbf78427
...
All warnings (new ones prefixed by >>):
   ...
   drivers/media/usb/au0828/au0828-video.c: In function 'au0828_enable_analog_tuner':
>> drivers/media/usb/au0828/au0828-video.c:674:7: warning: 'entity' may be used uninitialized in this function [-Wuninitialized]

vim +/entity +674 drivers/media/usb/au0828/au0828-video.c

61891e24 Mauro Carvalho Chehab          2015-06-18  658  	for (i = 0; i < dev->decoder->num_links; i++) {
61891e24 Mauro Carvalho Chehab          2015-06-18  659  		link = &dev->decoder->links[i];
61891e24 Mauro Carvalho Chehab          2015-06-18  660  		if (link->sink->entity == dev->decoder) {
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  661  			found_link = link;
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  662  			if (link->flags & MEDIA_LNK_FL_ENABLED)
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  663  				active_links++;
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  664  			break;
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  665  		}
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  666  	}
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  667  
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  668  	if (active_links == 1 || !found_link)
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  669  		return 0;
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  670  
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  671  	source = found_link->source->entity;
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  672  	for (i = 0; i < source->num_links; i++) {
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  673  		struct media_entity *sink;
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08 @674  		int flags = 0;
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  675  
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  676  		link = &source->links[i];
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  677  		sink = link->sink->entity;
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  678  
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  679  		if (sink == entity)
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  680  			flags = MEDIA_LNK_FL_ENABLED;
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  681  
1d8ab6f0 Rafael Lourenço de Lima Chehab 2015-06-08  682  		ret = media_entity_setup_link(link, flags);

:::::: The code at line 674 was first introduced by commit
:::::: 1d8ab6f0a0dfd8f976a51b677bb5ba13dae01b4f [media] au0828: Add support for media controller
...
# Linux/blackfin 4.1.0-rc3 Kernel Configuration
#
...
CONFIG_SND_SOC_BFIN_EVAL_ADAU1X61=y
CONFIG_SND_SOC_BFIN_EVAL_ADAU1X81=y
