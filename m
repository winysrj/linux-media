...
Received: from walker.ipnetwork.de ([83.246.120.22])
	...
	(envelope-from <admin@ipnetwork.de>) id 1JsxC2-0005rD-FM
	for linux-dvb@linuxtv.org; Mon, 05 May 2008 11:41:11 +0200
Received: from [192.168.0.20] (BAG3f03.bag.pppool.de [77.134.63.3])
	(authenticated bits=0)
	by walker.ipnetwork.de (8.13.8/8.13.8/Debian-3) with ESMTP id
	m459euOH023433
	(version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-SHA bits=256 verify=NO)
	for <linux-dvb@linuxtv.org>; Mon, 5 May 2008 11:40:56 +0200
Message-ID: <481ED628.4070901@ipnetwork.de>
Date: Mon, 05 May 2008 11:40:56 +0200
From: Ingo Peukes <admin@ipnetwork.de>
MIME-Version: 1.0
To: linux-dvb@linuxtv.org
Subject: [linux-dvb] Cinergy T2 Kernel Oops on Linkstation Live V1 (Marvel
	Orion ARM Architecture)
