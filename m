...
Received: from mx07-00178001.pphosted.com ([62.209.51.94]:43217 "EHLO
	mx07-00178001.pphosted.com" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S932864AbbELQCW (ORCPT
...
Subject: [PATCH v3 3/3] [media] bdisp: add debug file system
Date: Tue, 12 May 2015 18:02:11 +0200
Message-ID: <1431446531-11492-4-git-send-email-fabien.dessenne@st.com>
...
index 31badf5..2243836 100644
--- a/drivers/media/platform/sti/bdisp/bdisp-v4l2.c
+++ b/drivers/media/platform/sti/bdisp/bdisp-v4l2.c
@@ -335,6 +335,8 @@ static void bdisp_device_run(void *priv)
 		goto out;
 	}
...
@@ -1074,6 +1076,8 @@ static irqreturn_t bdisp_irq_thread(int irq, void *priv)
...
@@ -1246,6 +1250,8 @@ static int bdisp_remove(struct platform_device *pdev)
...
@@ -1327,12 +1333,19 @@ static int bdisp_probe(struct platform_device *pdev)
 		goto err_clk;
 	}
