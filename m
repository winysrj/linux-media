...
Received: from mailgw02.mediatek.com ([210.61.82.184]:52721 "EHLO
	...
	with ESMTP id S1757025AbcBWILa (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 23 Feb 2016 03:11:30 -0500
...
Subject: [PATCH v5 6/8] [media] vcodec: mediatek: Add Mediatek VP8 Video Encoder Driver
Date: Tue, 23 Feb 2016 16:11:19 +0800
Message-ID: <1456215081-16858-7-git-send-email-tiffany.lin@mediatek.com>
In-Reply-To: <1456215081-16858-6-git-send-email-tiffany.lin@mediatek.com>
...
+#include "vp8_enc/venc_vp8_if.h"
 ...
 {
@@ -35,6 +36,8 @@ int venc_if_create(struct mtk_vcodec_ctx *ctx, unsigned int fourcc)
