...
Received: from ec2-52-27-115-49.us-west-2.compute.amazonaws.com ([52.27.115.49]:53445
        "EHLO osg.samsung.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1752700AbcLGBUT (ORCPT
        <rfc822;linux-media@vger.kernel.org>); Tue, 6 Dec 2016 20:20:19 -0500
...
Subject: [PATCH v7 3/3] sound/usb: Use Media Controller API to share media resources
Date: Tue,  6 Dec 2016 18:20:00 -0700
Message-Id: <647ec0aa0777ead4d1c5a638eadaceda8d6ebfbf.1481071062.git.shuahkh@osg.samsung.com>
In-Reply-To: <cover.1481071062.git.shuahkh@osg.samsung.com>
References: <cover.1481071062.git.shuahkh@osg.samsung.com>
In-Reply-To: <cover.1481071062.git.shuahkh@osg.samsung.com>
References: <cover.1481071062.git.shuahkh@osg.samsung.com>
...
+	int ret;
 	...
 	subs->interface = -1;
 	subs->altset_idx = 0;
@@ -1234,7 +1246,13 @@ static int snd_usb_pcm_open(struct snd_pcm_substream *substream, int direction)
...
@@ -1243,6 +1261,7 @@ static int snd_usb_pcm_close(struct snd_pcm_substream *substream, int direction)
 	struct snd_usb_substream *subs = &as->substream[direction];
