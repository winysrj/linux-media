...
Received: from mail-px0-f174.google.com ([209.85.212.174]:49304 "EHLO
	mail-px0-f174.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1750896Ab1AWPOf convert rfc822-to-8bit (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sun, 23 Jan 2011 10:14:35 -0500
Received: by pxi15 with SMTP id 15so549987pxi.19
        for <linux-media@vger.kernel.org>; Sun, 23 Jan 2011 07:14:35 -0800 (PST)
...
Date: Mon, 24 Jan 2011 00:14:23 +0900
...
Message-Id: <99060DCB-3E91-4D46-A8CA-6822411AD2C5@gmail.com>
References: <4D3AAD8C.9040909@samsung.com> <4D3BABAA.7000200@gmail.com>
...
At this part, you're right looking only current that codes, but, it's different between
setting the value meaning states and the value setting registers, I think. If the AE
unlock value is 0x02 and AE lock value is 0x04, the value to be set at the register
is supposed to be like below, as your words:

	return i2c_w8_ae(sd, CAT3_AE_LOCK, (u8)(lock * 2));

I'm not sure this look better than my case. My opinions is that the value setting
register and the value meaning the driver state or something else, should be divided.
...
It's totally you're right. Thanks to find again. :)
...
Hue. I missed one. I'd to add this for the next version.
...
Ok. If usleep_range() can guarantee exact 15ms, what can I say that
more. I must change this as you said. After reading your comments,
I searched about times and hrtimers, then it's the better option, I think. 
...
At the next version, I'll not forget showing the patch to you. 
