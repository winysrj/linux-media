...
Received: from metis.ext.4.pengutronix.de ([92.198.50.35]:33444 "EHLO
        metis.ext.4.pengutronix.de" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S936186AbcJGQBQ (ORCPT
...
Subject: [PATCH 06/22] [media] imx: Add i.MX SoC wide media device driver
Date: Fri,  7 Oct 2016 18:00:51 +0200
Message-Id: <20161007160107.5074-7-p.zabel@pengutronix.de>
