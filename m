...
Received: from mail-yx0-f184.google.com ([209.85.210.184]:41287 "EHLO
	mail-yx0-f184.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1755609AbZGMU0K (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 13 Jul 2009 16:26:10 -0400
Received: by yxe14 with SMTP id 14so3516490yxe.33
        for <linux-media@vger.kernel.org>; Mon, 13 Jul 2009 13:26:09 -0700 (PDT)
MIME-Version: 1.0
In-Reply-To: <4A5B1950.8000800@samsung.com>
References: <4A5B1950.8000800@samsung.com>
Date: Tue, 14 Jul 2009 00:26:07 +0400
Message-ID: <208cbae30907131326t7cf9494bq9c28fed81cffa777@mail.gmail.com>
...
On 7/13/09, Joonyoung Shim <jy0922.shim@samsung.com> wrote:
...
>  		retval = -EINVAL;
>  		goto done;
> @@ -582,8 +592,12 @@ static int si470x_vidioc_g_tuner(struct file *file,
> void *priv,
>  	/* driver constants */
...
> @@ -609,10 +623,12 @@ static int si470x_vidioc_g_tuner(struct file *file,
> void *priv,
...
> @@ -648,10 +664,12 @@ static int si470x_vidioc_s_tuner(struct file *file,
> void *priv,
>  	int retval = -EINVAL;
>
>  	/* safety checks */
...
>  		goto done;
>
> @@ -687,10 +705,12 @@ static int si470x_vidioc_g_frequency(struct file
> *file, void *priv,
>  	int retval = 0;
>
>  	/* safety checks */
...
>  		retval = -EINVAL;
>  		goto done;
> @@ -717,10 +737,12 @@ static int si470x_vidioc_s_frequency(struct file
> *file, void *priv,
>  	int retval = 0;
>
>  	/* safety checks */
...
>  		retval = -EINVAL;
>  		goto done;
> @@ -746,10 +768,12 @@ static int si470x_vidioc_s_hw_freq_seek(struct file
> *file, void *priv,
>  	int retval = 0;
>
>  	/* safety checks */
