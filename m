...
Received: from aer-iport-2.cisco.com ([173.38.203.52]:51000 "EHLO
	...
	with ESMTP id S1755188AbcBPMww (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 16 Feb 2016 07:52:52 -0500
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hans.verkuil@cisco.com>,
	Federico Vaga <federico.vaga@gmail.com>,
	Mauro Carvalho Chehab <mchehab@osg.samsung.com>
Subject: [PATCH 04/12] media/pci: convert drivers to use the new vb2_queue dev field
Date: Tue, 16 Feb 2016 13:42:59 +0100
Message-Id: <1455626587-8051-5-git-send-email-hverkuil@xs4all.nl>
...
index 42bc417..4f549ae 100644
--- a/drivers/media/pci/saa7134/saa7134-core.c
+++ b/drivers/media/pci/saa7134/saa7134-core.c
@@ -1162,18 +1162,13 @@ static int saa7134_initdev(struct pci_dev *pci_dev,
...
@@ -1231,7 +1226,7 @@ static int saa7134_initdev(struct pci_dev *pci_dev,
 	if (err < 0) {
...
@@ -1244,7 +1239,7 @@ static int saa7134_initdev(struct pci_dev *pci_dev,
...
@@ -1255,7 +1250,7 @@ static int saa7134_initdev(struct pci_dev *pci_dev,
...
@@ -1266,7 +1261,7 @@ static int saa7134_initdev(struct pci_dev *pci_dev,
...
+		goto fail4;
 ...
 #endif
 	/* everything worked */
@@ -1285,17 +1280,15 @@ static int saa7134_initdev(struct pci_dev *pci_dev,
...
-	vb2_dma_sg_cleanup_ctx(dev->alloc_ctx);
  fail3:
 	saa7134_hwfini(dev);
 	iounmap(dev->lmmio);
@@ -1365,7 +1358,6 @@ static void saa7134_finidev(struct pci_dev *pci_dev)
...
@@ -2167,6 +2166,7 @@ int saa7134_video_init1(struct saa7134_dev *dev)
...
+	q->dev = &dev->pci->dev;
 	...
 	if (ret)
 		return ret;
@@ -2185,6 +2185,7 @@ int saa7134_video_init1(struct saa7134_dev *dev)
 	q->buf_struct_size = sizeof(struct saa7134_buf);
 	q->timestamp_flags = V4L2_BUF_FLAG_TIMESTAMP_MONOTONIC;
 	q->lock = &dev->lock;
+	q->dev = &dev->pci->dev;
...
index 8936568..08ca7b3 100644
--- a/drivers/media/pci/saa7134/saa7134.h
+++ b/drivers/media/pci/saa7134/saa7134.h
@@ -609,7 +609,6 @@ struct saa7134_dev {
