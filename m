...
Received: from mail.kernel.org ([198.145.29.99]:37440 "EHLO mail.kernel.org"
        ...
        id S1752335AbdIMLSz (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Wed, 13 Sep 2017 07:18:55 -0400
From: Kieran Bingham <kieran.bingham+renesas@ideasonboard.com>
To: laurent.pinchart@ideasonboard.com,
        linux-renesas-soc@vger.kernel.org
Cc: linux-media@vger.kernel.org,
        Kieran Bingham <kieran.bingham+renesas@ideasonboard.com>
Subject: [PATCH v3 1/9] v4l: vsp1: Reword uses of 'fragment' as 'body'
Date: Wed, 13 Sep 2017 12:18:40 +0100
Message-Id: <e0fbc6a9c80727e913af07ea3c64aa4509aa7193.1505299165.git-series.kieran.bingham+renesas@ideasonboard.com>
...
@@ -709,25 +708,25 @@ void vsp1_dlm_reset(struct vsp1_dl_manager *dlm)
 }
...
@@ -739,7 +738,7 @@ static void vsp1_dlm_garbage_collect(struct work_struct *work)
...
@@ -761,7 +760,7 @@ struct vsp1_dl_manager *vsp1_dlm_create(struct vsp1_device *vsp1,
...
@@ -791,5 +790,5 @@ void vsp1_dlm_destroy(struct vsp1_dl_manager *dlm)
