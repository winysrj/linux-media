...
Received: from metis.ext.pengutronix.de ([85.220.165.71]:35527 "EHLO
        metis.ext.pengutronix.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1732159AbeGSQOe (ORCPT
...
Subject: [PATCH v2 03/16] gpu: ipu-v3: image-convert: calculate per-tile resize coefficients
Date: Thu, 19 Jul 2018 17:30:29 +0200
Message-Id: <20180719153042.533-4-p.zabel@pengutronix.de>
