...
Received: from mailout3.samsung.com ([203.254.224.33]:44841 "EHLO
	mailout3.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1754637Ab2JJOtc (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 10 Oct 2012 10:49:32 -0400
Received: from epcpsbgm2.samsung.com (epcpsbgm2 [203.254.230.27])
 by mailout3.samsung.com
 (Oracle Communications Messaging Server 7u4-24.01(7.0.4.24.0) 64bit (built Nov
 17 2011)) with ESMTP id <0MBO00MTZMIIXZ10@mailout3.samsung.com> for
 linux-media@vger.kernel.org; Wed, 10 Oct 2012 23:49:30 +0900 (KST)
...
Subject: [PATCHv10 03/26] v4l: vb2: add support for shared buffer (dma_buf)
Date: Wed, 10 Oct 2012 16:46:22 +0200
Message-id: <1349880405-26049-4-git-send-email-t.stanislaws@samsung.com>
...
@@ -959,6 +1030,107 @@ static int __qbuf_mmap(struct vb2_buffer *vb, const struct v4l2_buffer *b)
 }
...
+		break;
 	default:
 		...
 		ret = -EINVAL;
@@ -1303,6 +1478,30 @@ int vb2_wait_for_all_buffers(struct vb2_queue *q)
