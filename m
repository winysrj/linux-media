...
Received: from mailout1.w1.samsung.com ([210.118.77.11]:34448 "EHLO
	mailout1.w1.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1759401AbZKZKc7 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 26 Nov 2009 05:32:59 -0500
Received: from eu_spt2 (mailout1.w1.samsung.com [210.118.77.11])
 by mailout1.w1.samsung.com
 (iPlanet Messaging Server 5.2 Patch 2 (built Jul 14 2004))
 with ESMTP id <0KTP0024XPB3XF@mailout1.w1.samsung.com> for
 linux-media@vger.kernel.org; Thu, 26 Nov 2009 10:33:03 +0000 (GMT)
Received: from linux.samsung.com ([106.116.38.10])
 by spt2.w1.samsung.com (iPlanet Messaging Server 5.2 Patch 2 (built Jul 14
 2004)) with ESMTPA id <0KTP00EAVPB374@spt2.w1.samsung.com> for
 linux-media@vger.kernel.org; Thu, 26 Nov 2009 10:33:03 +0000 (GMT)
Date: Thu, 26 Nov 2009 11:32:50 +0100
From: Pawel Osciak <p.osciak@samsung.com>
Subject: [PATCH 1/2] Added memory-to-memory device helper framework for V4L2.
...
Message-id: <1259231572-20334-2-git-send-email-p.osciak@samsung.com>
MIME-version: 1.0
...
---
 ...
 include/media/v4l2-mem2mem.h       |  152 ++++++++
...
index e541932..22a9fef 100644
--- a/drivers/media/video/Makefile
+++ b/drivers/media/video/Makefile
@@ -112,6 +112,8 @@ obj-$(CONFIG_VIDEOBUF_VMALLOC) += videobuf-vmalloc.o
...
+	out_q_ctx->q.priv_data = cap_q_ctx->q.priv_data = m2m_ctx;
+
+	return m2m_ctx;
+}
...
+void v4l2_m2m_buf_queue(struct videobuf_queue *vq, struct videobuf_buffer *vb)
+{
+	struct v4l2_m2m_ctx *m2m_ctx = vq->priv_data;
+	struct v4l2_m2m_queue_ctx *q_ctx;
+
