...
Received: from na3sys009aog114.obsmtp.com ([74.125.149.211]:44508 "EHLO
	na3sys009aog114.obsmtp.com" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1751498Ab3FDGA5 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 4 Jun 2013 02:00:57 -0400
Message-ID: <1370325613.26072.34.camel@younglee-desktop>
Subject: [PATCH 6/7] marvell-ccic: add SOF / EOF pair check for marvell-ccic
 driver
...
Date: Tue, 4 Jun 2013 14:00:13 +0800
...
@@ -1137,6 +1142,7 @@ static void mcam_vb_wait_finish(struct vb2_queue *vq)
...
@@ -1154,6 +1160,14 @@ static int mcam_vb_start_streaming(struct vb2_queue *vq, unsigned int count)
 		cam->state = S_BUFWAIT;
 		return 0;
 	}
+
...
@@ -1842,9 +1856,11 @@ int mccic_irq(struct mcam_camera *cam, unsigned int irqs)
 	 * each time.
 	 */
 	for (frame = 0; frame < cam->nbufs; frame++)
...
@@ -1853,9 +1869,15 @@ int mccic_irq(struct mcam_camera *cam, unsigned int irqs)
