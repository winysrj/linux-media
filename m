...
Received: from mga06.intel.com ([134.134.136.31]:21227 "EHLO mga06.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1751210AbeDQEfX (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Tue, 17 Apr 2018 00:35:23 -0400
...
Subject: RE: [PATCH v10] media: imx258: Add imx258 camera sensor driver
Date: Tue, 17 Apr 2018 04:35:18 +0000
Message-ID: <8E0971CCB6EA9D41AF58191A2D3978B61D56DCBF@PGSMSX111.gar.corp.intel.com>
References: <1523891059-27323-1-git-send-email-andy.yeh@intel.com>
In-Reply-To: <1523891059-27323-1-git-send-email-andy.yeh@intel.com>
...
Cc: sakari.ailus@linux.intel.com; Yeh, Andy <andy.yeh@intel.com>; tfiga@chromium.org; Chen, JasonX Z <jasonx.z.chen@intel.com>; Chiang, AlanX <alanx.chiang@intel.com>
...
-- Added handling for VBLANK control that auto frame-line-control is enabled since v8:
...
+
 ...
 L:	linux-media@vger.kernel.org
diff --git a/drivers/media/i2c/Kconfig b/drivers/media/i2c/Kconfig index fd01842..bcd4bf1 100644
...
+
 config VIDEO_IMX274
 	...
 	depends on I2C && VIDEO_V4L2 && VIDEO_V4L2_SUBDEV_API diff --git a/drivers/media/i2c/Makefile b/drivers/media/i2c/Makefile index 1b62639..4bf7d00 100644
...
diff --git a/drivers/media/i2c/imx258.c b/drivers/media/i2c/imx258.c new file mode 100644 index 0000000..c02588e
--- /dev/null
...
+#define IMX258_REG_TEST_PATTERN		0x0601
+
+/* Orientation */
...
+imx258_reg mipi_data_rate_1267mbps[] = {
+	{ 0x0301, 0x05 },
+	{ 0x0303, 0x02 },
+	{ 0x0305, 0x03 },
+	{ 0x0306, 0x00 },
...
+ * data rate => double data rate; number of lanes => 4; bits per pixel 
+=> 10  */ static u64 link_freq_to_pixel_rate(u64 f) {
+	f *= 2 * 4;
+	do_div(f, 10);
+
+	return f;
...
+}
+
+static int imx258_update_digital_gain(struct imx258 *imx258, u32 len, 
+u32 val) {
+	int ret;
+
...
+};
+
+MODULE_DEVICE_TABLE(acpi, imx258_acpi_ids); #endif
+
...
+
+MODULE_AUTHOR("Yeh, Andy <andy.yeh@intel.com>"); MODULE_AUTHOR("Chiang, 
+Alan <alanx.chiang@intel.com>"); MODULE_AUTHOR("Chen, Jason 
+<jasonx.z.chen@intel.com>"); MODULE_DESCRIPTION("Sony IMX258 sensor 
