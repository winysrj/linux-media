...
Received: from mail-wr0-f195.google.com ([209.85.128.195]:34004 "EHLO
        mail-wr0-f195.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1750903AbdIKSDJ (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Mon, 11 Sep 2017 14:03:09 -0400
Date: Mon, 11 Sep 2017 20:03:03 +0200
...
Message-ID: <20170911180303.GA14304@dfiloni-N82JQ>
...
In-Reply-To: <20170911145529.xelwo2ip67k4jfwb@valkosipuli.retiisi.org.uk>
...
> > issues with atomisp, the output is the same as ov2680 driver which is very similar.
> 
> Has this been somehow tested?

Nope. As far as I know my Lenovo Miix 310 and NextBook Flexx 10.1 use this camera sensor
however the driver doesn't work on both systems due to other issues in atomisp driver itself.
As I think this driver is identical to ov2680 I decided to send this patch, I also have a
patch for hm2056 camera sensor however I'm still not sending it as I'm not properly sure
about it.
Please note: my Lenovo Miix 310 has an ov2680 camera, this is how I know that ov2680 doesn't
work too (same errors). Let me know if this patch cannot be committed until atomisp is fixed.
Please take a look at https://bugzilla.kernel.org/show_bug.cgi?id=195877 for more infos.
...
The same can be done on other atomisp drivers as far as I know. Please, let me know
about this point.
...
> > diff --git a/drivers/staging/media/atomisp/i2c/ov5648.c b/drivers/staging/media/atomisp/i2c/ov5648.c
> > new file mode 100644
> > index 0000000..4815a19
> > --- /dev/null
...
> > +		break;
> 
> Could you rely on the control framework instead? I presume the values are
> only programmed by the user / the driver and not read from sensor
> registers.

I'm sorry, I don't understand what you mean, isn't it already using the control framework
as per ov5648_g_volatile_ctrl declaration in v4l2_ctrl_ops?
ov2680 works in the same way.
...
> 
> Are either being actually used on an ACPI table in a production device?

XXOV5648 comes from the original 01org patch.
INT5648 comes from my Lenovo Miix 310 DSDT (so yes, it's used at least
in a production device, the driver was not probing at all without it)
