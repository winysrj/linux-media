...
Received: from bear.ext.ti.com ([192.94.94.41]:46146 "EHLO bear.ext.ti.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1751172AbZA1QL4 convert rfc822-to-8bit (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 28 Jan 2009 11:11:56 -0500
From: "Hiremath, Vaibhav" <hvaibhav@ti.com>
To: Sebastian Andrzej Siewior <bigeasy@linutronix.de>
CC: "linux-media@vger.kernel.org" <linux-media@vger.kernel.org>,
	Mauro Carvalho Chehab <mchehab@redhat.com>,
	"video4linux-list@redhat.com" <video4linux-list@redhat.com>
Date: Wed, 28 Jan 2009 21:41:21 +0530
Subject: RE: [PATCH v2] v4l/tvp514x: make the module aware of rich people
Message-ID: <19F8576C6E063C45BE387C64729E739403FA78FEAC@dbde02.ent.ti.com>
...
> @@ -422,7 +423,7 @@ static int tvp514x_configure(struct
...
>  		return err;
> 
> @@ -580,7 +581,7 @@ static int ioctl_s_std(struct v4l2_int_device
...
> @@ -625,8 +626,8 @@ static int ioctl_s_routing(struct
> v4l2_int_device *s,
>  	if (err)
>  		return err;
> 
...
> @@ -779,16 +780,16 @@ ioctl_g_ctrl(struct v4l2_int_device *s, struct
> v4l2_control *ctrl)
> 
>  	switch (ctrl->id) {
...
> @@ -798,7 +799,7 @@ ioctl_g_ctrl(struct v4l2_int_device *s, struct
> v4l2_control *ctrl)
> 
>  		break;
...
>  			ctrl->value = 1;
>  		else
> @@ -848,7 +849,7 @@ ioctl_s_ctrl(struct v4l2_int_device *s, struct
> v4l2_control *ctrl)
>  				value);
>  		if (err)
>  			return err;
...
> @@ -861,7 +862,7 @@ ioctl_s_ctrl(struct v4l2_int_device *s, struct
> v4l2_control *ctrl)
>  				value);
>  		if (err)
>  			return err;
...
>  	case V4L2_CID_SATURATION:
>  		if (ctrl->value < 0 || ctrl->value > 255) {
> @@ -874,7 +875,7 @@ ioctl_s_ctrl(struct v4l2_int_device *s, struct
> v4l2_control *ctrl)
>  				value);
>  		if (err)
>  			return err;
...
>  	case V4L2_CID_HUE:
>  		if (value == 180)
> @@ -893,7 +894,7 @@ ioctl_s_ctrl(struct v4l2_int_device *s, struct
> v4l2_control *ctrl)
>  				value);
>  		if (err)
>  			return err;
...
>  	case V4L2_CID_AUTOGAIN:
>  		if (value == 1)
> @@ -910,7 +911,7 @@ ioctl_s_ctrl(struct v4l2_int_device *s, struct
> v4l2_control *ctrl)
>  				value);
>  		if (err)
>  			return err;
...
> @@ -1275,7 +1276,7 @@ static int ioctl_init(struct v4l2_int_device
> *s)
...
>  	/*
> @@ -1419,23 +1430,26 @@ tvp514x_probe(struct i2c_client *client,
...
> 
>  /**
> @@ -1452,9 +1466,9 @@ static int __exit tvp514x_remove(struct
> i2c_client *client)
>  	if (!client->adapter)
