...
Received: from lb3-smtp-cloud3.xs4all.net ([194.109.24.30]:40986 "EHLO
	...
	by vger.kernel.org with ESMTP id S1751920AbcDVIic (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 22 Apr 2016 04:38:32 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hans.verkuil@cisco.com>
Subject: [PATCHv3 02/12] v4l2-pci-skeleton: set q->dev instead of allocating a context
Date: Fri, 22 Apr 2016 10:38:09 +0200
Message-Id: <1461314299-36126-3-git-send-email-hverkuil@xs4all.nl>
