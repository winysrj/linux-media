...
Received: from smtp11.smtpout.orange.fr ([80.12.242.133]:58266 "EHLO
	smtp.smtpout.orange.fr" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753157AbcHOTCR (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 15 Aug 2016 15:02:17 -0400
...
Subject: [PATCH v4 04/13] media: platform: pxa_camera: convert to vb2
Date: Mon, 15 Aug 2016 21:01:54 +0200
Message-Id: <1471287723-25451-5-git-send-email-robert.jarzmik@free.fr>
...
@@ -860,9 +850,8 @@ static void pxa_camera_eof(unsigned long arg)
...
@@ -871,9 +860,8 @@ static void pxa_camera_eof(unsigned long arg)
...
@@ -885,7 +873,7 @@ static irqreturn_t pxa_camera_irq(int irq, void *data)
...
+	dev_dbg(pcdev_to_dev(pcdev),
 	...
 	if (!status)
@@ -1489,42 +1477,11 @@ static int pxa_camera_try_fmt(struct soc_camera_device *icd,
 	return ret;
 }
...
@@ -1597,8 +1554,7 @@ static struct soc_camera_host_ops pxa_soc_camera_host_ops = {
