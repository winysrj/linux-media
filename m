...
Received: from mail-qy0-f174.google.com ([209.85.216.174]:65239 "EHLO
	mail-qy0-f174.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752568Ab0JNSvf convert rfc822-to-8bit (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 14 Oct 2010 14:51:35 -0400
Received: by qyk5 with SMTP id 5so355079qyk.19
        for <linux-media@vger.kernel.org>; Thu, 14 Oct 2010 11:51:34 -0700 (PDT)
Subject: Re: [PATCH] V4L/DVB: ir: avoid race conditions at device disconnect - was: Fwd: Re: *buntu 10.10 rc
Mime-Version: 1.0 (Apple Message framework v1081)
Content-Type: text/plain; charset=us-ascii
From: Jarod Wilson <jarod@wilsonet.com>
In-Reply-To: <4CB73034.5040208@gmail.com>
Date: Thu, 14 Oct 2010 14:51:48 -0400
Cc: Linux Media Mailing List <linux-media@vger.kernel.org>
Content-Transfer-Encoding: 8BIT
Message-Id: <124AC8C4-3360-4CB2-8D19-CE0543395549@wilsonet.com>
References: <4CB73034.5040208@gmail.com>
To: Mauro Carvalho Chehab <maurochehab@gmail.com>
List-ID: <linux-media.vger.kernel.org>
Sender: <mchehab@pedra>

On Oct 14, 2010, at 12:30 PM, Mauro Carvalho Chehab wrote:
...
Same reply I sent to the patch on the lirc list:

Yeah, I'm reasonably sure that'll do the trick, since clearly, store_protocols is getting called after we've already started working our way through ir_input_unregister, so if drvdata is set to NULL before we enter ir_input_unregister and we check for NULL ir_dev in {store,show}_protocols, we should be good.
