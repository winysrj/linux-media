...
Received: from smtp-vbr8.xs4all.nl ([194.109.24.28]:3426 "EHLO
	smtp-vbr8.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1754709AbaJWLWQ (ORCPT
...
Subject: [RFCv4 PATCH 03/15] vb2-dma-sg: move dma_(un)map_sg here
Date: Thu, 23 Oct 2014 13:21:30 +0200
Message-Id: <1414063302-26903-4-git-send-email-hverkuil@xs4all.nl>
...
index 27f88e4..0f521ca 100644
--- a/drivers/media/pci/cx23885/cx23885-dvb.c
+++ b/drivers/media/pci/cx23885/cx23885-dvb.c
@@ -122,11 +122,8 @@ static void buffer_finish(struct vb2_buffer *vb)
 	struct cx23885_dev *dev = port->dev;
 	struct cx23885_buffer *buf = container_of(vb,
 		struct cx23885_buffer, vb);
-	struct sg_table *sgt = vb2_dma_sg_plane_desc(vb, 0);
