...
Received: from bear.ext.ti.com ([192.94.94.41]:55309 "EHLO bear.ext.ti.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1755449AbZHEFRF (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Wed, 5 Aug 2009 01:17:05 -0400
From: "chaithrika" <chaithrika@ti.com>
To: "'Chaithrika U S'" <chaithrika@ti.com>, <rmk@arm.linux.org.uk>
...
References: <1249483314-9406-1-git-send-email-chaithrika@ti.com>
In-Reply-To: <1249483314-9406-1-git-send-email-chaithrika@ti.com>
Subject: RE: [PATCH] Subject: [PATCH v4] ARM: DaVinci: DM646x Video: Platform and board specific setup
Date: Wed, 5 Aug 2009 10:44:52 +0530
Message-ID: <007e01ca158b$a9d42310$fd7c6930$@com>
MIME-Version: 1.0
