...
Received: from metis.ext.pengutronix.de ([85.220.165.71]:58669 "EHLO
        ...
        with ESMTP id S1725882AbeK0FMc (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Tue, 27 Nov 2018 00:12:32 -0500
From: Michael Grzeschik <m.grzeschik@pengutronix.de>
To: linux-media@vger.kernel.org
Cc: linux-kernel@vger.kernel.org, stoth@kernellabs.com,
        laurent.pinchart@ideasonboard.com, kernel@pengutronix.de,
        mchehab@kernel.org, davem@davemloft.net
Subject: [PATCH v2 1/2] media: mst3367: add support for mstar mst3367 HDMI RX
Date: Mon, 26 Nov 2018 19:09:36 +0100
Message-Id: <20181126180937.32535-2-m.grzeschik@pengutronix.de>
