...
Received: from mail-ee0-f53.google.com ([74.125.83.53]:56855 "EHLO
	mail-ee0-f53.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751933AbaASKUG (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sun, 19 Jan 2014 05:20:06 -0500
Received: by mail-ee0-f53.google.com with SMTP id t10so2843437eei.26
        for <linux-media@vger.kernel.org>; Sun, 19 Jan 2014 02:20:04 -0800 (PST)
Subject: Help needed for zolid usb dvb-t stick
From: mjs <mjstork@gmail.com>
Reply-To: mjstork@gmail.com
To: linux-media@vger.kernel.org
Content-Type: text/plain; charset="UTF-8"
Date: Sun, 19 Jan 2014 11:20:03 +0100
Message-ID: <1390126803.2286.123.camel@fujitsu>
Mime-Version: 1.0
...
[ 2876.961893] xc2028 3-0061: Loading SCODE for type=DTV6 QAM DTV7
               ZARLINK456 SCODE HAS_IF_4760 (620000e0),
               id 0000000000000000.
...
-     { USB_DEVICE(0xeb1a, 0x2883),                   /* Delete cause */
-          .driver_info = EM2880_BOARD_UNKNOWN },     /* same vid/pid */
...
+     {0xb06a32c3, EM2882_BOARD_ZOLID_HYBRID_TV_STICK, TUNER_XC2028},
------------------------------------------------------------------------
  static void em28xx_setup_xc3028(struct em28xx *dev, struct xc2028_
  ctrl *ctl)
+     case EM2882_BOARD_ZOLID_HYBRID_TV_STICK:        /* [FIXME-MJS] */
+          ctl->demod = XC3028_FE_ZARLINK456;     /* according dmesg */
+          ctl->fname = XC3028L_DEFAULT_FIRMWARE;      /* if = 45000 */
+          break;
