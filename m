...
Received: from mail.kapsi.fi ([217.30.184.167]:57598 "EHLO mail.kapsi.fi"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1750784AbaBCLAK (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Mon, 3 Feb 2014 06:00:10 -0500
From: Antti Palosaari <crope@iki.fi>
To: linux-media@vger.kernel.org
Cc: Antti Palosaari <crope@iki.fi>
Subject: [PATCH 1/5] msi001: Mirics MSi001 silicon tuner driver
Date: Mon,  3 Feb 2014 12:59:51 +0200
Message-Id: <1391425195-17865-2-git-send-email-crope@iki.fi>
...
---
 drivers/staging/media/msi3101/Kconfig  |   5 +
...
index 0c349c8..faad318 100644
--- a/drivers/staging/media/msi3101/Kconfig
+++ b/drivers/staging/media/msi3101/Kconfig
@@ -3,3 +3,8 @@ config USB_MSI3101
...
+};
+
+static int msi001_set_gain(struct msi001 *s)
+{
+	int ret;
+	u32 reg;
