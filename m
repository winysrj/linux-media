...
Received: from bues.ch ([80.190.117.144]:41551 "EHLO bues.ch"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1749667Ab2CaQtX (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Sat, 31 Mar 2012 12:49:23 -0400
Date: Sat, 31 Mar 2012 18:49:07 +0200
...
Subject: Re: [GIT PULL FOR 3.5] AF9035/AF9033/TUA9001 => TerraTec Cinergy T
 Stick [0ccd:0093]
Message-ID: <20120331184907.4eed0481@milhouse>
...
Content-Type: multipart/signed; micalg=PGP-SHA1;
 boundary="Sig_/NLeIIgNiWnjYaD5G6Vn5VMP"; protocol="application/pgp-signature"
Sender: linux-media-owner@vger.kernel.org
List-ID: <linux-media.vger.kernel.org>

--Sig_/NLeIIgNiWnjYaD5G6Vn5VMP
Content-Type: multipart/mixed; boundary="MP_/JtJ8ViVjxImNOFcukZ.ln=4"

--MP_/JtJ8ViVjxImNOFcukZ.ln=4
...
> On 31.03.2012 19:29, Michael B=C3=BCsch wrote:
...
> > The firmware that I successfully used with the other af9035 driver seem=
s to
> > be incompatible with your driver, though. It crashes it somewhere
> > on firmware download in one of the USB transfer's memcpy.
>=20
> Most likely it is incompatible. It is surely one of the earliest=20
> firmwares. I will try to make that new fw downloaded ASAP, likely=20
...
--- linux.orig/drivers/media/common/tuners/Kconfig	2012-03-31 00:32:25.0000=
00000 +0200
+++ linux/drivers/media/common/tuners/Kconfig	2012-03-31 13:03:07.279334714=
 +0200
@@ -204,6 +204,13 @@
 	help
...
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D
--- linux.orig/drivers/media/common/tuners/Makefile	2012-03-31 00:32:25.000=
000000 +0200
+++ linux/drivers/media/common/tuners/Makefile	2012-03-31 13:03:42.44480626=
7 +0200
@@ -29,6 +29,7 @@
...
+++ linux/drivers/media/common/tuners/fc0011.c	2012-03-31 14:30:24.12231464=
7 +0200
@@ -0,0 +1,489 @@
+/*
...
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D
--- /dev/null	1970-01-01 00:00:00.000000000 +0000
+++ linux/drivers/media/common/tuners/fc0011.h	2012-03-31 14:27:31.82295824=
9 +0200
@@ -0,0 +1,41 @@
...
Content-Type: text/x-patch
Content-Transfer-Encoding: quoted-printable
Content-Disposition: attachment; filename=af9035-add-usbid.patch

Index: linux/drivers/media/dvb/dvb-usb/af9035.c
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D
--- linux.orig/drivers/media/dvb/dvb-usb/af9035.c	2012-03-31 15:25:06.61112=
2203 +0200
+++ linux/drivers/media/dvb/dvb-usb/af9035.c	2012-03-31 18:44:14.557214890 =
+0200
@@ -634,11 +634,17 @@
=20
...
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D
--- linux.orig/drivers/media/dvb/dvb-usb/af9035.c	2012-03-31 18:44:28.26545=
7286 +0200
+++ linux/drivers/media/dvb/dvb-usb/af9035.c	2012-03-31 18:44:38.241633686 =
+0200
@@ -19,9 +19,12 @@
...
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D
--- linux.orig/drivers/media/dvb/frontends/af9033.c	2012-03-31 18:43:26.392=
363037 +0200
+++ linux/drivers/media/dvb/frontends/af9033.c	2012-03-31 18:44:38.24163368=
6 +0200
@@ -297,6 +297,10 @@
...
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=
=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D=3D
--- linux.orig/drivers/media/dvb/frontends/af9033_priv.h	2012-03-31 18:43:2=
6.392363037 +0200
+++ linux/drivers/media/dvb/frontends/af9033_priv.h	2012-03-31 18:44:38.241=
633686 +0200
@@ -238,5 +238,66 @@
 	{ 0x80f1e6, 0x00 },
 };
...

LG9hcnM3o4zEPkyXk6Gw
=u45E
-----END PGP SIGNATURE-----
