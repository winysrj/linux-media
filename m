...
Received: from gofer.mess.org ([88.97.38.141]:50965 "EHLO gofer.mess.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S937861AbdDXP5s (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Mon, 24 Apr 2017 11:57:48 -0400
Date: Mon, 24 Apr 2017 16:57:46 +0100
From: Sean Young <sean@mess.org>
To: David =?iso-8859-1?Q?H=E4rdeman?= <david@hardeman.nu>
Cc: linux-media@vger.kernel.org, mchehab@s-opensource.com
Subject: Re: [PATCH] rc-core: use the full 32 bits for NEC scancodes
Message-ID: <20170424155746.GA12437@gofer.mess.org>
References: <149253062750.8732.14617348605110322157.stgit@zeus.hardeman.nu>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <149253062750.8732.14617348605110322157.stgit@zeus.hardeman.nu>
...
If someone sets the filter and filter_mask to (say) 0xe100 and 0xff00 
respectively, then your change just broke it.
...
So what about extended nec with an address < 0x100? Or an nec32 with the
upper 8 bits set to 0? This is no longer possible.
