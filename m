...
Received: from comal.ext.ti.com ([198.47.26.152]:39763 "EHLO comal.ext.ti.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1751780AbZLWPZ5 convert rfc822-to-8bit (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 23 Dec 2009 10:25:57 -0500
...
CC: "linux-media@vger.kernel.org" <linux-media@vger.kernel.org>,
	...
	<davinci-linux-open-source@linux.davincidsp.com>
Date: Wed, 23 Dec 2009 09:25:54 -0600
Subject: RE: [PATCH - v2 4/6] V4L - vpfe_capture - bug fixes and enhancements
Message-ID: <A69FA2915331DC488A831521EAE36FE40162A62428@dlee06.ent.ti.com>
...
In-Reply-To: <200912231524.30159.hverkuil@xs4all.nl>
...
The change is because of the void * type that we use. Since ccdc parameter structures are different for different IPs, a constant type for this arg
is not possible. The ccdc driver needs the pointer to structure. But the
v4l2 core tries to copies 4 bytes of data from the void * pointed location which is not what we want. I am sure this code will change once we have a device node available for ccdc on which case, this ioctl will be handled by the ccdc sub device node. The long term goal is to convert ccdc/isif drivers
to sub device and pass this user ioctl to that sub device node. But currently we don't have support for device nodes for sub devices. I think
