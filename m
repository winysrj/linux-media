...
Received: from nblzone-211-213.nblnetworks.fi ([83.145.211.213]:45332 "EHLO
	hillosipuli.retiisi.org.uk" rhost-flags-OK-OK-OK-FAIL)
	by vger.kernel.org with ESMTP id S1751789Ab2LBWYe (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sun, 2 Dec 2012 17:24:34 -0500
Date: Mon, 3 Dec 2012 00:24:28 +0200
...
Cc: Florian Neuhaus <florian.neuhaus@reberinformatik.ch>,
	...
	tuukkat76@gmail.com
Subject: Re: [PATCH] ad5820: Voice coil motor controller driver
Message-ID: <20121202222428.GM31879@valkosipuli.retiisi.org.uk>
References: <6EE9CD707FBED24483D4CB0162E854671008F9FD@AM2PRD0710MB375.eurprd07.prod.outlook.com>
 <1352938546-22104-1-git-send-email-laurent.pinchart@ideasonboard.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <1352938546-22104-1-git-send-email-laurent.pinchart@ideasonboard.com>
...
Do you need all of these? E.g. delay.h and sched.h are probably not needed.
...
I know we've gotten used to i2c_transfer(), but wouldn't
i2c_master_{send,recv}() be better for the task?
...
I think Tuukka's e-mail is wrong here. tuukkat76@gmail.com? Cc Tuukka.
...
The patch itself looks fine, but I think the bigger question is: what's the
interface for such low-level lens control chips?

Based on what I've seen in the past, the vast majority of these are very
simple but a yet diverse set of devices in terms of how they are controlled.
So until we've got more of them the private controls are probably best we
can do.
