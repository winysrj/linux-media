...
Received: from mga06.intel.com ([134.134.136.31]:12806 "EHLO mga06.intel.com"
        ...
        id S932497AbdKBUAN (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Thu, 2 Nov 2017 16:00:13 -0400
...
Subject: [PATCH v7 0/3] add IPU3 CIO2 CSI2 driver
Date: Thu,  2 Nov 2017 14:59:58 -0500
Message-Id: <1509652801-9729-1-git-send-email-yong.zhi@intel.com>
...
- entity 10: ipu3-csi2:1 (2 pads, 2 links)
	...
	pad0: Sink
		[fmt:SRGGB10_1X10/1280x720 field:none]
		<- "ov5670 10-0036":0 []
	pad1: Source
		[fmt:SRGGB10_1X10/1280x720 field:none]
