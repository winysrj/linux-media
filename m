...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id 7FE51C43387
	for <linux-media@archiver.kernel.org>; Wed, 19 Dec 2018 00:05:27 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id 36E0F218AD
	for <linux-media@archiver.kernel.org>; Wed, 19 Dec 2018 00:05:27 +0000 (UTC)
Authentication-Results: mail.kernel.org;
	dkim=pass (1024-bit key) header.d=nextdimension.cc header.i=@nextdimension.cc header.b="UU3GBNpT"
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726746AbeLSAF0 (ORCPT <rfc822;linux-media@archiver.kernel.org>);
        Tue, 18 Dec 2018 19:05:26 -0500
Received: from goldenrod.birch.relay.mailchannels.net ([23.83.209.74]:60763
        "EHLO goldenrod.birch.relay.mailchannels.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726655AbeLSAF0 (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Tue, 18 Dec 2018 19:05:26 -0500
X-Sender-Id: dreamhost|x-authsender|brad@b-rad.cc
Received: from relay.mailchannels.net (localhost [127.0.0.1])
        by relay.mailchannels.net (Postfix) with ESMTP id EC258683A5C;
        Wed, 19 Dec 2018 00:05:22 +0000 (UTC)
Received: from pdx1-sub0-mail-a57.g.dreamhost.com (unknown [100.96.30.62])
        (Authenticated sender: dreamhost)
        by relay.mailchannels.net (Postfix) with ESMTPA id 7E49C68399A;
        Wed, 19 Dec 2018 00:05:22 +0000 (UTC)
X-Sender-Id: dreamhost|x-authsender|brad@b-rad.cc
Received: from pdx1-sub0-mail-a57.g.dreamhost.com (pop.dreamhost.com
 [64.90.62.162])
        ...
        Wed, 19 Dec 2018 00:05:22 +0000
X-MC-Relay: Neutral
X-MailChannels-SenderId: dreamhost|x-authsender|brad@b-rad.cc
X-MailChannels-Auth-Id: dreamhost
X-Ruddy-Chief: 3dd150470180dcc4_1545177922843_2366479636
X-MC-Loop-Signature: 1545177922843:1825538472
X-MC-Ingress-Time: 1545177922842
Received: from pdx1-sub0-mail-a57.g.dreamhost.com (localhost [127.0.0.1])
        by pdx1-sub0-mail-a57.g.dreamhost.com (Postfix) with ESMTP id 39EBC81C34;
        Tue, 18 Dec 2018 16:05:22 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha1; c=relaxed; d=nextdimension.cc; h=
        subject:to:cc:references:from:message-id:date:mime-version
        :in-reply-to:content-type:content-transfer-encoding; s=
        nextdimension.cc; bh=/YU+QSufZBAO53mEpqCz+cw98lU=; b=UU3GBNpTocd
        NTcCEbWPp05RTl1pOq4LSBfFu7NPZaz8UDypnFXtWLhIhGCfidl3zys2oZTLZorU
        rnbDRk+s5mN8NB///ub3aRQ9yXumhRXmKNzy5BPihP5aK0WjvK9byotHDshakH1z
        V6zHx7m7LlBiA1gMOAy7OcT5lp8iRiac=
Received: from [192.168.0.21] (66-90-189-166.dyn.grandenetworks.net [66.90.189.166])
        ...
        by pdx1-sub0-mail-a57.g.dreamhost.com (Postfix) with ESMTPSA id 3B19D81C39;
        Tue, 18 Dec 2018 16:05:19 -0800 (PST)
...
Message-ID: <c985e00a-2fe7-f89a-7993-6efb2158611e@nextdimension.cc>
Date:   Tue, 18 Dec 2018 18:05:18 -0600
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:60.0) Gecko/20100101
 Thunderbird/60.2.1
MIME-Version: 1.0
In-Reply-To: <CADnq5_NWjA3J9__+rQ6yo9j_Gre7N+R==HyJHr0jT1d6vGr=Ow@mail.gmail.com>
Content-Type: text/plain; charset=utf-8
Content-Transfer-Encoding: quoted-printable
Content-Language: en-GB
X-VR-OUT-STATUS: OK
X-VR-OUT-SCORE: -90
X-VR-OUT-SPAMCAUSE: 
...
>>>>>>> Hi everyone,
>>>>>>>
>>>>>>> I will try if the hack mentioned fixes the issue for me on the we=
ekend
>>>>>>> (but I assume, as if effectively removes the function).
>>>>>> It should, but it keeps a few changes. Just want to be sure that w=
hat
>>>>>> would be left won't cause issues. If this works, the logic that wo=
uld
>>>>>> solve Ryzen DMA fixes will be contained into a single point, makin=
g
...
>>>>>
>>>>> So, adding a reliable detection for affected chipsets, where the `i=
f
...
>>>>         +       /* According with
>>>>         +        * https://openbenchmarking.org/system/1703021-RI-AM=
DZEN08075/Ryzen%207%201800X/lspci,
...
>>>>         +
>>>>
>>>> Ideally, the ID for the affected Ryzen DMA engines should be there a=
t
...
>>> These aren't really DMA engines.  Isn't this just the pcie bridge on =
the CPU?
...
>> DMA scatter/gather. The actual DMA engine is there. For it to work, th=
e
>> Northbridge (or the CPU chipset - as nowadays several chipsets integra=
ted
>> the Northbridge inside an IP block at the CPU) has to do the counter p=
art,
>> by allowing the board's DMA engine to access the mainboard's main memo=
ry,
...
>>
>> If the video stream is recorded, the same physical memory DMA mapped a=
rea
>> where the data is written by the video board could be used on another =
DMA
>> transfer via the HD disk controller.
>>
>> It is even possible to setup the Conexant's DMA engine to do transfers=

>> directly to the GPU's internal memory, causing a PCI to PCI DMA transf=
er,
...
>>
>>     This bug affects all of Hauppauge QuadHD boards when used on all R=
yzen
>>     platforms and some XEON platforms. On these platforms it is possib=
le to
>>     error out the RiSC engine and cause it to stall, whereafter the on=
ly
...
>>>>
>>>> [1] like this: https://www.techarp.com/bios-guide/cpu-pci-write-buff=
er/
>>>>
...
>>
>>> The original commit mentioned that xeon platforms were affected as we=
ll.
...
>>> + Suravee.  I'm not really familiar with the changes, if any, that ar=
e
