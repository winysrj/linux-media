...
Received: from fmmailgate01.web.de ([217.72.192.221]:42098 "EHLO
	fmmailgate01.web.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751509AbZFEM43 (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Fri, 5 Jun 2009 08:56:29 -0400
Received: from smtp05.web.de (fmsmtp05.dlan.cinetic.de [172.20.4.166])
	by fmmailgate01.web.de (Postfix) with ESMTP id AF2581048AC66
	for <linux-media@vger.kernel.org>; Fri,  5 Jun 2009 14:56:28 +0200 (CEST)
Received: from [77.1.243.10] (helo=tobi-desktop.localnet)
	by smtp05.web.de with esmtp (WEB.DE 4.110 #277)
	id 1MCYyC-0000i2-00
	for linux-media@vger.kernel.org; Fri, 05 Jun 2009 14:56:28 +0200
From: Tobias Kaminsky <tobiaskaminsky@web.de>
To: linux-media@vger.kernel.org
Subject: Re: Two WinTV1110 in one PC not working, single works
Date: Fri, 5 Jun 2009 14:55:52 +0200
References: <200906021557.27614.tobiaskaminsky@web.de> <200906021632.43653.tobiaskaminsky@web.de> <200906041431.15681.tobiaskaminsky@web.de>
In-Reply-To: <200906041431.15681.tobiaskaminsky@web.de>
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="iso-8859-1"
Content-Transfer-Encoding: 7bit
Content-Disposition: inline
Message-Id: <200906051455.52304.tobiaskaminsky@web.de>
Sender: linux-media-owner@vger.kernel.org
List-ID: <linux-media.vger.kernel.org>

Just for the record.
Using a self compiled kernel under mythbuntu solved the problems.

Tobi

On Thursday 04 June 2009 14:31:15 you wrote:
> Hello,
>
...
> card works
> 2) make install --> init 0 (not powering completly off) --> just one card
> works 3) make install --> init 6 --> both card works
>
>
...
> > -rw-r--r-- 1 root 24478 2009-06-02 16:09
> > /lib/firmware/dvb-fe-tda10046.fw- backup-02-06-09
> >
...
> >
> > Jun  2 16:11:33 finswimmer-desktop kernel: [ 6540.080006] tda1004x:
...
> >
> > Jun  2 16:11:49 finswimmer-desktop kernel: [ 6556.044007] tda1004x:
> > setting up plls for 48MHz sampling clock
> > Jun  2 16:11:49 finswimmer-desktop kernel: [ 6556.712007] tda1004x: found
> > firmware revision 0 -- invalid
> > Jun  2 16:11:49 finswimmer-desktop kernel: [ 6556.712015] tda1004x:
> > trying to boot from eeprom
> > Jun  2 16:11:52 finswimmer-desktop kernel: [ 6559.080007] tda1004x: found
> > firmware revision 0 -- invalid
> > Jun  2 16:11:52 finswimmer-desktop kernel: [ 6559.080013] tda1004x:
...
> > Jun  2 16:12:27 finswimmer-desktop kernel: [ 6594.332007] tda1004x:
> > setting up plls for 48MHz sampling clock
> > Jun  2 16:12:29 finswimmer-desktop kernel: [ 6596.616006] tda1004x: found
> > firmware revision 0 -- invalid
> > Jun  2 16:12:29 finswimmer-desktop kernel: [ 6596.616012] tda1004x:
> > trying to boot from eeprom
> > Jun  2 16:12:31 finswimmer-desktop kernel: [ 6598.984007] tda1004x: found
> > firmware revision 0 -- invalid
> > Jun  2 16:12:31 finswimmer-desktop kernel: [ 6598.984014] tda1004x:
> > waiting for firmware upload...
...
> > >
> > > So the current status is that only one is working and I do not know
> > > what I can change.
> > >
> > > The Firmware:
> > > -rw-r--r-- 1 root 24478 2008-10-27 06:33
...
> > > [   12.904714] saa7133[0]: subsystem: 0070:6701, board: Hauppauge
...
> > > [   13.367371] tveeprom 1-0050: Hauppauge model 67019, rev B4B4,
> > > serial# 948335
...
> > > [   17.484060] saa7133[1]: subsystem: 0070:6701, board: Hauppauge
> > > WinTV- HVR1110 DVB-T/Hybrid [card=104,autodetected]
...
> > > 00 00 00 00 00 00
> > > [   17.685388] tveeprom 2-0050: Hauppauge model 67019, rev B4B4,
> > > serial# 5196633
