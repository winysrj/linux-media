...
Received: from lb1-smtp-cloud2.xs4all.net ([194.109.24.21]:38299 "EHLO
	lb1-smtp-cloud2.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1752705AbcCYNKu (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 25 Mar 2016 09:10:50 -0400
...
Subject: [PATCHv14 09/18] cec.txt: add CEC framework documentation
Date: Fri, 25 Mar 2016 14:10:07 +0100
Message-Id: <1458911416-47981-10-git-send-email-hverkuil@xs4all.nl>
...
+
+This sets the number of simultaneous logical addresses the hardware
+can program. Normally this is given when the adapter is created, but sometimes
+you won't know this until later. As long as the device node hasn't been
+registered you can update the available_log_addrs field using this function.
+
