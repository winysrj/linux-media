...
Received: from mailout2.w1.samsung.com ([210.118.77.12]:31204 "EHLO
	...
	with ESMTP id S932199Ab1FVSBm (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 22 Jun 2011 14:01:42 -0400
Date: Wed, 22 Jun 2011 20:01:19 +0200
From: Sylwester Nawrocki <s.nawrocki@samsung.com>
Subject: [PATCH v2 13/18] s5p-fimc: Convert to use media pipeline operations
In-reply-to: <1308765684-10677-1-git-send-email-s.nawrocki@samsung.com>
To: linux-media@vger.kernel.org, linux-samsung-soc@vger.kernel.org
Cc: m.szyprowski@samsung.com, kyungmin.park@samsung.com,
	s.nawrocki@samsung.com, sw0312.kim@samsung.com,
	riverful.kim@samsung.com
Message-id: <1308765684-10677-14-git-send-email-s.nawrocki@samsung.com>
MIME-version: 1.0
...
@@ -332,10 +338,10 @@ static int fimc_capture_close(struct file *file)
...
@@ -396,41 +402,11 @@ static int fimc_cap_enum_fmt_mplane(struct file *file, void *priv,
 	return 0;
 }
...
@@ -450,7 +426,7 @@ static int fimc_cap_try_fmt_mplane(struct file *file, void *fh,
...
@@ -466,10 +442,6 @@ static int fimc_cap_s_fmt_mplane(struct file *file, void *priv,
...
@@ -499,7 +471,6 @@ static int fimc_cap_s_fmt_mplane(struct file *file, void *priv,
...
@@ -507,12 +478,14 @@ static int fimc_cap_enum_input(struct file *file, void *priv,
 			       struct v4l2_input *i)
 {
 	struct fimc_dev *fimc = video_drvdata(file);
...
@@ -532,14 +505,16 @@ static int fimc_cap_streamon(struct file *file, void *priv,
 {
 	struct fimc_dev *fimc = video_drvdata(file);
 	struct fimc_ctx *ctx = fimc->vid_cap.ctx;
...
@@ -548,8 +523,13 @@ static int fimc_cap_streamoff(struct file *file, void *priv,
...
@@ -655,7 +635,6 @@ static int fimc_cap_s_crop(struct file *file, void *fh, struct v4l2_crop *cr)
 	return 0;
 }
...
@@ -761,8 +740,6 @@ int fimc_register_capture_device(struct fimc_dev *fimc,
...
index 22bebd9..bc6258f 100644
--- a/drivers/media/video/s5p-fimc/fimc-core.c
+++ b/drivers/media/video/s5p-fimc/fimc-core.c
@@ -900,6 +900,60 @@ int fimc_fill_format(struct fimc_frame *frame, struct v4l2_format *f)
 	return 0;
 }
...
+
 static int fimc_m2m_g_fmt_mplane(struct file *file, void *fh,
 				 struct v4l2_format *f)
 {
@@ -941,43 +995,33 @@ struct fimc_fmt *fimc_find_format(u32 *pixelformat, u32 *mbus_code,
 	return def_fmt;
 }
...
@@ -990,34 +1034,12 @@ int fimc_try_fmt_mplane(struct fimc_ctx *ctx, struct v4l2_format *f)
 		else
 			mod_y = mod_x;
 	}
...
@@ -1066,15 +1088,7 @@ static int fimc_m2m_s_fmt_mplane(struct file *file, void *fh,
...
@@ -1154,8 +1168,8 @@ static int fimc_m2m_cropcap(struct file *file, void *fh,
...
+	cr->bounds.height	= frame->o_height;
 	...
 	return 0;
@@ -1582,7 +1596,6 @@ static int fimc_probe(struct platform_device *pdev)
...
@@ -311,9 +315,8 @@ struct fimc_vid_cap {
 	struct fimc_ctx			*ctx;
...
@@ -643,13 +646,13 @@ int fimc_hw_set_camera_type(struct fimc_dev *fimc,
 /* fimc-core.c */
...
@@ -660,6 +663,7 @@ int fimc_prepare_addr(struct fimc_ctx *ctx, struct vb2_buffer *vb,
