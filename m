...
Received: from mail-pd0-f171.google.com ([209.85.192.171]:33959 "EHLO
	mail-pd0-f171.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751301Ab3HNEqR (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 14 Aug 2013 00:46:17 -0400
...
Subject: [PATCH v5 03/13] [media] exynos5-fimc-is: Add driver core files
Date: Wed, 14 Aug 2013 10:16:04 +0530
Message-Id: <1376455574-15560-4-git-send-email-arun.kk@samsung.com>
...
+
+	/* Get the PMU base */
+	node = of_parse_phandle(dev->of_node, "pmu", 0);
+	if (!node)
+		return -ENODEV;
