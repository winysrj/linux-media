...
Received: from mx3.redhat.com (mx3.redhat.com [172.16.48.32])
	by int-mx1.corp.redhat.com (8.13.1/8.13.1) with ESMTP id mBNBZfbt028506
	for <video4linux-list@redhat.com>; Tue, 23 Dec 2008 06:35:41 -0500
Received: from mail.gmx.net (mail.gmx.net [213.165.64.20])
	by mx3.redhat.com (8.13.8/8.13.8) with SMTP id mBNBZQts019827
	for <video4linux-list@redhat.com>; Tue, 23 Dec 2008 06:35:26 -0500
Date: Tue, 23 Dec 2008 12:35:32 +0100 (CET)
From: Guennadi Liakhovetski <lg@denx.de>
To: video4linux-list@redhat.com
In-Reply-To: <Pine.LNX.4.64.0812231225520.5188@axis700.grange>
Message-ID: <Pine.LNX.4.64.0812231232030.5188@axis700.grange>
References: <Pine.LNX.4.64.0812231225520.5188@axis700.grange>
MIME-Version: 1.0
Content-Type: TEXT/PLAIN; charset=US-ASCII
Cc: 
Subject: [PATCH 2/3 v2] soc-camera: camera host driver for i.MX3x SoCs
...
---
 ...
 drivers/media/video/mx3_camera.c            | 1176 +++++++++++++++++++++++++++
 4 files changed, 1238 insertions(+), 2 deletions(-)
...
+ * @irq:		CSI interrupt number - not the DMA channel IRQ
...
+	 */
+	if (pixfmt && channel_change_requested(mx3_cam, xlate->cam_fmt->fourcc)) {
+		dma_cap_mask_t mask;
...
+	 * if rotated, IPU_IRQ_SENSOR_OUT_EOF in our case
+	 */
