...
Received: from smtp-vbr9.xs4all.nl ([194.109.24.29]:3930 "EHLO
	smtp-vbr9.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1757393AbaGQQVy (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 17 Jul 2014 12:21:54 -0400
Message-ID: <53C7F7FC.7090300@xs4all.nl>
Date: Thu, 17 Jul 2014 18:21:16 +0200
...
Subject: Re: [PATCH 08/11] [media] coda: split userspace interface into encoder
 and decoder device
References: <1405613112-22442-1-git-send-email-p.zabel@pengutronix.de> <1405613112-22442-9-git-send-email-p.zabel@pengutronix.de>
