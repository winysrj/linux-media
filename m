...
Received: from smtprelay01.ispgateway.de ([80.67.31.28]:37069 "EHLO
	smtprelay01.ispgateway.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753846Ab1BDJZh (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Fri, 4 Feb 2011 04:25:37 -0500
Message-ID: <4D4BC4A7.2070905@tqsc.de>
Date: Fri, 04 Feb 2011 10:19:35 +0100
...
Subject: Re: [PATCH 2/2 v2] dma: ipu_idmac: do not lose valid received data
 in the irq handler
References: <1296031789-1721-3-git-send-email-agust@denx.de> <1296476549-10421-1-git-send-email-agust@denx.de> <Pine.LNX.4.64.1102031104090.21719@axis700.grange>
