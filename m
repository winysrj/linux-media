...
Received: from smtp-vbr13.xs4all.nl ([194.109.24.33]:4105 "EHLO
	smtp-vbr13.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1754849AbaHNMQ6 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 14 Aug 2014 08:16:58 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hans.verkuil@cisco.com>
Subject: [PATCHv2 1/2] tw68: add support for Techwell tw68xx PCI grabber boards
Date: Thu, 14 Aug 2014 14:16:47 +0200
Message-Id: <1408018608-7858-2-git-send-email-hverkuil@xs4all.nl>
...
+			return IRQ_HANDLED;
+	}
+	dev_dbg(&dev->pci_dev->dev, "%s: **** INTERRUPT NOT HANDLED - clearing mask (orig 0x%08x, cur 0x%08x)",
+			dev->name, orig, tw_readl(TW68_INTSTAT));
+	dev_dbg(&dev->pci_dev->dev, "%s: pci_irqmask 0x%08x; board_virqmask 0x%08x ****\n",
