...
Received: from smtp-vbr17.xs4all.nl ([194.109.24.37]:4230 "EHLO
	smtp-vbr17.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753738AbZDRN7c (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sat, 18 Apr 2009 09:59:32 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: Hardik Shah <hardik.shah@ti.com>
Subject: Re: [Review PATCH 3/3] OMAP2/3 V4L2 Display Driver
Date: Sat, 18 Apr 2009 15:59:24 +0200
Cc: linux-media@vger.kernel.org, linux-omap@vger.kernel.org,
	Brijesh Jadav <brijesh.j@ti.com>,
	Vaibhav Hiremath <hvaibhav@ti.com>
References: <1239021654-16421-1-git-send-email-hardik.shah@ti.com>
In-Reply-To: <1239021654-16421-1-git-send-email-hardik.shah@ti.com>
MIME-Version: 1.0
Content-Type: text/plain;
  charset="iso-8859-15"
Content-Transfer-Encoding: 7bit
Content-Disposition: inline
Message-Id: <200904181559.24471.hverkuil@xs4all.nl>
...
>  {
>  	int eth_cs;
> @@ -307,7 +320,6 @@ static struct omap_dss_display_config omap3_evm_display_data_tv = {
...
>  {
>  	if (lcd_enabled) {
> @@ -433,6 +445,8 @@ static struct omap_board_config_kernel omap3_evm_config[] __initdata = {
