...
Received: from resqmta-po-12v.sys.comcast.net ([96.114.154.171]:56484 "EHLO
	resqmta-po-12v.sys.comcast.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1751403AbbA2Qlh (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 29 Jan 2015 11:41:37 -0500
...
Subject: [PATCH v6] media: au0828 - convert to use videobuf2
Date: Thu, 29 Jan 2015 09:41:32 -0700
Message-Id: <1422549692-5643-1-git-send-email-shuahkh@osg.samsung.com>
...
@@ -2038,9 +1796,7 @@ int au0828_analog_register(struct au0828_dev *dev,
...
@@ -2077,18 +1833,34 @@ int au0828_analog_register(struct au0828_dev *dev,
 		goto err_vdev;
 	}
...
@@ -2096,7 +1868,7 @@ int au0828_analog_register(struct au0828_dev *dev,
...
@@ -2106,13 +1878,18 @@ int au0828_analog_register(struct au0828_dev *dev,
