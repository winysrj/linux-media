...
Received: from scing.com ([217.160.110.58])
	...
	(envelope-from <janne-dvb@grunau.be>) id 1Jjfxd-0007VQ-5L
	for linux-dvb@linuxtv.org; Wed, 09 Apr 2008 21:28:00 +0200
From: Janne Grunau <janne-dvb@grunau.be>
To: "Michael Krufky" <mkrufky@linuxtv.org>
Date: Wed, 9 Apr 2008 21:28:24 +0200
...
Content-Type: Multipart/Mixed;
  boundary="Boundary-00=_YjR/HCru3BUWcAp"
Message-Id: <200804092128.24588.janne-dvb@grunau.be>
...
Content-Type: text/x-diff;
  charset="iso-8859-1";
  name="modoption_adapter_numbers5.diff"
Content-Transfer-Encoding: 7bit
Content-Disposition: attachment;
	filename="modoption_adapter_numbers5.diff"
