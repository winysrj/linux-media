...
Received: from mail.kapsi.fi ([217.30.184.167]:37883 "EHLO mail.kapsi.fi"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1752215AbbJJQv0 (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Sat, 10 Oct 2015 12:51:26 -0400
From: Antti Palosaari <crope@iki.fi>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hverkuil@xs4all.nl>, Antti Palosaari <crope@iki.fi>
Subject: [PATCHv5 10/13] hackrf: add support for transmitter
Date: Sat, 10 Oct 2015 19:51:06 +0300
Message-Id: <1444495869-1969-11-git-send-email-crope@iki.fi>
...
---
 drivers/media/usb/hackrf/hackrf.c | 904 ++++++++++++++++++++++++++------------
 1 file changed, 628 insertions(+), 276 deletions(-)

diff --git a/drivers/media/usb/hackrf/hackrf.c b/drivers/media/usb/hackrf/hackrf.c
index c7dac68..b64acbb 100644
...
@@ -629,37 +772,62 @@ static int hackrf_queue_setup(struct vb2_queue *vq,
...
@@ -672,39 +840,32 @@ static int hackrf_start_streaming(struct vb2_queue *vq, unsigned int count)
 		goto err;
...
@@ -715,9 +876,12 @@ static void hackrf_stop_streaming(struct vb2_queue *vq)
 	hackrf_free_urbs(dev);
 	hackrf_free_stream_bufs(dev);
...
@@ -735,29 +899,46 @@ static int hackrf_querycap(struct file *file, void *fh,
...
@@ -779,8 +960,8 @@ static int hackrf_s_fmt_sdr_cap(struct file *file, void *priv,
 	return 0;
 }
...
@@ -794,8 +975,8 @@ static int hackrf_g_fmt_sdr_cap(struct file *file, void *priv,
 	return 0;
 }
...
+			      struct v4l2_format *f)
 {
 	struct hackrf_dev *dev = video_drvdata(file);
 	int i;
@@ -817,8 +998,8 @@ static int hackrf_try_fmt_sdr_cap(struct file *file, void *priv,
 	return 0;
 }
...
@@ -860,17 +1041,46 @@ static int hackrf_g_tuner(struct file *file, void *priv, struct v4l2_tuner *v)
...
+		a->rangehigh = bands_rx_tx[0].rangehigh;
 		...
 		ret = -EINVAL;
@@ -884,19 +1094,33 @@ static int hackrf_s_frequency(struct file *file, void *priv,
 {
 	struct hackrf_dev *dev = video_drvdata(file);
 	struct usb_interface *intf = dev->intf;
+	struct video_device *vdev = video_devdata(file);
...
+		}
 		...
 		ret = -EINVAL;
 		goto err;
@@ -916,22 +1140,32 @@ static int hackrf_g_frequency(struct file *file, void *priv,
...
@@ -945,17 +1179,17 @@ static int hackrf_enum_freq_bands(struct file *file, void *priv,
...
@@ -968,10 +1202,15 @@ static int hackrf_enum_freq_bands(struct file *file, void *priv,
...
@@ -979,6 +1218,7 @@ static const struct v4l2_ioctl_ops hackrf_ioctl_ops = {
...
@@ -986,6 +1226,8 @@ static const struct v4l2_ioctl_ops hackrf_ioctl_ops = {
...
@@ -1000,6 +1242,7 @@ static const struct v4l2_file_operations hackrf_fops = {
 	.open                     = v4l2_fh_open,
...
@@ -1016,15 +1259,18 @@ static void hackrf_video_release(struct v4l2_device *v)
 {
...
@@ -1071,20 +1356,29 @@ static int hackrf_probe(struct usb_interface *intf,
...
@@ -1093,85 +1387,143 @@ static int hackrf_probe(struct usb_interface *intf,
 				buf, BUF_SIZE);
 	if (ret) {
