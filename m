...
Received: from mo-p00-ob.rzone.de ([81.169.146.160]:47323 "EHLO
	mo-p00-ob.rzone.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S932290Ab2AIQin (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Mon, 9 Jan 2012 11:38:43 -0500
From: linuxtv@stefanringel.de
To: linux-media@vger.kernel.org
Cc: mchehab@redhat.com, Stefan Ringel <linuxtv@stefanringel.de>
Subject: [PATCH] mt2063: rework tuner driver
Date: Mon,  9 Jan 2012 17:37:34 +0100
Message-Id: <1326127054-12358-1-git-send-email-linuxtv@stefanringel.de>
...
@@ -274,1769 +70,442 @@ static u32 mt2063_write(struct mt2063_state *state, u8 reg, u8 *data, u32 len)
 	return ret;
 }
...
@@ -2044,264 +513,157 @@ static int mt2063_release(struct dvb_frontend *fe)
 {
 	struct mt2063_state *state = fe->tuner_priv;
