...
Received: from mo4-p00-ob.smtp.rzone.de ([81.169.146.219]:28137 "EHLO
        mo4-p00-ob.smtp.rzone.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1751302AbcJYOc7 (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Tue, 25 Oct 2016 10:32:59 -0400
Content-Type: text/plain; charset=us-ascii
Mime-Version: 1.0 (Mac OS X Mail 9.3 \(3124\))
Subject: Re: [PATCH] [media] omap3isp: don't call of_node_put
From: "H. Nikolaus Schaller" <hns@goldelico.com>
In-Reply-To: <14483379.k0ruKCM9Us@avalon>
...
Message-Id: <5D801691-4A1F-47E0-86D9-33AFC5BAB73A@goldelico.com>
References: <b46d4d86d20d6b93ecc0b434f2c9b7312bcaa829.1473349712.git.hns@goldelico.com> <3824432.fffa8JciHz@avalon> <D2919AEE-E8B6-4CC8-9558-8AF1F50E6961@goldelico.com> <14483379.k0ruKCM9Us@avalon>
...
>>>> ERROR:
>>>> Bad of_node_put() on /ocp/isp@480bc000/ports/port@0/endpoint [ =20
>>>> 10.118499]
...
>>>> (show_stack+0x10/0x14) [   10.118591] [<c010b6d8>] (show_stack) =
from
...
>>>> (__of_get_next_child) from [<c05ab158>] =
...
>>>> (of_graph_get_next_endpoint) from [<bf1c88a4>] =
(isp_probe+0xdc/0xd80
>>>> [omap3_isp]) [   10.118896] [<bf1c88a4>] (isp_probe [omap3_isp]) =
from
...
>>>> (load_module+0xe5c/0x1004) [   10.119049] [<c01bd314>] =
(load_module) from
>>>> [<c01bd68c>] (SyS_finit_module+0x88/0x90) [   10.119079] =
[<c01bd68c>]
...
>>>> b/drivers/media/platform/omap3isp/isp.c index 5d54e2c..6e2624e =
100644
...
>>>               }
>>>=20
>>>               notifier->subdevs[notifier->num_subdevs] =3D =
&isd->asd;
>>>=20
...
>>>       }
>>>=20
>>> of_graph_get_next_endpoint() increases the reference count of the =
node it
>>> returns, which needs a corresponding of_node_put() in the error =
paths. It
...
*async,
>>=20
>> Seems to fix the reported warning, but obviously I can't test the =
error
>> paths.
>=20
> Can I add
