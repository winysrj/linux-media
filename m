...
Received: from gofer.mess.org ([88.97.38.141]:46413 "EHLO gofer.mess.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1752084AbeCOMqI (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Thu, 15 Mar 2018 08:46:08 -0400
Date: Thu, 15 Mar 2018 12:46:06 +0000
From: Sean Young <sean@mess.org>
To: A Sun <as1033x@comcast.net>
Cc: linux-media@vger.kernel.org,
        Mauro Carvalho Chehab <mchehab@osg.samsung.com>
Subject: Re: [PATCH v2 1/1] media: mceusb: add IR learning support features
 (IR carrier frequency measurement and wide-band/short-range receiver)
Message-ID: <20180315124606.yvugyfb4cn2f6byz@gofer.mess.org>
...
In-Reply-To: <aa4be7ab-b643-9dc9-6a06-7981d314583e@comcast.net>
...
If carrier reports or learning mode is enabled, set the wideband receiver,
else the narrowband.
...
Disable wideband again if learning mode is not enabled.
...
DEFINE_IR_RAW_EVENT() already clears rawir, no need to call init_ir_raw_event().
