...
Received: from metis.ext.pengutronix.de ([92.198.50.35]:57603 "EHLO
	metis.ext.pengutronix.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753248AbaFXO4Z (ORCPT
...
Subject: [PATCH v2 09/29] [media] coda: add workqueue to serialize hardware commands
Date: Tue, 24 Jun 2014 16:55:51 +0200
Message-Id: <1403621771-11636-10-git-send-email-p.zabel@pengutronix.de>
...
@@ -2785,7 +2818,9 @@ static int coda_open(struct file *file)
 	}
...
+	INIT_WORK(&ctx->seq_end_work, coda_seq_end_work);
 	...
 	v4l2_fh_add(&ctx->fh);
@@ -2888,16 +2923,10 @@ static int coda_release(struct file *file)
...
@@ -3195,8 +3224,6 @@ static irqreturn_t coda_irq_handler(int irq, void *data)
...
@@ -3212,7 +3239,6 @@ static irqreturn_t coda_irq_handler(int irq, void *data)
 	if (ctx->aborting) {
...
@@ -3221,57 +3247,11 @@ static irqreturn_t coda_irq_handler(int irq, void *data)
 		return IRQ_NONE;
 	}
...
@@ -3575,7 +3555,6 @@ static int coda_probe(struct platform_device *pdev)
...
@@ -3682,6 +3661,12 @@ static int coda_probe(struct platform_device *pdev)
 		return -ENOMEM;
 	}
...
@@ -3697,6 +3682,7 @@ static int coda_remove(struct platform_device *pdev)
 	if (dev->alloc_ctx)
