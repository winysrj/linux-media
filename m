...
Received: from smtp-vbr11.xs4all.nl ([194.109.24.31]:2962 "EHLO
	smtp-vbr11.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752031Ab0EPNTf (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sun, 16 May 2010 09:19:35 -0400
Message-Id: <3a0e767148c2cf69c4f3b58528e8372939e4d169.1274015085.git.hverkuil@xs4all.nl>
In-Reply-To: <cover.1274015084.git.hverkuil@xs4all.nl>
References: <cover.1274015084.git.hverkuil@xs4all.nl>
From: Hans Verkuil <hverkuil@xs4all.nl>
Date: Sun, 16 May 2010 15:21:12 +0200
Subject: [PATCH 05/15] [RFCv2] saa7115: convert to the new control framework
...
@@ -1229,25 +1193,6 @@ static int saa711x_g_tuner(struct v4l2_subdev *sd, struct v4l2_tuner *vt)
 	return 0;
 }
...
-
 ...
 {
 	struct saa711x_state *state = to_state(sd);
@@ -1524,17 +1469,27 @@ static int saa711x_log_status(struct v4l2_subdev *sd)
 		break;
 	}
...
@@ -1586,8 +1541,9 @@ static int saa711x_probe(struct i2c_client *client,
 {
...
@@ -1626,15 +1582,37 @@ static int saa711x_probe(struct i2c_client *client,
 		return -ENOMEM;
 	sd = &state->sd;
...
@@ -1682,6 +1660,7 @@ static int saa711x_probe(struct i2c_client *client,
...
@@ -1696,6 +1675,7 @@ static int saa711x_remove(struct i2c_client *client)
