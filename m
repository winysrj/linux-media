...
Received: from smtp-vbr7.xs4all.nl ([194.109.24.27]:4178 "EHLO
	smtp-vbr7.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751576AbZK1DGZ (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 27 Nov 2009 22:06:25 -0500
From: Hans Verkuil <hverkuil@xs4all.nl>
To: santiago.nunez@ridgerun.com
Subject: Re: [PATCH 3/4 v10] TVP7002 driver for DM365
Date: Sat, 28 Nov 2009 04:06:38 +0100
...
In-Reply-To: <1259361140-14526-1-git-send-email-santiago.nunez@ridgerun.com>
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="iso-8859-6"
Content-Transfer-Encoding: 7bit
Message-Id: <200911280406.39013.hverkuil@xs4all.nl>
...
> +	u32 current_preset = device->current_preset->p_data.index;
> +	int i;
> +
...
> +			tvp7002_presets[current_preset].p_data.name);

Why not use device->current_preset directly?

> +	v4l2_info(sd, "   Pixels per line: %u\n",
> +			tvp7002_presets[current_preset].p_data.width);
> +	v4l2_info(sd, "   Lines per frame: %u\n\n",
> +			tvp7002_presets[current_preset].p_data.height);
> +	if (i == NUM_PRESETS) {
...
Huh? device->current_preset is a NULL pointer at this stage if I am not
mistaken.
