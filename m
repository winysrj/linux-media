...
Received: from mga03.intel.com ([134.134.136.65]:19788 "EHLO mga03.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1751611AbdGAWbf (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Sat, 1 Jul 2017 18:31:35 -0400
...
Date: Sat, 1 Jul 2017 22:31:31 +0000
Message-ID: <8408A4B5C50F354EA5F62D9FC805153D2C43C033@ORSMSX115.amr.corp.intel.com>
References: <1495752141-29922-1-git-send-email-chiranjeevi.rapolu@intel.com>
 <1497404348-16255-1-git-send-email-chiranjeevi.rapolu@intel.com>
 <20170614230028.GX12407@valkosipuli.retiisi.org.uk>
In-Reply-To: <20170614230028.GX12407@valkosipuli.retiisi.org.uk>
...
Thanks Sakari for the review comments, v4 submitted with review comments incorporated. And, my responses are embedded below.

-----Original Message-----
>From: Sakari Ailus [mailto:sakari.ailus@iki.fi] 
>Sent: Wednesday, June 14, 2017 4:00 PM
>To: Rapolu, Chiranjeevi <chiranjeevi.rapolu@intel.com>
>Cc: linux-media@vger.kernel.org; sakari.ailus@linux.intel.com; tfiga@chromium.org; Zheng, Jian Xu <jian.xu.zheng@intel.com>; Mani, Rajmohan <rajmohan.mani@intel.com>; Yang, Hyungwoo <hyungwoo.yang@intel.com>
>Subject: Re: [PATCH v3 1/1] i2c: Add Omnivision OV5670 5M sensor support
>
>Hi Chiranjeevi,
>
...
Added input clock-frequency property check for desired value.

>A few comments below...
>
>On Tue, Jun 13, 2017 at 06:39:08PM -0700, chiranjeevi.rapolu@intel.com wrote:
...
>> +	ret = 0;
>
>You can assign ret in variable declaration.
>
...
>> +		fmt->format.code = MEDIA_BUS_FMT_SGRBG10_1X10;
>
>You can make the assingment unconditionally.
>

Now, unconditional assignment.
...
>
>The value is 2 in all cases. If this is specific to the sensor and not to
>its configuration, how about moving it here? You may add a #define for it.
>

Replaced with single #define.
...
>> +	ov5670->streaming = 1;
>
>This isn't strictly wrong but if you have a bool variable it's better to use
>false and true instead.
>

I left as is similar to ov13858, to be in synch with it.
