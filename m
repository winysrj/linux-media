...
Received: from hqemgate15.nvidia.com ([216.228.121.64]:1292 "EHLO
	hqemgate15.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1759258AbbIVS42 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 22 Sep 2015 14:56:28 -0400
...
Message-ID: <5601A45B.3010704@nvidia.com>
Date: Tue, 22 Sep 2015 11:56:27 -0700
MIME-Version: 1.0
In-Reply-To: <560116B5.3070904@xs4all.nl>
...
Great, thanks for letting know this. I also feel like this can be some 
generic core code helper, such as

media_link_{set|get|try}_fmt(struct media_link *link);
This will iterate each media_entity on this media_link to do fmt related 
operations.
