...
Received: from mail-bw0-f219.google.com ([209.85.218.219]:51182 "EHLO
	mail-bw0-f219.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S933230AbZHVGua convert rfc822-to-8bit (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sat, 22 Aug 2009 02:50:30 -0400
Received: by bwz19 with SMTP id 19so756113bwz.37
        for <linux-media@vger.kernel.org>; Fri, 21 Aug 2009 23:50:29 -0700 (PDT)
From: Marek Vasut <marek.vasut@gmail.com>
To: linux-media@vger.kernel.org,
	Guennadi Liakhovetski <g.liakhovetski@gmx.de>
Subject: [PATCH 2/3] Add driver for OmniVision OV9640 sensor
Date: Sat, 22 Aug 2009 08:50:07 +0200
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="us-ascii"
Content-Transfer-Encoding: 8BIT
Message-Id: <200908220850.07435.marek.vasut@gmail.com>
...
+	if (ret)
+		dev_err(&client->dev, "An error occured while entering "
+					"soft reset!\n");
+
+	return ret;
+}
...
+static inline int ov9640_set_bus_param(struct soc_camera_device *icd,
+					unsigned long flags)
+{
+	return 0;
+}
...
+ * (this is used at only one place, can as well be inline) */
+static inline void ov9640_alter_regs(u32 pixfmt, struct ov9640_reg_alt *alt)
+{
+	switch (pixfmt) {
...
+}
+
+static inline int ov9640_set_crop(struct soc_camera_device *icd,
...
+const struct ov9640_reg ov9640_regs_dflt[] = {
...
+ */
+const struct ov9640_reg	ov9640_regs_qqcif[] = {
...
+};
+
+const struct ov9640_reg	ov9640_regs_qqvga[] = {
...
+};
+
+const struct ov9640_reg	ov9640_regs_qcif[] = {
+	{ OV9640_CLKRC,	OV9640_CLKRC_DPLL_EN | OV9640_CLKRC_DIV(0x07) },
+	{ OV9640_COM4,	OV9640_COM4_QQ_VP | OV9640_COM4_RSVD },
+	{ OV9640_COM7,	OV9640_COM7_QCIF },
+	{ OV9640_COM12,	OV9640_COM12_RSVD },
...
+};
+
+const struct ov9640_reg	ov9640_regs_qvga[] = {
...
+};
+
+const struct ov9640_reg	ov9640_regs_cif[] = {
+	{ OV9640_CLKRC,	OV9640_CLKRC_DPLL_EN | OV9640_CLKRC_DIV(0x03) },
...
+};
+
+const struct ov9640_reg	ov9640_regs_vga[] = {
...
+};
+
+const struct ov9640_reg	ov9640_regs_sxga[] = {
+	{ OV9640_CLKRC,	OV9640_CLKRC_DPLL_EN | OV9640_CLKRC_DIV(0x01) },
+	{ OV9640_COM3,	OV9640_COM3_VP },
+	{ OV9640_COM7,	0 },
+	{ OV9640_COM12,	OV9640_COM12_RSVD },
...
+};
+
+const struct ov9640_reg ov9640_regs_yuv[] = {
+	{ OV9640_MTX1,	0x50 },
+	{ OV9640_MTX2,	0x43 },
+	{ OV9640_MTX3,	0x0d },
+	{ OV9640_MTX4,	0x19 },
...
+};
+
+const struct ov9640_reg ov9640_regs_rgb[] = {
+	{ OV9640_MTX1,	0x71 },
+	{ OV9640_MTX2,	0x3e },
+	{ OV9640_MTX3,	0x0c },
+	{ OV9640_MTX4,	0x33 },
