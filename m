...
Received: from smtp-vbr11.xs4all.nl ([194.109.24.31]:4070 "EHLO
	smtp-vbr11.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752375Ab2EAJGB (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Tue, 1 May 2012 05:06:01 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hans.verkuil@cisco.com>
Subject: [PATCH 3/7] v4l2-dv-timings.h: definitions for CEA-861 and VESA DMT timings.
Date: Tue,  1 May 2012 11:05:48 +0200
Message-Id: <69fba2589bf3eed77216ddeb21d5df83443a7c16.1335862609.git.hans.verkuil@cisco.com>
...
+	.type = V4L2_DV_BT_656_1120, \
+	.bt = { 1600, 900, 0, V4L2_DV_HSYNC_POS_POL | V4L2_DV_VSYNC_POS_POL, \
...
+	.type = V4L2_DV_BT_656_1120, \
+	.bt = { 2048, 1152, 0, V4L2_DV_HSYNC_POS_POL | V4L2_DV_VSYNC_POS_POL, \
