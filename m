...
Received: from smtp-vbr16.xs4all.nl ([194.109.24.36]:3742 "EHLO
	smtp-vbr16.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1759566Ab2C3O1w (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 30 Mar 2012 10:27:52 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: Ondrej Zary <linux@rainbow-software.org>
Subject: Re: [PATCH v2 1/2] [resend] radio-isa: PnP support for the new ISA radio framework
Date: Fri, 30 Mar 2012 16:27:47 +0200
Cc: linux-media@vger.kernel.org
References: <201203221953.04904.linux@rainbow-software.org>
In-Reply-To: <201203221953.04904.linux@rainbow-software.org>
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="iso-8859-1"
Content-Transfer-Encoding: 7bit
Message-Id: <201203301627.47405.hverkuil@xs4all.nl>
