...
Received: from mail-lf0-f67.google.com ([209.85.215.67]:35965 "EHLO
        mail-lf0-f67.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1752553AbdGIU2W (ORCPT
        <rfc822;linux-media@vger.kernel.org>); Sun, 9 Jul 2017 16:28:22 -0400
MIME-Version: 1.0
In-Reply-To: <4339e5cc-ecf0-be0a-8299-becec5e2c41b@linaro.org>
References: <20170709131916.11643-1-robdclark@gmail.com> <4339e5cc-ecf0-be0a-8299-becec5e2c41b@linaro.org>
From: Rob Clark <robdclark@gmail.com>
Date: Sun, 9 Jul 2017 16:28:19 -0400
Message-ID: <CAF6AEGtpQdcHCxfG3YLR9rjeT8BBWx-ub=3v9m0gckvGqnJoVQ@mail.gmail.com>
Subject: Re: [PATCH] media: venus: hfi: fix error handling in hfi_sys_init_done()
...
>>
>>   Unable to handle kernel paging request at virtual address ffff80003c03=
9000
>>   pgd =3D ffff00000a14f000
>>   [ffff80003c039000] *pgd=3D00000000bd9f7003, *pud=3D00000000bd9f6003, *=
pmd=3D00000000bd9f0003, *pte=3D0000000000000000
>>   Internal error: Oops: 96000007 [#1] SMP
>>   Modules linked in: qcom_wcnss_pil(E+) crc32_ce(E) qcom_common(E) venus=
_core(E+) remoteproc(E) snd_soc_msm8916_digital(E) virtio_ring(E) cdc_ether=
(E) snd_soc_lpass_apq8016(E) snd_soc_lpass_cpu(E) snd_soc_apq8016_sbc(E) sn=
d_soc_lpass_platform(E) v4l2_mem2mem(E) virtio(E) snd_soc_core(E) ac97_bus(=
E) snd_pcm_dmaengine(E) snd_seq(E) leds_gpio(E) videobuf2_v4l2(E) videobuf2=
_core(E) snd_seq_device(E) sndi_pcm(E) videodev(E) media(E) nvmem_qfprom(E)=
 msm(E) snd_timer(E) snd(E) soundcore(E) spi_qup(E) mdt_loader(E) qcom_tsen=
s(E) qcom_spmi_temp_alarm(E) nvmem_core(E) msm_rng(E) uas(E) usb_storage(E)=
 dm9601(E) usbnet(E) mii(E) mmc_block(E) adv7511(E) drm_kms_helper(E) sysco=
pyarea(E) sysfillrect(E) sysimgblt(E) fb_sys_fops(E) qcom_spmi_vadc(E) qcom=
_vadc_common(PE) industrialio(E) pinctrl_spmi_mpp(E)
>>    pinctrl_spmi_gpio(E) rtc_pm8xxx(E) clk_smd_rpm(E) sdhci_msm(E) sdhci_=
pltfm(E) qcom_smd_regulator(E) drm(E) smd_rpm(E) qcom_spmi_pmic(E) regmap_s=
pmi(E) ci_hdrc_msm(E) ci_hdrc(E) usb3503(E) extcon_usb_gpio(E) phy_msm_usb(=
E) udc_core(E) qcom_hwspinlock(E) extcon_core(E) ehci_msm(E) i2c_qup(E) sdh=
ci(E) mmc_core(E) spmi_pmic_arb(E) spmi(E) qcom_smd(E) smsm(E) rpmsg_core(E=
) smp2p(E) smem(E) hwspinlock_core(E) gpio_keys(E)
>>   CPU: 2 PID: 551 Comm: irq/150-venus Tainted: P            E   4.12.0+ =
#1625
>>   Hardware name: qualcomm dragonboard410c/dragonboard410c, BIOS 2017.07-=
rc2-00144-ga97bdbdf72-dirty 07/08/2017
...
>>   Process irq/150-venus (pid: 551, stack limit =3D 0xffff800038e00000)
>>   Call trace:
...
>>
>> diff --git a/drivers/media/platform/qcom/venus/hfi_msgs.c b/drivers/medi=
a/platform/qcom/venus/hfi_msgs.c
>> index debf80a92797..4190825b20a1 100644
>> --- a/drivers/media/platform/qcom/venus/hfi_msgs.c
>> +++ b/drivers/media/platform/qcom/venus/hfi_msgs.c
>> @@ -239,11 +239,12 @@ static void hfi_sys_init_done(struct venus_core *c=
ore, struct venus_inst *inst,
>>                       break;
>>               }
>>
>> -             if (!error) {
>> -                     rem_bytes -=3D read_bytes;
>> -                     data +=3D read_bytes;
>> -                     num_properties--;
>> -             }
>> +             if (error)
