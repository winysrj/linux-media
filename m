...
Received: from mx3.redhat.com (mx3.redhat.com [172.16.48.32])
	by int-mx1.corp.redhat.com (8.13.1/8.13.1) with ESMTP id m4R1Ge5g023758
	for <video4linux-list@redhat.com>; Mon, 26 May 2008 21:16:40 -0400
Received: from mail1.radix.net (mail1.radix.net [207.192.128.31])
	by mx3.redhat.com (8.13.8/8.13.8) with ESMTP id m4R1G3VV023048
	for <video4linux-list@redhat.com>; Mon, 26 May 2008 21:16:03 -0400
From: Andy Walls <awalls@radix.net>
To: Hans Verkuil <hverkuil@xs4all.nl>
In-Reply-To: <200805262326.30501.hverkuil@xs4all.nl>
References: <200805262326.30501.hverkuil@xs4all.nl>
Content-Type: text/plain
Date: Mon, 26 May 2008 21:16:16 -0400
Message-Id: <1211850976.3188.83.camel@palomino.walls.org>
Mime-Version: 1.0
...
Well, wouldn't changing the luma signal sampling rate (in time), but not
the number of luma samples per pixel, effectively stretch or shrink the
"real world" as it is displayed on a horizontal line, thus affecting the
apparent aspect of a pixel when compared to the vertical dimension?
Thus, when representing real world features, the pixels can have an
apparent aspect?

>From the ITU-R BT.601-4 (which has been superseded by BT.601-6) that I
found on the 'net:
...
per NTSC line and 720 samples per active regions of a line.  The 11/10
ratio mentioned for NTSC maps to 704/640, which is clearly a ratio of
active digital pixels to digital pixels scaled for a display.  So I'm
not sure of the relationship to BT.601-4's 720 pixels.

That's where this informal document may help:

http://www.arachnotron.nl/videocap/doc/Karl_cap_v1_en.pdf

He somewhat explains Display Aspect Ratio (DAR) and Pixel Aspect Ratio
(PAR), where 704 comes from instead of 720, and works some examples with
numbers on pages 7-9.  He even talks about the BT8xx chips on page 10.
...
displayable spatial frequency on the line, the highest supported spatial
cycles/line before aliasing makes features unresolvable.  You need to
see a light pixel and a dark pixel to have one spatial cycle.  

(IIRC, If you know the focal length and field of view, the highest
spatial frequency tells you what is the smallest object length you can
hope to resolve.)
...
As the "Karl_cap_v1_en.pdf" points out on page 7, you need to know the
pixel aspect assumed by the digitization to do a proper conversion from
a source digital format to a target digital format and a crop is part of
that conversion.
...
recording standards, and digitization standards. All of these have been
influenced by the analog standards, so certain PARs can get tied to
certain analog standards.
