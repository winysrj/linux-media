...
Received: from devils.ext.ti.com ([198.47.26.153]:47074 "EHLO
	devils.ext.ti.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S932682AbcDYPTS (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 25 Apr 2016 11:19:18 -0400
Date: Mon, 25 Apr 2016 10:19:14 -0500
From: Benoit Parrot <bparrot@ti.com>
To: Hans Verkuil <hverkuil@xs4all.nl>
CC: <linux-media@vger.kernel.org>,
	Hans Verkuil <hans.verkuil@cisco.com>,
	Fabien Dessenne <fabien.dessenne@st.com>
Subject: Re: [PATCHv4 08/13] media/platform: convert drivers to use the new
 vb2_queue dev field
Message-ID: <20160425151913.GB3300@ti.com>
References: <1461409429-24995-1-git-send-email-hverkuil@xs4all.nl>
 <1461409429-24995-9-git-send-email-hverkuil@xs4all.nl>
MIME-Version: 1.0
Content-Type: text/plain; charset="us-ascii"
Content-Disposition: inline
In-Reply-To: <1461409429-24995-9-git-send-email-hverkuil@xs4all.nl>
...
Hans Verkuil <hverkuil@xs4all.nl> wrote on Sat [2016-Apr-23 13:03:44 +0200]:
