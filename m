...
Received: from smtp-vbr2.xs4all.nl ([194.109.24.22]:1259 "EHLO
	smtp-vbr2.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752843Ab3EZN1h (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sun, 26 May 2013 09:27:37 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hans.verkuil@cisco.com>
Subject: [RFC PATCH 02/24] v4l2: remove g_chip_ident from bridge drivers where it is easy to do so.
Date: Sun, 26 May 2013 15:26:57 +0200
Message-Id: <1369574839-6687-3-git-send-email-hverkuil@xs4all.nl>
