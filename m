...
Received: from mail.kernel.org ([198.145.29.99]:35514 "EHLO mail.kernel.org"
        ...
        id S1753158AbdF2ODO (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Thu, 29 Jun 2017 10:03:14 -0400
...
Subject: [PATCH v1 2/2] drm: rcar-du: Repair vblank for DRM page flips using the VSP1
Date: Thu, 29 Jun 2017 15:02:56 +0100
Message-Id: <1f52573cfb6e72b49af7a1071ffe136623fafc75.1498744799.git-series.kieran.bingham+renesas@ideasonboard.com>
...
@@ -735,6 +741,15 @@ int rcar_du_crtc_create(struct rcar_du_group *rgrp, unsigned int index)
