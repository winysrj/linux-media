...
Received: from smtp-vbr2.xs4all.nl ([194.109.24.22]:2609 "EHLO
	smtp-vbr2.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1757143Ab2IUJrV (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 21 Sep 2012 05:47:21 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: Federico Vaga <federico.vaga@gmail.com>
Subject: Re: [PATCH v2 3/4] sta2x11_vip: convert to videobuf2 and control framework
Date: Fri, 21 Sep 2012 11:47:06 +0200
...
References: <1348219298-23273-1-git-send-email-federico.vaga@gmail.com> <1348219298-23273-3-git-send-email-federico.vaga@gmail.com>
In-Reply-To: <1348219298-23273-3-git-send-email-federico.vaga@gmail.com>
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="iso-8859-15"
Content-Transfer-Encoding: 7bit
Message-Id: <201209211147.06204.hverkuil@xs4all.nl>
...
>  };
>  
> @@ -206,360 +187,217 @@ static struct v4l2_pix_format formats_60[] = {
...
>  	int status;
>  
> @@ -590,110 +428,22 @@ static int vidioc_s_std(struct file *file, void *priv, v4l2_std_id *std)
...
>  {
> @@ -707,22 +457,9 @@ static int vidioc_enum_input(struct file *file, void *priv,
>  	return 0;
>  }
>  
> -/**
...
>  
>  	if (i > 1)
> @@ -735,36 +472,14 @@ static int vidioc_s_input(struct file *file, void *priv, unsigned int i)
>  	return 0;
>  }
>  
> -/**
...
>  {
> @@ -778,32 +493,12 @@ static int vidioc_enum_fmt_vid_cap(struct file *file, void *priv,
>  	return 0;
>  }
>  
> -/**
...
>  		interlace_lim = 240;
>  	else
> @@ -827,6 +522,8 @@ static int vidioc_try_fmt_vid_cap(struct file *file, void *priv,
>  		return -EINVAL;

No -EINVAL allowed anymore in try_fmt_vid_cap. I generally handle unknown field
values in try_fmt_vid_cap as if FIELD_ANY was specified.
...
> @@ -840,304 +537,222 @@ static int vidioc_try_fmt_vid_cap(struct file *file, void *priv,
>  	return 0;
>  }
>  
> -/**
...
If you want to use create_bufs, then in queue_setup() you need to handle the
fmt argument. See e.g. vivi.c for an example.
...
> @@ -1223,6 +819,7 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
>  		goto disable;
>  	}
>  
> +	/* Power configuration */
...
>  			       config->pwr_name);
>  	if (ret)
> @@ -1237,7 +834,6 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
>  			goto disable;
>  		}
>  	}
> -
...
> @@ -1251,17 +847,20 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
>  	}
>  	usleep_range(5000, 25000);
>  
...
>  		goto free_mem;
>  
> @@ -1271,46 +870,52 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
>  
>  	pci_set_master(pdev);
>  
...
>  	if (!vip->adapter) {
>  		ret = -ENODEV;
> @@ -1328,10 +933,11 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
>  	}
>  
...
>  {
> @@ -1497,12 +1082,12 @@ static int sta2x11_vip_resume(struct pci_dev *pdev)
>  
>  	spin_lock_irqsave(&vip->slock, flags);
>  	for (i = 1; i < SAVE_COUNT; i++)
...
>  	return 0;
>  }
> @@ -1515,7 +1100,7 @@ static DEFINE_PCI_DEVICE_TABLE(sta2x11_vip_pci_tbl) = {
>  };
>  
...
> @@ -1543,7 +1128,7 @@ late_initcall_sync(sta2x11_vip_init_module);
>  #endif
>  
