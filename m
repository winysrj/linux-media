...
Received: from mail.kapsi.fi ([217.30.184.167]:58084 "EHLO mail.kapsi.fi"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1751610AbbIAV7z (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Tue, 1 Sep 2015 17:59:55 -0400
From: Antti Palosaari <crope@iki.fi>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hverkuil@xs4all.nl>, Antti Palosaari <crope@iki.fi>
Subject: [PATCH 10/13] hackrf: add support for transmitter
Date: Wed,  2 Sep 2015 00:59:26 +0300
Message-Id: <1441144769-29211-11-git-send-email-crope@iki.fi>
...
@@ -731,29 +897,46 @@ static int hackrf_querycap(struct file *file, void *fh,
...
@@ -775,8 +958,8 @@ static int hackrf_s_fmt_sdr_cap(struct file *file, void *priv,
 	return 0;
 }
...
@@ -790,8 +973,8 @@ static int hackrf_g_fmt_sdr_cap(struct file *file, void *priv,
 	return 0;
 }
...
+			      struct v4l2_format *f)
 {
 	struct hackrf_dev *dev = video_drvdata(file);
 	int i;
@@ -813,8 +996,8 @@ static int hackrf_try_fmt_sdr_cap(struct file *file, void *priv,
 	return 0;
 }
...
@@ -856,17 +1039,64 @@ static int hackrf_g_tuner(struct file *file, void *priv, struct v4l2_tuner *v)
...
+		a->rangehigh = bands_rx_tx[0].rangehigh;
 		...
 		ret = -EINVAL;
@@ -880,19 +1110,33 @@ static int hackrf_s_frequency(struct file *file, void *priv,
 {
 	struct hackrf_dev *dev = video_drvdata(file);
 	struct usb_interface *intf = dev->intf;
+	struct video_device *vdev = video_devdata(file);
...
+		}
 		...
 		ret = -EINVAL;
 		goto err;
@@ -912,22 +1156,32 @@ static int hackrf_g_frequency(struct file *file, void *priv,
...
@@ -941,17 +1195,17 @@ static int hackrf_enum_freq_bands(struct file *file, void *priv,
...
@@ -964,10 +1218,15 @@ static int hackrf_enum_freq_bands(struct file *file, void *priv,
...
@@ -975,6 +1234,7 @@ static const struct v4l2_ioctl_ops hackrf_ioctl_ops = {
...
@@ -982,6 +1242,9 @@ static const struct v4l2_ioctl_ops hackrf_ioctl_ops = {
...
@@ -996,6 +1259,7 @@ static const struct v4l2_file_operations hackrf_fops = {
 	.open                     = v4l2_fh_open,
...
@@ -1012,15 +1276,18 @@ static void hackrf_video_release(struct v4l2_device *v)
 {
...
@@ -1067,20 +1373,29 @@ static int hackrf_probe(struct usb_interface *intf,
...
@@ -1089,85 +1404,143 @@ static int hackrf_probe(struct usb_interface *intf,
 				buf, BUF_SIZE);
 	if (ret) {
