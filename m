...
Received: from na3sys009aog116.obsmtp.com ([74.125.149.240]:37333 "EHLO
	na3sys009aog116.obsmtp.com" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1753721Ab3GCF5h (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 3 Jul 2013 01:57:37 -0400
From: Libin Yang <lbyang@marvell.com>
To: <corbet@lwn.net>, <g.liakhovetski@gmx.de>
CC: <linux-media@vger.kernel.org>, <albert.v.wang@gmail.com>,
	Libin Yang <lbyang@marvell.com>,
	Albert Wang <twang13@marvell.com>
Subject: [PATCH v3 1/7] marvell-ccic: add MIPI support for marvell-ccic driver
Date: Wed, 3 Jul 2013 13:55:58 +0800
Message-ID: <1372830964-22323-2-git-send-email-lbyang@marvell.com>
...
@@ -1816,7 +1884,11 @@ int mccic_resume(struct mcam_camera *cam)
...
@@ -113,10 +115,17 @@ static void mmpcam_power_up_ctlr(struct mmp_camera *cam)
 	mdelay(1);
 }
...
+
  ...
  */
@@ -133,6 +142,7 @@ static void mmpcam_power_up(struct mcam_camera *mcam)
 	mdelay(5);
...
@@ -150,8 +160,109 @@ static void mmpcam_power_down(struct mcam_camera *mcam)
...
+}
 ...
 {
@@ -174,17 +285,30 @@ static int mmpcam_probe(struct platform_device *pdev)
 	struct mmp_camera_platform_data *pdata;
 	int ret;
