...
Received: from nblzone-211-213.nblnetworks.fi ([83.145.211.213]:60599 "EHLO
	...
	by vger.kernel.org with ESMTP id S1754631AbbLPNeu (ORCPT
...
Subject: [PATCH v3 17/23] staging: v4l: omap4iss: Fix sub-device power management code
Date: Wed, 16 Dec 2015 15:32:32 +0200
Message-Id: <1450272758-29446-18-git-send-email-sakari.ailus@iki.fi>
