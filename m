...
Received: from lb1-smtp-cloud2.xs4all.net ([194.109.24.21]:54024 "EHLO
        lb1-smtp-cloud2.xs4all.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1752228AbdGFOnR (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Thu, 6 Jul 2017 10:43:17 -0400
...
References: <1497883719-12410-1-git-send-email-todor.tomov@linaro.org>
 ...
 <b5eba8f1-571f-4adf-080e-2234c6ca4cb4@linaro.org>
Cc: mchehab@kernel.org, hans.verkuil@cisco.com, javier@osg.samsung.com,
        s.nawrocki@samsung.com, linux-media@vger.kernel.org,
        linux-kernel@vger.kernel.org, linux-arm-msm@vger.kernel.org,
        Sakari Ailus <sakari.ailus@iki.fi>
From: Hans Verkuil <hverkuil@xs4all.nl>
Message-ID: <f862a6ef-92d5-49d2-f91d-8890a131c45b@xs4all.nl>
Date: Thu, 6 Jul 2017 16:43:07 +0200
MIME-Version: 1.0
In-Reply-To: <b5eba8f1-571f-4adf-080e-2234c6ca4cb4@linaro.org>
...
If you look at the v4l2_fill_pix/mbus_format functions in include/media/v4l2-mediabus.h
you'll see that they don't do anything with pixelformat and mbus code. There are just
simple functions that transfer fields that are the same for both struct from one to
the other. That's all :-)

Rather than doing this same thing for each multiplanar driver it is better to refactor
a bit and add new helper functions.
...
Since you need to make some changes here anyway I would prefer it if you add
a 'pix->num_planes != 1 ||' line here. That can be removed again in patch 11/19.

It's not a blocker, but it is cleaner that way.
...
The format is a global thing, not a per-filehandle thing.
It has to be initialized, but that happens when the driver is initialized.

Basically after loading the driver and running v4l2-ctl --all it should all
look valid. v4l2-compliance tests the same thing.
