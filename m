...
Received: from mga09.intel.com ([134.134.136.24]:51739 "EHLO mga09.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1752664AbdGSDOJ (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Tue, 18 Jul 2017 23:14:09 -0400
...
Subject: [PATCH v3 10/12] intel-ipu3: css pipeline
Date: Tue, 18 Jul 2017 22:13:42 -0500
Message-Id: <1500434023-2411-8-git-send-email-yong.zhi@intel.com>
...
+
 ...
 {
 	while (len >= 4) {
@@ -34,8 +222,6 @@ static void writes(void *mem, ssize_t len, void __iomem *reg)
 	}
 }
...
-
 ...
 {
@@ -404,9 +590,6 @@ static int ipu3_css_hw_start(struct ipu3_css *css)
...
@@ -475,6 +658,1576 @@ static void ipu3_css_hw_cleanup(struct ipu3_css *css)
...
@@ -485,6 +2238,7 @@ int ipu3_css_irq_ack(struct ipu3_css *css)
...
@@ -507,7 +2261,6 @@ int ipu3_css_irq_ack(struct ipu3_css *css)
