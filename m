...
Received: from col0-omc2-s9.col0.hotmail.com ([65.55.34.83]:38735 "EHLO
	col0-omc2-s9.col0.hotmail.com" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1751914Ab2JLKzE convert rfc822-to-8bit
	(ORCPT <rfc822;linux-media@vger.kernel.org>);
	Fri, 12 Oct 2012 06:55:04 -0400
Message-ID: <COL102-W339E9988BA6D6B76DACB7F9F8C0@phx.gbl>
From: Phas Mid <phasmid90210@hotmail.com>
To: <linux-media@vger.kernel.org>
Subject: IVTV Hauppauge PVR 150 bug
Date: Fri, 12 Oct 2012 21:55:03 +1100
...
The card reports an error in ivtv_serialized_open and then reloads the firmware sporadically. Once this happens the card is usually dead until reboot.
 
The card was working perfectly for over 3 years in a seperate motherboard and running kernel 2.6.35-30, now I've moved to a new machine and brand new install the serialized_open calls began.
 
Here are the appropriate kernel logs. Any advice for troubleshooting further would be appreciated.
 
Oct  7 17:49:30 mythtv kernel: [    0.000000] Linux version 3.4.0-030400-generic (apw@gomeisa) (gcc version 4.4.3 (Ubuntu 4.4.3-4ubuntu5.1) ) #201205210521 SMP 
...
Oct 11 04:30:07 mythtv mythbackend[1571]: I TVRecEvent tv_rec.cpp:3989 (TuningNewRecorder) TVRec(9): rec->GetPathname(): '/mnt/localstore3/1004_20121011043000.mpg'
Oct 11 04:30:09 mythtv mythbackend[1571]: W RecThread mpegrecorder.cpp:1315 (StartEncoding) MPEGRec(/dev/video0): StartEncoding failed#012#011#011#011eno: Input/output error (5)
Oct 11 04:31:01 mythtv mythbackend[1571]: E DeviceReadBuffer DeviceReadBuffer.cpp:513 (Poll) DevRdB(/dev/video0): Poll giving up 2
