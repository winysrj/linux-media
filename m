...
Received: from lb3-smtp-cloud3.xs4all.net ([194.109.24.30]:34522 "EHLO
	...
	by vger.kernel.org with ESMTP id S1751467AbcBJMw0 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 10 Feb 2016 07:52:26 -0500
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: dri-devel@lists.freedesktop.org, linux-samsung-soc@vger.kernel.org,
	linux-input@vger.kernel.org, lars@opdenkamp.eu,
	linux@arm.linux.org.uk, Hans Verkuil <hansverk@cisco.com>
Subject: [PATCHv12 12/17] cec: adv7604: add cec support.
Date: Wed, 10 Feb 2016 13:51:46 +0100
Message-Id: <1455108711-29850-13-git-send-email-hverkuil@xs4all.nl>
...
@@ -1934,6 +1956,200 @@ static int adv76xx_set_format(struct v4l2_subdev *sd,
 	return 0;
 }
...
+
 ...
 {
 	struct adv76xx_state *state = to_state(sd);
@@ -1979,6 +2195,9 @@ static int adv76xx_isr(struct v4l2_subdev *sd, u32 status, bool *handled)
 			*handled = true;
 	}
...
+
 	...
 	if (tx_5v) {
@@ -2285,8 +2504,19 @@ static int adv76xx_log_status(struct v4l2_subdev *sd)
...
@@ -2421,6 +2651,13 @@ static const struct v4l2_subdev_video_ops adv76xx_video_ops = {
...
@@ -2436,6 +2673,7 @@ static const struct v4l2_subdev_ops adv76xx_ops = {
...
+	.cec = &adv76xx_cec_ops,
 ...
 /* -------------------------- custom ctrls ---------------------------------- */
@@ -3274,6 +3512,14 @@ static int adv76xx_remove(struct i2c_client *client)
