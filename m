...
Received: from mail-bk0-f50.google.com ([209.85.214.50]:34746 "EHLO
	mail-bk0-f50.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1755728Ab3BESaC (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Tue, 5 Feb 2013 13:30:02 -0500
...
Date: Tue,  5 Feb 2013 19:34:37 +0100
Message-Id: <1360089277-27898-1-git-send-email-federico.vaga@gmail.com>
In-Reply-To: <201302041157.45340.hverkuil@xs4all.nl>
References: <201302041157.45340.hverkuil@xs4all.nl>
...
+	return 0;
 ...
 /**
@@ -1212,10 +987,17 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
...
@@ -1223,6 +1005,7 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
 		goto disable;
 	}
...
+	/* Power configuration */
 	ret = vip_gpio_reserve(&pdev->dev, config->pwr_pin, 0,
 			       config->pwr_name);
 	if (ret)
@@ -1237,7 +1020,6 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
 			goto disable;
 		}
 	}
-
...
@@ -1251,17 +1033,20 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
 	}
 	usleep_range(5000, 25000);
...
@@ -1271,46 +1056,52 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
...
+	/* Get ADV7180 subdevice */
 	...
 	if (!vip->adapter) {
 		ret = -ENODEV;
@@ -1328,10 +1119,11 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
 	}
...
-	mutex_destroy(&vip->mutex);
 ...
 unreg:
@@ -1382,16 +1176,18 @@ static void __devexit sta2x11_vip_remove_one(struct pci_dev *pdev)
 	struct sta2x11_vip *vip =
...
-	mutex_destroy(&vip->mutex);
 	...
 	vip_gpio_release(&pdev->dev, vip->config->pwr_pin,
 			 vip->config->pwr_name);
@@ -1416,9 +1212,6 @@ static void __devexit sta2x11_vip_remove_one(struct pci_dev *pdev)
  *
