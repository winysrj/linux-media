...
Received: from mga01.intel.com ([192.55.52.88]:54725 "EHLO mga01.intel.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1753334AbaKCPhp (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Mon, 3 Nov 2014 10:37:45 -0500
Date: Mon, 3 Nov 2014 23:37:26 +0800
...
Message-ID: <201411032323.hb5neZww%fengguang.wu@intel.com>
MIME-Version: 1.0
...
All warnings:
   ...
   In file included from include/linux/printk.h:260:0,
                    ...
                    from drivers/media/media-entity.c:23:
   drivers/media/media-entity.c: In function 'media_entity_pipeline_start':
   include/linux/dynamic_debug.h:64:16: warning: format '%u' expects argument of type 'unsigned int', but argument 5 has type 'long unsigned int' [-Wformat=]
   ...
   include/linux/device.h:1107:2: note: in expansion of macro 'dynamic_dev_dbg'
     ...
     ^
>> drivers/media/media-entity.c:297:4: note: in expansion of macro 'dev_dbg'
       dev_dbg(entity->parent->dev,
       ^

vim +/dev_dbg +297 drivers/media/media-entity.c
...
# Linux/microblaze 3.18.0-rc2 Kernel Configuration
#
CONFIG_MICROBLAZE=y
CONFIG_SWAP=y
