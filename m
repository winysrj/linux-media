...
Received: from smtp06.smtpout.orange.fr ([80.12.242.128]:55179 "EHLO
	smtp.smtpout.orange.fr" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752826AbcHHTiz (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Mon, 8 Aug 2016 15:38:55 -0400
...
Subject: [PATCH v3 05/14] media: platform: pxa_camera: convert to vb2
Date: Mon,  8 Aug 2016 21:30:43 +0200
Message-Id: <1470684652-16295-6-git-send-email-robert.jarzmik@free.fr>
...
---
 ...
 drivers/media/platform/soc_camera/pxa_camera.c | 587 ++++++++++++-------------
 2 files changed, 277 insertions(+), 314 deletions(-)
...
index 2aaf4a8f71a0..6b6b654c8872 100644
...
@@ -860,9 +852,8 @@ static void pxa_camera_eof(unsigned long arg)
...
@@ -871,9 +862,8 @@ static void pxa_camera_eof(unsigned long arg)
...
@@ -885,7 +875,7 @@ static irqreturn_t pxa_camera_irq(int irq, void *data)
...
+	dev_dbg(pcdev_to_dev(pcdev),
 	...
 	if (!status)
@@ -1489,42 +1479,11 @@ static int pxa_camera_try_fmt(struct soc_camera_device *icd,
 	return ret;
 }
...
@@ -1597,8 +1556,7 @@ static struct soc_camera_host_ops pxa_soc_camera_host_ops = {
...
@@ -1692,6 +1650,10 @@ static int pxa_camera_probe(struct platform_device *pdev)
 		return -ENOMEM;
 	}
...
@@ -1828,6 +1790,7 @@ static int pxa_camera_remove(struct platform_device *pdev)
