...
Received: from metis.ext.pengutronix.de ([85.220.165.71]:37551 "EHLO
        ...
        with ESMTP id S1728410AbeHMMGy (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Mon, 13 Aug 2018 08:06:54 -0400
...
Subject: [PATCH v2 1/7] [media] tvp5150: add input source selection of_graph support
Date: Mon, 13 Aug 2018 11:25:02 +0200
Message-Id: <20180813092508.1334-2-m.felsch@pengutronix.de>
