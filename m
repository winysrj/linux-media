...
Received: from perceval.ideasonboard.com ([213.167.242.64]:50430 "EHLO
        ...
        with ESMTP id S1727193AbeHCNdl (ORCPT
...
Subject: [PATCH v6 10/11] media: vsp1: Support Interlaced display pipelines
Date: Fri,  3 Aug 2018 12:37:29 +0100
Message-Id: <406f40827ae5bbb85a4c4f6b4ee1b2e964c007a5.1533295631.git-series.kieran.bingham+renesas@ideasonboard.com>
...
+	u32 status = vsp1_read(vsp1, VI6_STATUS);
 	...
 	spin_lock(&dlm->lock);
@@ -972,6 +974,14 @@ unsigned int vsp1_dlm_irq_frame_end(struct vsp1_dl_manager *dlm)
 		goto done;
