...
Received: from mail.kernel.org ([198.145.29.99]:58552 "EHLO mail.kernel.org"
        ...
        id S965332AbdKQPrn (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Fri, 17 Nov 2017 10:47:43 -0500
From: Kieran Bingham <kieran.bingham+renesas@ideasonboard.com>
To: laurent.pinchart@ideasonboard.com, kieran.bingham@ideasonboard.com
Cc: linux-media@vger.kernel.org, linux-renesas-soc@vger.kernel.org,
        Kieran Bingham <kieran.bingham+renesas@ideasonboard.com>
Subject: [PATCH v4 4/9] v4l: vsp1: Convert display lists to use new body pool
Date: Fri, 17 Nov 2017 15:47:27 +0000
Message-Id: <d39c7aa3b1881f79e3c181969cb3294822cfd6e6.1510933306.git-series.kieran.bingham+renesas@ideasonboard.com>
...
-
  ...
  * @dlb: The body
@@ -398,11 +310,10 @@ void vsp1_dl_body_write(struct vsp1_dl_body *dlb, u32 reg, u32 data)
...
-	int ret;
 	...
 	if (!dl)
@@ -411,41 +322,39 @@ static struct vsp1_dl_list *vsp1_dl_list_alloc(struct vsp1_dl_manager *dlm)
...
@@ -499,18 +408,13 @@ static void __vsp1_dl_list_put(struct vsp1_dl_list *dl)
...
@@ -547,7 +451,7 @@ void vsp1_dl_list_put(struct vsp1_dl_list *dl)
  */
...
+	vsp1_dl_body_write(dl->body0, reg, data);
 ...
 /**
@@ -560,8 +464,7 @@ void vsp1_dl_list_write(struct vsp1_dl_list *dl, u32 reg, u32 data)
...
@@ -692,9 +595,9 @@ static void vsp1_dl_list_hw_enqueue(struct vsp1_dl_list *dl)
...
@@ -877,45 +780,12 @@ void vsp1_dlm_reset(struct vsp1_dl_manager *dlm)
 	dlm->pending = NULL;
 }
...
@@ -930,13 +800,26 @@ struct vsp1_dl_manager *vsp1_dlm_create(struct vsp1_device *vsp1,
...
@@ -953,12 +836,10 @@ void vsp1_dlm_destroy(struct vsp1_dl_manager *dlm)
 	if (!dlm)
 		return;
