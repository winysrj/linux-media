...
Received: from mail.gmx.net ([213.165.64.20]:57969 "HELO mail.gmx.net"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with SMTP
	id S932137AbZJ3OBO (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Fri, 30 Oct 2009 10:01:14 -0400
Date: Fri, 30 Oct 2009 15:01:27 +0100 (CET)
...
Subject: [PATCH/RFC 7/9 v2] v4l: add an image-bus API for configuring v4l2
 subdev pixel and frame formats
In-Reply-To: <Pine.LNX.4.64.0910301338140.4378@axis700.grange>
Message-ID: <Pine.LNX.4.64.0910301438500.4378@axis700.grange>
