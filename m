...
Received: from mga09.intel.com ([134.134.136.24]:14787 "EHLO mga09.intel.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1754374AbbCCBYW (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Mon, 2 Mar 2015 20:24:22 -0500
Date: Tue, 3 Mar 2015 09:24:05 +0800
From: kbuild test robot <fengguang.wu@intel.com>
To: Rafael =?iso-8859-1?Q?Louren=E7o?= de Lima Chehab
	<chehabrafael@gmail.com>
Cc: kbuild-all@01.org, Mauro Carvalho Chehab <m.chehab@samsung.com>,
	linux-media@vger.kernel.org
Subject: [linuxtv-media:master 371/397]
 drivers/media/usb/dvb-usb-v2/dvb_usb_core.c:704:26: error: 'struct
 dvb_usb_device' has no member named 'media_dev'
Message-ID: <201503030903.ViOB1Kzt%fengguang.wu@intel.com>
MIME-Version: 1.0
...
commit: 6f6c77d8d2e2fc77395d6bb9ed670161f18b6bd4 [371/397] [media] dvb-usb-v2: add support for the media controller at USB driver
...
Note: the linuxtv-media/master HEAD b44b2e06ae463327334235bf160e804632b9b37c builds fine.
      It only hurts bisectibility.

All error/warnings:

   drivers/media/usb/dvb-usb-v2/dvb_usb_core.c: In function 'dvb_usbv2_adapter_frontend_init':
>> drivers/media/usb/dvb-usb-v2/dvb_usb_core.c:704:26: error: 'struct dvb_usb_device' has no member named 'media_dev'
...
vim +704 drivers/media/usb/dvb-usb-v2/dvb_usb_core.c
   ...
   698				dev_dbg(&d->udev->dev, "%s: tuner_attach() failed=%d\n",
   699						__func__, ret);
