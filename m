...
Received: from mx1.redhat.com ([209.132.183.28]:41178 "EHLO mx1.redhat.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1753374Ab0JQM0a (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Sun, 17 Oct 2010 08:26:30 -0400
Message-ID: <4CBADD4F.9050401@redhat.com>
Date: Sun, 17 Oct 2010 09:26:07 -0200
...
Subject: Re: [RESEND][PATCH 1/2 v2] media: Add timberdale video-in driver
References: <1287074214.6322.17.camel@debian>
In-Reply-To: <1287074214.6322.17.camel@debian>
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: 8bit
List-ID: <linux-media.vger.kernel.org>
Sender: <mchehab@pedra>

Em 14-10-2010 13:36, Richard Röjfors escreveu:
...
There are two trivial changes needed for it to compile with some kABI changes for
2.6.37. Except for that, I saw two things that need fix:
	- try_fmt is actually setting the format. try_fmt is a dry-run version of
s_fmt. It should make no changes at the format.
	- your driver is using BKL.
...
Hmm... This logic is at the wrong place. You shouldn't be changing anything
on try_fmt. Instead, you should move it to happen at s_fmt, after the queue_is_busy
test.
...
There's a new argument here. You need to pass also vq:
...
There's a small API change that added a new parameter here. Initializing it with
NULL is the easiest way to comply with the changes:
...
Please use the BKL-free callback (.unlocked_ioctl). Of course, you need to test
if you're properly locking all ioctl's, or use the new v4l2-core supported locking
schema.
