...
Received: from mailout1.w1.samsung.com ([210.118.77.11]:25701 "EHLO
	mailout1.w1.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752441Ab3FELpN (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Wed, 5 Jun 2013 07:45:13 -0400
Received: from eucpsbgm1.samsung.com (unknown [203.254.199.244])
 by mailout1.w1.samsung.com
 (Oracle Communications Messaging Server 7u4-24.01(7.0.4.24.0) 64bit (built Nov
 17 2011)) with ESMTP id <0MNX00CQF4N8CT00@mailout1.w1.samsung.com> for
 linux-media@vger.kernel.org; Wed, 05 Jun 2013 12:45:10 +0100 (BST)
From: Andrzej Hajda <a.hajda@samsung.com>
To: linux-media@vger.kernel.org, devicetree-discuss@lists.ozlabs.org
Cc: s.nawrocki@samsung.com, sw0312.kim@samsung.com,
	Andrzej Hajda <a.hajda@samsung.com>,
	Kyungmin Park <kyungmin.park@samsung.com>
Subject: [PATCH RFC v3] s5k5baf: add camera sensor driver
Date: Wed, 05 Jun 2013 13:44:56 +0200
Message-id: <1370432696-24762-1-git-send-email-a.hajda@samsung.com>
...
index 3d7782b..850d4ad 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -6945,6 +6945,13 @@ L:	linux-media@vger.kernel.org
 S:	Supported
...
+}
+
+static int s5k5baf_parse_gpio(struct s5k5baf_gpio *gpio,
+			      struct device_node *node, int idx)
+{
+	enum of_gpio_flags of_flags;
+	int ret;
+
+	ret = of_get_gpio_flags(node, idx, &of_flags);
+	if (ret < 0)
+		return ret;
+
+	gpio->gpio = ret;
