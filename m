...
Received: from mail-io0-f194.google.com ([209.85.223.194]:33281 "EHLO
        mail-io0-f194.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S966516AbeFSPf1 (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Tue, 19 Jun 2018 11:35:27 -0400
Received: by mail-io0-f194.google.com with SMTP id d185-v6so620062ioe.0
        for <linux-media@vger.kernel.org>; Tue, 19 Jun 2018 08:35:27 -0700 (PDT)
MIME-Version: 1.0
...
Date: Tue, 19 Jun 2018 17:35:25 +0200
Message-ID: <CAKMK7uEvhMF92ifA=7xQ=9GR3NofZNExCDTHZTtikmujJTZ89A@mail.gmail.com>
...
>>
>> I wonder whether we can nuke the normal kmap stuff too ... everyone seem=
s
...
>>> onto at
>>>    *   max 2 atomic dma_buf kmaps at the same time (in any given proces=
s
>>> context).
>>
...
>> succeed." is also not true, might be good to update that stating that km=
ap
...
>>> - *
>>> - * This call must always succeed, any necessary preparations that migh=
t
>>> fail
...
>>> -
>>> -/**
>>> - * dma_buf_kunmap_atomic - Unmap a page obtained by dma_buf_kmap_atomi=
c.
...
>>> @@ -426,30 +426,6 @@ void drm_gem_dmabuf_vunmap(struct dma_buf *dma_buf=
,
>>> void *vaddr)
>>>   }
...
>>> @@ -225,9 +216,7 @@ static const struct dma_buf_ops i915_dmabuf_ops =3D=
  {
...
>>> +++ b/drivers/gpu/drm/i915/selftests/mock_dmabuf.c
>>> @@ -130,9 +130,7 @@ static const struct dma_buf_ops mock_dmabuf_ops =3D=
  {
...
>>> +++ b/drivers/gpu/drm/omapdrm/omap_gem_dmabuf.c
>>> @@ -148,8 +148,6 @@ static const struct dma_buf_ops omap_dmabuf_ops =3D=
 {
>>>         .release =3D drm_gem_dmabuf_release,
...
>>> +++ b/drivers/media/common/videobuf2/videobuf2-dma-sg.c
>>> @@ -507,7 +507,6 @@ static const struct dma_buf_ops vb2_dma_sg_dmabuf_o=
ps
>>> =3D {
...
>>> @@ -80,11 +80,6 @@ static void tee_shm_op_release(struct dma_buf *dmabu=
f)
>>>         tee_shm_release(shm);
>>>   }
