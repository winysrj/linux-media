...
Received: from mail-qk0-f193.google.com ([209.85.220.193]:36929 "EHLO
        mail-qk0-f193.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1751811AbdIALOG (ORCPT
        <rfc822;linux-media@vger.kernel.org>); Fri, 1 Sep 2017 07:14:06 -0400
MIME-Version: 1.0
In-Reply-To: <20170901074513.5e5ddbbe@vento.lan>
References: <cover.1504222628.git.mchehab@s-opensource.com>
 ...
 <20170901063703.673d2d37@vento.lan> <CAJbz7-10_dX2rL9piwKPdwE6V6n8w-_=u4Mf7NccufrwpYEdog@mail.gmail.com>
 <20170901074513.5e5ddbbe@vento.lan>
From: =?UTF-8?Q?Honza_Petrou=C5=A1?= <jpetrous@gmail.com>
Date: Fri, 1 Sep 2017 13:14:04 +0200
Message-ID: <CAJbz7-3tnMxNLhXVzbZ1v-GQoKWh-t_L5gnw+Lj2eay6_C5Q-g@mail.gmail.com>
...
>
>> 2017-09-01 11:37 GMT+02:00 Mauro Carvalho Chehab <mchehab@s-opensource.c=
om>:
...
>> >> >
>> >> > diff --git a/Documentation/media/dmx.h.rst.exceptions b/Documentati=
on/media/dmx.h.rst.exceptions
...
>> >> > @@ -61,4 +49,3 @@ replace define DMX_IMMEDIATE_START :c:type:`dmx_s=
ct_filter_params`
>> >> >  replace typedef dmx_filter_t :c:type:`dmx_filter`
>> >> >  replace typedef dmx_pes_type_t :c:type:`dmx_pes_type`
>> >> >  replace typedef dmx_input_t :c:type:`dmx_input`
>> >> > -replace typedef dmx_source_t :c:type:`dmx_source`
>> >> > diff --git a/Documentation/media/uapi/dvb/dmx-set-source.rst b/Docu=
mentation/media/uapi/dvb/dmx-set-source.rst
...
>> >> > ---------
>> >> > -
>> >> > -.. c:function:: int ioctl(fd, DMX_SET_SOURCE, struct dmx_source *s=
rc)
>> >> > -    :name: DMX_SET_SOURCE
>> >> > -
>> >> > -
...
>> >> > -------------
>> >> > -
>> >> > -On success 0 is returned, on error -1 and the ``errno`` variable i=
s set
>> >> > -appropriately. The generic error codes are described at the
>> >> > -:ref:`Generic Error Codes <gen-errors>` chapter.
>> >> > diff --git a/Documentation/media/uapi/dvb/dmx_fcalls.rst b/Document=
ation/media/uapi/dvb/dmx_fcalls.rst
...
>> >> >      dmx-add-pid
>> >> >      dmx-remove-pid
>> >> > diff --git a/Documentation/media/uapi/dvb/dmx_types.rst b/Documenta=
tion/media/uapi/dvb/dmx_types.rst
>> >> > index 9e907b85cf16..a205c02ccdc1 100644
>> >> > --- a/Documentation/media/uapi/dvb/dmx_types.rst
>> >> > +++ b/Documentation/media/uapi/dvb/dmx_types.rst
>> >> > @@ -197,23 +197,3 @@ struct dmx_stc
>> >> >         unsigned int base;  /* output: divisor for stc to get 90 kH=
z clock */
...
>> >> > -       DMX_SOURCE_DVR3
>> >> > -    } dmx_source_t;
>> >> > diff --git a/include/uapi/linux/dvb/dmx.h b/include/uapi/linux/dvb/=
dmx.h
...
>> >> >         unsigned int base;      /* output: divisor for stc to get 9=
0 kHz clock */
>> >> > @@ -140,7 +129,6 @@ struct dmx_stc {
>> >> >  #define DMX_SET_PES_FILTER       _IOW('o', 44, struct dmx_pes_filt=
er_params)
