...
Received: from outrelay02.libero.it ([212.52.84.102]:52525 "EHLO
	outrelay02.libero.it" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751833AbaBNP3J (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 14 Feb 2014 10:29:09 -0500
Message-ID: <4192955.7985181392391747391.JavaMail.defaultUser@defaultHost>
Date: Fri, 14 Feb 2014 16:29:07 +0100 (CET)
From: "valerio.vanni@inwind.it" <valerio.vanni@inwind.it>
Reply-To: "valerio.vanni@inwind.it" <valerio.vanni@inwind.it>
To: <linux-media@vger.kernel.org>, <torvalds@linux-foundation.org>
Subject: SAA7134 warning during resume from S3: regression 3.8.13 -> 3.9.0
Cc: <mchehab@infradead.org>, <alan@lxorguk.ukuu.org.uk>,
	<linux@rainbow-software.org>, <pavel@suse.cz>, <hverkuil@xs4all.nl>
MIME-Version: 1.0
