...
Received: from gofer.mess.org ([80.229.237.210]:60251 "EHLO gofer.mess.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S936238AbcKKXNK (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Fri, 11 Nov 2016 18:13:10 -0500
From: Sean Young <sean@mess.org>
To: Mauro Carvalho Chehab <mchehab@s-opensource.com>
Cc: linux-media@vger.kernel.org
Subject: [PATCH v3 2/2] [media] serial_ir: use precision ktime rather than guessing
Date: Fri, 11 Nov 2016 23:13:07 +0000
Message-Id: <1478905987-23019-2-git-send-email-sean@mess.org>
...
@@ -89,11 +66,11 @@ static int sense = -1;	/* -1 = auto, 0 = active high, 1 = active low */
...
@@ -748,7 +592,8 @@ static int serial_ir_tx(struct rc_dev *dev, unsigned int *txbuf,
 							unsigned int count)
 {
 	unsigned long flags;
-	long delta = 0;
...
@@ -756,11 +601,18 @@ static int serial_ir_tx(struct rc_dev *dev, unsigned int *txbuf,
 		/* DTR, RTS down */
 		on();
 	}
+
...
@@ -769,7 +621,8 @@ static int serial_ir_tx(struct rc_dev *dev, unsigned int *txbuf,
...
@@ -777,7 +630,8 @@ static int serial_ir_tx_carrier(struct rc_dev *dev, u32 carrier)
