...
Received: from gateway16.websitewelcome.com ([69.56.150.11]:38584 "EHLO
	gateway16.websitewelcome.com" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1752039AbaBKXgA (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 11 Feb 2014 18:36:00 -0500
Received: from gator3086.hostgator.com (ns6171.hostgator.com [50.87.144.121])
	by gateway16.websitewelcome.com (Postfix) with ESMTP id 9564C642E6422
	for <linux-media@vger.kernel.org>; Tue, 11 Feb 2014 17:05:14 -0600 (CST)
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8;
 format=flowed
Content-Transfer-Encoding: 7bit
Date: Tue, 11 Feb 2014 17:05:13 -0600
From: Dean Anderson <linux-dev@sensoray.com>
To: <hverkuil@xs4all.nl>, <linux-dev@sensoray.com>,
	<linux-media@vger.kernel.org>
Subject: Re: [PATCH] s2255drv: upgrade to videobuf2
In-Reply-To: <1392159384-30088-1-git-send-email-linux-dev@sensoray.com>
References: <1392159384-30088-1-git-send-email-linux-dev@sensoray.com>
Message-ID: <cd5a631056e9d46cea6f70e6231c0c33@sensoray.com>
...
>  		return -EINVAL;
> 
> @@ -706,93 +692,45 @@ static int buffer_prepare(struct videobuf_queue
...
>  	vc->bad_payload = 0;
>  	vc->cur_frame = 0;
> @@ -1225,48 +1104,40 @@ static int vidioc_streamon(struct file *file,
...
>  	*i = vc->std;
>  	return 0;
> @@ -1318,8 +1184,7 @@ static int vidioc_g_std(struct file *file, void
> *priv, v4l2_std_id *i)
...
> @@ -1416,8 +1280,8 @@ static int vidioc_g_jpegcomp(struct file *file,
> void *priv,
...
> @@ -1428,9 +1292,9 @@ static int vidioc_s_jpegcomp(struct file *file,
> void *priv,
...
> @@ -1464,8 +1328,7 @@ static int vidioc_g_parm(struct file *file, void 
> *priv,
...
>  	int fdec = FDEC_1;
>  	__u32 def_num, def_dem;
> @@ -1473,8 +1336,8 @@ static int vidioc_s_parm(struct file *file, void 
> *priv,
>  		return -EINVAL;
>  	mode = vc->mode;
...
>  			vc->mode.color |= (1 << 16);
> @@ -2249,7 +2038,7 @@ static int s2255_board_shutdown(struct s2255_dev 
> *dev)
