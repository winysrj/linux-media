...
Received: from nblzone-211-213.nblnetworks.fi ([83.145.211.213]:39748 "EHLO
        hillosipuli.retiisi.org.uk" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1753410AbeDYKyv (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Wed, 25 Apr 2018 06:54:51 -0400
Date: Wed, 25 Apr 2018 13:54:48 +0300
From: Sakari Ailus <sakari.ailus@iki.fi>
To: Todor Tomov <todor.tomov@linaro.org>
Cc: mchehab@kernel.org, hverkuil@xs4all.nl,
        laurent.pinchart@ideasonboard.com, linux-media@vger.kernel.org,
        linux-kernel@vger.kernel.org
Subject: Re: [PATCH v3 2/2] media: Add a driver for the ov7251 camera sensor
Message-ID: <20180425105447.z35h44ep3rqjmfaz@valkosipuli.retiisi.org.uk>
References: <1524582067-28585-1-git-send-email-todor.tomov@linaro.org>
 <1524582067-28585-3-git-send-email-todor.tomov@linaro.org>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <1524582067-28585-3-git-send-email-todor.tomov@linaro.org>
...
A newline would be nice here (before a label).
...
num is either 2 or 3. Could you allocate from the stack instead, and return
an error if num exceeds the reserved space?
...
Nice. But should you round upwards, i.e. DIV_ROUND_UP()?
...
You could assign all these in variable declaration.
