...
Received: from lb1-smtp-cloud3.xs4all.net ([194.109.24.22]:45819 "EHLO
	...
	by vger.kernel.org with ESMTP id S1751080AbcDONEL (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 15 Apr 2016 09:04:11 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hans.verkuil@cisco.com>
Subject: [PATCHv2 02/12] v4l2-pci-skeleton: set q->dev instead of allocating a context
Date: Fri, 15 Apr 2016 15:03:46 +0200
Message-Id: <1460725436-20045-3-git-send-email-hverkuil@xs4all.nl>
