...
Received: from mailout2.w1.samsung.com ([210.118.77.12]:31204 "EHLO
	...
	with ESMTP id S1758530Ab1FVSBo (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 22 Jun 2011 14:01:44 -0400
Date: Wed, 22 Jun 2011 20:01:13 +0200
From: Sylwester Nawrocki <s.nawrocki@samsung.com>
Subject: [PATCH v2 07/18] s5p-fimc: Add the media device driver
In-reply-to: <1308765684-10677-1-git-send-email-s.nawrocki@samsung.com>
To: linux-media@vger.kernel.org, linux-samsung-soc@vger.kernel.org
Cc: m.szyprowski@samsung.com, kyungmin.park@samsung.com,
	s.nawrocki@samsung.com, sw0312.kim@samsung.com,
	riverful.kim@samsung.com
Message-id: <1308765684-10677-8-git-send-email-s.nawrocki@samsung.com>
MIME-version: 1.0
...
+	struct fimc_pipeline		pipeline;
 ...
 /**
@@ -645,6 +653,8 @@ int fimc_prepare_addr(struct fimc_ctx *ctx, struct vb2_buffer *vb,
...
+	if (!fd)
+		return -ENXIO;
+	pm_runtime_get_sync(&fd->pdev->dev);
+
...
+ * There following values are valid:
