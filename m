...
Received: from lb3-smtp-cloud9.xs4all.net ([194.109.24.30]:52790 "EHLO
        lb3-smtp-cloud9.xs4all.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S967621AbeBNLyV (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Wed, 14 Feb 2018 06:54:21 -0500
From: Hans Verkuil <hverkuil@xs4all.nl>
To: stable@vger.kernel.org
Cc: linux-media@vger.kernel.org, Daniel Mentz <danielmentz@google.com>,
        Hans Verkuil <hans.verkuil@cisco.com>,
        Mauro Carvalho Chehab <mchehab@s-opensource.com>
Subject: [PATCH for v4.1 14/14] media: v4l2-compat-ioctl32.c: refactor compat ioctl32 logic
Date: Wed, 14 Feb 2018 12:54:19 +0100
Message-Id: <20180214115419.28156-15-hverkuil@xs4all.nl>
...
+			return -EINVAL;
 		...
 		if (get_user(p, &up->m.planes))
 			return -EFAULT;
@@ -408,37 +517,43 @@ static int get_v4l2_buffer32(struct v4l2_buffer *kp, struct v4l2_buffer32 __user
...
@@ -447,62 +562,70 @@ static int get_v4l2_buffer32(struct v4l2_buffer *kp, struct v4l2_buffer32 __user
 	return 0;
 }
...
@@ -514,7 +637,7 @@ static int put_v4l2_buffer32(struct v4l2_buffer *kp, struct v4l2_buffer32 __user
...
+	compat_caddr_t		base;
 	struct {
 		__u32		width;
 		__u32		height;
@@ -527,29 +650,32 @@ struct v4l2_framebuffer32 {
 	} fmt;
 };
...
@@ -562,21 +688,26 @@ struct v4l2_input32 {
...
@@ -630,40 +761,64 @@ static inline bool ctrl_is_pointer(struct file *file, u32 id)
...
@@ -680,43 +835,54 @@ static int get_v4l2_ext_controls32(struct file *file,
 }
...
@@ -735,17 +901,18 @@ struct v4l2_event32 {
 	__u32				reserved[8];
 };
...
@@ -758,31 +925,34 @@ struct v4l2_edid32 {
 	compat_caddr_t edid;
 };
...
@@ -799,7 +969,7 @@ static int put_v4l2_edid32(struct v4l2_edid *kp, struct v4l2_edid32 __user *up)
...
@@ -815,22 +985,23 @@ static int put_v4l2_edid32(struct v4l2_edid *kp, struct v4l2_edid32 __user *up)
...
@@ -869,30 +1040,52 @@ static long do_video_ioctl(struct file *file, unsigned int cmd, unsigned long ar
...
@@ -900,36 +1093,63 @@ static long do_video_ioctl(struct file *file, unsigned int cmd, unsigned long ar
...
@@ -938,25 +1158,26 @@ static long do_video_ioctl(struct file *file, unsigned int cmd, unsigned long ar
...
@@ -968,45 +1189,46 @@ static long do_video_ioctl(struct file *file, unsigned int cmd, unsigned long ar
 	case VIDIOC_S_OUTPUT:
 	case VIDIOC_G_INPUT:
 	case VIDIOC_G_OUTPUT:
