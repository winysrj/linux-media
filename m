...
Received: from outbound.icp-qv1-irony-out4.iinet.net.au ([203.59.1.150])
	...
	(envelope-from <sonofzev@iinet.net.au>) id 1Jw442-0007md-GK
	for linux-dvb@linuxtv.org; Wed, 14 May 2008 01:37:47 +0200
...
Message-Id: <1210721864.14631.14.camel@media1>
Mime-Version: 1.0
...
based remote support for the packaged remote (not ir-tty as I don't want
