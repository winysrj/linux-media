...
Received: from mail-wi0-f174.google.com ([209.85.212.174]:57474 "EHLO
	...
	with ESMTP id S1752404Ab2A3MOY (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 30 Jan 2012 07:14:24 -0500
Received: by mail-wi0-f174.google.com with SMTP id s10so3336871wic.19
        for <linux-media@vger.kernel.org>; Mon, 30 Jan 2012 04:14:23 -0800 (PST)
From: Javier Martin <javier.martin@vista-silicon.com>
To: linux-media@vger.kernel.org
Cc: g.liakhovetski@gmx.de, s.hauer@pengutronix.de,
	Javier Martin <javier.martin@vista-silicon.com>
Subject: [PATCH v3 1/4] media i.MX27 camera: migrate driver to videobuf2
Date: Mon, 30 Jan 2012 13:14:10 +0100
Message-Id: <1327925653-13310-1-git-send-email-javier.martin@vista-silicon.com>
...
+				buf->state);
 ...
 #endif
@@ -664,11 +638,10 @@ static void mx2_videobuf_release(struct videobuf_queue *vq,
...
@@ -679,30 +652,28 @@ static void mx2_videobuf_release(struct videobuf_queue *vq,
...
@@ -1135,25 +1106,11 @@ static int mx2_camera_querycap(struct soc_camera_host *ici,
 	return 0;
 }
...
@@ -1164,31 +1121,30 @@ static struct soc_camera_host_ops mx2_soc_camera_host_ops = {
...
+		phys = vb2_dma_contig_plane_dma_addr(vb, 0);
 		if (prp->cfg.channel == 1) {
 			if (readl(pcdev->base_emma + PRP_DEST_RGB1_PTR +
 				4 * bufnum) != phys) {
@@ -1207,16 +1163,15 @@ static void mx27_camera_frame_done_emma(struct mx2_camera_dev *pcdev,
 			}
 		}
 #endif
-		dev_dbg(pcdev->dev, "%s (vb=0x%p) 0x%08lx %d\n", __func__, vb,
...
+		vb2_buffer_done(vb, VB2_BUF_STATE_DONE);
 	...
 	if (list_empty(&pcdev->capture)) {
@@ -1240,16 +1195,16 @@ static void mx27_camera_frame_done_emma(struct mx2_camera_dev *pcdev,
 	}
...
@@ -1293,14 +1248,14 @@ static irqreturn_t mx27_camera_emma_irq(int irq_emma, void *data)
 		 * to first
 		 */
 		buf = list_entry(pcdev->active_bufs.next,
-			struct mx2_buffer, vb.queue);
...
@@ -1461,6 +1416,12 @@ static int __devinit mx2_camera_probe(struct platform_device *pdev)
...
+	}
 	...
 	if (err)
 		goto exit_free_emma;
@@ -1471,6 +1432,8 @@ static int __devinit mx2_camera_probe(struct platform_device *pdev)
 	return 0;
...
@@ -1505,6 +1468,8 @@ static int __devexit mx2_camera_remove(struct platform_device *pdev)
