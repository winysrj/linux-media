...
Received: from mailout3.samsung.com ([203.254.224.33]:19210 "EHLO
	mailout3.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751624AbbCTQyd (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 20 Mar 2015 12:54:33 -0400
...
Subject: [RFC v3 7/9] adv7604: add cec support.
Date: Fri, 20 Mar 2015 17:52:41 +0100
Message-id: <1426870363-18839-8-git-send-email-k.debski@samsung.com>
...
@@ -1862,6 +1867,176 @@ static int adv76xx_set_format(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh,
 	return 0;
 }
...
@@ -1907,6 +2082,9 @@ static int adv76xx_isr(struct v4l2_subdev *sd, u32 status, bool *handled)
 			*handled = true;
 	}
...
+
 	...
 	if (tx_5v) {
@@ -2301,6 +2479,10 @@ static const struct v4l2_subdev_video_ops adv76xx_video_ops = {
