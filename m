...
Received: from idcmail-mo1so.shaw.ca ([24.71.223.10]:38590 "EHLO
	idcmail-mo1so.shaw.ca" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751116AbZHQT1e (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 17 Aug 2009 15:27:34 -0400
From: Thomas Fjellstrom <tfjellstrom@shaw.ca>
Reply-To: tfjellstrom@shaw.ca
To: linux-media@vger.kernel.org
Subject: Re: KWorld UB435-Q support?
Date: Mon, 17 Aug 2009 13:28:08 -0600
Cc: Jarod Wilson <jarod@wilsonet.com>
References: <200908122253.12021.tfjellstrom@shaw.ca> <200908140903.29582.tfjellstrom@shaw.ca> <84CB1AA0-2C5D-4326-9240-11A38FC582DC@wilsonet.com>
In-Reply-To: <84CB1AA0-2C5D-4326-9240-11A38FC582DC@wilsonet.com>
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="iso-8859-1"
Content-Transfer-Encoding: 7bit
Message-Id: <200908171328.08301.tfjellstrom@shaw.ca>
...
Yeah, I've had absolutely no luck with it so far, and have returned it :( 
given your experience, and mine combined, I don't think its worth the time to 
fix it. Especially since I can't even tune a channel on the darn thing in any 
OS I have access to.

It did indeed have trouble keeping a connection, but when ever it lost 
connection, I got that message. And the driver is pretty much stuck. can't 
rmmod it, and it won't redetect the stick, so every single time it looses 
