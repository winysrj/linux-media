...
Received: from wa-out-1112.google.com ([209.85.146.179])
	...
	(envelope-from <beth.null@gmail.com>) id 1KZDTs-00038s-OQ
	for linux-dvb@linuxtv.org; Sat, 30 Aug 2008 01:34:19 +0200
Received: by wa-out-1112.google.com with SMTP id n7so624496wag.13
	for <linux-dvb@linuxtv.org>; Fri, 29 Aug 2008 16:34:11 -0700 (PDT)
Message-ID: <7641eb8f0808291634m63fd0d56me3cf1bb4f12d943b@mail.gmail.com>
Date: Sat, 30 Aug 2008 01:34:11 +0200
From: Beth <beth.null@gmail.com>
To: free_beer_for_all@yahoo.com
In-Reply-To: <757904.94437.qm@web46101.mail.sp1.yahoo.com>
MIME-Version: 1.0
...
The file http://sites.google.com/site/bethnull/Home/scan_test_second_try.tg=
z?attredirects=3D0
had the test (I was a bit impatient and there are only 3 scans).

And dvbtune, dammit, or it doesnt works for me or I am not using it correct=
ly:
...
>   1977
>   1978         /**
>   1979          *  filter timeouts > min repetition rates specified in ET=
R211
>   1980          */
...
> +             if (!no_nits) {
>                setup_filter (&s2, demux_devname, 0x10, 0x40, -1, 1, 0, 15=
); /* NIT */
>                add_filter (&s2);
> +             }
>                if (get_other_nits) {
...
>
> ### SCRAMBLED!!!  ###  NOT RUNNING!  #Blue Hustler:10920:h:1:22000:0:0:20=
353
...
>
> ### SCRAMBLED!!!  ###  NOT RUNNING!  #Bundesliga 9:12662:h:1:22000:0:0:13=
110
