...
Received: from mail-we0-f174.google.com ([74.125.82.174]:60964 "EHLO
	mail-we0-f174.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752399Ab2GIIHF (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Mon, 9 Jul 2012 04:07:05 -0400
Received: by weyx8 with SMTP id x8so989593wey.19
        for <linux-media@vger.kernel.org>; Mon, 09 Jul 2012 01:07:03 -0700 (PDT)
MIME-Version: 1.0
In-Reply-To: <1341816350.2489.1.camel@pizza.hi.pengutronix.de>
...
Date: Mon, 9 Jul 2012 10:07:02 +0200
Message-ID: <CACKLOr10RzcTQMJHrtd2K+imvhOcrvq3-vNFwqnKkyr1NSVqEQ@mail.gmail.com>
...
On 9 July 2012 08:45, Philipp Zabel <p.zabel@pengutronix.de> wrote:
> Hi Javier,
>
> Am Freitag, den 06.07.2012, 14:57 +0200 schrieb Javier Martin:
...
>>  drivers/media/video/coda.c   | 1916 ++++++++++++++++++++++++++++++++++++++++++
...
>> index 99937c9..89a0fd8 100644
>> --- a/drivers/media/video/Kconfig
>> +++ b/drivers/media/video/Kconfig
>> @@ -1179,6 +1179,16 @@ config VIDEO_MEM2MEM_TESTDEV
...
>
> I can see no reason to depend on SOC_IMX27 here.
...
Sorry, I forgot to do 's/CODA9/CODA7'.
...
>> + *  i.MX51 -> coda9
>
> i.MX51 and i.MX53 have CODA 7 Series
> i.MX6q has CODA960
...
>> +             switch (dst_fourcc) {
>> +             case V4L2_PIX_FMT_MPEG4:
>> +                     ctx->params.codec_mode = (dev->devtype->product == CODA_DX6) ? CODADX6_MODE_ENCODE_MP4 : CODA9_MODE_ENCODE_MP4;
...
>> +                     break;
>> +             case V4L2_PIX_FMT_H264:
>> +                     ctx->params.codec_mode = (dev->devtype->product == CODA_DX6) ? CODADX6_MODE_ENCODE_H264 : CODA9_MODE_ENCODE_H264;
...
>
> Space/tab mixture (there are several more of those).
>
...
>
> CODA7_MODE_...
> Especially those again chainged for CODA9, I think.
>
