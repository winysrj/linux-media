...
Received: from smtp-vbr5.xs4all.nl ([194.109.24.25]:1705 "EHLO
	smtp-vbr5.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1754205AbaG3OXa (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 30 Jul 2014 10:23:30 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hans.verkuil@cisco.com>
Subject: [PATCHv1 06/12] vivid: add VBI capture and output code
Date: Wed, 30 Jul 2014 16:23:09 +0200
Message-Id: <1406730195-64365-7-git-send-email-hverkuil@xs4all.nl>
...
+
+	wss_data = (data->data[0] << 8) | data->data[1];
+	for (i = 13; i >= 0; i--, bit += 6)
