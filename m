...
Received: from bhuna.collabora.co.uk ([46.235.227.227]:39908 "EHLO
        ...
        with ESMTP id S932263AbeF2SWw (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Fri, 29 Jun 2018 14:22:52 -0400
...
Subject: [PATCH v4 0/2] Memory-to-memory media controller topology
Date: Fri, 29 Jun 2018 15:22:42 -0300
Message-Id: <20180629182244.4235-1-ezequiel@collabora.com>
...
Media Controller ioctls:
	...
	Entities: 3 Interfaces: 1 Pads: 4 Links: 4
		...
		Entity: 0x00000003 (Name: 'vim2m-proc', Type: Unknown legacy device node type (0001ffff) DevPath: /dev/video2)
