...
Received: from mail-wr0-f193.google.com ([209.85.128.193]:33941 "EHLO
        mail-wr0-f193.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1752039AbdHIUbh (ORCPT
        <rfc822;linux-media@vger.kernel.org>); Wed, 9 Aug 2017 16:31:37 -0400
Received: by mail-wr0-f193.google.com with SMTP id o33so5202453wrb.1
...
Subject: [PATCH v3 01/12] [media] ddbridge: bump ddbridge code to version 0.9.29
Date: Wed,  9 Aug 2017 22:31:17 +0200
Message-Id: <20170809203128.31476-2-d.scheller.oss@gmail.com>
...
---
 drivers/media/pci/ddbridge/ddbridge-core.c | 3305 +++++++++++++++++++++-------
 ...
 6 files changed, 3388 insertions(+), 1169 deletions(-)

diff --git a/drivers/media/pci/ddbridge/ddbridge-core.c b/drivers/media/pci/ddbridge/ddbridge-core.c
index 7e164a370273..9d28448524de 100644
...
+	ddbwritel(dev, 0, tag | SPI_CONTROL);
 	...
 	if (rlen < 4)
 		data <<= ((4 - rlen) * 8);
@@ -1741,31 +2893,47 @@ static int flashio(struct ddb *dev, u8 *wbuf, u32 wlen, u8 *rbuf, u32 rlen)
 		rbuf++;
 		rlen--;
 	}
+exit:
...
@@ -1773,90 +2941,685 @@ static int ddb_open(struct inode *inode, struct file *file)
