...
Received: from mail.dibcom.eu ([84.37.95.247]:37221 "EHLO mail.dibcom.eu"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1752473Ab1HYJIm convert rfc822-to-8bit (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 25 Aug 2011 05:08:42 -0400
From: Patrick Boettcher <Patrick.Boettcher@dibcom.com>
To: Ben Hutchings <ben@decadent.org.uk>
CC: "639161@bugs.debian.org" <639161@bugs.debian.org>,
	"Soeren D. Schulze" <soeren.d.schulze@gmx.de>,
	linux-media <linux-media@vger.kernel.org>
Date: Thu, 25 Aug 2011 10:34:22 +0200
Subject: Re: Bug#639161: linux-image-3.0.0-1-686-pae: Upgrade 2.6.39 ->
 3.0.0 breaks playback on DiBcom 7000PC
Message-ID: <57C38DA176A0A34A9B9F3CCCE33D3C4A015F1CDA00AF@FRPAR1CL009.coe.adi.dibcom.com>
References: <4E552DE2.6000908@gmx.de> <1314226243.27179.56.camel@deadeye>
In-Reply-To: <1314226243.27179.56.camel@deadeye>
...
> [   26.999084] wlan0: RX AssocResp from 00:12:80:61:35:51 (capab=0x421
> status=0 aid=242)
...
> [   54.887762] agpgart-via 0000:00:00.0: putting AGP V3 device into 8x
mode
> [   54.887870] pci 0000:01:00.0: putting AGP V3 device into 8x mode
> [   55.014046] saa7134[0]/irq[10,-61247]: r=0x20 s=0x00 PE
...
> rc_core                17944  11
>
rc_dib0700_rc5,ir_lirc_codec,ir_sony_decoder,dvb_usb_dib0700,ir_jvc_decoder,ir_rc6_decoder,dvb_usb,ir_rc5_decoder,ir_nec_decoder,saa7134
...
> snd                    38562  14
>
saa7134_alsa,snd_ens1371,snd_via82xx,snd_ac97_codec,snd_mpu401_uart,snd_pcm_oss,snd_mixer_oss,snd_pcm,snd_rawmidi,snd_seq,snd_timer,snd_seq_device
> evdev                  12995  11
> i2c_viapro             12451  0
> shpchp                 26759  0
...
> i2c_core               19141  15
>
drm,dvb_usb_dib0700,dib7000p,dib0090,dib7000m,dib0070,dvb_usb,dib8000,dib3000mc,dibx000_common,saa7134,v4l2_common,videodev,tveeprom,i2c_viapro
