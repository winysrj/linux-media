...
Received: from lb1-smtp-cloud2.xs4all.net ([194.109.24.21]:37622 "EHLO
	lb1-smtp-cloud2.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1753087AbaKQORU (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 17 Nov 2014 09:17:20 -0500
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hans.verkuil@cisco.com>
Subject: [RFCv1 PATCH 4/8] DocBook media: rewrite the Colorspace chapter
Date: Mon, 17 Nov 2014 15:16:50 +0100
Message-Id: <1416233814-40579-5-git-send-email-hverkuil@xs4all.nl>
...
@@ -178,6 +178,65 @@ Signal - NTSC for Studio Applications"</title>
...
+
     <biblioentry id="iec62106">
       ...
       <authorgroup>
@@ -266,4 +325,20 @@ in the frequency range from 87,5 to 108,0 MHz</title>
...
@@ -296,343 +296,986 @@ in the 2-planar version or with each component in its own buffer in the
...
+and these X, Y and Z values describe a color as perceived by a human unambiguously.</para>
...
+used. Upper case refers to the CIE XYZ colorspace.</para>
...
+	  </row>
+	  <row>
+	    <entry><constant>V4L2_YCBCR_ENC_BT2020NC</constant></entry>
+	    <entry>Use the default non-constant luminance BT.2020 Y'CbCr encoding.</entry>
+	  </row>
+	  <row>
+	    <entry><constant>V4L2_YCBCR_ENC_BT2020C</constant></entry>
...
+      <para>The <xref linkend="adobergb" /> standard defines the colorspace used by computer graphics. The default
+Y'CbCr encoding is <constant>V4L2_YCBCR_ENC_601</constant>. The default Y'CbCr quantization is
+limited range. The chromaticities of the primary colors and the white reference are:</para>
+      <table frame="none">
...
+television (UHDTV). The default Y'CbCr encoding is <constant>V4L2_YCBCR_ENC_BT2020NC</constant>.
+The default Y'CbCr quantization is limited range. The chromaticities of the primary colors and
+the white reference are:</para>
+      <table frame="none">
...
+	<varlistentry>
+      	  <term>The luminance (Y') and color difference (Cb and Cr) are obtained with the
+following <constant>V4L2_YCBCR_ENC_BT2020NC</constant> encoding:</term>
+	  <listitem>
...
+(<constant>V4L2_YCBCR_ENC_BT2020C</constant>) encoding:</para>
+      <variablelist>
+	<varlistentry>
+      	  <term>Luma:</term>
+	  <listitem>
