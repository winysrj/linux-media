...
Received: from smtp-vbr15.xs4all.nl ([194.109.24.35]:4404 "EHLO
	smtp-vbr15.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S932202Ab3JOPJM (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 15 Oct 2013 11:09:12 -0400
Message-ID: <525D5A77.4050704@xs4all.nl>
Date: Tue, 15 Oct 2013 17:08:39 +0200
...
In-Reply-To: <1381847218-8408-1-git-send-email-pali.rohar@gmail.com>
...
Thanks for the patch, but I am afraid it will need some work to make this
acceptable for inclusion into the kernel.

The main thing you need to do is to implement all the controls using the
control framework (see Documentation/video4linux/v4l2-controls.txt). Most drivers
are by now converted to the control framework, so you will find many examples of
how to do this in drivers/media/radio.

The sysfs stuff should be replaced by controls as well. A lot of the RDS support
is now available as controls (although there may well be some missing features,
but that is easy enough to add). Since the RDS data is actually read() from the
device I am not sure whether the RDS properties/controls should be there at all.

Finally this driver should probably be split up into two parts: one v4l2_subdev-based
core driver and one platform driver. See e.g. radio-si4713/si4713-i2c.c as a good
example. But I would wait with that until the rest of the driver is cleaned up. Then
I have a better idea of whether this is necessary or not.

It's also very useful to run v4l2-compliance (available in the v4l-utils.git repo
on git.linuxtv.org). That does lots of sanity checks.

Another option is to add the driver as-is to drivers/staging/media, and clean it up
bit by bit.
...
> index 6ecdc39..fdd14ef 100644
> --- a/drivers/media/radio/Kconfig
> +++ b/drivers/media/radio/Kconfig
> @@ -50,6 +50,16 @@ config USB_MR800
...
> index 3b64560..9849f83 100644
> --- a/drivers/media/radio/Makefile
> +++ b/drivers/media/radio/Makefile
> @@ -24,6 +24,7 @@ obj-$(CONFIG_RADIO_MIROPCM20) += radio-miropcm20.o
