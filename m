...
Received: from mga12.intel.com ([192.55.52.136]:8005 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728003AbeJESub (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Fri, 5 Oct 2018 14:50:31 -0400
Date: Fri, 5 Oct 2018 14:50:59 +0300
...
Cc: Hans Verkuil <hans.verkuil@cisco.com>,
        ...
        jacopo@jmondi.org
Subject: Re: [PATCH v7 2/2] [media] imx214: Add imx214 camera sensor driver
Message-ID: <20181005115059.63uxeiayq3puadhs@paasikivi.fi.intel.com>
References: <20181004140834.5628-1-ricardo.ribalda@gmail.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20181004140834.5628-1-ricardo.ribalda@gmail.com>
...
> Sakari Ailus (Thanks!):
> -remove is_on
> -serialize start_streaming
> -style
> -rebase on: https://git.linuxtv.org/sailus/media_tree.git/log/?h=v4l2-fwnode
> -reuse ctrl lock
> 
>  MAINTAINERS                |    8 +
>  drivers/media/i2c/Kconfig  |   12 +
>  drivers/media/i2c/Makefile |    1 +
>  drivers/media/i2c/imx214.c | 1125 ++++++++++++++++++++++++++++++++++++
...
> index 000000000000..fa7754e1fed7
> --- /dev/null
...
goto done is fine here. One line less.
...
If the patch is merged now, will address this later?

It shouldn't be too hard to figure out when the value starts affecting the
frame rate.
...
Btw. doing v4l2_ctrl_handler_setup() here will do nothing: the device is
off (or being powered off) by here.
