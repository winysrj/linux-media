...
Received: from mta-out1.inet.fi ([62.71.2.231]:38755 "EHLO kirsi1.inet.fi"
	...
	id S1752261AbaHFHFK (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Wed, 6 Aug 2014 03:05:10 -0400
From: Olli Salonen <olli.salonen@iki.fi>
To: linux-media@vger.kernel.org
Cc: Olli Salonen <olli.salonen@iki.fi>
Subject: [PATCH 1/3] sp2: Add I2C driver for CIMaX SP2 common interface module
Date: Wed,  6 Aug 2014 10:05:02 +0300
Message-Id: <1407308704-4120-1-git-send-email-olli.salonen@iki.fi>
