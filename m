...
Received: from mailout2.w1.samsung.com ([210.118.77.12]:45614 "EHLO
	mailout2.w1.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S932301Ab2HVQTB (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 22 Aug 2012 12:19:01 -0400
Received: from eusync1.samsung.com (mailout2.w1.samsung.com [210.118.77.12])
 by mailout2.w1.samsung.com
 (Oracle Communications Messaging Server 7u4-24.01(7.0.4.24.0) 64bit (built Nov
 17 2011)) with ESMTP id <0M960094O00C6SC0@mailout2.w1.samsung.com> for
 linux-media@vger.kernel.org; Wed, 22 Aug 2012 17:19:24 +0100 (BST)
Received: from AMDN157 ([106.116.147.102])
 ...
 linux-media@vger.kernel.org; Wed, 22 Aug 2012 17:18:59 +0100 (BST)
...
References: <1344508110-16945-1-git-send-email-arun.kk@samsung.com>
 <1344508110-16945-4-git-send-email-arun.kk@samsung.com>
In-reply-to: <1344508110-16945-4-git-send-email-arun.kk@samsung.com>
Subject: RE: [PATCH v4 3/4] [media] s5p-mfc: MFCv6 register definitions
Date: Wed, 22 Aug 2012 18:18:58 +0200
Message-id: <007301cd8081$d5d22cf0$817686d0$%debski@samsung.com>
MIME-version: 1.0
...
> +
> +#define S5P_FIMV_SI_DISPLAY_Y_ADR_V6
S5P_FIMV_D_DISPLAY_LUMA_ADDR_V6
> +#define S5P_FIMV_SI_DISPLAY_C_ADR_V6
S5P_FIMV_D_DISPLAY_CHROMA_ADDR_V6
> +
> +#define S5P_FIMV_CRC_LUMA0_V6
S5P_FIMV_D_DECODED_LUMA_CRC_TOP_V6
> +#define S5P_FIMV_CRC_CHROMA0_V6
> 	S5P_FIMV_D_DECODED_CHROMA_CRC_TOP_V6
> +#define S5P_FIMV_CRC_LUMA1_V6
S5P_FIMV_D_DECODED_LUMA_CRC_BOT_V6
> +#define S5P_FIMV_CRC_CHROMA1_V6
> 	S5P_FIMV_D_DECODED_CHROMA_CRC_BOT_V6
> +#define S5P_FIMV_CRC_DISP_LUMA0_V6
S5P_FIMV_D_DISPLAY_LUMA_CRC_TOP_V6
> +#define S5P_FIMV_CRC_DISP_CHROMA0_V6
> 	S5P_FIMV_D_DISPLAY_CHROMA_CRC_TOP_V6
> +
> +#define S5P_FIMV_SI_DECODED_STATUS_V6
S5P_FIMV_D_DECODED_STATUS_V6
> +#define S5P_FIMV_SI_DISPLAY_STATUS_V6
S5P_FIMV_D_DISPLAY_STATUS_V6
> +#define S5P_FIMV_SHARED_SET_FRAME_TAG_V6	S5P_FIMV_D_PICTURE_TAG_V6
> +#define S5P_FIMV_SHARED_GET_FRAME_TAG_TOP_V6
S5P_FIMV_D_RET_PICTURE_TAG_TOP_V6
> +#define S5P_FIMV_CRC_DISP_STATUS_V6		S5P_FIMV_D_DISPLAY_STATUS_V6
> +
> +/* SEI related information */
> +#define S5P_FIMV_FRAME_PACK_SEI_AVAIL_V6
S5P_FIMV_D_FRAME_PACK_SEI_AVAIL_V6
> +#define S5P_FIMV_FRAME_PACK_ARRGMENT_ID_V6
> 	S5P_FIMV_D_FRAME_PACK_ARRGMENT_ID_V6
> +#define S5P_FIMV_FRAME_PACK_SEI_INFO_V6
> 	S5P_FIMV_D_FRAME_PACK_SEI_INFO_V6
> +#define S5P_FIMV_FRAME_PACK_GRID_POS_V6
> 	S5P_FIMV_D_FRAME_PACK_GRID_POS_V6
> +
...
> +#define S5P_FIMV_ENCODED_LUMA_ADDR_V6
> 	S5P_FIMV_E_ENCODED_SOURCE_LUMA_ADDR_V6
> +#define S5P_FIMV_ENCODED_CHROMA_ADDR_V6
> 	S5P_FIMV_E_ENCODED_SOURCE_CHROMA_ADDR_V6
> +#define	S5P_FIMV_FRAME_INSERTION_V6
> 	S5P_FIMV_E_FRAME_INSERTION_V6
> +
> +#define S5P_FIMV_PARAM_CHANGE_FLAG_V6
S5P_FIMV_E_PARAM_CHANGE_V6 /* flag
> */
> +#define S5P_FIMV_NEW_I_PERIOD_V6		S5P_FIMV_E_GOP_CONFIG_V6
> +#define S5P_FIMV_NEW_RC_FRAME_RATE_V6
...
> +
> +#define S5P_FIMV_FRAME_WIDTH_TO_MB_WIDTH_V6(w)		((w + 15) /
16)

I think this one can be safely replaced with ALIGN(w,
S5P_FIMV_NUM_PIXELS_IN_MB_ROW_V6)
(in the driver's code of course)
