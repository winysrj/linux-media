...
Received: from comal.ext.ti.com ([198.47.26.152]:60403 "EHLO comal.ext.ti.com"
	...
	id S933347Ab1J2Ovo (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Sat, 29 Oct 2011 10:51:44 -0400
Received: from dbdp20.itg.ti.com ([172.24.170.38])
	by comal.ext.ti.com (8.13.7/8.13.7) with ESMTP id p9TEpeD7031778
...
Subject: [RFC PATCH v3 7/8] davinci: vpfe: v4l2 capture driver with media interface
Date: Sat, 29 Oct 2011 20:21:31 +0530
Message-ID: <1319899892-19658-8-git-send-email-manjunath.hadli@ti.com>
...
+
+	vpfe_dev->ipipe = kmalloc(sizeof(struct ipipe_oper_state), GFP_KERNEL);
+	if (!vpfe_dev->ipipe) {
+		v4l2_err(pdev->dev.driver,
+			"Failed to allocate memory for ipipe\n");
+		ret = -ENOMEM;
+		goto probe_free_dev_mem;
+	}
+
