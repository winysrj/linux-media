...
Received: from gateway05.websitewelcome.com ([69.56.195.29]:59080 "EHLO
	gateway05.websitewelcome.com" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1753067AbaBLUvn (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 12 Feb 2014 15:51:43 -0500
Received: from gator3086.hostgator.com (ns6171.hostgator.com [50.87.144.121])
	by gateway05.websitewelcome.com (Postfix) with ESMTP id 5297CA675263F
	for <linux-media@vger.kernel.org>; Wed, 12 Feb 2014 14:26:55 -0600 (CST)
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8;
 format=flowed
Content-Transfer-Encoding: 7bit
Date: Wed, 12 Feb 2014 14:26:54 -0600
From: Dean Anderson <linux-dev@sensoray.com>
To: <hverkuil@xs4all.nl>, <linux-dev@sensoray.com>,
	<linux-media@vger.kernel.org>
Subject: Re: [PATCH v2] s2255drv: upgrade to videobuf2
In-Reply-To: <1392236745-27109-1-git-send-email-linux-dev@sensoray.com>
References: <1392236745-27109-1-git-send-email-linux-dev@sensoray.com>
Message-ID: <b788b2ee09d2d6f6e6e461d39a629227@sensoray.com>
...
> @@ -569,21 +564,20 @@ static int s2255_got_frame(struct s2255_vc *vc,
> int jpgsize)
...
>  		return -EINVAL;
> 
> @@ -706,98 +692,51 @@ static int buffer_prepare(struct videobuf_queue
...
>  	return 0;
>  }
> @@ -820,8 +759,7 @@ static int vidioc_enum_fmt_vid_cap(struct file
> *file, void *priv,
...
> @@ -844,8 +782,7 @@ static int vidioc_try_fmt_vid_cap(struct file
> *file, void *priv,
>  {
>  	const struct s2255_fmt *fmt;
>  	enum v4l2_field field;
...
> @@ -905,14 +842,13 @@ static int vidioc_try_fmt_vid_cap(struct file
> *file, void *priv,
...
>  	if (ret < 0)
>  		return ret;
> @@ -922,24 +858,16 @@ static int vidioc_s_fmt_vid_cap(struct file
> *file, void *priv,
>  	if (fmt == NULL)
>  		return -EINVAL;
> 
...
> @@ -984,44 +912,9 @@ static int vidioc_s_fmt_vid_cap(struct file
> *file, void *priv,
>  		mode.restart = 1;
>  	vc->mode = mode;
...
>  static int s2255_write_config(struct usb_device *udev, unsigned char 
> *pbuf,
> @@ -1199,24 +1092,11 @@ static int s2255_cmd_status(struct s2255_vc
> *vc, u32 *pstatus)
>  	return res;
>  }
> 
...
>  	vc->bad_payload = 0;
>  	vc->cur_frame = 0;
> @@ -1225,48 +1105,40 @@ static int vidioc_streamon(struct file *file,
...
> @@ -1287,22 +1159,17 @@ static int vidioc_s_std(struct file *file,
...
>  	*i = vc->std;
>  	return 0;
> @@ -1318,8 +1185,7 @@ static int vidioc_g_std(struct file *file, void
> *priv, v4l2_std_id *i)
...
> @@ -1416,8 +1281,8 @@ static int vidioc_g_jpegcomp(struct file *file,
> void *priv,
...
> @@ -1428,13 +1293,14 @@ static int vidioc_s_jpegcomp(struct file
> *file, void *priv,
...
> @@ -1464,8 +1330,7 @@ static int vidioc_g_parm(struct file *file, void 
> *priv,
...
>  	int fdec = FDEC_1;
>  	__u32 def_num, def_dem;
> @@ -1473,8 +1338,8 @@ static int vidioc_s_parm(struct file *file, void 
> *priv,
>  		return -EINVAL;
>  	mode = vc->mode;
...
> @@ -1494,6 +1359,7 @@ static int vidioc_s_parm(struct file *file, void 
> *priv,
>  	}
>  	mode.fdec = fdec;
>  	sp->parm.capture.timeperframe.denominator = def_dem;
...
> %d\n",
>  		__func__,
> @@ -1518,8 +1384,7 @@ static const struct v4l2_frmsize_discrete 
> pal_sizes[] = {
...
>  	const struct s2255_fmt *fmt;
> 
> @@ -1537,8 +1402,7 @@ static int vidioc_enum_framesizes(struct file
> *file, void *priv,
...
>  	int is_ntsc = vc->std & V4L2_STD_525_60;
> @@ -1570,16 +1434,18 @@ static int vidioc_enum_frameintervals(struct
> file *file, void *priv,
>  	return 0;
>  }
> 
...
> @@ -1720,59 +1540,14 @@ static void s2255_destroy(struct s2255_dev 
> *dev)
>  	kfree(dev);
>  }
> 
...
> @@ -1781,17 +1556,17 @@ static const struct v4l2_ioctl_ops 
> s2255_ioctl_ops = {
...
> @@ -1847,6 +1622,8 @@ static int s2255_probe_v4l(struct s2255_dev 
> *dev)
>  	int i;
>  	int cur_nr = video_nr;
>  	struct s2255_vc *vc;
...
>  	if (ret)
>  		return ret;
> @@ -1879,8 +1656,24 @@ static int s2255_probe_v4l(struct s2255_dev 
> *dev)
...
> @@ -2029,7 +1822,7 @@ static int save_frame(struct s2255_dev *dev,
...
>  		return -EINVAL;
> @@ -2073,7 +1866,7 @@ static int save_frame(struct s2255_dev *dev,
> struct s2255_pipeinfo *pipe_info)
...
>  		vc->frame_count++;
>  		frm->ulState = S2255_READ_IDLE;
> @@ -2222,7 +2015,6 @@ static int s2255_board_init(struct s2255_dev 
> *dev)
> 
...
>  			vc->mode.color |= (1 << 16);
> @@ -2249,7 +2041,7 @@ static int s2255_board_shutdown(struct s2255_dev 
> *dev)
...
> @@ -2397,7 +2189,6 @@ static int s2255_stop_acquire(struct s2255_vc 
> *vc)
>  	if (res != 0)
...
>  	return res;
> @@ -2503,6 +2294,8 @@ static int s2255_probe(struct usb_interface 
> *interface,
>  		vc->dev = dev;
...
> @@ -2548,7 +2341,6 @@ static int s2255_probe(struct usb_interface 
> *interface,
