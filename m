...
Received: from wr-out-0506.google.com ([64.233.184.235])
	...
	(envelope-from <anluoma@gmail.com>) id 1JgPyj-0004Jv-LL
	for linux-dvb@linuxtv.org; Mon, 31 Mar 2008 21:47:38 +0200
Received: by wr-out-0506.google.com with SMTP id c30so892685wra.14
	for <linux-dvb@linuxtv.org>; Mon, 31 Mar 2008 12:47:30 -0700 (PDT)
Message-ID: <754a11be0803311247n6921217agfa0d9ada055b76a6@mail.gmail.com>
Date: Mon, 31 Mar 2008 22:47:29 +0300
From: "Antti Luoma" <anluoma@gmail.com>
To: linux-dvb@linuxtv.org
In-Reply-To: <ea4209750803191655xfadfb03vc9323b6f45cbef1f@mail.gmail.com>
MIME-Version: 1.0
...
Content-Type: multipart/mixed; boundary="===============1207544390=="
Mime-version: 1.0
...
Content-Type: multipart/alternative;
	boundary="----=_Part_26234_2732433.1206992849062"

------=_Part_26234_2732433.1206992849062
...
This was a linux kernel issue, same issue that many others have faced... I
...
> > Hi again,
> >
> > I borrowed Targus 7-port powered usb hub from work today and tried it.
> > At first it hang when I issued the scan -> had to reboot (usb was gone).
> >
> > After that same usb error keeps bothering me and I can't get nothing out
> > of the tuner.
> >
...
> > > > > > > Mar 18 19:03:26 xenbuntu kernel: [13729.312499] usb 6-1: new
> > > > > > > high speed USB device using ehci_hcd and address 15
> > > > > > > Mar 18 19:03:26 xenbuntu kernel: [13729.365651] usb 6-1:
> > > > > > > configuration #1 chosen from 1 choice
> > > > > > > Mar 18 19:03:26 xenbuntu kernel: [13729.365724] dvb-usb: found
> > > > > > > a 'Pinnacle PCTV 72e DVB-T' in warm state.
> > > > > > > Mar 18 19:03:26 xenbuntu kernel: [13729.365841] dvb-usb: will
...
> > > > > > > 2008/3/18, Albert Comerma <albert.comerma@gmail.com>:
> > > > > > > >
> > > > > > > > Are you sure you tested with the new compiled module? Could
...
> > > > > > > > >
> > > > > > > > > I tested the Stick with windows and it found channels ok..
...
> > > > > > > > > > > >
> > > > > > > > > > > >  usb 6-4: new high speed USB device using ehci_hcd
> > > > > > > > > > > > and address 30
> > > > > > > > > > > > [ 6722.607546] usb 6-4: configuration #1 chosen from
> > > > > > > > > > > > 1 choice
...
> > > > > > > > > > > >
> > > > > > > > > > > >
> > > > > > > > > > > > BUT if I do a scan I don't get channels (i checked
...
Hi,<br><br>This was a linux kernel issue, same issue that many others have faced... I compiled 2.6.25-rc7 from <a href="http://kernel.org">kernel.org</a> and now it seem to scan channels!<br><br><br><br><div><span class="gmail_quote">2008/3/20, Albert Comerma &lt;<a href="mailto:albert.comerma@gmail.com">albert.comerma@gmail.com</a>&gt;:</span><blockquote class="gmail_quote" style="border-left: 1px solid rgb(204, 204, 204); margin: 0pt 0pt 0pt 0.8ex; padding-left: 1ex;">
Perhaps try an other computer?<br><br><div><span class="gmail_quote">2008/3/19, Antti Luoma &lt;<a href="mailto:anluoma@gmail.com" target="_blank" onclick="return top.js.OpenExtLink(window,event,this)">anluoma@gmail.com</a>&gt;:</span><div>
<span class="e" id="q_118c97804545fb4d_1"><blockquote class="gmail_quote" style="border-left: 1px solid rgb(204, 204, 204); margin: 0pt 0pt 0pt 0.8ex; padding-left: 1ex;">
...
</span></blockquote></div><br><br clear="all"><br></span></div>-- <br><span>-Antti-
