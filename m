...
X-Spam-Level: 
X-Spam-Status: No, score=-8.8 required=3.0 tests=FREEMAIL_FORGED_FROMDOMAIN,
	FREEMAIL_FROM,HEADER_FROM_DIFFERENT_DOMAINS,INCLUDES_PATCH,MAILING_LIST_MULTI,
	SIGNED_OFF_BY,SPF_PASS,USER_AGENT_GIT autolearn=ham autolearn_force=no
	version=3.4.0
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id 8721BC07E85
	for <linux-media@archiver.kernel.org>; Fri,  7 Dec 2018 09:58:24 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id 491322146D
	for <linux-media@archiver.kernel.org>; Fri,  7 Dec 2018 09:58:24 +0000 (UTC)
DMARC-Filter: OpenDMARC Filter v1.3.2 mail.kernel.org 491322146D
Authentication-Results: mail.kernel.org; dmarc=none (p=none dis=none) header.from=free.fr
Authentication-Results: mail.kernel.org; spf=none smtp.mailfrom=linux-media-owner@vger.kernel.org
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725994AbeLGJ6X (ORCPT <rfc822;linux-media@archiver.kernel.org>);
        Fri, 7 Dec 2018 04:58:23 -0500
Received: from lns-bzn-25-82-254-177-192.adsl.proxad.net ([82.254.177.192]:54257
        "EHLO maze.fork.zz" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1725985AbeLGJ6X (ORCPT
        <rfc822;linux-media@vger.kernel.org>); Fri, 7 Dec 2018 04:58:23 -0500
Received: from over.fork.zz (over.fork.zz [192.168.0.155])
        by maze.fork.zz (8.15.2/8.15.2) with ESMTPS id wB79wGJJ018732
        (version=TLSv1.2 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Fri, 7 Dec 2018 10:58:18 +0100
Received: from over.fork.zz (localhost [127.0.0.1])
        by over.fork.zz (8.15.2/8.15.2) with ESMTPS id wB79wGWG008036
        (version=TLSv1.2 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=NO);
        Fri, 7 Dec 2018 10:58:16 +0100
Received: (from patrick@localhost)
        by over.fork.zz (8.15.2/8.15.2/Submit) id wB79wFAV008035;
        Fri, 7 Dec 2018 10:58:15 +0100
From:   Patrick LERDA <patrick9876@free.fr>
To:     linux-media@vger.kernel.org
Cc:     Patrick LERDA <patrick9876@free.fr>, sean@mess.org
Subject: [PATCHv3 1/1] Add ir-rcmm-driver
Date:   Fri,  7 Dec 2018 10:57:21 +0100
Message-Id: <3a057647b40d9246aca4f64ee771594c32922974.1544175403.git.patrick9876@free.fr>
X-Mailer: git-send-email 2.19.2
In-Reply-To: <20181205002933.20870-2-patrick9876@free.fr>
References: <c44581638d2525bc383a75413259f708@free.fr> <20181205002933.20870-1-patrick9876@free.fr> <20181205002933.20870-2-patrick9876@free.fr>
MIME-Version: 1.0
