...
Received: from smtp.nokia.com ([192.100.122.230]:61017 "EHLO
	mgw-mx03.nokia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1758500Ab0D3RHb (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 30 Apr 2010 13:07:31 -0400
Received: from mgw-mx06.nokia.com (mgw-mx06.nokia.com [192.100.122.233])
	by mgw-mx03.nokia.com (Switch-3.3.3/Switch-3.3.3) with ESMTP id o3UDP99m007416
	(version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-SHA bits=256 verify=OK)
	for <linux-media@vger.kernel.org>; Fri, 30 Apr 2010 16:25:10 +0300
From: "Matti J. Aaltonen" <matti.j.aaltonen@nokia.com>
To: linux-media@vger.kernel.org, hverkuil@xs4all.nl,
	eduardo.valentin@nokia.com
Cc: "Matti J. Aaltonen" <matti.j.aaltonen@nokia.com>
Subject: [PATCH 1/3] MFD: WL1273 FM Radio: MFD driver for the FM radio.
Date: Fri, 30 Apr 2010 15:59:46 +0300
Message-Id: <1272632388-16048-2-git-send-email-matti.j.aaltonen@nokia.com>
...
+
+/**
+ * wl1273_fm_set_volume() -	Set volue.
+ * @core:			A pointer to the device struct.
+ * @volume:			The new volue value.
+ *
+ */
...
+	core->number_of_regions = ARRAY_SIZE(regions);
...
+#define WL1273_CID_FM_REGION		(V4L2_CID_PRIVATE_BASE + 1)
+#define WL1273_CID_FM_CHAN_SPACING	(V4L2_CID_PRIVATE_BASE + 2)
+#define WL1273_CID_FM_RDS_CTRL		(V4L2_CID_PRIVATE_BASE + 3)
+#define WL1273_CID_SEARCH_LVL		(V4L2_CID_PRIVATE_BASE + 4)
+
