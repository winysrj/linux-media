...
Received: from na3sys009aog107.obsmtp.com ([74.125.149.197]:35667 "EHLO
	na3sys009aog107.obsmtp.com" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1753260Ab2K0Pwj convert rfc822-to-8bit
	(ORCPT <rfc822;linux-media@vger.kernel.org>);
	Tue, 27 Nov 2012 10:52:39 -0500
From: Albert Wang <twang13@marvell.com>
To: Guennadi Liakhovetski <g.liakhovetski@gmx.de>
CC: "corbet@lwn.net" <corbet@lwn.net>,
	Linux Media Mailing List <linux-media@vger.kernel.org>,
	Libin Yang <lbyang@marvell.com>
Date: Tue, 27 Nov 2012 07:51:39 -0800
Subject: RE: [PATCH 11/15] [media] marvell-ccic: add soc_camera support in
 mcam core
Message-ID: <477F20668A386D41ADCC57781B1F70430D1367C90C@SC-VEXCH1.marvell.com>
References: <1353677659-24324-1-git-send-email-twang13@marvell.com>
 <Pine.LNX.4.64.1211271516010.22273@axis700.grange>
In-Reply-To: <Pine.LNX.4.64.1211271516010.22273@axis700.grange>
...
>Subject: Re: [PATCH 11/15] [media] marvell-ccic: add soc_camera support in mcam core
>
...
>
>please, double-check, which headers you really need. I don't mean, that only headers
>needed for compilation should be included, some helpers you should include explicitly,
>even if they're already included via some other headers. But headers, from which nothing
...
>
Yes, it looks we missed it. We should consolidate it.
Maybe we can do it in next version.
