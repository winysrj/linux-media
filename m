...
Received: from bear.ext.ti.com ([192.94.94.41]:45333 "EHLO bear.ext.ti.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1757846AbZKRRGw convert rfc822-to-8bit (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 18 Nov 2009 12:06:52 -0500
...
Date: Wed, 18 Nov 2009 11:06:57 -0600
Subject: RE: [PATCH v2] V4L - Adding Digital Video Timings APIs
Message-ID: <A69FA2915331DC488A831521EAE36FE401559C6035@dlee06.ent.ti.com>
References: <1258563824-1310-1-git-send-email-m-karicheri2@ti.com>
In-Reply-To: <1258563824-1310-1-git-send-email-m-karicheri2@ti.com>
...
>+++ b/drivers/media/video/v4l2-compat-ioctl32.c
>@@ -1077,6 +1077,13 @@ long v4l2_compat_ioctl32(struct file *file, unsigned
