...
Received: from ns.mm-sol.com ([37.157.136.199]:39960 "EHLO extserv.mm-sol.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2388169AbeGWMEt (ORCPT <rfc822;linux-media@vger.kernel.org>);
...
Subject: [PATCH v3 29/35] media: camss: csid: Different format support on source pad
Date: Mon, 23 Jul 2018 14:02:46 +0300
Message-Id: <1532343772-27382-30-git-send-email-todor.tomov@linaro.org>
...
@@ -667,15 +708,15 @@ static void csid_try_format(struct csid_device *csid,
...
@@ -709,7 +750,6 @@ static int csid_enum_mbus_code(struct v4l2_subdev *sd,
...
@@ -718,13 +758,16 @@ static int csid_enum_mbus_code(struct v4l2_subdev *sd,
