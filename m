...
Received: from perceval.ideasonboard.com ([95.142.166.194]:51317 "EHLO
	...
	with ESMTP id S1757365Ab0LTLiA (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 20 Dec 2010 06:38:00 -0500
From: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
To: linux-media@vger.kernel.org
Cc: sakari.ailus@maxwell.research.nokia.com
Subject: [RFC/PATCH v5 12/13] v4l: v4l2_subdev userspace frame interval API
Date: Mon, 20 Dec 2010 12:37:24 +0100
Message-Id: <1292845045-7945-13-git-send-email-laurent.pinchart@ideasonboard.com>
...
index 679062d..8f9001c 100644
--- a/drivers/media/video/v4l2-subdev.c
+++ b/drivers/media/video/v4l2-subdev.c
@@ -234,6 +234,22 @@ static long subdev_do_ioctl(struct file *file, unsigned int cmd, void *arg)
