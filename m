...
Received: from perceval.ideasonboard.com ([95.142.166.194]:58186 "EHLO
	...
	with ESMTP id S1754222Ab1BNMVm (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 14 Feb 2011 07:21:42 -0500
From: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
To: linux-media@vger.kernel.org
Cc: sakari.ailus@maxwell.research.nokia.com
Subject: [PATCH v7 10/11] v4l: v4l2_subdev userspace frame interval API
Date: Mon, 14 Feb 2011 13:21:23 +0100
Message-Id: <1297686084-9715-11-git-send-email-laurent.pinchart@ideasonboard.com>
...
index a34edeb..8592720 100644
--- a/Documentation/DocBook/v4l/v4l2.xml
+++ b/Documentation/DocBook/v4l/v4l2.xml
@@ -479,9 +479,11 @@ and discussions on the V4L mailing list.</revremark>
     &sub-reqbufs;
     &sub-s-hw-freq-seek;
     &sub-streamon;
...
@@ -418,6 +422,9 @@ struct v4l2_subdev_pad_ops {
