...
Received: from mga11.intel.com ([192.55.52.93]:62543 "EHLO mga11.intel.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1753259AbaKZPlg (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Wed, 26 Nov 2014 10:41:36 -0500
Date: Wed, 26 Nov 2014 23:40:43 +0800
From: kbuild test robot <fengguang.wu@intel.com>
To: Paul Bolle <pebolle@tiscali.nl>
Cc: kbuild-all@01.org, Mauro Carvalho Chehab <m.chehab@samsung.com>,
	linux-media@vger.kernel.org
Subject: [linuxtv-media:master 7661/7664] omap_vout.c:undefined reference to
 `omap_dispc_unregister_isr'
Message-ID: <201411262342.kAYTAOXi%fengguang.wu@intel.com>
MIME-Version: 1.0
...
>> omap_vout.c:(.text+0x283a4eb): undefined reference to `omap_dispc_unregister_isr'
   drivers/built-in.o: In function `omap_vout_release':
>> omap_vout.c:(.text+0x283a7d3): undefined reference to `omap_dispc_unregister_isr'
   drivers/built-in.o: In function `vidioc_streamon':
>> omap_vout.c:(.text+0x283c0c7): undefined reference to `omap_dispc_register_isr'
   drivers/built-in.o: In function `omap_vout_remove':
>> omap_vout.c:(.text+0x283ceb6): undefined reference to `omap_dss_put_device'
   drivers/built-in.o: In function `omap_vout_dss_omap24xx':
>> (.text+0x283d2f4): undefined reference to `omapdss_get_version'
   drivers/built-in.o: In function `omap_vout_dss_omap34xx':
>> (.text+0x283d323): undefined reference to `omapdss_get_version'
   drivers/built-in.o: In function `omap_vout_probe':
>> omap_vout.c:(.init.text+0xb26dd): undefined reference to `omapdss_is_initialized'
>> omap_vout.c:(.init.text+0xb2706): undefined reference to `omapdss_compat_init'
>> omap_vout.c:(.init.text+0xb28b1): undefined reference to `omap_dss_get_next_device'
>> omap_vout.c:(.init.text+0xb28d0): undefined reference to `omap_dss_get_device'
>> omap_vout.c:(.init.text+0xb290f): undefined reference to `omap_dss_put_device'
>> omap_vout.c:(.init.text+0xb299f): undefined reference to `omap_dss_get_num_overlays'
>> omap_vout.c:(.init.text+0xb29c2): undefined reference to `omap_dss_get_overlay'
>> omap_vout.c:(.init.text+0xb29ef): undefined reference to `omap_dss_get_num_overlay_managers'
>> omap_vout.c:(.init.text+0xb2a12): undefined reference to `omap_dss_get_overlay_manager'
>> omap_vout.c:(.init.text+0xb2a56): undefined reference to `omap_dss_get_overlay'
>> omap_vout.c:(.init.text+0xb2c42): undefined reference to `omap_dss_get_overlay'
>> omap_vout.c:(.init.text+0xb2cd6): undefined reference to `omapdss_compat_uninit'
