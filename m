...
Received: from bombadil.infradead.org ([198.137.202.133]:41508 "EHLO
        ...
        with ESMTP id S1751435AbeDEKDh (ORCPT
        <rfc822;linux-media@vger.kernel.org>); Thu, 5 Apr 2018 06:03:37 -0400
Date: Thu, 5 Apr 2018 07:03:26 -0300
...
Message-ID: <20180405070326.346bd1fa@vento.lan>
In-Reply-To: <20180405065713.4a4ce0e3@vento.lan>
References: <6a0009be-cbf8-671e-9d7d-c78340e93f58@gmail.com>
        <87in97up15.fsf@intel.com>
        <20180405065713.4a4ce0e3@vento.lan>
MIME-Version: 1.0
...
[   43.177394] WARNING: CPU: 1 PID: 711 at drivers/media/v4l2-core/v4l2-dev=
.c:945 __video_register_device+0xc99/0x1090 [videodev]
[   43.177396] Modules linked in: hid_sensor_custom hid_sensor_als hid_sens=
or_incl_3d hid_sensor_rotation hid_sensor_magn_3d hid_sensor_accel_3d hid_s=
ensor_gyro_3d hid_sensor_trigger industrialio_triggered_buffer kfifo_buf jo=
ydev hid_sensor_iio_common hid_rmi(+) rmi_core industrialio videobuf2_vmall=
oc videobuf2_memops videobuf2_v4l2 videobuf2_common videodev hid_multitouch=
 media hid_sensor_hub binfmt_misc nls_iso8859_1 snd_hda_codec_hdmi arc4 snd=
_soc_skl snd_soc_skl_ipc snd_hda_ext_core snd_soc_sst_dsp snd_soc_sst_ipc s=
nd_hda_codec_realtek snd_soc_acpi snd_hda_codec_generic snd_soc_core snd_co=
mpress ac97_bus snd_pcm_dmaengine snd_hda_intel snd_hda_codec intel_rapl sn=
d_hda_core x86_pkg_temp_thermal snd_hwdep intel_powerclamp coretemp snd_pcm=
 kvm_intel snd_seq_midi snd_seq_midi_event snd_rawmidi crct10dif_pclmul
[   43.177426]  crc32_pclmul ghash_clmulni_intel iwlmvm pcbc mac80211 snd_s=
eq aesni_intel iwlwifi aes_x86_64 snd_seq_device crypto_simd glue_helper cr=
yptd snd_timer intel_cstate intel_rapl_perf input_leds serio_raw intel_wmi_=
thunderbolt snd wmi_bmof cfg80211 soundcore ideapad_laptop sparse_keymap id=
ma64 virt_dma tpm_crb acpi_pad int3400_thermal acpi_thermal_rel intel_pch_t=
hermal processor_thermal_device mac_hid int340x_thermal_zone mei_me intel_s=
oc_dts_iosf mei intel_lpss_pci shpchp intel_lpss sch_fq_codel vfio_pci nfsd=
 vfio_virqfd parport_pc ppdev auth_rpcgss nfs_acl lockd grace lp parport su=
nrpc ip_tables x_tables autofs4 hid_logitech_hidpp hid_logitech_dj hid_gene=
ric usbhid kvmgt vfio_mdev mdev vfio_iommu_type1 vfio kvm irqbypass i915 i2=
c_algo_bit drm_kms_helper syscopyarea sdhci_pci sysfillrect
...
[   43.177484] RAX: 0000000000000000 RBX: 0000000000000005 RCX: 00000000000=
00000
[   43.177485] RDX: ffffffffc0c44cc0 RSI: ffffffffffffffff RDI: ffffffffc0c=
44cc0
[   43.177486] RBP: ffffa5c5c231b478 R08: ffffffffc0c96900 R09: ffff8eda1a5=
1f018
[   43.177487] R10: 0000000000000600 R11: 00000000000003b6 R12: 00000000000=
00000
[   43.177488] R13: 0000000000000005 R14: ffffffffc0c96900 R15: ffff8eda1d6=
d91c0
[   43.177489] FS:  00007fd2d8ef2480(0000) GS:ffff8eda33480000(0000) knlGS:=
0000000000000000
[   43.177490] CS:  0010 DS: 0000 ES: 0000 CR0: 0000000080050033
[   43.177491] CR2: 00007ffe0a6ad01c CR3: 0000000456ae2004 CR4: 00000000003=
606e0
...
[   43.177639] RSP: 002b:00007ffe0a6b2368 EFLAGS: 00000246 ORIG_RAX: 000000=
0000000139
[   43.177641] RAX: ffffffffffffffda RBX: 000055cdd86542e0 RCX: 00007fd2d88=
0b839
[   43.177641] RDX: 0000000000000000 RSI: 00007fd2d84ea0e5 RDI: 00000000000=
00016
[   43.177642] RBP: 00007fd2d84ea0e5 R08: 0000000000000000 R09: 00007ffe0a6=
b2480
[   43.177643] R10: 0000000000000016 R11: 0000000000000246 R12: 00000000000=
00000
[   43.177644] R13: 000055cdd8688930 R14: 0000000000020000 R15: 000055cdd86=
542e0
[   43.177645] Code: 48 c7 c7 54 b4 c3 c0 e8 96 9d ec dd e9 d4 fb ff ff 0f =
0b 41 be ea ff ff ff e9 c7 fb ff ff 0f 0b 41 be ea ff ff ff e9 ba fb ff ff =
<0f> 0b e9 d8 f4 ff ff 83 fa 01 0f 84 c4 02 00 00 48 83 78 68 00
[   43.177675] ---[ end trace d44d9bc41477c2dd ]---
[   43.177679] BUG: unable to handle kernel NULL pointer dereference at 000=
0000000000499
[   43.177723] IP: __video_register_device+0x1cc/0x1090 [videodev]
[   43.177749] PGD 0 P4D 0
[   43.177764] Oops: 0000 [#1] SMP PTI
[   43.177780] Modules linked in: hid_sensor_custom hid_sensor_als hid_sens=
or_incl_3d hid_sensor_rotation hid_sensor_magn_3d hid_sensor_accel_3d hid_s=
ensor_gyro_3d hid_sensor_trigger industrialio_triggered_buffer kfifo_buf jo=
ydev hid_sensor_iio_common hid_rmi(+) rmi_core industrialio videobuf2_vmall=
oc videobuf2_memops videobuf2_v4l2 videobuf2_common videodev hid_multitouch=
...
d_hda_core x86_pkg_temp_thermal snd_hwdep intel_powerclamp coretemp snd_pcm=
 kvm_intel snd_seq_midi snd_seq_midi_event snd_rawmidi crct10dif_pclmul
[   43.178055]  crc32_pclmul ghash_clmulni_intel iwlmvm pcbc mac80211 snd_s=
eq aesni_intel iwlwifi aes_x86_64 snd_seq_device crypto_simd glue_helper cr=
yptd snd_timer intel_cstate intel_rapl_perf input_leds serio_raw intel_wmi_=
thunderbolt snd wmi_bmof cfg80211 soundcore ideapad_laptop sparse_keymap id=
ma64 virt_dma tpm_crb acpi_pad int3400_thermal acpi_thermal_rel intel_pch_t=
...
[   43.178490] RAX: ffffffffc0c44cc0 RBX: 0000000000000005 RCX: ffffffffc0c=
454c0
[   43.178519] RDX: 0000000000000001 RSI: ffff8eda1d6d9118 RDI: ffffffffc0c=
44cc0
[   43.178549] RBP: ffffa5c5c231b478 R08: ffffffffc0c96900 R09: ffff8eda1a5=
1f018
[   43.178579] R10: 0000000000000600 R11: 00000000000003b6 R12: 00000000000=
00000
[   43.178608] R13: 0000000000000005 R14: ffffffffc0c96900 R15: ffff8eda1d6=
d91c0
[   43.178636] FS:  00007fd2d8ef2480(0000) GS:ffff8eda33480000(0000) knlGS:=
0000000000000000
[   43.178669] CS:  0010 DS: 0000 ES: 0000 CR0: 0000000080050033
[   43.178693] CR2: 0000000000000499 CR3: 0000000456ae2004 CR4: 00000000003=
606e0
...
[   43.242828] audit: type=3D1400 audit(1522795151.600:4): apparmor=3D"STAT=
US" operation=3D"profile_load" profile=3D"unconfined" name=3D"/snap/core/42=
06/usr/lib/snapd/snap-confine" pid=3D1151 comm=3D"apparmor_parser"
[   43.244859]  driver_probe_device+0x310/0x480
[   43.244862]  __driver_attach+0xbf/0xf0
[   43.246982] audit: type=3D1400 audit(1522795151.600:5): apparmor=3D"STAT=
US" operation=3D"profile_load" profile=3D"unconfined" name=3D"/snap/core/42=
06/usr/lib/snapd/snap-confine//mount-namespace-capture-helper" pid=3D1151 c=
omm=3D"apparmor_parser"
[   43.249403]  ? driver_probe_device+0x480/0x480
[   43.249405]  bus_for_each_dev+0x74/0xb0
[   43.253200] audit: type=3D1400 audit(1522795151.600:6): apparmor=3D"STAT=
US" operation=3D"profile_load" profile=3D"unconfined" name=3D"/snap/core/42=
06/usr/lib/snapd/snap-confine//snap_update_ns" pid=3D1151 comm=3D"apparmor_=
parser"
[   43.254055]  ? kmem_cache_alloc_trace+0x1a6/0x1c0
[   43.256282] audit: type=3D1400 audit(1522795151.604:7): apparmor=3D"STAT=
US" operation=3D"profile_load" profile=3D"unconfined" name=3D"/sbin/dhclien=
t" pid=3D1152 comm=3D"apparmor_parser"
[   43.258436]  driver_attach+0x1e/0x20
[   43.260875] audit: type=3D1400 audit(1522795151.604:8): apparmor=3D"STAT=
US" operation=3D"profile_load" profile=3D"unconfined" name=3D"/usr/lib/Netw=
orkManager/nm-dhcp-client.action" pid=3D1152 comm=3D"apparmor_parser"
[   43.263118]  bus_add_driver+0x167/0x260
[   43.267676] audit: type=3D1400 audit(1522795151.604:9): apparmor=3D"STAT=
US" operation=3D"profile_load" profile=3D"unconfined" name=3D"/usr/lib/Netw=
orkManager/nm-dhcp-helper" pid=3D1152 comm=3D"apparmor_parser"
[   43.268807]  ? 0xffffffffc0cbc000
[   43.268812]  driver_register+0x60/0xe0
[   43.271184] audit: type=3D1400 audit(1522795151.604:10): apparmor=3D"STA=
TUS" operation=3D"profile_load" profile=3D"unconfined" name=3D"/usr/lib/con=
nman/scripts/dhclient-script" pid=3D1152 comm=3D"apparmor_parser"
...
[   43.292348] audit: type=3D1400 audit(1522795151.652:11): apparmor=3D"STA=
TUS" operation=3D"profile_load" profile=3D"unconfined" name=3D"/usr/bin/man=
" pid=3D1242 comm=3D"apparmor_parser"
...
[   43.337810] RSP: 002b:00007ffe0a6b2368 EFLAGS: 00000246 ORIG_RAX: 000000=
0000000139
[   43.341259] RAX: ffffffffffffffda RBX: 000055cdd86542e0 RCX: 00007fd2d88=
0b839
[   43.344613] RDX: 0000000000000000 RSI: 00007fd2d84ea0e5 RDI: 00000000000=
00016
[   43.347962] RBP: 00007fd2d84ea0e5 R08: 0000000000000000 R09: 00007ffe0a6=
b2480
[   43.351456] R10: 0000000000000016 R11: 0000000000000246 R12: 00000000000=
00000
[   43.354845] R13: 000055cdd8688930 R14: 0000000000020000 R15: 000055cdd86=
542e0
[   43.358224] Code: c7 05 ad 12 02 00 00 00 00 00 48 8d 88 00 08 00 00 eb =
09 48 83 c0 08 48 39 c1 74 31 48 8b 10 48 85 d2 74 ef 49 8b b7 98 04 00 00 =
<48> 39 b2 98 04 00 00 75 df 48 63 92 f8 04 00 00 f0 48 0f ab 15
[   43.361764] RIP: __video_register_device+0x1cc/0x1090 [videodev] RSP: ff=
ffa5c5c231b420
[   43.365281] CR2: 0000000000000499

This patch fixes the array size and changes the WARN_ON() to return an erro=
r,
...
diff --git a/drivers/media/v4l2-core/v4l2-dev.c b/drivers/media/v4l2-core/v=
4l2-dev.c
index 0301fe426a43..cc95d6023d57 100644
--- a/drivers/media/v4l2-core/v4l2-dev.c
+++ b/drivers/media/v4l2-core/v4l2-dev.c
@@ -93,7 +93,7 @@ ATTRIBUTE_GROUPS(video_device);
  */
 static struct video_device *video_device[VIDEO_NUM_DEVICES];
 static DEFINE_MUTEX(videodev_lock);
-static DECLARE_BITMAP(devnode_nums[VFL_TYPE_MAX], VIDEO_NUM_DEVICES);
+static DECLARE_BITMAP(devnode_nums[VFL_TYPE_MAX + 1], VIDEO_NUM_DEVICES);
=20
 /* Device node utility functions */
=20
@@ -942,7 +942,11 @@ int __video_register_device(struct video_device *vdev,
 	devnode_set(vdev);
=20
