...
Received: from cnc.isely.net ([64.81.146.143]:52067 "EHLO cnc.isely.net"
	...
	id S1754766Ab0JCUMr (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Sun, 3 Oct 2010 16:12:47 -0400
Date: Sun, 3 Oct 2010 15:07:19 -0500 (CDT)
...
Subject: Re: [PATCH 16/16] v4l: Remove module_name argument to the
 v4l2_i2c_new_subdev* functions
In-Reply-To: <1285337654-5044-17-git-send-email-laurent.pinchart@ideasonboard.com>
Message-ID: <alpine.DEB.1.10.1010031506270.5590@ivanova.isely.net>
References: <1285337654-5044-1-git-send-email-laurent.pinchart@ideasonboard.com> <1285337654-5044-17-git-send-email-laurent.pinchart@ideasonboard.com>
Mime-Version: 1.0
