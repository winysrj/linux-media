...
Received: from mx3.redhat.com (mx3.redhat.com [172.16.48.32])
	by int-mx1.corp.redhat.com (8.13.1/8.13.1) with ESMTP id mBH4qlf5013778
	for <video4linux-list@redhat.com>; Tue, 16 Dec 2008 23:52:47 -0500
Received: from arroyo.ext.ti.com (arroyo.ext.ti.com [192.94.94.40])
	by mx3.redhat.com (8.13.8/8.13.8) with ESMTP id mBH4qcAN006027
	for <video4linux-list@redhat.com>; Tue, 16 Dec 2008 23:52:38 -0500
From: "Hiremath, Vaibhav" <hvaibhav@ti.com>
To: Kuninori Morimoto <morimoto.kuninori@renesas.com>, Guennadi Liakhovetski
	<g.liakhovetski@gmx.de>
Date: Wed, 17 Dec 2008 10:22:22 +0530
Message-ID: <19F8576C6E063C45BE387C64729E739403ECE3AD0A@dbde02.ent.ti.com>
In-Reply-To: <ufxknh84p.wl%morimoto.kuninori@renesas.com>
...
> bounces@redhat.com] On Behalf Of Kuninori Morimoto
> Sent: Wednesday, December 17, 2008 7:20 AM
> To: Guennadi Liakhovetski
> Cc: V4L-Linux
> Subject: [PATCH v4] Add tw9910 driver
>
...
> v3 -> v4
>
> o try_fmt check V4L2_FIELD_
>
>  drivers/media/video/Kconfig     |    6 +
>  drivers/media/video/Makefile    |    1 +
>  drivers/media/video/tw9910.c    |  960
> +++++++++++++++++++++++++++++++++++++++
...
> +
> +/* INFORM */
> +#define FC27_ON     0x40 /* 1 : Input crystal clock frequency is
> 27MHz */
...
> +
> +/* OPFORM */
> +#define MODE        0x80 /* 0 : CCIR601 compatible YCrCb 4:2:2
> format */
...
> +
> +/* OUTCTR1 */
> +#define VSP_LO      0x00 /* 0 : VS pin output polarity is active
> low */
> +#define VSP_HI      0x80 /* 1 : VS pin output polarity is active
> high. */
...
> +#define HSP_LOW     0x00 /* 0 : HS pin output polarity is active
> low */
> +#define HSP_HI      0x08 /* 1 : HS pin output polarity is active
> high.*/
...
> +                            const struct tw9910_cropping_ctrl
> *cropping)
> +{
> +     int ret;
> +
...
> +{
> +     struct tw9910_priv *priv = container_of(icd, struct
> tw9910_priv, icd);
> +     int ret = 0;
> +
...
> +}
> +
> +static unsigned long tw9910_query_bus_param(struct
...
> +             return -EINVAL;
> +
> +     return i2c_smbus_write_byte_data(priv->client, reg->reg, reg-
> >val);
> +}
> +#endif
> +
> +static int tw9910_set_fmt(struct soc_camera_device *icd, __u32
> pixfmt,
...
> +      * select current norm
> +      */
> +     priv->scale = tw9910_select_norm(icd->vdev->current_norm,
> rect);
> +     if (!priv->scale)
...
> +      * set cropping
> +      */
> +     ret = tw9910_set_cropping(priv->client,
...
> +             return -EINVAL;
> +
> +     if (!i2c_check_functionality(to_i2c_adapter(client-
> >dev.parent),
