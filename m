...
Received: from smtp-vbr13.xs4all.nl ([194.109.24.33]:3484 "EHLO
	smtp-vbr13.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752469AbaCGKh7 (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Fri, 7 Mar 2014 05:37:59 -0500
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hans.verkuil@cisco.com>, stable@vger.kernel.org,
	#@tschai.lan, for@tschai.lan, v3.7@tschai.lan, and@tschai.lan,
	up@tschai.lan
Subject: [REVIEW PATCH for v3.14 1/3] v4l2-compat-ioctl32: fix wrong VIDIOC_SUBDEV_G/S_EDID32 support.
Date: Fri,  7 Mar 2014 11:37:47 +0100
Message-Id: <1394188669-22260-2-git-send-email-hverkuil@xs4all.nl>
