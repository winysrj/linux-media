...
Received: from mailgw01.mediatek.com ([210.61.82.183]:35617 "EHLO
	...
	with ESMTP id S932192AbcELLZF (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 12 May 2016 07:25:05 -0400
...
Subject: [PATCH v2 8/9] [media] vcodec: mediatek: Add Mediatek VP9 Video Decoder Driver
Date: Thu, 12 May 2016 19:24:09 +0800
Message-ID: <1463052250-38262-9-git-send-email-tiffany.lin@mediatek.com>
In-Reply-To: <1463052250-38262-8-git-send-email-tiffany.lin@mediatek.com>
...
+		if (vsi->resolution_changed) {
+			*res_chg = true;
+			mtk_vcodec_err(inst, ".........VDEC_ST_RESOLUTION_CHANGED");
+
+			ret = 0;
+			goto DECODE_ERROR;
+		}
...
+	cr->left = 0;
+	cr->top = 0;
+	cr->width = inst->frm_hdr.width;
+	cr->height = inst->frm_hdr.height;
