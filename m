...
Received: from lb2-smtp-cloud3.xs4all.net ([194.109.24.26]:45967 "EHLO
	lb2-smtp-cloud3.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1750970AbcBJMwR (ORCPT
...
Subject: [PATCHv12 07/17] cec: add HDMI CEC framework
Date: Wed, 10 Feb 2016 13:51:41 +0100
Message-Id: <1455108711-29850-8-git-send-email-hverkuil@xs4all.nl>
...
---
 ...
 8 files changed, 5191 insertions(+)
...
+		adap->ops->adap_transmit(adap, data->attempts,
+					 signal_free_time_ms, &data->msg);
+unlock:
...
+		if (adap->is_source)
+			cec_set_phys_addr(adap, CEC_PHYS_ADDR_INVALID);
+		wake_up_interruptible(&adap->kthread_waitq);
+	}
