...
Received: from mail.kapsi.fi ([217.30.184.167]:50444 "EHLO mail.kapsi.fi"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1750844AbaBCLAL (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Mon, 3 Feb 2014 06:00:11 -0500
From: Antti Palosaari <crope@iki.fi>
To: linux-media@vger.kernel.org
Cc: Antti Palosaari <crope@iki.fi>
Subject: [PATCH 2/5] msi3101: use msi001 tuner driver
Date: Mon,  3 Feb 2014 12:59:52 +0200
Message-Id: <1391425195-17865-3-git-send-email-crope@iki.fi>
...
@@ -926,20 +920,24 @@ static int msi3101_ctrl_msg(struct msi3101_state *s, u8 cmd, u32 data)
 	return ret;
 };
...
@@ -1296,6 +1078,9 @@ static int msi3101_start_streaming(struct vb2_queue *vq, unsigned int count)
...
@@ -1330,7 +1115,7 @@ static int msi3101_stop_streaming(struct vb2_queue *vq)
...
@@ -1420,33 +1205,39 @@ static int msi3101_s_tuner(struct file *file, void *priv,
...
@@ -1457,12 +1248,14 @@ static int msi3101_g_frequency(struct file *file, void *priv,
...
@@ -1471,7 +1264,7 @@ static int msi3101_s_frequency(struct file *file, void *priv,
...
@@ -1483,19 +1276,9 @@ static int msi3101_s_frequency(struct file *file, void *priv,
 				__func__, s->f_adc);
 		ret = msi3101_set_usb_adc(s);
 	} else if (f->tuner == 1) {
...
+		ret = -EINVAL;
 	...
 	return ret;
@@ -1514,6 +1297,7 @@ static int msi3101_enum_freq_bands(struct file *file, void *priv,
...
@@ -1570,40 +1354,6 @@ static struct video_device msi3101_template = {
...
@@ -1616,13 +1366,43 @@ static void msi3101_video_release(struct v4l2_device *v)
 	kfree(s);
 }
...
+	};
 	...
 	if (s == NULL) {
@@ -1659,34 +1439,53 @@ static int msi3101_probe(struct usb_interface *intf,
...
@@ -1703,10 +1502,12 @@ static int msi3101_probe(struct usb_interface *intf,
