...
Received: from lb1-smtp-cloud9.xs4all.net ([194.109.24.22]:55760 "EHLO
        ...
        by vger.kernel.org with ESMTP id S1726671AbeKVWXA (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Thu, 22 Nov 2018 17:23:00 -0500
...
Subject: [PATCH for v4.9] Revert "media: videobuf2-core: don't call memop
 'finish' when queueing"
Message-ID: <d9f73b7c-fc28-77ff-8c28-a565e2879efe@xs4all.nl>
