...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id 5BDE1C43381
	for <linux-media@archiver.kernel.org>; Tue, 12 Mar 2019 09:11:46 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id E2DC72147C
	for <linux-media@archiver.kernel.org>; Tue, 12 Mar 2019 09:11:45 +0000 (UTC)
Authentication-Results: mail.kernel.org;
	dkim=pass (1024-bit key) header.d=chromium.org header.i=@chromium.org header.b="EryYNZc8"
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726187AbfCLJLp (ORCPT <rfc822;linux-media@archiver.kernel.org>);
        Tue, 12 Mar 2019 05:11:45 -0400
Received: from mail-lj1-f194.google.com ([209.85.208.194]:44235 "EHLO
        mail-lj1-f194.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725844AbfCLJLo (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Tue, 12 Mar 2019 05:11:44 -0400
Received: by mail-lj1-f194.google.com with SMTP id q128so1557925ljb.11
        for <linux-media@vger.kernel.org>; Tue, 12 Mar 2019 02:11:34 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=chromium.org; s=google;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc;
        bh=7xPUmhQPEuQjf0eWetbkidOHZ1ND1W5usWI71ICMxe8=;
        b=EryYNZc8X2uPqK1BnSrSZx3xaL2JAVCQ2z3ZAMlQimp7pGti12TJP/2Qb/detPzCL/
         dZU+5Qknxuss2alwyjeoFkAJuvzwwdkJsC+Q+wUqUHD9jjs8eFaJaBG0wrwuo9BwQCKP
         sljV8ru/HgDdQ7muQjS2Ol+zUvLe9FXTM4FwI=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:mime-version:references:in-reply-to:from:date
         :message-id:subject:to:cc;
        bh=7xPUmhQPEuQjf0eWetbkidOHZ1ND1W5usWI71ICMxe8=;
        b=
X-Gm-Message-State: APjAAAXyW+mlsNu/rrUxAONx0Wuad/Om+82MqCYkM8JhpYRMBs88MHv3
        HbWxQVLvApJCY6zctLS/OZpmBjoSqGARKyAj0szRWQ==
X-Google-Smtp-Source: APXvYqy9VBFUxq0hurIN4OzAkl0xQP28jKtJ7g9yFWCQ3EhW0Q9zPEBEoZCeYk5/ZPUdF1sjpg+TA8AI5BUCD4K3pHM=
X-Received: by 2002:a2e:814d:: with SMTP id t13mr18984397ljg.46.1552381893040;
 Tue, 12 Mar 2019 02:11:33 -0700 (PDT)
MIME-Version: 1.0
References: <1550733718-31702-1-git-send-email-louis.kuo@mediatek.com>
 <1550733718-31702-2-git-send-email-louis.kuo@mediatek.com>
 <CAAFQd5CVVPjBks=FVPviguvUp5d9Sxh9B--2213vcDnQY+S0wA@mail.gmail.com>
 <CAD90Vca5xV65gnv92n1Cn00megUiP2=Fc4bUnhLjb5UvyyOVZQ@mail.gmail.com> <1552380583.14351.43.camel@mtksdccf07>
In-Reply-To: <1552380583.14351.43.camel@mtksdccf07>
From:   Keiichi Watanabe <keiichiw@chromium.org>
Date:   Tue, 12 Mar 2019 18:11:20 +0900
Message-ID: <CAD90VcZ1_v1+QmFDQZD3=vic4B2pfL_QsTUfpsU8=iBeFYyVjA@mail.gmail.com>
Subject: Re: [RFC PATCH V0 1/4] media: platform: mtk-isp: Add Mediatek sensor
 interface driver
...
I added one inline comment below.

Best regards,
Keiichi

On Tue, Mar 12, 2019 at 5:49 PM Louis Kuo <louis.kuo@mediatek.com> wrote:
>
> Hi Keiichi,
> Thanks for your advice.
> I have fixed code following your comments.
>
> Please help me to review my notes below your comments, I will wait your
> reply and send new patch again.
>
> BRs
> Louis
>
>
>
> On Fri, 2019-03-08 at 18:59 +0900, Keiichi Watanabe wrote:
...
> >
> >
> > On Tue, Mar 5, 2019 at 4:51 PM Tomasz Figa <tfiga@chromium.org> wrote:
> > >
> > > +CC Shik and Keiichi
> > >
> > > On Thu, Feb 21, 2019 at 4:22 PM Louis Kuo <louis.kuo@mediatek.com> wrote:
> > > >
...
> > > > +       int ret = 0;
> >
> > Since |ret| is always 0, you don't need to define |ret|. You can
> > simply write "return 0" instead.
> Got it and fixed.
> >
...
> > > > +       void *pseninf =  NULL;
> >
> > Could you initialize pseninf with priv->seninf_ctrl[seninf_sel] here?
> Got it and fixed.
> >
> > > > +
> > > > +       return 0; /* todo: support virtual channel */
> >
> > Hmm, can we remove this todo now?
> > Or, are the following part still work in progress?
> Yes, this function is prepared for virtual channel case.
> I remove this line and add a define "SUPPORT_VIRTUAL_CHANNEL" to enclose
> this function for future advanced application.

Is supporting virtual channel a separated work?
Then, how about removing this function from this patch and creating a
new patch later for virtual channel support?
...
> > > > +       }
> >
> > Could you use switch-statement here for readability?
> > Probably, like this?
> Got it and fixed.
> >
...
> >
> > nit: Please add a spaces after '/*' and before '*/'.
> > same for all other one-line comments below.
> Got it and fixed all.
> >
> > > > +               if (input_data_type != JPEG_FMT)
> > > > +                       write_master(pseninf, SENINF1_MUX_CTRL,
> > > > +                                    ((0x1B << 22) | (0x1F << 16)),
...
> >
> > Could you initialize |pmipi_rx|, |pseninf|, and |pmipi_rx_conf| here
...
> > > > +       }
> >
> > Could you use switch-statement here as well?
> Got it and fixed.
> >
> > > > +
...
> >
> > nit: remove semi-collon for consistency. same for the bellow.
> Got it and fixed.
> >
> > > > +                       write_master(pmipi_rx, MIPI_RX_ANA00_CSI0A,
> > > > +                                    (0 << 5) | (0 << 6) | (1 << 8) |
...
> >
> > Why don't you use |pmipi_rx| as is?
> Got it, remove pdhy_ana_base, use pmipi_rx directly.
> >
> > > > +
...
> > > > +               int i = 0;
> >
> > You can declare variables only at the beginning of scopes.
> > I guess you can find warnings while building.
> > (Or, you might have forgotten to test this code because here is inside
> > of #ifdef)
> Got it and fixed.
> >
> > > > +
...
> > > > +                       status = 0;
> >
> > nit: no need to re-initialize |statue| here.
> Got it and fixed.
> >
> > > > +
> > > > +                       while (1) {
...
> >
> > nit: Do you have any special reason to start this comment with a
> > lower-case letter?
> > I think it's better to capitalize the first letter in this comment for
> > consistency.
> > same for the below comments.
> Got it and fixed all.
> >
...
> >
> > Hmm, I cannot figure out what this comment means.
> No need, remove this comment.
> >
> > > > +       port = priv->port;
...
> > > > +       /*configureMipi*/
> >
> > nit: /* Configure MIPI */ for consistency.
> Got it and fixed.
> >
> > > > +       csi_mipi.enable = 1;
...
> > > > +       //link seninf-p1
> >
> > You need to use /* */-style comment.
> > Same for all the comments in this function.
> Got it and fixed all.
> >
...
> >
> > I'm not sure, but should we call clk_prepare_enable even when
> > pm_runtime_get_sync fails?
> Got it and fixed, return when pm_runtime_get_sync fail.
> >
> > > > +
...
> > > > +               pr_debug("No IRQ!!\n");
> >
> > This debug message should be "No IRQ found\n" or something like this?
> > By the way, should we proceed even if |irq| is 0?
> Got it, return when No IRQ found.
> >
> > > > +       }
> > > > +
