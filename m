...
Received: from smtp2.macqel.be ([109.135.2.61]:55833 "EHLO smtp2.macqel.be"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726387AbeIKNft (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Tue, 11 Sep 2018 09:35:49 -0400
From: Philippe De Muyter <phdm@macqel.be>
To: linux-media@vger.kernel.org
Cc: Philippe De Muyter <phdm@macqel.be>
Subject: [PATCH v2] media: v4l2-subdev.h: allow V4L2_FRMIVAL_TYPE_CONTINUOUS & _STEPWISE
Date: Tue, 11 Sep 2018 10:36:28 +0200
Message-Id: <1536654988-27553-1-git-send-email-phdm@macqel.be>
In-Reply-To: <067c2ad9-6216-d2d3-6004-3c69289a0c5b@xs4all.nl>
