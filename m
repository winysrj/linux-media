...
Received: from mailout4.samsung.com ([203.254.224.34]:32896 "EHLO
	mailout4.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751256Ab0JOE1a (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 15 Oct 2010 00:27:30 -0400
Date: Fri, 15 Oct 2010 13:27:47 +0900
From: Jaeryul Oh <jaeryul.oh@samsung.com>
Subject: RE: [PATCH 3/4] MFC: Add MFC 5.1 V4L2 driver
In-reply-to: <005b01cb6b9f$304dd390$90e97ab0$%debski@samsung.com>
To: 'Kamil Debski' <k.debski@samsung.com>, linux-media@vger.kernel.org,
	linux-samsung-soc@vger.kernel.org
Cc: m.szyprowski@samsung.com, pawel@osciak.com,
	kyungmin.park@samsung.com, kgene.kim@samsung.com
Reply-to: jaeryul.oh@samsung.com
Message-id: <000301cb6c21$539ed5b0$fadc8110$%oh@samsung.com>
MIME-version: 1.0
...
> 
In many project, user can open many contexts according to the scenario of
not only phone but also netbook, tablet. 'cause MFC supports multiple
instance.
That's why I suggested this param. be configurable.
> >
> > > +
...
> memory).
Yes, what you said looks right. I missed some code sequence.
Thanks
> 
...
Let's get make better together
> 
