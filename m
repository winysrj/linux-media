...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id 87FABC64E79
	for <linux-media@archiver.kernel.org>; Mon, 24 Dec 2018 17:00:55 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id 4184821850
	for <linux-media@archiver.kernel.org>; Mon, 24 Dec 2018 17:00:55 +0000 (UTC)
Authentication-Results: mail.kernel.org;
	dkim=pass (1024-bit key) header.d=nextdimension.cc header.i=@nextdimension.cc header.b="fB2DoQYI"
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725799AbeLXRAy (ORCPT <rfc822;linux-media@archiver.kernel.org>);
        Mon, 24 Dec 2018 12:00:54 -0500
Received: from bonobo.maple.relay.mailchannels.net ([23.83.214.22]:23912 "EHLO
        bonobo.maple.relay.mailchannels.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1725747AbeLXRAx (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Mon, 24 Dec 2018 12:00:53 -0500
X-Sender-Id: dreamhost|x-authsender|brad@nextdimension.ws
Received: from relay.mailchannels.net (localhost [127.0.0.1])
        by relay.mailchannels.net (Postfix) with ESMTP id E87A55E3919;
        Mon, 24 Dec 2018 17:00:51 +0000 (UTC)
Received: from pdx1-sub0-mail-a7.g.dreamhost.com (unknown [100.96.29.126])
        (Authenticated sender: dreamhost)
        by relay.mailchannels.net (Postfix) with ESMTPA id A50235E367B;
        Mon, 24 Dec 2018 17:00:51 +0000 (UTC)
X-Sender-Id: dreamhost|x-authsender|brad@nextdimension.ws
...
X-Cure-Cooing: 38e3910c2acde76e_1545670851858_2592252399
X-MC-Loop-Signature: 1545670851858:1719953145
X-MC-Ingress-Time: 1545670851857
Received: from pdx1-sub0-mail-a7.g.dreamhost.com (localhost [127.0.0.1])
        by pdx1-sub0-mail-a7.g.dreamhost.com (Postfix) with ESMTP id 37DF980167;
        Mon, 24 Dec 2018 09:00:51 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha1; c=relaxed; d=nextdimension.cc; h=from
        :to:cc:subject:date:message-id:in-reply-to:references; s=
        nextdimension.cc; bh=iGZXp2pa384rJy2uQRNd8HP8tTE=; b=fB2DoQYIBUI
        OgB0NeW7xKKmN97FqY2wnCUlynAnuNlJ81LdVcR5AldiWqeD8bJ2CfPPAqSlZ5sG
        MlVgRtQ2IbIBds5fzS6ZijdlywqZGN/pYFHWgR0t3u8vQtQfmuNiZBJhpf3NKbtk
        nAhreNMC6sSnXn7JymUWMByJPpn1LcHs=
Received: from localhost.localdomain (66-90-189-166.dyn.grandenetworks.net [66.90.189.166])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-SHA256 (128/128 bits))
        (No client certificate requested)
        (Authenticated sender: brad@nextdimension.ws)
        by pdx1-sub0-mail-a7.g.dreamhost.com (Postfix) with ESMTPSA id 985C180166;
...
Date:   Mon, 24 Dec 2018 11:00:36 -0600
Message-Id: <1545670836-24035-5-git-send-email-brad@nextdimension.cc>
