...
Received: from smtp-vbr12.xs4all.nl ([194.109.24.32]:1863 "EHLO
	smtp-vbr12.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752827Ab3LMQOG (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 13 Dec 2013 11:14:06 -0500
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hans.verkuil@cisco.com>
Subject: [REVIEW PATCH 5/9] vb2: retry start_streaming in case of insufficient buffers.
Date: Fri, 13 Dec 2013 17:13:42 +0100
Message-Id: <1386951226-27655-6-git-send-email-hverkuil@xs4all.nl>
...
@@ -1377,6 +1377,39 @@ int vb2_prepare_buf(struct vb2_queue *q, struct v4l2_buffer *b)
 }
...
@@ -1425,6 +1458,12 @@ static int vb2_internal_qbuf(struct vb2_queue *q, struct v4l2_buffer *b)
...
+
 	 ...
 	 * buffers.
@@ -1737,12 +1782,9 @@ static int vb2_internal_streamon(struct vb2_queue *q, enum v4l2_buf_type type)
...
@@ -2312,15 +2354,15 @@ static int __vb2_init_fileio(struct vb2_queue *q, int read)
 				goto err_reqbufs;
