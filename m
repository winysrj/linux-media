...
Received: from mail-pz0-f190.google.com ([209.85.222.190]:44691 "EHLO
	mail-pz0-f190.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1750999AbZIDFPO (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Fri, 4 Sep 2009 01:15:14 -0400
Received: by pzk28 with SMTP id 28so486222pzk.27
        for <linux-media@vger.kernel.org>; Thu, 03 Sep 2009 22:15:17 -0700 (PDT)
Date: Thu, 3 Sep 2009 22:15:07 -0700
From: Dmitry Torokhov <dmitry.torokhov@gmail.com>
To: Mauro Carvalho Chehab <mchehab@redhat.com>
Cc: Linux Media Mailing List <linux-media@vger.kernel.org>
Subject: [PATCH] DVB/V4L: ov511 - export snapshot button through input layer
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
Message-Id: <20090904054805.5C944526EA5@mailhub.coreip.homeip.net>
...
+		{ OV511_REG_BUS, 0x31,			0x0f },
 		...
 		{ OV511_REG_BUS, 0x24,			0x9f },
 		{ OV511_REG_BUS, 0x25,			0x90 },
@@ -5880,6 +5962,13 @@ ov51x_probe(struct usb_interface *intf, const struct usb_device_id *id)
