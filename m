...
Received: from lb1-smtp-cloud2.xs4all.net ([194.109.24.21]:47348 "EHLO
	lb1-smtp-cloud2.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1751818AbbFHLN1 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 8 Jun 2015 07:13:27 -0400
Message-ID: <557578D0.1080102@xs4all.nl>
Date: Mon, 08 Jun 2015 13:13:20 +0200
From: Hans Verkuil <hverkuil@xs4all.nl>
MIME-Version: 1.0
To: Prashant Laddha <prladdha@cisco.com>, linux-media@vger.kernel.org
CC: Hans Verkuil <hans.verkuil@cisco.com>
Subject: Re: [RFC PATCH] v4l2-dv-timings: add support for reduced blanking
 v2
References: <1433494358-29050-1-git-send-email-prladdha@cisco.com> <1433494358-29050-2-git-send-email-prladdha@cisco.com> <557571F0.90109@xs4all.nl>
...
On 06/08/2015 12:44 PM, Hans Verkuil wrote:
...
Sorry, this should be active_width (or perhaps just image_width), not frame_width.
The latter would include blanking and we need the active width only.
...
BTW: make sure to remove the TODO comment at the start of v4l2_detect_cvt!
