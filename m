...
Received: from mga14.intel.com ([192.55.52.115]:7355 "EHLO mga14.intel.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1751325AbbDBWEB (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Thu, 2 Apr 2015 18:04:01 -0400
Date: Fri, 3 Apr 2015 06:03:24 +0800
From: kbuild test robot <fengguang.wu@intel.com>
To: Josh Wu <josh.wu@atmel.com>
Cc: kbuild-all@01.org, Mauro Carvalho Chehab <m.chehab@samsung.com>,
	linux-media@vger.kernel.org,
	Guennadi Liakhovetski <g.liakhovetski@gmx.de>
Subject: [linuxtv-media:master 534/537]
 drivers/media/i2c/soc_camera/ov2640.c:1057:3: error: implicit declaration of
 function 'gpiod_direction_output'
Message-ID: <201504030624.Y8BWtkyB%fengguang.wu@intel.com>
MIME-Version: 1.0
...
commit: 4e65172f7bd20fcbfa87453d1e5711ad129d4216 [534/537] [media] media: ov2640: add primary dt support
...
>> drivers/media/i2c/soc_camera/ov2640.c:1057:3: error: implicit declaration of function 'gpiod_direction_output' [-Werror=implicit-function-declaration]
      gpiod_direction_output(priv->pwdn_gpio, !on);
      ^
   drivers/media/i2c/soc_camera/ov2640.c: In function 'ov2640_probe_dt':
>> drivers/media/i2c/soc_camera/ov2640.c:1081:2: error: implicit declaration of function 'devm_gpiod_get_optional' [-Werror=implicit-function-declaration]
     priv->resetb_gpio = devm_gpiod_get_optional(&client->dev, "resetb",
     ^
>> drivers/media/i2c/soc_camera/ov2640.c:1082:4: error: 'GPIOD_OUT_LOW' undeclared (first use in this function)
       GPIOD_OUT_LOW);
       ^
   drivers/media/i2c/soc_camera/ov2640.c:1082:4: note: each undeclared identifier is reported only once for each function it appears in
>> drivers/media/i2c/soc_camera/ov2640.c:1090:4: error: 'GPIOD_OUT_HIGH' undeclared (first use in this function)
       GPIOD_OUT_HIGH);
       ^
