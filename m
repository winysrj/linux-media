...
Received: from mail-yx0-f174.google.com ([209.85.213.174]:59348 "EHLO
	mail-yx0-f174.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753689Ab1KPGSY (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 16 Nov 2011 01:18:24 -0500
Received: by yenq3 with SMTP id q3so1554161yen.19
        for <linux-media@vger.kernel.org>; Tue, 15 Nov 2011 22:18:24 -0800 (PST)
MIME-Version: 1.0
In-Reply-To: <CAB33W8dZCEpuJPF2bzU2-v5rbGcfv_1C8rPHLLLtu+9b3aVZRw@mail.gmail.com>
References: <CAB33W8dW0Yts_dxz=WyYEK9-bcoQ_9gM-t3+aR5s-G_5QswOyA@mail.gmail.com>
	...
	<CAB33W8dZCEpuJPF2bzU2-v5rbGcfv_1C8rPHLLLtu+9b3aVZRw@mail.gmail.com>
Date: Wed, 16 Nov 2011 06:18:24 +0000
Message-ID: <CAB33W8fyY2cT9=V09gQ0kK70byr=tv4AMPvpHNCFGHyyFnGJCw@mail.gmail.com>
...
On 15 November 2011 22:35, Tim Draper <veehexx@gmail.com> wrote:
...
ohhh, what an idiot i am. it's a user error, in the form of a typo!
because i have multiple tuners, and there is a race condition for
adapter number assignment when the server gets rebooted, i've had to
create a file in /etc/modprobe.d/ to define adapters.
incorrect: 'options dvb_usb_af9015 adapter nr=0,1'
correct: 'options dvb_usb_af9015 adapter_nr=0,1' (note the underscore
between 'adapter' and 'nr')

completely forgot i had configured that!
so, back to a working state! :)
