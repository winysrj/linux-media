...
Received: from moutng.kundenserver.de ([212.227.126.171]:61117 "EHLO
	moutng.kundenserver.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751985Ab3FNTkw (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 14 Jun 2013 15:40:52 -0400
...
Subject: [PATCH v11 17/21] soc-camera: switch I2C subdevice drivers to use v4l2-clk
Date: Fri, 14 Jun 2013 21:08:27 +0200
Message-Id: <1371236911-15131-18-git-send-email-g.liakhovetski@gmx.de>
...
@@ -1108,16 +1111,29 @@ static int mt9t112_probe(struct i2c_client *client,
...
+
 static const struct i2c_device_id mt9t112_id[] = {
 	{ "mt9t112", 0 },
 	{ }
@@ -1129,6 +1145,7 @@ static struct i2c_driver mt9t112_i2c_driver = {
 		.name = "mt9t112",
 	},
 	.probe    = mt9t112_probe,
...
@@ -935,7 +939,22 @@ static int tw9910_probe(struct i2c_client *client,
...
@@ -949,6 +968,7 @@ static struct i2c_driver tw9910_i2c_driver = {
 		.name = "tw9910",
 	},
 	.probe    = tw9910_probe,
