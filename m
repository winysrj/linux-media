...
Received: from mail-wi0-f170.google.com ([209.85.212.170]:40451 "EHLO
	mail-wi0-f170.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751258Ab2HKSJo (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sat, 11 Aug 2012 14:09:44 -0400
From: Sylwester Nawrocki <sylvester.nawrocki@gmail.com>
To: linux-media@vger.kernel.org, oselas@community.pengutronix.de,
	linux-samsung-soc@vger.kernel.org
Cc: Sylwester Nawrocki <sylvester.nawrocki@gmail.com>
Subject: [PATCH 1/1] V4L: Add driver for S3C244X/S3C64XX SoC series camera interface
Date: Sat, 11 Aug 2012 20:09:20 +0200
Message-Id: <1344708560-20071-1-git-send-email-sylvester.nawrocki@gmail.com>
...
It exposes a subdev device node for CAMIF pixel resolution and
crop control and two video nodes - for the "codec" and "preview"
data paths. This patch has been tested only on S3C2440 SoC based
system (Mini2440 board). Some minor corrections may be needed for
capture functionality on S3C64XX. mem-to-mem features available
in S3C64XX SoC series are not supported yet.
...
index 99937c9..1f445a0 100644
--- a/drivers/media/video/Kconfig
+++ b/drivers/media/video/Kconfig
@@ -1151,6 +1151,18 @@ config VIDEO_ATMEL_ISI
 	  This module makes the ATMEL Image Sensor Interface available
 	  as a v4l2 device.

+config VIDEO_S3C_CAMIF
+	tristate "Samsung S3C244X/S3C64XX SoC Camera Interface driver"
+	depends on VIDEO_V4L2 && I2C && VIDEO_V4L2_SUBDEV_API
+	depends on (PLAT_S3C64XX || PLAT_S3C24XX)
+	select VIDEOBUF2_DMA_CONTIG
+	---help---
+	  This is a v4l2 driver for s3c244x and s3c64xx SoC series camera
...
index d209de0..f5f6086 100644
--- a/drivers/media/video/Makefile
+++ b/drivers/media/video/Makefile
@@ -188,6 +188,7 @@ obj-$(CONFIG_VIDEO_ATMEL_ISI)		+= atmel-isi.o
...
diff --git a/drivers/media/video/s3c-camif/Makefile b/drivers/media/video/s3c-camif/Makefile
new file mode 100644
index 0000000..50bf8c5
--- /dev/null
+++ b/drivers/media/video/s3c-camif/Makefile
@@ -0,0 +1,5 @@
...
diff --git a/drivers/media/video/s3c-camif/camif-capture.c b/drivers/media/video/s3c-camif/camif-capture.c
new file mode 100644
index 0000000..d327f69
--- /dev/null
+++ b/drivers/media/video/s3c-camif/camif-capture.c
@@ -0,0 +1,1602 @@
+/*
...
+	return 0;
+}
diff --git a/drivers/media/video/s3c-camif/camif-core.c b/drivers/media/video/s3c-camif/camif-core.c
new file mode 100644
index 0000000..c579935
--- /dev/null
+++ b/drivers/media/video/s3c-camif/camif-core.c
@@ -0,0 +1,625 @@
+/*
...
+MODULE_LICENSE("GPL");
diff --git a/drivers/media/video/s3c-camif/camif-core.h b/drivers/media/video/s3c-camif/camif-core.h
new file mode 100644
index 0000000..e005494
--- /dev/null
+++ b/drivers/media/video/s3c-camif/camif-core.h
@@ -0,0 +1,375 @@
+/*
+ * s3c244x/s3c64xx SoC series Camera Interface (CAMIF) driver
+ *
...
+
+#endif /* CAMIF_CORE_H_ */
diff --git a/drivers/media/video/s3c-camif/camif-regs.c b/drivers/media/video/s3c-camif/camif-regs.c
new file mode 100644
index 0000000..7078727
--- /dev/null
+++ b/drivers/media/video/s3c-camif/camif-regs.c
@@ -0,0 +1,497 @@
+/*
...
+	}
+}
diff --git a/drivers/media/video/s3c-camif/camif-regs.h b/drivers/media/video/s3c-camif/camif-regs.h
new file mode 100644
index 0000000..4f9e41f
--- /dev/null
+++ b/drivers/media/video/s3c-camif/camif-regs.h
@@ -0,0 +1,262 @@
+/*
