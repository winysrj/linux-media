...
Received: from aer-iport-4.cisco.com ([173.38.203.54]:54990 "EHLO
	aer-iport-4.cisco.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1755181AbcBPMwt (ORCPT
...
Subject: [PATCH 01/12] vb2: add a dev field to use for the default allocation context
Date: Tue, 16 Feb 2016 13:42:56 +0100
Message-Id: <1455626587-8051-2-git-send-email-hverkuil@xs4all.nl>
...
index dab9408..a50ff08 100644
--- a/drivers/media/v4l2-core/videobuf2-core.c
+++ b/drivers/media/v4l2-core/videobuf2-core.c
@@ -205,8 +205,9 @@ static int __vb2_buf_mem_alloc(struct vb2_buffer *vb)
...
@@ -1130,9 +1131,10 @@ static int __qbuf_userptr(struct vb2_buffer *vb, const void *pb)
...
+				planes[plane].length, dma_dir);
 		if (IS_ERR_OR_NULL(mem_priv)) {
 			dprintk(1, "failed acquiring userspace "
 						"memory for plane %d\n", plane);
@@ -1255,8 +1257,8 @@ static int __qbuf_dmabuf(struct vb2_buffer *vb, const void *pb)
