...
Received: from metis.ext.pengutronix.de ([92.198.50.35]:36239 "EHLO
	metis.ext.pengutronix.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751561AbbFZJoW (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 26 Jun 2015 05:44:22 -0400
...
Subject: [PATCH v2 1/3] [media] v4l2: use event class to deduplicate v4l2 trace events
Date: Fri, 26 Jun 2015 11:44:04 +0200
Message-Id: <1435311846-23417-1-git-send-email-p.zabel@pengutronix.de>
