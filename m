...
Received: from mail-in-01.arcor-online.net ([151.189.21.41])
	...
	(envelope-from <hermann-pitton@arcor.de>) id 1KOiOF-0002eo-RV
	for linux-dvb@linuxtv.org; Fri, 01 Aug 2008 02:21:05 +0200
From: hermann pitton <hermann-pitton@arcor.de>
To: Ben Johnson <ben_v_johnson@hotmail.com>
In-Reply-To: <BLU117-W75BB1B915538C38349EF5A17C0@phx.gbl>
References: <mailman.0.1217068026.17467.linux-dvb@linuxtv.org>
	...
	<BLU117-W75BB1B915538C38349EF5A17C0@phx.gbl>
Date: Fri, 01 Aug 2008 02:14:52 +0200
Message-Id: <1217549692.3272.129.camel@pc10.localdom.local>
Mime-Version: 1.0
...
Am Freitag, den 01.08.2008, 09:25 +1000 schrieb Ben Johnson:
> Hi Herman
> 
> Thankyou very much for your response.  The card comes with a remote
> and a dongle that you plug in to the back, so I assume it includes an
> IR decoder chip.  I think I have found the wiki entry you mentioned at
> http://www.linuxtv.org/v4lwiki/index.php/Remote_controllers and I will
> work through the instructions with my card when I get home tonight.  I
> assume that will pose more questions but I greatly appreciate this
> pointer.

from the fuzzy pictures I saw, all three variants of the Super 007 don't
seem to have a dedicated IR controller chip.

Take care not wasting your time in that case.

Better wait until Mauro has time to come up with something or you should
know on what you are trying.

>From my experience with the Asus PC-39 without IR controller, it is not
that simple to get something baked. Might be totally different for a
remote addict, which I'm not that much ;)

http://linuxtv.org/hg/v4l-dvb/rev/e5f92e625d1e

Cheers,
Hermann

> 
> > Subject: Re: [linux-dvb] Please - can't someone help - saa7134-input
> Avermedia Super 007 Support (Remote)
...
> > > Hi
> > > 
> > > I sent in this a few days ago, but no one has been able to help
> yet.
> > > Please can someone help me.
> > > 
> > 
> > if this card also has no IR decoder chip on board, like the analog
> only
> > ones, then Mauro seems to have a solution.
> > 
> > Plaese be patient, he is not free in what is on top of his todo
> list.
> > 
> > Else for simple gpio remotes we have instructions on the v4l wiki at
> > linutv.org. If it has an IR controller, you can look up other
> Avermedia
> > cards and remotes also at the http://www.bttv-gallery.de
> > 
> > If already known, then you simply add the card to the gpio remotes
> in
> > saa7134-cards.c and accordingly in saa7134-input.c.
> > 
> > An example for a solution without IR controller chip is the patch
> for
> > the recent Asus PC-39 remote. This has an unknown transmitter chip
> and a
> > 3.3 Volts only receiver talking some sort of RC5. A potential
> deadlock,
...
> > > believe that adding support should only require adding a new case
> to
...
> > > not, where is please?
> > > 2. Should adding the relevant information to the saa7134-input.c
> file
> > > for an otherwise supported saa7134 dvb-t card result in the remote
> > > being supported?
> > > 3. If so, how do I determine what information needs to be
> supplied.
> > > ie:
> > > - are the ir_codes_avermedia appropriate for this card
> > > - how do you tell what the mask_keycode and mask_keydown should
> be?
...
> > > Gigabyte MA78GM-S2H with AMD 780 Northbridge & ATI HD 3200
> Graphics
