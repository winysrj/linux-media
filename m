...
Received: from smtp11.smtpout.orange.fr ([80.12.242.133]:56609 "EHLO
	smtp.smtpout.orange.fr" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753230AbcHOTCS (ORCPT
...
Subject: [PATCH v4 05/13] media: platform: pxa_camera: trivial move of functions
Date: Mon, 15 Aug 2016 21:01:55 +0200
Message-Id: <1471287723-25451-6-git-send-email-robert.jarzmik@free.fr>
...
-
 ...
 {
@@ -1052,6 +819,245 @@ static void pxa_camera_setup_cicr(struct soc_camera_device *icd,
...
@@ -1495,6 +1501,9 @@ static int pxa_camera_querycap(struct soc_camera_host *ici,
 	return 0;
 }
