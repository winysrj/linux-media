...
Received: from comal.ext.ti.com ([198.47.26.152]:33618 "EHLO comal.ext.ti.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1753739AbZIONNz convert rfc822-to-8bit (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 15 Sep 2009 09:13:55 -0400
...
Date: Tue, 15 Sep 2009 08:13:20 -0500
Subject: RE: [GIT PATCHES for 2.6.32] V4L/DVB updates
Message-ID: <A69FA2915331DC488A831521EAE36FE40155156602@dlee06.ent.ti.com>
References: <20090914233239.5dd6f5c8@pedra.chehab.org>
In-Reply-To: <20090914233239.5dd6f5c8@pedra.chehab.org>
...
>To: Linus Torvalds
>Cc: Andrew Morton; linux-kernel@vger.kernel.org; linux-
...
>
>Please pull from:
>        ssh://master.kernel.org/pub/scm/linux/kernel/git/mchehab/linux-
>2.6.git for_linus
>
>For the first set of patches for 2.6.32. During this cycle, we avoided to
>make
>lots of changes at core, in order to have the system more stable, since
>there
...
>  - IR standardization: use a more uniform mapping for IR keys along
>different
>    video boards;
...
>
>Abylay Ospan (2):
>      V4L/DVB (12311): Change clocking configuration and frequency for
>NetUP card.
...
>      V4L/DVB (12276): Remove a useless check from
...
>
>Andy Walls (10):
>      V4L/DVB (12207): cx18: Add an EEPROM dump routine for the Yuan MPC718
>and future cards
...
>1500MCE.
>      V4L/DVB (12334): tuner-simple: Add an entry for the Partsnic PTI-
>5NF05 NTSC tuner
>      V4L/DVB (12335): ivtv: Fix errors in AVerTV M113 card definitions and
>add a new M113 card
>      V4L/DVB (12336): ivtv: Fix improper GPIO audio mux input switch on
...
>transceivers
>      V4L/DVB (12699): cx18: ir-kbd-i2c initialization data should point to
>a persistent object
>
...
>
>David T.L. Wong (1):
>      V4L/DVB (12423): cxusb, d680 dmbth use unified lgs8gxx code instead
>of lgs8gl5
>
>David Wong (2):
...
>
>Devin Heitmueller (1):
>      V4L/DVB (12444): em28xx: add support for Terratec Cinergy Hybrid T
...
>      V4L/DVB (12720): em28xx-cards: Add vendor/product id for Kworld DVD
>Maker 2
>
>Eberhard Mattes (1):
...
>
>Eduardo Valentin (6):
>      V4L/DVB (12547): v4l2-subdev.h: Add g/s_modulator callbacks to subdev
>api
>      V4L/DVB (12548): v4l2: video device: Add V4L2_CTRL_CLASS_FM_TX
>controls
...
>      V4L/DVB (12612): si4713: simplify the code to remove a compiler
>warning.
...
>register writes
>      V4L/DVB (12617): gspca_pac207: enable higher framerates / lower
>exposure settings
>      V4L/DVB (12619): gspca: mr97310a fix detection of sensortype for
>vivicam with id byte of 0x53
...
>      V4L/DVB (12623): gspca_mr97310a: Add controls for CIF type 0 sensor
>cams
...
>      V4L/DVB (12582): The current AVC debugging can clog the log down a
>lot since many
>
>Igor M. Liplianin (9):
...
>parameter.
>      V4L/DVB (12313): stv6110: Read registers through one time
>i2c_transfer calling
...
>      V4L/DVB (12229): gspca - main: Change the ISOC initialization
>mechanism.
...
>ov7660 sensor.
>      V4L/DVB (12353): gspca - vc032x: Add the 1280x960 resolution for
>sensor mi1310_soc
>      V4L/DVB (12354): gspca - vc032x: H and V flip controls added for
>mi13x0_soc sensors
>      V4L/DVB (12355): gspca - vc032x: Cleanup source
>      V4L/DVB (12358): gspca - main: Memorize the current alt before
>setting it
...
>      V4L/DVB (12694): gspca - vc032x: Change the start exchanges of the
>sensor hv7131r.
>      V4L/DVB (12695): gspca - vc032x: Do the LED work with the sensor
>hv7131r.
...
>driver
>      V4L/DVB (12326): zr364xx: error message when buffer is too small and
>code cleanup
>
>Laurent Pinchart (8):
...
>
>Mart Raudsepp (1):
>      V4L/DVB: af9015: add new USB ID for KWorld PlusTV Dual DVB-T Stick
>(DVB-T 399U)
>
>Marton Nemeth (1):
...
>      V4L/DVB (12345): em28xx: fix audio VIDIOC_S_CTRL adjustments on
>devices without ac97
...
>      V4L/DVB (12563): ir-keymaps: add a link to the IR standard layout
>page
...
>space for new keys
>      V4L/DVB (12698): em28xx: ir-kbd-i2c init data needs a persistent
>object
>      V4L/DVB (12701): saa7134: ir-kbd-i2c init data needs a persistent
>object
...
>      V4L/DVB (12577): tda18271: remove excess whitespace from tda_foo
>printk macros
>      V4L/DVB (12578): tda18271: allow drivers to request RF tracking
>filter calibration during attach
>
>Nam Pháº¡m ThÃ nh (1):
>      V4L/DVB (12475): Add support for Humax/Coex DVB-T USB Stick 2.0 High
>Speed
>
>OldÅ(tm)ich JedliÄka (2):
...
>driver
>      V4L/DVB (12305): cx23885: Convert existing HVR1800 GPIO calls into
>new format
>      V4L/DVB (12306): cx23885: Add support for ATSC/QAM on Hauppauge HVR-
>1850
>      V4L/DVB (12307): cx23885: Modify hardware revision detection for
>newer silicon
>      V4L/DVB (12347): cx25840: Bugfix for no DVB-T on the Hauppauge HVR-
>1700
>
>Theodore Kilgore (2):
>      V4L/DVB (12459): gspca - jeilinj: New subdriver for Jeilin chip.
>      V4L/DVB (12618): gspca: mr97310a add support for CIF and more VGA
>camera's
>
>Tobias Lorenz (4):
>      V4L/DVB (12142): radio-si470x: Add suport for RDS endpoint interrupt
>mode
