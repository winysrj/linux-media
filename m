...
Received: from mga05.intel.com ([192.55.52.43]:4844 "EHLO mga05.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727203AbeJDRuV (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Thu, 4 Oct 2018 13:50:21 -0400
Date: Thu, 4 Oct 2018 13:57:29 +0300
...
Cc: Hans Verkuil <hans.verkuil@cisco.com>,
        ...
        jacopo@jmondi.org
Subject: Re: [PATCH v6 2/2] [media] imx214: Add imx214 camera sensor driver
Message-ID: <20181004105729.x5f27iy7llwbtdfz@paasikivi.fi.intel.com>
References: <20181004101159.13225-1-ricardo.ribalda@gmail.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20181004101159.13225-1-ricardo.ribalda@gmail.com>
Sender: linux-media-owner@vger.kernel.org
List-ID: <linux-media.vger.kernel.org>

Hi Ricardo,

A few more little comments... it's starting to look good.

On Thu, Oct 04, 2018 at 12:11:59PM +0200, Ricardo Ribalda Delgado wrote:
...
> - Serialize get_format/set_format/get_selection
> - runtime_pm: set_power_on/off
> - Fix set-ctrl -EINVAL
> - Reorted ret variable
> 
>  MAINTAINERS                |    8 +
>  drivers/media/i2c/Kconfig  |   12 +
>  drivers/media/i2c/Makefile |    1 +
>  drivers/media/i2c/imx214.c | 1126 ++++++++++++++++++++++++++++++++++++
...
> index 000000000000..33883c91d54d
> --- /dev/null
...
You can drop these checks as well as the is_on field.
...
Could you rebase this on the fwnode set, please?
...
How about using the same mutex for the control handler? See e.g. the smiapp
driver for an example. Perhaps serialise the streamon bits as well as
they're a part of the driver interface?

That way you wouldn't need to care about things happening in parallel. I'm
not fully certain that would be harmful but there is no benefit from that
either.
