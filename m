...
Received: from lb1-smtp-cloud9.xs4all.net ([194.109.24.22]:35795 "EHLO
        lb1-smtp-cloud9.xs4all.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726992AbeIMQ4q (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Thu, 13 Sep 2018 12:56:46 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: dri-devel@lists.freedesktop.org, Hans Verkuil <hansverk@cisco.com>
Subject: [PATCH 1/5] media: replace ADOBERGB by OPRGB
Date: Thu, 13 Sep 2018 13:47:27 +0200
Message-Id: <20180913114731.16500-2-hverkuil@xs4all.nl>
...
@@ -281,7 +289,7 @@ enum v4l2_xfer_func {
...
@@ -295,7 +303,7 @@ enum v4l2_ycbcr_encoding {
 	 *
