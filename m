...
Received: from galahad.ideasonboard.com ([185.26.127.97]:60065 "EHLO
	...
	with ESMTP id S1752531AbbAVOsS (ORCPT
...
Subject: [PATCH 3/7] v4l2-ctrls: Make the control type init op initialize the whole control
Date: Thu, 22 Jan 2015 16:48:42 +0200
Message-Id: <1421938126-17747-4-git-send-email-laurent.pinchart@ideasonboard.com>
