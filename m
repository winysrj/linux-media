...
Received: from mail-wi0-f172.google.com ([209.85.212.172]:39390 "EHLO
	mail-wi0-f172.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S932784Ab3BOFWG (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 15 Feb 2013 00:22:06 -0500
MIME-Version: 1.0
In-Reply-To: <20130213171753.4f394b71@redhat.com>
References: <1360215628-25303-1-git-send-email-prabhakar.lad@ti.com> <20130213171753.4f394b71@redhat.com>
From: Prabhakar Lad <prabhakar.csengg@gmail.com>
Date: Fri, 15 Feb 2013 10:51:44 +0530
Message-ID: <CA+V-a8s7mVKsDU8zbwhbcW8f3dKzteMjf2j1kn+QcJGgu_Q9_g@mail.gmail.com>
Subject: Re: [PATCH v3] media: ths7353: add support for ths7353 video amplifier
...
>
> Hmm... Why did you replaced HS7303_CHANNEL_x by 0x01 here?
>
>>       if (err)
>>               goto out;
>>
...
> Same comment here.
>
> Basically, please use the macro values on all the above to make it coherent.
>
OK
...
>
> The above replacement is not obvious. Hard to say if it won't cause
> regressions on exisiting devices. Please split those non-obvious changes
> into separate patches and properly explain why it is needed and what's
> the impact on the existing support.
>
The earlier way was incorrect we cannot use height as such, The right way
is to use the pixelclock, It is the pixelclock that determines which
mode to use.  For example what if I select a 1600x1200 format, this wont
work with earlier way.  Seprating this patch into a different one would be just
overkill. I would prefer it in the same patch, If you still insist I
will separate it
out.
...
>
> Instead of doing that, you should instead do:
>
>         indent = state->driver_data;
>
> and initialize the table below as:
>
...
> };
>
> That makes the code cleaner to read, as this is the way most drivers do.
>
> That would also help to make it easier to support other variants of this
> chip family if later needed.
>
Yes that's a good way, I'll do the same.
...
>> +             return ret;
>
> Again, please use the defined macros for the channels.
>
Ok.
