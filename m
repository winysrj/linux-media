...
Received: from mailout-de.gmx.net ([213.165.64.22]:60769 "HELO mail.gmx.net"
	rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with SMTP
	id S1756907Ab0JEJxi convert rfc822-to-8bit (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Tue, 5 Oct 2010 05:53:38 -0400
Received: from lyakh (helo=localhost)
	by axis700.grange with local-esmtp (Exim 4.63)
	(envelope-from <g.liakhovetski@gmx.de>)
	id 1P34DV-0007vt-91
	for linux-media@vger.kernel.org; Tue, 05 Oct 2010 11:53:49 +0200
Date: Tue, 5 Oct 2010 11:53:49 +0200 (CEST)
From: Guennadi Liakhovetski <g.liakhovetski@gmx.de>
To: Linux Media Mailing List <linux-media@vger.kernel.org>
Subject: [PATCH 2/2] V4L: add an IMX074 sensor soc-camera / v4l2-subdev driver
In-Reply-To: <Pine.LNX.4.64.1010041801060.5668@axis700.grange>
Message-ID: <Pine.LNX.4.64.1010051149570.28567@axis700.grange>
...
This patch adds an initial driver for the IMXß74 image sensor from Sony. 
...
index 8b1acc4..38cf6b3 100644
--- a/drivers/media/video/Kconfig
+++ b/drivers/media/video/Kconfig
@@ -783,6 +783,12 @@ config SOC_CAMERA
...
index d66bc65..7e8975b 100644
--- a/drivers/media/video/Makefile
+++ b/drivers/media/video/Makefile
@@ -74,6 +74,7 @@ obj-$(CONFIG_VIDEO_TCM825X) += tcm825x.o
