...
Received: from mx08-00178001.pphosted.com ([91.207.212.93]:43606 "EHLO
        mx07-00178001.pphosted.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1751369AbdAaQcX (ORCPT
...
Subject: [PATCH v5 07/10] [media] st-delta: rpmsg ipc support
Date: Tue, 31 Jan 2017 17:30:30 +0100
Message-ID: <1485880233-666-8-git-send-email-hugues.fruchet@st.com>
...
@@ -1706,6 +1707,14 @@ static int delta_probe(struct platform_device *pdev)
...
@@ -1750,6 +1759,8 @@ static int delta_remove(struct platform_device *pdev)
 {
