...
Received: from mx3.redhat.com (mx3.redhat.com [172.16.48.32])
	by int-mx1.corp.redhat.com (8.13.1/8.13.1) with ESMTP id mBJ91dP6027767
	for <video4linux-list@redhat.com>; Fri, 19 Dec 2008 04:01:39 -0500
Received: from mail05.idc.renesas.com (mail.renesas.com [202.234.163.13])
	by mx3.redhat.com (8.13.8/8.13.8) with ESMTP id mBJ91QvI013232
	for <video4linux-list@redhat.com>; Fri, 19 Dec 2008 04:01:26 -0500
Date: Thu, 18 Dec 2008 14:05:11 +0900
From: Kuninori Morimoto <morimoto.kuninori@renesas.com>
To: Guennadi Liakhovetski <g.liakhovetski@gmx.de>
Message-id: <uy6ycr129.wl%morimoto.kuninori@renesas.com>
MIME-version: 1.0 (generated by SEMI 1.14.6 - "Maruoka")
Content-type: text/plain; charset=US-ASCII
Cc: V4L-Linux <video4linux-list@redhat.com>
Subject: [PATCH v6] Add tw9910 driver
...
o change calculation mothod of select_norm
o change dev_info -> dev_dbg in start_capture
o add i2c_set_clientdata(client, NULL) in remove
o add SOCAM_DATA_ACTIVE_HIGH on query_bus_param
...
index 4f3803e..6965563 100644
--- a/drivers/media/video/Kconfig
+++ b/drivers/media/video/Kconfig
@@ -750,6 +750,12 @@ config MT9V022_PCA9536_SWITCH
...
index 490430e..9440aa9 100644
--- a/drivers/media/video/Makefile
+++ b/drivers/media/video/Makefile
@@ -136,6 +136,7 @@ obj-$(CONFIG_SOC_CAMERA_MT9T031)	+= mt9t031.o
