...
Received: from mga06.intel.com ([134.134.136.31]:58700 "EHLO mga06.intel.com"
        ...
        id S933641AbcIPLuU (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Fri, 16 Sep 2016 07:50:20 -0400
From: Sakari Ailus <sakari.ailus@linux.intel.com>
To: linux-media@vger.kernel.org
Cc: hverkuil@xs4all.nl, laurent.pinchart@ideasonboard.com,
        mchehab@s-opensource.com
Subject: [PATCH v5 3/4] media: Refactor copying IOCTL arguments from and to user space
Date: Fri, 16 Sep 2016 14:49:07 +0300
Message-Id: <1474026548-28829-4-git-send-email-sakari.ailus@linux.intel.com>
...
---
 drivers/media/media-device.c | 176 ++++++++++++++++++++-----------------------
 1 file changed, 83 insertions(+), 93 deletions(-)

diff --git a/drivers/media/media-device.c b/drivers/media/media-device.c
index 4ac912b..c44406e 100644
