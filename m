...
Received: from mga12.intel.com ([192.55.52.136]:23252 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726033AbeIYPNs (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Tue, 25 Sep 2018 11:13:48 -0400
...
Message-ID: <cf5bc142-cd60-1672-2539-7cf903a41acc@linux.intel.com>
Date: Tue, 25 Sep 2018 17:10:59 +0800
MIME-Version: 1.0
In-Reply-To: <20180925073300.4bcfgzcejrfes5ud@paasikivi.fi.intel.com>
...
> Do you need to support that, i.e. are there systems out there that are
> missing this information in firmware?
>
...
>> Sakari,
>> My understanding is that driver need get all the link freqs items from firmware and get the supported one.
...
>>             imx319->link_def_freq_index = i;
>>             break;
>>         }
>>     }
>>
>> then update the default value to expose:
>>     imx319->link_freq = v4l2_ctrl_new_int_menu(ctrl_hdlr, &imx319_ctrl_ops,
>>                            V4L2_CID_LINK_FREQ,
>>                            imx319->hwcfg->nr_of_link_freqs,
>>                            imx319->link_def_freq_index,
>>                            imx319->hwcfg->link_freqs);
>> Right?
> If you only need one frequency, then that's fine. You'll also need to
> enable a single value for the control only in that case.
>
