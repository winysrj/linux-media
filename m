...
Received: from aer-iport-1.cisco.com ([173.38.203.51]:43118 "EHLO
	aer-iport-1.cisco.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751349AbbCUM3W (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sat, 21 Mar 2015 08:29:22 -0400
From: Prashant Laddha <prladdha@cisco.com>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hans.verkuil@cisco.com>,
	Prashant Laddha <prladdha@cisco.com>
Subject: [PATCH v4 2/2] vivid: add support to set CVT, GTF timings
Date: Sat, 21 Mar 2015 17:59:14 +0530
Message-Id: <1426940954-28734-1-git-send-email-prladdha@cisco.com>
In-Reply-To: <Re: [PATCH v3 2/2] vivid: add support to set CVT, GTF timings>
References: <Re: [PATCH v3 2/2] vivid: add support to set CVT, GTF timings>
...
v4: Incorporated comments on v3. If CVT format is detected, return
true, otherwise, proceed further and try to test for GTF.
...
index 867a29a..73b1a0a 100644
--- a/drivers/media/platform/vivid/vivid-vid-cap.c
+++ b/drivers/media/platform/vivid/vivid-vid-cap.c
@@ -1552,6 +1552,65 @@ int vivid_vid_cap_s_std(struct file *file, void *priv, v4l2_std_id id)
 	return 0;
 }
...
+
 ...
 {
@@ -1561,8 +1620,10 @@ int vivid_vid_cap_s_dv_timings(struct file *file, void *_fh,
 		return -ENODATA;
