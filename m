...
Received: from perceval.irobotique.be ([92.243.18.41]:60206 "EHLO
	...
	with ESMTP id S1752059Ab0JENSp (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Tue, 5 Oct 2010 09:18:45 -0400
From: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
To: linux-media@vger.kernel.org
Cc: sakari.ailus@maxwell.research.nokia.com
Subject: [RFC/PATCH v2 2/6] V4L/DVB: v4l: Use v4l2_get_subdevdata instead of accessing v4l2_subdev::priv
Date: Tue,  5 Oct 2010 15:18:51 +0200
Message-Id: <1286284734-12292-3-git-send-email-laurent.pinchart@ideasonboard.com>
...
@@ -455,7 +455,7 @@ static int mt9m111_s_crop(struct v4l2_subdev *sd, struct v4l2_crop *a)
...
+	struct i2c_client *client = v4l2_get_subdevdata(sd);
 	...
 	a->c	= mt9m111->rect;
@@ -481,7 +481,7 @@ static int mt9m111_cropcap(struct v4l2_subdev *sd, struct v4l2_cropcap *a)
...
@@ -543,7 +543,7 @@ static int mt9m111_set_pixfmt(struct i2c_client *client,
...
@@ -578,7 +578,7 @@ static int mt9m111_s_fmt(struct v4l2_subdev *sd,
...
@@ -618,7 +618,7 @@ static int mt9m111_try_fmt(struct v4l2_subdev *sd,
...
+	struct i2c_client *client = v4l2_get_subdevdata(sd);
 	...
 	if (id->match.type != V4L2_CHIP_MATCH_I2C_ADDR)
@@ -637,7 +637,7 @@ static int mt9m111_g_chip_ident(struct v4l2_subdev *sd,
...
@@ -658,7 +658,7 @@ static int mt9m111_g_register(struct v4l2_subdev *sd,
...
+	struct i2c_client *client = v4l2_get_subdevdata(sd);
 	...
 	if (reg->match.type != V4L2_CHIP_MATCH_I2C_ADDR || reg->reg > 0x2ff)
 		return -EINVAL;
@@ -806,7 +806,7 @@ static int mt9m111_set_autowhitebalance(struct i2c_client *client, int on)
...
@@ -849,7 +849,7 @@ static int mt9m111_g_ctrl(struct v4l2_subdev *sd, struct v4l2_control *ctrl)
