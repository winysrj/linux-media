...
Received: from mga11.intel.com ([192.55.52.93]:23709 "EHLO mga11.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727795AbeIUNEL (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Fri, 21 Sep 2018 09:04:11 -0400
...
Message-ID: <ba2ba184-9bc2-869c-24d2-edfd6b796d2c@linux.intel.com>
Date: Fri, 21 Sep 2018 15:20:19 +0800
MIME-Version: 1.0
In-Reply-To: <20180917113413.n6hd5suldwuspio3@paasikivi.fi.intel.com>
...
Sakari,
Use IMX319_REG_DPGA_USE_GLOBAL_GAIN to do digital gain control, 1 for all color and 0 for by color.
For all color, use register IMX319_REG_DIG_GAIN_GLOBAL to set the digital gain value, otherwise use other registers below.
By default the digital gain select is not set and the gain will be set by color via setting register 0x0210, 0x0212, 0x0213, these registers
were set during powering on. So I prefer to only change the default digital gain control if any digital gain request.
