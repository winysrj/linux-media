...
Received: from mailout1.w1.samsung.com ([210.118.77.11]:16085 "EHLO
	mailout1.w1.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753487Ab1KYJih (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 25 Nov 2011 04:38:37 -0500
Received: from euspt1 (mailout1.w1.samsung.com [210.118.77.11])
 by mailout1.w1.samsung.com
 (iPlanet Messaging Server 5.2 Patch 2 (built Jul 14 2004))
 with ESMTP id <0LV7003SVMSASS@mailout1.w1.samsung.com> for
 linux-media@vger.kernel.org; Fri, 25 Nov 2011 09:38:34 +0000 (GMT)
Received: from linux.samsung.com ([106.116.38.10])
 by spt1.w1.samsung.com (iPlanet Messaging Server 5.2 Patch 2 (built Jul 14
 2004)) with ESMTPA id <0LV7001D2MS9WG@spt1.w1.samsung.com> for
 linux-media@vger.kernel.org; Fri, 25 Nov 2011 09:38:34 +0000 (GMT)
Date: Fri, 25 Nov 2011 10:38:13 +0100
From: Andrzej Pietrasiewicz <andrzej.p@samsung.com>
Subject: [PATCH v4][media] Exynos4 JPEG codec v4l2 driver
...
Message-id: <1322213893-5462-1-git-send-email-andrzej.p@samsung.com>
MIME-version: 1.0
...
This is the fourth version of the Exynos4 JPEG codec v4l2 driver. It includes
modifications resulting from Sylwester Nawrocki's, Tomasz Stanislawski's and
Sakari Ailus' reviews - thank you guys.

Summary of changes in v4:

- clean up internal formats definitions, add colplanes member describing
how many color planes there are
- clean up default format setting for both encoding and decoding
- some code refactoring (among others added s5p_jpeg_get_q_data function) and
simplification
- bytesperline adjustment
- correct g_selection
- use V4L2_PIX_FMT_RGB565 instead of V4L2_PIX_FMT_RGB565X
- move powering the device on/off to start/stop streaming from device_run
and isr
- change initialization sequence in probe so that video nodes are registered
after required resources are taken
- change image quality parameter semantics in encoding mode: the greater
the value, the betterm image quality (acceptable values: 0..3)
