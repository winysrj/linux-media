...
Received: from mga09.intel.com ([134.134.136.24]:48392 "EHLO mga09.intel.com"
	...
	id S1753716AbaCZNiQ (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Wed, 26 Mar 2014 09:38:16 -0400
Date: Wed, 26 Mar 2014 21:37:25 +0800
From: Fengguang Wu <fengguang.wu@intel.com>
To: Mauro Carvalho Chehab <m.chehab@samsung.com>
Cc: linux-media@vger.kernel.org, kbuild-all@01.org
Subject: Re: [linuxtv-media:master 202/499] WARNING: CVS style keyword
 markers, these will _not_ be updated
Message-ID: <20140326133725.GA8668@localhost>
References: <5330a979.sXMy7GbMSKAHyfG6%fengguang.wu@intel.com>
 <20140325085245.02c2f4b2@samsung.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20140325085245.02c2f4b2@samsung.com>
Sender: linux-media-owner@vger.kernel.org
List-ID: <linux-media.vger.kernel.org>

Hi Mauro,

On Tue, Mar 25, 2014 at 08:52:45AM -0300, Mauro Carvalho Chehab wrote:
> Hi Fengguang,
> 
> Please don't do such checkpatch.pl tests like that. You'll be only
> flooding the MLs with useless data.

OK, I'm very sorry for the noises!
...
Thanks for the explanations! So the problem is that you need to apply
patches as they are submitted, and then fix the style issues up in
follow up commits. That's perfect reasonable workflow.
...
Good idea! I'll follow your suggestion and run checkpatch on branch
HEAD - which is much less likely to cause email flooding, and will
be able to avoid pointless warning on fixed issues.
