...
Received: from gofer.mess.org ([80.229.237.210]:45641 "EHLO gofer.mess.org"
        ...
        id S945232AbcJaRwc (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Mon, 31 Oct 2016 13:52:32 -0400
From: Sean Young <sean@mess.org>
To: Mauro Carvalho Chehab <mchehab@s-opensource.com>
Cc: linux-media@vger.kernel.org
Subject: [PATCH 5/9] [media] redrat3: enable carrier reports using wideband receiver
Date: Mon, 31 Oct 2016 17:52:23 +0000
Message-Id: <1477936347-9029-6-git-send-email-sean@mess.org>
