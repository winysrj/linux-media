...
Received: from smtp22.services.sfr.fr ([93.17.128.13]:39846 "EHLO
	smtp22.services.sfr.fr" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751593Ab1CNWiP (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 14 Mar 2011 18:38:15 -0400
Message-ID: <4D7E98D2.3050609@sfr.fr>
Date: Mon, 14 Mar 2011 23:38:10 +0100
From: Patrice Chotard <patrice.chotard@sfr.fr>
MIME-Version: 1.0
To: linux-media@vger.kernel.org
CC: Theodore Kilgore <kilgota@banach.math.auburn.edu>
Subject: [PATCH v2] New Jeilin dual-mode camera support
Content-Type: multipart/mixed;
 boundary="------------060103020201050405020206"
List-ID: <linux-media.vger.kernel.org>
Sender: <mchehab@pedra>

This is a multi-part message in MIME format.
--------------060103020201050405020206
