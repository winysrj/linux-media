...
Received: from bombadil.infradead.org ([198.137.202.9]:51514 "EHLO
        bombadil.infradead.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S934617AbcJRUqU (ORCPT
...
Subject: [PATCH v2 48/58] uvc: don't break long lines
Date: Tue, 18 Oct 2016 18:46:00 -0200
Message-Id: <74854af1c3eaafda607285d55f98b4520ce3d21e.1476822925.git.mchehab@s-opensource.com>
...
+			  info.entity,
 	...
 	return ret;
@@ -1904,8 +1904,9 @@ static int uvc_ctrl_add_info(struct uvc_device *dev, struct uvc_control *ctrl,
...
@@ -1964,8 +1965,9 @@ int uvc_ctrl_add_mapping(struct uvc_video_chain *chain,
 	int ret;
...
@@ -2004,8 +2006,8 @@ int uvc_ctrl_add_mapping(struct uvc_video_chain *chain,
...
+				  "Can't add mapping '%s', control id 0x%08x already exists.\n",
 			...
 			ret = -EEXIST;
 			goto done;
@@ -2015,8 +2017,9 @@ int uvc_ctrl_add_mapping(struct uvc_video_chain *chain,
...
+			  mapping->name,
 		...
 		ret = -ENOMEM;
 		goto done;
@@ -2086,8 +2089,9 @@ static void uvc_ctrl_prune_entity(struct uvc_device *dev,
...
index 9c4b56b4a9c6..7502569752f6 100644
...
@@ -703,9 +708,9 @@ static int uvc_parse_streaming(struct uvc_device *dev,
...
@@ -755,10 +760,10 @@ static int uvc_parse_streaming(struct uvc_device *dev,
...
@@ -780,9 +785,9 @@ static int uvc_parse_streaming(struct uvc_device *dev,
 	}
...
@@ -829,9 +834,10 @@ static int uvc_parse_streaming(struct uvc_device *dev,
 	}
...
@@ -939,9 +945,9 @@ static int uvc_parse_vendor_control(struct uvc_device *dev,
...
@@ -988,9 +994,10 @@ static int uvc_parse_standard_control(struct uvc_device *dev,
...
@@ -1001,8 +1008,8 @@ static int uvc_parse_standard_control(struct uvc_device *dev,
 		for (i = 0; i < n; ++i) {
...
@@ -1013,8 +1020,8 @@ static int uvc_parse_standard_control(struct uvc_device *dev,
...
@@ -1024,11 +1031,11 @@ static int uvc_parse_standard_control(struct uvc_device *dev,
 		 */
...
@@ -1047,8 +1054,8 @@ static int uvc_parse_standard_control(struct uvc_device *dev,
 		}
...
@@ -1094,9 +1101,9 @@ static int uvc_parse_standard_control(struct uvc_device *dev,
...
@@ -1105,10 +1112,10 @@ static int uvc_parse_standard_control(struct uvc_device *dev,
 		 */
 		type = get_unaligned_le16(&buffer[4]);
 		if ((type & 0xff00) == 0) {
-			uvc_trace(UVC_TRACE_DESCR, "device %d videocontrol "
...
@@ -1132,9 +1139,9 @@ static int uvc_parse_standard_control(struct uvc_device *dev,
...
@@ -1158,9 +1165,9 @@ static int uvc_parse_standard_control(struct uvc_device *dev,
...
@@ -1191,9 +1198,9 @@ static int uvc_parse_standard_control(struct uvc_device *dev,
...
@@ -1218,8 +1225,9 @@ static int uvc_parse_standard_control(struct uvc_device *dev,
 		break;
...
@@ -1264,8 +1272,9 @@ static int uvc_parse_control(struct uvc_device *dev)
...
@@ -1312,8 +1321,9 @@ static int uvc_scan_chain_entity(struct uvc_video_chain *chain,
...
@@ -1324,8 +1334,8 @@ static int uvc_scan_chain_entity(struct uvc_video_chain *chain,
...
@@ -1341,8 +1351,8 @@ static int uvc_scan_chain_entity(struct uvc_video_chain *chain,
 			break;
...
@@ -1377,8 +1387,9 @@ static int uvc_scan_chain_entity(struct uvc_video_chain *chain,
 		break;
...
@@ -1407,8 +1418,8 @@ static int uvc_scan_chain_forward(struct uvc_video_chain *chain,
...
@@ -1428,8 +1439,9 @@ static int uvc_scan_chain_forward(struct uvc_video_chain *chain,
...
@@ -1478,9 +1490,9 @@ static int uvc_scan_chain_backward(struct uvc_video_chain *chain,
...
@@ -1515,8 +1527,9 @@ static int uvc_scan_chain_backward(struct uvc_video_chain *chain,
...
@@ -1537,8 +1550,9 @@ static int uvc_scan_chain(struct uvc_video_chain *chain,
 	while (entity != NULL) {
...
@@ -1766,8 +1780,8 @@ static int uvc_register_video(struct uvc_device *dev,
 	 */
...
@@ -1825,8 +1839,9 @@ static int uvc_register_terms(struct uvc_device *dev,
...
+			  id->idProduct);
 		...
 		uvc_trace(UVC_TRACE_PROBE, "Probing generic UVC device %s\n",
 				udev->devpath);
@@ -1909,8 +1926,8 @@ static int uvc_probe(struct usb_interface *intf,
...
@@ -1921,10 +1938,11 @@ static int uvc_probe(struct usb_interface *intf,
...
@@ -1966,9 +1984,9 @@ static int uvc_probe(struct usb_interface *intf,
...
@@ -2019,8 +2037,8 @@ static int uvc_suspend(struct usb_interface *intf, pm_message_t message)
...
@@ -2059,8 +2077,8 @@ static int __uvc_resume(struct usb_interface *intf, int reset)
 		}
 	}
...
index b5589d5f5da4..9202469af85d 100644
--- a/drivers/media/usb/uvc/uvc_video.c
+++ b/drivers/media/usb/uvc/uvc_video.c
@@ -77,8 +77,9 @@ int uvc_query_ctrl(struct uvc_device *dev, __u8 query, __u8 unit,
...
@@ -188,9 +189,8 @@ static int uvc_get_video_ctrl(struct uvc_streaming *stream,
...
@@ -287,8 +287,9 @@ static int uvc_set_video_ctrl(struct uvc_streaming *stream,
...
@@ -652,8 +653,8 @@ void uvc_video_clock_update(struct uvc_streaming *stream,
...
@@ -694,8 +695,8 @@ void uvc_video_clock_update(struct uvc_streaming *stream,
...
@@ -829,9 +830,8 @@ static void uvc_video_stats_update(struct uvc_streaming *stream)
 {
...
@@ -1002,8 +1002,8 @@ static int uvc_video_decode_start(struct uvc_streaming *stream,
...
@@ -1019,8 +1019,8 @@ static int uvc_video_decode_start(struct uvc_streaming *stream,
 		struct timespec ts;
...
@@ -1166,8 +1166,9 @@ static void uvc_video_decode_isoc(struct urb *urb, struct uvc_streaming *stream,
...
+				  urb->iso_frame_desc[i].status);
 			...
 			if (buf != NULL)
 				buf->error = 1;
@@ -1328,8 +1329,9 @@ static void uvc_video_complete(struct urb *urb)
 		break;
...
+			   urb->status);
 	...
 	case -ENOENT:		/* usb_kill_urb() called. */
 		if (stream->frozen)
@@ -1424,15 +1426,16 @@ static int uvc_alloc_urb_buffers(struct uvc_streaming *stream,
 		}
...
@@ -1621,12 +1624,13 @@ static int uvc_init_video(struct uvc_streaming *stream, gfp_t gfp_flags)
...
+				  bandwidth);
 		...
 		for (i = 0; i < intf->num_altsetting; ++i) {
@@ -1649,13 +1653,14 @@ static int uvc_init_video(struct uvc_streaming *stream, gfp_t gfp_flags)
 		}
...
+			  altsetting, best_psize);
 		...
 		if (ret < 0)
@@ -1679,8 +1684,8 @@ static int uvc_init_video(struct uvc_streaming *stream, gfp_t gfp_flags)
...
@@ -1814,8 +1819,8 @@ int uvc_video_init(struct uvc_streaming *stream)
 	}
...
@@ -1849,8 +1854,8 @@ int uvc_video_init(struct uvc_streaming *stream)
