...
Received: from mga03.intel.com ([134.134.136.65]:25643 "EHLO mga03.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1751973AbdEDWD1 (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Thu, 4 May 2017 18:03:27 -0400
From: Sakari Ailus <sakari.ailus@linux.intel.com>
To: linux-media@vger.kernel.org
Cc: linux-acpi@vger.kernel.org, devicetree@vger.kernel.org,
        laurent.pinchart@ideasonboard.com, hverkuil@xs4all.nl
Subject: [PATCH v3.2 4/7] v4l: Switch from V4L2 OF not V4L2 fwnode API
Date: Fri,  5 May 2017 01:02:29 +0300
Message-Id: <1493935349-20152-1-git-send-email-sakari.ailus@linux.intel.com>
In-Reply-To: <1493121374-13298-1-git-send-email-sakari.ailus@linux.intel.com>
References: <1493121374-13298-1-git-send-email-sakari.ailus@linux.intel.com>
...
@@ -1684,7 +1685,7 @@ static int isc_parse_dt(struct device *dev, struct isc_device *isc)
 {
...
+	struct v4l2_fwnode_endpoint v4l2_epn;
 	...
 	unsigned int flags;
 	int ret;
@@ -1703,7 +1704,8 @@ static int isc_parse_dt(struct device *dev, struct isc_device *isc)
 			continue;
 		}
...
+						 &v4l2_epn);
 		if (ret) {
 			of_node_put(rem);
 			ret = -EINVAL;
@@ -1738,8 +1740,9 @@ static int isc_parse_dt(struct device *dev, struct isc_device *isc)
