...
Received: from galahad.ideasonboard.com ([185.26.127.97]:47462 "EHLO
	galahad.ideasonboard.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1750868AbaLOUaA (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 15 Dec 2014 15:30:00 -0500
From: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
To: linux-media@vger.kernel.org
Cc: sakari.ailus@iki.fi
Subject: [PATCH 3/3] Implement compound control set support
Date: Mon, 15 Dec 2014 22:29:56 +0200
Message-Id: <1418675396-12485-4-git-send-email-laurent.pinchart@ideasonboard.com>
...
@@ -1148,7 +1128,7 @@ static void video_print_control_value(const struct v4l2_query_ext_ctrl *query,
 	}
 }
...
+static int video_get_control(struct device *dev, unsigned int id, bool full)
 {
 	struct v4l2_ext_control ctrl;
 	struct v4l2_query_ext_ctrl query;
@@ -1211,6 +1191,143 @@ static int video_print_control(struct device *dev, unsigned int id, bool full)
 	return query.id;
 }
