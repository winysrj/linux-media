...
Received: from down.free-electrons.com ([37.187.137.238]:48435 "EHLO
	mail.free-electrons.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
	with ESMTP id S1751245AbaKFJ5P (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Thu, 6 Nov 2014 04:57:15 -0500
...
Subject: [PATCH v2 02/10] [media] v4l: Update subdev-formats doc with new MEDIA_BUS_FMT values
Date: Thu,  6 Nov 2014 10:57:00 +0100
Message-Id: <1415267829-4177-3-git-send-email-boris.brezillon@free-electrons.com>
...
+	$(shell perl -ne 'print "$$1 " if /^enum\s+([^\s]+)\s+/' $(srctree)/include/uapi/linux/media-bus-format.h) \
