...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id 13C0FC4360F
	for <linux-media@archiver.kernel.org>; Fri, 22 Feb 2019 17:29:23 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id BC909207E0
	for <linux-media@archiver.kernel.org>; Fri, 22 Feb 2019 17:29:22 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=default; t=1550856562;
	bh=NAjiewPuaWxzXKmXkxXMdzVGl3t2wDxeVp7hRyG66Ag=;
	h=From:To:Cc:Subject:Date:In-Reply-To:References:List-ID:From;
	b=qaLtC6estVU0NHUPri6DuYrNeUhWBIGTGwRY2YdMnvGrmcFrgwpqD9M/VdAA/kKQP
	 YYgVOCVQKctbjg86s3PiJ7Oe9h6VUZb+ZdLB4rar4NcOTHfvTwAjnXG16i/6vHx8aI
	 2NsR3YNNJ5n2QuOckhoL/XWLyNggj29lKz52UbAc=
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727447AbfBVR3S (ORCPT <rfc822;linux-media@archiver.kernel.org>);
        Fri, 22 Feb 2019 12:29:18 -0500
Received: from mail.kernel.org ([198.145.29.99]:57908 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726131AbfBVR3R (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Fri, 22 Feb 2019 12:29:17 -0500
Received: from shuah-t480s.internal (c-24-9-64-241.hsd1.co.comcast.net [24.9.64.241])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id C92422086D;
        Fri, 22 Feb 2019 17:29:14 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1550856555;
        bh=NAjiewPuaWxzXKmXkxXMdzVGl3t2wDxeVp7hRyG66Ag=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=xmmHGCob17HYkXlIRza/52vXZRLWAJwFp3sRDSslfKZgbkES1M6uYm+gAa4oZEkjm
         gYku4Th+pD55LQ7X9Kckm1AXj64p00mO8++H5XpGI8yPYdvuPguuxuqb1yO8VB1srV
         zgylOZt2HiYvLpN8jFa40IU6Mwwa4QnbsHSLJH/w=
...
Subject: [PATCH v11 4/5] sound/usb: Use Media Controller API to share media resources
Date:   Fri, 22 Feb 2019 10:29:02 -0700
Message-Id: <f3d643d262fa74f5a6e7707d2d5f652600cb5934.1550804023.git.shuah@kernel.org>
...
index 000000000000..c5f6690f288d
--- /dev/null
+++ b/sound/usb/media.c
@@ -0,0 +1,327 @@
...
index db114f3977e0..a38483816c26 100644
--- a/sound/usb/pcm.c
+++ b/sound/usb/pcm.c
@@ -35,6 +35,7 @@
 #include "pcm.h"
...
@@ -783,6 +784,10 @@ static int snd_usb_hw_params(struct snd_pcm_substream *substream,
...
@@ -790,7 +795,7 @@ static int snd_usb_hw_params(struct snd_pcm_substream *substream,
...
@@ -804,12 +809,13 @@ static int snd_usb_hw_params(struct snd_pcm_substream *substream,
...
+		goto stop_pipeline;
 	...
 	if (ret < 0)
@@ -825,6 +831,12 @@ static int snd_usb_hw_params(struct snd_pcm_substream *substream,
...
@@ -837,6 +849,7 @@ static int snd_usb_hw_free(struct snd_pcm_substream *substream)
 {
...
+	snd_media_stop_pipeline(subs);
 	...
 	subs->cur_rate = 0;
 	subs->period_bytes = 0;
@@ -1309,6 +1322,7 @@ static int snd_usb_pcm_open(struct snd_pcm_substream *substream)
...
+	int ret;
 	...
 	subs->interface = -1;
 	subs->altset_idx = 0;
@@ -1322,7 +1336,13 @@ static int snd_usb_pcm_open(struct snd_pcm_substream *substream)
...
@@ -1333,6 +1353,7 @@ static int snd_usb_pcm_close(struct snd_pcm_substream *substream)
 	int ret;
