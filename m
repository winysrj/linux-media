...
Received: from lb3-smtp-cloud3.xs4all.net ([194.109.24.30]:32963 "EHLO
	...
	by vger.kernel.org with ESMTP id S1753754AbaLDJ4O (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 4 Dec 2014 04:56:14 -0500
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: g.liakhovetski@gmx.de, laurent.pinchart@ideasonboard.com,
	prabhakar.csengg@gmail.com, Hans Verkuil <hans.verkuil@cisco.com>
Subject: [RFC PATCH 6/8] v4l2-subdev: add v4l2_subdev_create_pad_configs
Date: Thu,  4 Dec 2014 10:54:57 +0100
Message-Id: <1417686899-30149-7-git-send-email-hverkuil@xs4all.nl>
...
@@ -571,6 +606,7 @@ void v4l2_subdev_init(struct v4l2_subdev *sd, const struct v4l2_subdev_ops *ops)
 	sd->grp_id = 0;
 	sd->dev_priv = NULL;
 	sd->host_priv = NULL;
+	sd->pad_configs = NULL;
...
+	struct v4l2_subdev_pad_config *pad_configs;
 	...
 	void *dev_priv;
 	void *host_priv;
@@ -689,6 +691,8 @@ int v4l2_subdev_link_validate_default(struct v4l2_subdev *sd,
