...
Received: from mx1.redhat.com ([209.132.183.28]:41754 "EHLO mx1.redhat.com"
	...
	id S1754310Ab3D1PsE (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Sun, 28 Apr 2013 11:48:04 -0400
Received: from int-mx10.intmail.prod.int.phx2.redhat.com (int-mx10.intmail.prod.int.phx2.redhat.com [10.5.11.23])
	by mx1.redhat.com (8.14.4/8.14.4) with ESMTP id r3SFm4bB013740
	(version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-SHA bits=256 verify=OK)
	for <linux-media@vger.kernel.org>; Sun, 28 Apr 2013 11:48:04 -0400
From: Mauro Carvalho Chehab <mchehab@redhat.com>
Cc: Mauro Carvalho Chehab <mchehab@redhat.com>,
	Linux Media Mailing List <linux-media@vger.kernel.org>
Subject: [PATCH 3/9] [media] drxk_hard: use pr_info/pr_warn/pr_err/... macros
Date: Sun, 28 Apr 2013 12:47:45 -0300
Message-Id: <1367164071-11468-4-git-send-email-mchehab@redhat.com>
...
---
 drivers/media/dvb-frontends/drxk_hard.c | 182 ++++++++++++++++----------------
 1 file changed, 89 insertions(+), 93 deletions(-)

diff --git a/drivers/media/dvb-frontends/drxk_hard.c b/drivers/media/dvb-frontends/drxk_hard.c
index d2b331a..552bce5 100644
