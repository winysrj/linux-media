...
Received: from mailout4.w1.samsung.com ([210.118.77.14]:47472 "EHLO
	...
	with ESMTP id S1755967Ab2EWMKq (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 23 May 2012 08:10:46 -0400
MIME-version: 1.0
Content-transfer-encoding: 7BIT
Content-type: TEXT/PLAIN
Date: Wed, 23 May 2012 14:10:16 +0200
From: Tomasz Stanislawski <t.stanislaws@samsung.com>
Subject: [PATCHv6 02/13] Documentation: media: description of DMABUF importing
 in V4L2
...
Message-id: <1337775027-9489-3-git-send-email-t.stanislaws@samsung.com>
...
index 765549f..fee66ac 100644
--- a/Documentation/DocBook/media/v4l/vidioc-create-bufs.xml
+++ b/Documentation/DocBook/media/v4l/vidioc-create-bufs.xml
@@ -104,6 +104,7 @@ information.</para>
...
@@ -103,6 +105,7 @@ as the &v4l2-format; <structfield>type</structfield> field. See <xref
 	    <entry><structfield>memory</structfield></entry>
 	    <entry>Applications set this field to
 <constant>V4L2_MEMORY_MMAP</constant> or
+<constant>V4L2_MEMORY_DMABUF</constant> or
