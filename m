...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id 36C70C43387
	for <linux-media@archiver.kernel.org>; Thu, 17 Jan 2019 12:58:01 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id E074620657
	for <linux-media@archiver.kernel.org>; Thu, 17 Jan 2019 12:58:00 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=default; t=1547729881;
	bh=IcylNn/9L+IqIgLlGsdxPalN28doGVH/LgXAKP8EseI=;
	h=From:Cc:Subject:Date:To:List-ID:From;
	b=ao2c0xULC6zhFGch3m+qnebCF49hMgzwtJkYMUZca3HbCj2KnhJjbXdtIgTL+tSJq
	 lSGFhGl9pu7JSzPx0TuTHqv2Wma/QsCgZgfh7nKs7G7sXbPB7DCx7t4VVwxyOgMIHm
	 UBrN8umykoAYm/fZj2D+zU1Mm2IH/Qxg4KpCHFnY=
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727091AbfAQM6A (ORCPT <rfc822;linux-media@archiver.kernel.org>);
        Thu, 17 Jan 2019 07:58:00 -0500
Received: from bombadil.infradead.org ([198.137.202.133]:49788 "EHLO
        bombadil.infradead.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725928AbfAQM6A (ORCPT
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        ...
        List-Help:List-Unsubscribe:List-Subscribe:List-Post:List-Owner:List-Archive;
         bh=CitYpTPsdhK3SndOxq3+h5Ut8xMvisUUQeapx2CwARk=; b=rHRul4CA9NPbWgFHf5YVc8HP6
        ;
Received: from [186.213.247.186] (helo=bombadil.infradead.org)
        by bombadil.infradead.org with esmtpsa (Exim 4.90_1 #2 (Red Hat Linux))
        id 1gk7F7-0002E3-JL; Thu, 17 Jan 2019 12:57:59 +0000
Received: from mchehab by bombadil.infradead.org with local (Exim 4.91)
        (envelope-from <mchehab@bombadil.infradead.org>)
        id 1gk7F2-0004c4-H9; Thu, 17 Jan 2019 07:57:52 -0500
...
Subject: [PATCH] media: remove soc_camera ov9640
Date:   Thu, 17 Jan 2019 07:57:47 -0500
Message-Id: <cbb14a0b0a22202c17279155b17eca77aae05904.1547729848.git.mchehab+samsung@kernel.org>
...
index 7d7b801ab2ce..f67499187bda 100644
--- a/drivers/media/i2c/soc_camera/Kconfig
+++ b/drivers/media/i2c/soc_camera/Kconfig
@@ -41,14 +41,6 @@ config SOC_CAMERA_OV772X
 	help
...
index 09ae483b96ef..0d15864cfda8 100644
--- a/drivers/media/i2c/soc_camera/Makefile
+++ b/drivers/media/i2c/soc_camera/Makefile
@@ -4,7 +4,6 @@ obj-$(CONFIG_SOC_CAMERA_MT9T112)	+= soc_mt9t112.o
