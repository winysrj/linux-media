...
Received: from lb2-smtp-cloud3.xs4all.net ([194.109.24.26]:39579 "EHLO
	...
	by vger.kernel.org with ESMTP id S1753671AbaLDJ4c (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 4 Dec 2014 04:56:32 -0500
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: g.liakhovetski@gmx.de, laurent.pinchart@ideasonboard.com,
	prabhakar.csengg@gmail.com, Hans Verkuil <hans.verkuil@cisco.com>
Subject: [RFC PATCH 8/8] v4l2-subdev: remove g/s_crop and cropcap from video ops
Date: Thu,  4 Dec 2014 10:54:59 +0100
Message-Id: <1417686899-30149-9-git-send-email-hverkuil@xs4all.nl>
...
index 8d8438b..5231e66 100644
--- a/drivers/media/platform/soc_camera/rcar_vin.c
+++ b/drivers/media/platform/soc_camera/rcar_vin.c
@@ -1054,16 +1054,15 @@ static void rcar_vin_put_formats(struct soc_camera_device *icd)
 	icd->host_priv = NULL;
 }
...
+	struct v4l2_rect *cam_rect = &cam_sel.r;
 	...
 	struct device *dev = icd->parent;
 	struct v4l2_mbus_framefmt mf;
@@ -1077,8 +1076,8 @@ static int rcar_vin_set_crop(struct soc_camera_device *icd,
...
+	ret = soc_camera_client_s_selection(sd, sel, &cam_sel,
 	...
 	if (ret < 0)
 		return ret;
@@ -1131,13 +1130,12 @@ static int rcar_vin_set_crop(struct soc_camera_device *icd,
 	return ret;
 }
...
@@ -1383,8 +1381,8 @@ static struct soc_camera_host_ops rcar_vin_host_ops = {
...
@@ -1955,12 +1904,10 @@ int soc_camera_host_register(struct soc_camera_host *ici)
 	    !ici->v4l2_dev.dev)
 		return -EINVAL;
...
+		ici->ops->get_selection = default_g_selection;
 	...
 	if (!ici->ops->get_parm)
@@ -2113,9 +2060,6 @@ static const struct v4l2_ioctl_ops soc_camera_ioctl_ops = {
