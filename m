...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id 48955C169C4
	for <linux-media@archiver.kernel.org>; Wed,  6 Feb 2019 22:53:38 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id E983B218D9
	for <linux-media@archiver.kernel.org>; Wed,  6 Feb 2019 22:53:37 +0000 (UTC)
Authentication-Results: mail.kernel.org;
	dkim=pass (2048-bit key) header.d=linaro.org header.i=@linaro.org header.b="MmqMQnEF"
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726161AbfBFWxh (ORCPT <rfc822;linux-media@archiver.kernel.org>);
        Wed, 6 Feb 2019 17:53:37 -0500
Received: from mail-wm1-f67.google.com ([209.85.128.67]:36794 "EHLO
        mail-wm1-f67.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725959AbfBFWxh (ORCPT
        <rfc822;linux-media@vger.kernel.org>); Wed, 6 Feb 2019 17:53:37 -0500
Received: by mail-wm1-f67.google.com with SMTP id p6so4664248wmc.1
        for <linux-media@vger.kernel.org>; Wed, 06 Feb 2019 14:53:33 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references
         :mime-version:content-transfer-encoding;
        bh=3BTrCZok1SCvgkb9oLBUkmlMUvmQ6PDgHYgFTKX9w9Q=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=3BTrCZok1SCvgkb9oLBUkmlMUvmQ6PDgHYgFTKX9w9Q=;
        b=
X-Gm-Message-State: AHQUAuY+ZOIF7gwLfwsbghWM5mD6z7oeI69bX8G0P40AlV/26v8/Ux8B
        ZEbUrq8jPhx8csX0Ryt4nc12FIUlypM=
X-Google-Smtp-Source: AHgI3IbSfVx9E0tl+emPfN4Uo/KBPLR9fo3omAsb7/u1ulo3j851mqzRA9rglkiw9sIlTXi9bjhHyQ==
X-Received: by 2002:a1c:30b:: with SMTP id 11mr4885072wmd.110.1549493612521;
        Wed, 06 Feb 2019 14:53:32 -0800 (PST)
Received: from arch-late.local (a109-49-46-234.cpe.netcabo.pt. [109.49.46.234])
        by smtp.gmail.com with ESMTPSA id h4sm4759613wre.5.2019.02.06.14.53.31
        (version=TLS1_2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);
        Wed, 06 Feb 2019 14:53:31 -0800 (PST)
From:   Rui Miguel Silva <rui.silva@linaro.org>
To:     Hans Verkuil <hverkuil@xs4all.nl>
Cc:     linux-media@vger.kernel.org, devel@driverdev.osuosl.org,
        Greg Kroah-Hartman <gregkh@linuxfoundation.org>,
        Rui Miguel Silva <rui.silva@linaro.org>
Subject: [PATCH v14.1] media: staging/imx7: add MIPI CSI-2 receiver subdev for i.MX7
Date:   Wed,  6 Feb 2019 22:53:06 +0000
Message-Id: <20190206225306.20007-1-rui.silva@linaro.org>
X-Mailer: git-send-email 2.20.1
In-Reply-To: <20190206151328.21629-6-rui.silva@linaro.org>
References: <20190206151328.21629-6-rui.silva@linaro.org>
MIME-Version: 1.0
...
commit: 4bb816545b626911079514028f0d14891627020c [5/9] media: staging/imx7: add MIPI CSI-2 receiver subdev for i.MX7
...
>> WARNING: vmlinux.o(.text+0x8703e02): Section mismatch in reference from the function mipi_csis_probe() to the function .exit.text:mipi_csis_debugfs_exit()
   The function mipi_csis_probe() references a function in an exit section.
   Often the function mipi_csis_debugfs_exit() has valid usage outside the exit section
   and the fix is to remove the __exit annotation of mipi_csis_debugfs_exit.
--
>> WARNING: vmlinux.o(.text.unlikely+0x147662): Section mismatch in reference from the function mipi_csis_remove() to the function .exit.text:mipi_csis_debugfs_exit()
...
index 000000000000..c92d18f2194c
--- /dev/null
