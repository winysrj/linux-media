...
Received: from ams-iport-2.cisco.com ([144.254.224.141]:36483 "EHLO
	...
	with ESMTP id S1755467Ab2GEOf6 (ORCPT
...
Subject: [RFCv1 PATCH 7/7] ad9389b: driver for the Analog Devices AD9389B video encoder.
Date: Thu,  5 Jul 2012 16:26:15 +0200
Message-Id: <7638aacd814c5657889b079d0b221b89d921f4bf.1341497271.git.hans.verkuil@cisco.com>
...
+	/* private controls */
+
+	state->hdmi_mode_ctrl = v4l2_ctrl_new_std(hdl, &ad9389b_ctrl_ops,
+			V4L2_CID_DV_TX_MODE, V4L2_DV_TX_MODE_DVI_D,
+			V4L2_DV_TX_MODE_HDMI, 1, V4L2_DV_TX_MODE_DVI_D);
+	state->hdmi_mode_ctrl->is_private = true;
+	state->hotplug_ctrl = v4l2_ctrl_new_std(hdl, &ad9389b_ctrl_ops,
+			V4L2_CID_DV_TX_HOTPLUG, 0, 1, 0, 0);
+	state->hotplug_ctrl->is_private = true;
+	state->rx_sense_ctrl = v4l2_ctrl_new_std(hdl, &ad9389b_ctrl_ops,
+			V4L2_CID_DV_TX_RXSENSE, 0, 1, 0, 0);
+	state->rx_sense_ctrl->is_private = true;
+	state->have_edid0_ctrl = v4l2_ctrl_new_std(hdl, &ad9389b_ctrl_ops,
+			V4L2_CID_DV_TX_EDID_PRESENT, 0, 1, 0, 0);
+	state->have_edid0_ctrl->is_private = true;
+	state->rgb_quantization_range_ctrl =
+		v4l2_ctrl_new_std_menu(hdl, &ad9389b_ctrl_ops,
+			V4L2_CID_DV_TX_RGB_RANGE, V4L2_DV_RGB_RANGE_AUTO,
+			V4L2_DV_RGB_RANGE_FULL, V4L2_DV_RGB_RANGE_AUTO);
