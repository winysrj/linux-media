...
Received: from perceval.irobotique.be ([92.243.18.41]:40628 "EHLO
	...
	with ESMTP id S1752549Ab0HTP3U (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 20 Aug 2010 11:29:20 -0400
From: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
To: linux-media@vger.kernel.org
Cc: sakari.ailus@maxwell.research.nokia.com
Subject: [RFC/PATCH v4 09/11] v4l: Add a media_device pointer to the v4l2_device structure
Date: Fri, 20 Aug 2010 17:29:11 +0200
Message-Id: <1282318153-18885-10-git-send-email-laurent.pinchart@ideasonboard.com>
