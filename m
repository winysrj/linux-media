...
Received: from perceval.irobotique.be ([92.243.18.41]:55204 "EHLO
	...
	with ESMTP id S1752455Ab0JENMu (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Tue, 5 Oct 2010 09:12:50 -0400
From: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
To: linux-media@vger.kernel.org
Cc: sakari.ailus@maxwell.research.nokia.com
Subject: [RFC/PATCH v2 08/10] v4l: v4l2_subdev userspace format API
Date: Tue,  5 Oct 2010 15:12:54 +0200
Message-Id: <1286284376-12217-9-git-send-email-laurent.pinchart@ideasonboard.com>
...
---
 ...
 drivers/media/video/v4l2-subdev.c                  |   67 +-
 include/linux/Kbuild                               |    1 +
 include/linux/v4l2-subdev.h                        |   90 ++
 include/media/v4l2-subdev.h                        |   22 +-
 16 files changed, 2194 insertions(+), 17 deletions(-)
...
@@ -32,24 +32,24 @@
 ...
 {
-	/* Allocate trial format and crop in the same memory block */
-	fh->trial_fmt = kzalloc((sizeof(*fh->trial_fmt) +
-				sizeof(*fh->trial_crop)) * sd->entity.num_pads,
-				GFP_KERNEL);
-	if (fh->trial_fmt == NULL)
+	/* Allocate try format and crop in the same memory block */
+	fh->try_fmt = kzalloc((sizeof(*fh->try_fmt) +
+			       sizeof(*fh->try_crop)) * sd->entity.num_pads,
+			      GFP_KERNEL);
+	if (fh->try_fmt == NULL)
 		return -ENOMEM;
 
-	fh->trial_crop = (struct v4l2_rect *)
-		(fh->trial_fmt + sd->entity.num_pads);
...
@@ -168,6 +169,52 @@ static long subdev_do_ioctl(struct file *file, unsigned int cmd, void *arg)
...
@@ -420,6 +421,15 @@ struct v4l2_subdev_ir_ops {
 };
...
@@ -480,23 +490,23 @@ struct v4l2_subdev {
  */
 struct v4l2_subdev_fh {
 	struct v4l2_fh vfh;
-	struct v4l2_mbus_framefmt *trial_fmt;
-	struct v4l2_rect *trial_crop;
...
-v4l2_subdev_get_trial_format(struct v4l2_subdev_fh *fh, unsigned int pad)
+v4l2_subdev_get_try_format(struct v4l2_subdev_fh *fh, unsigned int pad)
 {
-	return &fh->trial_fmt[pad];
+	return &fh->try_fmt[pad];
 }
 
 static inline struct v4l2_rect *
-v4l2_subdev_get_trial_crop(struct v4l2_subdev_fh *fh, unsigned int pad)
+v4l2_subdev_get_try_crop(struct v4l2_subdev_fh *fh, unsigned int pad)
 {
-	return &fh->trial_crop[pad];
