...
Received: from service1.sh.cvut.cz ([147.32.127.214]:37214 "EHLO
	service1.sh.cvut.cz" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1754721AbZIJMMR (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 10 Sep 2009 08:12:17 -0400
From: =?utf-8?q?Luk=C3=A1=C5=A1_Karas?= <lukas.karas@centrum.cz>
To: linux-media@vger.kernel.org
Subject: [PATCH] add support for IR on FlyDVB Trio (saa7134)
Date: Thu, 10 Sep 2009 14:12:07 +0200
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="us-ascii"
Content-Transfer-Encoding: 7bit
Message-Id: <200909101412.07415.lukas.karas@centrum.cz>
