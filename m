...
Received: from mail-pf0-f193.google.com ([209.85.192.193]:34443 "EHLO
        ...
        with ESMTP id S1753281AbcLLHpx (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Mon, 12 Dec 2016 02:45:53 -0500
From: Bhumika Goyal <bhumirks@gmail.com>
To: julia.lawall@lip6.fr, laurent.pinchart@ideasonboard.com,
        mchehab@kernel.org, linux-media@vger.kernel.org,
        linux-kernel@vger.kernel.org
Cc: Bhumika Goyal <bhumirks@gmail.com>
Subject: [PATCH] drivers: media: i2c: constify v4l2_subdev_* structures
Date: Mon, 12 Dec 2016 13:15:32 +0530
Message-Id: <1481528732-15565-1-git-send-email-bhumirks@gmail.com>
...
@@ -989,7 +989,7 @@ static int mt9p031_close(struct v4l2_subdev *subdev, struct v4l2_subdev_fh *fh)
...
@@ -936,15 +936,15 @@ static int mt9v032_close(struct v4l2_subdev *subdev, struct v4l2_subdev_fh *fh)
...
@@ -953,7 +953,7 @@ static int mt9v032_close(struct v4l2_subdev *subdev, struct v4l2_subdev_fh *fh)
...
@@ -664,13 +664,13 @@ static int noon010_open(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh)
