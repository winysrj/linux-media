...
Received: from ns.mm-sol.com ([37.157.136.199]:35603 "EHLO extserv.mm-sol.com"
        ...
        id S1729501AbeGYRv0 (ORCPT <rfc822;linux-media@vger.kernel.org>);
...
Subject: [PATCH v4 11/34] media: camss: csid: Configure data type and decode format properly
Date: Wed, 25 Jul 2018 19:38:20 +0300
Message-Id: <1532536723-19062-12-git-send-email-todor.tomov@linaro.org>
