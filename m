...
Received: from hqemgate16.nvidia.com ([216.228.121.65]:6778 "EHLO
	hqemgate16.nvidia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1756644AbbIUSz5 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 21 Sep 2015 14:55:57 -0400
...
Date: Mon, 21 Sep 2015 11:55:53 -0700
Message-ID: <1442861755-22743-2-git-send-email-pengw@nvidia.com>
In-Reply-To: <1442861755-22743-1-git-send-email-pengw@nvidia.com>
...
+	struct tegra_csi_device *csi = to_csi(subdev);
+
+	fmt->format = *__tegra_csi_get_pad_format(csi, cfg, fmt->pad, fmt->which);
+	return 0;
+}
+
