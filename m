...
Received: from metis.ext.4.pengutronix.de ([92.198.50.35]:54532 "EHLO
	metis.ext.4.pengutronix.de" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S934498AbcCNPXj (ORCPT
...
Subject: [PATCH v3 1/9] [media] tvp5150: convert register access to regmap
Date: Mon, 14 Mar 2016 16:23:29 +0100
Message-Id: <1457969017-4088-1-git-send-email-l.stach@pengutronix.de>
