...
Received: from mga04.intel.com ([192.55.52.120]:39139 "EHLO mga04.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1754522AbeDWKHm (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Mon, 23 Apr 2018 06:07:42 -0400
Date: Mon, 23 Apr 2018 13:07:36 +0300
...
Subject: Re: [PATCH v10 2/2] v4l: cadence: Add Cadence MIPI-CSI2 TX driver
Message-ID: <20180423100736.q3pifzbejo3m3rgn@paasikivi.fi.intel.com>
References: <20180419132850.20958-1-maxime.ripard@bootlin.com>
 <20180419132850.20958-3-maxime.ripard@bootlin.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=iso-8859-1
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <20180419132850.20958-3-maxime.ripard@bootlin.com>
...
On Thu, Apr 19, 2018 at 03:28:50PM +0200, Maxime Ripard wrote:
...
> index 000000000000..028ea87158da
> --- /dev/null
...
> +
> +	/* The CSI-2 TX pad doesn't really have a format (yet) */

It won't: there are no plans AFAIK to add formats to multiplexed pads. How
about just:
...
> +{
> +	struct csi2tx_priv *csi2tx = v4l2_subdev_to_csi2tx(subdev);
> +	const struct v4l2_mbus_framefmt *format = &fmt->format;

When fmt->which == V4L2_SUBDEV_FORMAT_TRY, you'll have to use
v4l2_subdev_get_try_format. Same for csi2tx_get_pad_format(). I missed this
earlier, see e.g. the smiapp driver's __smiapp_get_format().

> +
> +	/* The CSI-2 TX pad format cannot be changed (yet) */

Same comment as for csi2tx_get_pad_format().
...
> +		format = &fmt_default;
> +
> +	csi2tx->pad_fmts[fmt->pad] = *format;
> +
> +	return 0;
> +}
> +
