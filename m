...
Received: from smtp-vbr13.xs4all.nl ([194.109.24.33]:2475 "EHLO
	smtp-vbr13.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1754861Ab0CNKW5 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sun, 14 Mar 2010 06:22:57 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: Guennadi Liakhovetski <g.liakhovetski@gmx.de>
Subject: Re: [PATCH] V4L: SuperH Video Output Unit (VOU) driver
Date: Sun, 14 Mar 2010 11:23:11 +0100
Cc: Linux Media Mailing List <linux-media@vger.kernel.org>,
	"linux-sh@vger.kernel.org" <linux-sh@vger.kernel.org>,
	Magnus Damm <damm@opensource.se>
References: <Pine.LNX.4.64.1003111121380.4385@axis700.grange>
In-Reply-To: <Pine.LNX.4.64.1003111121380.4385@axis700.grange>
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="iso-8859-1"
Content-Transfer-Encoding: 7bit
Message-Id: <201003141123.11963.hverkuil@xs4all.nl>
