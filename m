...
Received: from ms16-1.1blu.de ([89.202.0.34]:40780 "EHLO ms16-1.1blu.de"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1754501Ab1KIW4X (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Wed, 9 Nov 2011 17:56:23 -0500
Date: Wed, 9 Nov 2011 22:13:47 +0100
...
Message-ID: <20111109221347.7cfe23f8@hana.gusto>
In-Reply-To: <1320872939.57808.YahooMailNeo@web132418.mail.ird.yahoo.com>
...
On Wed, 9 Nov 2011 21:08:59 +0000 (GMT)
Norret Thierry <tnorret@yahoo.com> wrote:
...
> [   83.804849] xc2028 1-0061: Loading 81 firmware images from
...
> [  110.118331] xc2028 1-0061: Loading SCODE for type=MONO SCODE
> HAS_IF_4320 (60008000), id 0000000000008000.
> [  110.733824] tm6000 #0: registered device video1
> [  110.733831] Trident TVMaster TM5600/TM6000/TM6010 USB2 board (Load
> status: 0)
> [  110.733865] usbcore: registered new interface driver tm6000
> [  110.735587] tm6000: open called (dev=video1)
> [  110.812501] tm6000_dvb: module is from the staging directory, the
> quality is unknown, you have been warned.
> [  110.876588] DVB: registering new adapter (Trident TVMaster 6000
> DVB-T) [  110.876597] DVB: registering adapter 0 frontend 0 (Zarlink
> ZL10353 DVB-T)... [  110.876695] xc2028 1-0061: attaching existing
> instance [  110.876701] xc2028 1-0061: type set to XCeive
> xc2028/xc3028 tuner [  110.876705] tm6000: XC2028/3028 asked to be
> attached to frontend! [  110.876846] tm6000 #0: Initialized (TM6000
> dvb Extension) extension # vlc log when trying to open channel.conf
> in kernel 3.0.6 [0xb64eb0] dvb access warning: no lock, tuning again
> [0xb64eb0] dvb access debug: using inversion=2 [0xb64eb0] dvb access
> debug: using bandwidth=8 [0xb64eb0] dvb access debug: using fec=9
...
> [0xb64eb0] dvb access debug: - SNR: 58596 # mplayer log when trying
> to open dvb in kernel 3.0.6 MPlayer SVN-r33094-4.5.3 (C) 2000-2011
> MPlayer Team Lecture de dvb://
...
> dvb_streaming_read, return 0 bytes dvb_streaming_read, attempt N. 6
> failed with errno 0 when reading 2048 bytes dvb_streaming_read,
> attempt N. 5 failed with errno 0 when reading 2048 bytes
> dvb_streaming_read, attempt N. 4 failed with errno 0 when reading
> 2048 bytes dvb_streaming_read, attempt N. 3 failed with errno 0 when
> reading 2048 bytes dvb_streaming_read, attempt N. 2 failed with errno
> 0 when reading 2048 bytes dvb_streaming_read, attempt N. 1 failed
> with errno 0 when reading 2048 bytes dvb_streaming_read, return 0
> bytes
> 
> # w_scan
> # w_scan kernel 3.0.6
...
>     /dev/dvb/adapter0/frontend0 -> DVB-T "Zarlink ZL10353 DVB-T":
> good :-) Using DVB-T frontend (adapter /dev/dvb/adapter0/frontend0)
