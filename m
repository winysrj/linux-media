...
Received: from perceval.ideasonboard.com ([95.142.166.194]:52875 "EHLO
	...
	with ESMTP id S1754601Ab2GRNyG (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 18 Jul 2012 09:54:06 -0400
From: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
To: Guennadi Liakhovetski <g.liakhovetski@gmx.de>
Cc: linux-media@vger.kernel.org
Subject: [PATCH v3 9/9] soc-camera: Push probe-time power management to drivers
Date: Wed, 18 Jul 2012 15:54:04 +0200
Message-Id: <1342619644-5712-10-git-send-email-laurent.pinchart@ideasonboard.com>
...
index 6abeae2..cbab3ba 100644
--- a/drivers/media/video/soc_camera.c
+++ b/drivers/media/video/soc_camera.c
@@ -1080,22 +1080,6 @@ static int soc_camera_probe(struct soc_camera_device *icd)
 	if (ret < 0)
 		goto eadd;
...
-
 	...
 	if (ret < 0)
@@ -1165,8 +1149,6 @@ static int soc_camera_probe(struct soc_camera_device *icd)
