...
Received: from bombadil.infradead.org ([65.50.211.133]:44887 "EHLO
        bombadil.infradead.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1751468AbdC2Syc (ORCPT
...
Subject: [PATCH 10/22] usb/power-management.txt: convert to ReST and add to driver-api book
Date: Wed, 29 Mar 2017 15:54:09 -0300
Message-Id: <0af5957ca1b4aa14fd67af1e37dbd6953249a08e.1490813422.git.mchehab@s-opensource.com>
...
@@ -44,22 +47,25 @@ device is turned off while the system as a whole remains running, we
...
@@ -76,8 +82,8 @@ event.  Examples include a suspended keyboard resuming when a key is
...
@@ -92,11 +98,11 @@ If a USB device has no driver, its usbfs file isn't open, and it isn't
...
@@ -125,51 +131,51 @@ all dynamic suspend events are internal; external agents are not
...
@@ -180,31 +186,31 @@ but only "autosuspend" works.)
...
@@ -214,14 +220,14 @@ image.  To alter the parameter value you would have to rebuild that
 image.
...
@@ -234,8 +240,8 @@ autosuspend of any USB device.  This has the benefit of allowing you
...
@@ -246,7 +252,7 @@ among printers and scanners, but plenty of other types of device have
 the same deficiency.
...
@@ -284,30 +290,30 @@ device by suspending it at the wrong time.  (Highly unlikely, but
 possible.)  Take care.
...
@@ -315,22 +321,22 @@ optional.  The methods' jobs are quite simple:
 	before the suspend).
...
@@ -341,15 +347,15 @@ to suspend or resume some but not all of a device's interfaces.  The
...
@@ -368,41 +374,41 @@ autosuspend the device.
...
@@ -413,37 +419,37 @@ the device is no longer present or operating properly.  Unlike
...
@@ -453,41 +459,41 @@ be pushed back.  Many of the usb_autopm_* routines also make this call,
...
+--------------------------------------------
 ...
 a couple of ways.
@@ -512,8 +518,8 @@ wakeup may fail and get lost.  Which outcome occurs depends on timing
...
@@ -522,11 +528,11 @@ lower power state(L1 for usb2.0 devices, or U1/U2 for usb3.0 devices),
...
@@ -537,8 +543,8 @@ relevant attribute files are usb2_hardware_lpm and usb3_hardware_lpm.
...
@@ -550,29 +556,31 @@ relevant attribute files are usb2_hardware_lpm and usb3_hardware_lpm.
...
@@ -581,38 +589,49 @@ similarly affected by a port power cycle event.  For this reason the
...
@@ -631,10 +650,10 @@ these files are relative to a usb hub device (prefix).
...
@@ -645,24 +664,26 @@ While a superspeed port is powered off a device may downgrade its
...
@@ -670,24 +691,24 @@ Sysfs files relevant for port power control:
...
@@ -698,48 +719,50 @@ Sysfs files relevant for port power control:
...
@@ -747,14 +770,14 @@ Summary of poweroff pre-requisite settings relative to a port device:
...
@@ -764,7 +787,7 @@ done for 'hardwired' ports provided poweroff is coordinated with any
