...
Received: from mga03.intel.com ([134.134.136.65]:11537 "EHLO mga03.intel.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1754196AbbFJPEw (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Wed, 10 Jun 2015 11:04:52 -0400
Date: Wed, 10 Jun 2015 23:04:19 +0800
From: kbuild test robot <fengguang.wu@intel.com>
To: Fabien Dessenne <fabien.dessenne@st.com>
Cc: kbuild-all@01.org, Mauro Carvalho Chehab <m.chehab@samsung.com>,
	linux-media@vger.kernel.org, Hans Verkuil <hans.verkuil@cisco.com>
Subject: [linuxtv-media:master 1224/1252]
 drivers/media/platform/sti/bdisp/bdisp-debug.c:594:2: warning: right shift
 count >= width of type
Message-ID: <201506102307.2ojC5Ny1%fengguang.wu@intel.com>
MIME-Version: 1.0
...
commit: 34b6beb65beb7f7726baa771661c671310445265 [1224/1252] [media] bdisp: add debug file system
config: mips-allyesconfig (attached as .config)
reproduce:
  wget https://git.kernel.org/cgit/linux/kernel/git/wfg/lkp-tests.git/plain/sbin/make.cross -O ~/bin/make.cross
  chmod +x ~/bin/make.cross
  git checkout 34b6beb65beb7f7726baa771661c671310445265
...
All warnings (new ones prefixed by >>):
   ...
   In file included from arch/mips/include/asm/div64.h:12:0,
                    ...
                    from drivers/media/platform/sti/bdisp/bdisp-debug.c:7:
   ...
   include/asm-generic/div64.h:43:28: warning: comparison of distinct pointer types lacks a cast
     (void)(((typeof((n)) *)0) == ((uint64_t *)0)); \
                               ^
>> drivers/media/platform/sti/bdisp/bdisp-debug.c:588:2: note: in expansion of macro 'do_div'
     do_div(avg_time_us, request->nb_req);
     ^
   include/asm-generic/div64.h:43:28: warning: comparison of distinct pointer types lacks a cast
     (void)(((typeof((n)) *)0) == ((uint64_t *)0)); \
                               ^
   drivers/media/platform/sti/bdisp/bdisp-debug.c:594:2: note: in expansion of macro 'do_div'
     do_div(avg_fps, avg_time_us);
     ^
>> drivers/media/platform/sti/bdisp/bdisp-debug.c:594:2: warning: right shift count >= width of type
   In file included from arch/mips/include/asm/div64.h:12:0,
                    from include/linux/kernel.h:136,
                    from include/linux/list.h:8,
                    from include/linux/wait.h:6,
   ...
   include/asm-generic/div64.h:43:28: warning: comparison of distinct pointer types lacks a cast
     (void)(((typeof((n)) *)0) == ((uint64_t *)0)); \
                               ^
   drivers/media/platform/sti/bdisp/bdisp-debug.c:595:2: note: in expansion of macro 'do_div'
     do_div(min_fps, bdisp->dbg.min_duration);
     ^
   drivers/media/platform/sti/bdisp/bdisp-debug.c:595:2: warning: right shift count >= width of type
   In file included from arch/mips/include/asm/div64.h:12:0,
                    from include/linux/kernel.h:136,
                    from include/linux/list.h:8,
                    from include/linux/wait.h:6,
   ...
   include/asm-generic/div64.h:43:28: warning: comparison of distinct pointer types lacks a cast
     (void)(((typeof((n)) *)0) == ((uint64_t *)0)); \
                               ^
   drivers/media/platform/sti/bdisp/bdisp-debug.c:596:2: note: in expansion of macro 'do_div'
     do_div(max_fps, bdisp->dbg.max_duration);
     ^
   drivers/media/platform/sti/bdisp/bdisp-debug.c:596:2: warning: right shift count >= width of type
   In file included from arch/mips/include/asm/div64.h:12:0,
                    from include/linux/kernel.h:136,
                    from include/linux/list.h:8,
                    from include/linux/wait.h:6,
   ...
   include/asm-generic/div64.h:43:28: warning: comparison of distinct pointer types lacks a cast
     (void)(((typeof((n)) *)0) == ((uint64_t *)0)); \
                               ^
   drivers/media/platform/sti/bdisp/bdisp-debug.c:597:2: note: in expansion of macro 'do_div'
     do_div(last_fps, bdisp->dbg.last_duration);
     ^
   drivers/media/platform/sti/bdisp/bdisp-debug.c:597:2: warning: right shift count >= width of type
   In file included from arch/mips/include/asm/div64.h:12:0,
                    from include/linux/kernel.h:136,
                    from include/linux/list.h:8,
                    from include/linux/wait.h:6,
...
vim +594 drivers/media/platform/sti/bdisp/bdisp-debug.c

   582		if (!request->nb_req) {
   583			seq_puts(s, "No request\n");
   584			return 0;
   585		}
   586	
   587		avg_time_us = bdisp->dbg.tot_duration;
 > 588		do_div(avg_time_us, request->nb_req);
   589	
   590		avg_fps = 1000000;
   591		min_fps = 1000000;
   592		max_fps = 1000000;
   593		last_fps = 1000000;
 > 594		do_div(avg_fps, avg_time_us);
   595		do_div(min_fps, bdisp->dbg.min_duration);
   596		do_div(max_fps, bdisp->dbg.max_duration);
   597		do_div(last_fps, bdisp->dbg.last_duration);
