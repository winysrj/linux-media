...
Received: from mailout4.w1.samsung.com ([210.118.77.14]:14942 "EHLO
	mailout4.w1.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751148Ab2IYRff (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 25 Sep 2012 13:35:35 -0400
Received: from eusync2.samsung.com (mailout4.w1.samsung.com [210.118.77.14])
 by mailout4.w1.samsung.com
 (Oracle Communications Messaging Server 7u4-24.01(7.0.4.24.0) 64bit (built Nov
 17 2011)) with ESMTP id <0MAX00JKN2882R30@mailout4.w1.samsung.com> for
 linux-media@vger.kernel.org; Tue, 25 Sep 2012 18:36:08 +0100 (BST)
Received: from AMDN157 ([106.116.147.102])
 by eusync2.samsung.com (Oracle Communications Messaging Server 7u4-23.01
 (7.0.4.23.0) 64bit (built Aug 10 2011))
 with ESMTPA id <0MAX00IF52789V60@eusync2.samsung.com> for
 linux-media@vger.kernel.org; Tue, 25 Sep 2012 18:35:33 +0100 (BST)
From: Kamil Debski <k.debski@samsung.com>
To: Andrzej Hajda <a.hajda@samsung.com>, linux-media@vger.kernel.org
Cc: Marek Szyprowski <m.szyprowski@samsung.com>
References: <1345547132-6252-1-git-send-email-a.hajda@samsung.com>
In-reply-to: <1345547132-6252-1-git-send-email-a.hajda@samsung.com>
Subject: RE: [PATCH] v4l/s5p-mfc: added support for end of stream handling in
 MFC encoder
Date: Tue, 25 Sep 2012 19:35:32 +0200
Message-id: <024101cd9b44$29f49a70$7dddcf50$%debski@samsung.com>
MIME-version: 1.0
...
> Sent: 21 August 2012 13:06
> To: linux-media@vger.kernel.org
> Cc: Marek Szyprowski; Kamil Debski; Andrzej Hajda
> Subject: [PATCH] v4l/s5p-mfc: added support for end of stream handling in
MFC
> encoder
> 
...
> ---
> Corrected code to support the latest event API.
> ---
...
>  drivers/media/platform/s5p-mfc/s5p_mfc_enc.c    |  106
++++++++++++++++++-----
...
> @@ -1119,27 +1120,43 @@ static int vidioc_qbuf(struct file *file, void
*priv,
...
O_NONBLOCK);
> -	else if (buf->type == V4L2_BUF_TYPE_VIDEO_CAPTURE_MPLANE)
> -		return vb2_dqbuf(&ctx->vq_dst, buf, file->f_flags &
O_NONBLOCK);
> -	return -EINVAL;
> +	if (buf->type == V4L2_BUF_TYPE_VIDEO_OUTPUT_MPLANE) {
...
> 
>  /* Stream on */
> @@ -1471,6 +1488,57 @@ static int vidioc_g_parm(struct file *file, void
*priv,
>  	return 0;
>  }
> 
...
> @@ -1491,6 +1559,9 @@ static const struct v4l2_ioctl_ops
s5p_mfc_enc_ioctl_ops =
> {
...
>  }
> 
> @@ -1133,7 +1140,7 @@ static int s5p_mfc_run_dec_frame(struct s5p_mfc_ctx
*ctx,
> int last_frame)
>  	}
...
> @@ -1160,7 +1167,7 @@ static int s5p_mfc_run_enc_frame(struct s5p_mfc_ctx
*ctx)
...
>  		spin_unlock_irqrestore(&dev->irqlock, flags);
>  		return -EAGAIN;
> @@ -1170,19 +1177,40 @@ static int s5p_mfc_run_enc_frame(struct s5p_mfc_ctx
*ctx)
>  		spin_unlock_irqrestore(&dev->irqlock, flags);
>  		return -EAGAIN;
>  	}
