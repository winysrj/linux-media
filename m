...
Received: from mailgw02.mediatek.com ([210.61.82.184]:25931 "EHLO
	mailgw02.mediatek.com" rhost-flags-OK-FAIL-OK-FAIL) by vger.kernel.org
	with ESMTP id S1751895AbcC2LcU (ORCPT
...
Subject: [PATCH v6 0/8] Add MT8173 Video Encoder Driver and VPU Driver
Date: Tue, 29 Mar 2016 19:32:02 +0800
Message-ID: <1459251130-53774-1-git-send-email-tiffany.lin@mediatek.com>
MIME-Version: 1.0
...
7. Refine makefile to build as a module
8. Code clean up

VPU Part
1. export symbols for building VPU as a module
...
Tiffany Lin (3):
 ...
 drivers/media/platform/mtk-vcodec/venc_drv_if.c    |  111 ++
 ...
 33 files changed, 6281 insertions(+)
