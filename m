...
Received: from mail.kapsi.fi ([217.30.184.167]:37784 "EHLO mail.kapsi.fi"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1755923Ab1G1Vc6 (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Thu, 28 Jul 2011 17:32:58 -0400
Received: from dyn3-82-128-185-212.psoas.suomi.net ([82.128.185.212] helo=localhost.localdomain)
	by mail.kapsi.fi with esmtpsa (TLS1.0:DHE_RSA_AES_256_CBC_SHA1:32)
	(Exim 4.69)
	(envelope-from <crope@iki.fi>)
	id 1QmYCN-0005c7-A0
	for linux-media@vger.kernel.org; Fri, 29 Jul 2011 00:32:55 +0300
Message-ID: <4E31D586.5080903@iki.fi>
Date: Fri, 29 Jul 2011 00:32:54 +0300
...
+++ b/drivers/media/dvb/dvb-usb/af9015.c
@@ -1111,10 +1111,10 @@ static int af9015_af9013_frontend_attach(struct 
dvb_usb_adapter *adap)
  	}
...
@@ -1188,49 +1188,49 @@ static int af9015_tuner_attach(struct 
dvb_usb_adapter *adap)
...
+++ b/drivers/media/dvb/dvb-usb/anysee.c
@@ -488,13 +488,13 @@ static int anysee_frontend_attach(struct 
dvb_usb_adapter *adap)
  		/* E30 */
...
+		adap->fe[0] = dvb_attach(zl10353_attach, &anysee_zl10353_config,
  		...
  		break;
@@ -512,7 +512,7 @@ static int anysee_frontend_attach(struct 
dvb_usb_adapter *adap)
  			goto error;
...
+		adap->fe[0] = dvb_attach(zl10353_attach, &anysee_zl10353_config,
  		...
  		break;
@@ -525,7 +525,7 @@ static int anysee_frontend_attach(struct 
dvb_usb_adapter *adap)
  			goto error;
...
+		adap->fe[0] = dvb_attach(tda10023_attach, &anysee_tda10023_config,
  		...
  		break;
@@ -538,7 +538,7 @@ static int anysee_frontend_attach(struct 
dvb_usb_adapter *adap)
  			goto error;
...
+		adap->fe[0] = dvb_attach(cx24116_attach, &anysee_cx24116_config,
  		...
  		break;
@@ -580,12 +580,12 @@ static int anysee_frontend_attach(struct 
dvb_usb_adapter *adap)
  			/* attach demod */
  			if (tmp == 0xc7) {
  				/* TDA18212 config */
...
@@ -605,12 +605,12 @@ static int anysee_frontend_attach(struct 
dvb_usb_adapter *adap)
  			/* attach demod */
  			if (tmp == 0xc7) {
  				/* TDA18212 config */
...
@@ -647,7 +647,7 @@ static int anysee_frontend_attach(struct 
dvb_usb_adapter *adap)
  				goto error;
...
@@ -670,7 +670,7 @@ static int anysee_frontend_attach(struct 
dvb_usb_adapter *adap)
  				goto error;
...
@@ -692,13 +692,13 @@ static int anysee_frontend_attach(struct 
dvb_usb_adapter *adap)
  			goto error;
...
@@ -720,7 +720,7 @@ static int anysee_tuner_attach(struct 
dvb_usb_adapter *adap)
  		/* E30 */
...
+		fe = dvb_attach(dvb_pll_attach, adap->fe[0], (0xc2 >> 1),
  		...
  		break;
@@ -728,7 +728,7 @@ static int anysee_tuner_attach(struct 
dvb_usb_adapter *adap)
  		/* E30 Plus */
...
+		fe = dvb_attach(dvb_pll_attach, adap->fe[0], (0xc2 >> 1),
  		...
  		break;
@@ -736,7 +736,7 @@ static int anysee_tuner_attach(struct 
dvb_usb_adapter *adap)
  		/* E30 C Plus */
...
+		fe = dvb_attach(dvb_pll_attach, adap->fe[0], (0xc0 >> 1),
  		...
  		break;
@@ -744,7 +744,7 @@ static int anysee_tuner_attach(struct 
dvb_usb_adapter *adap)
  		/* E30 S2 Plus */
...
+		fe = dvb_attach(isl6423_attach, adap->fe[0], &adap->dev->i2c_adap,
  		...
  		break;
@@ -775,7 +775,7 @@ static int anysee_tuner_attach(struct 
dvb_usb_adapter *adap)
  			goto error;
...
+		fe = dvb_attach(tda18212_attach, adap->fe[0], &adap->dev->i2c_adap,
  		...
  		if (fe)
  			break;
@@ -786,7 +786,7 @@ static int anysee_tuner_attach(struct 
dvb_usb_adapter *adap)
  			goto error;
...
+		fe = dvb_attach(dvb_pll_attach, adap->fe[0], (0xc0 >> 1),
  		...
  		break;
@@ -801,7 +801,7 @@ static int anysee_tuner_attach(struct 
dvb_usb_adapter *adap)
  			goto error;
...
+		fe = dvb_attach(tda18212_attach, adap->fe[0], &adap->dev->i2c_adap,
  		...
  		break;
@@ -811,12 +811,12 @@ static int anysee_tuner_attach(struct 
dvb_usb_adapter *adap)
  		/* E7 PS2 */
...
+	adap->fe[0] = stb0899_attach(&az6027_stb0899_config, 
&adap->dev->i2c_adap);
...
-		if (stb6100_attach(adap->fe, &az6027_stb6100_config, 
&adap->dev->i2c_adap)) {
+		if (stb6100_attach(adap->fe[0], &az6027_stb6100_config, 
&adap->dev->i2c_adap)) {
...
@@ -214,7 +214,7 @@ static int ce6230_mxl5003s_tuner_attach(struct 
dvb_usb_adapter *adap)
  {
  	int ret;
  	deb_info("%s:\n", __func__);
...
+++ b/drivers/media/dvb/dvb-usb/cinergyT2-core.c
@@ -69,7 +69,7 @@ static int cinergyt2_frontend_attach(struct 
dvb_usb_adapter *adap)
  	char state[3];
  	int ret;
...
+	dvb_attach(simple_tuner_attach, adap->fe[0],
  	...
  	return 0;
@@ -733,27 +733,27 @@ static int cxusb_fmd1216me_tuner_attach(struct 
dvb_usb_adapter *adap)
...
@@ -795,9 +795,9 @@ static int cxusb_dvico_xc3028_tuner_attach(struct 
dvb_usb_adapter *adap)
  	};
...
@@ -808,7 +808,7 @@ static int cxusb_dvico_xc3028_tuner_attach(struct 
dvb_usb_adapter *adap)
...
@@ -816,7 +816,7 @@ static int cxusb_mxl5003s_tuner_attach(struct 
dvb_usb_adapter *adap)
...
@@ -824,7 +824,7 @@ static int cxusb_d680_dmb_tuner_attach(struct 
dvb_usb_adapter *adap)
...
@@ -837,7 +837,7 @@ static int cxusb_cx22702_frontend_attach(struct 
dvb_usb_adapter *adap)
...
@@ -851,7 +851,7 @@ static int cxusb_lgdt3303_frontend_attach(struct 
dvb_usb_adapter *adap)
...
@@ -860,9 +860,9 @@ static int cxusb_lgdt3303_frontend_attach(struct 
dvb_usb_adapter *adap)

  static int cxusb_aver_lgdt3303_frontend_attach(struct dvb_usb_adapter 
*adap)
  {
...
+	if (adap->fe[0] != NULL)
  	...
  	return -EIO;
@@ -876,7 +876,7 @@ static int cxusb_mt352_frontend_attach(struct 
dvb_usb_adapter *adap)
...
@@ -890,9 +890,9 @@ static int cxusb_dee1601_frontend_attach(struct 
dvb_usb_adapter *adap)
...
+		((adap->fe[0] = dvb_attach(zl10353_attach,
  					...
  					&adap->dev->i2c_adap)) != NULL))
  		return 0;
@@ -917,7 +917,7 @@ static int cxusb_dualdig4_frontend_attach(struct 
dvb_usb_adapter *adap)
...
+	if ((adap->fe[0] = dvb_attach(zl10353_attach,
  				   ...
  				   &adap->dev->i2c_adap)) == NULL)
  		return -EIO;
@@ -1031,9 +1031,9 @@ static int 
cxusb_dualdig4_rev2_frontend_attach(struct dvb_usb_adapter *adap)
  		return -ENODEV;
  	}
...
+	if (adap->fe[0] == NULL)
  	...
  	return 0;
@@ -1084,15 +1084,15 @@ static int 
cxusb_dualdig4_rev2_tuner_attach(struct dvb_usb_adapter *adap)
  {
...
@@ -1108,12 +1108,12 @@ static int cxusb_nano2_frontend_attach(struct 
dvb_usb_adapter *adap)
  	cxusb_bluebird_gpio_pulse(adap->dev, 0x01, 1);
  	cxusb_bluebird_gpio_pulse(adap->dev, 0x02, 1);
...
+	if ((adap->fe[0] = dvb_attach(mt352_attach,
  				   ...
  				   &adap->dev->i2c_adap)) != NULL)
  		return 0;
@@ -1172,8 +1172,8 @@ static int cxusb_d680_dmb_frontend_attach(struct 
dvb_usb_adapter *adap)
  	msleep(100);
...
+	if (adap->fe[0] == NULL)
  	...
  	return 0;
@@ -1223,9 +1223,9 @@ static int 
cxusb_mygica_d689_frontend_attach(struct dvb_usb_adapter *adap)
  	msleep(100);
...
+++ b/drivers/media/dvb/dvb-usb/dib0700_devices.c
@@ -101,7 +101,7 @@ static int bristol_frontend_attach(struct 
dvb_usb_adapter *adap)
  		}
  	}
...
+	return (adap->fe[0] = dvb_attach(dib3000mc_attach, &adap->dev->i2c_adap,
  		(10 + adap->id) << 1, &bristol_dib3000mc_config[adap->id])) == NULL 
? -ENODEV : 0;
  }

@@ -118,14 +118,14 @@ static int eeprom_read(struct i2c_adapter *adap,u8 
adrs,u8 *pval)
...
+	struct i2c_adapter *tun_i2c = 
dib3000mc_get_tuner_i2c_master(adap->fe[0], 1);
  	s8 a;
  	int if1=1220;
  	if (adap->dev->udev->descriptor.idVendor  == 
...
+	return dvb_attach(mt2060_attach,adap->fe[0], 
tun_i2c,&bristol_mt2060_config[adap->id],
  		if1) == NULL ? -ENODEV : 0;
  }

@@ -279,10 +279,10 @@ static int stk7700P2_frontend_attach(struct 
dvb_usb_adapter *adap)
  		}
  	}
...
+	adap->fe[0] = dvb_attach(dib7000p_attach, 
&adap->dev->i2c_adap,0x80+(adap->id << 1),
...
@@ -306,17 +306,17 @@ static int stk7700d_frontend_attach(struct 
dvb_usb_adapter *adap)
  		}
  	}
...
@@ -396,8 +396,8 @@ static int stk7700ph_xc3028_callback(void *ptr, int 
component,
  	switch (command) {
...
+		dib7000p_set_gpio(adap->fe[0], 8, 0, 1);
  	...
  	case XC2028_RESET_CLK:
  		break;
@@ -447,25 +447,25 @@ static int stk7700ph_frontend_attach(struct 
dvb_usb_adapter *adap)
  		return -ENODEV;
  	}
...
@@ -685,12 +685,12 @@ static int stk7700p_frontend_attach(struct 
dvb_usb_adapter *adap)
  	st->mt2060_if1[0] = 1220;

  	if (dib7000pc_detection(&adap->dev->i2c_adap)) {
-		adap->fe = dvb_attach(dib7000p_attach, &adap->dev->i2c_adap, 18, 
&stk7700p_dib7000p_config);
+		adap->fe[0] = dvb_attach(dib7000p_attach, &adap->dev->i2c_adap, 18, 
&stk7700p_dib7000p_config);
  		st->is_dib7000pc = 1;
  	} else
-		adap->fe = dvb_attach(dib7000m_attach, &adap->dev->i2c_adap, 18, 
&stk7700p_dib7000m_config);
+		adap->fe[0] = dvb_attach(dib7000m_attach, &adap->dev->i2c_adap, 18, 
&stk7700p_dib7000m_config);
...
DIBX000_I2C_INTERFACE_TUNER, 1);
+		tun_i2c = dib7000m_get_i2c_master(adap->fe[0], 
DIBX000_I2C_INTERFACE_TUNER, 1);

-	return dvb_attach(mt2060_attach, adap->fe, tun_i2c, 
&stk7700p_mt2060_config,
+	return dvb_attach(mt2060_attach, adap->fe[0], tun_i2c, 
&stk7700p_mt2060_config,
  		if1) == NULL ? -ENODEV : 0;
  }

@@ -843,33 +843,33 @@ static int dib7770_set_param_override(struct 
dvb_frontend *fe,
...
@@ -878,26 +878,26 @@ static int stk7700p_pid_filter(struct 
dvb_usb_adapter *adapter, int index,
  {
...
@@ -955,9 +955,9 @@ static int stk7070p_frontend_attach(struct 
dvb_usb_adapter *adap)
  		return -ENODEV;
  	}
...
+	return adap->fe[0] == NULL ? -ENODEV : 0;
  ...
  /* STK7770P */
@@ -1007,9 +1007,9 @@ static int stk7770p_frontend_attach(struct 
dvb_usb_adapter *adap)
  		return -ENODEV;
  	}
...
+	return adap->fe[0] == NULL ? -ENODEV : 0;
  ...
  /* DIB807x generic */
@@ -1225,34 +1225,34 @@ static int dib807x_set_param_override(struct 
dvb_frontend *fe,
...
+	return dib8000_pid_filter_ctrl(adapter->fe[0], onoff);
  ...
  /* STK807x */
@@ -1276,10 +1276,10 @@ static int stk807x_frontend_attach(struct 
dvb_usb_adapter *adap)
...
+	return adap->fe[0] == NULL ?  -ENODEV : 0;
  ...
  /* STK807xPVR */
@@ -1305,10 +1305,10 @@ static int stk807xpvr_frontend_attach0(struct 
dvb_usb_adapter *adap)
  	/* initialize IC 0 */
...
@@ -1316,10 +1316,10 @@ static int stk807xpvr_frontend_attach1(struct 
dvb_usb_adapter *adap)
  	/* initialize IC 1 */
...
+	return adap->fe[0] == NULL ? -ENODEV : 0;
  ...
  /* STK8096GP */
@@ -1546,13 +1546,13 @@ static int dib8096_set_param_override(struct 
dvb_frontend *fe,
...
-	if (dvb_attach(dib0090_register, adap->fe, tun_i2c, 
&dib809x_dib0090_config) == NULL)
+	if (dvb_attach(dib0090_register, adap->fe[0], tun_i2c, 
&dib809x_dib0090_config) == NULL)
  		return -ENODEV;
...
@@ -1575,30 +1575,30 @@ static int stk809x_frontend_attach(struct 
dvb_usb_adapter *adap)
...
dib8000_get_slave_frontend(adap->fe[0], 1);

  	if (fe_slave) {
  		tun_i2c = dib8000_get_i2c_master(fe_slave, 
DIBX000_I2C_INTERFACE_TUNER, 1);
...
-	tun_i2c = dib8000_get_i2c_master(adap->fe, 
DIBX000_I2C_INTERFACE_TUNER, 1);
-	if (dvb_attach(dib0090_register, adap->fe, tun_i2c, 
&dib809x_dib0090_config) == NULL)
+	tun_i2c = dib8000_get_i2c_master(adap->fe[0], 
DIBX000_I2C_INTERFACE_TUNER, 1);
+	if (dvb_attach(dib0090_register, adap->fe[0], tun_i2c, 
&dib809x_dib0090_config) == NULL)
  		return -ENODEV;
...
@@ -1626,12 +1626,12 @@ static int nim8096md_frontend_attach(struct 
dvb_usb_adapter *adap)
...
+	if (adap->fe[0] == NULL)
  	...
  	fe_slave = dvb_attach(dib8000_attach, &adap->dev->i2c_adap, 0x82, 
...
@@ -1639,12 +1639,12 @@ static int nim8096md_frontend_attach(struct 
dvb_usb_adapter *adap)
  /* STK9090M */
...
+	return dib9000_fw_pid_filter(adapter->fe[0], index, pid, onoff);
  ...
  static int dib90x0_pid_filter_ctrl(struct dvb_usb_adapter *adapter, 
int onoff)
  {
...
@@ -1856,15 +1856,15 @@ static int stk9090m_frontend_attach(struct 
dvb_usb_adapter *adap)
  	stk9090m_config.microcode_B_fe_size = state->frontend_firmware->size;
  	stk9090m_config.microcode_B_fe_buffer = state->frontend_firmware->data;

-	adap->fe = dvb_attach(dib9000_attach, &adap->dev->i2c_adap, 0x80, 
&stk9090m_config);
+	adap->fe[0] = dvb_attach(dib9000_attach, &adap->dev->i2c_adap, 0x80, 
&stk9090m_config);
...
+	struct i2c_adapter *i2c = dib9000_get_tuner_interface(adap->fe[0]);
  	u16 data_dib190[10] = {
  		1, 0x1374,
  		2, 0x01a2,
@@ -1873,13 +1873,13 @@ static int dib9090_tuner_attach(struct 
dvb_usb_adapter *adap)
  		8, 0x0486,
  	};

-	if (dvb_attach(dib0090_fw_register, adap->fe, i2c, 
&dib9090_dib0090_config) == NULL)
+	if (dvb_attach(dib0090_fw_register, adap->fe[0], i2c, 
&dib9090_dib0090_config) == NULL)
  		return -ENODEV;
-	i2c = dib9000_get_i2c_master(adap->fe, DIBX000_I2C_INTERFACE_GPIO_1_2, 0);
+	i2c = dib9000_get_i2c_master(adap->fe[0], 
...
+	if (dib9000_firmware_post_pll_init(adap->fe[0]) < 0)
  	...
  	return 0;
@@ -1925,16 +1925,16 @@ static int nim9090md_frontend_attach(struct 
dvb_usb_adapter *adap)
  	nim9090md_config[1].microcode_B_fe_buffer = 
state->frontend_firmware->data;
...
@@ -2393,23 +2393,23 @@ static int nim7090_frontend_attach(struct 
dvb_usb_adapter *adap)
...
@@ -2439,11 +2439,11 @@ static int tfe7090pvr_frontend0_attach(struct 
dvb_usb_adapter *adap)
  	}

  	dib0700_set_i2c_speed(adap->dev, 340);
-	adap->fe = dvb_attach(dib7000p_attach, &adap->dev->i2c_adap, 0x90, 
&tfe7090pvr_dib7000p_config[0]);
-	if (adap->fe == NULL)
+	adap->fe[0] = dvb_attach(dib7000p_attach, &adap->dev->i2c_adap, 0x90, 
&tfe7090pvr_dib7000p_config[0]);
+	if (adap->fe[0] == NULL)
  		return -ENODEV;
...
@@ -2452,50 +2452,50 @@ static int tfe7090pvr_frontend1_attach(struct 
dvb_usb_adapter *adap)
  {
...
-	i2c = dib7000p_get_i2c_master(adap->dev->adapter[0].fe, 
DIBX000_I2C_INTERFACE_GPIO_6_7, 1);
+	i2c = dib7000p_get_i2c_master(adap->dev->adapter[0].fe[0], 
DIBX000_I2C_INTERFACE_GPIO_6_7, 1);
  	if (dib7000p_i2c_enumeration(i2c, 1, 0x10, 
...
-	adap->fe = dvb_attach(dib7000p_attach, i2c, 0x92, 
&tfe7090pvr_dib7000p_config[1]);
+	adap->fe[0] = dvb_attach(dib7000p_attach, i2c, 0x92, 
&tfe7090pvr_dib7000p_config[1]);
...
@@ -2555,14 +2555,14 @@ static int stk7070pd_frontend_attach0(struct 
dvb_usb_adapter *adap)
  		return -ENODEV;
  	}
...
+	return adap->fe[0] == NULL ? -ENODEV : 0;
  ...
  {
-	adap->fe = dvb_attach(dib7000p_attach, &adap->dev->i2c_adap, 0x82, 
&stk7070pd_dib7000p_config[1]);
-	return adap->fe == NULL ? -ENODEV : 0;
+	adap->fe[0] = dvb_attach(dib7000p_attach, &adap->dev->i2c_adap, 0x82, 
&stk7070pd_dib7000p_config[1]);
+	return adap->fe[0] == NULL ? -ENODEV : 0;
  }

  /* S5H1411 */
@@ -2617,9 +2617,9 @@ static int s5h1411_frontend_attach(struct 
dvb_usb_adapter *adap)
...
@@ -2649,9 +2649,9 @@ static struct xc5000_config 
...
@@ -2663,9 +2663,9 @@ static int dib0700_xc4000_tuner_callback(void 
*priv, int component,
...
+		dib7000p_set_gpio(adap->fe[0], 8, 0, 1);
  		...
  		return -EINVAL;
@@ -2771,11 +2771,11 @@ static int pctv340e_frontend_attach(struct 
dvb_usb_adapter *adap)
  		return -ENODEV;
  	}
...
@@ -2791,7 +2791,7 @@ static int xc4000_tuner_attach(struct 
dvb_usb_adapter *adap)
  	struct i2c_adapter *tun_i2c;
...
@@ -2799,9 +2799,9 @@ static int xc4000_tuner_attach(struct 
dvb_usb_adapter *adap)
  	}
...
@@ -2857,16 +2857,16 @@ static int lgdt3305_frontend_attach(struct 
dvb_usb_adapter *adap)
...
+++ b/drivers/media/dvb/dvb-usb/dibusb-common.c
@@ -23,7 +23,7 @@ int dibusb_streaming_ctrl(struct dvb_usb_adapter 
*adap, int onoff)
  	if (adap->priv != NULL) {
...
@@ -37,7 +37,7 @@ int dibusb_pid_filter(struct dvb_usb_adapter *adap, 
int index, u16 pid, int onof
  	if (adap->priv != NULL) {
  		struct dibusb_state *st = adap->priv;
...
@@ -48,7 +48,7 @@ int dibusb_pid_filter_ctrl(struct dvb_usb_adapter 
*adap, int onoff)
  	if (adap->priv != NULL) {
  		struct dibusb_state *st = adap->priv;
...
+			if (st->ops.pid_parse(adap->fe[0],onoff) < 0)
  	...
  	return 0;
@@ -254,8 +254,8 @@ int dibusb_dib3000mc_frontend_attach(struct 
dvb_usb_adapter *adap)
  		msleep(1000);
  	}

-	if ((adap->fe = dvb_attach(dib3000mc_attach, &adap->dev->i2c_adap, 
DEFAULT_DIB3000P_I2C_ADDRESS,  &mod3000p_dib3000p_config)) != NULL ||
-		(adap->fe = dvb_attach(dib3000mc_attach, &adap->dev->i2c_adap, 
DEFAULT_DIB3000MC_I2C_ADDRESS, &mod3000p_dib3000p_config)) != NULL) {
+	if ((adap->fe[0] = dvb_attach(dib3000mc_attach, &adap->dev->i2c_adap, 
DEFAULT_DIB3000P_I2C_ADDRESS,  &mod3000p_dib3000p_config)) != NULL ||
+		(adap->fe[0] = dvb_attach(dib3000mc_attach, &adap->dev->i2c_adap, 
DEFAULT_DIB3000MC_I2C_ADDRESS, &mod3000p_dib3000p_config)) != NULL) {
  		if (adap->priv != NULL) {
  			struct dibusb_state *st = adap->priv;
...
-	if (dvb_attach(mt2060_attach, adap->fe, tun_i2c, 
&stk3000p_mt2060_config, if1) == NULL) {
+	tun_i2c = dib3000mc_get_tuner_i2c_master(adap->fe[0], 1);
+	if (dvb_attach(mt2060_attach, adap->fe[0], tun_i2c, 
&stk3000p_mt2060_config, if1) == NULL) {
  		/* not found - use panasonic pll parameters */
-		if (dvb_attach(dvb_pll_attach, adap->fe, 0x60, tun_i2c, 
DVB_PLL_ENV57H1XD5) == NULL)
+		if (dvb_attach(dvb_pll_attach, adap->fe[0], 0x60, tun_i2c, 
DVB_PLL_ENV57H1XD5) == NULL)
  			return -ENOMEM;
  	} else {
  		st->mt2060_present = 1;
...
+++ b/drivers/media/dvb/dvb-usb/dibusb-mb.c
@@ -31,11 +31,11 @@ static int dibusb_dib3000mb_frontend_attach(struct 
dvb_usb_adapter *adap)
...
@@ -46,7 +46,7 @@ static int dibusb_thomson_tuner_attach(struct 
dvb_usb_adapter *adap)
...
@@ -57,7 +57,7 @@ static int dibusb_panasonic_tuner_attach(struct 
dvb_usb_adapter *adap)
...
@@ -78,16 +78,16 @@ static int dibusb_tuner_probe_and_attach(struct 
dvb_usb_adapter *adap)
...
&adap->dev->i2c_adap)) != NULL) {
+	if ((adap->fe[0] = dvb_attach(mt352_attach, &digitv_mt352_config, 
&adap->dev->i2c_adap)) != NULL) {
  		st->is_nxt6000 = 0;
  		return 0;
  	}
...
&adap->dev->i2c_adap)) != NULL) {
+	if ((adap->fe[0] = dvb_attach(nxt6000_attach, &digitv_nxt6000_config, 
&adap->dev->i2c_adap)) != NULL) {
  		st->is_nxt6000 = 1;
  		return 0;
  	}
@@ -152,11 +152,11 @@ static int digitv_tuner_attach(struct 
dvb_usb_adapter *adap)
  {
  	struct digitv_state *st = adap->dev->priv;
...
+++ b/drivers/media/dvb/dvb-usb/dtt200u.c
@@ -90,7 +90,7 @@ static int dtt200u_rc_query(struct dvb_usb_device *d, 
u32 *event, int *state)
...
diff --git a/drivers/media/dvb/dvb-usb/dtv5100.c 
b/drivers/media/dvb/dvb-usb/dtv5100.c
index 078ce92..75ed55c 100644
--- a/drivers/media/dvb/dvb-usb/dtv5100.c
+++ b/drivers/media/dvb/dvb-usb/dtv5100.c
@@ -115,13 +115,13 @@ static struct zl10353_config 
dtv5100_zl10353_config = {
...
+++ b/drivers/media/dvb/dvb-usb/dvb-usb-dvb.c
@@ -186,14 +186,14 @@ int dvb_usb_adapter_frontend_init(struct 
dvb_usb_adapter *adap)
  	}
...
@@ -208,9 +208,9 @@ int dvb_usb_adapter_frontend_init(struct 
dvb_usb_adapter *adap)
...
@@ -1119,16 +1119,16 @@ static int stv0288_frontend_attach(struct 
dvb_usb_adapter *d)
  {
  	u8 obuf[] = {7, 1};
...
@@ -1163,12 +1163,12 @@ static int prof_7500_frontend_attach(struct 
dvb_usb_adapter *d)
  {
  	u8 obuf[] = {7, 1};
...
diff --git a/drivers/media/dvb/dvb-usb/gp8psk.c 
...
@@ -958,10 +958,10 @@ static int dm04_lme2510_frontend_attach(struct 
dvb_usb_adapter *adap)
  	st->i2c_talk_onoff = 1;
...
@@ -975,9 +975,9 @@ static int dm04_lme2510_frontend_attach(struct 
dvb_usb_adapter *adap)
  	}
...
@@ -991,9 +991,9 @@ static int dm04_lme2510_frontend_attach(struct 
dvb_usb_adapter *adap)
  	}
...
+	if (adap->fe[0]) {
  		...
  		st->i2c_tuner_gate_w = 4;
  		st->i2c_tuner_gate_r = 5;
@@ -1010,15 +1010,15 @@ static int dm04_lme2510_frontend_attach(struct 
dvb_usb_adapter *adap)
...
@@ -1031,17 +1031,17 @@ static int dm04_lme2510_tuner(struct 
dvb_usb_adapter *adap)
...
+++ b/drivers/media/dvb/dvb-usb/m920x.c
@@ -501,7 +501,7 @@ static int m920x_mt352_frontend_attach(struct 
dvb_usb_adapter *adap)
  {
  	deb("%s\n",__func__);
...
+	if ((adap->fe[0] = dvb_attach(mt352_attach,
  				   ...
  				   &adap->dev->i2c_adap)) == NULL)
  		return -EIO;
@@ -513,7 +513,7 @@ static int m920x_tda10046_08_frontend_attach(struct 
dvb_usb_adapter *adap)
  {
  	deb("%s\n",__func__);
...
+	if ((adap->fe[0] = dvb_attach(tda10046_attach,
  				   ...
  				   &adap->dev->i2c_adap)) == NULL)
  		return -EIO;
@@ -525,7 +525,7 @@ static int m920x_tda10046_0b_frontend_attach(struct 
dvb_usb_adapter *adap)
  {
  	deb("%s\n",__func__);
...
+	if ((adap->fe[0] = dvb_attach(tda10046_attach,
  				   ...
  				   &adap->dev->i2c_adap)) == NULL)
  		return -EIO;
@@ -537,7 +537,7 @@ static int m920x_qt1010_tuner_attach(struct 
dvb_usb_adapter *adap)
  {
  	deb("%s\n",__func__);
...
+	if (dvb_attach(qt1010_attach, adap->fe[0], &adap->dev->i2c_adap, 
&m920x_qt1010_config) == NULL)
  		return -ENODEV;

  	return 0;
@@ -547,7 +547,7 @@ static int m920x_tda8275_60_tuner_attach(struct 
dvb_usb_adapter *adap)
  {
  	deb("%s\n",__func__);
...
NULL) == NULL)
+	if (dvb_attach(tda827x_attach, adap->fe[0], 0x60, 
&adap->dev->i2c_adap, NULL) == NULL)
  		return -ENODEV;

  	return 0;
@@ -557,7 +557,7 @@ static int m920x_tda8275_61_tuner_attach(struct 
dvb_usb_adapter *adap)
  {
  	deb("%s\n",__func__);
...
NULL) == NULL)
+	if (dvb_attach(tda827x_attach, adap->fe[0], 0x61, 
&adap->dev->i2c_adap, NULL) == NULL)
  		return -ENODEV;

  	return 0;
@@ -565,7 +565,7 @@ static int m920x_tda8275_61_tuner_attach(struct 
dvb_usb_adapter *adap)
...
+++ b/drivers/media/dvb/dvb-usb/technisat-usb2.c
@@ -292,7 +292,7 @@ static void technisat_usb2_green_led_control(struct 
work_struct *work)
  {
...
+	struct dvb_frontend *fe = state->dev->adapter[0].fe[0];
  	...
  	if (state->power_state == 0)
  		goto schedule;
@@ -505,14 +505,14 @@ static int technisat_usb2_frontend_attach(struct 
dvb_usb_adapter *a)
...
@@ -532,8 +532,8 @@ static int technisat_usb2_frontend_attach(struct 
dvb_usb_adapter *a)
...
+				a->fe[0]->ops.init(a->fe[0]);
  			...
  			if (mutex_lock_interruptible(&a->dev->i2c_mutex) < 0)
  				return -EAGAIN;
@@ -548,20 +548,20 @@ static int technisat_usb2_frontend_attach(struct 
dvb_usb_adapter *a)
  			if (ret != 0)
...
+++ b/drivers/media/dvb/dvb-usb/ttusb2.c
@@ -195,7 +195,7 @@ static int ttusb2_frontend_tda10086_attach(struct 
dvb_usb_adapter *adap)
...
&adap->dev->i2c_adap)) == NULL) {
+	if ((adap->fe[0] = dvb_attach(tda10086_attach, &tda10086_config, 
&adap->dev->i2c_adap)) == NULL) {
  		deb_info("TDA10086 attach failed\n");
  		return -ENODEV;
  	}
@@ -207,7 +207,7 @@ static int ttusb2_frontend_tda10023_attach(struct 
dvb_usb_adapter *adap)
  {
  	if (usb_set_interface(adap->dev->udev, 0, 3) < 0)
  		err("set interface to alts=3 failed");
...
+	if ((adap->fe[0] = dvb_attach(tda10023_attach, &tda10023_config, 
&adap->dev->i2c_adap, 0x48)) == NULL) {
  		deb_info("TDA10023 attach failed\n");
  		return -ENODEV;
  	}
@@ -216,7 +216,7 @@ static int ttusb2_frontend_tda10023_attach(struct 
dvb_usb_adapter *adap)
...
@@ -225,12 +225,12 @@ static int ttusb2_tuner_tda827x_attach(struct 
dvb_usb_adapter *adap)

  static int ttusb2_tuner_tda826x_attach(struct dvb_usb_adapter *adap)
  {
-	if (dvb_attach(tda826x_attach, adap->fe, 0x60, &adap->dev->i2c_adap, 
0) == NULL) {
...
-	if (dvb_attach(lnbp21_attach, adap->fe, &adap->dev->i2c_adap, 0, 0) == 
NULL) {
+	if (dvb_attach(lnbp21_attach, adap->fe[0], &adap->dev->i2c_adap, 0, 0) 
== NULL) {
...
+++ b/drivers/media/dvb/dvb-usb/umt-010.c
@@ -60,14 +60,14 @@ static int umt_mt352_frontend_attach(struct 
dvb_usb_adapter *adap)
