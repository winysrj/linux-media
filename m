...
Received: from smtp-vbr1.xs4all.nl ([194.109.24.21]:4406 "EHLO
	smtp-vbr1.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751389Ab3G2H6t (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 29 Jul 2013 03:58:49 -0400
Message-ID: <51F6209F.2080007@xs4all.nl>
Date: Mon, 29 Jul 2013 09:58:23 +0200
From: Hans Verkuil <hverkuil@xs4all.nl>
MIME-Version: 1.0
To: Ondrej Zary <linux@rainbow-software.org>
CC: linux-media@vger.kernel.org, alsa-devel@alsa-project.org
Subject: Re: [PATCH 2/2] tea575x: Move from sound to media
References: <1375041704-17928-1-git-send-email-linux@rainbow-software.org> <1375041704-17928-2-git-send-email-linux@rainbow-software.org> <1375041704-17928-3-git-send-email-linux@rainbow-software.org>
In-Reply-To: <1375041704-17928-3-git-send-email-linux@rainbow-software.org>
...
I really like these changes: the Kconfig part is simplified and it makes much more
