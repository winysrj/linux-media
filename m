...
Received: from mx07-00178001.pphosted.com ([62.209.51.94]:29565 "EHLO
        mx07-00178001.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1751223AbcLERLu (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Mon, 5 Dec 2016 12:11:50 -0500
...
Subject: [PATCH v4 07/10] [media] st-delta: rpmsg ipc support
Date: Mon, 5 Dec 2016 18:11:30 +0100
Message-ID: <1480957893-25636-8-git-send-email-hugues.fruchet@st.com>
...
@@ -1690,6 +1691,14 @@ static int delta_probe(struct platform_device *pdev)
...
@@ -1734,6 +1743,8 @@ static int delta_remove(struct platform_device *pdev)
 {
