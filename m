...
Received: from smtp-vbr6.xs4all.nl ([194.109.24.26]:4638 "EHLO
	smtp-vbr6.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752446AbaELKAy (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 12 May 2014 06:00:54 -0400
Message-ID: <53709BB5.6030700@xs4all.nl>
Date: Mon, 12 May 2014 12:00:21 +0200
...
Subject: Re: [PATCH v4 2/2] media: davinci: vpif display: upgrade the driver
 with v4l offerings
References: <1399885110-9899-1-git-send-email-prabhakar.csengg@gmail.com> <1399885110-9899-3-git-send-email-prabhakar.csengg@gmail.com>
In-Reply-To: <1399885110-9899-3-git-send-email-prabhakar.csengg@gmail.com>
...
The same comment as for the previous patch applies here as well. There are just too many
independent changes mixed into a single patch.
...
This looks like a spurious message from the driver. It is perfectly valid to
pass an invalid format index. The driver should just return EINVAL, not print
a message.
...
This should be set, possibly from the video op g_mbus_config().
...
Same weirdness as with the capture case.

>         test VIDIOC_EXPBUF: FAIL
> 
> Total: 53, Succeeded: 50, Failed: 3, Warnings: 0

And you should try 'v4l2-compliance -s' here as well.
