...
Received: from smtp10.smtpout.orange.fr ([80.12.242.132]:27853 "EHLO
        ...
        with ESMTP id S1755674AbcIFJEc (ORCPT
...
Subject: [PATCH v6 04/14] media: platform: pxa_camera: convert to vb2
Date: Tue,  6 Sep 2016 11:04:14 +0200
Message-Id: <1473152664-5077-4-git-send-email-robert.jarzmik@free.fr>
...
+	dev_dbg(pcdev_to_dev(pcdev),
 	...
 	if (!status)
@@ -1496,42 +1483,11 @@ static int pxa_camera_try_fmt(struct soc_camera_device *icd,
 	return ret;
 }
...
@@ -1604,8 +1560,7 @@ static struct soc_camera_host_ops pxa_soc_camera_host_ops = {
