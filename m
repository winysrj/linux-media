...
Received: from lb1-smtp-cloud9.xs4all.net ([194.109.24.22]:54130 "EHLO
        lb1-smtp-cloud9.xs4all.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S967450AbeBNLog (ORCPT
...
Subject: [PATCH for v4.14 08/13] media: v4l2-compat-ioctl32.c: fix ctrl_is_pointer
