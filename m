...
Received: from mail-we0-f174.google.com ([74.125.82.174]:53480 "EHLO
	mail-we0-f174.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752200Ab2GXJbA (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 24 Jul 2012 05:31:00 -0400
Received: by weyx8 with SMTP id x8so4907539wey.19
        for <linux-media@vger.kernel.org>; Tue, 24 Jul 2012 02:30:58 -0700 (PDT)
MIME-Version: 1.0
In-Reply-To: <CAMm-=zCORLRA7=Ckeq45A9vPxZ9Yxm=y4MpnHNTnwSb-jCzjMw@mail.gmail.com>
References: <1341484061-10914-1-git-send-email-shaik.ameer@samsung.com>
	...
	<CAMm-=zCORLRA7=Ckeq45A9vPxZ9Yxm=y4MpnHNTnwSb-jCzjMw@mail.gmail.com>
Date: Tue, 24 Jul 2012 15:00:58 +0530
Message-ID: <CAFSwF2cbMfA14GHc50Z4oMSx=dDsgUY6fZOFxECGTzwbv-Gq7Q@mail.gmail.com>
...
I will try to release the v3 patch in a day or two with your comments
addressed ...

please find my review comments inline...


On Wed, Jul 11, 2012 at 11:22 PM, Pawel Osciak <pawel@osciak.com> wrote:
> Hi Shaik,
...
OK. I will create "exynos-gsc" folder.
...
".color" remains same, the VU order is taken care under ".corder" field
...
Its same.. YUV. as you can see, the plane order is changed in the name (Y/Cr/Cb)
...
Gscaler supports RGB Types
RGB601 (SD, 16 ~ 235)
RGB601 (SD, 0 ~ 255)
RGB709 (HD, 16 ~ 235)
RGB709 (HD, 0 ~ 255)

so i will change this field to either V4L2_COLORSPACE_REC709 or
V4L2_COLORSPACE_SMPTE170M as default.
Is it fine ???
...
Ok. I will check for zero parameters.
...
platform_get_resource() is getting some references from
platform_device. I don't think we need to explicitly release these
resources..
Is there anything i am missing?? i mean any API's ???
...
Ok. i will remove all the unused code...
...
Yes. I think we can keep the reference.. but updating the values are
not valid... which i was doing in the user_to_drv() funciton.
I will change that..
...
Sorry.. i read the documentation... we can store the pointer but we
should not update values explicitly...
I will change this implementation.
...
Ok. I will fix this and all others...
