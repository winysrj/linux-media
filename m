...
Received: from mailout4.w1.samsung.com ([210.118.77.14]:13370 "EHLO
	...
	with ESMTP id S1753212Ab0LVNk4 (ORCPT
...
Received: from linux.samsung.com ([106.116.38.10])
 ...
 2004)) with ESMTPA id <0LDU00KP50O1TG@spt1.w1.samsung.com> for
 linux-media@vger.kernel.org; Wed, 22 Dec 2010 13:40:50 +0000 (GMT)
Date: Wed, 22 Dec 2010 14:40:32 +0100
...
Message-id: <1293025239-9977-3-git-send-email-m.szyprowski@samsung.com>
...
@@ -817,8 +986,38 @@ static long __video_do_ioctl(struct file *file,
 		case V4L2_BUF_TYPE_VIDEO_CAPTURE:
...
@@ -829,8 +1028,38 @@ static long __video_do_ioctl(struct file *file,
 		case V4L2_BUF_TYPE_VIDEO_OUTPUT:
 			CLEAR_AFTER_FIELD(f, fmt.pix);
 			v4l_print_pix_fmt(vfd, &f->fmt.pix);
...
+			}
 		...
 		case V4L2_BUF_TYPE_VIDEO_OUTPUT_OVERLAY:
 			CLEAR_AFTER_FIELD(f, fmt.win);
@@ -879,11 +1108,41 @@ static long __video_do_ioctl(struct file *file,
 		switch (f->type) {
 		case V4L2_BUF_TYPE_VIDEO_CAPTURE:
 			CLEAR_AFTER_FIELD(f, fmt.pix);
...
@@ -892,11 +1151,41 @@ static long __video_do_ioctl(struct file *file,
 			break;
 		case V4L2_BUF_TYPE_VIDEO_OUTPUT:
 			CLEAR_AFTER_FIELD(f, fmt.pix);
...
@@ -2057,7 +2346,7 @@ static unsigned long cmd_input_size(unsigned int cmd)
 	switch (cmd) {
...
@@ -2082,6 +2371,49 @@ static unsigned long cmd_input_size(unsigned int cmd)
 	}
 }
...
+
 ...
 {
@@ -2089,16 +2421,14 @@ long video_ioctl2(struct file *file,
 	void    *mbuf = NULL;
 	void	*parg = (void *)arg;
 	long	err  = -EINVAL;
-	int     is_ext_ctrl;
...
@@ -2127,43 +2457,43 @@ long video_ioctl2(struct file *file,
 		}
 	}
