...
Received: from lb1-smtp-cloud6.xs4all.net ([194.109.24.24]:54337 "EHLO
	lb1-smtp-cloud6.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1752547AbaKUKuu (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 21 Nov 2014 05:50:50 -0500
Message-ID: <546F18F5.6010407@xs4all.nl>
Date: Fri, 21 Nov 2014 11:50:29 +0100
From: Hans Verkuil <hverkuil@xs4all.nl>
MIME-Version: 1.0
To: Linux Media Mailing List <linux-media@vger.kernel.org>
CC: Mariusz Bialonczyk <manio@skyboo.net>
Subject: Re: [PATCH for v3.18] media: use sg = sg_next(sg) instead of sg++
References: <546F03F8.9000301@xs4all.nl> <546F0E5B.80600@xs4all.nl>
In-Reply-To: <546F0E5B.80600@xs4all.nl>
