...
Received: from mout.gmx.net ([212.227.17.22]:52837 "EHLO mout.gmx.net"
	...
	id S1752527AbcBURjy (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Sun, 21 Feb 2016 12:39:54 -0500
Date: Sun, 21 Feb 2016 17:32:12 +0100 (CET)
From: Guennadi Liakhovetski <g.liakhovetski@gmx.de>
To: Hans Verkuil <hverkuil@xs4all.nl>
cc: linux-media@vger.kernel.org, Hans Verkuil <hans.verkuil@cisco.com>,
	Ludovic Desroches <ludovic.desroches@atmel.com>,
	Sergei Shtylyov <sergei.shtylyov@cogentembedded.com>
Subject: Re: [PATCH 09/12] media/.../soc-camera: convert drivers to use the
 new vb2_queue dev field
In-Reply-To: <1455626587-8051-10-git-send-email-hverkuil@xs4all.nl>
Message-ID: <Pine.LNX.4.64.1602211731530.5959@axis700.grange>
References: <1455626587-8051-1-git-send-email-hverkuil@xs4all.nl>
 <1455626587-8051-10-git-send-email-hverkuil@xs4all.nl>
MIME-Version: 1.0
Content-Type: TEXT/PLAIN; charset=US-ASCII
Sender: linux-media-owner@vger.kernel.org
List-ID: <linux-media.vger.kernel.org>

On Tue, 16 Feb 2016, Hans Verkuil wrote:
...
>  drivers/media/platform/soc_camera/mx2_camera.c          | 17 +++--------------
...
>  		priv->sequence = 0;
>  
> @@ -1797,6 +1794,7 @@ static int rcar_vin_init_videobuf2(struct vb2_queue *vq,
...
>  }
> @@ -1891,10 +1889,6 @@ static int rcar_vin_probe(struct platform_device *pdev)
>  	if (ret)
>  		return ret;
>  
...
> @@ -1925,7 +1919,6 @@ static int rcar_vin_probe(struct platform_device *pdev)
>  
>  cleanup:
>  	pm_runtime_disable(&pdev->dev);
