...
Received: from lb3-smtp-cloud3.xs4all.net ([194.109.24.30]:50433 "EHLO
	lb3-smtp-cloud3.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1751274AbcFBHTE (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 2 Jun 2016 03:19:04 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hans.verkuil@cisco.com>,
	Guennadi Liakhovetski <g.liakhovetski@gmx.de>
Subject: [PATCH 2/4] staging/media: remove deprecated mx3 driver
Date: Thu,  2 Jun 2016 09:18:50 +0200
Message-Id: <1464851932-17915-3-git-send-email-hverkuil@xs4all.nl>
In-Reply-To: <1464851932-17915-1-git-send-email-hverkuil@xs4all.nl>
References: <1464851932-17915-1-git-send-email-hverkuil@xs4all.nl>
...
---
 ...
 6 files changed, 1295 deletions(-)
