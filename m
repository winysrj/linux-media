...
Received: from metis.ext.4.pengutronix.de ([92.198.50.35]:56357 "EHLO
        metis.ext.4.pengutronix.de" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1754876AbcJNRfC (ORCPT
...
Subject: [PATCH v2 10/21] [media] imx: Add i.MX MIPI CSI-2 subdevice driver
Date: Fri, 14 Oct 2016 19:34:30 +0200
Message-Id: <1476466481-24030-11-git-send-email-p.zabel@pengutronix.de>
