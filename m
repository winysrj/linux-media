...
Received: from proofpoint-cluster.metrocast.net ([65.175.128.136]:53021 "EHLO
	proofpoint-cluster.metrocast.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1755231Ab0EaXK4 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 31 May 2010 19:10:56 -0400
Subject: Re: PROBLEM: 2.6.34-rc7 kernel panics "BUG: unable to handle
 kernel NULL pointer dereference at (null)" while channel scan running
From: Andy Walls <awalls@md.metrocast.net>
To: Silamael <Silamael@coronamundi.de>
Cc: linux-media@vger.kernel.org
In-Reply-To: <4C023EE0.8050405@coronamundi.de>
References: <4C023EE0.8050405@coronamundi.de>
Content-Type: text/plain; charset="UTF-8"
Date: Mon, 31 May 2010 19:11:04 -0400
Message-ID: <1275347464.2260.60.camel@localhost>
Mime-Version: 1.0
