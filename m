...
Received: from lb1-smtp-cloud2.xs4all.net ([194.109.24.21]:36039 "EHLO
        lb1-smtp-cloud2.xs4all.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S972416AbdDXP72 (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Mon, 24 Apr 2017 11:59:28 -0400
Subject: Re: [PATCH v5 1/3] [media] v4l: add parsed MPEG-2 support
To: Hugues Fruchet <hugues.fruchet@st.com>, linux-media@vger.kernel.org
References: <1492789933-17090-1-git-send-email-hugues.fruchet@st.com>
 <1492789933-17090-2-git-send-email-hugues.fruchet@st.com>
Cc: kernel@stlinux.com,
        Benjamin Gaignard <benjamin.gaignard@linaro.org>,
        Jean-Christophe Trotin <jean-christophe.trotin@st.com>
From: Hans Verkuil <hverkuil@xs4all.nl>
Message-ID: <8e7359f2-4fe6-e43d-fd7c-ca8233449376@xs4all.nl>
Date: Mon, 24 Apr 2017 17:59:24 +0200
MIME-Version: 1.0
In-Reply-To: <1492789933-17090-2-git-send-email-hugues.fruchet@st.com>
...
> index 0d2e1e0..d652a77 100644
> --- a/include/uapi/linux/v4l2-controls.h
> +++ b/include/uapi/linux/v4l2-controls.h
> @@ -547,6 +547,104 @@ enum v4l2_mpeg_video_mpeg4_profile {
>  };
...
Are you sure this is right? You have 3 + 64 + 64 bytes before the padding
field. So you need only one byte padding, not three.

I'm wondering if it isn't better to replace the occasional _u8 by a
__u16 or __u32 to achieve the correct alignment, rather than adding
padding arrays.
