...
Received: from mta5.srv.hcvlny.cv.net ([167.206.4.200])
	...
	(envelope-from <stoth@linuxtv.org>) id 1JquEP-0007Kd-FR
	for linux-dvb@linuxtv.org; Tue, 29 Apr 2008 20:07:10 +0200
Received: from steven-toths-macbook-pro.local
	(ool-18bfe594.dyn.optonline.net [24.191.229.148]) by
	mta5.srv.hcvlny.cv.net
	(Sun Java System Messaging Server 6.2-8.04 (built Feb 28 2007))
	with ESMTP id <0K0300735MAY4OM0@mta5.srv.hcvlny.cv.net> for
	linux-dvb@linuxtv.org; Tue, 29 Apr 2008 14:06:35 -0400 (EDT)
Date: Tue, 29 Apr 2008 14:06:34 -0400
From: Steven Toth <stoth@linuxtv.org>
In-reply-to: <48176236.1020306@web.de>
To: Torben Viets <viets@web.de>
Message-id: <481763AA.4030702@linuxtv.org>
MIME-version: 1.0
...
> 
> I hope you've got an idea, i updated my bios (afters this my RAM doesn't 
...
is requested on the fly. But, that doesn't explain the missing eeprom 
errors.
