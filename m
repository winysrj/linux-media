...
Received: from smtp.nokia.com ([192.100.122.233]:36886 "EHLO
	mgw-mx06.nokia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1755578Ab0I2MlZ (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 29 Sep 2010 08:41:25 -0400
From: "Matti J. Aaltonen" <matti.j.aaltonen@nokia.com>
To: linux-media@vger.kernel.org, mchehab@redhat.com,
	hverkuil@xs4all.nl, eduardo.valentin@nokia.com
Cc: "Matti J. Aaltonen" <matti.j.aaltonen@nokia.com>
Subject: [PATCH v11 2/4] MFD: WL1273 FM Radio: MFD driver for the FM radio.
Date: Wed, 29 Sep 2010 15:40:37 +0300
Message-Id: <1285764039-5767-3-git-send-email-matti.j.aaltonen@nokia.com>
In-Reply-To: <1285764039-5767-2-git-send-email-matti.j.aaltonen@nokia.com>
...
+				core->rx_frequency = WL1273_BAND_JAPAN_LOW +
+					freq * 50;
+			else
+				core->rx_frequency = WL1273_BAND_OTHER_LOW +
+					freq * 50;
+			/*
...
+	core->buf_size = rds_buf * RDS_BLOCK_SIZE;
...
+	core->band = WL1273_BAND_OTHER;
+	core->i2s_mode = WL1273_I2S_DEF_MODE;
+	core->channel_number = 2;
+	core->volume = WL1273_DEFAULT_VOLUME;
+	core->rx_frequency = WL1273_BAND_OTHER_LOW;
+	core->tx_frequency = WL1273_BAND_OTHER_HIGH;
+	core->rangelow = WL1273_BAND_OTHER_LOW;
+	core->rangehigh = WL1273_BAND_OTHER_HIGH;
+	core->stereo = true;
+
