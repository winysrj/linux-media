...
Received: from lb3-smtp-cloud2.xs4all.net ([194.109.24.29]:42779 "EHLO
	lb3-smtp-cloud2.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S932855AbcFTPNh (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 20 Jun 2016 11:13:37 -0400
Subject: Re: [PATCH 2/6] v4l: Fix number of zeroed high order bits in 12-bit
 raw format defs
To: Sakari Ailus <sakari.ailus@linux.intel.com>,
	linux-media@vger.kernel.org
References: <1464353080-18300-1-git-send-email-sakari.ailus@linux.intel.com>
 <1464353080-18300-3-git-send-email-sakari.ailus@linux.intel.com>
Cc: g.liakhovetski@gmx.de
From: Hans Verkuil <hverkuil@xs4all.nl>
Message-ID: <57680809.3080609@xs4all.nl>
Date: Mon, 20 Jun 2016 17:13:13 +0200
MIME-Version: 1.0
In-Reply-To: <1464353080-18300-3-git-send-email-sakari.ailus@linux.intel.com>
