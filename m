...
Received: from wx-out-0506.google.com ([66.249.82.229])
	...
	(envelope-from <anluoma@gmail.com>) id 1JbfzF-0006dF-0U
	for linux-dvb@linuxtv.org; Tue, 18 Mar 2008 18:52:34 +0100
Received: by wx-out-0506.google.com with SMTP id s11so5881129wxc.17
	for <linux-dvb@linuxtv.org>; Tue, 18 Mar 2008 10:52:27 -0700 (PDT)
Message-ID: <754a11be0803181052i6b80ece7o81921dcf142db4e@mail.gmail.com>
Date: Tue, 18 Mar 2008 19:52:25 +0200
From: "Antti Luoma" <anluoma@gmail.com>
To: "Albert Comerma" <albert.comerma@gmail.com>, linux-dvb@linuxtv.org
In-Reply-To: <ea4209750803181030ge4fb4c3o6fd885d57744d9e0@mail.gmail.com>
MIME-Version: 1.0
...
Content-Type: multipart/mixed; boundary="===============1354894776=="
Mime-version: 1.0
...
Content-Type: multipart/alternative;
	boundary="----=_Part_12526_5523646.1205862745886"

------=_Part_12526_5523646.1205862745886
...
>
> That's very strange... You can try adding a usb hub, but I don't think
> this should be the problem. Perhaps a kernel crash in some function... but I
> don't see much information in your dmesg...
>
> Albert
>
...
> > Yes I'm sure.
> >
> > Could the problem be low power from usb? Though this is the only usb
...
> > Mar 18 19:03:10 xenbuntu kernel: [13722.883240] usb 6-1: USB disconnect,
> > address 14
...
> > Mar 18 19:03:26 xenbuntu kernel: [13729.268363] dvb-usb: Pinnacle PCTV
> > 72e DVB-T successfully deinitialized and disconnected.
> > Mar 18 19:03:26 xenbuntu kernel: [13729.312499] usb 6-1: new high speed
> > USB device using ehci_hcd and address 15
> > Mar 18 19:03:26 xenbuntu kernel: [13729.365651] usb 6-1: configuration
> > #1 chosen from 1 choice
> > Mar 18 19:03:26 xenbuntu kernel: [13729.365724] dvb-usb: found a
> > 'Pinnacle PCTV 72e DVB-T' in warm state.
> > Mar 18 19:03:26 xenbuntu kernel: [13729.365841] dvb-usb: will pass the
> > complete MPEG2 transport stream to the software demuxer.
> > Mar 18 19:03:26 xenbuntu kernel: [13729.365926] DVB: registering new
> > adapter (Pinnacle PCTV 72e DVB-T)
...
> > frontend 0 (DiBcom 7000PC)...
> > Mar 18 19:03:26 xenbuntu kernel: [13729.600365] DiB0070: successfully
> > identified
> > Mar 18 19:03:26 xenbuntu kernel: [13729.600376] dvb-usb: Pinnacle PCTV
> > 72e DVB-T successfully initialized and connected.
> >
> > It looks that it is disconnecting the device after scan has started...?
> >
> > BTW this is Ubuntu 8.04 (RC4):
> > Linux xenbuntu 2.6.24-12-generic #1 SMP Wed Mar 12 22:31:43 UTC 2008
> > x86_64 GNU/Linux
> >
> > -Antti-
> >
> > 2008/3/18, Albert Comerma <albert.comerma@gmail.com>:
> > >
> > > Are you sure you tested with the new compiled module? Could you verify
> > > that in your v4l-dvb/linux/drivers/media/dvb/dvb-usb/dib0700_devices.c  you
> > > have this on the stk7070p_frontend_attach first line;
> > >
> > >        dib0700_set_gpio(adap->dev, GPIO6, GPIO_OUT, 0);
> > >
> > > Because I remember with 72e that with GPIO6 set to 1 the tunner is
> > > disabled.
...
> > > >
> > > > I tested the Stick with windows and it found channels ok.. So what
> > > > shall I do next?
> > > >
> > > > -antti-
> > > >
...
> > > > >
> > > > > Tomorrow I'l (hmm today, its getting late) test this with windows
> > > > > that it works in there...
> > > > >
> > > > > -Antti-
> > > > >
> > > > >
...
> > > > > > >  Hi,
> > > > > > >
> > > > > > > I have trying to get Solo Stick (72e) to work for couple of
> > > > > > > days, but with no luck. So what's the current status of this driver?
> > > > > > >
> > > > > > > I did download latest drivers from mercurial today, added
> > > > > > > PCI_ids for card, modified dib0700_devices.c (in stk7070p_frontend_attach),
> > > > > > > added device to struct dvb_usb_device_properties dib0700_devices[] where
> > > > > > > stk7070p_frontend_attach was called.
> > > > > > >
> > > > > > > After that it looked promising:
> > > > > > >
> > > > > > >  usb 6-4: new high speed USB device using ehci_hcd and address
> > > > > > > 30
> > > > > > > [ 6722.607546] usb 6-4: configuration #1 chosen from 1 choice
> > > > > > > [ 6722.607622] dvb-usb: found a 'Pinnacle PCTV 72e DVB-T' in
> > > > > > > warm state.
...
[15046.961287] &gt;&gt;&gt; 03 80 00 ec 07 00 <br><br><br>I think this has to be USB related issue...<br><br><br><br><br><div><span class="gmail_quote">2008/3/18, Albert Comerma &lt;<a href="mailto:albert.comerma@gmail.com">albert.comerma@gmail.com</a>&gt;:</span><blockquote class="gmail_quote" style="border-left: 1px solid rgb(204, 204, 204); margin: 0pt 0pt 0pt 0.8ex; padding-left: 1ex;">
That&#39;s very strange... You can try adding a usb hub, but I don&#39;t think this should be the problem. Perhaps a kernel crash in some function... but I don&#39;t see much information in your dmesg...<div><span class="e" id="q_118c2f11010addb4_1"><br>
<br>Albert<br><br>
...
</span></div></blockquote></div><br><br clear="all"><br>-- <br>-Antti-
