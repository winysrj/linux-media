...
Received: from smtp2.macqel.be ([109.135.2.61]:59988 "EHLO smtp2.macqel.be"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727332AbeIKWHE (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Tue, 11 Sep 2018 18:07:04 -0400
From: Philippe De Muyter <phdm@macqel.be>
To: linux-media@vger.kernel.org, slongerbeam@gmail.com
Cc: Philippe De Muyter <phdm@macqel.be>
Subject: [PATCH v3 1/2] media: v4l2-subdev.h: allow V4L2_FRMIVAL_TYPE_CONTINUOUS & _STEPWISE
Date: Tue, 11 Sep 2018 19:06:32 +0200
Message-Id: <1536685593-27512-2-git-send-email-phdm@macqel.be>
