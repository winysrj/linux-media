...
Received: from mail1.radix.net ([207.192.128.31]:46705 "EHLO mail1.radix.net"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1750874AbZLXCzN (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Wed, 23 Dec 2009 21:55:13 -0500
Subject: Re: [PATCH v2.1 1/2] V4L: Add memory-to-memory device helper
 framework for V4L2.
...
In-Reply-To: <1261574255-23386-2-git-send-email-p.osciak@samsung.com>
References: <1261574255-23386-1-git-send-email-p.osciak@samsung.com>
	 <1261574255-23386-2-git-send-email-p.osciak@samsung.com>
Content-Type: text/plain
Date: Wed, 23 Dec 2009 21:53:15 -0500
Message-Id: <1261623196.3140.84.camel@palomino.walls.org>
Mime-Version: 1.0
