...
Received: from mailgw02.mediatek.com ([210.61.82.184]:52721 "EHLO
	mailgw02.mediatek.com" rhost-flags-OK-FAIL-OK-FAIL) by vger.kernel.org
	with ESMTP id S932731AbcBWILc (ORCPT
...
Subject: [PATCH v5 5/8] [Media] vcodec: mediatek: Add Mediatek V4L2 Video Encoder Driver
Date: Tue, 23 Feb 2016 16:11:18 +0800
Message-ID: <1456215081-16858-6-git-send-email-tiffany.lin@mediatek.com>
In-Reply-To: <1456215081-16858-5-git-send-email-tiffany.lin@mediatek.com>
...
+		  */
+		*nplanes = sizes[i] = fmt->fmt.pix_mp.num_planes;
+		for (i = 0; i < *nplanes; i++) {
...
+ *				(struct venc_vp8_handle/venc_h264_handle *)
+ */
...
+ * @inst_id:	VPU encoder instance id
+ *			(struct venc_vp8_vpu_drv/venc_h264_vpu_drv *)
