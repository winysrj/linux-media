...
Received: from lb3-smtp-cloud2.xs4all.net ([194.109.24.29]:60235 "EHLO
	...
	by vger.kernel.org with ESMTP id S1752421AbcDCTm4 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sun, 3 Apr 2016 15:42:56 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: niklas.soderlund+renesas@ragnatech.se,
	Hans Verkuil <hans.verkuil@cisco.com>
Subject: [PATCH 1/2] v4l2-rect.h: new header with struct v4l2_rect helper functions.
Date: Sun,  3 Apr 2016 12:42:42 -0700
Message-Id: <1459712563-8796-2-git-send-email-hverkuil@xs4all.nl>
