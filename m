...
Received: from lb3-smtp-cloud2.xs4all.net ([194.109.24.29]:32768 "EHLO
	lb3-smtp-cloud2.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1754959AbcBEPkT (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 5 Feb 2016 10:40:19 -0500
...
Subject: [PATCHv11 14/17] cec: adv7511: add cec support.
Date: Fri,  5 Feb 2016 16:27:57 +0100
Message-Id: <1454686080-39018-15-git-send-email-hverkuil@xs4all.nl>
...
+}
+
+static int adv7511_cec_adap_transmit(struct v4l2_subdev *sd, u8 *retries,
...
@@ -685,24 +887,84 @@ static void adv7511_set_isr(struct v4l2_subdev *sd, bool enable)
...
@@ -808,6 +1070,13 @@ static const struct v4l2_subdev_video_ops adv7511_video_ops = {
...
+
 ...
 {
@@ -1138,6 +1407,7 @@ static const struct v4l2_subdev_ops adv7511_ops = {
 	.pad  = &adv7511_pad_ops,
...
+	.cec  = &adv7511_cec_ops,
 ...
 /* ----------------------------------------------------------------------- */
@@ -1193,6 +1463,7 @@ static void adv7511_edid_handler(struct work_struct *work)
...
@@ -1333,10 +1604,36 @@ static bool edid_verify_header(struct v4l2_subdev *sd, u32 segment)
...
@@ -1382,6 +1679,12 @@ static bool adv7511_check_edid_status(struct v4l2_subdev *sd)
...
@@ -1403,11 +1706,14 @@ static void adv7511_init_setup(struct v4l2_subdev *sd)
 {
 	struct adv7511_state *state = get_adv7511_state(sd);
 	struct adv7511_state_edid *edid = &state->edid;
...
@@ -1419,6 +1725,25 @@ static void adv7511_init_setup(struct v4l2_subdev *sd)
 	adv7511_set_isr(sd, false);
...
@@ -1495,26 +1820,47 @@ static int adv7511_probe(struct i2c_client *client, const struct i2c_device_id *
...
@@ -1534,6 +1880,9 @@ static int adv7511_probe(struct i2c_client *client, const struct i2c_device_id *
...
+		i2c_unregister_device(state->i2c_cec);
 ...
 err_entity:
@@ -1555,9 +1904,12 @@ static int adv7511_remove(struct i2c_client *client)
