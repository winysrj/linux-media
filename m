...
Received: from bhuna.collabora.co.uk ([46.235.227.227]:51371 "EHLO
	bhuna.collabora.co.uk" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751206AbcDBFfS (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Sat, 2 Apr 2016 01:35:18 -0400
...
Subject: [PATCH v3] [media] tpg: Export the tpg code from vivid as a module
Date: Sat,  2 Apr 2016 02:35:08 -0300
Message-Id: <1459575308-13761-1-git-send-email-helen.koike@collabora.co.uk>
...
+EXPORT_SYMBOL_GPL(tpg_fill_plane_buffer);
 ...
 {
@@ -2312,3 +2328,7 @@ void tpg_fillbuffer(struct tpg_data *tpg, v4l2_std_id std, unsigned p, u8 *vbuf)
