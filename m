...
Received: from multi.imgtec.com ([194.200.65.239]:48384 "EHLO multi.imgtec.com"
	...
	id S1752656AbaAQOAP (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Fri, 17 Jan 2014 09:00:15 -0500
From: James Hogan <james.hogan@imgtec.com>
To: Mauro Carvalho Chehab <m.chehab@samsung.com>,
	<linux-media@vger.kernel.org>
CC: James Hogan <james.hogan@imgtec.com>
Subject: [PATCH v2 09/15] media: rc: img-ir: add hardware decoder driver
Date: Fri, 17 Jan 2014 13:58:54 +0000
Message-ID: <1389967140-20704-10-git-send-email-james.hogan@imgtec.com>
...
+	for (i = 0; i < RC_FILTER_MAX; ++i) {
+		rdev->scancode_filters[i].data = 0;
+		rdev->scancode_filters[i].mask = 0;
+	}
+
+	/* clear raw filters */
...
+	rdev->allowed_protos = img_ir_allowed_protos(priv);
