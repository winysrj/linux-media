...
Received: from smtp-vbr9.xs4all.nl ([194.109.24.29]:1108 "EHLO
	smtp-vbr9.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752007Ab2JEIGS (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Fri, 5 Oct 2012 04:06:18 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: Tomasz Stanislawski <t.stanislaws@samsung.com>
Subject: Re: [PATCHv9 02/25] Documentation: media: description of DMABUF importing in V4L2
Date: Fri, 5 Oct 2012 10:05:34 +0200
...
References: <1349188056-4886-1-git-send-email-t.stanislaws@samsung.com> <1349188056-4886-3-git-send-email-t.stanislaws@samsung.com>
In-Reply-To: <1349188056-4886-3-git-send-email-t.stanislaws@samsung.com>
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="iso-8859-15"
Content-Transfer-Encoding: 7bit
Message-Id: <201210051005.34847.hverkuil@xs4all.nl>
