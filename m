...
Received: from n35.bullet.mail.ukl.yahoo.com ([87.248.110.168])
	...
	(envelope-from <eallaud@yahoo.fr>) id 1K0Na4-0000bP-HJ
	for linux-dvb@linuxtv.org; Sun, 25 May 2008 23:16:42 +0200
Date: Sun, 25 May 2008 15:55:13 -0400
From: manu <eallaud@yahoo.fr>
To: linux-dvb@linuxtv.org
References: <1211682529l.9766l.0l@manu-laptop>
	<1211683962l.9766l.2l@manu-laptop>
In-Reply-To: <1211683962l.9766l.2l@manu-laptop> (from eallaud@yahoo.fr on
	Sat May 24 22:52:42 2008)
Message-Id: <1211745313l.6418l.0l@manu-laptop>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="=-0a+v7E+SujFxFs+fMeEq"
Subject: [linux-dvb] Re :  Re : [PATCH]: TT-3200 remote patch
...
--=-0a+v7E+SujFxFs+fMeEq
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
Content-Transfer-Encoding: quoted-printable

On 05/24/2008 10:52:42 PM, manu wrote:
...
> > one=20
> > puts my computer on sleep. I already checked the ir keymap and I
> dont=20
> > see the problem, if someone could give it a shot...
> > - I dont know how to test which remote is used, I based the
> detection=20
> > on the product id (0x1019), but all other cases are handled the=20
> same
>=20
> > way so...
...
Oh well I think I should have gotten more sleep before mail bombing=20
with empty patches ;-)
Here it is.
Sorry
Bye
