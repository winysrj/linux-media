...
Received: from mx3.redhat.com (mx3.redhat.com [172.16.48.32])
	by int-mx1.corp.redhat.com (8.13.1/8.13.1) with ESMTP id m6Q2jnwU030905
	for <video4linux-list@redhat.com>; Fri, 25 Jul 2008 22:45:49 -0400
Received: from calf.ext.ti.com (calf.ext.ti.com [198.47.26.144])
	by mx3.redhat.com (8.13.8/8.13.8) with ESMTP id m6Q2jb7F030120
	for <video4linux-list@redhat.com>; Fri, 25 Jul 2008 22:45:37 -0400
Received: from dlep34.itg.ti.com ([157.170.170.115])
	by calf.ext.ti.com (8.13.7/8.13.7) with ESMTP id m6Q2jQDd029427
	for <video4linux-list@redhat.com>; Fri, 25 Jul 2008 21:45:31 -0500
Received: from legion.dal.design.ti.com (localhost [127.0.0.1])
	by dlep34.itg.ti.com (8.13.7/8.13.7) with ESMTP id m6Q2jQ42025570
	for <video4linux-list@redhat.com>; Fri, 25 Jul 2008 21:45:26 -0500 (CDT)
...
Received: from dirac.dal.design.ti.com (localhost.localdomain [127.0.0.1])
	...
	m6Q2jQgA009411
	for <video4linux-list@redhat.com>; Fri, 25 Jul 2008 21:45:26 -0500
Received: (from a0270762@localhost)
	by dirac.dal.design.ti.com (8.12.11/8.12.11/Submit) id m6Q2jPv2009408
	for video4linux-list@redhat.com; Fri, 25 Jul 2008 21:45:25 -0500
Date: Fri, 25 Jul 2008 21:45:25 -0500
From: Mohit Jalori <mjalori@ti.com>
To: video4linux-list@redhat.com
Message-ID: <20080726024525.GA9403@dirac.dal.design.ti.com>
Mime-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
Subject: [Patch 1/4] sensor driver for OMAP3 camera
...
Sensor driver for OMAP3 camera
...
--- a/drivers/media/video/Kconfig	2008-07-20 17:26:15.000000000 -0500
+++ b/drivers/media/video/Kconfig	2008-07-23 16:43:59.000000000 -0500
@@ -290,6 +290,14 @@ config VIDEO_OV9640
...
@@ -822,6 +830,7 @@ menuconfig V4L_USB_DRIVERS
...
--- a/drivers/media/video/Makefile	2008-07-20 17:26:15.000000000 -0500
+++ b/drivers/media/video/Makefile	2008-07-23 16:45:36.000000000 -0500
@@ -109,6 +109,7 @@ obj-$(CONFIG_VIDEO_OMAP3) += omap34xxcam
...
diff -purN a/drivers/media/video/mt9p012.c b/drivers/media/video/mt9p012.c
--- a/drivers/media/video/mt9p012.c	1969-12-31 18:00:00.000000000 -0600
+++ b/drivers/media/video/mt9p012.c	2008-07-24 17:27:02.000000000 -0500
@@ -0,0 +1,1699 @@
+/*
...
diff -purN a/drivers/media/video/mt9p012.h b/drivers/media/video/mt9p012.h
--- a/drivers/media/video/mt9p012.h	1969-12-31 18:00:00.000000000 -0600
+++ b/drivers/media/video/mt9p012.h	2008-07-25 20:02:38.000000000 -0500
@@ -0,0 +1,295 @@
+/*
