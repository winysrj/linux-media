...
Received: from mx3.redhat.com (mx3.redhat.com [172.16.48.32])
	by int-mx1.corp.redhat.com (8.13.1/8.13.1) with ESMTP id mBGGpVsg021577
	for <video4linux-list@redhat.com>; Tue, 16 Dec 2008 11:51:31 -0500
Received: from smtp-vbr14.xs4all.nl (smtp-vbr14.xs4all.nl [194.109.24.34])
	by mx3.redhat.com (8.13.8/8.13.8) with ESMTP id mBGGpGWS008389
	for <video4linux-list@redhat.com>; Tue, 16 Dec 2008 11:51:16 -0500
From: Hans Verkuil <hverkuil@xs4all.nl>
To: video4linux-list@redhat.com
Date: Tue, 16 Dec 2008 17:51:06 +0100
References: <A24693684029E5489D1D202277BE894415E6E19B@dlee02.ent.ti.com>
In-Reply-To: <A24693684029E5489D1D202277BE894415E6E19B@dlee02.ent.ti.com>
MIME-Version: 1.0
Content-Type: text/plain;
  charset="iso-8859-1"
Content-Transfer-Encoding: 7bit
Content-Disposition: inline
Message-Id: <200812161751.07283.hverkuil@xs4all.nl>
Cc: Sakari Ailus <sakari.ailus@nokia.com>,
	"linux-omap@vger.kernel.org" <linux-omap@vger.kernel.org>,
	"Tuukka.O Toivonen" <tuukka.o.toivonen@nokia.com>, "Nagalla,
	Hari" <hnagalla@ti.com>
Subject: Re: [REVIEW PATCH 06/14] OMAP: CAM: Add ISP SCM
...
On Thursday 11 December 2008 21:38:01 Aguirre Rodriguez, Sergio Alberto wrote:
> >From 8526bbc7e5fe3f5cb73931c5db25e39402389b5b Mon Sep 17 00:00:00 2001
> From: Sergio Aguirre <saaguirre@ti.com>
> Date: Thu, 11 Dec 2008 13:35:49 -0600
> Subject: [PATCH] OMAP: CAM: Add ISP SCM
> 
...
> ---
>  drivers/media/video/isp/isp_af.c  |  755 +++++++++++++++++++++++++++++++
>  drivers/media/video/isp/isp_af.h  |  118 +++++
>  drivers/media/video/isp/isph3a.c  |  883 +++++++++++++++++++++++++++++++++++++
...
Why not handle these two 'if's first? E.g.:

	if (afdata->update == 0 ||
		!(afdata->update & REQUEST_STATISTICS)) {
		// do simple case
		return 0;
	}

	// Now do the hard case

This saves two unnecessary indents and makes it much more readable.
...
Saves an indent and makes the for-loop more readable.
...
Remove the 'else' keyword since the 'if' always returns. It's done more
often in this function.
...
This is completely unreadable. Why not:
...
Now the linebreaks are at logical places.
...
Again, handle the simple cases first and return when they are done,
then start on the hard cases. That makes it much easier to understand and
reduces the indentation. It's now hard to see what happens if update == 0
or if the REQUEST_STATISTICS flag isn't set.
