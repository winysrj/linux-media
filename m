...
Received: from mail-lf0-f65.google.com ([209.85.215.65]:34230 "EHLO
        mail-lf0-f65.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1750923AbdK3P6k (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Thu, 30 Nov 2017 10:58:40 -0500
Received: by mail-lf0-f65.google.com with SMTP id x20so8469987lff.1
        for <linux-media@vger.kernel.org>; Thu, 30 Nov 2017 07:58:39 -0800 (PST)
From: "Niklas =?iso-8859-1?Q?S=F6derlund?=" <niklas.soderlund@ragnatech.se>
Date: Thu, 30 Nov 2017 16:58:36 +0100
To: Laurent Pinchart <laurent.pinchart@ideasonboard.com>,
        Hans Verkuil <hverkuil@xs4all.nl>, linux-media@vger.kernel.org
Cc: linux-renesas-soc@vger.kernel.org, tomoharu.fukawa.eb@renesas.com,
        Kieran Bingham <kieran.bingham@ideasonboard.com>
Subject: Re: [PATCH v8 23/28] rcar-vin: parse Gen3 OF and setup media graph
Message-ID: <20171130155836.GF22365@bigcity.dyn.berto.se>
...
It should not try to update the links here as there might not be any 
entities in the graph at this point. It should simply 'return 0'. This 
was missed during testing as all drivers where compiled in and the 
complete() callback had always ran as part of the notifier registration 
before we hit this point.

Thanks to Kieran for hitting and reporting this issue.
