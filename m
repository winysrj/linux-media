...
Received: from mail-pb0-f41.google.com ([209.85.160.41]:56789 "EHLO
	mail-pb0-f41.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751135Ab3HNEqI (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 14 Aug 2013 00:46:08 -0400
...
Subject: [PATCH v5 01/13] [media] exynos5-is: Adding media device driver for exynos5
Date: Wed, 14 Aug 2013 10:16:02 +0530
Message-Id: <1376455574-15560-2-git-send-email-arun.kk@samsung.com>
...
+		struct device_node *port;
+
+		node = of_parse_phandle(parent, "csis", index);
...
+#include "mipi-csis.h"
+
+#define FIMC_LITE_OF_COMPATIBLE_NAME	"samsung,exynos5250-fimc-lite"
+#define CSIS_OF_COMPATIBLE_NAME		"samsung,exynos5250-csis"
+#define FIMC_IS_OF_COMPATIBLE_NAME	"samsung,exynos5250-fimc-is"
+
