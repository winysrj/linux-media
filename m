...
Received: from galahad.ideasonboard.com ([185.26.127.97]:35687 "EHLO
        galahad.ideasonboard.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1750791AbdFOIXw (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Thu, 15 Jun 2017 04:23:52 -0400
From: Laurent Pinchart <laurent.pinchart+renesas@ideasonboard.com>
To: linux-media@vger.kernel.org
Cc: linux-renesas-soc@vger.kernel.org
Subject: [PATCH 2/6] v4l: vsp1: Add support for the BRS entity
Date: Thu, 15 Jun 2017 11:24:05 +0300
Message-Id: <20170615082409.9523-3-laurent.pinchart+renesas@ideasonboard.com>
...
index 85387a64179a..d0b9cc64270d 100644
...
index 239996cf882e..2f2a7455e9fd 100644
...
+	u32 route;
 	...
 	if (entity->type == VSP1_ENTITY_HGO) {
 		u32 smppt;
@@ -70,8 +71,14 @@ void vsp1_entity_route_setup(struct vsp1_entity *entity,
 		return;
 
 	sink = media_entity_to_vsp1_entity(source->sink);
-	vsp1_dl_list_write(dl, source->route->reg,
-			   sink->route->inputs[source->sink_pad]);
+	route = sink->route->inputs[source->sink_pad];
+	/*
...
index c169a060b6d2..df7a8cd056a3 100644
...
index edebf3fa926f..9405bc46593c 100644
--- a/drivers/media/platform/vsp1/vsp1_pipe.c
+++ b/drivers/media/platform/vsp1/vsp1_pipe.c
@@ -362,10 +362,11 @@ void vsp1_pipeline_propagate_alpha(struct vsp1_pipeline *pipe,
 		return;
...
index eab3c3ea85d7..7e87818db1d0 100644
