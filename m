...
Received: from mailout2.samsung.com ([203.254.224.25]:36233 "EHLO
        epoutp02.samsung.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S932638AbdCaJEg (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Fri, 31 Mar 2017 05:04:36 -0400
...
Subject: [Patch v3 03/11] [media] s5p-mfc: Use min scratch buffer size as
 provided by F/W
Date: Fri, 31 Mar 2017 14:36:32 +0530
Message-id: <1490951200-32070-4-git-send-email-smitha.t@samsung.com>
...
References: <1490951200-32070-1-git-send-email-smitha.t@samsung.com>
        <CGME20170331090433epcas1p4491ae8b6539e065ee3320aff08373ace@epcas1p4.samsung.com>
...
@@ -724,6 +724,7 @@ void s5p_mfc_cleanup_queue(struct list_head *lh, struct vb2_queue *vq);
...
@@ -2160,6 +2190,7 @@ const struct s5p_mfc_regs *s5p_mfc_init_regs_v6_plus(struct s5p_mfc_dev *dev)
...
@@ -2175,6 +2206,7 @@ const struct s5p_mfc_regs *s5p_mfc_init_regs_v6_plus(struct s5p_mfc_dev *dev)
...
+	R(e_min_scratch_buffer_size, S5P_FIMV_E_MIN_SCRATCH_BUFFER_SIZE_V8);
 	...
 	return &mfc_regs;
@@ -2223,6 +2255,8 @@ static struct s5p_mfc_hw_ops s5p_mfc_ops_v6 = {
