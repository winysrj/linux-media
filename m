...
Received: from smtp.nokia.com ([192.100.105.134]:37863 "EHLO
	mgw-mx09.nokia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1761661AbZFRODs (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 18 Jun 2009 10:03:48 -0400
...
Subject: [PATCHv8  5/9] v4l2-spec: Add documentation description for FM TX extended control class
Date: Thu, 18 Jun 2009 16:55:47 +0300
Message-Id: <1245333351-28157-6-git-send-email-eduardo.valentin@nokia.com>
...
+described in the following text.</para>
     ...
     <section>
@@ -1816,6 +1822,206 @@ control must support read access and may support write access.</entry>
       </tgroup>
     </table>
   </section>
+
...
+	  </row>
+	  <row>
+	    <entry spanname="id"><constant>V4L2_CID_RDS_TX_ENABLED</constant>&nbsp;</entry>
+	    <entry>boolean</entry>
+	  </row>
