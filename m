...
Received: from smtp-vbr6.xs4all.nl ([194.109.24.26]:4837 "EHLO
	smtp-vbr6.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1757844Ab3FTNow (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 20 Jun 2013 09:44:52 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hans.verkuil@cisco.com>
Subject: [RFCv2 PATCH 04/15] saa7134: remove dev from saa7134_fh, use saa7134_fh for empress node
Date: Thu, 20 Jun 2013 15:44:20 +0200
Message-Id: <1371735871-2658-5-git-send-email-hverkuil@xs4all.nl>
...
+	struct saa7134_dev *dev = video_drvdata(file);
 	...
 	reg->size = 1;
@@ -2030,8 +2010,7 @@ static int vidioc_g_register (struct file *file, void *priv,
...
+	struct saa7134_dev *dev = video_drvdata(file);
 	...
 	return 0;
@@ -2041,8 +2020,7 @@ static int vidioc_s_register (struct file *file, void *priv,
...
+	struct saa7134_dev *dev = video_drvdata(file);
 	...
 	if (0 != t->index)
 		return -EINVAL;
@@ -2061,8 +2039,7 @@ static int radio_g_tuner(struct file *file, void *priv,
