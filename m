...
Received: from mailout3.samsung.com ([203.254.224.33]:48991 "EHLO
	mailout3.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1754137Ab3C2QSs (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 29 Mar 2013 12:18:48 -0400
...
Subject: [PATCH v3 1/7] exynos4-is: Add Exynos4x12 FIMC-IS driver
Date: Fri, 29 Mar 2013 17:18:04 +0100
Message-id: <1364573890-31536-2-git-send-email-s.nawrocki@samsung.com>
...
Changes since v2:
 - more complete clocks handling, the clock rates are now
   configured by the driver; we don't need to rely any more
   on any clock configuration hacks at the platform level.
 - fixed issues on error path in probe(),
 - fixed couple isssues fiund with checkpatch.pl, removed
   CamelCase from fimc-is-param.[ch]
 - updated copyright notice in some files.
---
 ...
 drivers/media/platform/exynos4-is/fimc-is.c        | 1018 ++++++++++++++++++++
 drivers/media/platform/exynos4-is/fimc-is.h        |  366 +++++++
 drivers/media/platform/exynos4-is/fimc-isp.c       |  708 ++++++++++++++
