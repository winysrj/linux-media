...
Received: from moutng.kundenserver.de ([212.227.126.171]:55838 "EHLO
	moutng.kundenserver.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752529Ab1BQXYN (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 17 Feb 2011 18:24:13 -0500
Date: Fri, 18 Feb 2011 00:24:08 +0100 (CET)
...
In-Reply-To: <1297980873-18022-1-git-send-email-achew@nvidia.com>
Message-ID: <Pine.LNX.4.64.1102180022080.1841@axis700.grange>
...
This looks good now, thanks, I'll queue it for 2.6.39. Just one question:
...
Didn't you mean to say just "scaling?" You're not implementing cropping. 
You could, certainly, fake scaling with cropping, but are you really using 
both to switch between 720p and VGA? No need for a v5, just tell me how to 
change the comment.
