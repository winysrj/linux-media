...
Received: from smtp-vbr13.xs4all.nl ([194.109.24.33]:1067 "EHLO
	smtp-vbr13.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1750919AbZC3NwT (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 30 Mar 2009 09:52:19 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: Chaithrika U S <chaithrika@ti.com>
Subject: Re: [PATCH 3/4] ARM: DaVinci: DM646x Video: Add VPIF display driver
Date: Mon, 30 Mar 2009 15:52:07 +0200
Cc: linux-media@vger.kernel.org,
	davinci-linux-open-source@linux.davincidsp.com
References: <1238073752-9930-1-git-send-email-chaithrika@ti.com>
In-Reply-To: <1238073752-9930-1-git-send-email-chaithrika@ti.com>
MIME-Version: 1.0
Content-Type: text/plain;
  charset="iso-8859-15"
Content-Transfer-Encoding: 7bit
Content-Disposition: inline
Message-Id: <200903301552.07252.hverkuil@xs4all.nl>
...
Why not set it directly in the querycap function? That way everything is
in one place.
...
No need for parenthesis here. It can be removed elsewhere as well as this
...
Please fix this camelCase! It's really distracting... It should be next_frm
and cur_frm.
...
> +		memset(&(channel->vpifparams), 0, sizeof(channel->vpifparams));
> +	}
> +
> +	if (err < 0) {
> +		if (fh->initialized)
...
matches. I noticed it's checked in the s_ and g_ variants as well. That's
not needed.
...
Do these defines belong here? This is rather board specific. They also do
not seem to be used.
...
Unless this is a counting semaphore, then this should be replaced by the
