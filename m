...
Received: from mx2.suse.de ([195.135.220.15]:46006 "EHLO mx2.suse.de"
	...
	id S1752055AbcCATiA (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Tue, 1 Mar 2016 14:38:00 -0500
Date: Tue, 01 Mar 2016 20:37:52 +0100
Message-ID: <s5h7fhmt2en.wl-tiwai@suse.de>
From: Takashi Iwai <tiwai@suse.de>
To: "Shuah Khan" <shuahkh@osg.samsung.com>
Cc: <hans.verkuil@cisco.com>, <laurent.pinchart@ideasonboard.com>,
	<sakari.ailus@linux.intel.com>, <geliangtang@163.com>,
	...
	<dominic.sacre@gmx.de>, <albert@huitsing.nl>, <crope@iki.fi>,
	...
	<mchehab@osg.samsung.com>, <p.zabel@pengutronix.de>,
	<perex@perex.cz>, <stefanr@s5r6.in-berlin.de>,
	<inki.dae@samsung.com>, <j.anaszewski@samsung.com>,
	<jh1009.sung@samsung.com>, <k.kozlowski@samsung.com>,
	<kyungmin.park@samsung.com>, <m.szyprowski@samsung.com>,
	<nenggun.kim@samsung.com>, <sw0312.kim@samsung.com>,
...
In-Reply-To: <56D5C381.4060504@osg.samsung.com>
References: <1456725482-4849-1-git-send-email-shuahkh@osg.samsung.com>
	<56D5C381.4060504@osg.samsung.com>
MIME-Version: 1.0 (generated by SEMI 1.14.6 - "Maruoka")
Content-Type: text/plain; charset=US-ASCII
Sender: linux-media-owner@vger.kernel.org
List-ID: <linux-media.vger.kernel.org>

On Tue, 01 Mar 2016 17:29:53 +0100,
Shuah Khan wrote:
> 
...
Supposing you tested the different configs, feel free to take my ack
as previous one.
