...
Received: from nblzone-211-213.nblnetworks.fi ([83.145.211.213]:41244 "EHLO
        hillosipuli.retiisi.org.uk" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1750815AbeDFGvE (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Fri, 6 Apr 2018 02:51:04 -0400
Date: Fri, 6 Apr 2018 09:51:01 +0300
From: Sakari Ailus <sakari.ailus@iki.fi>
To: Matt Ranostay <matt.ranostay@konsulko.com>
Cc: linux-media@vger.kernel.org
Subject: Re: [PATCH v7 2/2] media: video-i2c: add video-i2c driver
Message-ID: <20180406065101.k5jompxrt5v5chm2@valkosipuli.retiisi.org.uk>
References: <20180406051449.32157-1-matt.ranostay@konsulko.com>
 <20180406051449.32157-3-matt.ranostay@konsulko.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20180406051449.32157-3-matt.ranostay@konsulko.com>
...
> index 000000000000..42427a724c00
> --- /dev/null
...
Over 80 characters per lines; please wrap. The same in assignment in delay
declaration above. As max_fps is constant for a given chip, you could just
...
If you want to check here (indeed it probably makes sense), then please use
dev_fwnode(&client->dev) instead. With this change, you get ACPI support
...
id is NULL if no matching chip ID was found. Could you add a check for it?
