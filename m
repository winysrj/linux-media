...
Received: from mailgw02.mediatek.com ([210.61.82.184]:55474 "EHLO
	...
	with ESMTP id S1751531AbcHAJom (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Mon, 1 Aug 2016 05:44:42 -0400
Message-ID: <1470044307.30651.18.camel@mtksdaap41>
...
Date: Mon, 1 Aug 2016 17:38:27 +0800
In-Reply-To: <32112952-6a34-ac8b-9d06-198c6c653611@xs4all.nl>
...
> 
> s/is try/tries/
> s/buffer/buffers/ (2 times)
> 
> checkpatch should complain about this comment block format ('/*' should be on
> its own line). Please run checkpatch to double check.
> 
> > + * display order.
> > + * Note the buffer return from codec driver may still in driver's reference
> 
> s/buffer return/buffers returned/
> s/still/still be/
> 
...
> 
> garbled comment. Not sure what is meant here.
> 
Will fix and refine comment in next version
...
> > +		clean_free_buffer(ctx);
> 
> Just call v4l2_m2m_job_finish(dev->m2m_dev_dec, ctx->m2m_ctx); here and return.
> 
> 
> > +	} else {
> 
> This can now have one less TAB.
> 
...
> 
> Do the 'else' part first and return there.
> 
> Then this can be shifted one TAB to the left.
> 
Will fix this in next version.
...
> 
> Actually, just invert the condition and return. The remainder can then be shifted
> one TAB to the left.
> 
Got it, will fix this in next version.
...
> > +	dev->num_instances++;
> 
> This field can be dropped since it is no longer used.
> 
...
> > @@ -197,6 +200,32 @@ struct mtk_vcodec_pm {
> >  };
> >  
> >  /**
...
> > @@ -210,9 +239,12 @@ struct mtk_vcodec_pm {
...
> > @@ -220,12 +252,16 @@ struct mtk_vcodec_pm {
...
> > @@ -240,21 +276,31 @@ struct mtk_vcodec_ctx {
...
> >  
> >  /**
> > @@ -268,25 +314,48 @@ struct mtk_vcodec_ctx {
...
> > @@ -294,8 +363,10 @@ struct mtk_vcodec_ctx {
> >   */
...
> > @@ -308,6 +379,7 @@ struct mtk_vcodec_dev {
...
> >  
> >  	int int_cond;
> > @@ -315,9 +387,11 @@ struct mtk_vcodec_dev {
...
> >  
> >  	if (!ret) {
> > @@ -52,3 +51,4 @@ int mtk_vcodec_wait_for_done_ctx(struct mtk_vcodec_ctx  *ctx, int command,
> >  	return status;
> >  }
> >  EXPORT_SYMBOL(mtk_vcodec_wait_for_done_ctx);
> > +
> > diff --git a/drivers/media/platform/mtk-vcodec/mtk_vcodec_intr.h b/drivers/media/platform/mtk-vcodec/mtk_vcodec_intr.h
> > index 33e890f..fbb8b1e 100644
...
> > index 5e36513..7617305 100644
> > --- a/drivers/media/platform/mtk-vcodec/mtk_vcodec_util.c
> > +++ b/drivers/media/platform/mtk-vcodec/mtk_vcodec_util.c
> > @@ -81,14 +81,35 @@ void mtk_vcodec_mem_free(struct mtk_vcodec_ctx *data,
> >  		return;
> >  	}
> >  
