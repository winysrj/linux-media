...
Received: from lb2-smtp-cloud6.xs4all.net ([194.109.24.28]:59378 "EHLO
	...
	by vger.kernel.org with ESMTP id S932245AbcDYMZJ (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 25 Apr 2016 08:25:09 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: dri-devel@lists.freedesktop.org, linux-samsung-soc@vger.kernel.org,
	linux-input@vger.kernel.org, lars@opdenkamp.eu,
	linux@arm.linux.org.uk, Hans Verkuil <hansverk@cisco.com>
Subject: [PATCHv15 09/15] cec: adv7604: add cec support.
Date: Mon, 25 Apr 2016 14:24:36 +0200
Message-Id: <1461587082-48041-10-git-send-email-hverkuil@xs4all.nl>
...
@@ -2441,6 +2676,11 @@ static const struct v4l2_ctrl_config adv76xx_ctrl_free_run_color = {
 	.def = 0x0,
 };
...
@@ -3220,6 +3461,18 @@ static int adv76xx_probe(struct i2c_client *client,
...
@@ -3248,6 +3501,13 @@ static int adv76xx_remove(struct i2c_client *client)
