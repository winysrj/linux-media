...
Received: from mout.gmx.net ([212.227.15.19]:58342 "EHLO mout.gmx.net"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1752542AbdJRHf7 (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Wed, 18 Oct 2017 03:35:59 -0400
Date: Wed, 18 Oct 2017 09:35:54 +0200 (CEST)
From: Guennadi Liakhovetski <g.liakhovetski@gmx.de>
To: linux-media@vger.kernel.org
cc: Laurent Pinchart <laurent.pinchart@ideasonboard.com>,
        Hans Verkuil <hverkuil@xs4all.nl>
Subject: [PATCH 4/6 v6]  uvcvideo: add a metadata device node
In-Reply-To: <1501245205-15802-5-git-send-email-g.liakhovetski@gmx.de>
Message-ID: <alpine.DEB.2.20.1710180932420.11231@axis700.grange>
References: <1501245205-15802-1-git-send-email-g.liakhovetski@gmx.de> <1501245205-15802-5-git-send-email-g.liakhovetski@gmx.de>
MIME-Version: 1.0
...
@@ -1152,8 +1219,28 @@ static void uvc_video_validate_buffer(const struct uvc_streaming *stream,
 /*
...
+			struct uvc_buffer *buf, struct uvc_buffer *meta_buf)
 {
 	u8 *mem;
 	int ret, i;
@@ -1175,14 +1262,16 @@ static void uvc_video_decode_isoc(struct urb *urb, struct uvc_streaming *stream,
...
@@ -1193,13 +1282,13 @@ static void uvc_video_decode_isoc(struct urb *urb, struct uvc_streaming *stream,
...
+			struct uvc_buffer *buf, struct uvc_buffer *meta_buf)
 {
 	u8 *mem;
 	int len, ret;
@@ -1222,8 +1311,8 @@ static void uvc_video_decode_bulk(struct urb *urb, struct uvc_streaming *stream,
 		do {
...
@@ -1233,6 +1322,8 @@ static void uvc_video_decode_bulk(struct urb *urb, struct uvc_streaming *stream,
...
@@ -1256,7 +1347,7 @@ static void uvc_video_decode_bulk(struct urb *urb, struct uvc_streaming *stream,
...
@@ -1266,7 +1357,7 @@ static void uvc_video_decode_bulk(struct urb *urb, struct uvc_streaming *stream,
 }
...
@@ -1312,7 +1403,10 @@ static void uvc_video_complete(struct urb *urb)
 {
...
@@ -1331,6 +1425,8 @@ static void uvc_video_complete(struct urb *urb)
...
@@ -1340,7 +1436,15 @@ static void uvc_video_complete(struct urb *urb)
 				       queue);
