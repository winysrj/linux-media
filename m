...
Received: from mailout3.samsung.com ([203.254.224.33]:43702 "EHLO
	...
	with ESMTP id S1751738AbbKBEnz (ORCPT
...
Received: from epcpsbgr1.samsung.com
 ...
 with ESMTP id <0NX601K3W7T19K10@mailout3.samsung.com> for
 linux-media@vger.kernel.org; Mon, 02 Nov 2015 13:43:49 +0900 (KST)
...
Subject: [RFC PATCH v8 6/6] media: videobuf2: Move vb2_fileio_data and
 vb2_thread to core part
Date: Mon, 02 Nov 2015 13:43:45 +0900
Message-id: <1446439425-13242-7-git-send-email-jh1009.sung@samsung.com>
...
@@ -732,9 +739,6 @@ int vb2_queue_init(struct vb2_queue *q)
 }
...
-
  ...
  * @q:		videobuf2 queue
@@ -745,110 +749,11 @@ static int __vb2_cleanup_fileio(struct vb2_queue *q);
  */
...
-/**
  ...
  * @q:		videobuf2 queue
  * @file:	file argument passed to the poll file operation handler
@@ -886,525 +791,6 @@ unsigned int vb2_poll(struct vb2_queue *q, struct file *file, poll_table *wait)
 }
