...
Received: from mailout1.w1.samsung.com ([210.118.77.11]:41447 "EHLO
	mailout1.w1.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751194Ab3HTQEF (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 20 Aug 2013 12:04:05 -0400
...
Subject: [PATCH v6] s5k5baf: add camera sensor driver
Date: Tue, 20 Aug 2013 18:03:39 +0200
Message-id: <1377014619-5349-1-git-send-email-a.hajda@samsung.com>
...
Thanks for the review of v5 of the patch, changes applied according
to your comments.

In this version of the patch I have also re-added changes from v4 which I
forgot to merge in v5.
...
---
 ...
 5 files changed, 2118 insertions(+)
