...
Received: from smtp-vbr6.xs4all.nl ([194.109.24.26]:2409 "EHLO
	...
	with ESMTP id S1751738AbaBNKlg (ORCPT
...
Subject: [RFCv4 PATCH 03/11] vb2: add note that buf_finish can be called with !vb2_is_streaming()
Date: Fri, 14 Feb 2014 11:41:04 +0100
Message-Id: <1392374472-18393-4-git-send-email-hverkuil@xs4all.nl>
