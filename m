...
Received: from mail-ob0-f178.google.com ([209.85.214.178]:58124 "EHLO
	mail-ob0-f178.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S932884AbbBDKED (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Wed, 4 Feb 2015 05:04:03 -0500
MIME-Version: 1.0
...
Date: Wed, 4 Feb 2015 11:03:46 +0100
Message-ID: <CAL8zT=hCUxmhWfAYaOGmyB18cK5T1E5OxergLkuw-tFOd=8_2g@mail.gmail.com>
...
Cc: Pablo Anton <pablo.anton@vodalys-labs.com>,
	...
	mchehab@osg.samsung.com, Lars-Peter Clausen <lars@metafoo.de>,
...
2015-02-04 10:55 GMT+01:00 Hans Verkuil <hverkuil@xs4all.nl>:
...
> @@ -360,15 +360,15 @@ static s32 adv_smbus_read_byte_data_check(struct i2c_client *client,
>         return -EIO;
>  }
>
...
> @@ -391,8 +391,8 @@ static s32 adv_smbus_write_byte_data(struct adv7604_state *state,
>         return err;
>  }
>
...
>  {
>         struct i2c_client *client = state->i2c_clients[page];
> @@ -411,16 +411,16 @@ static s32 adv_smbus_write_i2c_block_data(struct adv7604_state *state,
>
...
> @@ -430,73 +430,73 @@ static inline int io_write_clr_set(struct v4l2_subdev *sd, u8 reg, u8 mask, u8 v
>
...
> @@ -506,34 +506,34 @@ static inline int rep_write_clr_set(struct v4l2_subdev *sd, u8 reg, u8 mask, u8
>
...
>         unsigned int i;
>
> @@ -544,26 +544,26 @@ static void adv7604_set_hpd(struct adv7604_state *state, unsigned int hpd)
...
> @@ -573,9 +573,9 @@ static u16 hdmi_read16(struct v4l2_subdev *sd, u8 reg, u16 mask)
>
...
> @@ -585,16 +585,16 @@ static inline int hdmi_write_clr_set(struct v4l2_subdev *sd, u8 reg, u8 mask, u8
>
...
> @@ -604,9 +604,9 @@ static u16 cp_read16(struct v4l2_subdev *sd, u8 reg, u16 mask)
>
...
> @@ -616,25 +616,25 @@ static inline int cp_write_clr_set(struct v4l2_subdev *sd, u8 reg, u8 mask, u8 v
>
...
> @@ -646,9 +646,9 @@ static int adv7604_read_reg(struct v4l2_subdev *sd, unsigned int reg)
>  }
>  #endif
>
...
>
>         if (!(BIT(page) & state->info->page_mask))
> @@ -659,91 +659,91 @@ static int adv7604_write_reg(struct v4l2_subdev *sd, unsigned int reg, u8 val)
...
>         unsigned int i;
>
> @@ -759,7 +759,7 @@ adv7604_format_info(struct adv7604_state *state, u32 code)
>
...
> @@ -767,9 +767,9 @@ static inline bool is_analog_input(struct v4l2_subdev *sd)
>
...
> @@ -778,7 +778,7 @@ static inline bool is_digital_input(struct v4l2_subdev *sd)
>  /* ----------------------------------------------------------------------- */
>
>  #ifdef CONFIG_VIDEO_ADV_DEBUG
...
> @@ -795,15 +795,15 @@ static void adv7604_inv_register(struct v4l2_subdev *sd)
...
>         }
>
> @@ -813,15 +813,15 @@ static int adv7604_g_register(struct v4l2_subdev *sd,
>         return 0;
>  }
>
...
>         }
>
> @@ -846,10 +846,10 @@ static unsigned int adv7611_read_cable_det(struct v4l2_subdev *sd)
>         return value & 1;
>  }
>
...
> @@ -857,7 +857,7 @@ static int adv7604_s_detect_tx_5v_ctrl(struct v4l2_subdev *sd)
>
...
>  {
>         int i;
> @@ -878,12 +878,12 @@ static int find_and_set_predefined_video_timings(struct v4l2_subdev *sd,
...
> @@ -909,10 +909,10 @@ static int configure_predefined_video_timings(struct v4l2_subdev *sd,
...
> @@ -926,7 +926,7 @@ static int configure_predefined_video_timings(struct v4l2_subdev *sd,
...
> @@ -934,7 +934,7 @@ static void configure_custom_video_timings(struct v4l2_subdev *sd,
...
>                 0xc0 | ((width >> 8) & 0x1f),
>                 width & 0xff
> @@ -952,7 +952,7 @@ static void configure_custom_video_timings(struct v4l2_subdev *sd,
...
>
> @@ -983,9 +983,9 @@ static void configure_custom_video_timings(struct v4l2_subdev *sd,
...
>
>         if (auto_offset) {
> @@ -1004,14 +1004,14 @@ static void adv7604_set_offset(struct v4l2_subdev *sd, bool auto_offset, u16 off
...
>         u8 gain_man = 1;
>         u8 agc_mode_man = 1;
> @@ -1034,14 +1034,14 @@ static void adv7604_set_gain(struct v4l2_subdev *sd, bool auto_gain, u16 gain_a,
...
>
> @@ -1049,8 +1049,8 @@ static void set_rgb_quantization_range(struct v4l2_subdev *sd)
...
> @@ -1086,10 +1086,10 @@ static void set_rgb_quantization_range(struct v4l2_subdev *sd)
...
>                 }
>                 break;
> @@ -1119,21 +1119,21 @@ static void set_rgb_quantization_range(struct v4l2_subdev *sd)
>
...
> @@ -1153,7 +1153,7 @@ static int adv7604_s_ctrl(struct v4l2_ctrl *ctrl)
...
> @@ -1185,15 +1185,15 @@ static inline bool no_power(struct v4l2_subdev *sd)
>
...
>  }
> @@ -1205,13 +1205,13 @@ static inline bool is_hdmi(struct v4l2_subdev *sd)
>
...
>
>         /* TODO channel 2 */
> @@ -1243,9 +1243,9 @@ static inline bool no_signal(struct v4l2_subdev *sd)
>
...
> @@ -1253,7 +1253,7 @@ static inline bool no_lock_cp(struct v4l2_subdev *sd)
...
> @@ -1278,22 +1278,22 @@ static int stdi2dv_timings(struct v4l2_subdev *sd,
...
>                 }
>         }
> @@ -1319,8 +1319,8 @@ static int stdi2dv_timings(struct v4l2_subdev *sd,
>
...
> @@ -1334,7 +1334,7 @@ static int read_stdi(struct v4l2_subdev *sd, struct stdi_readback *stdi)
...
> @@ -1373,26 +1373,26 @@ static int read_stdi(struct v4l2_subdev *sd, struct stdi_readback *stdi)
>         return 0;
>  }
>
...
>                 return -EINVAL;
> @@ -1403,7 +1403,7 @@ static int adv7604_dv_timings_cap(struct v4l2_subdev *sd,
...
> @@ -1424,16 +1424,16 @@ static int adv7604_dv_timings_cap(struct v4l2_subdev *sd,
>  }
>
...
>                 }
>         }
> @@ -1471,11 +1471,11 @@ static unsigned int adv7611_read_hdmi_pixelclock(struct v4l2_subdev *sd)
...
>         struct stdi_readback stdi;
>
> @@ -1519,7 +1519,7 @@ static int adv7604_query_dv_timings(struct v4l2_subdev *sd,
...
>         int err;
>
> @@ -1606,7 +1606,7 @@ static int adv7604_s_dv_timings(struct v4l2_subdev *sd,
>                 return -ERANGE;
>         }
>
> -       adv7604_fill_optional_dv_timings_fields(sd, timings);
...
>
> @@ -1623,15 +1623,15 @@ static int adv7604_s_dv_timings(struct v4l2_subdev *sd,
>         set_rgb_quantization_range(sd);
>
>         if (debug > 1)
...
>         return 0;
> @@ -1649,7 +1649,7 @@ static void adv7611_set_termination(struct v4l2_subdev *sd, bool enable)
>
...
> @@ -1666,7 +1666,7 @@ static void enable_input(struct v4l2_subdev *sd)
>
...
> @@ -1676,11 +1676,11 @@ static void disable_input(struct v4l2_subdev *sd)
>
...
> @@ -1688,9 +1688,9 @@ static void select_input(struct v4l2_subdev *sd)
>         } else if (is_digital_input(sd)) {
...
> @@ -1705,10 +1705,10 @@ static void select_input(struct v4l2_subdev *sd)
>         }
>  }
>
...
> @@ -1730,11 +1730,11 @@ static int adv7604_s_routing(struct v4l2_subdev *sd,
>         return 0;
>  }
>
...
>                 return -EINVAL;
> @@ -1744,7 +1744,7 @@ static int adv7604_enum_mbus_code(struct v4l2_subdev *sd,
>         return 0;
>  }
>
...
> @@ -1765,7 +1765,7 @@ static void adv7604_fill_format(struct adv7604_state *state,
>   *
...
>   * ----------+-------------------------------------------------
> @@ -1776,11 +1776,11 @@ static void adv7604_fill_format(struct adv7604_state *state,
...
> @@ -1795,28 +1795,28 @@ static unsigned int adv7604_op_ch_sel(struct adv7604_state *state)
...
> @@ -1830,20 +1830,20 @@ static int adv7604_get_format(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh,
>         return 0;
>  }
>
...
>
>         if (format->which == V4L2_SUBDEV_FORMAT_TRY) {
> @@ -1853,16 +1853,16 @@ static int adv7604_set_format(struct v4l2_subdev *sd, struct v4l2_subdev_fh *fh,
...
> @@ -1890,7 +1890,7 @@ static int adv7604_isr(struct v4l2_subdev *sd, u32 status, bool *handled)
...
>                 if (handled)
>                         *handled = true;
> @@ -1909,22 +1909,22 @@ static int adv7604_isr(struct v4l2_subdev *sd, u32 status, bool *handled)
>         if (tx_5v) {
...
>         case ADV7604_PAD_HDMI_PORT_C:
>         case ADV7604_PAD_HDMI_PORT_D:
> @@ -1982,10 +1982,10 @@ static int get_edid_spa_location(const u8 *edid)
>         return -1;
>  }
>
...
>         int err;
>         int i;
> @@ -1999,7 +1999,7 @@ static int adv7604_set_edid(struct v4l2_subdev *sd, struct v4l2_edid *edid)
>         if (edid->blocks == 0) {
...
> @@ -2023,7 +2023,7 @@ static int adv7604_set_edid(struct v4l2_subdev *sd, struct v4l2_edid *edid)
>
>         /* Disable hotplug and I2C access to EDID RAM from DDC port */
...
> @@ -2031,7 +2031,7 @@ static int adv7604_set_edid(struct v4l2_subdev *sd, struct v4l2_edid *edid)
...
>                 break;
> @@ -2074,7 +2074,7 @@ static int adv7604_set_edid(struct v4l2_subdev *sd, struct v4l2_edid *edid)
>                 return err;
>         }
>
...
>         rep_write_clr_set(sd, info->edid_enable_reg, 0x0f, state->edid.present);
>
> @@ -2138,10 +2138,10 @@ static void print_avi_infoframe(struct v4l2_subdev *sd)
...
> @@ -2213,7 +2213,7 @@ static int adv7604_log_status(struct v4l2_subdev *sd)
...
> @@ -2279,47 +2279,47 @@ static int adv7604_log_status(struct v4l2_subdev *sd)
>
>  /* ----------------------------------------------------------------------- */
>
...
> @@ -2329,8 +2329,8 @@ static const struct v4l2_ctrl_config adv7604_ctrl_analog_sampling_phase = {
>         .def = 0,
>  };
>
...
> @@ -2340,8 +2340,8 @@ static const struct v4l2_ctrl_config adv7604_ctrl_free_run_color_manual = {
>         .def = false,
>  };
>
...
>         .type = V4L2_CTRL_TYPE_INTEGER,
> @@ -2353,11 +2353,11 @@ static const struct v4l2_ctrl_config adv7604_ctrl_free_run_color = {
>
>  /* ----------------------------------------------------------------------- */
>
...
> @@ -2385,7 +2385,7 @@ static int adv7604_core_init(struct v4l2_subdev *sd)
...
>
> @@ -2415,7 +2415,7 @@ static int adv7604_core_init(struct v4l2_subdev *sd)
...
>         }
> @@ -2440,7 +2440,7 @@ static void adv7611_setup_irqs(struct v4l2_subdev *sd)
...
>         unsigned int i;
>
> @@ -2450,7 +2450,7 @@ static void adv7604_unregister_clients(struct adv7604_state *state)
>         }
>  }
>
...
> @@ -2460,74 +2460,74 @@ static struct i2c_client *adv7604_dummy_client(struct v4l2_subdev *sd,
...
>                 .type = ADV7604,
>                 .has_afe = true,
> @@ -2553,18 +2553,18 @@ static const struct adv7604_chip_info adv7604_chip_info[] = {
...
> @@ -2584,34 +2584,34 @@ static const struct adv7604_chip_info adv7604_chip_info[] = {
...
> @@ -2638,20 +2638,20 @@ static int adv7604_parse_dt(struct adv7604_state *state)
>         }
>
...
> @@ -2666,12 +2666,12 @@ static int adv7604_parse_dt(struct adv7604_state *state)
>         return 0;
>  }
>
...
>         struct v4l2_subdev *sd;
>         unsigned int i;
> @@ -2681,16 +2681,16 @@ static int adv7604_probe(struct i2c_client *client,
...
> @@ -2699,18 +2699,18 @@ static int adv7604_probe(struct i2c_client *client,
...
> @@ -2730,10 +2730,10 @@ static int adv7604_probe(struct i2c_client *client,
>         }
>
...
>                 client->addr);
> @@ -2763,15 +2763,15 @@ static int adv7604_probe(struct i2c_client *client,
>
>         /* control handlers */
>         hdl = &state->hdl;
...
>
>         /* private controls */
> @@ -2779,18 +2779,18 @@ static int adv7604_probe(struct i2c_client *client,
...
>         sd->ctrl_handler = hdl;
>         if (hdl->error) {
> @@ -2799,22 +2799,22 @@ static int adv7604_probe(struct i2c_client *client,
>         }
...
>                         err = -ENOMEM;
> @@ -2832,7 +2832,7 @@ static int adv7604_probe(struct i2c_client *client,
>         }
>
