...
Received: from mail01d.mail.t-online.hu ([84.2.42.6]:53094 "EHLO
	mail01d.mail.t-online.hu" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S933389AbZJaXRi (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sat, 31 Oct 2009 19:17:38 -0400
Message-ID: <4AECC56C.6090107@freemail.hu>
Date: Sun, 01 Nov 2009 00:17:00 +0100
...
Subject: [PATCH 20/21] gspca pac7302/pac7311: separate the two subdrivers
...
--- t/drivers/media/video/gspca/Kconfig	2009-10-23 07:07:59.000000000 +0200
+++ u/drivers/media/video/gspca/Kconfig	2009-10-31 10:08:10.000000000 +0100
@@ -103,6 +103,15 @@ config USB_GSPCA_PAC207
...
--- t/drivers/media/video/gspca/Makefile	2009-10-23 07:07:59.000000000 +0200
+++ u/drivers/media/video/gspca/Makefile	2009-10-31 10:17:05.000000000 +0100
...
@@ -37,6 +38,7 @@ gspca_mr97310a-objs := mr97310a.o
...
+++ u/drivers/media/video/gspca/pac7302.c	2009-10-31 15:24:50.000000000 +0100
@@ -0,0 +1,977 @@
+/*
...
+++ u/drivers/media/video/gspca/pac7311.c	2009-10-31 10:15:12.000000000 +0100
...
-
 ...
 static struct sd_desc pac7311_sd_desc = {
 	.name = MODULE_NAME,
@@ -1492,21 +796,12 @@ static struct sd_desc pac7311_sd_desc =
...
-	{USB_DEVICE(0x093a, 0x262c), .driver_info = SENSOR_PAC7302},
 ...
 MODULE_DEVICE_TABLE(usb, device_table);
@@ -1515,12 +810,8 @@ MODULE_DEVICE_TABLE(usb, device_table);
 static int sd_probe(struct usb_interface *intf,
 			const struct usb_device_id *id)
 {
