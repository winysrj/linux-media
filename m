...
Received: from mailout1.w1.samsung.com ([210.118.77.11]:21738 "EHLO
        ...
        with ESMTP id S1752707AbdBTNjR (ORCPT
...
Subject: [PATCH v2 09/15] media: s5p-mfc: Allocate firmware with internal
 private buffer alloc function
Date: Mon, 20 Feb 2017 14:38:58 +0100
Message-id: <1487597944-2000-10-git-send-email-m.szyprowski@samsung.com>
...
References: <1487597944-2000-1-git-send-email-m.szyprowski@samsung.com>
 <CGME20170220133914eucas1p1d45c1e88319669e3c63b1b3626b1b519@eucas1p1.samsung.com>
