...
Received: from mail-db3on0108.outbound.protection.outlook.com ([157.55.234.108]:2593
	...
	id S1751206AbcDTPeC (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Wed, 20 Apr 2016 11:34:02 -0400
...
Subject: [PATCH v7 00/24] i2c mux cleanup and locking update
Date: Wed, 20 Apr 2016 17:17:40 +0200
Message-ID: <1461165484-2314-1-git-send-email-peda@axentia.se>
MIME-Version: 1.0
...
for you to fetch changes up to f725ef789ff0eb2663f1cff2b29d8196a7f0fd0b:
  ...
  [media] rtl2832: regmap is aware of lockdep, drop local locking hack (2016-04-20 14:49:00 +0200)
---------------------
...
Peter Rosin (23):
 ...
 drivers/iio/imu/inv_mpu6050/inv_mpu_i2c.c    |  81 ++----
