...
Received: from mga02.intel.com ([134.134.136.20]:3512 "EHLO mga02.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1752402AbeAZI4x (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Fri, 26 Jan 2018 03:56:53 -0500
Date: Fri, 26 Jan 2018 10:56:50 +0200
From: Sakari Ailus <sakari.ailus@linux.intel.com>
To: Andy Yeh <andy.yeh@intel.com>
Cc: linux-media@vger.kernel.org, tfiga@chromium.org,
        Alan Chiang <alanx.chiang@intel.com>
Subject: Re: [PATCH v3] media: dw9807: Add dw9807 vcm driver
Message-ID: <20180126085649.j4i6zr4hbww3jx3o@paasikivi.fi.intel.com>
References: <1516901932-22636-1-git-send-email-andy.yeh@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <1516901932-22636-1-git-send-email-andy.yeh@intel.com>
...
You could use v4l2_get_subdevdata on the sub-device to obtain the client,
just as the dw9714 driver does.
...
You only use this once. How about simply using container_of() there
instead?
...
It's usually best to declare temporary and loop variables as last,
typically this leads to shorter declarations being last.
...
The name of the function suggests a generic write command but it's actually
about setting the coil current. How about reflecting that in the function
name?
...
I wonder how common it is that you'll end up here. That'd likely be
troublesome for the AF control. Ideally a read-only control would tell you
this, but that could well be added later on.
...
Not needed. If you've been given the same comment on a similar driver, you
should apply it elsewhere.
