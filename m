...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id 33851C67839
	for <linux-media@archiver.kernel.org>; Fri, 14 Dec 2018 10:45:04 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id C943920892
	for <linux-media@archiver.kernel.org>; Fri, 14 Dec 2018 10:45:03 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=default; t=1544784304;
	bh=oEwNxlPT92XlzplVOZbmuzIWPNaMjiOkmhPSh6Q0PZo=;
	h=Date:From:To:Cc:Subject:In-Reply-To:References:List-ID:From;
	b=2q7nCkjOiVcaShYWTAMaVm0gFZ+8C1JghbbBu9xA0BDu7yxYaP9liko61z2VmAgDC
	 2z2yRkmEmU+aqTnAK9NPS0OzCVpCVdHNzJlz6sE8zoZEMUIE5mWdWgIC47/g8jR3KC
	 6RnM4EB+kUObMGx4O4+Y8zn8jb2Hgi36QzABiEfM=
DMARC-Filter: OpenDMARC Filter v1.3.2 mail.kernel.org C943920892
Authentication-Results: mail.kernel.org; dmarc=fail (p=none dis=none) header.from=kernel.org
Authentication-Results: mail.kernel.org; spf=none smtp.mailfrom=linux-media-owner@vger.kernel.org
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726604AbeLNKpD (ORCPT <rfc822;linux-media@archiver.kernel.org>);
        Fri, 14 Dec 2018 05:45:03 -0500
Received: from casper.infradead.org ([85.118.1.10]:59500 "EHLO
        casper.infradead.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726344AbeLNKpC (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Fri, 14 Dec 2018 05:45:02 -0500
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        ...
        bh=HZunfzzZtBC1cdtzswvvCz9svTYZkJOoqZqIKPC77v8=; b=ZMSj1TmxAR6kgpq6l0QNLX9BdA
        ;
Received: from 177.43.150.95.dynamic.adsl.gvt.net.br ([177.43.150.95] helo=coco.lan)
        by casper.infradead.org with esmtpsa (Exim 4.90_1 #2 (Red Hat Linux))
        id 1gXkxm-0002cr-LM; Fri, 14 Dec 2018 10:44:59 +0000
Date:   Fri, 14 Dec 2018 08:44:53 -0200
...
Subject: Re: [PATCH v9 13/22] media: staging/intel-ipu3: Add v4l2 driver
 based on media framework
Message-ID: <20181214084453.5e169617@coco.lan>
In-Reply-To: <20181213095107.14894-14-sakari.ailus@linux.intel.com>
References: <20181213095107.14894-1-sakari.ailus@linux.intel.com>
        <20181213095107.14894-14-sakari.ailus@linux.intel.com>
...
Em Thu, 13 Dec 2018 11:50:58 +0200
...
> index 0000000000000..038ee749cb75c
> --- /dev/null
...
Please don't do that! a goto to something inside a loop is very
weird...

I'm not even sure if C spec allows that (or if it would do what
you think it does). Instead, do something like:
...
and ensure that this would do the right thing  - either by adding
some checks inside the loop or by doing some undo logic before
calling goto. E. g. something like:
...
As the driver is merged for staging, I'll apply it (as we can accept
bad code there), but please send a fix for it as soon as possible.
