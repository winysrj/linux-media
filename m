...
Received: from ams-iport-3.cisco.com ([144.254.224.146]:8406 "EHLO
	ams-iport-3.cisco.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751792Ab3E0I5y (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 27 May 2013 04:57:54 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: Sergei Shtylyov <sergei.shtylyov@cogentembedded.com>
Subject: Re: [PATCH v5] V4L2: I2C: ML86V7667 video decoder driver
Date: Mon, 27 May 2013 10:57:29 +0200
...
References: <201305240007.32769.sergei.shtylyov@cogentembedded.com>
In-Reply-To: <201305240007.32769.sergei.shtylyov@cogentembedded.com>
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="iso-8859-1"
Content-Transfer-Encoding: 7bit
Message-Id: <201305271057.29434.hverkuil@xs4all.nl>
...
Since this function is used for set/get and try I recommend renaming
it to ml86v7667_mbus_fmt.
...
This test is no longer necessary so you can drop it.
...
> +	.g_mbus_fmt = ml86v7667_try_mbus_fmt,
> +	.s_mbus_fmt = ml86v7667_try_mbus_fmt,
