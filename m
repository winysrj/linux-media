...
Received: from bear.ext.ti.com ([192.94.94.41]:42183 "EHLO bear.ext.ti.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1752875Ab1KLNTN (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Sat, 12 Nov 2011 08:19:13 -0500
Received: from dbdp20.itg.ti.com ([172.24.170.38])
	by bear.ext.ti.com (8.13.7/8.13.7) with ESMTP id pACDJ9DF007567
...
Subject: [RFC PATCH v4 2/8] davinci: vpfe: add IPIPE hardware layer support
Date: Sat, 12 Nov 2011 18:48:56 +0530
Message-ID: <1321103942-2778-3-git-send-email-manjunath.hadli@ti.com>
...
+			 * of IPIPE
+			 */
+			val = config->ipipe_colpat_elep << COLPAT_EE_SHIFT;
+			val |= config->ipipe_colpat_elop << COLPAT_EO_SHIFT;
+			val |= config->ipipe_colpat_olep << COLPAT_OE_SHIFT;
+			val |= config->ipipe_colpat_olop << COLPAT_OO_SHIFT;
