...
Received: from mx07-00178001.pphosted.com ([62.209.51.94]:62992 "EHLO
        mx07-00178001.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S2997142AbdD1N3U (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Fri, 28 Apr 2017 09:29:20 -0400
From: Hugues Fruchet <hugues.fruchet@st.com>
To: <linux-media@vger.kernel.org>, Hans Verkuil <hverkuil@xs4all.nl>
CC: Benjamin Gaignard <benjamin.gaignard@linaro.org>,
        Hugues Fruchet <hugues.fruchet@st.com>,
        Jean-Christophe Trotin <jean-christophe.trotin@st.com>
Subject: [PATCH v6 2/3] [media] st-delta: add parsing metadata controls support
Date: Fri, 28 Apr 2017 15:25:48 +0200
Message-ID: <1493385949-2962-3-git-send-email-hugues.fruchet@st.com>
...
+	v4l2_ctrl_handler_free(&ctx->ctrl_handler);
 err_fh_del:
 	v4l2_fh_del(&ctx->fh);
 	v4l2_fh_exit(&ctx->fh);
@@ -1732,6 +1852,8 @@ static int delta_release(struct file *file)
...
@@ -1887,6 +2009,9 @@ static int delta_probe(struct platform_device *pdev)
