...
Received: from mail-wr0-f195.google.com ([209.85.128.195]:36851 "EHLO
        mail-wr0-f195.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1753683AbdG2L3A (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Sat, 29 Jul 2017 07:29:00 -0400
Received: by mail-wr0-f195.google.com with SMTP id y67so27403640wrb.3
...
Subject: [PATCH v2 03/14] [media] ddbridge: bump ddbridge code to version 0.9.29
Date: Sat, 29 Jul 2017 13:28:37 +0200
Message-Id: <20170729112848.707-4-d.scheller.oss@gmail.com>
...
@@ -1773,7 +3021,7 @@ static int ddb_open(struct inode *inode, struct file *file)
...
+	__user void *parg = (__user void *) arg;
 	...
 	switch (cmd) {
@@ -1784,24 +3032,175 @@ static long ddb_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
...
@@ -1811,6 +3210,7 @@ static long ddb_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
...
@@ -1820,43 +3220,665 @@ static char *ddb_devnode(struct device *device, umode_t *mode)
...
index 41c0adc176b1..dde938ad1247 100644
...
index 4290a1e28531..ab6364ae0711 100644
...
@@ -239,5 +430,6 @@ int ddb_ports_attach(struct ddb *dev);
 int ddb_device_create(struct ddb *dev);
 int ddb_class_create(void);
 void ddb_class_destroy(void);
+int ddb_init(struct ddb *dev);
