...
Received: from lb1-smtp-cloud6.xs4all.net ([194.109.24.24]:53374 "EHLO
	lb1-smtp-cloud6.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1751403AbbGQMYE (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 17 Jul 2015 08:24:04 -0400
Message-ID: <55A8F3A6.5030000@xs4all.nl>
Date: Fri, 17 Jul 2015 14:23:02 +0200
...
References: <1437130692-8256-1-git-send-email-p.zabel@pengutronix.de> <1437130692-8256-3-git-send-email-p.zabel@pengutronix.de>
In-Reply-To: <1437130692-8256-3-git-send-email-p.zabel@pengutronix.de>
...
>  
> @@ -1638,6 +1645,137 @@ static const struct v4l2_ctrl_config tc358743_ctrl_audio_present = {
>  
>  /* --------------- PROBE / REMOVE --------------- */
>  
> +#if CONFIG_OF
