...
Received: from galahad.ideasonboard.com ([185.26.127.97]:40282 "EHLO
	...
	with ESMTP id S1752233AbcCXX2g (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 24 Mar 2016 19:28:36 -0400
From: Laurent Pinchart <laurent.pinchart+renesas@ideasonboard.com>
To: linux-media@vger.kernel.org
Cc: linux-renesas-soc@vger.kernel.org
Subject: [PATCH 51/51] v4l: vsp1: Add Z-order support for DRM pipeline
Date: Fri, 25 Mar 2016 01:27:47 +0200
Message-Id: <1458862067-19525-52-git-send-email-laurent.pinchart+renesas@ideasonboard.com>
...
index 7cde2d970dba..6c4236b4ce7e 100644
...
+int vsp1_du_atomic_update_zpos(struct device *dev, unsigned int rpf_index,
+			       u32 pixelformat, unsigned int pitch,
+			       dma_addr_t mem[2], const struct v4l2_rect *src,
...
+	return 0;
+}
+EXPORT_SYMBOL_GPL(vsp1_du_atomic_update_zpos);
+
...
index d01f7cb8f691..45e92a210461 100644
...
-			  const struct v4l2_rect *dst);
+int vsp1_du_atomic_update_zpos(struct device *dev, unsigned int rpf,
+			       u32 pixelformat, unsigned int pitch,
+			       dma_addr_t mem[2], const struct v4l2_rect *src,
+			       const struct v4l2_rect *dst, unsigned int zpos);
...
+					const struct v4l2_rect *dst)
+{
+	return vsp1_du_atomic_update_zpos(dev, rpf_index, pixelformat, pitch,
+					  mem, src, dst, 0);
+}
+
