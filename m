...
Received: from comal.ext.ti.com ([198.47.26.152]:35451 "EHLO comal.ext.ti.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1753425Ab0ADODQ (ORCPT <rfc822;linux-media@vger.kernel.org>);
...
Subject: [PATCH 7/9] DM644x CCDC : Add Suspend/Resume Support
Date: Mon,  4 Jan 2010 19:33:00 +0530
Message-Id: <1262613782-20463-8-git-send-email-hvaibhav@ti.com>
...
+
 ...
 {
@@ -835,6 +838,87 @@ static int ccdc_set_hw_if_params(struct vpfe_hw_if_param *params)
 	return 0;
 }
...
+}
 static struct ccdc_hw_device ccdc_hw_dev = {
 	.name = "DM6446 CCDC",
 	.owner = THIS_MODULE,
@@ -943,10 +1027,40 @@ static int dm644x_ccdc_remove(struct platform_device *pdev)
 	return 0;
 }
