...
Received: from moutng.kundenserver.de ([212.227.126.187]:58509 "EHLO
	...
	with ESMTP id S934583Ab3DHLHe (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Mon, 8 Apr 2013 07:07:34 -0400
...
Subject: [PATCH v7 3/7] media: soc-camera: switch I2C subdevice drivers to use v4l2-clk
Date: Mon,  8 Apr 2013 13:07:07 +0200
Message-Id: <1365419231-14830-4-git-send-email-g.liakhovetski@gmx.de>
