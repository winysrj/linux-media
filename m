...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id DE3B9C7112F
	for <linux-media@archiver.kernel.org>; Mon, 21 Jan 2019 11:29:32 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id 8ABBE20663
	for <linux-media@archiver.kernel.org>; Mon, 21 Jan 2019 11:29:32 +0000 (UTC)
Authentication-Results: mail.kernel.org;
	dkim=fail reason="key not found in DNS" (0-bit key) header.d=codeaurora.org header.i=@codeaurora.org header.b="N/GXIy5W";
	dkim=fail reason="key not found in DNS" (0-bit key) header.d=codeaurora.org header.i=@codeaurora.org header.b="bCOrWn+R"
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728062AbfAUL3U (ORCPT <rfc822;linux-media@archiver.kernel.org>);
        Mon, 21 Jan 2019 06:29:20 -0500
Received: from smtp.codeaurora.org ([198.145.29.96]:52674 "EHLO
        smtp.codeaurora.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727665AbfAUL3U (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Mon, 21 Jan 2019 06:29:20 -0500
Received: by smtp.codeaurora.org (Postfix, from userid 1000)
        id E73DA608CF; Mon, 21 Jan 2019 11:29:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=codeaurora.org;
        s=default; t=1548070158;
        bh=5BNA2rDchIHLC2Le4PVPk7n7bOF+tsO7J/RqZnRYSXQ=;
        h=Date:From:To:Cc:Subject:In-Reply-To:References:From;
        b=N/GXIy5WfYeJvtZ6RtWfMbJSToXGuRuOLEsMr/Fz3Jx+7KVD89Y1hAMhtM9f7l0Sy
         t0d//ceSEUdVDqaNBG5rT1NpQRAJsObf7BQR5WPzi9jUvzCp3Trf9hlH4DUhtUZZRP
         PTUx4Qpwvj3iRJTc/ELhYG6+ShtOn6hgoKzdHDE4=
Received: from mail.codeaurora.org (localhost.localdomain [127.0.0.1])
        by smtp.codeaurora.org (Postfix) with ESMTP id 70AAB6085C;
        Mon, 21 Jan 2019 11:29:11 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=codeaurora.org;
        s=default; t=1548070152;
        bh=5BNA2rDchIHLC2Le4PVPk7n7bOF+tsO7J/RqZnRYSXQ=;
        h=Date:From:To:Cc:Subject:In-Reply-To:References:From;
        b=bCOrWn+R85fhLctd6K98KwIe/8d0qsjv1X/ImvQ1MjFie5TsPY7rLM0+izFHSU3D6
         kAE82K0jqEvX00IWht2YTUI29Vv9oWAi2QsVslRtOW2RwaYFeXlvvp/OGCPDwPzbbG
         +EPhXN1GY28J1LVitHFZVyErxKlkWPCVTwfEMcC8=
MIME-Version: 1.0
Content-Type: text/plain; charset=UTF-8;
 format=flowed
Content-Transfer-Encoding: 8bit
Date:   Mon, 21 Jan 2019 16:59:11 +0530
...
Message-ID: <0fc547f46d2ff90a2a8adf957cca7297@codeaurora.org>
...
On 2019-01-21 16:50, mgottam@codeaurora.org wrote:
...
Adding to the above comment, I could say that with this patch, VEA 
unittests passes.
