...
Received: from mailout2.w1.samsung.com ([210.118.77.12]:50001 "EHLO
	...
	with ESMTP id S1753351Ab1ITL7J (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 20 Sep 2011 07:59:09 -0400
Received: from euspt2 (mailout2.w1.samsung.com [210.118.77.12])
 by mailout2.w1.samsung.com
 (iPlanet Messaging Server 5.2 Patch 2 (built Jul 14 2004))
 with ESMTP id <0LRT00BTLLAFJW@mailout2.w1.samsung.com> for
 linux-media@vger.kernel.org; Tue, 20 Sep 2011 12:59:03 +0100 (BST)
Received: from linux.samsung.com ([106.116.38.10])
 by spt2.w1.samsung.com (iPlanet Messaging Server 5.2 Patch 2 (built Jul 14
 2004)) with ESMTPA id <0LRT00937LAF7S@spt2.w1.samsung.com> for
 linux-media@vger.kernel.org; Tue, 20 Sep 2011 12:59:03 +0100 (BST)
Date: Tue, 20 Sep 2011 13:58:59 +0200
From: Sylwester Nawrocki <s.nawrocki@samsung.com>
Subject: [PATCH v1 3/3] v4l: Add v4l2 subdev driver for S5K6AAFX sensor
...
Message-id: <1316519939-22540-4-git-send-email-s.nawrocki@samsung.com>
MIME-version: 1.0
...
index 9da6044..cd737a3 100644
--- a/drivers/media/video/Kconfig
+++ b/drivers/media/video/Kconfig
@@ -496,6 +496,12 @@ config VIDEO_TCM825X
...
+
+	ret = s5k6aa_set_output_framefmt(s5k6aa, preset, false);
+	if (!ret)
