...
Received: from down.free-electrons.com ([37.187.137.238]:53100 "EHLO
	mail.free-electrons.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
	with ESMTP id S1751191AbbD3PaV (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 30 Apr 2015 11:30:21 -0400
...
Date: Thu, 30 Apr 2015 17:30:08 +0200
Message-Id: <1430407809-31147-2-git-send-email-boris.brezillon@free-electrons.com>
In-Reply-To: <1430407809-31147-1-git-send-email-boris.brezillon@free-electrons.com>
...
CC: rtc-linux@googlegroups.com
 ...
 74 files changed, 659 insertions(+), 469 deletions(-)
...
index 0b7c3e8..08a2ee2 100644
--- a/drivers/clk/at91/clk-usb.c
+++ b/drivers/clk/at91/clk-usb.c
@@ -269,8 +269,9 @@ static unsigned long at91rm9200_clk_usb_recalc_rate(struct clk_hw *hw,
 	return 0;
 }
...
@@ -286,13 +287,13 @@ static long at91rm9200_clk_usb_round_rate(struct clk_hw *hw, unsigned long rate,
 		if (!usb->divisors[i])
 			continue;
...
+			tmpdiff = tmprate - *rate;
 		...
 		if (bestdiff < 0 || bestdiff > tmpdiff) {
 			bestrate = tmprate;
@@ -304,7 +305,8 @@ static long at91rm9200_clk_usb_round_rate(struct clk_hw *hw, unsigned long rate,
 			break;
 	}
...
@@ -1614,7 +1617,7 @@ static struct clk_core *clk_calc_new_rates(struct clk_core *clk,
...
+	unsigned long new_rate = rate;
 	...
 	int p_index = 0;
@@ -1645,12 +1648,11 @@ static struct clk_core *clk_calc_new_rates(struct clk_core *clk,
 		new_rate = ret;
 		parent = parent_hw ? parent_hw->core : NULL;
 	} else if (clk->ops->round_rate) {
-		ret = clk->ops->round_rate(clk->hw, rate,
+		ret = clk->ops->round_rate(clk->hw, &new_rate,
 					   &best_parent_rate);
 		if (ret < 0)
 			return NULL;
...
@@ -1273,12 +1281,13 @@ static unsigned long clk_pllre_recalc_rate(struct clk_hw *hw,
 	return rate;
 }
