...
Received: from ns.mm-sol.com ([37.157.136.199]:56040 "EHLO extserv.mm-sol.com"
        ...
        id S1750907AbdFSO4o (ORCPT <rfc822;linux-media@vger.kernel.org>);
...
Subject: [PATCH v2 06/19] media: camss: Add ISPIF files
Date: Mon, 19 Jun 2017 17:48:26 +0300
Message-Id: <1497883719-12410-7-git-send-email-todor.tomov@linaro.org>
