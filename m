...
Received: from mail-sn1nam01on0077.outbound.protection.outlook.com ([104.47.32.77]:11520
        "EHLO NAM01-SN1-obe.outbound.protection.outlook.com"
        rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org with ESMTP
        id S1754808AbeBOGmv (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Thu, 15 Feb 2018 01:42:51 -0500
From: Satish Kumar Nagireddy <satish.nagireddy.nagireddy@xilinx.com>
To: <linux-media@vger.kernel.org>, <laurent.pinchart@ideasonboard.com>,
        <michal.simek@xilinx.com>, <hyun.kwon@xilinx.com>
CC: Satish Kumar Nagireddy <satishna@xilinx.com>
Subject: [PATCH v3 7/9] v4l: xilinx: dma: Add multi-planar support
Date: Wed, 14 Feb 2018 22:42:43 -0800
Message-ID: <1518676963-19660-1-git-send-email-satishna@xilinx.com>
MIME-Version: 1.0
...
@@ -553,40 +681,91 @@ __xvip_dma_try_format(struct xvip_dma *dma, struct v4=
l2_pix_format *pix,
        unsigned int width;
        unsigned int align;
        unsigned int bpl;
...
+       if (V4L2_TYPE_IS_MULTIPLANAR(dma->format.type))
+           info =3D xvip_get_format_by_fourcc(format->fmt.pix_mp.pixelform=
at);
+       else
+           info =3D xvip_get_format_by_fourcc(format->fmt.pix.pixelformat)=
;
+
        if (IS_ERR(info))
...
@@ -609,12 +788,16 @@ xvip_dma_set_format(struct file *file, void *fh, stru=
ct v4l2_format *format)
        struct xvip_dma *dma =3D to_xvip_dma(vfh->vdev);
        const struct xvip_video_format *info;
...
+
        ...
        return 0;
@@ -623,11 +806,15 @@ xvip_dma_set_format(struct file *file, void *fh, stru=
ct v4l2_format *format)
...
@@ -661,6 +848,7 @@ int xvip_dma_init(struct xvip_composite_device *xdev, s=
truct xvip_dma *dma,
 {
        char name[16];
        int ret;
