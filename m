...
Received: from mail-pf0-f195.google.com ([209.85.192.195]:52680 "EHLO
        mail-pf0-f195.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1751830AbdJ1UlN (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Sat, 28 Oct 2017 16:41:13 -0400
...
Subject: [PATCH 6/9] media: staging/imx: remove static subdev arrays
Date: Sat, 28 Oct 2017 13:36:46 -0700
Message-Id: <1509223009-6392-7-git-send-email-steve_longerbeam@mentor.com>
...
---
 ...
 drivers/staging/media/imx/imx-media-dev.c         | 216 ++++++++++++----------
 ...
 7 files changed, 218 insertions(+), 217 deletions(-)
...
-	struct imx_media_subdev *imxsd;
 	...
 	struct v4l2_subdev *sd;
@@ -250,11 +239,18 @@ static int imx_media_add_vdev_to_pad(struct imx_media_dev *imxmd,
 		return 0;
...
@@ -293,6 +289,27 @@ static int imx_media_add_vdev_to_pad(struct imx_media_dev *imxmd,
 	return 0;
 }
...
+
 ...
 {
@@ -300,6 +317,10 @@ static int imx_media_create_pad_vdev_lists(struct imx_media_dev *imxmd)
 	struct media_link *link;
 	int i, ret;
...
@@ -316,20 +337,11 @@ static int imx_media_create_pad_vdev_lists(struct imx_media_dev *imxmd)
...
@@ -393,7 +405,6 @@ static int imx_media_link_notify(struct media_link *link, u32 flags,
...
@@ -413,10 +424,11 @@ static int imx_media_link_notify(struct media_link *link, u32 flags,
...
@@ -460,8 +472,10 @@ static int imx_media_probe(struct platform_device *pdev)
 {
...
+	int num_subdevs, i, ret;
 	...
 	if (!imxmd)
@@ -490,6 +504,8 @@ static int imx_media_probe(struct platform_device *pdev)
...
@@ -504,15 +520,27 @@ static int imx_media_probe(struct platform_device *pdev)
 		goto unreg_dev;
 	}
