...
Received: from smtp-vbr1.xs4all.nl ([194.109.24.21]:3947 "EHLO
	...
	with ESMTP id S1756758AbZCYH0g (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 25 Mar 2009 03:26:36 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: davinci-linux-open-source@linux.davincidsp.com
Subject: Re: [PATCH v2] v4l2-subdev: THS7303 video amplifier driver
Date: Wed, 25 Mar 2009 08:26:52 +0100
Cc: Chaithrika U S <chaithrika@ti.com>, linux-media@vger.kernel.org
References: <1237902021-12983-1-git-send-email-chaithrika@ti.com>
In-Reply-To: <1237902021-12983-1-git-send-email-chaithrika@ti.com>
MIME-Version: 1.0
Content-Type: text/plain;
  charset="iso-8859-15"
Content-Transfer-Encoding: 7bit
Content-Disposition: inline
Message-Id: <200903250826.52845.hverkuil@xs4all.nl>
Sender: linux-media-owner@vger.kernel.org
List-ID: <linux-media.vger.kernel.org>

On Tuesday 24 March 2009 14:40:21 Chaithrika U S wrote:
...
> +}
> +
> +static int ths7303_s_std_output(struct v4l2_subdev *sd, v4l2_std_id
> norm) +{
