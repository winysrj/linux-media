...
Received: from lb1-smtp-cloud6.xs4all.net ([194.109.24.24]:35124 "EHLO
	lb1-smtp-cloud6.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1752066AbbBPOMS (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 16 Feb 2015 09:12:18 -0500
Message-ID: <54E1FAAE.2000307@xs4all.nl>
Date: Mon, 16 Feb 2015 15:11:58 +0100
...
Subject: Re: [PATCH] media: vivid test device: Add NV{12,21} and Y{U,V}12
 pixel format.
References: <CAPUS084EM0QMVapYxt8pDOn7=M+JK0BQMwufXsH94vD+bMDMgw@mail.gmail.com>
In-Reply-To: <CAPUS084EM0QMVapYxt8pDOn7=M+JK0BQMwufXsH94vD+bMDMgw@mail.gmail.com>
