...
Received: from mailout3.samsung.com ([203.254.224.33]:55489 "EHLO
	mailout3.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S932661Ab2JCRGS (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Wed, 3 Oct 2012 13:06:18 -0400
Received: from epcpsbgm2.samsung.com (epcpsbgm2 [203.254.230.27])
 by mailout3.samsung.com
 (Oracle Communications Messaging Server 7u4-24.01(7.0.4.24.0) 64bit (built Nov
 17 2011)) with ESMTP id <0MBB00HDPU6GCS40@mailout3.samsung.com> for
 linux-media@vger.kernel.org; Thu, 04 Oct 2012 02:06:16 +0900 (KST)
Received: from localhost.localdomain ([107.108.73.106])
 by mmp2.samsung.com (Oracle Communications Messaging Server 7u4-24.01
 (7.0.4.24.0) 64bit (built Nov 17 2011))
 with ESMTPA id <0MBB009RUU5VQI80@mmp2.samsung.com> for
 linux-media@vger.kernel.org; Thu, 04 Oct 2012 02:06:15 +0900 (KST)
From: Arun Kumar K <arun.kk@samsung.com>
To: linux-media@vger.kernel.org
Cc: k.debski@samsung.com, s.nawrocki@samsung.com, arun.kk@samsung.com,
	joshi@samsung.com
Subject: [PATCH v10 3/7] [media] s5p-mfc: Prepare driver for callback based
 re-architecture
Date: Thu, 04 Oct 2012 06:49:07 +0530
Message-id: <1349313551-23368-4-git-send-email-arun.kk@samsung.com>
...
---
 drivers/media/platform/s5p-mfc/Makefile         |    6 +-
 ...
 drivers/media/platform/s5p-mfc/s5p_mfc_cmd_v5.c |  120 ++
 drivers/media/platform/s5p-mfc/s5p_mfc_cmd_v5.h |   30 +
 drivers/media/platform/s5p-mfc/s5p_mfc_ctrl.c   |    2 +-
 drivers/media/platform/s5p-mfc/s5p_mfc_dec.c    |    7 +-
 drivers/media/platform/s5p-mfc/s5p_mfc_enc.c    |    2 +-
 drivers/media/platform/s5p-mfc/s5p_mfc_opr.c    | 1425 ----------------------
 drivers/media/platform/s5p-mfc/s5p_mfc_opr.h    |   93 --
 drivers/media/platform/s5p-mfc/s5p_mfc_opr_v5.c | 1456 +++++++++++++++++++++++
 drivers/media/platform/s5p-mfc/s5p_mfc_opr_v5.h |  163 +++
 drivers/media/platform/s5p-mfc/s5p_mfc_shm.c    |   47 -
 drivers/media/platform/s5p-mfc/s5p_mfc_shm.h    |   90 --
 15 files changed, 1782 insertions(+), 1820 deletions(-)
 delete mode 100644 drivers/media/platform/s5p-mfc/s5p_mfc_cmd.c
 delete mode 100644 drivers/media/platform/s5p-mfc/s5p_mfc_cmd.h
 ...
 delete mode 100644 drivers/media/platform/s5p-mfc/s5p_mfc_opr.c
 delete mode 100644 drivers/media/platform/s5p-mfc/s5p_mfc_opr.h
