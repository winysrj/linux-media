...
Received: from metis.ext.pengutronix.de ([92.198.50.35]:43474 "EHLO
	metis.ext.pengutronix.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751236AbbGPQZO (ORCPT
...
Subject: [PATCH v3 5/5] [media] imx-ipu: Add i.MX IPUv3 scaler driver
Date: Thu, 16 Jul 2015 18:24:43 +0200
Message-Id: <1437063883-23981-6-git-send-email-p.zabel@pengutronix.de>
