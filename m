...
Received: from mailout3.w1.samsung.com ([210.118.77.13]:21852 "EHLO
        ...
        with ESMTP id S1752513AbdBTNjS (ORCPT
...
Subject: [PATCH v2 03/15] media: s5p-mfc: Replace mem_dev_* entries with an
 array
Date: Mon, 20 Feb 2017 14:38:52 +0100
Message-id: <1487597944-2000-4-git-send-email-m.szyprowski@samsung.com>
...
References: <1487597944-2000-1-git-send-email-m.szyprowski@samsung.com>
 <CGME20170220133912eucas1p19fece549b0759c7e6a308e309f6d3081@eucas1p1.samsung.com>
