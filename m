...
Received: from mga09.intel.com ([134.134.136.24]:53253 "EHLO mga09.intel.com"
	...
	id S1752811AbaCXPIv (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Mon, 24 Mar 2014 11:08:51 -0400
Date: Mon, 24 Mar 2014 23:06:27 +0800
From: Fengguang Wu <fengguang.wu@intel.com>
To: Mauro Carvalho Chehab <m.chehab@samsung.com>
Cc: linux-media@vger.kernel.org, kbuild-all@01.org
Subject: cxusb.c:undefined reference to `dib7000p_get_i2c_master'
Message-ID: <20140324150627.GD22341@localhost>
References: <532ed914.6l7yopWzFgNUlCGJ%fengguang.wu@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <532ed914.6l7yopWzFgNUlCGJ%fengguang.wu@intel.com>
...
>> cxusb.c:(.text+0x2c848a): undefined reference to `dib7000p_get_i2c_master'
   drivers/built-in.o: In function `dib7070_tuner_reset':
>> cxusb.c:(.text+0x2c859a): undefined reference to `dib7000p_set_gpio'
   drivers/built-in.o: In function `dib7070_set_param_override':
>> cxusb.c:(.text+0x2c8836): undefined reference to `dib7000p_set_wbd_ref'
   drivers/built-in.o: In function `cxusb_dualdig4_rev2_frontend_attach':
>> cxusb.c:(.text+0x2c8fac): undefined reference to `dib7000p_i2c_enumeration'
   drivers/built-in.o: In function `az6027_frontend_attach':
   az6027.c:(.text+0x2cddda): undefined reference to `stb0899_attach'
