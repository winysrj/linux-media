...
Received: from mx3.redhat.com (mx3.redhat.com [172.16.48.32])
	by int-mx1.corp.redhat.com (8.13.1/8.13.1) with ESMTP id n0A1Jr2M017132
	for <video4linux-list@redhat.com>; Fri, 9 Jan 2009 20:19:53 -0500
Received: from mail1.radix.net (mail1.radix.net [207.192.128.31])
	by mx3.redhat.com (8.13.8/8.13.8) with ESMTP id n0A1JZGB018731
	for <video4linux-list@redhat.com>; Fri, 9 Jan 2009 20:19:35 -0500
...
Date: Fri, 09 Jan 2009 20:19:27 -0500
Message-Id: <1231550367.3122.33.camel@palomino.walls.org>
Mime-Version: 1.0
...
On Mon, 2009-01-05 at 17:33 -0700, Paul Thomas wrote:
...
Well, I don't have kernel 2.6.28 code lying around, but it looks like a
BUG() that was being emitted Oops'ed instead of completing.

The ARMv5te disassmbly of the code bytes show this:

   0:   e1a01000        mov     r1, r0
   4:   e59f000c        ldr     r0, [pc, #12]   ; 0x18
   8:   eb0052c5        bl      0x14b24
   c:   e3a03000        mov     r3, #0  ; 0x0
  10:   e5833000        str     r3, [r3]       <=== Ooops here

r3 is 0/NULL in the Oops dump, but that just means there was a problem
with the BUG() call (I think).  That doesn't help much.

Without the 2.6.28 ARM kernel source at hand, I can't say much more
aside from the em82xx_init_isoc() is the first v4l-dvb driver function
encountered going through the backtrace and that it looks like the chain
of events was spurred by the memory mapping activity:
