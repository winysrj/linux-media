...
Received: from mout.gmx.net ([212.227.15.19]:62475 "EHLO mout.gmx.net"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1751045AbdG1JCD (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Fri, 28 Jul 2017 05:02:03 -0400
Date: Fri, 28 Jul 2017 10:59:29 +0200 (CEST)
From: Guennadi Liakhovetski <g.liakhovetski@gmx.de>
To: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
cc: Linux Media Mailing List <linux-media@vger.kernel.org>,
        Hans Verkuil <hverkuil@xs4all.nl>
Subject: Re: [PATCH v4] uvcvideo: add a metadata device node
In-Reply-To: <1573148.l0ngrOGOl6@avalon>
Message-ID: <Pine.LNX.4.64.1707280836040.15990@axis700.grange>
...
Ok, I missed the point, that .release() is only called, when the last file 
handle is closed.
...
It's definitely less code now, but uvc_queue_init() became metadata-node 
aware and slightly more complex now. But if you prefer it that way - no 
problem with me.
...
Expect a v++ with auxiliary patches soon.
