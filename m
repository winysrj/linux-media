...
Received: from mx1.redhat.com ([209.132.183.28]:1027 "EHLO mx1.redhat.com"
	...
	id S1751405Ab1LFQkA (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Tue, 6 Dec 2011 11:40:00 -0500
Message-ID: <4EDE454D.5060605@redhat.com>
Date: Tue, 06 Dec 2011 14:39:41 -0200
...
References: <ADF13DA15EB3FE4FBA487CCC7BEFDF36225500763A@bssrvexch01> <4ED905E0.5020706@redhat.com> <007201ccb118$633ff890$29bfe9b0$%debski@samsung.com> <201112061301.01010.laurent.pinchart@ideasonboard.com> <20111206142821.GC938@valkosipuli.localdomain> <4EDE29AA.8090203@redhat.com> <00de01ccb42a$7cddab70$76990250$%debski@samsung.com> <4EDE375B.6010900@redhat.com> <00df01ccb431$bd28d9f0$377a8dd0$%debski@samsung.com>
In-Reply-To: <00df01ccb431$bd28d9f0$377a8dd0$%debski@samsung.com>
...
Ah, ok. The RFC should not be restricted to M2M devices, as a V4L2 decoder device
...
If the input for such device is really coming from userspace, yes, you're right.
But you should remind that the same device block could be connected into some
...
At the first scenario, no real time is envolved. So, it can pause when something is
not met, but, the same IP block should behave different, as pausing would cause
data loss.
