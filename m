...
Received: from mail-bk0-f46.google.com ([209.85.214.46]:39263 "EHLO
	mail-bk0-f46.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1754103Ab2EGSiL (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Mon, 7 May 2012 14:38:11 -0400
Received: by bkcji2 with SMTP id ji2so3956945bkc.19
        for <linux-media@vger.kernel.org>; Mon, 07 May 2012 11:38:09 -0700 (PDT)
Message-ID: <4FA8168E.3040807@googlemail.com>
Date: Mon, 07 May 2012 20:38:06 +0200
From: Thomas Mair <thomas.mair86@googlemail.com>
MIME-Version: 1.0
To: linux-media@vger.kernel.org
Subject: Re: [PATCH v3 1/3] Modified RTL28xxU driver to work with RTL2832
References: <CAKZ=SG9U48d=eE3avccR-Auao5UMo0OANw8KKb=MP1XPtkHwmg@mail.gmail.com> <4FA780DB.1030800@iki.fi>
In-Reply-To: <4FA780DB.1030800@iki.fi>
...
>>   }
> 
> GPIOs are needed to configure only once. Put that configuration stuff to frontend_attach() (or tuner_attach()) and switch only GPIO output (hi/lo) here.
Ack.
...
> EP 0x81 == 0x01.
> Increasing buffers from 6 to 10 should not be needed for DVB-T stream (20 Mbit/sec). If you set it too small you will see very soon erros in the picture.
