...
Received: from mga18.intel.com ([134.134.136.126]:6504 "EHLO mga18.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1751248AbeCIIyr (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Fri, 9 Mar 2018 03:54:47 -0500
Date: Fri, 9 Mar 2018 10:54:43 +0200
From: Sakari Ailus <sakari.ailus@linux.intel.com>
To: Andy Yeh <andy.yeh@intel.com>
Cc: linux-media@vger.kernel.org, tfiga@chromium.org,
        jasonx.z.chen@intel.com, alanx.chiang@intel.com
Subject: Re: [PATCH v8] media: imx258: Add imx258 camera sensor driver
Message-ID: <20180309085442.qyo2ufb4abaupzop@paasikivi.fi.intel.com>
References: <1520525754-15726-1-git-send-email-andy.yeh@intel.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <1520525754-15726-1-git-send-email-andy.yeh@intel.com>
...
> +
> +	put_unaligned_be32(val << (8 * (4 - len)), __buf + 2);
...
unsigned int i, and please arrange it before ret.
...
The alignment coule be improved on. Same below, also in other functions.
...
Please do use v4l2_find_nearest_size(). The pull request (I just sent a new
one) is here:

<URL:https://patchwork.linuxtv.org/patch/47780/> 
...
IMO the comment is redundant, but if you prefer to keep it, then format it
correctly:
