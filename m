...
Received: from lb2-smtp-cloud2.xs4all.net ([194.109.24.25]:55631 "EHLO
	lb2-smtp-cloud2.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1751562AbbAVPNg (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 22 Jan 2015 10:13:36 -0500
Message-ID: <54C1135F.30504@xs4all.nl>
Date: Thu, 22 Jan 2015 16:12:31 +0100
From: Hans Verkuil <hverkuil@xs4all.nl>
MIME-Version: 1.0
To: Laurent Pinchart <laurent.pinchart@ideasonboard.com>,
	linux-media@vger.kernel.org
CC: sadegh abbasi <sadegh612000@yahoo.co.uk>
Subject: Re: [PATCH 3/7] v4l2-ctrls: Make the control type init op initialize
 the whole control
References: <1421938126-17747-1-git-send-email-laurent.pinchart@ideasonboard.com> <1421938126-17747-4-git-send-email-laurent.pinchart@ideasonboard.com>
In-Reply-To: <1421938126-17747-4-git-send-email-laurent.pinchart@ideasonboard.com>
...
> @@ -1301,6 +1301,35 @@ static void std_init(const struct v4l2_ctrl *ctrl, u32 idx,
>  	}
>  }
>  
...
> @@ -1929,7 +1958,6 @@ static struct v4l2_ctrl *v4l2_ctrl_new(struct v4l2_ctrl_handler *hdl,
>  	unsigned elems = 1;
>  	bool is_array;
...
>  	int err;
>  
> @@ -2049,10 +2077,8 @@ static struct v4l2_ctrl *v4l2_ctrl_new(struct v4l2_ctrl_handler *hdl,
