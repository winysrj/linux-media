...
Received: from kadath.azazel.net ([81.187.231.250]:33622 "EHLO
        kadath.azazel.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1752367AbdLBWME (ORCPT
        <rfc822;linux-media@vger.kernel.org>); Sat, 2 Dec 2017 17:12:04 -0500
From: Jeremy Sowden <jeremy@azazel.net>
To: linux-media@vger.kernel.org, devel@driverdev.osuosl.org
Subject: [PATCH v4 1/3] media: atomisp: convert default struct values to use compound-literals with designated initializers.
Date: Sat,  2 Dec 2017 22:11:59 +0000
Message-Id: <20171202221201.6063-2-jeremy@azazel.net>
