...
Received: from mailout3.w1.samsung.com ([210.118.77.13]:28519 "EHLO
	...
	with ESMTP id S1753528Ab0L2RdC (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 29 Dec 2010 12:33:02 -0500
MIME-version: 1.0
Content-transfer-encoding: 7BIT
Content-type: TEXT/PLAIN
Date: Wed, 29 Dec 2010 18:32:47 +0100
From: Sylwester Nawrocki <s.nawrocki@samsung.com>
Subject: [PATCH 05/15 v2] [media] s5p-fimc: Conversion to multiplanar formats
In-reply-to: <1293643975-4528-1-git-send-email-s.nawrocki@samsung.com>
To: linux-media@vger.kernel.org, linux-samsung-soc@vger.kernel.org
Cc: m.szyprowski@samsung.com, kyungmin.park@samsung.com,
	s.nawrocki@samsung.com
Message-id: <1293643975-4528-6-git-send-email-s.nawrocki@samsung.com>
...
index 0364a35..8796f78 100644
--- a/drivers/media/video/s5p-fimc/fimc-capture.c
+++ b/drivers/media/video/s5p-fimc/fimc-capture.c
@@ -281,34 +281,16 @@ static int stop_streaming(struct vb2_queue *q)
...
@@ -316,25 +298,24 @@ static int queue_setup(struct vb2_queue *vq, unsigned int *num_buffers,
 		       void *allocators[])
 {
...
@@ -348,16 +329,13 @@ static int buffer_prepare(struct vb2_buffer *vb)
...
@@ -452,7 +430,6 @@ static int fimc_capture_close(struct file *file)
...
@@ -520,7 +497,8 @@ static int fimc_vidioc_querycap_capture(struct file *file, void *priv,
...
@@ -561,19 +539,20 @@ static int sync_capture_fmt(struct fimc_ctx *ctx)
 	return 0;
 }
...
@@ -584,10 +563,12 @@ static int fimc_cap_s_fmt(struct file *file, void *priv,
 		ret = -EBUSY;
 		goto sf_unlock;
 	}
...
@@ -595,14 +576,17 @@ static int fimc_cap_s_fmt(struct file *file, void *priv,
 		goto sf_unlock;
 	}
...
@@ -770,7 +754,7 @@ static int fimc_cap_streamoff(struct file *file, void *priv,
 }
...
+			    struct v4l2_requestbuffers *reqbufs)
 {
 	struct fimc_ctx *ctx = priv;
 	struct fimc_dev *fimc = ctx->fimc_dev;
@@ -871,13 +855,13 @@ static int fimc_cap_cropcap(struct file *file, void *fh,
...
@@ -981,6 +965,7 @@ static const struct v4l2_ioctl_ops fimc_capture_ioctl_ops = {
...
@@ -988,6 +973,7 @@ int fimc_register_capture_device(struct fimc_dev *fimc)
...
@@ -1000,8 +986,12 @@ int fimc_register_capture_device(struct fimc_dev *fimc)
...
@@ -1031,7 +1021,7 @@ int fimc_register_capture_device(struct fimc_dev *fimc)
...
@@ -1041,7 +1031,7 @@ int fimc_register_capture_device(struct fimc_dev *fimc)
