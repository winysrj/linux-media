...
Received: from mta-out1.inet.fi ([62.71.2.195]:60438 "EHLO jenni2.inet.fi"
	...
	id S1751193AbaHHHQh (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Fri, 8 Aug 2014 03:16:37 -0400
From: Olli Salonen <olli.salonen@iki.fi>
To: linux-media@vger.kernel.org
Cc: Olli Salonen <olli.salonen@iki.fi>
Subject: [PATCHv2 1/4] sp2: Add I2C driver for CIMaX SP2 common interface module
Date: Fri,  8 Aug 2014 10:06:35 +0300
Message-Id: <1407481598-24598-1-git-send-email-olli.salonen@iki.fi>
