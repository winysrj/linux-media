...
Received: from smtp-vbr11.xs4all.nl ([194.109.24.31]:2882 "EHLO
	smtp-vbr11.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1757344Ab0E2Ooo (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sat, 29 May 2010 10:44:44 -0400
Message-Id: <34506ccd71c4702d54ff2cf658a63e7448f122dd.1275143672.git.hverkuil@xs4all.nl>
In-Reply-To: <cover.1275143672.git.hverkuil@xs4all.nl>
References: <cover.1275143672.git.hverkuil@xs4all.nl>
From: Hans Verkuil <hverkuil@xs4all.nl>
Date: Sat, 29 May 2010 16:46:34 +0200
Subject: [PATCH 09/15] [RFCv4] cx25840: convert to the new control framework
...
+	};
 	...
 	int radio;
 	v4l2_std_id std;
@@ -36,8 +43,6 @@ struct cx25840_state {
...
-	int default_volume;
 	...
 	u32 id;
 	u32 rev;
@@ -51,6 +56,11 @@ static inline struct cx25840_state *to_state(struct v4l2_subdev *sd)
...
@@ -86,8 +96,8 @@ int cx25840_loadfw(struct i2c_client *client);
 /* cx25850-audio.c                                                         */
