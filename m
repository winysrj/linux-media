...
Received: from smtp-vbr11.xs4all.nl ([194.109.24.31]:4134 "EHLO
	smtp-vbr11.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751365AbaHJLSl (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sun, 10 Aug 2014 07:18:41 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: wbrack@mmm.com.hk, Hans Verkuil <hans.verkuil@cisco.com>
Subject: [PATCH 1/2] tw68: add support for Techwell tw68xx PCI grabber boards
Date: Sun, 10 Aug 2014 13:17:12 +0200
Message-Id: <1407669433-13571-2-git-send-email-hverkuil@xs4all.nl>
...
+			return IRQ_HANDLED;
+	}
+	dprintk(1, "%s: **** INTERRUPT NOT HANDLED - clearing mask (orig 0x%08x, cur 0x%08x)",
+			dev->name, orig, tw_readl(TW68_INTSTAT));
+	dprintk(1, "%s: pci_irqmask 0x%08x; board_virqmask 0x%08x ****\n",
...
+		dprintk(1, "PABORT interrupt\n");
+	}
+	if (status & TW68_DMAPERR) {
+		dprintk(1, "DMAPERR interrupt\n");
+		/* Stop risc & fifo */
+		/*tw_clearl(TW68_DMAC, TW68_DMAP_EN | TW68_FIFO_EN);
...
+		dprintk(1, "FFOF interrupt\n");
+		tw_setl(TW68_DMAC, reg);
+	}
+	if (status & TW68_FFERR)
+		dprintk(1, "FFERR interrupt\n");
+}
diff --git a/drivers/media/pci/tw68/tw68.h b/drivers/media/pci/tw68/tw68.h
new file mode 100644
index 0000000..07d30e3
--- /dev/null
