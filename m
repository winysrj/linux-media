...
Received: from mx3.redhat.com (mx3.redhat.com [172.16.48.32])
	by int-mx1.corp.redhat.com (8.13.1/8.13.1) with ESMTP id m593mk0u009297
	for <video4linux-list@redhat.com>; Sun, 8 Jun 2008 23:48:46 -0400
Received: from mail9.dslextreme.com (mail9.dslextreme.com [66.51.199.94])
	by mx3.redhat.com (8.13.8/8.13.8) with SMTP id m593mYCK029143
	for <video4linux-list@redhat.com>; Sun, 8 Jun 2008 23:48:35 -0400
Message-ID: <484CA80A.2050000@gimpelevich.san-francisco.ca.us>
Date: Sun, 08 Jun 2008 20:48:26 -0700
From: Daniel Gimpelevich <daniel@gimpelevich.san-francisco.ca.us>
MIME-Version: 1.0
To: video4linux-list@redhat.com
Content-Type: multipart/mixed; boundary="------------090500020606020108010502"
Subject: [PATCH] Take 2: Implement proper cx88 deactivation
...
--------------090500020606020108010502
Content-Type: text/plain; charset=UTF-8; format=flowed
Content-Transfer-Encoding: 7bit

I'm sorry for jumping the gun with the patch in my previous message. 
This is a much more complete patch, which takes its place. Same 
description applies.
...
+++ b/linux/Documentation/video4linux/CARDLIST.cx88	Sun Jun 08 20:35:44 2008 -0700
@@ -60,7 +60,7 @@
...
diff -r 3f7d664a285d linux/drivers/media/video/cx88/cx88-blackbird.c
--- a/linux/drivers/media/video/cx88/cx88-blackbird.c	Sun Jun 08 07:26:00 2008 -0300
+++ b/linux/drivers/media/video/cx88/cx88-blackbird.c	Sun Jun 08 20:35:44 2008 -0700
@@ -1014,15 +1014,16 @@
...
+++ b/linux/drivers/media/video/cx88/cx88-cards.c	Sun Jun 08 20:35:44 2008 -0700
@@ -1425,10 +1425,6 @@
...
+++ b/linux/drivers/media/video/cx88/cx88-core.c	Sun Jun 08 20:35:44 2008 -0700
@@ -605,6 +605,8 @@
...
+++ b/linux/drivers/media/video/cx88/cx88-mpeg.c	Sun Jun 08 20:35:44 2008 -0700
@@ -665,13 +665,21 @@
...
+++ b/linux/drivers/media/video/cx88/cx88-tvaudio.c	Sun Jun 08 20:35:44 2008 -0700
@@ -774,6 +774,7 @@
...
+++ b/linux/drivers/media/video/cx88/cx88-video.c	Sun Jun 08 20:35:44 2008 -0700
@@ -417,14 +417,20 @@
...
+++ b/linux/drivers/media/video/cx88/cx88.h	Sun Jun 08 20:35:44 2008 -0700
@@ -236,6 +236,7 @@
 	CX88_VMUX_DVB,
 	CX88_VMUX_DEBUG,
 	CX88_RADIO,
