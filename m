...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id BDF2EC07E85
	for <linux-media@archiver.kernel.org>; Fri,  7 Dec 2018 14:00:44 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id 6F5322064D
	for <linux-media@archiver.kernel.org>; Fri,  7 Dec 2018 14:00:44 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=default; t=1544191244;
	bh=h/4GfrRizWZMuOD6IwsBefdyGXcONrILB0+Ue+51IJs=;
	h=Date:From:To:Cc:Subject:In-Reply-To:References:List-ID:From;
	b=X4UKsaF/2VkIJ4ODTm2wsrUD4zYAs+OpuwaDJO3HqVlhR3jaweTIL9+RFgDw6F+1Z
	 Hi5G85G3AqlVxtR/YxWbyNDG73niZSAn4Sh+QUcmoceJSp676hgAgd80hUGnqsZ6rq
	 GR/NV+GHeuXYExMDJ+zIsA7ZE/vHPd/d9eSX0pIo=
DMARC-Filter: OpenDMARC Filter v1.3.2 mail.kernel.org 6F5322064D
Authentication-Results: mail.kernel.org; dmarc=fail (p=none dis=none) header.from=kernel.org
Authentication-Results: mail.kernel.org; spf=none smtp.mailfrom=linux-media-owner@vger.kernel.org
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726122AbeLGOAn (ORCPT <rfc822;linux-media@archiver.kernel.org>);
        Fri, 7 Dec 2018 09:00:43 -0500
Received: from casper.infradead.org ([85.118.1.10]:60578 "EHLO
        casper.infradead.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726041AbeLGOAn (ORCPT
        <rfc822;linux-media@vger.kernel.org>); Fri, 7 Dec 2018 09:00:43 -0500
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        ...
        bh=21QiAbFydJQ8hGjor2TLFNgdHhXlKQt2cweNHWtpdts=; b=RnU4Tb4bPzSyQnzoZwUQ37L9tL
        ;
Received: from [179.95.33.236] (helo=coco.lan)
        by casper.infradead.org with esmtpsa (Exim 4.90_1 #2 (Red Hat Linux))
        id 1gVGgL-0003UU-Kw; Fri, 07 Dec 2018 14:00:42 +0000
Date:   Fri, 7 Dec 2018 12:00:37 -0200
...
Message-ID: <20181207120037.6679c797@coco.lan>
...
References: <89b0af6f-1371-50d9-5c19-fac7bb6562a3@xs4all.nl>
        ...
        <20181207115317.7a6d5feb@coco.lan>
