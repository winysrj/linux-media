...
Received: from fg-out-1718.google.com ([72.14.220.159]:29367 "EHLO
	fg-out-1718.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752512AbZAaQ22 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sat, 31 Jan 2009 11:28:28 -0500
...
References: <hvaibhav@ti.com>
	 <1233256950-26704-2-git-send-email-hvaibhav@ti.com>
Content-Type: text/plain
Date: Sat, 31 Jan 2009 19:28:58 +0300
Message-Id: <1233419338.19837.21.camel@tux.localhost>
Mime-Version: 1.0
...
May be it's better to add MODULE_NAME here? To provide more comfortable
...
If i'm not wrong gpio_request can return -EBUSY and -EINVAL. May be it's
better to introduce retval variable, call to gpio_request, check retval
value and provide error number to printk-message and and return retval.
