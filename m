...
Received: from perceval.ideasonboard.com ([95.142.166.194]:52874 "EHLO
	...
	with ESMTP id S1754598Ab2GRNyG (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 18 Jul 2012 09:54:06 -0400
From: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
To: Guennadi Liakhovetski <g.liakhovetski@gmx.de>
Cc: linux-media@vger.kernel.org
Subject: [PATCH v3 8/9] soc-camera: Add and use soc_camera_power_[on|off]() helper functions
Date: Wed, 18 Jul 2012 15:54:03 +0200
Message-Id: <1342619644-5712-9-git-send-email-laurent.pinchart@ideasonboard.com>
...
@@ -548,7 +560,7 @@ static int soc_camera_open(struct file *file)
 			goto eiciadd;
 		}
...
+	__soc_camera_power_off(icd);
 epower:
 	ici->ops->remove(icd);
 eiciadd:
@@ -607,8 +619,6 @@ static int soc_camera_close(struct file *file)
...
@@ -616,7 +626,7 @@ static int soc_camera_close(struct file *file)
...
@@ -1075,8 +1085,14 @@ static int soc_camera_probe(struct soc_camera_device *icd)
...
@@ -1149,7 +1165,7 @@ static int soc_camera_probe(struct soc_camera_device *icd)
