...
Received: from mail-la0-f42.google.com ([209.85.215.42]:43212 "EHLO
	mail-la0-f42.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751479Ab3GYUXV (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 25 Jul 2013 16:23:21 -0400
Received: by mail-la0-f42.google.com with SMTP id eh20so1705508lab.29
        for <linux-media@vger.kernel.org>; Thu, 25 Jul 2013 13:23:19 -0700 (PDT)
To: g.liakhovetski@gmx.de, mchehab@redhat.com,
	linux-media@vger.kernel.org
Subject: [PATCH v9] V4L2: soc_camera: Renesas R-Car VIN driver
Cc: magnus.damm@gmail.com, linux-sh@vger.kernel.org,
	phil.edworthy@renesas.com, matsu@igel.co.jp,
	vladimir.barinov@cogentembedded.com
From: Sergei Shtylyov <sergei.shtylyov@cogentembedded.com>
Date: Fri, 26 Jul 2013 00:23:10 +0400
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="iso-8859-1"
Content-Transfer-Encoding: 7bit
Message-Id: <201307260023.11460.sergei.shtylyov@cogentembedded.com>
...
- made rcar_vin_setup() return *int*, replaced BUG() by dev_warn() and *return*
  -EINVAL and added *return* 0 at end of the function;
- moved rcar_vin_setup() call in the buf_queue() method and started handling
  error returned by it;
- added comments to clock_{start|stop}() methods;
- fixed 'bits_per_sample' field for V4L2_PIX_FMT_NV16 format;
- fixed line longer than 80 characters;
- fixed dev_dbg() message in the set_fmt() method.
...
@@ -14,3 +14,4 @@ obj-$(CONFIG_VIDEO_OMAP1)		+= omap1_came
