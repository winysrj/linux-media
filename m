...
Received: from mail-lf0-f68.google.com ([209.85.215.68]:41325 "EHLO
        mail-lf0-f68.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1751555AbdLBLI0 (ORCPT
        <rfc822;linux-media@vger.kernel.org>); Sat, 2 Dec 2017 06:08:26 -0500
Received: by mail-lf0-f68.google.com with SMTP id f18so14321791lfg.8
        for <linux-media@vger.kernel.org>; Sat, 02 Dec 2017 03:08:25 -0800 (PST)
From: "Niklas =?iso-8859-1?Q?S=F6derlund?=" <niklas.soderlund@ragnatech.se>
Date: Sat, 2 Dec 2017 12:08:21 +0100
...
Subject: Re: [PATCH v12 2/2] rcar-csi2: add Renesas R-Car MIPI CSI-2 receiver
 driver
Message-ID: <20171202110821.GC26548@bigcity.dyn.berto.se>
...
In-Reply-To: <20171201130136.vmskp34z7pfpg422@valkosipuli.retiisi.org.uk>
...
> > +	unsigned int code;
> 
> Media bus codes are generally u32, I'd use the same here, too.
...
> 
> I might just ignore the error here. Maybe complain as well?

Sure it might be better to ignore the error here, I will change this.
...
Don't look like I do, I will remove this.
