...
Received: from smtp-vbr4.xs4all.nl ([194.109.24.24]:1692 "EHLO
	smtp-vbr4.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1754461Ab3CVLB0 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 22 Mar 2013 07:01:26 -0400
Received: from alastor.dyndns.org (166.80-203-20.nextgentel.com [80.203.20.166] (may be forged))
	(authenticated bits=0)
	by smtp-vbr4.xs4all.nl (8.13.8/8.13.8) with ESMTP id r2MB1MIW061847
	(version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-SHA bits=256 verify=FAIL)
	for <linux-media@vger.kernel.org>; Fri, 22 Mar 2013 12:01:24 +0100 (CET)
	(envelope-from hverkuil@xs4all.nl)
Received: from durdane.localnet (64-103-25-233.cisco.com [64.103.25.233])
	(Authenticated sender: hans)
	by alastor.dyndns.org (Postfix) with ESMTPSA id C52F811E0151
	for <linux-media@vger.kernel.org>; Fri, 22 Mar 2013 12:01:21 +0100 (CET)
From: Hans Verkuil <hverkuil@xs4all.nl>
To: "linux-media" <linux-media@vger.kernel.org>
Subject: Re: [GIT PULL FOR v3.10] v4l2: make arg of write-only ioctls const
Date: Fri, 22 Mar 2013 12:01:20 +0100
References: <201303221135.17245.hverkuil@xs4all.nl>
In-Reply-To: <201303221135.17245.hverkuil@xs4all.nl>
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="iso-8859-1"
Content-Transfer-Encoding: 7bit
Message-Id: <201303221201.20444.hverkuil@xs4all.nl>
