...
Received: from lists.s-osg.org ([54.187.51.154]:54538 "EHLO lists.s-osg.org"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1754576AbbFCTOm (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Wed, 3 Jun 2015 15:14:42 -0400
Date: Wed, 3 Jun 2015 16:14:33 -0300
...
Subject: Re: [PATCH v2 2/2] sound/usb: Update ALSA driver to use media
 controller API
Message-ID: <20150603161433.20f9a746@recife.lan>
In-Reply-To: <7326d512ec83ac510431864d2fe2d79b0c72e0a6.1433298842.git.shuahkh@osg.samsung.com>
References: <cover.1433298842.git.shuahkh@osg.samsung.com>
	<7326d512ec83ac510431864d2fe2d79b0c72e0a6.1433298842.git.shuahkh@osg.samsung.com>
MIME-Version: 1.0
...
This way, it won't matter if snd-usb-audio is probed before or after
au0828.

As the above knowledge is au0828-specifics, the best is to add the
hook function caller code inside au0828 driver.
...
Hmm... will this work? What happens if just snd-usb-audio is removed,
but au0828 keeps loaded?
...
I think that pipeline start/stop functions need to be modified, as it
should start/stop here just the alsa part of the pipeline, not touching
at the V4L2 one.
