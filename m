...
Received: from butterbrot.org ([176.9.106.16]:55768 "EHLO butterbrot.org"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1751165AbaLSO5J (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Fri, 19 Dec 2014 09:57:09 -0500
Message-ID: <54943CC2.6040803@butterbrot.org>
Date: Fri, 19 Dec 2014 15:57:06 +0100
...
References: <5492D7E8.504@butterbrot.org> <5492E091.1060404@xs4all.nl> <54943680.3020007@butterbrot.org> <549437DA.6090601@xs4all.nl>
In-Reply-To: <549437DA.6090601@xs4all.nl>
Content-Type: multipart/signed; micalg=pgp-sha1;
 protocol="application/pgp-signature";
 boundary="LKW0Qt8P03c8uv56vxn7KTJ40Vp3INeRT"
Sender: linux-media-owner@vger.kernel.org
List-ID: <linux-media.vger.kernel.org>

This is an OpenPGP/MIME signed message (RFC 4880 and 3156)
--LKW0Qt8P03c8uv56vxn7KTJ40Vp3INeRT
Content-Type: multipart/mixed;
 boundary="------------010104030608060208080305"

This is a multi-part message in MIME format.
--------------010104030608060208080305
...
>> =09
>>> fail: v4l2-test-input-output.cpp(455): could set input to invalid inp=
ut 1
...
>>
>>> fail: v4l2-compliance.cpp(365): doioctl(node, VIDIOC_G_PRIORITY, &pri=
o)
...
>=20
> Can you post the driver code you used to run these tests? And which ker=
nel version
...
iEYEARECAAYFAlSUPMIACgkQ7CzyshGvatjAyACfTDvkSGpLG55jXgnQvygq8Np8
OpwAnA2uE+MwWTT1/PwFWfB0CQTpp6Gb
=PNkx
-----END PGP SIGNATURE-----
