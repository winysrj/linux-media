...
Received: from mailout4.w1.samsung.com ([210.118.77.14]:63561 "EHLO
	mailout4.w1.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S933654Ab0LUJzt (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 21 Dec 2010 04:55:49 -0500
MIME-version: 1.0
Content-transfer-encoding: 7BIT
Content-type: TEXT/PLAIN
Date: Tue, 21 Dec 2010 10:55:17 +0100
From: Kamil Debski <k.debski@samsung.com>
Subject: [RFC/PATCH v5 3/4] MFC: Added MFC 5.1 V4L2 driver
...
Message-id: <1292925318-2911-4-git-send-email-k.debski@samsung.com>
...
---
 ...
 drivers/media/video/s5p-mfc/s5p_mfc.c        | 2056 ++++++++++++++++++++++++++
 ...
 drivers/media/video/s5p-mfc/s5p_mfc_opr.h    |  127 ++
...
index 72241cd..f25b3e0 100644
--- a/drivers/media/video/Kconfig
+++ b/drivers/media/video/Kconfig
@@ -1028,4 +1028,12 @@ config  VIDEO_SAMSUNG_S5P_FIMC
...
+
+static inline void *s5p_mfc_mem_alloc(struct vb2_alloc_ctx *a, unsigned int s)
+{
+	return a->mem_ops->alloc(a, s);
+}
+
+static inline size_t s5p_mfc_mem_paddr(struct vb2_alloc_ctx *a, void *b)
+{
+	return (size_t)a->mem_ops->cookie(b);
+}
+
+static inline void s5p_mfc_mem_put(struct vb2_alloc_ctx *a, void *b)
+{
+	a->mem_ops->put(b);
+}
+
+static inline void *s5p_mfc_mem_vaddr(struct vb2_alloc_ctx *a, void *b)
+{
+	return a->mem_ops->vaddr(b);
+}
+
+/* Reset the device */
...
+void s5p_mfc_release_instance_buffer(struct s5p_mfc_ctx *ctx);
+
+#define s5p_mfc_pre_shared_io() dma_unmap_single(ctx->dev->v4l2_dev.dev, \
+			ctx->shared_dma, SHARED_BUF_SIZE, DMA_BIDIRECTIONAL);
+#define s5p_mfc_post_shared_io() ctx->shared_dma = dma_map_single( \
+				ctx->dev->v4l2_dev.dev, ctx->shared_virt, \
+				SHARED_BUF_SIZE, DMA_BIDIRECTIONAL);
+
