...
Received: from mailout2.w1.samsung.com ([210.118.77.12]:33631 "EHLO
	...
	with ESMTP id S1754505Ab1HZNGW (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 26 Aug 2011 09:06:22 -0400
Received: from eu_spt1 (mailout2.w1.samsung.com [210.118.77.12])
 by mailout2.w1.samsung.com
 (iPlanet Messaging Server 5.2 Patch 2 (built Jul 14 2004))
 with ESMTP id <0LQJ00HQADQKQF@mailout2.w1.samsung.com> for
 linux-media@vger.kernel.org; Fri, 26 Aug 2011 14:06:20 +0100 (BST)
Received: from linux.samsung.com ([106.116.38.10])
 by spt1.w1.samsung.com (iPlanet Messaging Server 5.2 Patch 2 (built Jul 14
 2004)) with ESMTPA id <0LQJ00GEVDQIWQ@spt1.w1.samsung.com> for
 linux-media@vger.kernel.org; Fri, 26 Aug 2011 14:06:19 +0100 (BST)
Date: Fri, 26 Aug 2011 15:06:07 +0200
From: Tomasz Stanislawski <t.stanislaws@samsung.com>
Subject: [PATCH 5/5] [media] v4l: s5p-tv: mixer: add support for selection API
In-reply-to: <1314363967-6448-1-git-send-email-t.stanislaws@samsung.com>
To: linux-media@vger.kernel.org
Cc: m.szyprowski@samsung.com, t.stanislaws@samsung.com,
	kyungmin.park@samsung.com, hverkuil@xs4all.nl,
	laurent.pinchart@ideasonboard.com
Message-id: <1314363967-6448-6-git-send-email-t.stanislaws@samsung.com>
MIME-version: 1.0
...
@@ -331,73 +310,183 @@ static int mxr_g_fmt(struct file *file, void *priv,
 	return 0;
 }
...
+		return -EINVAL;
+	}
+	/* backup geometry if setup fails */
+	memcpy(&tmp, geo, sizeof tmp);
+	/* apply change and update geometry */
...
+
+	/* backup requested rectangle */
+	req = s->r;
+	/* return results to the user */
+	s->r.left = target->x_offset;
+	s->r.top = target->y_offset;
+	s->r.width = target->width;
+	s->r.height = target->height;
+	/* checking if the rectangle satisfies constraints */ 
+	if ((s->flags & V4L2_SEL_SIZE_LE) && !mxr_is_rect_inside(&s->r, &req))
+		goto fail;
+	if ((s->flags & V4L2_SEL_SIZE_GE) && !mxr_is_rect_inside(&req, &s->r))
+		goto fail;
+
+
 	return 0;
...
@@ -437,6 +526,8 @@ static int mxr_s_dv_preset(struct file *file, void *fh,
...
@@ -477,6 +568,8 @@ static int mxr_s_std(struct file *file, void *fh, v4l2_std_id *norm)
...
@@ -525,25 +618,27 @@ static int mxr_s_output(struct file *file, void *fh, unsigned int i)
...
@@ -632,10 +727,9 @@ static const struct v4l2_ioctl_ops mxr_ioctl_ops = {
...
@@ -807,10 +901,7 @@ static int start_streaming(struct vb2_queue *vq)
