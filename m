...
Received: from mailout3.w1.samsung.com ([210.118.77.13]:56753 "EHLO
	mailout3.w1.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S933129Ab2GYOdX (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 25 Jul 2012 10:33:23 -0400
Received: from eusync3.samsung.com (mailout3.w1.samsung.com [210.118.77.13])
 by mailout3.w1.samsung.com
 (Oracle Communications Messaging Server 7u4-24.01(7.0.4.24.0) 64bit (built Nov
 17 2011)) with ESMTP id <0M7Q003ST0GKF270@mailout3.w1.samsung.com> for
 linux-media@vger.kernel.org; Wed, 25 Jul 2012 15:33:56 +0100 (BST)
Received: from localhost.localdomain ([106.116.147.88])
 ...
 with ESMTPA id <0M7Q00LUY0FCMJ80@eusync3.samsung.com> for
 linux-media@vger.kernel.org; Wed, 25 Jul 2012 15:33:21 +0100 (BST)
...
Subject: [PATCH] v4l/s5p-mfc: added support for end of stream handling in MFC
 encoder
Date: Wed, 25 Jul 2012 16:32:55 +0200
Message-id: <1343226775-21882-1-git-send-email-a.hajda@samsung.com>
In-reply-to: <1340958178-14309-1-git-send-email-a.hajda@samsung.com>
References: <1340958178-14309-1-git-send-email-a.hajda@samsung.com>
...
It correctly handles end of stream in case of multiple running contextes.
---
...
index feea867..05c4e04 100644
--- a/drivers/media/video/s5p-mfc/s5p_mfc_dec.c
+++ b/drivers/media/video/s5p-mfc/s5p_mfc_dec.c
@@ -930,14 +930,14 @@ static void s5p_mfc_buf_queue(struct vb2_buffer *vb)
...
@@ -1114,27 +1115,43 @@ static int vidioc_qbuf(struct file *file, void *priv, struct v4l2_buffer *buf)
...
+	return ret;
 ...
 /* Stream on */
@@ -1466,6 +1483,53 @@ static int vidioc_g_parm(struct file *file, void *priv,
 	return 0;
 }
...
@@ -1486,6 +1550,9 @@ static const struct v4l2_ioctl_ops s5p_mfc_enc_ioctl_ops = {
...
@@ -1701,7 +1768,7 @@ static void s5p_mfc_buf_queue(struct vb2_buffer *vb)
 	}
...
@@ -1709,17 +1776,10 @@ static void s5p_mfc_buf_queue(struct vb2_buffer *vb)
 		spin_unlock_irqrestore(&dev->irqlock, flags);
