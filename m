...
Received: from lb1-smtp-cloud3.xs4all.net ([194.109.24.22]:45831 "EHLO
	...
	by vger.kernel.org with ESMTP id S1760857AbbCDJs3 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 4 Mar 2015 04:48:29 -0500
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hans.verkuil@cisco.com>
Subject: [PATCHv2 1/8] v4l2-subdev: replace v4l2_subdev_fh by v4l2_subdev_pad_config
Date: Wed,  4 Mar 2015 10:47:54 +0100
Message-Id: <1425462481-8200-2-git-send-email-hverkuil@xs4all.nl>
