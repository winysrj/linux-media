...
Received: from mx1.redhat.com ([209.132.183.28]:48466 "EHLO mx1.redhat.com"
	...
	id S1757445Ab0KLWjq (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Fri, 12 Nov 2010 17:39:46 -0500
Received: from int-mx02.intmail.prod.int.phx2.redhat.com (int-mx02.intmail.prod.int.phx2.redhat.com [10.5.11.12])
	by mx1.redhat.com (8.13.8/8.13.8) with ESMTP id oACMdjfu031903
	(version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-SHA bits=256 verify=OK)
	for <linux-media@vger.kernel.org>; Fri, 12 Nov 2010 17:39:46 -0500
Received: from xavier.bos.redhat.com (xavier.bos.redhat.com [10.16.16.50])
	by int-mx02.intmail.prod.int.phx2.redhat.com (8.13.8/8.13.8) with ESMTP id oACMdjxb016265
	for <linux-media@vger.kernel.org>; Fri, 12 Nov 2010 17:39:45 -0500
Date: Fri, 12 Nov 2010 17:39:45 -0500
From: Jarod Wilson <jarod@redhat.com>
To: linux-media@vger.kernel.org
Subject: [PATCH] mceusb: fix keybouce issue after parser simplification
Message-ID: <20101112223945.GB8205@redhat.com>
MIME-Version: 1.0
...
@@ -538,10 +543,12 @@ static void mceusb_dev_printdata(struct mceusb_dev *ir, char *buf,
...
@@ -795,6 +802,34 @@ static int mceusb_set_tx_carrier(struct rc_dev *dev, u32 carrier)
 	return carrier;
 }
...
@@ -814,13 +849,14 @@ static void mceusb_process_ir_data(struct mceusb_dev *ir, int buf_len)
...
@@ -842,7 +878,8 @@ static void mceusb_process_ir_data(struct mceusb_dev *ir, int buf_len)
 				continue;
 			}
