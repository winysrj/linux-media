...
Received: from mail-we0-f174.google.com ([74.125.82.174]:65517 "EHLO
	mail-we0-f174.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752351Ab2IVR7q (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sat, 22 Sep 2012 13:59:46 -0400
Received: by weyx8 with SMTP id x8so2566043wey.19
        for <linux-media@vger.kernel.org>; Sat, 22 Sep 2012 10:59:44 -0700 (PDT)
From: Sylwester Nawrocki <sylvester.nawrocki@gmail.com>
To: linux-media@vger.kernel.org
Cc: tomasz.figa@gmail.com, oselas@community.pengutronix.de,
	Sylwester Nawrocki <sylvester.nawrocki@gmail.com>
Subject: [PATCH RFC v3] V4L: Add driver for S3C244X/S3C64XX SoC series camera interface
Date: Sat, 22 Sep 2012 19:59:31 +0200
Message-Id: <1348336771-14235-1-git-send-email-sylvester.nawrocki@gmail.com>
...
---
Changes since v2:
 - multiple fixes and variant definitions for s3c6410 SoC (thanks
   to Tomasz Figa), succesfully tested on mini6410 board;
 - camera pin mux setup moved to board code as it used the platform
   specific API;
 - added logging of errors from sensor's s_stream callback, fixed
   start_streaming so errors from sensor s_stream are propagated
   up to the VIDIOC_STREAMON caller;
 - used common clock conn_id names in order to make the driver work
   on all s3c244x and s3c64xx platforms,;
 - monotonic clock used for buffer timestamps, rather than realtime.

 Full patch series, including platform patches can be pulled from git
 repository:
 ...
 drivers/media/platform/s3c-camif/camif-capture.c | 1638 ++++++++++++++++++++++
 drivers/media/platform/s3c-camif/camif-core.c    |  661 +++++++++
 drivers/media/platform/s3c-camif/camif-core.h    |  381 +++++
 drivers/media/platform/s3c-camif/camif-regs.c    |  579 ++++++++
 drivers/media/platform/s3c-camif/camif-regs.h    |  267 ++++
 include/media/s3c_camif.h                        |   46 +
 9 files changed, 3590 insertions(+), 0 deletions(-)
