...
Received: from vps-vb.mhejs.net ([37.28.154.113]:49976 "EHLO vps-vb.mhejs.net"
        ...
        id S1755515AbdJJVxg (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Tue, 10 Oct 2017 17:53:36 -0400
From: "Maciej S. Szmigiero" <mail@maciej.szmigiero.name>
Subject: [PATCH v2 4/6] tuner-simple: allow setting mono radio mode
To: Michael Krufky <mkrufky@linuxtv.org>,
        Mauro Carvalho Chehab <mchehab@kernel.org>
Cc: Andy Walls <awalls@md.metrocast.net>,
        linux-kernel <linux-kernel@vger.kernel.org>,
        linux-media@vger.kernel.org, Hans Verkuil <hverkuil@xs4all.nl>
Message-ID: <73b66649-6a41-31f7-d88d-d4d67400ea5f@maciej.szmigiero.name>
Date: Tue, 10 Oct 2017 23:36:09 +0200
MIME-Version: 1.0
