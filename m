...
Received: from mail-1.atlantis.sk ([80.94.52.57]:50216 "EHLO
	mail-1.atlantis.sk" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1758870Ab3HJWLX (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sat, 10 Aug 2013 18:11:23 -0400
From: Ondrej Zary <linux@rainbow-software.org>
To: linux-media@vger.kernel.org
Subject: [RFC PATCH] introduce gspca-stk1135: Syntek STK1135 driver
Date: Sun, 11 Aug 2013 00:10:56 +0200
MIME-Version: 1.0
Content-Type: text/plain;
  charset="us-ascii"
Content-Transfer-Encoding: 7bit
Content-Disposition: inline
Message-Id: <201308110010.56508.linux@rainbow-software.org>
...
+		sethflip(gspca_dev, sd->flip_status);
+		setvflip(gspca_dev, sd->flip_status);
...
+	v4l2_ctrl_new_std(hdl, &sd_ctrl_ops, V4L2_CID_VFLIP, 0, 1, 1, 0);
+
+	if (hdl->error) {
