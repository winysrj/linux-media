...
Received: from metis.ext.4.pengutronix.de ([92.198.50.35]:46470 "EHLO
        metis.ext.4.pengutronix.de" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1755136AbcJNRfF (ORCPT
...
Subject: [PATCH v2 15/21] ARM: dts: nitrogen6x: Add dtsi for BD_HDMI_MIPI HDMI to MIPI CSI-2 receiver board
Date: Fri, 14 Oct 2016 19:34:35 +0200
Message-Id: <1476466481-24030-16-git-send-email-p.zabel@pengutronix.de>
