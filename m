...
Received: from perceval.ideasonboard.com ([213.167.242.64]:40104 "EHLO
        perceval.ideasonboard.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1751850AbeEQAFZ (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Wed, 16 May 2018 20:05:25 -0400
From: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
To: Kieran Bingham <kieran.bingham+renesas@ideasonboard.com>
Cc: linux-renesas-soc@vger.kernel.org, linux-media@vger.kernel.org
Subject: Re: [PATCH v9 4/8] media: vsp1: Convert display lists to use new body pool
Date: Thu, 17 May 2018 03:05:43 +0300
Message-ID: <6277952.HDHDbCRQnR@avalon>
In-Reply-To: <fbf636d897af408b25db68ad733cd63b4ea62176.1525354160.git-series.kieran.bingham+renesas@ideasonboard.com>
References: <cover.76b8251c2457cea047ecba892cf0d7a351644051.1525354160.git-series.kieran.bingham+renesas@ideasonboard.com> <fbf636d897af408b25db68ad733cd63b4ea62176.1525354160.git-series.kieran.bingham+renesas@ideasonboard.com>
MIME-Version: 1.0
...
> - *
> - * Passing a NULL pointer to this function is safe, in that case no
...
>   * @dlb: The body
> @@ -401,8 +313,6 @@ void vsp1_dl_body_write(struct vsp1_dl_body *dlb, u32
...
>  	if (!dl)
> @@ -411,41 +321,39 @@ static struct vsp1_dl_list *vsp1_dl_list_alloc(struct
...
>  }
> 
> @@ -499,18 +407,13 @@ static void __vsp1_dl_list_put(struct vsp1_dl_list
> *dl)
> 
>  	dl->has_chain = false;
> 
...
> 
>  /**
> @@ -560,8 +463,8 @@ void vsp1_dl_list_write(struct vsp1_dl_list *dl, u32
> reg, u32 data) * which bodies are added.
>   *
>   * Adding a body to a display list passes ownership of the body to the
> list. The - * caller must not touch the body after this call, and must not
> free it - * explicitly with vsp1_dl_body_free().
...
> error. @@ -619,7 +522,7 @@ static void vsp1_dl_list_fill_header(struct
> vsp1_dl_list *dl, bool is_last) * list was allocated.
>  	 */
> 
...
> @@ -693,9 +596,9 @@ static void vsp1_dl_list_hw_enqueue(struct vsp1_dl_list
...
> @@ -953,8 +823,21 @@ struct vsp1_dl_manager *vsp1_dlm_create(struct
> vsp1_device *vsp1,
> 
...
> b/drivers/media/platform/vsp1/vsp1_dl.h index 107eebcdbab6..6a7d48e385d5
> 100644
> --- a/drivers/media/platform/vsp1/vsp1_dl.h
> +++ b/drivers/media/platform/vsp1/vsp1_dl.h
> @@ -41,9 +41,6 @@ void vsp1_dl_body_pool_destroy(struct vsp1_dl_body_pool
> *pool); struct vsp1_dl_body *vsp1_dl_body_get(struct vsp1_dl_body_pool
> *pool); void vsp1_dl_body_put(struct vsp1_dl_body *dlb);
> 
> -struct vsp1_dl_body *vsp1_dl_body_alloc(struct vsp1_device *vsp1,
> -					unsigned int num_entries);
> -void vsp1_dl_body_free(struct vsp1_dl_body *dlb);
...
> *dlb); int vsp1_dl_list_add_chain(struct vsp1_dl_list *head, struct
> vsp1_dl_list *dl); diff --git a/drivers/media/platform/vsp1/vsp1_lut.c
> b/drivers/media/platform/vsp1/vsp1_lut.c index acbaca0f47f0..6b358617ce15
> 100644
...
> -- * Device Access
>   */
> @@ -40,11 +42,11 @@ static int lut_set_table(struct vsp1_lut *lut, struct
> v4l2_ctrl *ctrl) struct vsp1_dl_body *dlb;
>  	unsigned int i;
> 
...
>  				       ctrl->p_new.p_u32[i]);
> 
> @@ -52,7 +54,7 @@ static int lut_set_table(struct vsp1_lut *lut, struct
> v4l2_ctrl *ctrl) swap(lut->lut, dlb);
...
>  /*
> ---------------------------------------------------------------------------
> -- @@ -172,8 +174,16 @@ static void lut_configure(struct vsp1_entity
> *entity, }
>  }
> 
...
>  /*
> ---------------------------------------------------------------------------
> -- @@ -199,6 +209,15 @@ struct vsp1_lut *vsp1_lut_create(struct vsp1_device
> *vsp1) if (ret < 0)
>  		return ERR_PTR(ret);
> 
> +	/*
...
> b/drivers/media/platform/vsp1/vsp1_lut.h index dce2fdc315f6..8cb0df1b7e27
> 100644
