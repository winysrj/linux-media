...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id DF66AC43444
	for <linux-media@archiver.kernel.org>; Wed,  9 Jan 2019 11:31:08 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id 8C97421848
	for <linux-media@archiver.kernel.org>; Wed,  9 Jan 2019 11:31:08 +0000 (UTC)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730633AbfAILbH (ORCPT <rfc822;linux-media@archiver.kernel.org>);
        Wed, 9 Jan 2019 06:31:07 -0500
Received: from metis.ext.pengutronix.de ([85.220.165.71]:53899 "EHLO
        metis.ext.pengutronix.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1730755AbfAILbH (ORCPT
        <rfc822;linux-media@vger.kernel.org>); Wed, 9 Jan 2019 06:31:07 -0500
Received: from dude.hi.pengutronix.de ([2001:67c:670:100:1d::7])
        by metis.ext.pengutronix.de with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.89)
        (envelope-from <mtr@pengutronix.de>)
        id 1ghC4e-0005Fk-AF; Wed, 09 Jan 2019 12:31:04 +0100
Received: from mtr by dude.hi.pengutronix.de with local (Exim 4.91)
        (envelope-from <mtr@pengutronix.de>)
        id 1ghC4d-0003yr-Vb; Wed, 09 Jan 2019 12:31:03 +0100
...
Subject: [PATCH 3/3] [media] allegro: add SPS/PPS nal unit writer
Date:   Wed,  9 Jan 2019 12:30:37 +0100
Message-Id: <20190109113037.28430-4-m.tretter@pengutronix.de>
...
index 5d8273fff123..cd375ad11862 100644
...
@@ -1069,6 +1078,110 @@ static int allocate_reference_buffers(struct allegro_channel *channel,
 					 n, PAGE_ALIGN(size));
 }
...
+
 ...
 {
@@ -1080,6 +1193,9 @@ static void allegro_finish_frame(struct allegro_channel *channel,
 		u32 size;
 	} *partition;
...
@@ -1128,18 +1244,60 @@ static void allegro_finish_frame(struct allegro_channel *channel,
