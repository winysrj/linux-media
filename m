...
Date: Fri, 12 Sep 2008 15:31:26 +0200
References: <48CA0355.6080903@linuxtv.org> <48CA6C2E.7050908@linuxtv.org>
	<200809121529.41795.hftom@free.fr>
In-Reply-To: <200809121529.41795.hftom@free.fr>
MIME-Version: 1.0
Content-Disposition: inline
Message-Id: <200809121531.27016.hftom@free.fr>
...
Le Friday 12 September 2008 15:29:41 Christophe Thommeret, vous avez =E9cri=
t=A0:
> Le Friday 12 September 2008 15:18:38 Steven Toth, vous avez =E9crit=A0:
...
> > >> requested. This cleans up the application API nicely. Various intern=
al
...
> > >> they chose to do so. Quite a lot of changes internally and to the us=
er
> > >> facing API.
> > >>
...
> > >>
> > >> Two tree here, offering slightly different approaches, one with S2AP=
I,
...
> > >> this driver, see the set_frontend() func, it's a small change - just=
 a
...
> > >> know your thoughts. Andreas also has the multifrontend thread runnin=
g,
...
> > >>
> > >> Darron Broad has offered to bring the cx24116.c driver up to date wi=
th
