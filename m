...
Received: from arroyo.ext.ti.com ([192.94.94.40]:34499 "EHLO arroyo.ext.ti.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1752951Ab0LWLyT (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Thu, 23 Dec 2010 06:54:19 -0500
...
Subject: [PATCH v10 1/8] davinci vpbe: V4L2 display driver for DM644X SoC
Date: Thu, 23 Dec 2010 17:23:48 +0530
Message-Id: <1293105228-16834-1-git-send-email-manjunath.hadli@ti.com>
...
+
+__iomem void *reg_base_venc_vstat;
+
+static int venc_is_second_field()
+{
+	u32 val;
+	val = __raw_readl(reg_base_venc_vstat);
...
+	}
+
+	reg_base_venc_vstat = ioremap_nocache(res->start, resource_size(res));
+	if (!reg_base_venc_vstat) {
