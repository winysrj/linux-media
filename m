...
Received: from mx3.redhat.com (mx3.redhat.com [172.16.48.32])
	by int-mx2.corp.redhat.com (8.13.1/8.13.1) with ESMTP id m7VDVEPX004290
	for <video4linux-list@redhat.com>; Sun, 31 Aug 2008 09:31:15 -0400
Received: from devils.ext.ti.com (devils.ext.ti.com [198.47.26.153])
	by mx3.redhat.com (8.13.8/8.13.8) with ESMTP id m7VDV2PJ002548
	for <video4linux-list@redhat.com>; Sun, 31 Aug 2008 09:31:02 -0400
From: "Aguirre Rodriguez, Sergio Alberto" <saaguirre@ti.com>
To: Hans Verkuil <hverkuil@xs4all.nl>, "video4linux-list@redhat.com"
	<video4linux-list@redhat.com>
Date: Sun, 31 Aug 2008 08:30:55 -0500
Message-ID: <A24693684029E5489D1D202277BE8944119A4FAC@dlee02.ent.ti.com>
References: <A24693684029E5489D1D202277BE89441191E339@dlee02.ent.ti.com>,
	<200808302234.26296.hverkuil@xs4all.nl>
In-Reply-To: <200808302234.26296.hverkuil@xs4all.nl>
Content-Language: en-US
Content-Type: text/plain; charset="us-ascii"
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
Cc: "camera_team@list.ti.com - Distribution list for Camera activities \(May
...
I think that it has been detected by the list mail server to have a suspicious header name, and therefore not finally sent to the list.

I'm not at my work pc right now, but i'll be resending the patch tomorrow morning (9:00 AM, GMT -6) to see if i still have the same error.

Thanks for all the comments, we will be fixing those aswell starting tomorrow.

These set of patches should apply cleanly on top of MontaVista kernel v2.6.27-rc3. They are ready for V4L api changes until that kernel version (changes in video_device, ioctls).
