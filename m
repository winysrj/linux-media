...
Received: from lb1-smtp-cloud3.xs4all.net ([194.109.24.22]:51313 "EHLO
	lb1-smtp-cloud3.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1753292AbbFOHZN (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 15 Jun 2015 03:25:13 -0400
Message-ID: <557E7DC7.3000607@xs4all.nl>
Date: Mon, 15 Jun 2015 09:24:55 +0200
From: Hans Verkuil <hverkuil@xs4all.nl>
MIME-Version: 1.0
To: Linux Media Mailing List <linux-media@vger.kernel.org>
CC: Jan Kara <jack@suse.cz>, Andrew Morton <akpm@linux-foundation.org>
Subject: [PATCH] Revert "[media] vb2: Push mmap_sem down to memops"
