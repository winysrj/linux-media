...
Received: from mail-ey0-f174.google.com ([209.85.215.174]:34799 "EHLO
	mail-ey0-f174.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751560Ab1IEJRU (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Mon, 5 Sep 2011 05:17:20 -0400
Received: by eyx24 with SMTP id 24so3314264eyx.19
        for <linux-media@vger.kernel.org>; Mon, 05 Sep 2011 02:17:19 -0700 (PDT)
Date: Mon, 5 Sep 2011 09:17:13 +0000 (UTC)
From: Bastian Hecht <hechtb@googlemail.com>
To: linux-media@vger.kernel.org
cc: Guennadi Liakhovetski <g.liakhovetski@gmx.de>,
	Laurent Pinchart <laurent.pinchart@ideasonboard.com>
Subject: [PATCH 1/2 v3] media: Add support for arbitrary resolution for the
 ov5642 camera driver
Message-ID: <alpine.DEB.2.02.1109050915070.26655@ipanema>
MIME-Version: 1.0
...
+static int ov5642_g_fmt(struct v4l2_subdev *sd, struct v4l2_mbus_framefmt *mf)
 {
 	struct i2c_client *client = v4l2_get_subdevdata(sd);
 	struct ov5642 *priv = to_ov5642(client);
@@ -793,8 +834,8 @@ static int ov5642_g_fmt(struct v4l2_subdev *sd,
...
+	mf->height	= priv->crop_rect.height;
 	...
 	return 0;
@@ -827,15 +868,44 @@ static int ov5642_g_chip_ident(struct v4l2_subdev *sd,
 	return 0;
 }
...
@@ -844,8 +914,8 @@ static int ov5642_cropcap(struct v4l2_subdev *sd, struct v4l2_cropcap *a)
 {
 	a->bounds.left			= 0;
 	a->bounds.top			= 0;
...
@@ -858,9 +928,8 @@ static int ov5642_g_mbus_config(struct v4l2_subdev *sd,
...
@@ -870,6 +939,7 @@ static struct v4l2_subdev_video_ops ov5642_subdev_video_ops = {
...
@@ -941,8 +1011,17 @@ static int ov5642_probe(struct i2c_client *client,
...
+	priv->total_height = BLANKING_MIN_HEIGHT;
 	...
 	if (ret < 0)
@@ -951,6 +1030,7 @@ static int ov5642_probe(struct i2c_client *client,
 	return 0;
...
@@ -961,6 +1041,7 @@ static int ov5642_remove(struct i2c_client *client)
