...
Received: from lb1-smtp-cloud9.xs4all.net ([194.109.24.22]:52351 "EHLO
        lb1-smtp-cloud9.xs4all.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S967532AbeBNLwl (ORCPT
...
Subject: [PATCH for v4.4 06/14] media: v4l2-compat-ioctl32.c: avoid sizeof(type)
