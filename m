...
Received: from lb2-smtp-cloud9.xs4all.net ([194.109.24.26]:45260 "EHLO
        lb2-smtp-cloud9.xs4all.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S967455AbeBNLoh (ORCPT
...
Subject: [PATCH for v4.14 12/13] media: v4l2-compat-ioctl32.c: refactor compat ioctl32 logic
