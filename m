...
Received: from mga05.intel.com ([192.55.52.43]:41067 "EHLO mga05.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1752408AbdEZBUK (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Thu, 25 May 2017 21:20:10 -0400
...
Date: Fri, 26 May 2017 01:19:59 +0000
Message-ID: <8408A4B5C50F354EA5F62D9FC805153D018D4DD9@ORSMSX115.amr.corp.intel.com>
...
1. Responses embedded below. Already submitted v2 patch to address these comments.
2. Can you submit <URL:https://git.linuxtv.org/sailus/media_tree.git/log/?h=ctrl-setup-unlocked>?

-----Original Message-----
>From: Sakari Ailus [mailto:sakari.ailus@iki.fi] 
>Sent: Thursday, May 4, 2017 1:49 AM
...
>Indentation.
>
Reduced indentation to single tab
>> +				};
>> +
>> +struct ov5670 {
...
>> +	int link_freq_index;
>
>You can use link_freq->val .
>
Removed link_freq_index from struct ov5670.
>> +
>> +	bool streaming;
>> +};
>> +
...
>
>You can use ctrl->val here directly.
>
Used ctrl->val directly.
>> +}
>> +
>> +/* Exposure control */
...
>
>Link frequency should be a read-only control. Could you use
>V4L2_CTRL_FLAG_READ_ONLY instead? Use v4l2_ctrl_s_ctrl() to change its
>value.
>
>Although... you have just a single value for now.
>
Made link frequency V4L2_CTRL_FLAG_READ_ONLY control.
>> +
...
>> +			ret);
>
>This could fail once you make changes to how controls are created but it's
>not needed after development time. How about removing the message?
>
Deleted debug print.
>> +		goto error;
>> +	}
...
>
>You have no use for ov5670 argument.
>
...
>> +		fmt->format = *framefmt;
>
>You could do without framefmt.
>
Did without framefmt.
>> +	} else {
...
>
>Instead of returning an error you should adjust the format instead. I.e. in
>this case just assign it to fmt->format.code.
>
Adjusted format code.
>> +		mutex_unlock(&ov5670->mutex);
>> +		return -EINVAL;
>> +	}
>> +
...
>> +		*framefmt = fmt->format;
>
>You could do without framefmt. Up to you.
>
Did.
>> +	} else {
...
>
>I'd just return what v4l2_ctrl_handler_setup() does and remove the error
>message.
>
Did.
>> +	if (ret) {
...
>
>Please remove #ifdef and use __maybe_unused instead. It's not easy to get
>the #ifdefs right in all cases.
>
Used __maybe_unused.
>> +{
...
>
>In ACPI based systems the device power management is handled by ACPI. Could
>you add runtime PM support for this driver as well, so the device can be
...
>
>Could you use SET_SYSTEM_SLEEP_PM_OPS() to set these?
>
Used.
>> +};
>> +
