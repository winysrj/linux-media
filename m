...
Received: from lb1-smtp-cloud3.xs4all.net ([194.109.24.22]:51683 "EHLO
	...
	by vger.kernel.org with ESMTP id S1753558AbcHQGaA (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 17 Aug 2016 02:30:00 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Songjun Wu <songjun.wu@microchip.com>,
	Hans Verkuil <hans.verkuil@cisco.com>
Subject: [RFC PATCH 6/7] atmel-isi: remove dependency of the soc-camera framework
Date: Wed, 17 Aug 2016 08:29:42 +0200
Message-Id: <1471415383-38531-7-git-send-email-hverkuil@xs4all.nl>
...
-	struct soc_camera_host *ici = to_soc_camera_host(icd->parent);
-	struct atmel_isi *isi = ici->priv;
+	struct atmel_isi *isi = vb->vb2_queue->drv_priv;
 	unsigned long size;
...
+	spin_lock_irqsave(&isi->irqlock, flags);
 	...
 	if (isi->active == NULL) {
@@ -457,60 +433,68 @@ static void buffer_queue(struct vb2_buffer *vb)
...
@@ -520,7 +504,7 @@ static void stop_streaming(struct vb2_queue *vq)
 			msleep(1);
...
@@ -531,9 +515,9 @@ static void stop_streaming(struct vb2_queue *vq)
...
@@ -548,380 +532,256 @@ static struct vb2_ops isi_video_qops = {
...
@@ -930,50 +790,19 @@ static int isi_camera_set_bus_param(struct soc_camera_device *icd)
...
@@ -1021,13 +850,356 @@ static int atmel_isi_parse_dt(struct atmel_isi *isi,
 	return 0;
 }
...
+	for (i = 0; i < VIDEO_MAX_FRAME; i++) {
 		...
 		isi->dma_desc[i].fbd_phys = isi->fb_descriptors_phys +
 					i * sizeof(struct fbd);
@@ -1089,41 +1306,49 @@ static int atmel_isi_probe(struct platform_device *pdev)
 	}
 	isi->irq = irq;
...
@@ -1131,9 +1356,7 @@ static int atmel_isi_runtime_suspend(struct device *dev)
 }
...
@@ -1151,15 +1374,16 @@ static const struct of_device_id atmel_isi_of_match[] = {
