...
Received: from bombadil.infradead.org ([18.85.46.34]:42583 "EHLO
	bombadil.infradead.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752423AbZDTROG convert rfc822-to-8bit (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 20 Apr 2009 13:14:06 -0400
Date: Mon, 20 Apr 2009 14:14:00 -0300
From: Mauro Carvalho Chehab <mchehab@infradead.org>
To: Uri Shkolnik <urishk@yahoo.com>
Cc: LinuxML <linux-media@vger.kernel.org>
Subject: Re: [PATCH] [0904_10] Siano: smsdvb - add events mechanism
Message-ID: <20090420141400.359e39b9@pedra.chehab.org>
In-Reply-To: <272905.65085.qm@web110814.mail.gq1.yahoo.com>
References: <272905.65085.qm@web110814.mail.gq1.yahoo.com>
Mime-Version: 1.0
...
On Mon, 20 Apr 2009 09:56:26 -0700 (PDT)
...
This makes the above patch meaningless. If you first need to create this function, then add the function first, then add its call at the proper places, otherwise, it is impossible for someone that it is reviewing your patch series what are you doing with it.
> 
...
The same applies to the parts: first add the function, then add the function calls (or do both on the same patch), not the reverse.
