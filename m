...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id DEC2FC64E75
	for <linux-media@archiver.kernel.org>; Mon, 24 Dec 2018 17:00:52 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id 9E3FC21B69
	for <linux-media@archiver.kernel.org>; Mon, 24 Dec 2018 17:00:52 +0000 (UTC)
Authentication-Results: mail.kernel.org;
	dkim=pass (1024-bit key) header.d=nextdimension.cc header.i=@nextdimension.cc header.b="qoUrW+4f"
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725790AbeLXRAw (ORCPT <rfc822;linux-media@archiver.kernel.org>);
        Mon, 24 Dec 2018 12:00:52 -0500
Received: from goldenrod.birch.relay.mailchannels.net ([23.83.209.74]:6495
        "EHLO goldenrod.birch.relay.mailchannels.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1725747AbeLXRAv (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Mon, 24 Dec 2018 12:00:51 -0500
X-Sender-Id: dreamhost|x-authsender|brad@nextdimension.ws
Received: from relay.mailchannels.net (localhost [127.0.0.1])
        by relay.mailchannels.net (Postfix) with ESMTP id 75E69502B5B;
        Mon, 24 Dec 2018 17:00:50 +0000 (UTC)
Received: from pdx1-sub0-mail-a7.g.dreamhost.com (unknown [100.96.29.126])
        (Authenticated sender: dreamhost)
        by relay.mailchannels.net (Postfix) with ESMTPA id 22F4A5028DF;
        Mon, 24 Dec 2018 17:00:50 +0000 (UTC)
X-Sender-Id: dreamhost|x-authsender|brad@nextdimension.ws
Received: from pdx1-sub0-mail-a7.g.dreamhost.com (pop.dreamhost.com
 [64.90.62.162])
        ...
        Mon, 24 Dec 2018 17:00:50 +0000
X-MC-Relay: Neutral
X-MailChannels-SenderId: dreamhost|x-authsender|brad@nextdimension.ws
X-MailChannels-Auth-Id: dreamhost
X-Drop-Descriptive: 3b2b0a29202d56f6_1545670850325_1896202625
X-MC-Loop-Signature: 1545670850325:3767902311
X-MC-Ingress-Time: 1545670850325
Received: from pdx1-sub0-mail-a7.g.dreamhost.com (localhost [127.0.0.1])
        by pdx1-sub0-mail-a7.g.dreamhost.com (Postfix) with ESMTP id B80E280166;
        Mon, 24 Dec 2018 09:00:49 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha1; c=relaxed; d=nextdimension.cc; h=from
        :to:cc:subject:date:message-id:in-reply-to:references; s=
        nextdimension.cc; bh=GcaEOVLdql7MEy27bkeLywe7ZPc=; b=qoUrW+4faeZ
        sgYgouR9soZUuP4VknlrJvR1rUFZafymi+wUdjnrleV1ohUuUuEay1pdcAk6Bv7T
        ItU2UKZ/ejrBmNddVBRoxwqPD3w2093YgBEDGdd1k7BX8+8uH2r4zliX9V2Ysg7T
        lY6PNkbRLTPJXceT0b5pKOSsTFaXdPKI=
Received: from localhost.localdomain (66-90-189-166.dyn.grandenetworks.net [66.90.189.166])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-SHA256 (128/128 bits))
        (No client certificate requested)
        (Authenticated sender: brad@nextdimension.ws)
        by pdx1-sub0-mail-a7.g.dreamhost.com (Postfix) with ESMTPSA id 3A1CC8016D;
        Mon, 24 Dec 2018 09:00:49 -0800 (PST)
...
Date:   Mon, 24 Dec 2018 11:00:34 -0600
Message-Id: <1545670836-24035-3-git-send-email-brad@nextdimension.cc>
