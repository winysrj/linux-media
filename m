...
Received: from relay1-d.mail.gandi.net ([217.70.183.193]:55751 "EHLO
        relay1-d.mail.gandi.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1751927AbeEOHRO (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Tue, 15 May 2018 03:17:14 -0400
Date: Tue, 15 May 2018 09:17:04 +0200
...
Subject: Re: [PATCH v16 2/2] rcar-csi2: add Renesas R-Car MIPI CSI-2 receiver
 driver
Message-ID: <20180515071704.GO5956@w540>
References: <20180515005635.25715-1-niklas.soderlund+renesas@ragnatech.se>
 <20180515005635.25715-3-niklas.soderlund+renesas@ragnatech.se>
MIME-Version: 1.0
Content-Type: multipart/signed; micalg=pgp-sha1;
        protocol="application/pgp-signature"; boundary="BnCwdHgQ2ZomtW9r"
Content-Disposition: inline
In-Reply-To: <20180515005635.25715-3-niklas.soderlund+renesas@ragnatech.se>
...
On Tue, May 15, 2018 at 02:56:35AM +0200, Niklas S=C3=B6derlund wrote:
...
> index 0000000000000000..e64f07fe184e7675
> --- /dev/null
...
> +};
> +
> +static const struct rcsi2_mbps_reg phtw_mbps_h3_v3h_m3n[] =3D {
> +	{ .mbps =3D   80, .reg =3D 0x86 },
> +	{ .mbps =3D   90, .reg =3D 0x86 },
> +	{ .mbps =3D  100, .reg =3D 0x87 },
> +	{ .mbps =3D  110, .reg =3D 0x87 },
> +	{ .mbps =3D  120, .reg =3D 0x88 },
> +	{ .mbps =3D  130, .reg =3D 0x88 },
> +	{ .mbps =3D  140, .reg =3D 0x89 },
> +	{ .mbps =3D  150, .reg =3D 0x89 },
> +	{ .mbps =3D  160, .reg =3D 0x8a },
> +	{ .mbps =3D  170, .reg =3D 0x8a },
> +	{ .mbps =3D  180, .reg =3D 0x8b },
> +	{ .mbps =3D  190, .reg =3D 0x8b },
> +	{ .mbps =3D  205, .reg =3D 0x8c },
> +	{ .mbps =3D  220, .reg =3D 0x8d },
> +	{ .mbps =3D  235, .reg =3D 0x8e },
> +	{ .mbps =3D  250, .reg =3D 0x8e },
> +	{ /* sentinel */ },
> +};
> +
...
> +
> +static const struct rcsi2_mbps_reg hsfreqrange_h3_v3h_m3n[] =3D {
> +	{ .mbps =3D   80, .reg =3D 0x00 },
...
> +	{ .mbps =3D  450, .reg =3D 0x16 },
> +	{ .mbps =3D  500, .reg =3D 0x26 },
...
> +};
> +
> +static const struct rcsi2_mbps_reg hsfreqrange_m3w_h3es1[] =3D {
> +	{ .mbps =3D   80,	.reg =3D 0x00 },
> +	{ .mbps =3D   90,	.reg =3D 0x10 },
> +	{ .mbps =3D  100,	.reg =3D 0x20 },
> +	{ .mbps =3D  110,	.reg =3D 0x30 },
...
> +}
> +
> +static struct platform_driver rcar_csi2_pdrv =3D {
...

5hG52P1ERUqX9t9RoUfl
=n2c3
-----END PGP SIGNATURE-----
