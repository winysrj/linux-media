...
Received: from lb3-smtp-cloud3.xs4all.net ([194.109.24.30]:32963 "EHLO
	...
	by vger.kernel.org with ESMTP id S1753762AbaLDJ4W (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 4 Dec 2014 04:56:22 -0500
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: g.liakhovetski@gmx.de, laurent.pinchart@ideasonboard.com,
	prabhakar.csengg@gmail.com, Hans Verkuil <hans.verkuil@cisco.com>
Subject: [RFC PATCH 7/8] v4l2-subdev: remove enum_framesizes/intervals
Date: Thu,  4 Dec 2014 10:54:58 +0100
Message-Id: <1417686899-30149-8-git-send-email-hverkuil@xs4all.nl>
...
+	ret = sensor_call(cam, pad, enum_frame_interval,
+			  cam->sensor->pad_configs, &fie);
 	mutex_unlock(&cam->s_mutex);
-	return ret;
+	if (ret)
+		return ret;
...
index f4be2a1..b8a2815 100644
--- a/drivers/media/platform/soc_camera/soc_camera.c
+++ b/drivers/media/platform/soc_camera/soc_camera.c
@@ -1906,22 +1906,33 @@ static int default_enum_framesizes(struct soc_camera_device *icd,
 	int ret;
...
+	ret = v4l2_subdev_call(sd, pad, enum_frame_size, sd->pad_configs, &fse);
 	if (ret < 0)
 		return ret;
