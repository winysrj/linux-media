...
Received: from mail-qk0-f172.google.com ([209.85.220.172]:34120 "EHLO
        mail-qk0-f172.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1752039AbcKHQMg (ORCPT
        <rfc822;linux-media@vger.kernel.org>); Tue, 8 Nov 2016 11:12:36 -0500
Received: by mail-qk0-f172.google.com with SMTP id q130so222512126qke.1
        for <linux-media@vger.kernel.org>; Tue, 08 Nov 2016 08:11:42 -0800 (PST)
MIME-Version: 1.0
In-Reply-To: <CANgUfueAGBgM3MtzH1qvgaPFM9JsCSCsy2J0tmjGkT_krrpzaQ@mail.gmail.com>
References: <1478584830-15695-1-git-send-email-matt@ranostay.consulting> <CANgUfueAGBgM3MtzH1qvgaPFM9JsCSCsy2J0tmjGkT_krrpzaQ@mail.gmail.com>
From: Matt Ranostay <matt@ranostay.consulting>
Date: Tue, 8 Nov 2016 08:11:41 -0800
Message-ID: <CAJ_EiSTH0HamV2tsx9N13AyPKuLo-fskgcuXKP6xUdDz7YXjGA@mail.gmail.com>
Subject: Re: [PATCH v2] media: i2c-polling: add i2c-polling driver
To: Ozgur <okaratas@member.fsf.org>
...
On Mon, Nov 7, 2016 at 11:03 PM, Ozgur <okaratas@member.fsf.org> wrote:
> Dear Matt;
>
...
>> index 000000000000..807f3aa84245
>> --- /dev/null
>> +++ b/drivers/media/i2c/i2c-polling.c
>> @@ -0,0 +1,469 @@
>> +/*
...
>> +
>> +       strlcpy(vcap->bus_info, "I2C:i2c-polling",
...
>> +       strlcpy(v4l2_dev->name, I2C_POLLING_DRIVER,
...
>> +
>> +       strlcpy(data->vdev.name, "I2C Polling Video",
>> sizeof(data->vdev.name));
>> +
