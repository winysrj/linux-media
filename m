...
Received: from arroyo.ext.ti.com ([192.94.94.40]:43787 "EHLO arroyo.ext.ti.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1758023AbZKRSe4 (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Wed, 18 Nov 2009 13:34:56 -0500
...
Date: Wed, 18 Nov 2009 13:34:49 -0500
Message-Id: <1258569289-4635-1-git-send-email-m-karicheri2@ti.com>
...
+	v4l2_bt_timings \
 ...
 ERRORS = \
 	EACCES \
diff -uNr v4l-dvb-aba823ecaea6/media-specs/v4l/common.xml v4l-dvb-aba823ecaea6_new/media-specs/v4l/common.xml
--- v4l-dvb-aba823ecaea6/media-specs/v4l/common.xml	2009-11-12 09:21:05.000000000 -0500
+++ v4l-dvb-aba823ecaea6_new/media-specs/v4l/common.xml	2009-11-18 12:13:34.000000000 -0500
@@ -716,6 +716,41 @@
 }
       </programlisting>
     </example>
...
+  	</section>
   ...
   &sub-controls;
diff -uNr v4l-dvb-aba823ecaea6/media-specs/v4l/v4l2.xml v4l-dvb-aba823ecaea6_new/media-specs/v4l/v4l2.xml
--- v4l-dvb-aba823ecaea6/media-specs/v4l/v4l2.xml	2009-11-12 09:21:05.000000000 -0500
+++ v4l-dvb-aba823ecaea6_new/media-specs/v4l/v4l2.xml	2009-11-18 12:13:57.000000000 -0500
@@ -416,6 +416,10 @@
     &sub-enum-frameintervals;
     &sub-enuminput;
     &sub-enumoutput;
...
+    &sub-g-dv-timings;
     ...
     &sub-g-audio;
     &sub-g-audioout;
diff -uNr v4l-dvb-aba823ecaea6/media-specs/v4l/vidioc-enum-dv-presets.xml v4l-dvb-aba823ecaea6_new/media-specs/v4l/vidioc-enum-dv-presets.xml
--- v4l-dvb-aba823ecaea6/media-specs/v4l/vidioc-enum-dv-presets.xml	1969-12-31 19:00:00.000000000 -0500
+++ v4l-dvb-aba823ecaea6_new/media-specs/v4l/vidioc-enum-dv-presets.xml	2009-11-18 12:14:25.000000000 -0500
@@ -0,0 +1,167 @@
+<refentry id="vidioc-enum-dv-presets">
+  <refmeta>
+    <refentrytitle>ioctl VIDIOC_ENUM_DV_PRESETS</refentrytitle>
...
+End:
+-->
diff -uNr v4l-dvb-aba823ecaea6/media-specs/v4l/vidioc-enuminput.xml v4l-dvb-aba823ecaea6_new/media-specs/v4l/vidioc-enuminput.xml
--- v4l-dvb-aba823ecaea6/media-specs/v4l/vidioc-enuminput.xml	2009-11-12 09:21:05.000000000 -0500
+++ v4l-dvb-aba823ecaea6_new/media-specs/v4l/vidioc-enuminput.xml	2009-11-18 12:14:54.000000000 -0500
@@ -124,7 +124,13 @@
 	  </row>
 	  <row>
 	    <entry>__u32</entry>
...
+    </table>
   ...
   <refsect1>
diff -uNr v4l-dvb-aba823ecaea6/media-specs/v4l/vidioc-enumoutput.xml v4l-dvb-aba823ecaea6_new/media-specs/v4l/vidioc-enumoutput.xml
--- v4l-dvb-aba823ecaea6/media-specs/v4l/vidioc-enumoutput.xml	2009-11-12 09:21:05.000000000 -0500
+++ v4l-dvb-aba823ecaea6_new/media-specs/v4l/vidioc-enumoutput.xml	2009-11-18 12:15:09.000000000 -0500
@@ -114,7 +114,13 @@
 	  </row>
 	  <row>
 	    <entry>__u32</entry>
...
+
   ...
   <refsect1>
     &return-value;
diff -uNr v4l-dvb-aba823ecaea6/media-specs/v4l/vidioc-g-dv-preset.xml v4l-dvb-aba823ecaea6_new/media-specs/v4l/vidioc-g-dv-preset.xml
--- v4l-dvb-aba823ecaea6/media-specs/v4l/vidioc-g-dv-preset.xml	1969-12-31 19:00:00.000000000 -0500
+++ v4l-dvb-aba823ecaea6_new/media-specs/v4l/vidioc-g-dv-preset.xml	2009-11-18 12:15:31.000000000 -0500
@@ -0,0 +1,103 @@
+<refentry id="vidioc-g-dv-preset">
+  <refmeta>
+    <refentrytitle>ioctl VIDIOC_G_DV_PRESET, VIDIOC_S_DV_PRESET</refentrytitle>
...
+End:
+-->
diff -uNr v4l-dvb-aba823ecaea6/media-specs/v4l/vidioc-g-dv-timings.xml v4l-dvb-aba823ecaea6_new/media-specs/v4l/vidioc-g-dv-timings.xml
--- v4l-dvb-aba823ecaea6/media-specs/v4l/vidioc-g-dv-timings.xml	1969-12-31 19:00:00.000000000 -0500
+++ v4l-dvb-aba823ecaea6_new/media-specs/v4l/vidioc-g-dv-timings.xml	2009-11-18 12:15:42.000000000 -0500
@@ -0,0 +1,195 @@
+<refentry id="vidioc-g-dv-timings">
+  <refmeta>
+    <refentrytitle>ioctl VIDIOC_G_DV_TIMINGS, VIDIOC_S_DV_TIMINGS</refentrytitle>
...
+End:
+-->
diff -uNr v4l-dvb-aba823ecaea6/media-specs/v4l/vidioc-query-dv-preset.xml v4l-dvb-aba823ecaea6_new/media-specs/v4l/vidioc-query-dv-preset.xml
--- v4l-dvb-aba823ecaea6/media-specs/v4l/vidioc-query-dv-preset.xml	1969-12-31 19:00:00.000000000 -0500
+++ v4l-dvb-aba823ecaea6_new/media-specs/v4l/vidioc-query-dv-preset.xml	2009-11-18 12:15:53.000000000 -0500
@@ -0,0 +1,80 @@
+<refentry id="vidioc-query-dv-preset">
+  <refmeta>
+    <refentrytitle>ioctl VIDIOC_QUERY_DV_PRESET</refentrytitle>
