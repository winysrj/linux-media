...
Received: from mail.kapsi.fi ([217.30.184.167]:35529 "EHLO mail.kapsi.fi"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1755583Ab2EGI3G (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Mon, 7 May 2012 04:29:06 -0400
Message-ID: <4FA787D0.40000@iki.fi>
Date: Mon, 07 May 2012 11:29:04 +0300
From: Antti Palosaari <crope@iki.fi>
MIME-Version: 1.0
To: Thomas Mair <thomas.mair86@googlemail.com>
CC: linux-media@vger.kernel.org, hfvogt@gmx.net,
	poma <pomidorabelisima@gmail.com>, gennarone@gmail.com
...
There is one log2 in DVB core routines and IIRC other can be found from 
the Kernel common functions.
...
This is wrong as it imports tuner IDs from the DVB USB driver.
...
If you would like to read signal strength from the tuner then callback 
must be implemented inside tuner driver. Then just override demod 
.read_signal_strength() with tuner .get_rf_strength() after tuner is 
attached.
...
Hey, whats here! You should not export any chip internals like register 
names that way. Those are only for that driver and should be inside 
rtl2832_priv.h
...
That, xtal, does not belong here. And it is not even used.
