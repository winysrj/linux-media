...
Received: from smtp-vbr13.xs4all.nl ([194.109.24.33]:3206 "EHLO
	smtp-vbr13.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1754102Ab0BVT4G (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 22 Feb 2010 14:56:06 -0500
From: Hans Verkuil <hverkuil@xs4all.nl>
To: Sakari Ailus <sakari.ailus@maxwell.research.nokia.com>
Subject: Re: [PATCH 4/6] V4L: Events: Add backend
Date: Mon, 22 Feb 2010 20:58:36 +0100
Cc: linux-media@vger.kernel.org, laurent.pinchart@nokia.com,
	david.cohen@nokia.com
References: <4B82A7FB.50505@maxwell.research.nokia.com> <1266853897-25749-3-git-send-email-sakari.ailus@maxwell.research.nokia.com> <1266853897-25749-4-git-send-email-sakari.ailus@maxwell.research.nokia.com>
In-Reply-To: <1266853897-25749-4-git-send-email-sakari.ailus@maxwell.research.nokia.com>
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="iso-8859-6"
Content-Transfer-Encoding: 7bit
Message-Id: <201002222058.36870.hverkuil@xs4all.nl>
...
>  
> @@ -60,5 +63,7 @@ void v4l2_fh_exit(struct v4l2_fh *fh)
>  		return;
>  
>  	fh->vdev = NULL;
> +
