...
Received: from mga17.intel.com ([192.55.52.151]:60916 "EHLO mga17.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726507AbeIYJ7R (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Tue, 25 Sep 2018 05:59:17 -0400
...
Message-ID: <93059dcc-6091-02a0-2f4e-3b4cf182aa56@linux.intel.com>
Date: Tue, 25 Sep 2018 11:57:31 +0800
MIME-Version: 1.0
In-Reply-To: <20180921120647.slvwe3jljupruo2z@kekkonen.localdomain>
...
> Hi Bingbu,
>
> On Fri, Sep 21, 2018 at 05:41:55PM +0800, bingbu.cao@intel.com wrote:
...
>> index 000000000000..5e80b113c386
>> --- /dev/null
...
>> +const static s64 link_freq_menu_items[] = {
>> +	IMX319_LINK_FREQ_DEFAULT,
>> +};
>> +
>> +static struct imx319_hwcfg def_hwcfg;
>> +
>> +/* Mode configs */
...
>> +	struct imx319_hwcfg *hwcfg = &def_hwcfg;
...
>> +	int ret;
>> +
>> +	num = ARRAY_SIZE(link_freq_menu_items);
>> +	if (!fwnode && num) {
> Where do you need this?
Sakari,
I think it also need get the default link frequency even if there is no fwnode support from system.
And as the link_freq_menu_items is const, so I move getting link frequency from static data here.
Do you have any suggestion?

>
>> +		hwcfg->link_freqs = devm_kcalloc(dev, num + 1,
>> +						 sizeof(*hwcfg->link_freqs),
>> +						 GFP_KERNEL);
>> +		for (i = 0; i < num; i++)
>> +			hwcfg->link_freqs[i] = link_freq_menu_items[i];
>> +
>> +		return hwcfg;
>> +	}
>> +
...
>> +	imx319->link_def_freq = imx319->hwcfg->link_freqs[0];
>> +	if (imx319->link_def_freq != IMX319_LINK_FREQ_DEFAULT) {
>> +		dev_err(&client->dev, "link frequency is not supported");
>> +		ret = -EINVAL;
>> +		goto error_probe;
>> +	}
>> +
