...
Received: from bombadil.infradead.org ([18.85.46.34]:33358 "EHLO
	bombadil.infradead.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752465AbZCPLiS (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 16 Mar 2009 07:38:18 -0400
Date: Mon, 16 Mar 2009 08:37:47 -0300
...
Message-ID: <20090316083747.3331f140@gaivota.chehab.org>
In-Reply-To: <20090316080944.17115a46@gaivota.chehab.org>
References: <37140.62.70.2.252.1237200252.squirrel@webmail.xs4all.nl>
	<20090316080944.17115a46@gaivota.chehab.org>
Mime-Version: 1.0
...
> --- a/linux/drivers/media/video/bt8xx/bttv-cards.c	Sun Mar 15 10:53:32 2009 +0100
> +++ b/linux/drivers/media/video/bt8xx/bttv-cards.c	Sun Mar 15 13:07:15 2009 +0100
> @@ -97,12 +97,8 @@ static unsigned int tuner[BTTV_MAX]  = {
>  static unsigned int tuner[BTTV_MAX]  = { [ 0 ... (BTTV_MAX-1) ] = UNSET };
>  static unsigned int svhs[BTTV_MAX]   = { [ 0 ... (BTTV_MAX-1) ] = UNSET };
>  static unsigned int remote[BTTV_MAX] = { [ 0 ... (BTTV_MAX-1) ] = UNSET };
> +static unsigned int tvaudio[BTTV_MAX] = { [0 ... (BTTV_MAX - 1)] = UNSET };
...
As already discussed, instead of removing, just print some warning if people
use this parameter. The printed message should ideally direct to some wiki page
...
> +MODULE_PARM_DESC(tvaudio, "specify whether tvaudio should be loaded (1) or not (0),"
...
boards with bttv being selled in the market. We should test if !TUNER_ABSENT
...
Why aren't you probing first at I2C_ADDR_MSP3400? You're changing the behaviour
...
Why do you need to probe it twice? Shouldn't it be just one probing for both addresses?
...
> +		printk(KERN_INFO "bttv%d: if you need to set the tvaudio module option to %d, then the\n",
> +				btv->c.nr, load_tvaudio);
> +		printk(KERN_INFO "bttv%d: definition for card type %d needs to be updated.\n",
> +				btv->c.nr, btv->c.type);
> +		printk(KERN_INFO "bttv%d: please report this to the bttv maintainer.\n", btv->c.nr);

This is not what I call "tvaudio autodectect" (that should be the default way,
as the comments for tvaudio option states).

A bttv board should have some audio chip otherwise audio won't work.

I dunno if is there any supported card without audio at all, but probably, if
we have, this is by far much less than boards with an audio chip.

Based on this principle, IMO, the probing function should, by default, probe
for tvaudio, if it doesn't find another audio device. You may eventually ask
...
We should preserve the same probing order as before, in order to reduce breakage risks.
...
No audio module found. This requires printing a warning, since the board won't have audio working. 
...
>  	} else {
>  		btv->has_radio    = 0;
> --- a/linux/drivers/media/video/bt8xx/bttv-driver.c	Sun Mar 15 10:53:32 2009 +0100
> +++ b/linux/drivers/media/video/bt8xx/bttv-driver.c	Sun Mar 15 13:07:15 2009 +0100
...
>  	return cmd.result;
>  }
> --- a/linux/drivers/media/video/bt8xx/bttv-i2c.c	Sun Mar 15 10:53:32 2009 +0100
> +++ b/linux/drivers/media/video/bt8xx/bttv-i2c.c	Sun Mar 15 13:07:15 2009 +0100
> @@ -35,8 +35,6 @@
...
> --- a/linux/drivers/media/video/bt8xx/bttv.h	Sun Mar 15 10:53:32 2009 +0100
> +++ b/linux/drivers/media/video/bt8xx/bttv.h	Sun Mar 15 13:07:15 2009 +0100
...
> --- a/linux/drivers/media/video/bt8xx/bttvp.h	Sun Mar 15 10:53:32 2009 +0100
> +++ b/linux/drivers/media/video/bt8xx/bttvp.h	Sun Mar 15 13:07:15 2009 +0100
