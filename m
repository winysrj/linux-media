...
Received: from bombadil.infradead.org ([198.137.202.9]:55256 "EHLO
	bombadil.infradead.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1759133AbaKANjG (ORCPT
...
Subject: [PATCH 7/7] [media] cx231xx: disable I2C errors during i2c_scan
Date: Sat,  1 Nov 2014 11:38:59 -0200
Message-Id: <7afd2c8e04f8311fc82095152a4490106e870fc3.1414849031.git.mchehab@osg.samsung.com>
...
index 9b7e5a155e34..04924aff4899 100644
--- a/drivers/media/usb/cx231xx/cx231xx-i2c.c
+++ b/drivers/media/usb/cx231xx/cx231xx-i2c.c
@@ -495,6 +495,9 @@ void cx231xx_do_i2c_scan(struct cx231xx *dev, int i2c_port)
 	if (!i2c_scan)
 		return;
...
@@ -511,6 +514,8 @@ void cx231xx_do_i2c_scan(struct cx231xx *dev, int i2c_port)
 	}
