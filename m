...
Received: from arroyo.ext.ti.com ([192.94.94.40]:35097 "EHLO arroyo.ext.ti.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1753626Ab1AJMlN (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Mon, 10 Jan 2011 07:41:13 -0500
From: manjunatha_halli@ti.com
To: mchehab@infradead.org, hverkuil@xs4all.nl
Cc: linux-kernel@vger.kernel.org, linux-media@vger.kernel.org,
	Manjunatha Halli <manjunatha_halli@ti.com>
Subject: [RFC V9 4/7] drivers:media:radio: wl128x: FM driver RX sources
Date: Mon, 10 Jan 2011 08:04:57 -0500
Message-Id: <1294664700-26949-5-git-send-email-manjunatha_halli@ti.com>
...
+u32 fm_rx_get_currband_freq_range(struct fmdev *fmdev, u32 *bot_freq, u32 *top_freq)
+{
+	if (bot_freq != NULL)
...
+u32 fm_rx_get_currband_freq_range(struct fmdev *,
+					u32 *, u32 *);
