...
Received: from devils.ext.ti.com ([198.47.26.153]:36382 "EHLO
	devils.ext.ti.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752433Ab1KLNTM (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sat, 12 Nov 2011 08:19:12 -0500
Received: from dbdp20.itg.ti.com ([172.24.170.38])
	by devils.ext.ti.com (8.13.7/8.13.7) with ESMTP id pACDJ9QA023256
...
Subject: [RFC PATCH v4 7/8] davinci: vpfe: v4l2 capture driver with media interface
Date: Sat, 12 Nov 2011 18:49:01 +0530
Message-ID: <1321103942-2778-8-git-send-email-manjunath.hadli@ti.com>
...
+	if (ret < 0) {
+		v4l2_err(&vpfe_dev->v4l2_dev, "Error: requesting IMP"
+				" IRQ interrupt\n");
+		free_irq(vpfe_dev->ccdc_irq1, vpfe_dev);
+		free_irq(vpfe_dev->ccdc_irq0, vpfe_dev);
+		return ret;
