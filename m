...
Received: from mga18.intel.com ([134.134.136.126]:58249 "EHLO mga18.intel.com"
        ...
        id S1728156AbeJ3HRv (ORCPT <rfc822;linux-media@vger.kernel.org>);
...
Subject: [PATCH v7 04/16] intel-ipu3: abi: Add register definitions and enum
Date: Mon, 29 Oct 2018 15:22:58 -0700
Message-Id: <1540851790-1777-5-git-send-email-yong.zhi@intel.com>
