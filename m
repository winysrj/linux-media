...
Received: from mail-wg0-f44.google.com ([74.125.82.44]:37917 "EHLO
	mail-wg0-f44.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752621Ab2GLLfk (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 12 Jul 2012 07:35:40 -0400
Received: by wgbdr13 with SMTP id dr13so2008242wgb.1
        for <linux-media@vger.kernel.org>; Thu, 12 Jul 2012 04:35:38 -0700 (PDT)
...
Subject: [PATCH 1/2 v2] media: Add mem2mem deinterlacing driver.
Date: Thu, 12 Jul 2012 13:35:28 +0200
Message-Id: <1342092929-31590-1-git-send-email-javier.martin@vista-silicon.com>
...
+	switch (s_q_data->fmt->field) {
+	case V4L2_FIELD_SEQ_BT:
+		if (d_q_data->fmt->field != V4L2_FIELD_NONE &&
+			d_q_data->fmt->field != V4L2_FIELD_INTERLACED_BT) {
+			v4l2_err(&ctx->dev->v4l2_dev,
+			 "src and dst field conversion [(%d)->(%d)] not supported.\n",
+				s_q_data->fmt->field, d_q_data->fmt->field);
+			return -EINVAL;
+		}
+		break;
+	case V4L2_FIELD_SEQ_TB:
+		if (d_q_data->fmt->field != V4L2_FIELD_NONE &&
+			d_q_data->fmt->field != V4L2_FIELD_INTERLACED_TB) {
+			v4l2_err(&ctx->dev->v4l2_dev,
+			 "src and dst field conversion [(%d)->(%d)] not supported.\n",
+				s_q_data->fmt->field, d_q_data->fmt->field);
+			return -EINVAL;
