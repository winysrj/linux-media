...
Received: from gofer.mess.org ([88.97.38.141]:54361 "EHLO gofer.mess.org"
        ...
        id S932115AbdJ2U7h (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Sun, 29 Oct 2017 16:59:37 -0400
From: Sean Young <sean@mess.org>
To: linux-media@vger.kernel.org
Subject: [PATCH 22/28] media: lirc: remove last remnants of lirc kapi
Date: Sun, 29 Oct 2017 20:59:36 +0000
Message-Id: <0c4db8c4a1ab4a541581a9c4f31f6e343344d816.1509309834.git.sean@mess.org>
...
+					  lirc_cdev);
 	...
 	retval = rc_open(dev);
@@ -521,7 +521,7 @@ static ssize_t ir_lirc_read(struct file *file, char __user *buffer,
 	return copied;
 }
