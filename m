...
Received: from bombadil.infradead.org ([18.85.46.34]:58872 "EHLO
	bombadil.infradead.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1750968Ab0DUEaW (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 21 Apr 2010 00:30:22 -0400
Date: Wed, 21 Apr 2010 01:30:17 -0300
From: Mauro Carvalho Chehab <mchehab@infradead.org>
To: sensoray-dev <linux-dev@sensoray.com>
Cc: linux-media@vger.kernel.org, Douglas Landgraf <dougsland@gmail.com>
Subject: Re: [PATCH] s2255drv: cleanup of device structure
Message-ID: <20100421013017.2770faa8@pedra>
In-Reply-To: <tkrat.7c7e306760d428af@sensoray.com>
References: <tkrat.7c7e306760d428af@sensoray.com>
Mime-Version: 1.0
...
sensoray-dev <linux-dev@sensoray.com> escreveu:
...
1 out of 61 hunks FAILED -- saving rejects to file drivers/media/video/s2255drv.c.rej
>>> Patch patches/lmml_92061_s2255drv_cleanup_of_device_structure.patch doesn't apply

I might try to fix the failed hunk, but I prefer if you could double check what's going
