...
Received: from lb1-smtp-cloud6.xs4all.net ([194.109.24.24]:37358 "EHLO
	lb1-smtp-cloud6.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1751272AbcCCKd0 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 3 Mar 2016 05:33:26 -0500
Subject: Re: [PATCH for 4.5] media.h: use hex values for the range offsets,
 move connectors base up.
To: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
References: <56D3FB27.7000202@xs4all.nl> <8424145.Mo5klZhWrz@avalon>
 <56D80F76.4050009@xs4all.nl> <2536094.RaAQmbIGIp@avalon>
Cc: Linux Media Mailing List <linux-media@vger.kernel.org>,
	Sakari Ailus <sakari.ailus@iki.fi>
From: Hans Verkuil <hverkuil@xs4all.nl>
Message-ID: <56D812F8.7020208@xs4all.nl>
