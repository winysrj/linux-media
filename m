...
Received: from banach.math.auburn.edu ([131.204.45.3]:60935 "EHLO
	banach.math.auburn.edu" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1754503AbZCDXSA (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Wed, 4 Mar 2009 18:18:00 -0500
Date: Wed, 4 Mar 2009 17:30:26 -0600 (CST)
From: kilgota@banach.math.auburn.edu
To: Mauro Carvalho Chehab <mchehab@infradead.org>,
	Jean-Francois Moine <moinejf@free.fr>
cc: Linux Media <linux-media@vger.kernel.org>
Subject: [PATCH] to gspca, to support SQ905C cameras. (revision)
Message-ID: <alpine.LNX.2.00.0903041727100.23054@banach.math.auburn.edu>
MIME-Version: 1.0
...
are similar to the SQ905 cameras, in that they use bulk transport while 
streaming, and thus the driver functions similarly, using a workqueue to 
perform the streaming. However, there are also some serious
...
-- while streaming, there are no commands sent during a frame download, nor is 
there an ack between frames. Thus, the only command sent during streaming is a 
command to quit streaming.
...
algorithm in libv4lconvert. I have submitted the libv4lconvert patch a couple 
of days ago.
...
+++ linuxb/drivers/media/video/gspca/sq905c.c	2009-03-04 16:38:42.000000000 -0600
@@ -0,0 +1,328 @@
+/*
+ * SQ905C subdriver
+ *
