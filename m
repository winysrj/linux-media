...
Received: from hl140.dinaserver.com ([82.98.160.94]:46798 "EHLO
	hl140.dinaserver.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1754242AbbI3Ihi (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 30 Sep 2015 04:37:38 -0400
Subject: Re: [PATCH] media: Add a driver for the ov5640 sensor.
To: linux-media@vger.kernel.org
References: <1443598463-14817-1-git-send-email-javiermartin@by.com.es>
Cc: antonioperez@by.com.es, manuel@by.com.es, german@by.com.es,
	g.liakhovetski@gmx.de
From: Javier Martin <javiermartin@by.com.es>
Message-ID: <560B9F45.6010107@by.com.es>
Date: Wed, 30 Sep 2015 10:37:25 +0200
MIME-Version: 1.0
In-Reply-To: <1443598463-14817-1-git-send-email-javiermartin@by.com.es>
...
Logo <http://www.by.com.es> 	
Javier Martín
			
javiermartin@by.com.es <mailto:javiermartin@by.com.es>
	
www.by.com.es <http://www.by.com.es>
...
Tel. 902 82 00 82
	LogoLinkedin
<https://www.linkedin.com/company/by_esp?trk=biz-companies-cym>
LogoTwitter <https://twitter.com/By_esp> 	LogoFacebook
<https://www.facebook.com/ByTechSistemasdeControldeAccesos>
LogoGooglePlus <https://plus.google.com/+ByEsByTechControldeAccesos/posts>
(+34) 918 707 193
   	
   	
Antes de imprimir este email piense si es realmente necesario,
el medio ambiente se lo agradecerá.
	LogoReciclar

Advertencia: La información contenida en este correo electrónico y
cualquier fichero anexo al mismo, es de carácter privado y confidencial,
siendo para uso exclusivo de su destinatario. Si usted no es el
destinatario correcto o ha recibido esta comunicación por error, le
...
su destrucción sin continuar su lectura. Le informamos que su dirección
de correo electrónico, así como el resto de los datos de carácter
personal de su tarjeta de visita que nos facilite, podrían ser objeto de
tratamiento automatizado en nuestros ficheros, con la finalidad de
gestionar la agenda de contactos de By TechDesign S.L. Vd. podrá en
cualquier momento ejercer sus derechos de acceso, rectificación,
cancelación y oposición según la Ley Orgánica 15/1999 mediante
notificación escrita a la siguiente dirección: C/Tomás Edison 5, 28500
