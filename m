...
Received: from mail-wr0-f196.google.com ([209.85.128.196]:36723 "EHLO
        mail-wr0-f196.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1752360AbeEGQEU (ORCPT
        <rfc822;linux-media@vger.kernel.org>); Mon, 7 May 2018 12:04:20 -0400
Received: by mail-wr0-f196.google.com with SMTP id f2-v6so17494024wrm.3
        for <linux-media@vger.kernel.org>; Mon, 07 May 2018 09:04:19 -0700 (PDT)
Date: Mon, 7 May 2018 18:04:15 +0200
...
Subject: Re: [PATCH v3 1/3] [media] dvb_frontend: add S2X and misc. other
 enums
Message-ID: <20180507180415.0b15c7e4@perian.wuest.de>
...
References: <20180313221805.26818-1-d.scheller.oss@gmail.com>
        ...
        <20180504125050.49e1ca54@vento.lan>
MIME-Version: 1.0
...
> >=20
> > diff --git a/Documentation/media/frontend.h.rst.exceptions b/Documentat=
ion/media/frontend.h.rst.exceptions
...
> > diff --git a/drivers/media/dvb-core/dvb_frontend.c b/drivers/media/dvb-=
core/dvb_frontend.c
> > index a7ed16e0841d..52c76e32f864 100644
> > --- a/drivers/media/dvb-core/dvb_frontend.c
> > +++ b/drivers/media/dvb-core/dvb_frontend.c
> > @@ -2183,6 +2183,15 @@ static int dtv_set_frontend(struct dvb_frontend =
*fe)
> >  		break;
> >  	case SYS_DVBS2:
> >  		switch (c->rolloff) {
...
> >   *
> >   * Please note that not all FEC types are supported by a given standar=
d.
> >   */
...
> >   *
> >   * Please note that not all modulations are supported by a given stand=
ard.
> >   *
...
> >   * .. note:
> >   *
> > - *    Roloff factor of 35% is implied on DVB-S. On DVB-S2, it is defau=
lt.
> > + *    Rolloff factor of 35% is implied on DVB-S. On DVB-S2, it is defa=
ult.
> >   */
> >  enum fe_rolloff {
> >  	ROLLOFF_35,
...
> > =20
> >  /**
> > diff --git a/include/uapi/linux/dvb/version.h b/include/uapi/linux/dvb/=
version.h
