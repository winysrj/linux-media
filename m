...
Received: from mx07-00178001.pphosted.com ([62.209.51.94]:58336 "EHLO
	mx07-00178001.pphosted.com" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1753170AbbD0P4z (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 27 Apr 2015 11:56:55 -0400
From: Fabien Dessenne <fabien.dessenne@st.com>
To: <linux-media@vger.kernel.org>
CC: Benjamin Gaignard <benjamin.gaignard@linaro.org>
Subject: [PATCH 3/3] [media] bdisp: add debug file system
Date: Mon, 27 Apr 2015 17:56:44 +0200
Message-ID: <1430150204-22944-4-git-send-email-fabien.dessenne@st.com>
...
diff --git a/drivers/media/platform/bdisp/bdisp-debug.c b/drivers/media/platform/bdisp/bdisp-debug.c
...
--- a/drivers/media/platform/bdisp/bdisp-hw.c
...
index c8ccfd3..8499ff7 100644
--- a/drivers/media/platform/bdisp/bdisp-v4l2.c
+++ b/drivers/media/platform/bdisp/bdisp-v4l2.c
@@ -338,6 +338,8 @@ static void bdisp_device_run(void *priv)
 		goto out;
 	}
...
@@ -1148,6 +1150,8 @@ static irqreturn_t bdisp_irq_thread(int irq, void *priv)
...
@@ -1318,6 +1322,8 @@ static int bdisp_remove(struct platform_device *pdev)
...
@@ -1407,12 +1413,19 @@ static int bdisp_probe(struct platform_device *pdev)
 		goto err_v4l2;
 	}
...
index 291f79c..5a853a8 100644
--- a/drivers/media/platform/bdisp/bdisp.h
+++ b/drivers/media/platform/bdisp/bdisp.h
@@ -145,6 +145,29 @@ struct bdisp_m2m_device {
 };
...
@@ -162,6 +185,7 @@ struct bdisp_m2m_device {
...
@@ -188,3 +213,8 @@ int bdisp_hw_alloc_filters(struct device *dev);
