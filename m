...
Received: from mga14.intel.com ([192.55.52.115]:59738 "EHLO mga14.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726717AbeJBXLj (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Tue, 2 Oct 2018 19:11:39 -0400
Date: Tue, 2 Oct 2018 19:24:38 +0300
...
Message-ID: <20181002162438.zia2pwztd6vuqme2@paasikivi.fi.intel.com>
References: <20181002133058.12942-1-ricardo.ribalda@gmail.com>
 <20181002133058.12942-2-ricardo.ribalda@gmail.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20181002133058.12942-2-ricardo.ribalda@gmail.com>
Sender: linux-media-owner@vger.kernel.org
List-ID: <linux-media.vger.kernel.org>

Hi Ricardo,

On Tue, Oct 02, 2018 at 03:30:58PM +0200, Ricardo Ribalda Delgado wrote:
...
> -Avoid fwd declaration of tables
> -Blank line removal/add
> -Fix find mode
> -Use usleep_range
> -Fix enum_frame_interval
> 
> Sakari Ailus:
> -Check for node frequencies
> 
> 
>  MAINTAINERS                |   8 +
>  drivers/media/i2c/Kconfig  |  12 +
>  drivers/media/i2c/Makefile |   1 +
>  drivers/media/i2c/imx214.c | 982 +++++++++++++++++++++++++++++++++++++
...
> index 000000000000..5ca0e8eb48f3
> --- /dev/null
...
This is also not needed in the ...power_on() function above.
...
of_fwnode_handle(dev->of_node) -> dev_fwnode(dev)
