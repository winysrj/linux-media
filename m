...
Received: from bombadil.infradead.org ([18.85.46.34]:50968 "EHLO
	bombadil.infradead.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753258Ab0EPRsT (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sun, 16 May 2010 13:48:19 -0400
Message-ID: <4BF02FDE.5080409@infradead.org>
Date: Sun, 16 May 2010 14:48:14 -0300
...
References: <ee20bb7da9d2708352bb7236108294d5.squirrel@webmail.xs4all.nl> <201005160622.00278@orion.escape-edv.de> <4BEFEBAE.8020600@infradead.org> <201005161701.36084@orion.escape-edv.de>
In-Reply-To: <201005161701.36084@orion.escape-edv.de>
...
If it is a new driver, we can do that, but even moving a patch at the patch series
or changing an unrelated patch will change the md5sum for the entire series.

Disabling bisect hurts not only us, when seeking for a bug, but any other developer/user
that is seeking for what patch broke for him. From one kernel version to the next one,
dozens of thousands of patches are applied. With bisect, a broken patch can be identified
with about 10 compilations, while, without bisect, you'll need to seek the entire patch 
series.
...
It were always complex, but as we're having much more conflicts with SoC patches, and
a much higher number of patches, the old process, where I was fixing the conflicts myself 
only when sending stuff upstream, weren't working anymore, as the number of troubles
