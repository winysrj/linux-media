...
Received: from mx1.redhat.com ([209.132.183.28]:1025 "EHLO mx1.redhat.com"
	...
	id S1758537Ab1FAPpu (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Wed, 1 Jun 2011 11:45:50 -0400
Message-ID: <4DE65E9B.7060509@redhat.com>
Date: Wed, 01 Jun 2011 12:45:31 -0300
From: Mauro Carvalho Chehab <mchehab@redhat.com>
MIME-Version: 1.0
To: Takashi Iwai <tiwai@suse.de>
CC: Ondrej Zary <linux@rainbow-software.org>,
	Hans Verkuil <hverkuil@xs4all.nl>, alsa-devel@alsa-project.org,
	Kernel development list <linux-kernel@vger.kernel.org>,
	linux-media@vger.kernel.org
Subject: Re: [alsa-devel] [PATCH v5] [resend] radio-sf16fmr2: convert to generic
 TEA575x interface
References: <201105231417.17450.linux@rainbow-software.org>	<4DDD9D0A.6040606@redhat.com> <s5hvcwx29co.wl%tiwai@suse.de>
In-Reply-To: <s5hvcwx29co.wl%tiwai@suse.de>
...
>> Ondrej,
>>
>> As your first series went via alsa tree, and we are close to the end of the merge window,
>> and assuming that Takashi didn't apply those patches on his tree, as you're re-sending it,
>> I think that the better is to wait for the end of the merge window, in order to allow us
>> to sync our development tree with 2.6.40-rc1, and then review and apply it on the top of it.
> 
...
Applying patch patches/lmml_808552_v5_resend_radio_sf16fmr2_convert_to_generic_tea575x_interface.patch
...
Patch patches/lmml_808552_v5_resend_radio_sf16fmr2_convert_to_generic_tea575x_interface.patch does not apply (enforce with -f)
