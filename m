...
Received: from mx3.redhat.com (mx3.redhat.com [172.16.48.32])
	by int-mx1.corp.redhat.com (8.13.1/8.13.1) with ESMTP id mBG2MPDc003170
	for <video4linux-list@redhat.com>; Mon, 15 Dec 2008 21:22:25 -0500
Received: from mail02.idc.renesas.com (mail.renesas.com [202.234.163.13])
	by mx3.redhat.com (8.13.8/8.13.8) with ESMTP id mBG2MCm9007680
	for <video4linux-list@redhat.com>; Mon, 15 Dec 2008 21:22:12 -0500
Date: Tue, 16 Dec 2008 11:09:37 +0900
From: Kuninori Morimoto <morimoto.kuninori@renesas.com>
To: Guennadi Liakhovetski <g.liakhovetski@gmx.de>
Message-id: <uljughnao.wl%morimoto.kuninori@renesas.com>
MIME-version: 1.0 (generated by SEMI 1.14.6 - "Maruoka")
Content-type: text/plain; charset=US-ASCII
Cc: V4L-Linux <video4linux-list@redhat.com>
Subject: [PATCH v3] Add interlace support to sh_mobile_ceu_camera.c
...
o fix check method about f->fmt.pix.field
 ...
 drivers/media/video/sh_mobile_ceu_camera.c |   55 +++++++++++++++++++++++-----
 1 files changed, 45 insertions(+), 10 deletions(-)

diff --git a/drivers/media/video/sh_mobile_ceu_camera.c b/drivers/media/video/sh_mobile_ceu_camera.c
index 4dea1ff..cad2c16 100644
