...
Received: from mx08-00178001.pphosted.com ([91.207.212.93]:38972 "EHLO
        mx07-00178001.pphosted.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1751385AbdAaQcX (ORCPT
...
Subject: [PATCH v5 10/10] [media] st-delta: debug: trace stream/frame information & summary
Date: Tue, 31 Jan 2017 17:30:33 +0100
Message-ID: <1485880233-666-11-git-send-email-hugues.fruchet@st.com>
...
@@ -446,11 +447,13 @@ static int delta_g_fmt_stream(struct file *file, void *fh,
 	struct delta_dev *delta = ctx->dev;
...
@@ -473,11 +476,13 @@ static int delta_g_fmt_frame(struct file *file, void *fh, struct v4l2_format *f)
 	struct v4l2_pix_format *pix = &f->fmt.pix;
...
@@ -660,6 +665,7 @@ static int delta_s_fmt_frame(struct file *file, void *fh, struct v4l2_format *f)
...
@@ -712,6 +718,10 @@ static int delta_s_fmt_frame(struct file *file, void *fh, struct v4l2_format *f)
...
+		delta_frameinfo_str(&frameinfo, str, sizeof(str)));
 	...
 	pix->pixelformat = frameinfo.pixelformat;
 	pix->width = frameinfo.aligned_width;
@@ -1323,6 +1333,8 @@ static int delta_vb2_au_start_streaming(struct vb2_queue *q,
...
@@ -1384,6 +1396,10 @@ static int delta_vb2_au_start_streaming(struct vb2_queue *q,
...
@@ -1711,6 +1727,12 @@ static int delta_release(struct file *file)
 	/* close decoder */
