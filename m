...
Received: from mailgw02.mediatek.com ([210.61.82.184]:9087 "EHLO
	...
	with ESMTP id S932551AbcBWILb (ORCPT
...
Subject: [PATCH v5 7/8] [media] vcodec: mediatek: Add Mediatek H264 Video Encoder Driver
Date: Tue, 23 Feb 2016 16:11:20 +0800
Message-ID: <1456215081-16858-8-git-send-email-tiffany.lin@mediatek.com>
In-Reply-To: <1456215081-16858-7-git-send-email-tiffany.lin@mediatek.com>
...
+#include "h264_enc/venc_h264_if.h"
 ...
 {
@@ -39,6 +40,8 @@ int venc_if_create(struct mtk_vcodec_ctx *ctx, unsigned int fourcc)
