...
Received: from smtp-vbr12.xs4all.nl ([194.109.24.32]:2264 "EHLO
	smtp-vbr12.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751477AbaAZJy7 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sun, 26 Jan 2014 04:54:59 -0500
Received: from tschai.lan (209.80-203-20.nextgentel.com [80.203.20.209] (may be forged))
	(authenticated bits=0)
	by smtp-vbr12.xs4all.nl (8.13.8/8.13.8) with ESMTP id s0Q9ssAF003074
	for <linux-media@vger.kernel.org>; Sun, 26 Jan 2014 10:54:57 +0100 (CET)
	(envelope-from hverkuil@xs4all.nl)
Received: from [192.168.1.126] (marune.xs4all.nl [80.101.105.217])
	by tschai.lan (Postfix) with ESMTPSA id 955122A00A3
	for <linux-media@vger.kernel.org>; Sun, 26 Jan 2014 10:54:49 +0100 (CET)
Message-ID: <52E4DB6C.30206@xs4all.nl>
Date: Sun, 26 Jan 2014 10:54:52 +0100
From: Hans Verkuil <hverkuil@xs4all.nl>
MIME-Version: 1.0
To: "linux-media@vger.kernel.org" <linux-media@vger.kernel.org>
Subject: [RFC PATCH] v4l2-pci-skeleton: add a V4L2 PCI skeleton driver
...
show some code, so I put together this V4L2 PCI skeleton driver that can function
...
+	struct skeleton *skel = vb2_get_drv_priv(vq);
+
+	/* Do not start the DMA engine until the required minimum number
+	   of buffers have been queued. */
+	if (count < 2)
+		return -ENOBUFS;
+
+	skel->sequence = 0;
...
+		return -ENODATA;
+
+	/* TODO: Query currently seen standard. Initial value of *std is
...
+		return -ENODATA;
+
+	/* TODO: Query currently seen timings. This function should look
+	   something like this:
+	detect_timings();
+	if (no_signal)
+	   	return -ENOLINK;
