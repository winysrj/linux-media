...
Received: from lb1-smtp-cloud6.xs4all.net ([194.109.24.24]:48532 "EHLO
	...
	by vger.kernel.org with ESMTP id S1751952AbaLSOw1 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 19 Dec 2014 09:52:27 -0500
...
Subject: [RFCv2 PATCH 05/11] v4l2-subdev: replace v4l2_subdev_fh by v4l2_subdev_pad_config
Date: Fri, 19 Dec 2014 15:51:30 +0100
Message-Id: <1419000696-25202-6-git-send-email-hverkuil@xs4all.nl>
...
---
 ...
 include/media/v4l2-subdev.h                        | 52 ++++++++------
 47 files changed, 822 insertions(+), 811 deletions(-)
...
@@ -624,13 +638,7 @@ struct v4l2_subdev {
  */
...
@@ -639,17 +647,17 @@ struct v4l2_subdev_fh {
 #if defined(CONFIG_VIDEO_V4L2_SUBDEV_API)
