...
Received: from mailout3.w1.samsung.com ([210.118.77.13]:30564 "EHLO
        ...
        with ESMTP id S1753331AbdCTK5J (ORCPT
...
Subject: [PATCH v3 00/16] Exynos MFC v6+ - remove the need for the reserved
 memory
Date: Mon, 20 Mar 2017 11:56:26 +0100
Message-id: <1490007402-30265-1-git-send-email-m.szyprowski@samsung.com>
References: <CGME20170320105648eucas1p29654616c7d29c45abdc3c2ba002126ec@eucas1p2.samsung.com>
...
Marek Szyprowski (16):
 ...
 24 files changed, 269 insertions(+), 283 deletions(-)
