...
Received: from n21.bullet.mail.mud.yahoo.com ([68.142.206.160])
	by www.linuxtv.org with smtp (Exim 4.63)
	(envelope-from <eallaud@yahoo.fr>) id 1K066h-0007lB-O0
	for linux-dvb@linuxtv.org; Sun, 25 May 2008 04:37:13 +0200
Date: Sat, 24 May 2008 22:33:35 -0400
...
Message-Id: <1211682815l.9766l.1l@manu-laptop>
MIME-Version: 1.0
...
OOOOPSSS, forget the second problem I saw a KEY_SLEEP in the patch I 
sent, I will post a corrected patch when I find which button it is 
mapped to. Sorry.
Bye
Manu
