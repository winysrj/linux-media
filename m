...
Received: from mga09.intel.com ([134.134.136.24]:40313 "EHLO mga09.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1750864AbdE2TMk (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Mon, 29 May 2017 15:12:40 -0400
...
Date: Mon, 29 May 2017 19:12:37 +0000
Message-ID: <7A4F467111FEF64486F40DFE7DF3500A03EB24F6@ORSMSX111.amr.corp.intel.com>
References: <1495844847-21655-1-git-send-email-hyungwoo.yang@intel.com>
 ...
 <20170529072957.GZ29527@valkosipuli.retiisi.org.uk>
In-Reply-To: <20170529072957.GZ29527@valkosipuli.retiisi.org.uk>
...
Thank you for the reviews. I have addressed all of your comments and please review the "v4" I already submitted.
...
> > > > +/* Mode : resolution and related config&values */ struct 
> > > > +ov13858_mode {
> > > > +	/* Frame width */
> > > > +	u32 width;
> > > > +	/* Frame height */
...
> > > > +ov13858_read_reg(struct ov13858 *ov13858, u16 reg, u32 len, u32 
> > > > +*val) {
...
> > > > +ov13858_write_reg(struct ov13858 *ov13858, u16 reg, u32 len, u32 
> > > > +val) {
> > > > +	struct i2c_client *client = v4l2_get_subdevdata(&ov13858->sd);
> > > > +	int buf_i, val_i;
> > > > +	u8 buf[6], *val_p;
...
> > > > +
> > > > +/* Open sub-device */
> > > > +static int ov13858_open(struct v4l2_subdev *sd, struct 
> > > > +v4l2_subdev_fh
> > > > +*fh) {
...
> > in generated machine code, I want to keep this if there's no strict 
> > rule on this.
> 
> There's no strict rule on such matters, but the function definitions don't really add anything --- especially that they take a struct v4l2_ctrl as argument, so you can only meaningfully use them when you have the related struct v4l2_ctrl. It's just harder to read the way it is.
> 
