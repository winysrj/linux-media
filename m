...
Received: from perceval.irobotique.be ([92.243.18.41]:46863 "EHLO
	...
	with ESMTP id S932252Ab0GUOmF (ORCPT
...
Subject: [SAMPLE v2 03/12] v4l: Create v4l2 subdev file handle structure
Date: Wed, 21 Jul 2010 16:41:50 +0200
Message-Id: <1279723318-28943-4-git-send-email-laurent.pinchart@ideasonboard.com>
