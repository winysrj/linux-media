...
Received: from mga01.intel.com ([192.55.52.88]:14392 "EHLO mga01.intel.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1752461AbbHUMXd (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Fri, 21 Aug 2015 08:23:33 -0400
Date: Fri, 21 Aug 2015 20:26:44 +0800
From: kbuild test robot <fengguang.wu@intel.com>
To: Geert Uytterhoeven <geert@linux-m68k.org>
Cc: kbuild-all@01.org, Mauro Carvalho Chehab <m.chehab@samsung.com>,
	linux-media@vger.kernel.org
Subject: [linux-next:master 7080/10086] drivers/media/i2c/s5k4ecgx.c:346:2:
 warning: format '%zu' expects argument of type 'size_t', but argument 4 has
 type 'unsigned int'
Message-ID: <201508212042.48EvSvC5%fengguang.wu@intel.com>
MIME-Version: 1.0
...
>> drivers/media/i2c/s5k4ecgx.c:346:2: warning: format '%zu' expects argument of type 'size_t', but argument 4 has type 'unsigned int' [-Wformat=]
     v4l2_dbg(3, debug, sd, "FW: %s size %zu register sets %d\n",
     ^
--
   drivers/media/i2c/s5k5baf.c: In function 's5k5baf_fw_parse':
>> drivers/media/i2c/s5k5baf.c:363:3: warning: format '%zu' expects argument of type 'size_t', but argument 3 has type 'unsigned int' [-Wformat=]
      dev_err(dev, "firmware file too short (%zu)\n", count);
      ^
   drivers/media/i2c/s5k5baf.c:386:4: warning: format '%zu' expects argument of type 'size_t', but argument 4 has type 'unsigned int' [-Wformat=]
       f->count, 2 * (count + S5K5BAG_FW_TAG_LEN));
       ^
--
   drivers/media/i2c/s5c73m3/s5c73m3-core.c: In function 's5c73m3_load_fw':
>> drivers/media/i2c/s5c73m3/s5c73m3-core.c:365:2: warning: format '%zu' expects argument of type 'size_t', but argument 4 has type 'unsigned int' [-Wformat=]
     v4l2_info(sd, "Loading firmware (%s, %zu B)\n", fw_name, fw->size);
     ^

vim +346 drivers/media/i2c/s5k4ecgx.c

8b99312b Sangwook Lee 2012-09-13  330  static int s5k4ecgx_load_firmware(struct v4l2_subdev *sd)
8b99312b Sangwook Lee 2012-09-13  331  {
8b99312b Sangwook Lee 2012-09-13  332  	struct i2c_client *client = v4l2_get_subdevdata(sd);
...
8b99312b Sangwook Lee 2012-09-13  339  	err = request_firmware(&fw, S5K4ECGX_FIRMWARE, sd->v4l2_dev->dev);
8b99312b Sangwook Lee 2012-09-13  340  	if (err) {
8b99312b Sangwook Lee 2012-09-13  341  		v4l2_err(sd, "Failed to read firmware %s\n", S5K4ECGX_FIRMWARE);
...
107376ba Randy Dunlap 2012-10-16 @346  	v4l2_dbg(3, debug, sd, "FW: %s size %zu register sets %d\n",
8b99312b Sangwook Lee 2012-09-13  347  		 S5K4ECGX_FIRMWARE, fw->size, regs_num);
8b99312b Sangwook Lee 2012-09-13  348  
8b99312b Sangwook Lee 2012-09-13  349  	regs_num++; /* Add header */
8b99312b Sangwook Lee 2012-09-13  350  	if (fw->size != regs_num * FW_RECORD_SIZE + FW_CRC_SIZE) {
...
b75f2d16 Hans Verkuil 2014-12-13  354  	crc_file = get_unaligned_le32(fw->data + regs_num * FW_RECORD_SIZE);

:::::: The code at line 346 was first introduced by commit
:::::: 107376ba4ef1ecd4249427a9f9c1922fc1d66bb4 [media] i2c/s5k4ecgx: fix printk format warning
