...
Received: from 78.218.95.91.static.ter-s.siw.siwnet.net ([91.95.218.78]
	...
	(envelope-from <magnus@alefors.se>) id 1JewX1-0005rC-Vf
	for linux-dvb@linuxtv.org; Thu, 27 Mar 2008 19:08:58 +0100
Received: from [192.168.0.10] (aria.alefors.se [192.168.0.10])
	by gw (Postfix) with ESMTP id 4C30715A8B
	for <linux-dvb@linuxtv.org>; Thu, 27 Mar 2008 19:08:51 +0100 (CET)
Message-ID: <47EBE2B1.2060904@alefors.se>
Date: Thu, 27 Mar 2008 19:08:49 +0100
From: =?UTF-8?B?TWFnbnVzIEjDtnJsaW4=?= <magnus@alefors.se>
MIME-Version: 1.0
To: linux-dvb@linuxtv.org
Subject: [linux-dvb] dst-ca and multiproto
...
Hi. I just bought an old Twinhan VisionPlus DVB-S card off ebay and I 
