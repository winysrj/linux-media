...
Received: from mailout-de.gmx.net ([213.165.64.22]:35287 "HELO
	mailout-de.gmx.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with SMTP id S1753178Ab2EFPh0 (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Sun, 6 May 2012 11:37:26 -0400
From: "Hans-Frieder Vogt" <hfvogt@gmx.net>
To: Thomas Mair <thomas.mair86@googlemail.com>
Subject: Re: [PATCH v3 1/3] Modified RTL28xxU driver to work with RTL2832
Date: Sun, 6 May 2012 17:37:18 +0200
References: <CAKZ=SG9U48d=eE3avccR-Auao5UMo0OANw8KKb=MP1XPtkHwmg@mail.gmail.com>
In-Reply-To: <CAKZ=SG9U48d=eE3avccR-Auao5UMo0OANw8KKb=MP1XPtkHwmg@mail.gmail.com>
Cc: linux-media@vger.kernel.org
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="us-ascii"
Content-Transfer-Encoding: 7bit
Message-Id: <201205061737.18561.hfvogt@gmx.net>
...
>  }
> 
> +static int rtl2832u_tuner_callback(struct dvb_usb_device *d, int cmd, int
> arg) +{
...
>  }
> 
> -static int rtl28xxu_streaming_ctrl(struct dvb_usb_adapter *adap , int
> onoff) +static int rtl2831u_streaming_ctrl(struct dvb_usb_adapter *adap ,
> int onoff) {
>  	int ret;
>  	u8 buf[2], gpio;
> 
...
> +static int rtl2832u_streaming_ctrl(struct dvb_usb_adapter *adap , int
> onoff) +{
> +	int ret;
> +	u8 buf[2];
> +
...
>  		goto err;
> 
> @@ -687,22 +1061,24 @@ static int rtl2831u_rc_query(struct dvb_usb_device
> *d)
> 
...
>  			if (ret)
>  				goto err;
> @@ -737,37 +1113,40 @@ static int rtl2832u_rc_query(struct dvb_usb_device
> *d) priv->rc_active = true;
>  	}
> 
...
>  		}
>  	},
> @@ -907,10 +1299,11 @@ static int rtl28xxu_probe(struct usb_interface
...
> @@ -926,22 +1319,31 @@ static int rtl28xxu_probe(struct usb_interface
> *intf, if (ret)
>  		goto err;
> 
> +
