...
Received: from smtp08.smtpout.orange.fr ([80.12.242.130]:28641 "EHLO
	smtp.smtpout.orange.fr" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753821AbbH3TMq (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sun, 30 Aug 2015 15:12:46 -0400
...
Subject: [PATCH v4 4/4] media: pxa_camera: conversion to dmaengine
Date: Sun, 30 Aug 2015 21:08:01 +0200
Message-Id: <1440961681-17279-5-git-send-email-robert.jarzmik@free.fr>
...
@@ -276,61 +271,40 @@ static void free_buffer(struct videobuf_queue *vq, struct pxa_buffer *buf)
...
@@ -345,93 +319,53 @@ static void pxa_camera_dma_irq_v(int channel, void *data)
...
@@ -458,6 +392,7 @@ static int pxa_videobuf_prepare(struct videobuf_queue *vq,
...
@@ -500,9 +435,7 @@ static int pxa_videobuf_prepare(struct videobuf_queue *vq,
...
-		struct scatterlist *sg;
 		...
 		if (ret)
@@ -515,11 +448,19 @@ static int pxa_videobuf_prepare(struct videobuf_queue *vq,
 			size_y = size;
 		}
...
+					   size_y, 0);
 		if (ret) {
 			...
 			goto fail;
@@ -528,19 +469,19 @@ static int pxa_videobuf_prepare(struct videobuf_queue *vq,
...
@@ -551,12 +492,6 @@ static int pxa_videobuf_prepare(struct videobuf_queue *vq,
...
-			  buf->dmas[0].sg_cpu, buf->dmas[0].sg_dma);
 fail:
 	free_buffer(vq, buf);
 out:
@@ -580,10 +515,8 @@ static void pxa_dma_start_channels(struct pxa_camera_dev *pcdev)
...
@@ -594,7 +527,7 @@ static void pxa_dma_stop_channels(struct pxa_camera_dev *pcdev)
 	for (i = 0; i < pcdev->channels; i++) {
 		dev_dbg(pcdev->soc_host.v4l2_dev.dev,
 			"%s (channel=%d)\n", __func__, i);
...
@@ -602,18 +535,12 @@ static void pxa_dma_add_tail_buf(struct pxa_camera_dev *pcdev,
 				 struct pxa_buffer *buf)
 {
 	int i;
...
@@ -705,8 +632,6 @@ static void pxa_camera_wakeup(struct pxa_camera_dev *pcdev,
 			      struct videobuf_buffer *vb,
 			      struct pxa_buffer *buf)
 {
-	int i;
...
@@ -718,8 +643,6 @@ static void pxa_camera_wakeup(struct pxa_camera_dev *pcdev,
...
@@ -743,50 +666,41 @@ static void pxa_camera_wakeup(struct pxa_camera_dev *pcdev,
  *
...
-
 	 ...
 	 *
@@ -806,28 +720,41 @@ static void pxa_camera_dma_irq(int channel, struct pxa_camera_dev *pcdev,
...
+					   last_issued);
 ...
 out:
@@ -1014,10 +941,7 @@ static void pxa_camera_clock_stop(struct soc_camera_host *ici)
...
@@ -1644,10 +1568,6 @@ static int pxa_camera_resume(struct device *dev)
...
@@ -1753,8 +1673,11 @@ static int pxa_camera_probe(struct platform_device *pdev)
...
@@ -1822,36 +1745,51 @@ static int pxa_camera_probe(struct platform_device *pdev)
 	pcdev->base = base;
...
@@ -1875,11 +1813,11 @@ static int pxa_camera_probe(struct platform_device *pdev)
 	return 0;
...
@@ -1889,9 +1827,9 @@ static int pxa_camera_remove(struct platform_device *pdev)
