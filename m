...
Received: from bombadil.infradead.org ([18.85.46.34])
	...
	(envelope-from <jaswinder@infradead.org>) id 1KAM9D-0007Ab-6b
	for linux-dvb@linuxtv.org; Sun, 22 Jun 2008 11:46:11 +0200
From: Jaswinder Singh <jaswinder@infradead.org>
To: linux-dvb <linux-dvb@linuxtv.org>, David Woodhouse <dwmw2@infradead.org>
Date: Sun, 22 Jun 2008 15:09:35 +0530
Message-Id: <1214127575.4974.7.camel@jaswinder.satnam>
Mime-Version: 1.0
Subject: [linux-dvb] [PATCH] firmware: convert av7110 driver to
	request_firmware()
