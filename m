...
Received: from lb2-smtp-cloud8.xs4all.net ([194.109.24.25]:57012 "EHLO
        ...
        by vger.kernel.org with ESMTP id S1752555AbeBSKiP (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Mon, 19 Feb 2018 05:38:15 -0500
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hans.verkuil@cisco.com>
Subject: [PATCHv3 13/15] media: document the reservedX fields in media_v2_topology
Date: Mon, 19 Feb 2018 11:38:04 +0100
Message-Id: <20180219103806.17032-14-hverkuil@xs4all.nl>
...
index 870a6c0d1f7a..58621630c469 100644
...
+       -  ``reserved1``
+
+       -  Reserved for future extensions. Drivers must set this to zero.
+
+    -  .. row 4
+
        -  __u64
