...
Received: from smtp-vbr8.xs4all.nl ([194.109.24.28]:3807 "EHLO
	smtp-vbr8.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751285Ab0A0Lmp convert rfc822-to-8bit (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 27 Jan 2010 06:42:45 -0500
From: Hans Verkuil <hverkuil@xs4all.nl>
To: Richard =?iso-8859-1?q?R=F6jfors?=
	<richard.rojfors@pelagicore.com>
Subject: Re: [PATCH 1/2] radio: Add radio-timb
Date: Wed, 27 Jan 2010 12:41:46 +0100
Cc: Linux Media Mailing List <linux-media@vger.kernel.org>,
	Mauro Carvalho Chehab <mchehab@infradead.org>,
	Douglas Schilling Landgraf <dougsland@gmail.com>,
	Andrew Morton <akpm@linux-foundation.org>
References: <4B599C44.4030801@pelagicore.com> <201001221726.16522.hverkuil@xs4all.nl> <4B59FE40.3020004@pelagicore.com>
In-Reply-To: <4B59FE40.3020004@pelagicore.com>
MIME-Version: 1.0
Content-Type: Text/Plain;
  charset="iso-8859-1"
Content-Transfer-Encoding: 8BIT
Message-Id: <201001271241.46912.hverkuil@xs4all.nl>
...
The reason why I much prefer everyone to use these functions is that these
functions are tested and reviewed carefully. It's actually fairly tricky code.
And it provides a single point of entry so if we need to fix/improve anything
here, then it is just one place that needs to be modified.
