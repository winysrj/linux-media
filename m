...
Received: from vps-vb.mhejs.net ([37.28.154.113]:41934 "EHLO vps-vb.mhejs.net"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1752112AbeCYV1z (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Sun, 25 Mar 2018 17:27:55 -0400
From: "Maciej S. Szmigiero" <mail@maciej.szmigiero.name>
Subject: [PATCH v6 5/6] [media] cxusb: implement Medion MD95700 digital /
 analog coexistence
...
Message-ID: <9810a7f1-717b-a47d-7755-3305e85a9eeb@maciej.szmigiero.name>
Date: Sun, 25 Mar 2018 23:27:53 +0200
MIME-Version: 1.0
...
@@ -632,9 +714,21 @@ static struct max2165_config mygica_d689_max2165_cfg = {
...
@@ -738,20 +832,105 @@ static int cxusb_mygica_d689_tuner_attach(struct dvb_usb_adapter *adap)
...
@@ -1311,6 +1490,101 @@ static int bluebird_patch_dvico_firmware_download(struct usb_device *udev,
 	return -EINVAL;
 }
...
@@ -1326,12 +1600,101 @@ static struct dvb_usb_device_properties cxusb_d680_dmb_properties;
...
+	} else if (0 == dvb_usb_device_init(intf, &cxusb_bluebird_lgh064f_properties,
 	    ...
 	    0 == dvb_usb_device_init(intf, &cxusb_bluebird_dee1601_properties,
 				     THIS_MODULE, NULL, adapter_nr) ||
@@ -1361,6 +1724,11 @@ static int cxusb_probe(struct usb_interface *intf,
 		return 0;
...
@@ -1369,6 +1737,9 @@ static void cxusb_disconnect(struct usb_interface *intf)
 	struct cxusb_state *st = d->priv;
...
+
 	...
 	if (client) {
@@ -1386,31 +1757,6 @@ static void cxusb_disconnect(struct usb_interface *intf)
 	dvb_usb_device_exit(intf);
 }
...
@@ -1484,13 +1830,16 @@ static struct dvb_usb_device_properties cxusb_medion_properties = {
...
@@ -2197,6 +2546,7 @@ module_usb_driver(cxusb_driver);
