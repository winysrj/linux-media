...
Received: from ns.mm-sol.com ([37.157.136.199]:41213 "EHLO extserv.mm-sol.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1753407AbeGENdT (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Thu, 5 Jul 2018 09:33:19 -0400
From: Todor Tomov <todor.tomov@linaro.org>
To: mchehab@kernel.org, sakari.ailus@linux.intel.com,
        hans.verkuil@cisco.com, laurent.pinchart+renesas@ideasonboard.com,
        linux-media@vger.kernel.org
Cc: linux-kernel@vger.kernel.org, Todor Tomov <todor.tomov@linaro.org>
Subject: [PATCH v2 00/34] Qualcomm Camera Subsystem driver - 8x96 support
Date: Thu,  5 Jul 2018 16:32:31 +0300
Message-Id: <1530797585-8555-1-git-send-email-todor.tomov@linaro.org>
Sender: linux-media-owner@vger.kernel.org
List-ID: <linux-media.vger.kernel.org>

Changelog v2:
- added v4l2-compliance test log in cover-letter;
- patch 08: added CC to device tree maintainers;
- patch 14: added Reviewed-by tag;
- patch 15: added Reviewed-by tag;
- patch 25: bugfix in format selection;
- patch 28: bugfix in format selection;
- new patch 33 to support events on user control change;
- new patch 34 to remove a warning.
