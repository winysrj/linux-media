...
Received: from bombadil.infradead.org ([65.50.211.133]:58908 "EHLO
        bombadil.infradead.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1762825AbdLSMxp (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Tue, 19 Dec 2017 07:53:45 -0500
Date: Tue, 19 Dec 2017 10:53:29 -0200
...
Subject: Re: [PATCH v4 6/6] [media] cxusb: add analog mode support for
 Medion MD95700
Message-ID: <20171219105329.3d6b2fb4@vento.lan>
In-Reply-To: <8b06f30b-bd92-6454-c810-c2774fd8818b@maciej.szmigiero.name>
...
> index 000000000000..de345cb42e23
> --- /dev/null
...
No need to print errors on kmalloc results. The mm will do it already.
Same applies to other similar places.
...
> index ea55b31cf681..1d414faab4b9 100644
...
> @@ -2683,5 +2682,5 @@ MODULE_AUTHOR("Michael Krufky <mkrufky@linuxtv.org>");
...
Just get rid of this. Nobody uses or remembers to update it anyway.

>  MODULE_LICENSE("GPL");
> diff --git a/drivers/media/usb/dvb-usb/cxusb.h b/drivers/media/usb/dvb-usb/cxusb.h
> index f586d61a7bf8..f037a8dbdbe4 100644
...
> @@ -63,31 +115,67 @@ struct cxusb_medion_dev {
