...
Received: from smtp-out-231.synserver.de ([212.40.185.231]:1076 "EHLO
	smtp-out-227.synserver.de" rhost-flags-OK-OK-OK-FAIL)
	by vger.kernel.org with ESMTP id S1752335AbbAMMBb (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 13 Jan 2015 07:01:31 -0500
From: Lars-Peter Clausen <lars@metafoo.de>
To: Hans Verkuil <hverkuil@xs4all.nl>
Cc: linux-media@vger.kernel.org, Lars-Peter Clausen <lars@metafoo.de>
Subject: [PATCH 09/16] [media] adv7180: Prepare for multi-chip support
Date: Tue, 13 Jan 2015 13:01:14 +0100
Message-Id: <1421150481-30230-10-git-send-email-lars@metafoo.de>
