...
Received: from mail-wm0-f46.google.com ([74.125.82.46]:36031 "EHLO
        mail-wm0-f46.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1754248AbcHXPZP (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Wed, 24 Aug 2016 11:25:15 -0400
Received: by mail-wm0-f46.google.com with SMTP id q128so206118900wma.1
        for <linux-media@vger.kernel.org>; Wed, 24 Aug 2016 08:24:35 -0700 (PDT)
...
Message-ID: <57BDBC2F.7020902@linaro.org>
Date: Wed, 24 Aug 2016 18:24:31 +0300
MIME-Version: 1.0
In-Reply-To: <20160824101708.GI12130@valkosipuli.retiisi.org.uk>
...
I'd rather remove the REG suffix from all, it doesn't add a lot of a value.
...
>> +	{ 0x3103, 0x11 },
> 
> Are there dependencies here to board properties such as input voltage or the
> external clock frequency in these registers?

Yes, some of these register values depend on the external clock.
...
>> +		goto exit;
> 
> It'd be nicer to just return the error here as that's all what's needed.
...
>> +			goto err;
> 
> You could simply return here and omit the goto and the label.
...
Not actually. Sure, I'll remove them.

> 
> I bet it's good for debugging but I wouldn't leave these to the driver after
> that. Please remove; there's one in ov5645_set_power_on() as well.
> 
>> +
>> +	if (ov5645->rst_gpio)
> 
> Is it possible that ov5645->rst_gpio is NULL here?

It is not possible, I'll remove the check.

> 
> gpiod_set_value_cansleep() can take NULL as the first argument.
> 
...
> 
> This will mangle error codes if you happen to get an error.
...
>> +	"Random Data",
> 
> I bet this is pseudo-random data rather than really, properly random. I'd
> say that here, to avoid someone unthinkingly using an inventive source of
> data for cryptographic purposes. :-)
...
>> +	"Black Image",
> 
> What an inventive test pattern. :-)
> 
>> +};
>> +
