...
Received: from mail.gmx.net ([213.165.64.20]:46637 "HELO mail.gmx.net"
	...
	id S1755516AbZLCJt4 (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Thu, 3 Dec 2009 04:49:56 -0500
Date: Thu, 3 Dec 2009 10:49:57 +0100 (CET)
From: Guennadi Liakhovetski <g.liakhovetski@gmx.de>
To: Hans Verkuil <hverkuil@xs4all.nl>
cc: Linux Media Mailing List <linux-media@vger.kernel.org>,
	Laurent Pinchart <laurent.pinchart@ideasonboard.com>,
	Sakari Ailus <sakari.ailus@maxwell.research.nokia.com>
Subject: [PATCH 2/2 v3] soc-camera: convert to the new mediabus API
In-Reply-To: <Pine.LNX.4.64.0912031036510.4328@axis700.grange>
Message-ID: <Pine.LNX.4.64.0912031047440.4328@axis700.grange>
...
v2  -> v3: comments addressed - thanks! Updated to the new mediabus core, 
...
Guennadi
 ...
 drivers/media/video/mt9m001.c              |  141 ++++++----
 drivers/media/video/mt9m111.c              |  188 ++++++++-----
 drivers/media/video/mt9t031.c              |   66 +++---
 drivers/media/video/mt9v022.c              |  150 ++++++----
 drivers/media/video/mx1_camera.c           |   90 +++++--
 drivers/media/video/mx3_camera.c           |  278 +++++++++++--------
 drivers/media/video/ov772x.c               |  229 ++++++++--------
 drivers/media/video/ov9640.c               |  107 +++++---
 drivers/media/video/pxa_camera.c           |  272 ++++++++++---------
 drivers/media/video/rj54n1cb0c.c           |  201 ++++++++++----
 drivers/media/video/sh_mobile_ceu_camera.c |  403 ++++++++++++++++------------
 drivers/media/video/soc_camera.c           |   78 +++---
...
+	if (mf->code != V4L2_MBUS_FMT_VYUY8_2X8)
 		return -EINVAL;
