...
Received: from perceval.irobotique.be ([92.243.18.41]:42707 "EHLO
	...
	with ESMTP id S1752832Ab0IWLfP (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 23 Sep 2010 07:35:15 -0400
From: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
To: linux-media@vger.kernel.org
Cc: sakari.ailus@maxwell.research.nokia.com
Subject: [RFC/PATCH v5 03/12] media: Entities, pads and links
Date: Thu, 23 Sep 2010 13:34:47 +0200
Message-Id: <1285241696-16826-4-git-send-email-laurent.pinchart@ideasonboard.com>
...
+  devices (CMOS sensor for instance), logical hardware devices (a building block
+  in a  System-on-Chip image processing pipeline), DMA channels or physical
+  connectors.</para>
+  <para>A pad is a connection endpoint through which an entity can interact with
...
+  confused with physical pins at chip boundaries.</para>
+  <para>A link is a point-to-point oriented connection between two pads, either
