...
Received: from moutng.kundenserver.de ([212.227.126.171]:58626 "EHLO
	moutng.kundenserver.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1750753Ab2JARkn (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Mon, 1 Oct 2012 13:40:43 -0400
Date: Mon, 1 Oct 2012 19:40:35 +0200 (CEST)
From: Guennadi Liakhovetski <g.liakhovetski@gmx.de>
To: Linux Media Mailing List <linux-media@vger.kernel.org>
cc: Hans Verkuil <hverkuil@xs4all.nl>,
	Magnus Damm <magnus.damm@gmail.com>, linux-sh@vger.kernel.org
Subject: [PATCH v2] media: add a VEU MEM2MEM format conversion and scaling
 driver
Message-ID: <Pine.LNX.4.64.1210011925340.3573@axis700.grange>
MIME-Version: 1.0
...
v2: addressed comments from Hans (thanks!), namely:

- taking into account, that the control implementation in the driver was 
  incomplete, instead of fixing it I removed it completely, since the 
  implementation didn't really do anything useful.
- set .bus_info appropriately
- fixed capability reporting
- added missing .colorspace
- set V4L2_FIELD_NONE always on TRY_FMT
- removed impossible case of unhandled buffer type
- removed *_INPUT ioctl() handling
- fixed all warnings and errors from v4l2-compliance, except one: the test 
  issues a REQBUFS ioctl() and the driver is returning -EPERM, since the 
  requesting process hasn't been registered as "streamer." The standard 
  only allows -EINVAL if .type is wrong. I think the spec is wrong, since 
  also vb2_reqbufs() can return -EBUSY (in __verify_memory_type() or 
  __reqbufs()), or -ENOMEM (from __reqbufs())

Other fixes:

- added missing spinlock initialisation

 drivers/media/platform/Kconfig  |    9 +
 drivers/media/platform/Makefile |    2 +
 drivers/media/platform/sh_veu.c | 1312 +++++++++++++++++++++++++++++++++++++++
