...
Received: from mail-wy0-f174.google.com ([74.125.82.174]:53327 "EHLO
	...
	with ESMTP id S1757873Ab1EYNLC (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 25 May 2011 09:11:02 -0400
Received: by mail-wy0-f174.google.com with SMTP id 21so5754852wya.19
        for <linux-media@vger.kernel.org>; Wed, 25 May 2011 06:11:01 -0700 (PDT)
From: "Christoph Pinkl" <christoph.pinkl@gmail.com>
To: <linux-media@vger.kernel.org>
Subject: [PATCH] Add remote control support for mantis
Date: Wed, 25 May 2011 15:10:58 +0200
Message-ID: <4ddcffe4.9cebd80a.355f.25e0@mx.google.com>
MIME-Version: 1.0
...
@@ -171,7 +171,6 @@ int mantis_uart_init(struct mantis_pci *mantis)
 	...
 	mmwrite(mmread(MANTIS_UART_CTL) | MANTIS_UART_RXINT,
MANTIS_UART_CTL);
...
@@ -343,6 +346,20 @@ static int vp1041_frontend_init(struct mantis_pci
