...
Received: from mail-we0-f174.google.com ([74.125.82.174]:40522 "EHLO
	mail-we0-f174.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753890Ab2HEOKf (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Sun, 5 Aug 2012 10:10:35 -0400
Received: by weyx8 with SMTP id x8so1389638wey.19
        for <linux-media@vger.kernel.org>; Sun, 05 Aug 2012 07:10:34 -0700 (PDT)
Message-ID: <1344175824.18047.7.camel@router7789>
Subject: [PATCH] lmedm04 v2.05 conversion to dvb-usb-v2
From: Malcolm Priestley <tvboxspy@gmail.com>
To: Linux Media Mailing List <linux-media@vger.kernel.org>
Cc: Mauro Carvalho Chehab <mchehab@redhat.com>,
	Antti Palosaari <crope@iki.fi>
Date: Sun, 05 Aug 2012 15:10:24 +0100
...
+	struct dvb_usb_device *d = adap_to_d(adap);
 	...
 	mutex_lock(&d->i2c_mutex);
@@ -976,59 +955,42 @@ static struct m88rs2000_config m88rs2000_config = {
...
@@ -1038,120 +1000,117 @@ static int lme_name(struct dvb_usb_adapter *adap)
...
+			&d->i2c_adap, DVB_PLL_OPERA1))
 		...
 		break;
 	case TUNER_RS2000:
@@ -1165,7 +1124,7 @@ static int dm04_lme2510_tuner(struct dvb_usb_adapter *adap)
...
@@ -1179,6 +1138,50 @@ static int dm04_lme2510_tuner(struct dvb_usb_adapter *adap)
 	return ret;
 }
 
+static int dm04_fe_ioctl_override(struct dvb_frontend *fe,
...
+		/* TODO add other tuners here */
+		switch (cmd) {
+		case FE_SET_VOLTAGE:
+			ret = dm04_lme2510_set_voltage(fe,
+				(fe_sec_voltage_t) parg);
+			if (ret == 0 && st->tuner_config != TUNER_RS2000)
+				ret = 1;
+			break;
+		case FE_READ_SIGNAL_STRENGTH:
+			if (st->tuner_config == TUNER_RS2000) {
+				parg_get = parg;
+				*parg_get = (u16)((u32)st->signal_level
+					* 0xffff / 0x7f);
+				ret = 1;
+			}
+			break;
...
+
 ...
 {
 	struct lme2510_state *st = d->priv;
@@ -1201,158 +1204,57 @@ static int lme2510_powerup(struct dvb_usb_device *d, int onoff)
 	return ret;
 }
...
+}
 ...
 {
@@ -1361,8 +1263,7 @@ static void *lme2510_exit_int(struct dvb_usb_device *d)
 	void *buffer = NULL;
...
@@ -1383,29 +1284,86 @@ static void *lme2510_exit_int(struct dvb_usb_device *d)
 	return buffer;
 }
...
+	.frontend_attach  = dm04_lme2510_frontend_attach,
+	.tuner_attach = dm04_lme2510_tuner,
+	.fe_ioctl_override = dm04_fe_ioctl_override,
...
index 67b91b7..3e3efcc 100644
--- a/drivers/media/dvb/dvb-usb/Kconfig
+++ b/drivers/media/dvb/dvb-usb/Kconfig
@@ -312,19 +312,6 @@ config DVB_USB_AZ6027
 	help
...
index 29fa0f0..fccc931 100644
--- a/drivers/media/dvb/dvb-usb/Makefile
+++ b/drivers/media/dvb/dvb-usb/Makefile
@@ -75,9 +75,6 @@ obj-$(CONFIG_DVB_USB_AZ6007) += dvb-usb-az6007.o
