...
Received: from lb3-smtp-cloud2.xs4all.net ([194.109.24.29]:50169 "EHLO
	lb3-smtp-cloud2.xs4all.net" rhost-flags-OK-OK-OK-OK)
	by vger.kernel.org with ESMTP id S1751470AbbCTOoS (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 20 Mar 2015 10:44:18 -0400
Message-ID: <550C323B.3070903@xs4all.nl>
Date: Fri, 20 Mar 2015 15:44:11 +0100
...
Subject: Re: [PATCH v9] media: i2c: add support for omnivision's ov2659 sensor
References: <1426854398-10177-1-git-send-email-prabhakar.csengg@gmail.com>
In-Reply-To: <1426854398-10177-1-git-send-email-prabhakar.csengg@gmail.com>
...
I would just drop colorspace: it's always the same anyway.
...
You do that in quite a few places.
...
As mentioned above, just drop .colorspace.
...
checkpatch complains about this unnecessary return.
...
Huh? What exactly do you want to do here? I don't see any call to v4l2_ctrl_activate()
