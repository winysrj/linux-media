...
Received: from smtp-vbr13.xs4all.nl ([194.109.24.33]:4076 "EHLO
	smtp-vbr13.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753101AbaFTHCr (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 20 Jun 2014 03:02:47 -0400
Message-ID: <53A3DC7A.7040509@xs4all.nl>
Date: Fri, 20 Jun 2014 09:02:18 +0200
From: Hans Verkuil <hverkuil@xs4all.nl>
MIME-Version: 1.0
To: Ramakrishnan Muthukrishnan <ram@fastmail.in>,
	linux-media@vger.kernel.org
CC: Ramakrishnan Muthukrishnan <ramakrmu@cisco.com>
Subject: Re: [REVIEW PATCH 4/4] media: Documentation: remove V4L2_FL_USE_FH_PRIO
 flag.
References: <1403198580-3126-1-git-send-email-ram@fastmail.in> <1403198580-3126-5-git-send-email-ram@fastmail.in>
