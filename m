...
Received: from void.printf.net ([89.145.121.20]:46665 "EHLO void.printf.net"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1760429Ab2D0QoS (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Fri, 27 Apr 2012 12:44:18 -0400
From: Chris Ball <cjb@laptop.org>
To: Jonathan Corbet <corbet@lwn.net>
Cc: linux-media@vger.kernel.org
Subject: Re: [PATCH 2/2] marvell-cam: Build fix: missing "select VIDEOBUF2_VMALLOC"
In-Reply-To: <20120427100358.4f5c2be7@lwn.net> (Jonathan Corbet's message of
	"Fri, 27 Apr 2012 10:03:58 -0600")
References: <87d36u9rzc.fsf@laptop.org> <20120427100358.4f5c2be7@lwn.net>
Date: Fri, 27 Apr 2012 12:44:41 -0400
Message-ID: <87fwbp86py.fsf@laptop.org>
MIME-Version: 1.0
...
# Linux/arm 3.3.1 Kernel Configuration
#
CONFIG_ARM=y
...
CONFIG_MACH_OLPC_XO_1_75=y
# CONFIG_MACH_OLPC_XO_3 is not set
CONFIG_CPU_MMP2=y
CONFIG_MMP2_GPU=y
...
CONFIG_CMDLINE="console=ttyS2,115200 console=tty0 selinux=0 fbcon=font:SUN12x22"
...
CONFIG_OLPC_EC_1_75=y
CONFIG_OLPC_SWITCH_1_75=y
...
CONFIG_VIVANTE_GC_SUPPORT=y
CONFIG_GALCORE_MARVELL=y
# CONFIG_GALCORE_VIVANTE is not set
CONFIG_GALCORE_ENABLE_ARM_L2_CACHE=y
# CONFIG_GALCORE_NO_DMA_COHERENT is not set
CONFIG_GALCORE_PLATFORM_GPU=y
# CONFIG_GALCORE_ENABLE_GPU_CLOCK_BY_DRIVER is not set
CONFIG_GALCORE_USE_3D_VG=y
# CONFIG_GALCORE_USE_POWER_MANAGEMENT is not set
# CONFIG_GALCORE_USE_PROFILER is not set
# CONFIG_GALCORE_USE_NEW_LINUX_SIGNAL is not set
CONFIG_GALCORE_NO_USER_DIRECT_ACCESS_FROM_KERNEL=y
CONFIG_GALCORE_PROC=y
# CONFIG_GALCORE_DEBUG is not set
...
CONFIG_SND_SOC=y
CONFIG_SND_MMP2_SOC=y
CONFIG_SND_MMP2_SOC_OLPC_XO_1_75=y
CONFIG_SND_SOC_I2C_AND_SPI=y
# CONFIG_SND_SOC_ALL_CODECS is not set
CONFIG_SND_SOC_ALC5631=y
...
# CONFIG_USB_PXA168_EHCI is not set
...
CONFIG_LEDS_TRIGGER_MMC_BLOCK=y
