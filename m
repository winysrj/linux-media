...
Received: from metis.ext.pengutronix.de ([92.198.50.35]:32964 "EHLO
	metis.ext.pengutronix.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751996AbaFCJgN (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Tue, 3 Jun 2014 05:36:13 -0400
From: Philipp Zabel <p.zabel@pengutronix.de>
To: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
Cc: Mauro Carvalho Chehab <m.chehab@samsung.com>,
	linux-media@vger.kernel.org, kernel@pengutronix.de,
	Philipp Zabel <p.zabel@pengutronix.de>
Subject: [PATCH v2 5/5] [media] mt9v032: use regmap
Date: Tue,  3 Jun 2014 11:35:55 +0200
Message-Id: <1401788155-3690-6-git-send-email-p.zabel@pengutronix.de>
