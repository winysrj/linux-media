...
Received: from mail-wi0-f170.google.com ([209.85.212.170]:37993 "EHLO
	mail-wi0-f170.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1758694Ab2GLHOe (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 12 Jul 2012 03:14:34 -0400
Received: by wibhq12 with SMTP id hq12so5279063wib.1
        for <linux-media@vger.kernel.org>; Thu, 12 Jul 2012 00:14:32 -0700 (PDT)
MIME-Version: 1.0
In-Reply-To: <1342018424.2865.114.camel@pizza.hi.pengutronix.de>
References: <1341825437-23420-1-git-send-email-javier.martin@vista-silicon.com>
	<1342018424.2865.114.camel@pizza.hi.pengutronix.de>
Date: Thu, 12 Jul 2012 09:14:32 +0200
Message-ID: <CACKLOr3ozrNQZpv5LgoiybpeU1WwgW9=n1q3F3yhRE=C5Ah6fw@mail.gmail.com>
Subject: Re: [PATCH v2 2/3] media: coda: Add driver for Coda video codec.
...
On 11 July 2012 16:53, Philipp Zabel <p.zabel@pengutronix.de> wrote:
> Hi Javier,
>
> I noticed a few more issues, some of them only cosmetic, when trying to
> use this with GStreamer. Please see below.
>
> Am Montag, den 09.07.2012, 11:17 +0200 schrieb Javier Martin:
...
>> --
>> Changes since v1:
>>  - Don't set default 'n' in Kconfig.
>>  - Don't depend on SOC_IMX27 in Kconfig.
>>  - Remove framerate control.
>>  - Remove CODA_INVALID.
>>  - 's/CODA9/CODA7'.
>>  - Cosmetic fixes.
>>
...
>>  drivers/media/video/coda.c   | 1874 ++++++++++++++++++++++++++++++++++++++++++
>>  drivers/media/video/coda.h   |  214 +++++
>>  4 files changed, 2098 insertions(+)
...
>> +int coda_debug;
>
> This should be static. sparse found this one and a few more of those.
>
...
>
> According to the v4l2 spec, bytesperline only applies to the Y plane
> here. This should be q_data->width rounded up to an even value.
>
...
>
> videodev2.h says bytesperline should be zero if unused, and GStreamer
> also expects this field to be zero for compressed formats.
> What is the reason to set it to the image size?

Good catch,
I don't know what exactly led me to assign those values but you are
definitely right. Please take a look at the new v3 patch I've sent.
...
>
> As above, round_up(f->fmt.pix.width, 2).
>
...
>> +}
>
> get_qops() is not needed anymore.
>
>> +
...
>> +     dst_vq->ops = get_qops();
>
> Same here, use &coda_qops directly.
>
...
>
> Could you turn all hexadecimal constants to lower case?
>
...
I basically agree with all the points you exposed. Please, find all of
them fixed in my last v3 patch.
