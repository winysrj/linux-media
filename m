...
Received: from atrey.karlin.mff.cuni.cz ([195.113.26.193]:56122 "EHLO
        atrey.karlin.mff.cuni.cz" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1750886AbdALLRf (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Thu, 12 Jan 2017 06:17:35 -0500
Date: Thu, 12 Jan 2017 12:17:31 +0100
...
Message-ID: <20170112111731.GA27541@amd>
...
> +
> +This is a binding for a gpio controlled switch for camera interfaces. Su=
ch a
> +device is used on some embedded devices to connect two cameras to the sa=
me
...
> +/*
> + * TODO:
> + * isp_subdev_notifier_complete() calls v4l2_device_register_subdev_node=
s()
> + */
> +
...
> +}
> +
> +static int vbs_subdev_notifier_complete(struct v4l2_async_notifier *asyn=
c)
> +{
> +	struct vbs_data *pdata =3D container_of(async, struct vbs_data, notifie=
r);
> +	struct media_entity *sink =3D &pdata->subdev.entity;
> +	int sink_pad;
> +
...
> +}
> +
> +static int vbs_g_endpoint_config(struct v4l2_subdev *sd, struct v4l2_of_=
endpoint *cfg)
> +{
> +	struct vbs_data *pdata =3D v4l2_get_subdevdata(sd);
...
iEYEARECAAYFAlh3ZcoACgkQMOfwapXb+vKcpQCgunnz+cxKUfXJGkOS319dlCiS
stUAoLV4S1TuuWlAXqArtRXCAbg9QSbP
=KRgh
-----END PGP SIGNATURE-----
