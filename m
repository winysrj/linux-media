...
Received: from mga09.intel.com ([134.134.136.24]:28547 "EHLO mga09.intel.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1754756AbbCBQ6I (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Mon, 2 Mar 2015 11:58:08 -0500
Date: Tue, 3 Mar 2015 00:57:39 +0800
From: kbuild test robot <fengguang.wu@intel.com>
To: Hans Verkuil <hverkuil@xs4all.nl>
Cc: kbuild-all@01.org, Mauro Carvalho Chehab <m.chehab@samsung.com>,
	linux-media@vger.kernel.org
Subject: [linuxtv-media:fixes 1/2]
 drivers/media/v4l2-core/videobuf2-core.c:3228:26: warning: unused variable
 'fileio'
Message-ID: <201503030038.umi3yNLK%fengguang.wu@intel.com>
MIME-Version: 1.0
...
head:   ce037f19aaef992c634af653b17e61eee30a9404
commit: 0e661006370b7e7fb9ac9d94f9c3500a62cd559b [1/2] [media] vb2: fix 'UNBALANCED' warnings when calling vb2_thread_stop()
config: i386-allyesconfig (attached as .config)
reproduce:
  git checkout 0e661006370b7e7fb9ac9d94f9c3500a62cd559b
...
vim +/fileio +3228 drivers/media/v4l2-core/videobuf2-core.c

3415a89f Hans Verkuil 2014-04-14  3212  		threadio->thread = NULL;
3415a89f Hans Verkuil 2014-04-14  3213  		goto nothread;
3415a89f Hans Verkuil 2014-04-14  3214  	}
3415a89f Hans Verkuil 2014-04-14  3215  	return 0;
3415a89f Hans Verkuil 2014-04-14  3216  
3415a89f Hans Verkuil 2014-04-14  3217  nothread:
3415a89f Hans Verkuil 2014-04-14  3218  	__vb2_cleanup_fileio(q);
3415a89f Hans Verkuil 2014-04-14  3219  nomem:
3415a89f Hans Verkuil 2014-04-14  3220  	kfree(threadio);
3415a89f Hans Verkuil 2014-04-14  3221  	return ret;
3415a89f Hans Verkuil 2014-04-14  3222  }
3415a89f Hans Verkuil 2014-04-14  3223  EXPORT_SYMBOL_GPL(vb2_thread_start);
3415a89f Hans Verkuil 2014-04-14  3224  
3415a89f Hans Verkuil 2014-04-14  3225  int vb2_thread_stop(struct vb2_queue *q)
3415a89f Hans Verkuil 2014-04-14  3226  {
3415a89f Hans Verkuil 2014-04-14  3227  	struct vb2_threadio_data *threadio = q->threadio;
3415a89f Hans Verkuil 2014-04-14 @3228  	struct vb2_fileio_data *fileio = q->fileio;
3415a89f Hans Verkuil 2014-04-14  3229  	int err;
3415a89f Hans Verkuil 2014-04-14  3230  
3415a89f Hans Verkuil 2014-04-14  3231  	if (threadio == NULL)
3415a89f Hans Verkuil 2014-04-14  3232  		return 0;
3415a89f Hans Verkuil 2014-04-14  3233  	threadio->stop = true;
0e661006 Hans Verkuil 2015-02-16  3234  	/* Wake up all pending sleeps in the thread */
0e661006 Hans Verkuil 2015-02-16  3235  	vb2_queue_error(q);
6cf11ee6 Hans Verkuil 2015-01-19  3236  	err = kthread_stop(threadio->thread);

:::::: The code at line 3228 was first introduced by commit
:::::: 3415a89f48dce655ae353bc70a8e292764e8e931 [media] vb2: add thread support
