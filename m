...
Received: from aer-iport-4.cisco.com ([173.38.203.54]:39474 "EHLO
	...
	with ESMTP id S1751206AbbIGNpO (ORCPT
...
Subject: [PATCHv9 11/15] cec: adv7604: add cec support.
Date: Mon,  7 Sep 2015 15:44:40 +0200
Message-Id: <0ecbbe5251e0088e0da7ff0cf0bf4ef31511ce63.1441633456.git.hansverk@cisco.com>
...
@@ -430,7 +438,8 @@ static inline int io_write(struct v4l2_subdev *sd, u8 reg, u8 val)
...
@@ -463,6 +472,12 @@ static inline int cec_write(struct v4l2_subdev *sd, u8 reg, u8 val)
...
@@ -891,9 +913,14 @@ static int adv76xx_s_detect_tx_5v_ctrl(struct v4l2_subdev *sd)
 {
 	struct adv76xx_state *state = to_state(sd);
...
+
 ...
 {
 	struct adv76xx_state *state = to_state(sd);
@@ -1959,6 +2178,9 @@ static int adv76xx_isr(struct v4l2_subdev *sd, u32 status, bool *handled)
 			*handled = true;
 	}
...
+
 	...
 	if (tx_5v) {
@@ -2266,8 +2488,19 @@ static int adv76xx_log_status(struct v4l2_subdev *sd)
...
@@ -2400,6 +2633,11 @@ static const struct v4l2_subdev_video_ops adv76xx_video_ops = {
...
@@ -3249,6 +3487,14 @@ static int adv76xx_remove(struct i2c_client *client)
