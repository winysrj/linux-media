...
Received: from perceval.irobotique.be ([92.243.18.41]:56756 "EHLO
	...
	with ESMTP id S1753664Ab0JEOZI (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Tue, 5 Oct 2010 10:25:08 -0400
From: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
To: linux-media@vger.kernel.org
Cc: sakari.ailus@maxwell.research.nokia.com
Subject: [PATCH/RFC v3 09/11] v4l: v4l2_subdev userspace format API
Date: Tue,  5 Oct 2010 16:25:12 +0200
Message-Id: <1286288714-16506-10-git-send-email-laurent.pinchart@ideasonboard.com>
...
---
 ...
 drivers/media/video/v4l2-subdev.c                  |   47 +
 include/linux/Kbuild                               |    1 +
 include/linux/v4l2-subdev.h                        |   90 ++
 include/media/v4l2-subdev.h                        |   10 +
 13 files changed, 2178 insertions(+), 1 deletions(-)
...
index 3d08750..af04e82 100644
--- a/drivers/media/video/v4l2-subdev.c
+++ b/drivers/media/video/v4l2-subdev.c
@@ -132,6 +132,7 @@ static long subdev_do_ioctl(struct file *file, unsigned int cmd, void *arg)
...
@@ -167,6 +168,52 @@ static long subdev_do_ioctl(struct file *file, unsigned int cmd, void *arg)
