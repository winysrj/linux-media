...
Received: from smtp1.betherenow.co.uk ([87.194.0.68])
	...
	(envelope-from <tghewett2@onetel.com>) id 1JngHy-0002d7-T2
	for linux-dvb@linuxtv.org; Sun, 20 Apr 2008 22:37:34 +0200
Message-Id: <EF8B9950-8BD0-4123-A96C-081621154365@onetel.com>
From: Tim Hewett <tghewett2@onetel.com>
To: bas@kompasmedia.nl
In-Reply-To: <65417d9de0a860b3b76c58263d4e4112@localhost>
Mime-Version: 1.0 (Apple Message framework v919.2)
Date: Sun, 20 Apr 2008 21:36:55 +0100
References: <11E5EC6B-6658-4703-A2B1-F39EB49ED318@onetel.com>
	<65417d9de0a860b3b76c58263d4e4112@localhost>
...
I forgot about the other hack I had to do to get this going. Add these  
two lines just after the list of #includes near the top of v4l/ 
mantis_dvb.c:
...
On 20 Apr 2008, at 20:00, Bas v.d. Wiel wrote:

>
> Hello there,
> In my case this crashes when compiling with an error about implicity
> declaration of ca_init in mantis.c. Nothing seems to work, at all. I'm
> starting to feel VERY ripped-off by TwinHan. They actively advertise a
> Linux driver on their website, which is why I bought this specific  
> card in
> the first place. I'm about to give up on this card completely. I'll  
> leave
> it in my machine for now and use Windows to watch TV. If anyone  
> knows of a
> *working* alternative that supports the capture of encrypted DVB-C on
> Linux, PLEASE let me know. If anyone feels like debugging my setup,  
> mail me
> privately for login details.
>
>
> Cheers!
>
> Bas
>
> On Sun, 20 Apr 2008 14:49:57 +0100, Tim Hewett <tghewett2@onetel.com>
> wrote:
>> Same problem here with a Technisat SkyStar HD2 / Azurewave AD SP400 /
>> Twinhan VP-1041 using dvbstream.
>>
>> I have reverted to changeset 7301 ("hg clone -r 7301 -v
>> http://jusst.de/hg/mantis
>> ") and applied this patch: http://de.pastebin.ca/957250 (this may  
>> only
...
>> usbnet dvb_usb_dtt200u dvb_usb mantis soundcore parport psmouse  
>> pcspkr
>> cdrom mii b2c2_flexcop_pci b2c2_flexcop snd_page_alloc lnbp21 mb86a16
>> stb6100 tda10021 tda10023 stb0899 stv0299 dvb_core i2c_nforce2  
>> generic
...
>> [  131.145363] Pid: 6037, comm: dvbstream Tainted: P         
>> 2.6.24.4 #1
