...
Received: from mail-pg0-f68.google.com ([74.125.83.68]:34662 "EHLO
        mail-pg0-f68.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1751137AbdFJTAo (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Sat, 10 Jun 2017 15:00:44 -0400
...
Subject: [PATCH v9 19/34] media: Add i.MX media core driver
Date: Sat, 10 Jun 2017 12:00:29 -0700
Message-Id: <1497121229-9843-1-git-send-email-steve_longerbeam@mentor.com>
In-Reply-To: <1496860453-6282-20-git-send-email-steve_longerbeam@mentor.com>
References: <1496860453-6282-20-git-send-email-steve_longerbeam@mentor.com>
...
- don't return error if the entity given to imx_media_add_vdev_to_pad()
  is not a v4l2-subdev, just skip it.

[1] https://patchwork.linuxtv.org/patch/41703/
---
