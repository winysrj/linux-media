...
Received: from shell.v3.sk ([90.176.6.54]:49590 "EHLO shell.v3.sk"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1729555AbeKEQuE (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Mon, 5 Nov 2018 11:50:04 -0500
...
Subject: [PATCH 11/11] [media] marvell-ccic: provide a clock for the sensor
Date: Mon,  5 Nov 2018 08:30:54 +0100
Message-Id: <20181105073054.24407-12-lkundrak@v3.sk>
...
@@ -94,95 +91,6 @@ static struct mmp_camera *mmpcam_find_device(struct pl=
atform_device *pdev)
 	return NULL;
 }
=20
...
=20
 	mcam_init_clk(mcam);
=20
@@ -411,14 +290,21 @@ static int mmpcam_probe(struct platform_device *pde=
v)
...
@@ -437,10 +323,10 @@ static int mmpcam_probe(struct platform_device *pde=
v)
 		return 0;
 	}
=20
...
=20
@@ -483,12 +368,6 @@ static int mmpcam_resume(struct platform_device *pde=
v)
 {
