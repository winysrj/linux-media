...
Received: from lb3-smtp-cloud8.xs4all.net ([194.109.24.29]:37519 "EHLO
        lb3-smtp-cloud8.xs4all.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1731008AbeGSM4x (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Thu, 19 Jul 2018 08:56:53 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Tom aan de Wiel <tom.aandewiel@gmail.com>,
        Hans Verkuil <hans.verkuil@cisco.com>
Subject: [PATCH 5/5] vicodec: add the virtual codec driver
Date: Thu, 19 Jul 2018 14:13:53 +0200
Message-Id: <20180719121353.20021-6-hverkuil@xs4all.nl>
...
new file mode 100644
index 000000000000..f1f7f597768c
--- /dev/null
...
+{
+	static const u8 magic[] = { 0x4f, 0x4f, 0x4f, 0x4f, 0x6f, 0x6f, 0x6f, 0x6f };
+	struct vicodec_ctx *ctx = priv;
+	struct vb2_v4l2_buffer *src_buf;
+	u8 *p_out;
+	u8 *p;
