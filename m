...
Received: from smtp.nokia.com ([147.243.128.26]:48239 "EHLO mgw-da02.nokia.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S933847Ab0KQOc0 (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Wed, 17 Nov 2010 09:32:26 -0500
From: "Matti J. Aaltonen" <matti.j.aaltonen@nokia.com>
To: mchehab@redhat.com, hverkuil@xs4all.nl, sameo@linux.intel.com,
	linux-media@vger.kernel.org
Cc: "Matti J. Aaltonen" <matti.j.aaltonen@nokia.com>
Subject: [PATCH v16 2/2] V4L2: WL1273 FM Radio: TI WL1273 FM radio driver
Date: Wed, 17 Nov 2010 15:42:01 +0200
Message-Id: <1290001321-6732-3-git-send-email-matti.j.aaltonen@nokia.com>
In-Reply-To: <1290001321-6732-2-git-send-email-matti.j.aaltonen@nokia.com>
...
---
 ...
 3 files changed, 2364 insertions(+), 0 deletions(-)
...
+			      struct wl1273_fw_packet *packets, int len)
+{
+	struct i2c_client *client = core->client;
+	struct i2c_msg msg;
+	int i, r = 0;
...
+
+	for (i = 0; i <= len; i++) {
+		msg.len = packets[i].len;
+		msg.buf = packets[i].buf;
+
+		r = i2c_transfer(client->adapter, &msg, 1);
+		if (r < 0 && i < len + 1)
+			break;
...
+	}
+
+	r = wl1273_fm_write_fw(core, packets, packet_num);
+	kfree(packets);
+
+	if (r) {
...
+				__func__, r);
+	} else if (core->mode == WL1273_MODE_TX) {
+		int r = wl1273_fm_write_cmd(core, WL1273_PUPD_SET, WL1273_PUPD_SET_OFF);
+		if (r)
+			dev_err(radio->dev,
+				"%s: PUPD_SET fails: %d\n", __func__, r);
+	}
...
+		/* If this fails try again */
+		r = wl1273_fm_write_cmd(core, WL1273_PUPD_SET, WL1273_PUPD_SET_ON);
+		if (r) {
+			msleep(100);
...
+		goto out;
+
+	r = wl1273_fm_write_cmd(core, WL1273_TUNER_MODE_SET, TUNER_MODE_AUTO_SEEK);
+	if (r)
+		goto out;
+
