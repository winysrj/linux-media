...
Received: from rv-out-0506.google.com ([209.85.198.225])
	...
	(envelope-from <anluoma@gmail.com>) id 1Jprr2-0003F9-3W
	for linux-dvb@linuxtv.org; Sat, 26 Apr 2008 23:22:45 +0200
Received: by rv-out-0506.google.com with SMTP id b25so2797593rvf.41
	for <linux-dvb@linuxtv.org>; Sat, 26 Apr 2008 14:22:39 -0700 (PDT)
Message-ID: <754a11be0804261422u62cf6302g978deb3257381439@mail.gmail.com>
Date: Sun, 27 Apr 2008 00:22:38 +0300
From: "Antti Luoma" <anluoma@gmail.com>
To: "Bert Haverkamp" <bert@bertenselena.net>, linux-dvb <linux-dvb@linuxtv.org>
In-Reply-To: <754a11be0804240813k36301454nb92097727190ea0@mail.gmail.com>
MIME-Version: 1.0
References: <754a11be0803171553p63ac231aicbaeaee4c91b2a2d@mail.gmail.com>
	...
	<754a11be0804240813k36301454nb92097727190ea0@mail.gmail.com>
...
Content-Type: multipart/mixed; boundary="===============0994357287=="
Mime-version: 1.0
...
Content-Type: multipart/alternative;
	boundary="----=_Part_1258_11101181.1209244958309"

------=_Part_1258_11101181.1209244958309
...
Good new! I installed new and shiny Hardy Heron (Ubuntu 8.04) and compiled
drivers from todays head-revision, booted, launched me-tv and it found my
channels ok, and ALL the channels seem to work! So somebody must have done
something because now it works with all channels..

Installed also mythtv (it complained something when it installed mysqlserver
package, but it seems to still work.

And if somebody is wondering why mythtv isn't showing any channels, just
blank screen, check channels table from mysql.. there is a bug that it
populates data with wrong multiplex_id -> you have to manually change them
with sql editor (I used Mysql Administrator / query browser)..
Mythtvfrontend seems to have some seqfaults, but sometimes it works. But
this isn't my fronted to come so I am not so annoyed with them (yet.. )


-Antti-


2008/4/24 Antti Luoma <anluoma@gmail.com>:
...
> > > Hi,
> > >
> > > This was a linux kernel issue, same issue that many others have
> > faced... I
...
> > it.
> > > At first it hang when I issued the scan -> had to reboot (usb was
> > gone).
> > > > >
> > > > > After that same usb error keeps bothering me and I can't get
> > nothing out
> > > of the tuner.
> > > > >
...
> > > channels..
> > > > >
> > > > > Anyone has more ideas to try? (they are starting to be very
> > welcome)
> > > > >
> > > > >
> > > > > -antti-
...
> > > > > > > > > > Yes I'm sure.
> > > > > > > > > >
> > > > > > > > > > Could the problem be low power from usb? Though this is
> > the
...
> > > > > > > > > >
> > > > > > > > > > It looks that it is disconnecting the device after scan
> > has
> > > started...?
> > > > > > > > > >
> > > > > > > > > > BTW this is Ubuntu 8.04 (RC4):
> > > > > > > > > > Linux xenbuntu 2.6.24-12-generic #1 SMP Wed Mar 12
> > 22:31:43
...
> > > > > > > > > > >
> > > > > > > > > > >        dib0700_set_gpio(adap->dev, GPIO6, GPIO_OUT,
> > 0);
> > > > > > > > > > >
> > > > > > > > > > > Because I remember with 72e that with GPIO6 set to 1
> > the
> > > tunner is disabled.
> > > > > > > > > > > Anyway, your dmesg should tell more information after
> > the
> > > failed tunning.
> > > > > > > > > > >
> > > > > > > > > > > Albert
...
> > > > > > > > > > > >
> > > > > > > > > > > > I tested the Stick with windows and it found
> > channels ok..
...
> > > > > > > > > > > > >
> > > > > > > > > > > > > Tomorrow I'l (hmm today, its getting late) test
> > this
...
> > > > > > > > > > > > > > > Hi,
> > > > > > > > > > > > > > >
> > > > > > > > > > > > > > > I have trying to get Solo Stick (72e) to work
> > for
...
> > ehci_hcd
> > > and address 30
> > > > > > > > > > > > > > > [ 6722.607546] usb 6-4: configuration #1
> > chosen from
> > > 1 choice
...
> > (DiBcom
> > > 7000PC)...
> > > > > > > > > > > > > > > [ 6722.811550] DiB0070: successfully
> > identified
> > > > > > > > > > > > > > > [ 6722.811557] dvb-usb: Pinnacle PCTV 72e
> > DVB-T
...
Hello again,<br><br><br>Good new! I installed new and shiny Hardy Heron (Ubuntu 8.04) and compiled drivers from todays head-revision, booted, launched me-tv and it found my channels ok, and ALL the channels seem to work! So somebody must have done something because now it works with all channels.. <br>
<br>Installed also mythtv (it complained something when it installed mysqlserver package, but it seems to still work.<br><br>And if somebody is wondering why mythtv isn&#39;t showing any channels, just blank screen, check channels table from mysql.. there is a bug that it populates data with wrong multiplex_id -&gt; you have to manually change them with sql editor (I used Mysql Administrator / query browser).. Mythtvfrontend seems to have some seqfaults, but sometimes it works. But this isn&#39;t my fronted to come so I am not so annoyed with them (yet.. )<br>
<br><br>-Antti-<br><br><br><div class="gmail_quote">2008/4/24 Antti Luoma &lt;<a href="mailto:anluoma@gmail.com">anluoma@gmail.com</a>&gt;:<br><blockquote class="gmail_quote" style="border-left: 1px solid rgb(204, 204, 204); margin: 0pt 0pt 0pt 0.8ex; padding-left: 1ex;">
...
<br><div class="gmail_quote">2008/4/23 Bert Haverkamp &lt;<a href="mailto:bert@bertenselena.net" target="_blank">bert@bertenselena.net</a>&gt;:<div><div></div><div class="Wj3C7c"><br><blockquote class="gmail_quote" style="border-left: 1px solid rgb(204, 204, 204); margin: 0pt 0pt 0pt 0.8ex; padding-left: 1ex;">
...
Bert<br>
<br>
2008/3/31, Antti Luoma &lt;<a href="mailto:anluoma@gmail.com" target="_blank">anluoma@gmail.com</a>&gt;:<br>
...
&gt;<br>
&gt;<br>
&gt; 2008/3/20, Albert Comerma &lt;<a href="mailto:albert.comerma@gmail.com" target="_blank">albert.comerma@gmail.com</a>&gt;:<br>
&gt; &gt; Perhaps try an other computer?<br>
&gt; &gt;<br>
&gt; &gt;<br>
&gt; &gt; 2008/3/19, Antti Luoma &lt;<a href="mailto:anluoma@gmail.com" target="_blank">anluoma@gmail.com</a>&gt;:<br>
&gt; &gt;<br>
&gt; &gt; &gt; Hi again,<br>
&gt; &gt; &gt;<br>
...
&gt; &gt; &gt;<br>
&gt; &gt; &gt;<br>
&gt; &gt; &gt; 2008/3/18, Antti Luoma &lt;<a href="mailto:anluoma@gmail.com" target="_blank">anluoma@gmail.com</a>&gt;:<br>
...
&gt; &gt; &gt; &gt;<br>
&gt; &gt; &gt; &gt;<br>
&gt; &gt; &gt; &gt; 2008/3/18, Albert Comerma &lt;<a href="mailto:albert.comerma@gmail.com" target="_blank">albert.comerma@gmail.com</a>&gt;:<br>
...
&gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt;<br>
&gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt;<br>
&gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; 2008/3/17, Antti Luoma &lt;<a href="mailto:anluoma@gmail.com" target="_blank">anluoma@gmail.com</a>&gt;:<br>
&gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt;<br>
&gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; Hi,<br>
&gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt;<br>
...
</blockquote></div></div></div><br><br clear="all"><br>-- <br><font color="#888888">-Antti-
