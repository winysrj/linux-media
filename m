...
Received: from mga07.intel.com ([134.134.136.100]:35426 "EHLO mga07.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1751550AbdIRI4A (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Mon, 18 Sep 2017 04:56:00 -0400
Date: Mon, 18 Sep 2017 11:55:25 +0300
...
Subject: Re: [PATCH v5 2/2] media:imx274 V4l2 driver for Sony imx274 CMOS
 sensor
Message-ID: <20170918085525.y7f2uqw7r5p5luiu@paasikivi.fi.intel.com>
References: <20170915074952.22148-1-leonl@leopardimaging.com>
 <20170915074952.22148-2-leonl@leopardimaging.com>
MIME-Version: 1.0
Content-Type: text/plain; charset=utf-8
Content-Disposition: inline
Content-Transfer-Encoding: 8bit
In-Reply-To: <20170915074952.22148-2-leonl@leopardimaging.com>
...
No need to check this, the V4L2 subdev framework does it for you.
...
This makes it explicit how many entries there are. The same applies to
...
This would be nicer closer to imx274_of_id_table definition.
...
It'd be better to do this before v4l2_async_register_subdev --- that may
already expose the device node, and in that case the changes will be
visible to the user.
...
Even if the i2c write fails, the device will be removed, including the
resources allocated using devm_() functions. Therefore you can't return
here, but proceed with releasing the resources and unregistering devices.
