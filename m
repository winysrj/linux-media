...
Received: from metis.ext.pengutronix.de ([92.198.50.35]:55611 "EHLO
	metis.ext.pengutronix.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S932378AbbGJNtp (ORCPT
...
Subject: [PATCH v3 2/3] [media] v4l2-mem2mem: set the queue owner field just as vb2_ioctl_reqbufs does
Date: Fri, 10 Jul 2015 15:49:25 +0200
Message-Id: <1436536166-3307-2-git-send-email-p.zabel@pengutronix.de>
In-Reply-To: <1436536166-3307-1-git-send-email-p.zabel@pengutronix.de>
