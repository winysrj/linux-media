...
Received: from mail-pl0-f48.google.com ([209.85.160.48]:45314 "EHLO
        mail-pl0-f48.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1753420AbeBFU2U (ORCPT
        <rfc822;linux-media@vger.kernel.org>); Tue, 6 Feb 2018 15:28:20 -0500
Received: by mail-pl0-f48.google.com with SMTP id p5so1974420plo.12
...
Subject: [PATCH v8 5/7] media: i2c: Add TDA1997x HDMI receiver driver
Date: Tue,  6 Feb 2018 12:27:52 -0800
Message-Id: <1517948874-21681-6-git-send-email-tharvey@gateworks.com>
...
+
+	if (edid->pad != TDA1997X_PAD_SOURCE)
+		return -EINVAL;
+
