...
Received: from mailout1.w1.samsung.com ([210.118.77.11]:39235 "EHLO
        ...
        with ESMTP id S1751789AbdBNHwV (ORCPT
...
Subject: [PATCH 03/15] media: s5p-mfc: Replace mem_dev_* entries with an array
Date: Tue, 14 Feb 2017 08:51:56 +0100
Message-id: <1487058728-16501-4-git-send-email-m.szyprowski@samsung.com>
