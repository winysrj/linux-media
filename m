...
Received: from mail-vc0-f176.google.com ([209.85.220.176]:36647 "EHLO
	mail-vc0-f176.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1754885Ab3HMImS (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 13 Aug 2013 04:42:18 -0400
MIME-Version: 1.0
In-Reply-To: <520569B9.1030901@gmail.com>
References: <1375866242-18084-1-git-send-email-arun.kk@samsung.com>
	<1375866242-18084-4-git-send-email-arun.kk@samsung.com>
	<520569B9.1030901@gmail.com>
Date: Tue, 13 Aug 2013 14:12:17 +0530
Message-ID: <CALt3h7_=c1QaqyFObSoSn3jV=OSJi+-P=Rr=AyzZ3LtpyGa5XA@mail.gmail.com>
...
On Sat, Aug 10, 2013 at 3:44 AM, Sylwester Nawrocki
...
Did you mean static const char *fimc_is_clock_name[] ?
The one you mentioned is giving syntax error.
...
Ok I will add a pmu node and use its phandle in fimc-is node.
...
>> +                               pdev->dev.of_node);
>> +               if (match)
>> +                       driver_data = (struct fimc_is_drvdata
>> *)match->data;
>> +       }
>> +       return driver_data;
>> +}
