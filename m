...
Received: from lb2-smtp-cloud3.xs4all.net ([194.109.24.26]:34808 "EHLO
        lb2-smtp-cloud3.xs4all.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1751373AbdEHJGf (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Mon, 8 May 2017 05:06:35 -0400
...
Message-ID: <a33ac20c-5a72-3e6e-c55c-78bdb46449a5@xs4all.nl>
Date: Mon, 8 May 2017 11:06:29 +0200
MIME-Version: 1.0
...
See my review comments below. Nothing earth-shattering, you'll be pleased to hear :-)
...
I would very much prefer to see a helper function in v4l2-ctrls.c for this. Actually,
it would be sufficient to extend v4l2_ctrl_g_ctrl_int64 to support V4L2_CTRL_TYPE_INTEGER_MENU.
...
Don't set this, it will be set by vb2_buffer_done().
...
Don't set the device_caps/capabilities fields here. Instead fill the device_caps
field of the video_device when you create that. The v4l2 core will automatically
fill in these two struct v4l2_capability fields for you based on the video_device
device_caps field.
...
Shouldn't the colorspace/xfer_func/ycbcr_enc/quantization information all come
from the subdev? That's the one that knows about this.
...
Keep these defines out of the struct.
