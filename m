...
Received: from lb2-smtp-cloud2.xs4all.net ([194.109.24.25]:48121 "EHLO
        lb2-smtp-cloud2.xs4all.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1755877AbdGKNaO (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Tue, 11 Jul 2017 09:30:14 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: dri-devel <dri-devel@lists.freedesktop.org>,
        Daniel Vetter <daniel.vetter@ffwll.ch>,
        Hans Verkuil <hans.verkuil@cisco.com>
Subject: [PATCH 1/3] drm: add support for DisplayPort CEC-Tunneling-over-AUX
Date: Tue, 11 Jul 2017 15:30:09 +0200
Message-Id: <20170711133011.41139-2-hverkuil@xs4all.nl>
