...
Received: from smtp-vbr12.xs4all.nl ([194.109.24.32]:1317 "EHLO
	...
	with ESMTP id S1755249AbaDGNLn (ORCPT
...
Subject: [REVIEWv2 PATCH 03/13] vb2: if bytesused is 0, then fill with output buffer length
Date: Mon,  7 Apr 2014 15:11:02 +0200
Message-Id: <1396876272-18222-4-git-send-email-hverkuil@xs4all.nl>
