...
Received: from galahad.ideasonboard.com ([185.26.127.97]:56945 "EHLO
        ...
        with ESMTP id S932236AbcIBPbM (ORCPT
        <rfc822;linux-media@vger.kernel.org>); Fri, 2 Sep 2016 11:31:12 -0400
From: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
To: Sakari Ailus <sakari.ailus@linux.intel.com>
Cc: linux-media@vger.kernel.org, hverkuil@xs4all.nl,
        mchehab@osg.samsung.com
Subject: Re: [PATCH v4 3/5] media: Refactor copying IOCTL arguments from and to user space
Date: Fri, 02 Sep 2016 18:31:16 +0300
Message-ID: <1597937.xEjSpWDtUJ@avalon>
In-Reply-To: <1470947358-31168-4-git-send-email-sakari.ailus@linux.intel.com>
References: <1470947358-31168-1-git-send-email-sakari.ailus@linux.intel.com> <1470947358-31168-4-git-send-email-sakari.ailus@linux.intel.com>
MIME-Version: 1.0
