...
Received: from bombadil.infradead.org ([198.137.202.133]:58990 "EHLO
        ...
        with ESMTP id S1751664AbeEQTHU (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Thu, 17 May 2018 15:07:20 -0400
Date: Thu, 17 May 2018 16:07:08 -0300
From: Mauro Carvalho Chehab <mchehab+samsung@kernel.org>
To: LMML <linux-media@vger.kernel.org>
Subject: [ANN] Meeting to discuss improvements to support MC-based cameras
 on generic apps
Message-ID: <20180517160708.74811cfb@vento.lan>
MIME-Version: 1.0
...
Cheese, Xawtv, Firefox, Chromium, ...) and closed source ones (Skype,=20
