...
Received: from mailout1.w1.samsung.com ([210.118.77.11]:63168 "EHLO
	...
	with ESMTP id S1754778AbbLIN6l (ORCPT
...
Subject: [PATCH v2 6/7] media: s5p-mfc: replace custom reserved memory init
 code with generic one
Date: Wed, 09 Dec 2015 14:58:21 +0100
Message-id: <1449669502-24601-7-git-send-email-m.szyprowski@samsung.com>
