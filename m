...
Received: from mail.kapsi.fi ([217.30.184.167]:42171 "EHLO mail.kapsi.fi"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1751080Ab2ETTiY (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Sun, 20 May 2012 15:38:24 -0400
Message-ID: <4FB93B2E.6010109@iki.fi>
Date: Sun, 20 May 2012 21:42:54 +0300
...
References: <201205062257.02674.hfvogt@gmx.net>
In-Reply-To: <201205062257.02674.hfvogt@gmx.net>
...
> --- a/drivers/media/common/tuners/Kconfig	2012-05-06 22:20:10.167088333 +0200
> +++ b/drivers/media/common/tuners/Kconfig	2012-05-05 12:00:43.769785450 +0200
...
>   	depends on VIDEO_MEDIA&&  I2C
> diff -up --new-file --recursive a/drivers/media/common/tuners/Makefile b/drivers/media/common/tuners/Makefile
> --- a/drivers/media/common/tuners/Makefile	2012-05-06 22:20:25.270299615 +0200
> +++ b/drivers/media/common/tuners/Makefile	2012-05-06 19:13:08.974524215 +0200
...
> --- a/drivers/media/common/tuners/fc0013.c	1970-01-01 01:00:00.000000000 +0100
> +++ b/drivers/media/common/tuners/fc0013.c	2012-05-06 19:40:15.506368324 +0200
> @@ -0,0 +1,562 @@
> +/*
...
> +MODULE_LICENSE("GPL");
> +MODULE_VERSION("0.1");
> diff -up --new-file --recursive a/drivers/media/common/tuners/fc0013.h b/drivers/media/common/tuners/fc0013.h
> --- a/drivers/media/common/tuners/fc0013.h	1970-01-01 01:00:00.000000000 +0100
> +++ b/drivers/media/common/tuners/fc0013.h	2012-05-06 19:40:48.162715247 +0200
> @@ -0,0 +1,57 @@
> +/*
> + * Fitipower FC0013 tuner driver
> + *
...
> +
> +#endif
> diff -up --new-file --recursive a/drivers/media/common/tuners/fc0013-priv.h b/drivers/media/common/tuners/fc0013-
> priv.h
> --- a/drivers/media/common/tuners/fc0013-priv.h	1970-01-01 01:00:00.000000000 +0100
> +++ b/drivers/media/common/tuners/fc0013-priv.h	2012-05-06 19:33:20.420412665 +0200
> @@ -0,0 +1,44 @@
> +/*
> + * Fitipower FC0013 tuner driver
> + *
