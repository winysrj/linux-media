...
Received: from mail-we0-f180.google.com ([74.125.82.180]:60251 "EHLO
	mail-we0-f180.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752164AbbAOXj2 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 15 Jan 2015 18:39:28 -0500
...
Subject: [PATCH] media: i2c: add support for omnivision's ov2659 sensor
Date: Thu, 15 Jan 2015 23:39:23 +0000
Message-Id: <1421365163-29394-1-git-send-email-prabhakar.csengg@gmail.com>
...
+
+The OV2659 is a 1/5-inch SOC camera, with an active array size of 1632H x 1212V.
...
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -8754,6 +8754,16 @@ T:	git git://linuxtv.org/mhadli/v4l-dvb-davinci_devices.git
 S:	Maintained
...
+
+#define OV2659_DEFAULT_MCLK_FREQ	12000000
+
+/* Target Pixel Clock */
...
+
+	return ov2659_s_power(subdev, 1);
+}
+
+static int ov2659_close(struct v4l2_subdev *subdev, struct v4l2_subdev_fh *fh)
+{
+	return ov2659_s_power(subdev, 0);
+}
+
