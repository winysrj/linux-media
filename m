...
Received: from mail.kernel.org (mail.kernel.org [198.145.29.99])
	by smtp.lore.kernel.org (Postfix) with ESMTP id CA5F8C43444
	for <linux-media@archiver.kernel.org>; Fri, 18 Jan 2019 13:37:31 +0000 (UTC)
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.kernel.org (Postfix) with ESMTP id 82A8B20883
	for <linux-media@archiver.kernel.org>; Fri, 18 Jan 2019 13:37:31 +0000 (UTC)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727342AbfARNhb (ORCPT <rfc822;linux-media@archiver.kernel.org>);
        Fri, 18 Jan 2019 08:37:31 -0500
Received: from metis.ext.pengutronix.de ([85.220.165.71]:45173 "EHLO
        metis.ext.pengutronix.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727037AbfARNha (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Fri, 18 Jan 2019 08:37:30 -0500
Received: from dude.hi.pengutronix.de ([2001:67c:670:100:1d::7])
        by metis.ext.pengutronix.de with esmtps (TLS1.2:ECDHE_RSA_AES_256_GCM_SHA384:256)
        (Exim 4.89)
        (envelope-from <mtr@pengutronix.de>)
        id 1gkUKr-0006Uq-6r; Fri, 18 Jan 2019 14:37:25 +0100
Received: from mtr by dude.hi.pengutronix.de with local (Exim 4.92-RC4)
        (envelope-from <mtr@pengutronix.de>)
        id 1gkUKq-0001R7-SQ; Fri, 18 Jan 2019 14:37:24 +0100
...
Subject: [PATCH v2 3/3] [media] allegro: add SPS/PPS nal unit writer
Date:   Fri, 18 Jan 2019 14:37:16 +0100
Message-Id: <20190118133716.29288-4-m.tretter@pengutronix.de>
...
index db48747b345c..1572f71b420c 100644
...
+
  ...
  *
@@ -1278,6 +1280,131 @@ static int allocate_reference_buffers(struct allegro_channel *channel,
 					 n, PAGE_ALIGN(size));
 }
...
+
 ...
 {
@@ -1289,6 +1416,9 @@ static void allegro_finish_frame(struct allegro_channel *channel,
 		u32 size;
 	} *partition;
...
@@ -1337,10 +1467,60 @@ static void allegro_finish_frame(struct allegro_channel *channel,
