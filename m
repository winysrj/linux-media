...
Received: from mail-pa0-f46.google.com ([209.85.220.46]:40122 "EHLO
	...
	with ESMTP id S1751741Ab2KPOrT (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 16 Nov 2012 09:47:19 -0500
...
Subject: [PATCH v2 07/12] davinci: vpfe: dm365: resizer driver based on media framework
Date: Fri, 16 Nov 2012 20:15:09 +0530
Message-Id: <1353077114-19296-8-git-send-email-prabhakar.lad@ti.com>
...
diff --git a/drivers/media/platform/davinci/dm365_resizer.c b/drivers/media/platform/davinci/dm365_resizer.c
new file mode 100644
index 0000000..9cb0262
--- /dev/null
+++ b/drivers/media/platform/davinci/dm365_resizer.c
@@ -0,0 +1,1999 @@
+/*
...
+					res->end - res->start + 1);
+}
diff --git a/drivers/media/platform/davinci/dm365_resizer.h b/drivers/media/platform/davinci/dm365_resizer.h
new file mode 100644
index 0000000..59a7942
--- /dev/null
+++ b/drivers/media/platform/davinci/dm365_resizer.h
@@ -0,0 +1,244 @@
+/*
+ * Copyright (C) 2012 Texas Instruments Inc
+ *
