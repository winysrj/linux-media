...
Received: from mailout4.w1.samsung.com ([210.118.77.14]:58946 "EHLO
	...
	with ESMTP id S1758153Ab1GDRzo (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Mon, 4 Jul 2011 13:55:44 -0400
MIME-version: 1.0
Content-transfer-encoding: 7BIT
Content-type: TEXT/PLAIN
Date: Mon, 04 Jul 2011 19:55:00 +0200
From: Sylwester Nawrocki <s.nawrocki@samsung.com>
Subject: [PATCH v3 09/19] s5p-fimc: Conversion to use struct v4l2_fh
In-reply-to: <1309802110-16682-1-git-send-email-s.nawrocki@samsung.com>
To: linux-media@vger.kernel.org, linux-samsung-soc@vger.kernel.org
Cc: m.szyprowski@samsung.com, kyungmin.park@samsung.com,
	s.nawrocki@samsung.com, sw0312.kim@samsung.com,
	riverful.kim@samsung.com
Message-id: <1309802110-16682-10-git-send-email-s.nawrocki@samsung.com>
...
@@ -427,7 +449,7 @@ static int fimc_cap_s_fmt_mplane(struct file *file, void *priv,
...
+	struct fimc_dev *fimc = video_drvdata(file);
 	...
 	if (i->index != 0)
 		return -EINVAL;
@@ -451,8 +473,8 @@ static int fimc_cap_g_input(struct file *file, void *priv, unsigned int *i)
...
+	struct fimc_ctx *ctx = fimc->vid_cap.ctx;
 	...
 	if (fimc_capture_active(fimc) || !fimc->vid_cap.sd)
 		return -EBUSY;
@@ -468,8 +490,7 @@ static int fimc_cap_streamon(struct file *file, void *priv,
...
@@ -477,47 +498,43 @@ static int fimc_cap_streamoff(struct file *file, void *priv,
...
@@ -540,14 +557,12 @@ static int fimc_cap_s_ctrl(struct file *file, void *priv,
...
@@ -559,10 +574,8 @@ static int fimc_cap_cropcap(struct file *file, void *fh,
...
+	struct fimc_frame *f = &fimc->vid_cap.ctx->s_frame;
 	...
 	cr->c.left	= f->offs_h;
 	cr->c.top	= f->offs_v;
@@ -572,12 +585,11 @@ static int fimc_cap_g_crop(struct file *file, void *fh, struct v4l2_crop *cr)
 	return 0;
 }
...
@@ -615,9 +627,9 @@ static const struct v4l2_ioctl_ops fimc_capture_ioctl_ops = {
...
@@ -1422,13 +1426,18 @@ static int fimc_m2m_open(struct file *file)
...
@@ -1437,26 +1446,33 @@ static int fimc_m2m_open(struct file *file)
...
@@ -1465,9 +1481,9 @@ static int fimc_m2m_release(struct file *file)
 }
...
@@ -1475,7 +1491,7 @@ static unsigned int fimc_m2m_poll(struct file *file,
