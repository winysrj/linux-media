...
Received: from mx1.redhat.com ([209.132.183.28]:36834 "EHLO mx1.redhat.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1757709Ab2EGTUj (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Mon, 7 May 2012 15:20:39 -0400
From: Hans de Goede <hdegoede@redhat.com>
To: Linux Media Mailing List <linux-media@vger.kernel.org>
Cc: hverkuil@xs4all.nl, Hans Verkuil <hans.verkuil@cisco.com>,
	Hans de Goede <hdegoede@redhat.com>
Subject: [PATCH 20/23] gcpca-sn9c20x: convert to the control framework.
Date: Mon,  7 May 2012 21:01:31 +0200
Message-Id: <1336417294-4566-21-git-send-email-hdegoede@redhat.com>
...
---
 drivers/media/video/gspca/sn9c20x.c |  496 +++++++++++++++--------------------
 1 file changed, 213 insertions(+), 283 deletions(-)

diff --git a/drivers/media/video/gspca/sn9c20x.c b/drivers/media/video/gspca/sn9c20x.c
index 5285a51..9112b32 100644
...
@@ -1879,13 +1688,132 @@ static int sd_config(struct gspca_dev *gspca_dev,
 	sd->older_step = 0;
 	sd->exposure_step = 16;
...
+
 ...
 {
 	struct sd *sd = (struct sd *) gspca_dev;
@@ -1978,7 +1906,6 @@ static int sd_init(struct gspca_dev *gspca_dev)
...
@@ -2096,7 +2023,7 @@ static int sd_start(struct gspca_dev *gspca_dev)
...
+	jpeg_set_qual(sd->jpeg_hdr, v4l2_ctrl_g_ctrl(sd->jpegqual));
 	...
 	if (mode & MODE_RAW)
 		fmt = 0x2d;
@@ -2133,12 +2060,17 @@ static int sd_start(struct gspca_dev *gspca_dev)
...
@@ -2177,6 +2109,9 @@ static void sd_stop0(struct gspca_dev *gspca_dev)
...
+	s32 min = sd->exposure->minimum + sd->exposure_step;
 	...
 	/*
@@ -2185,16 +2120,15 @@ static void do_autoexposure(struct gspca_dev *gspca_dev, u16 avg_lum)
 	 * and exposure steps
 	 */
...
+		v4l2_ctrl_s_ctrl(sd->exposure, new_exp);
 		...
 		sd->old_step = 1;
@@ -2205,15 +2139,14 @@ static void do_autoexposure(struct gspca_dev *gspca_dev, u16 avg_lum)
 			sd->exposure_step += 2;
 	}
...
@@ -2227,19 +2160,12 @@ static void do_autoexposure(struct gspca_dev *gspca_dev, u16 avg_lum)
...
@@ -2247,7 +2173,7 @@ static void sd_dqcallback(struct gspca_dev *gspca_dev)
 	struct sd *sd = (struct sd *) gspca_dev;
 	int avg_lum;
...
@@ -2263,10 +2189,11 @@ static void qual_upd(struct work_struct *work)
 {
...
@@ -2315,14 +2242,18 @@ static void transfer_check(struct gspca_dev *gspca_dev,
 	if (new_qual != 0) {
 		sd->nchg += new_qual;
...
@@ -2402,10 +2333,9 @@ static void sd_pkt_scan(struct gspca_dev *gspca_dev,
