...
Received: from perceval.ideasonboard.com ([95.142.166.194]:58152 "EHLO
	...
	with ESMTP id S1753089Ab1BNMU5 (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 14 Feb 2011 07:20:57 -0500
From: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
To: linux-media@vger.kernel.org
Cc: sakari.ailus@maxwell.research.nokia.com
Subject: [PATCH v7 1/6] v4l: Share code between video_usercopy and video_ioctl2
Date: Mon, 14 Feb 2011 13:20:54 +0100
Message-Id: <1297686059-9622-2-git-send-email-laurent.pinchart@ideasonboard.com>
...
index f51327e..e85eea0 100644
--- a/drivers/media/video/v4l2-ioctl.c
+++ b/drivers/media/video/v4l2-ioctl.c
@@ -325,35 +325,62 @@ video_fix_command(unsigned int cmd)
 }
 #endif
...
@@ -365,11 +392,21 @@ video_usercopy(struct file *file, unsigned int cmd, unsigned long arg,
 		}
...
@@ -391,7 +428,7 @@ video_usercopy(struct file *file, unsigned int cmd, unsigned long arg,
 		}
 	}
...
@@ -1959,138 +2009,12 @@ static long __video_do_ioctl(struct file *file,
 	return ret;
 }
