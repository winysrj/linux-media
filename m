...
Received: from devils.ext.ti.com ([198.47.26.153]:40104 "EHLO
	devils.ext.ti.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753507Ab1GNIFy convert rfc822-to-8bit (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 14 Jul 2011 04:05:54 -0400
...
Date: Thu, 14 Jul 2011 13:35:41 +0530
Subject: RE: [RFC v1] mt9v113: VGA camera sensor driver and support for
 BeagleBoard
Message-ID: <19F8576C6E063C45BE387C64729E739404E35E43E9@dbde02.ent.ti.com>
References: <1310581347-31102-1-git-send-email-agnel.joel@gmail.com>
 <201107140020.19432.laurent.pinchart@ideasonboard.com>
In-Reply-To: <201107140020.19432.laurent.pinchart@ideasonboard.com>
...
> To: Joel A Fernandes
> Cc: beagleboard@googlegroups.com; Kridner, Jason; Javier Martin; linux-
> media@vger.kernel.org; Kooi, Koen; Prakash, Punya; Maupin, Chase; Kipisz,
> Steven; Aguirre, Sergio
> Subject: Re: [RFC v1] mt9v113: VGA camera sensor driver and support for
> BeagleBoard
>
> Hi Joel,
...
> purpose.
>
[Hiremath, Vaibhav] As always thanks for your comments.

Laurent,
But here the question is nowhere related to politics. I do not care about authorship at all; this is completely engineering argument/discussion I have with this patch.

I have been working with community since long time now, so I was not in favor of submitting this patch with so many known issues (from both feature and cleanliness). If you look at all the comments you provided, most of them should have been already part of the patch series. I wanted them to fix before submitting it to the linux-media, it doesn't matter whether it's RFC.

Another point FYI, the sensor driver has been written during 2.6.37 timeframe, where media-controller was still under flux. Since I wanted to make our production release with MC framework, I pulled in patches from your private branch and started developing from there, so definitely there will be various issues with the driver Vs the current mainline status.


If I would have been aware that, somebody is willing to push my patches, I could have helped him or worked with him (that will ease my bandwidth).

I just made my stand clear here, and I think we should park this discussion here now. We talked enough on this, and I believe we all understand this.
...
> > +   {TOK_TERM, 0, 0},
>
> I'm afraid this isn't an option. You need to compute those values
> dynamically
...
>
> That will always return the active format code, it won't enumerate
> supported
> options.
>
> > +
...
> format structure in struct mt9v113. Storing the format code should be
> enough.
>
...
> > +   mt9v113->rect = rect;
>
> No need to assign mt9v113->rect, it has already been initialized. crop-
> >rect =
> mt9v113->rect should do. And thinking about it, if you don't support
> modifying
...
> > +
> > +/**
> > + * struct mt9v113_init_seq - Structure for TVP5146/47/46M2/47M1 power
> up
> > + *         Sequence.
...
> > ISPCCDC_SYN_MODE);
>
> You need more than this. When the CCDC receives YUV data it can't forward
> it
