...
Received: from perceval.ideasonboard.com ([95.142.166.194]:58187 "EHLO
	...
	with ESMTP id S1753983Ab1BNMVa (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 14 Feb 2011 07:21:30 -0500
From: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
To: linux-media@vger.kernel.org
Cc: sakari.ailus@maxwell.research.nokia.com
Subject: [PATCH v7 09/11] v4l: v4l2_subdev userspace format API
Date: Mon, 14 Feb 2011 13:21:22 +0100
Message-Id: <1297686084-9715-10-git-send-email-laurent.pinchart@ideasonboard.com>
...
index 9288af9..a34edeb 100644
--- a/Documentation/DocBook/v4l/v4l2.xml
+++ b/Documentation/DocBook/v4l/v4l2.xml
@@ -411,6 +411,7 @@ and discussions on the V4L mailing list.</revremark>
...
+    <section id="subdev"> &sub-dev-subdev; </section>
   ...
   <chapter id="driver">
@@ -478,6 +479,9 @@ and discussions on the V4L mailing list.</revremark>
     &sub-reqbufs;
     &sub-s-hw-freq-seek;
     &sub-streamon;
...
index 0e74498..19530c6 100644
--- a/include/linux/Kbuild
+++ b/include/linux/Kbuild
@@ -371,6 +371,7 @@ header-y += usbdevice_fs.h
 header-y += utime.h
 header-y += utsname.h
...
@@ -412,6 +413,15 @@ struct v4l2_subdev_ir_ops {
 };
