...
Received: from mx1.redhat.com ([209.132.183.28]:36317 "EHLO mx1.redhat.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S932353Ab1JRQ3G (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Tue, 18 Oct 2011 12:29:06 -0400
Message-ID: <4E9DA94D.2070907@redhat.com>
Date: Tue, 18 Oct 2011 14:29:01 -0200
...
References: <201110171032.08466.hverkuil@xs4all.nl> <201110171903.24297.hverkuil@xs4all.nl> <4E9D6EDC.3010206@redhat.com> <201110181624.41565.hverkuil@xs4all.nl>
In-Reply-To: <201110181624.41565.hverkuil@xs4all.nl>
...
Ok, but sometimes, you can have two different timings for the same resolution/fps,
and we may discover it too late (for example, a new standard may arise with a different
set of timings for the same resolution/fps). As the name is part of the API, changing
...
as userspace may rely on the names. This can work fine for something that is very
well defined (like the standards name) or is board-specific (like the name of the
...
Ok. I've understood it as a query for transmitters. We'll probably need it for
transmitters, in order to handle EDID information.
