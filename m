...
Received: from arroyo.ext.ti.com ([192.94.94.40]:55778 "EHLO arroyo.ext.ti.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1750885AbZDAEbs convert rfc822-to-8bit (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Wed, 1 Apr 2009 00:31:48 -0400
From: "Subrahmanya, Chaithrika" <chaithrika@ti.com>
To: Hans Verkuil <hverkuil@xs4all.nl>
CC: "linux-media@vger.kernel.org" <linux-media@vger.kernel.org>,
	"davinci-linux-open-source@linux.davincidsp.com"
	<davinci-linux-open-source@linux.davincidsp.com>
Date: Wed, 1 Apr 2009 09:57:58 +0530
Subject: RE: [PATCH 2/4] ARM: DaVinci: DM646x Video: VPIF driver
Message-ID: <EAF47CD23C76F840A9E7FCE10091EFAB02A8764C44@dbde02.ent.ti.com>
References: <1238073740-9902-1-git-send-email-chaithrika@ti.com>,<200903301524.01931.hverkuil@xs4all.nl>
In-Reply-To: <200903301524.01931.hverkuil@xs4all.nl>
...
> > +};
>
> This still feels wrong to me. This driver is here just to setup the
> VPIF
...
> than a complicated way of doing a table lookup to get hold of the
> format
> timings for a particular standard. Just do it directly in
> vpif_display.c.
>
> I'm convinced it will simplify both sources.
>
OK, will look into this and try to improve this implementation.
...
> > + */
> > +static void vpif_set_mode_info(u8 index, u8 channel_id, u8
> config_channel_id)
> > +{
...
>
> Here you would just pass on the timings and set them directly.
>
OK.
...
> > +
> > +             /* If the mode is found, set the parameter in VPIF
> register */
> > +             if (config->stdid == vpifparams->video_params.stdid) {
> > +                     found = 1;
> > +                     vpif_set_mode_info(index, channel_id,
> channel_id);
...
> > +                     }
> > +
> > +                     config_vpif_params(vpifparams, config,
> channel_id,
> > +
> found);
> > +                     break;
...
> > +{
>
> And this function will just disappear altogether.
>
> > +     int index, found = -1;
> > +     u8 channel_id;
> > +     u8 max_modes;
...
> */
> > +     u16 height;                     /* Indicates height of the
> image */
> > +     u8 fps;
...
> > +     u16 l1, l3, l5, l7, l9, l11;    /* Other parameter
> configurations */
> > +     u16 vsize;                      /* Vertical size of the image
> */
> > +     u8 capture_format;              /* Indicates whether capture
> format
> > +                                        is in BT or in CCD/CMOS */
> > +     u8  vbi_supported;              /* Indicates whether this mode
> > +                                        supports capturing vbi or
> not */
> > +     u8 hd_sd;
> > +     v4l2_std_id stdid;
> > +};
...
> > +struct vpif_interface {
> > +     char name[25];
> > +     __u8 storage_mode;      /* Indicates whether it is field or
> frame
> > +                                based storage mode */
...
> field */
> > +     __u32 vstart0;  /* Vertical start of raw vbi data for first
> field */
> > +     __u32 hsize0;   /* Horizontal size of raw vbi data for first
> field */
> > +     __u32 vsize0;   /* Vertical size of raw vbi data for first
> field */
...
> field */
> > +     __u32 vsize1;   /* Vertical size of raw vbi data for second
> field */
> > +};
> > +
> > +struct vpif_params {
