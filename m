...
Received: from mx3.redhat.com (mx3.redhat.com [172.16.48.32])
	by int-mx1.corp.redhat.com (8.13.1/8.13.1) with ESMTP id mAKJmjES015309
	for <video4linux-list@redhat.com>; Thu, 20 Nov 2008 14:48:45 -0500
Received: from kuber.nabble.com (kuber.nabble.com [216.139.236.158])
	by mx3.redhat.com (8.13.8/8.13.8) with ESMTP id mAKJmRKq019427
	for <video4linux-list@redhat.com>; Thu, 20 Nov 2008 14:48:27 -0500
Received: from tervel.nabble.com ([192.168.236.150])
	by kuber.nabble.com with esmtp (Exim 4.63)
	(envelope-from <bounces@n2.nabble.com>) id 1L3FVq-0005fz-M8
	for video4linux-list@redhat.com; Thu, 20 Nov 2008 11:48:26 -0800
Message-ID: <1227210506675-1558605.post@n2.nabble.com>
Date: Thu, 20 Nov 2008 11:48:26 -0800 (PST)
From: alexWe <hondansx@gmx.de>
To: video4linux-list@redhat.com
In-Reply-To: <ea3b75ed0811141442i1fc3bf3en5577bbb281b09e4e@mail.gmail.com>
MIME-Version: 1.0
...
>>TAbort- SERR- TAbort- SERR- TAbort- SERR- TAbort- SERR- TAbort- SERR-
TAbort-
...
> [    6.439131] bttv: using 8 buffers with 2080k (520 pages) each for
> capture
...
> [ 1115.638115] RIP: 0010:[]  []
> page_remove_rmap+0xff/0x11b
> [ 1115.638123] RSP: 0000:ffff8100165fbbe8  EFLAGS: 00010292
> [ 1115.638125] RAX: 000000000000004a RBX: ffffe20000545438 RCX:
> 000000000000aea0
> [ 1115.638127] RDX: 000000000000aea0 RSI: 0000000000000046 RDI:
> 0000000000000286
> [ 1115.638129] RBP: ffff81001ec45298 R08: 00000000f7e00000 R09:
> ffff8100165fb600
> [ 1115.638131] R10: 0000000000000000 R11: 0000000000000010 R12:
> ffff81001cdec080
> [ 1115.638132] R13: 00000000f7e00000 R14: ffffe20000545438 R15:
> ffff810001026b80
...
> [ 1115.638138] CR2: 00000000f629e000 CR3: 0000000000201000 CR4:
> 00000000000006e0
> [ 1115.638141] DR0: 0000000000000000 DR1: 0000000000000000 DR2:
> 0000000000000000
> [ 1115.638143] DR3: 0000000000000000 DR6: 00000000ffff0ff0 DR7:
> 0000000000000400
...
> [ 1115.638163]  [] ? unmap_vmas+0x4c9/0x885
> [ 1115.638171]  [] ? exit_mmap+0x7c/0xf0
> [ 1115.638180]  [] ? mmput+0x2c/0xa2
> [ 1115.638185]  [] ? do_exit+0x25a/0x6b4
> [ 1115.638189]  [] ? do_group_exit+0x6d/0x9d
> [ 1115.638194]  [] ? get_signal_to_deliver+0x302/0x324
> [ 1115.638199]  [] ? do_notify_resume+0xaf/0x7fc
> [ 1115.639205]  [] ? autoremove_wake_function+0x0/0x2e
> [ 1115.639211]  [] ? hrtick_set+0x88/0xf7
> [ 1115.639217]  [] ? int_signal+0x12/0x17
> [ 1115.639223]
> [ 1115.639223]
...
> e9 a5
> [ 1115.639249] RIP  [] page_remove_rmap+0xff/0x11b
> [ 1115.639252]  RSP 
...
same situation here with 2 Server of identical hardware.
...
-- 
View this message in context: http://n2.nabble.com/v4l-crash-dump-tp1500519p1558605.html
