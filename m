...
Received: from smtp-vbr1.xs4all.nl ([194.109.24.21]:4089 "EHLO
	smtp-vbr1.xs4all.nl" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752199AbaJKJXA (ORCPT
...
Subject: [RFCv3 PATCH 04/10] vb2-dma-sg: move dma_(un)map_sg here
Date: Sat, 11 Oct 2014 11:22:31 +0200
Message-Id: <1413019357-12382-5-git-send-email-hverkuil@xs4all.nl>
...
index 80e2356..f3cbd5b 100644
--- a/drivers/media/pci/cx23885/cx23885-dvb.c
+++ b/drivers/media/pci/cx23885/cx23885-dvb.c
@@ -118,11 +118,8 @@ static void buffer_finish(struct vb2_buffer *vb)
 	struct cx23885_dev *dev = port->dev;
 	struct cx23885_buffer *buf = container_of(vb,
 		struct cx23885_buffer, vb);
-	struct sg_table *sgt = vb2_dma_sg_plane_desc(vb, 0);
