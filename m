...
Received: from mail-bk0-f42.google.com ([209.85.214.42]:58976 "EHLO
	mail-bk0-f42.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1755157Ab3AWOEq (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Wed, 23 Jan 2013 09:04:46 -0500
...
Subject: [PATCH v6 1/2] sta2x11_vip: convert to videobuf2, control framework, file handler
Date: Wed, 23 Jan 2013 15:07:06 +0100
Message-Id: <1358950027-27419-1-git-send-email-federico.vaga@gmail.com>
...
@@ -842,8 +646,7 @@ static int vidioc_try_fmt_vid_cap(struct file *file, void *priv,
...
@@ -854,22 +657,63 @@ static int vidioc_try_fmt_vid_cap(struct file *file, void *priv,
...
@@ -879,150 +723,47 @@ static int vidioc_s_fmt_vid_cap(struct file *file, void *priv,
...
@@ -1036,9 +777,7 @@ static struct video_device video_dev_template = {
  *
...
+ * signal a complete buffer if done
  ...
  *
@@ -1046,88 +785,122 @@ static struct video_device video_dev_template = {
  */
...
+	return 0;
 ...
 /**
@@ -1212,10 +985,17 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
...
@@ -1223,6 +1003,7 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
 		goto disable;
 	}
...
+	/* Power configuration */
 	ret = vip_gpio_reserve(&pdev->dev, config->pwr_pin, 0,
 			       config->pwr_name);
 	if (ret)
@@ -1237,7 +1018,6 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
 			goto disable;
 		}
 	}
-
...
@@ -1251,17 +1031,20 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
 	}
 	usleep_range(5000, 25000);
...
@@ -1271,46 +1054,52 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
...
+	/* Get ADV7180 subdevice */
 	...
 	if (!vip->adapter) {
 		ret = -ENODEV;
@@ -1328,10 +1117,11 @@ static int __devinit sta2x11_vip_init_one(struct pci_dev *pdev,
 	}
...
-	mutex_destroy(&vip->mutex);
 ...
 unreg:
@@ -1382,16 +1174,18 @@ static void __devexit sta2x11_vip_remove_one(struct pci_dev *pdev)
 	struct sta2x11_vip *vip =
...
-	mutex_destroy(&vip->mutex);
 	...
 	vip_gpio_release(&pdev->dev, vip->config->pwr_pin,
 			 vip->config->pwr_name);
@@ -1416,9 +1210,6 @@ static void __devexit sta2x11_vip_remove_one(struct pci_dev *pdev)
  *
...
- * power down mode.
 ...
 {
@@ -1429,15 +1220,15 @@ static int sta2x11_vip_suspend(struct pci_dev *pdev, pm_message_t state)
 	int i;
...
+		    reg_read(vip, registers_to_save[i]);
 	...
 	/* save pci state */
 	pci_save_state(pdev);
@@ -1477,7 +1268,7 @@ static int sta2x11_vip_resume(struct pci_dev *pdev)
 	if (vip->disabled) {
 		ret = pci_enable_device(pdev);
 		if (ret) {
...
+			pr_warn("VIP: Can't enable device.\n");
 		...
 		vip->disabled = 0;
@@ -1488,7 +1279,7 @@ static int sta2x11_vip_resume(struct pci_dev *pdev)
...
@@ -1497,12 +1288,12 @@ static int sta2x11_vip_resume(struct pci_dev *pdev)
...
@@ -1515,7 +1306,7 @@ static DEFINE_PCI_DEVICE_TABLE(sta2x11_vip_pci_tbl) = {
 };
