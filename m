...
Received: from mailout2.w1.samsung.com ([210.118.77.12]:20491 "EHLO
	mailout2.w1.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1759405AbZKZKdA (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 26 Nov 2009 05:33:00 -0500
Received: from eu_spt1 (mailout2.w1.samsung.com [210.118.77.12])
 by mailout2.w1.samsung.com
 (iPlanet Messaging Server 5.2 Patch 2 (built Jul 14 2004))
 with ESMTP id <0KTP002TJPB4JX@mailout2.w1.samsung.com> for
 linux-media@vger.kernel.org; Thu, 26 Nov 2009 10:33:04 +0000 (GMT)
Received: from linux.samsung.com ([106.116.38.10])
 by spt1.w1.samsung.com (iPlanet Messaging Server 5.2 Patch 2 (built Jul 14
 2004)) with ESMTPA id <0KTP00JVVPB410@spt1.w1.samsung.com> for
 linux-media@vger.kernel.org; Thu, 26 Nov 2009 10:33:04 +0000 (GMT)
Date: Thu, 26 Nov 2009 11:32:51 +0100
From: Pawel Osciak <p.osciak@samsung.com>
Subject: [PATCH 2/2] Added a mem-to-mem V4L2 framework test device.
...
Message-id: <1259231572-20334-3-git-send-email-p.osciak@samsung.com>
MIME-version: 1.0
...
index b33d371..6495d35 100644
--- a/drivers/media/video/Kconfig
+++ b/drivers/media/video/Kconfig
@@ -551,6 +551,13 @@ config VIDEO_VIVI
...
index 22a9fef..86a3dd8 100644
--- a/drivers/media/video/Makefile
+++ b/drivers/media/video/Makefile
@@ -146,6 +146,7 @@ obj-$(CONFIG_VIDEO_IVTV) += ivtv/
...
+
+#define MEM2MEMTEST_IOCTL_MAGIC	'V'
+#define MEM2MEMTEST_IOCTL_SET_TRANSLEN	_IO(MEM2MEMTEST_IOCTL_MAGIC, 0)
+#define MEM2MEMTEST_IOCTL_SET_TRANSTIME	_IO(MEM2MEMTEST_IOCTL_MAGIC, 1)
+
