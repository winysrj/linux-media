...
Received: from lb2-smtp-cloud3.xs4all.net ([194.109.24.26]:42143 "EHLO
	...
	by vger.kernel.org with ESMTP id S1751798AbcDWLEI (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sat, 23 Apr 2016 07:04:08 -0400
From: Hans Verkuil <hverkuil@xs4all.nl>
To: linux-media@vger.kernel.org
Cc: Hans Verkuil <hans.verkuil@cisco.com>,
	Fabien Dessenne <fabien.dessenne@st.com>,
	Benoit Parrot <bparrot@ti.com>
Subject: [PATCHv4 08/13] media/platform: convert drivers to use the new vb2_queue dev field
Date: Sat, 23 Apr 2016 13:03:44 +0200
Message-Id: <1461409429-24995-9-git-send-email-hverkuil@xs4all.nl>
