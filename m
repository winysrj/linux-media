...
Received: from gofer.mess.org ([88.97.38.141]:45313 "EHLO gofer.mess.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1751413AbdJEIpj (ORCPT <rfc822;linux-media@vger.kernel.org>);
        Thu, 5 Oct 2017 04:45:39 -0400
From: Sean Young <sean@mess.org>
To: linux-media@vger.kernel.org
Subject: [PATCH v2 18/25] media: lirc: implement reading scancode
Date: Thu,  5 Oct 2017 09:45:20 +0100
Message-Id: <8370817465c40a4abe080d5c4865e08305a1a2c7.1507192752.git.sean@mess.org>
...
@@ -287,7 +304,7 @@ static long ir_lirc_ioctl(struct file *filep, unsigned int cmd,
 	switch (cmd) {
...
@@ -325,15 +342,17 @@ static long ir_lirc_ioctl(struct file *filep, unsigned int cmd,
 		if (dev->driver_type == RC_DRIVER_IR_RAW_TX)
 			return -ENOTTY;
...
@@ -523,6 +542,59 @@ static ssize_t ir_lirc_read(struct file *file, char __user *buffer,
 	return copied;
 }
...
index 0ed727d375b4..4263228d3d84 100644
--- a/drivers/media/rc/rc-main.c
+++ b/drivers/media/rc/rc-main.c
@@ -697,6 +697,12 @@ static void ir_do_keydown(struct rc_dev *dev, enum rc_proto protocol,
