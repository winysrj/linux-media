...
Received: from down.free-electrons.com ([37.187.137.238]:48479 "EHLO
	mail.free-electrons.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
	with ESMTP id S1752153AbaKFJ5W (ORCPT
...
Subject: [PATCH v2 08/10] staging: media: Make use of media_bus_format enum
Date: Thu,  6 Nov 2014 10:57:06 +0100
Message-Id: <1415267829-4177-9-git-send-email-boris.brezillon@free-electrons.com>
...
+	enum media_bus_format temp_pix_fmt;
...
+ipipeif_get_pack_mode(enum media_bus_format in_pix_fmt)
 {
 	switch (in_pix_fmt) {
-	case V4L2_MBUS_FMT_SBGGR8_1X8:
...
+	enum media_bus_format isif_port_if;
...
+resizer_calculate_line_length(enum media_bus_format pix, int width,
...
+omap4iss_video_format_info(enum media_bus_format code)
 {
 	unsigned int i;
 
diff --git a/drivers/staging/media/omap4iss/iss_video.h b/drivers/staging/media/omap4iss/iss_video.h
index 9dccdb1..cc8146b 100644
