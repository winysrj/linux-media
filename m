...
Received: from mx1.redhat.com ([209.132.183.28]:33241 "EHLO mx1.redhat.com"
	...
	id S1757169Ab2FYQsf (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Mon, 25 Jun 2012 12:48:35 -0400
Message-ID: <4FE89655.5040509@redhat.com>
Date: Mon, 25 Jun 2012 13:48:21 -0300
...
References: <204715047.2885246.1340047937566.JavaMail.root@advansee.com>
In-Reply-To: <204715047.2885246.1340047937566.JavaMail.root@advansee.com>
...
It is better to re-order the array, in order to put the specific standards
first, e. g. moving V4L2_STD_NTSC_443 and V4L2_STD_PAL_60 to be before V4L2_STD_NTSC
and V4L2_STD_PAL.

Also, SECAM is missing on the above table, but the driver has some tests for it.
So, I suspect that the device is capable of supporting SECAM (maybe using the same
