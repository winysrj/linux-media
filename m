...
Received: from smtp.nokia.com ([192.100.105.134]:58646 "EHLO
	mgw-mx09.nokia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1751582AbZGYPIg (ORCPT
...
Subject: [PATCHv11 6/8] FM TX: si4713: Add files to handle si4713 i2c device
Date: Sat, 25 Jul 2009 17:57:40 +0300
Message-Id: <1248533862-20860-7-git-send-email-eduardo.valentin@nokia.com>
In-Reply-To: <1248533862-20860-6-git-send-email-eduardo.valentin@nokia.com>
...
+			control->length = MAX_RDS_PS_NAME + 1;
+			rval = -ENOSPC;
+			goto exit;
+		}
