...
Received: from galahad.ideasonboard.com ([185.26.127.97]:32928 "EHLO
	galahad.ideasonboard.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1752670AbaIIMjg (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Tue, 9 Sep 2014 08:39:36 -0400
Received: from avalon.ideasonboard.com (dsl-hkibrasgw3-50ddcc-40.dhcp.inet.fi [80.221.204.40])
	by galahad.ideasonboard.com (Postfix) with ESMTPSA id 7694820015
	for <linux-media@vger.kernel.org>; Tue,  9 Sep 2014 14:38:35 +0200 (CEST)
From: Laurent Pinchart <laurent.pinchart@ideasonboard.com>
To: linux-media@vger.kernel.org
Subject: [PATCH] uvcvideo: Move to video_ioctl2
Date: Tue,  9 Sep 2014 15:39:35 +0300
Message-Id: <1410266375-19719-1-git-send-email-laurent.pinchart@ideasonboard.com>
...
@@ -1105,23 +1188,8 @@ static long uvc_v4l2_do_ioctl(struct file *file, unsigned int cmd, void *arg)
...
-	return video_usercopy(file, cmd, arg, uvc_v4l2_do_ioctl);
 ...
 #ifdef CONFIG_COMPAT
@@ -1304,7 +1372,7 @@ static long uvc_v4l2_compat_ioctl32(struct file *file,
...
+	ret = video_ioctl2(file, cmd, (unsigned long)&karg);
 	...
 	if (ret < 0)
@@ -1365,11 +1433,48 @@ static unsigned long uvc_v4l2_get_unmapped_area(struct file *file,
 }
 #endif
...
index b1f69a6..259a547 100644
--- a/drivers/media/usb/uvc/uvcvideo.h
+++ b/drivers/media/usb/uvc/uvcvideo.h
@@ -577,7 +577,6 @@ struct uvc_driver {
...
@@ -651,6 +650,7 @@ static inline int uvc_queue_streaming(struct uvc_video_queue *queue)
 }
