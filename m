...
Received: from mga01.intel.com ([192.55.52.88]:2335 "EHLO mga01.intel.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1752406AbaKCPOj (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Mon, 3 Nov 2014 10:14:39 -0500
Date: Mon, 3 Nov 2014 23:13:33 +0800
From: kbuild test robot <fengguang.wu@intel.com>
To: Sakari Ailus <sakari.ailus@linux.intel.com>
Cc: kbuild-all@01.org, Mauro Carvalho Chehab <m.chehab@samsung.com>,
	linux-media@vger.kernel.org
Subject: [linuxtv-media:master 497/499] drivers/media/media-entity.c:297:4:
 warning: format '%u' expects argument of type 'unsigned int', but argument 5
 has type 'long unsigned int'
Message-ID: <201411032329.H2FjpT3X%fengguang.wu@intel.com>
MIME-Version: 1.0
...
commit: fab9d30b7b4216affd1708f0bcf93c746cc428bd [497/499] [media] media: Print information on failed link validation
config: s390-allmodconfig (attached as .config)
reproduce:
  wget https://git.kernel.org/cgit/linux/kernel/git/wfg/lkp-tests.git/plain/sbin/make.cross -O ~/bin/make.cross
  chmod +x ~/bin/make.cross
  git checkout fab9d30b7b4216affd1708f0bcf93c746cc428bd
  # save the attached .config to linux build tree
  make.cross ARCH=s390 

All warnings:

   drivers/media/media-entity.c: In function 'media_entity_pipeline_start':
>> drivers/media/media-entity.c:297:4: warning: format '%u' expects argument of type 'unsigned int', but argument 5 has type 'long unsigned int' [-Wformat=]
       dev_dbg(entity->parent->dev,
       ^
   drivers/media/media-entity.c:332:1: warning: 'media_entity_pipeline_start' uses dynamic stack allocation
    }
    ^

vim +297 drivers/media/media-entity.c
