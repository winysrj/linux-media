...
Received: from mailout1.w2.samsung.com ([211.189.100.11]:37540 "EHLO
	usmailout1.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1753707Ab3KNN0t (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Thu, 14 Nov 2013 08:26:49 -0500
Received: from uscpsbgm2.samsung.com
 (u115.gpu85.samsung.co.kr [203.254.195.115]) by mailout1.w2.samsung.com
 (Oracle Communications Messaging Server 7u4-24.01(7.0.4.24.0) 64bit (built Nov
 17 2011)) with ESMTP id <0MW900MOU9CB6670@mailout1.w2.samsung.com> for
 linux-media@vger.kernel.org; Thu, 14 Nov 2013 08:26:48 -0500 (EST)
Date: Thu, 14 Nov 2013 11:26:44 -0200
From: Mauro Carvalho Chehab <m.chehab@samsung.com>
To: CrazyCat <crazycat69@narod.ru>
Cc: linux-media@vger.kernel.org
Subject: Re: [PATCH] dw2102: Use RC Core instead of the legacy RC.
Message-id: <20131114112644.38186408@samsung.com>
In-reply-to: <4651914.EnQWLY6Jr6@ubuntu>
References: <4651914.EnQWLY6Jr6@ubuntu>
MIME-version: 1.0
...
I suspect that the full keycode is there, at key[1] << 8 | key[0]. If so,
the better is to do:

			rc_keydown(d->rc_dev, key[1] << 8 | key[0], 1);

(msg.buf is equal to key)

That allows passing the full 16 bits NEC code to the RC core, and works
better, because it prevents other remote controllers (like the TV one) to
