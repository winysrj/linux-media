...
Received: from lb2-smtp-cloud7.xs4all.net ([194.109.24.28]:56195 "EHLO
        ...
        by vger.kernel.org with ESMTP id S1727629AbeHDOqL (ORCPT
...
Subject: [PATCHv17 10/34] v4l2-ctrls: v4l2_ctrl_add_handler: add from_other_dev
Date: Sat,  4 Aug 2018 14:45:02 +0200
Message-Id: <20180804124526.46206-11-hverkuil@xs4all.nl>
