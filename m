...
Received: from lb2-smtp-cloud2.xs4all.net ([194.109.24.25]:45037 "EHLO
        lb2-smtp-cloud2.xs4all.net" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S935482AbdCJK1S (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Fri, 10 Mar 2017 05:27:18 -0500
...
Subject: [PATCHv4 07/15] atmel-isi: remove dependency of the soc-camera framework
Date: Fri, 10 Mar 2017 11:26:06 +0100
Message-Id: <20170310102614.20922-8-hverkuil@xs4all.nl>
...
-	struct soc_camera_host *soc_host;
 	...
 	if (!isi) {
@@ -1044,20 +1223,65 @@ static int atmel_isi_probe(struct platform_device *pdev)
 		return ret;
...
+	for (i = 0; i < VIDEO_MAX_FRAME; i++) {
 		...
 		isi->dma_desc[i].fbd_phys = isi->fb_descriptors_phys +
 					i * sizeof(struct fbd);
@@ -1089,41 +1313,49 @@ static int atmel_isi_probe(struct platform_device *pdev)
 	}
 	isi->irq = irq;
...
@@ -1131,9 +1363,7 @@ static int atmel_isi_runtime_suspend(struct device *dev)
 }
...
@@ -1151,15 +1381,16 @@ static const struct of_device_id atmel_isi_of_match[] = {
