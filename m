...
Received: from mailout2.samsung.com ([203.254.224.25]:47615 "EHLO
	mailout2.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1757538Ab2HIKMf (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Thu, 9 Aug 2012 06:12:35 -0400
Received: from epcpsbgm1.samsung.com (mailout2.samsung.com [203.254.224.25])
 by mailout2.samsung.com
 (Oracle Communications Messaging Server 7u4-24.01(7.0.4.24.0) 64bit (built Nov
 17 2011)) with ESMTP id <0M8H007H5GC8ORZ0@mailout2.samsung.com> for
 linux-media@vger.kernel.org; Thu, 09 Aug 2012 19:12:33 +0900 (KST)
...
Subject: [PATCH v4 4/4] [media] s5p-mfc: Update MFC v4l2 driver to support
 MFC6.x
Date: Thu, 09 Aug 2012 15:58:30 +0530
Message-id: <1344508110-16945-5-git-send-email-arun.kk@samsung.com>
...
---
 ...
 drivers/media/video/s5p-mfc/s5p_mfc.c        |   60 +-
 ...
 drivers/media/video/s5p-mfc/s5p_mfc_common.h |   52 +-
 ...
 15 files changed, 2657 insertions(+), 167 deletions(-)
...
@@ -278,12 +278,13 @@ static void s5p_mfc_handle_frame(struct s5p_mfc_ctx *ctx,
...
@@ -435,10 +436,26 @@ static void s5p_mfc_handle_seq_done(struct s5p_mfc_ctx *ctx,
...
+		}
 	...
 	s5p_mfc_clear_int_flags(dev);
 	clear_work_bit(ctx);
@@ -469,7 +486,7 @@ static void s5p_mfc_handle_init_buffers(struct s5p_mfc_ctx *ctx,
...
+	size_t scratch_buf_size;
 ...
 /*
@@ -633,4 +676,9 @@ struct mfc_control {
...
+	int mbX, mbY;
+
+	mbX = S5P_FIMV_FRAME_WIDTH_TO_MB_WIDTH_V6(width);
+	mbY = S5P_FIMV_FRAME_HEIGHT_TO_MB_HEIGHT_V6(height);
+
