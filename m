...
Received: from bombadil.infradead.org ([198.137.202.9]:37172 "EHLO
        bombadil.infradead.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1752315AbcKSMOi (ORCPT
        <rfc822;linux-media@vger.kernel.org>);
        Sat, 19 Nov 2016 07:14:38 -0500
...
Subject: [PATCH] [media] cx88: make checkpatch.pl happy
Date: Sat, 19 Nov 2016 10:14:05 -0200
Message-Id: <8729e94b8ef1fd4a17631d6a0c81b8a10b7d3a54.1479557581.git.mchehab@s-opensource.com>
...
---
 ...
 drivers/media/pci/cx88/cx88-blackbird.c  | 168 ++++++++++-------
 drivers/media/pci/cx88/cx88-cards.c      | 313 +++++++++++++++++--------------
 drivers/media/pci/cx88/cx88-core.c       | 203 ++++++++++----------
 ...
 drivers/media/pci/cx88/cx88-mpeg.c       | 110 ++++++-----
 drivers/media/pci/cx88/cx88-reg.h        | 114 +++++------
 ...
 drivers/media/pci/cx88/cx88.h            | 166 ++++++++--------
 15 files changed, 958 insertions(+), 843 deletions(-)
...
index bffd064daff5..32537fd4b888 100644
...
index 33719f0b06a5..a535c80c7b36 100644
...
index c072b7ecc8d6..ffa5696ecddf 100644
...
index 4533e2c6cb9f..ce61eab5035b 100644
...
@@ -54,7 +54,8 @@ MODULE_PARM_DESC(debug, "enable debug messages [mpeg]");
...
@@ -77,14 +78,13 @@ static void flush_request_modules(struct cx8802_dev *dev)
...
@@ -98,33 +98,35 @@ int cx8802_start_dma(struct cx8802_dev    *dev,
...
+			cx_write(MO_PINMUX_IO, 0x88);
 			...
 			break;
 		case CX88_BOARD_HAUPPAUGE_HVR1300:
@@ -153,13 +155,15 @@ int cx8802_start_dma(struct cx8802_dev    *dev,
...
@@ -177,10 +181,11 @@ int cx8802_start_dma(struct cx8802_dev    *dev,
...
+EXPORT_SYMBOL(cx8802_start_dma);
 ...
 {
@@ -219,7 +224,7 @@ static int cx8802_restart_queue(struct cx8802_dev    *dev,
 /* ------------------------------------------------------------------ */
...
@@ -231,15 +236,17 @@ int cx8802_buf_prepare(struct vb2_queue *q, struct cx8802_dev *dev,
...
+EXPORT_SYMBOL(cx8802_buf_prepare);
 ...
 {
@@ -268,6 +275,7 @@ void cx8802_buf_queue(struct cx8802_dev *dev, struct cx88_buffer *buf)
...
@@ -292,6 +300,7 @@ void cx8802_cancel_buffers(struct cx8802_dev *dev)
 	cx8802_stop_dma(dev);
...
@@ -324,7 +333,8 @@ static void cx8802_mpeg_irq(struct cx8802_dev *dev)
 	if (status & (1 << 16)) {
...
+				       &cx88_sram_channels[SRAM_CH28]);
 	...
 	/* risc1 y */
@@ -452,7 +462,8 @@ static int cx8802_suspend_common(struct pci_dev *pci_dev, pm_message_t state)
...
@@ -497,7 +508,8 @@ static int cx8802_resume_common(struct pci_dev *pci_dev)
 	return 0;
 }
...
@@ -507,6 +519,7 @@ struct cx8802_driver *cx8802_get_driver(struct cx8802_dev *dev, enum cx88_board_
...
@@ -524,7 +537,8 @@ static int cx8802_request_acquire(struct cx8802_driver *drv)
...
+			  sizeof(struct cx88_input));
 			...
 			if (core->board.input[i].type == CX88_VMUX_DVB) {
 				core->input = i;
@@ -533,8 +547,7 @@ static int cx8802_request_acquire(struct cx8802_driver *drv)
 		}
 	}
...
@@ -552,11 +565,12 @@ static int cx8802_request_release(struct cx8802_driver *drv)
 {
...
@@ -570,21 +584,21 @@ static int cx8802_request_release(struct cx8802_driver *drv)
...
+	    (!drv->advise_release))
 	...
 	return 0;
@@ -598,9 +612,11 @@ int cx8802_register_driver(struct cx8802_driver *drv)
...
@@ -615,7 +631,7 @@ int cx8802_register_driver(struct cx8802_driver *drv)
...
@@ -644,6 +660,7 @@ int cx8802_register_driver(struct cx8802_driver *drv)
...
+EXPORT_SYMBOL(cx8802_register_driver);
 ...
 {
@@ -653,7 +670,8 @@ int cx8802_unregister_driver(struct cx8802_driver *drv)
...
@@ -686,6 +704,7 @@ int cx8802_unregister_driver(struct cx8802_driver *drv)
...
@@ -697,7 +716,7 @@ static int cx8802_probe(struct pci_dev *pci_dev,
...
@@ -708,7 +727,7 @@ static int cx8802_probe(struct pci_dev *pci_dev,
...
+	if (!dev)
 	...
 	dev->pci = pci_dev;
 	dev->core = core;
@@ -797,12 +816,3 @@ static struct pci_driver cx8802_pci_driver = {
 };
...
index 88ed8a2e4ee1..27657a40e7bd 100644
...
index 20f6924abe35..501fbbe5deb7 100644
...
index ac1fb9fb340e..47513bb7377b 100644
...
@@ -634,43 +635,37 @@ cx88_risc_databuffer(struct pci_dev *pci, struct cx88_riscmem *risc,
 		     struct scatterlist *sglist, unsigned int bpl,
...
@@ -679,17 +674,16 @@ extern const struct vb2_ops cx8800_vbi_qops;
 /* ----------------------------------------------------------- */
 /* cx88-i2c.c                                                  */
...
+void cx88_setup_xc3028(struct cx88_core *core, struct xc2028_ctrl *ctl);
 ...
 /* ----------------------------------------------------------- */
 /* cx88-tvaudio.c                                              */
@@ -720,18 +714,18 @@ int cx88_ir_fini(struct cx88_core *core);
...
+		     struct cx88_buffer   *buf);
 ...
 /* ----------------------------------------------------------- */
 /* cx88-video.c*/
@@ -739,6 +733,6 @@ int cx88_enum_input(struct cx88_core *core, struct v4l2_input *i);
