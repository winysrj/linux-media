...
Received: from mailout3.w1.samsung.com ([210.118.77.13]:15655 "EHLO
	mailout3.w1.samsung.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1757470Ab3DSKbs (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Fri, 19 Apr 2013 06:31:48 -0400
Received: from eucpsbgm1.samsung.com (unknown [203.254.199.244])
 by mailout3.w1.samsung.com
 (Oracle Communications Messaging Server 7u4-24.01(7.0.4.24.0) 64bit (built Nov
 17 2011)) with ESMTP id <0MLH00F2TZRSEC00@mailout3.w1.samsung.com> for
 linux-media@vger.kernel.org; Fri, 19 Apr 2013 11:31:45 +0100 (BST)
...
Subject: [PATCH RFC v2] s5k5baf: add camera sensor driver
Date: Fri, 19 Apr 2013 12:31:17 +0200
Message-id: <1366367477-25613-1-git-send-email-a.hajda@samsung.com>
...
This is a second version of s5k5baf patch with
changes according to Sylwester comments.
...
---
 ...
 drivers/media/i2c/s5k5baf.c                        | 1983 ++++++++++++++++++++
 include/uapi/linux/s5k5baf.h                       |   19 +
 include/uapi/linux/v4l2-controls.h                 |    5 +
 7 files changed, 2076 insertions(+)
...
index 66245eb..4b4ed29 100644
--- a/drivers/media/i2c/Kconfig
+++ b/drivers/media/i2c/Kconfig
@@ -514,6 +514,13 @@ config VIDEO_S5K4ECGX
...
+}
+
+static void s5k5baf_parse_device_node(struct s5k5baf *state, struct device *dev)
+{
...
+	s5k5baf_parse_device_node(state, &c->dev);
...
index 22556a2..4cf28a6 100644
--- a/include/uapi/linux/v4l2-controls.h
+++ b/include/uapi/linux/v4l2-controls.h
@@ -684,6 +684,11 @@ enum v4l2_auto_focus_range {
