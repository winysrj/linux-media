...
Received: from service1.sh.cvut.cz ([147.32.127.214]:37434 "EHLO
	service1.sh.cvut.cz" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S933222AbZJaU0n (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Sat, 31 Oct 2009 16:26:43 -0400
From: =?utf-8?q?Luk=C3=A1=C5=A1_Karas?= <lukas.karas@centrum.cz>
To: linux-media@vger.kernel.org
Subject: [PATCH] Multifrontend support for saa7134
Date: Sat, 31 Oct 2009 21:21:21 +0100
MIME-Version: 1.0
Cc: Petr Fiala <petr.fiala@gmail.com>
Content-Type: Multipart/Mixed;
  boundary="Boundary-00=_BxJ7KsHlx66Khle"
Message-Id: <200910312121.21926.lukas.karas@centrum.cz>
Sender: linux-media-owner@vger.kernel.org
List-ID: <linux-media.vger.kernel.org>

--Boundary-00=_BxJ7KsHlx66Khle
...
+		.num_frontends  = 1,
 		.inputs = { {
 			.name   = name_tv,
 			.vmux   = 3,
diff -uprN ./linux-a76d06e9ff9b/drivers/media/video/saa7134/saa7134-dvb.c ./linux/drivers/media/video/saa7134/saa7134-
dvb.c
--- ./linux-a76d06e9ff9b/drivers/media/video/saa7134/saa7134-dvb.c	2009-10-31 10:40:46.000000000 +0100
+++ ./linux/drivers/media/video/saa7134/saa7134-dvb.c	2009-10-31 20:51:59.000000000 +0100
...
Content-Type: text/x-patch;
  charset="UTF-8";
  name="saa7134-multifrontend.1.patch"
Content-Transfer-Encoding: 7bit
Content-Disposition: attachment;
	filename="saa7134-multifrontend.1.patch"

Signed-off-by: Lukas Karas <lukas.karas@centrum.cz>
Tested-by: Petr Fiala <petr.fiala@gmail.com>
diff -uprN ./linux-a76d06e9ff9b/drivers/media/video/saa7134/saa7134-cards.c ./linux/drivers/media/video/saa7134/saa7134-cards.c
--- ./linux-a76d06e9ff9b/drivers/media/video/saa7134/saa7134-cards.c	2009-10-31 10:40:46.000000000 +0100
+++ ./linux/drivers/media/video/saa7134/saa7134-cards.c	2009-10-31 17:47:51.000000000 +0100
@@ -614,6 +614,7 @@ struct saa7134_board saa7134_boards[] =
 		.radio_addr	= ADDR_UNSET,
