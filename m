...
Received: from smtp.nokia.com ([192.100.105.134]:19704 "EHLO
	mgw-mx09.nokia.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1755575AbZEKJhL (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 11 May 2009 05:37:11 -0400
From: Eduardo Valentin <eduardo.valentin@nokia.com>
To: Hans Verkuil <hverkuil@xs4all.nl>
Cc: "linux-media@vger.kernel.org" <linux-media@vger.kernel.org>,
	"Nurkkala Eero.An (EXT-Offcode/Oulu)" <ext-Eero.Nurkkala@nokia.com>,
	Eduardo Valentin <eduardo.valentin@nokia.com>
Subject: [PATCH v2 5/7] FMTx: si4713: Add files to add radio interface for si4713
Date: Mon, 11 May 2009 12:31:47 +0300
Message-Id: <1242034309-13448-6-git-send-email-eduardo.valentin@nokia.com>
...
+		V4L2_CID_REGION,
+		V4L2_CID_REGION_BOTTOM_FREQUENCY,
+		V4L2_CID_REGION_TOP_FREQUENCY,
+		V4L2_CID_REGION_PREEMPHASIS,
+		V4L2_CID_REGION_CHANNEL_SPACING,
...
+
+	/*
+	 * We want this because we create client based on existing
+	 * adapter. So we may not want to wait existing adapter to be
+	 * unloaded in order to release data created by us.
+	 */
+	list_for_each_entry_safe(sd, tmp, &(v4l2_dev)->subdevs, list)
+		i2c_unregister_device(v4l2_get_subdevdata(sd));
+
