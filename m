...
Received: from mx1.redhat.com ([209.132.183.28]:65157 "EHLO mx1.redhat.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1757706Ab2EGTUj (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Mon, 7 May 2012 15:20:39 -0400
From: Hans de Goede <hdegoede@redhat.com>
To: Linux Media Mailing List <linux-media@vger.kernel.org>
Cc: hverkuil@xs4all.nl, Hans Verkuil <hans.verkuil@cisco.com>,
	Hans de Goede <hdegoede@redhat.com>
Subject: [PATCH 19/23] gspca-zc3xx: convert to the control framework.
Date: Mon,  7 May 2012 21:01:30 +0200
Message-Id: <1336417294-4566-20-git-send-email-hdegoede@redhat.com>
...
---
 drivers/media/video/gspca/zc3xx.c |  439 +++++++++++++++----------------------
 1 file changed, 171 insertions(+), 268 deletions(-)

diff --git a/drivers/media/video/gspca/zc3xx.c b/drivers/media/video/gspca/zc3xx.c
index 998017e..a88330f 100644
...
+	reg_w(gspca_dev, val ? 0x42 : 0x02, 0x0180);
 ...
 /*
@@ -6450,7 +6320,6 @@ static int sd_config(struct gspca_dev *gspca_dev,
...
@@ -6458,12 +6327,85 @@ static int sd_config(struct gspca_dev *gspca_dev,
 	return 0;
 }
...
+	struct v4l2_ctrl_handler *hdl = &sd->ctrl_handler;
 	static const u8 gamma[SENSOR_MAX] = {
 		[SENSOR_ADCM2700] =	4,
 		[SENSOR_CS2102] =	4,
@@ -6485,6 +6427,48 @@ static int sd_init(struct gspca_dev *gspca_dev)
 		[SENSOR_PO2030] =	4,
 		[SENSOR_TAS5130C] =	3,
 	};
+
...
+	int sensor;
 	static const u8 mode_tb[SENSOR_MAX] = {
 		[SENSOR_ADCM2700] =	2,
 		[SENSOR_CS2102] =	1,
@@ -6614,7 +6598,6 @@ static int sd_init(struct gspca_dev *gspca_dev)
 		case 0x2030:
...
@@ -6656,26 +6639,6 @@ static int sd_init(struct gspca_dev *gspca_dev)
 		break;
 	}
...
-
 	...
 	return gspca_dev->usb_err;
@@ -6792,7 +6755,7 @@ static int sd_start(struct gspca_dev *gspca_dev)
...
+	setsharpness(gspca_dev, v4l2_ctrl_g_ctrl(sd->sharpness));
 	...
 	switch (sd->sensor) {
@@ -6801,7 +6764,9 @@ static int sd_start(struct gspca_dev *gspca_dev)
 	case SENSOR_OV7630C:
 		break;
 	default:
...
@@ -6815,7 +6780,8 @@ static int sd_start(struct gspca_dev *gspca_dev)
 	setquality(gspca_dev);
...
@@ -6826,7 +6792,7 @@ static int sd_start(struct gspca_dev *gspca_dev)
...
+		setexposure(gspca_dev, v4l2_ctrl_g_ctrl(sd->exposure));
 		...
 		break;
 	case SENSOR_GC0305:
@@ -6850,7 +6816,7 @@ static int sd_start(struct gspca_dev *gspca_dev)
 		break;
 	}
...
+	setautogain(gspca_dev, v4l2_ctrl_g_ctrl(sd->autogain));
 	...
 	if (gspca_dev->usb_err < 0)
 		return gspca_dev->usb_err;
@@ -6911,79 +6877,17 @@ static void sd_pkt_scan(struct gspca_dev *gspca_dev,
...
@@ -6992,7 +6896,7 @@ static int sd_get_jcomp(struct gspca_dev *gspca_dev,
 	struct sd *sd = (struct sd *) gspca_dev;
...
+	jcomp->quality = v4l2_ctrl_g_ctrl(sd->jpegqual);
 	...
 	return 0;
@@ -7016,15 +6920,13 @@ static int sd_int_pkt_scan(struct gspca_dev *gspca_dev,
...
@@ -7108,6 +7010,7 @@ static struct usb_driver sd_driver = {
 #ifdef CONFIG_PM
