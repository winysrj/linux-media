...
Received: from mx1.redhat.com (mx1.redhat.com [172.16.48.31])
	by int-mx1.corp.redhat.com (8.13.1/8.13.1) with ESMTP id n0N874DH031987
	for <video4linux-list@redhat.com>; Fri, 23 Jan 2009 03:07:04 -0500
Received: from aneto.bordeaux.inserm.fr (aneto.bordeaux.inserm.fr
	[195.221.150.9])
	by mx1.redhat.com (8.13.8/8.13.8) with ESMTP id n0N86lU3011815
	for <video4linux-list@redhat.com>; Fri, 23 Jan 2009 03:06:47 -0500
Received: from aneto.bordeaux.inserm.fr (localhost.localdomain [127.0.0.1])
	by localhost.bordeaux.inserm.fr (SrvInserm) with SMTP id D1F9C5F911
	for <video4linux-list@redhat.com>; Fri, 23 Jan 2009 09:06:45 +0100 (CET)
Received: from localhost.localdomain (unknown [195.221.147.159])
	by aneto.bordeaux.inserm.fr (SrvInserm) with ESMTP id BEFAB5F90D
	for <video4linux-list@redhat.com>; Fri, 23 Jan 2009 09:06:45 +0100 (CET)
Message-ID: <497979FF.5090600@inserm.fr>
Date: Fri, 23 Jan 2009 09:04:15 +0100
From: Yves Le Feuvre <yves.lefeuvre@inserm.fr>
MIME-Version: 1.0
To: video4linux-list@redhat.com
Content-Type: text/plain; charset=ISO-8859-1; format=flowed
Content-Transfer-Encoding: 7bit
Subject: asus Europa2 OEM regression ?
...
I have two DVB cards, an Hauppauge Nova-T DVB-T [card=18,autodetected], 
and a Asus Europa2 OEM [card=100,autodetected].
Both cards are working fine on fedora 7 (kernel 2.6.22.9), but the Asus 
Europa doesn't work anymore on latest fedora 10 or ubuntu 8.10. I have 
to say that I have tested only the DVB-T part, as I don't use the cards 
for analog TV or radio.
...
NVRM: loading NVIDIA UNIX x86 Kernel Module  180.22  Tue Jan  6 09:29:08 
PST 2009
...
cx88[0]/2: cx2388x 8802 Driver Manager
cx88-mpeg driver manager 0000:02:05.2: PCI INT A -> GSI 17 (level, low) 
-> IRQ 17
