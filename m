...
Received: from galahad.ideasonboard.com ([185.26.127.97]:40788 "EHLO
        galahad.ideasonboard.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1750852AbeDCNv1 (ORCPT
        <rfc822;linux-media@vger.kernel.org>); Tue, 3 Apr 2018 09:51:27 -0400
...
Date: Tue, 03 Apr 2018 16:51:35 +0300
Message-ID: <4443207.o8kk4zUXaG@avalon>
In-Reply-To: <66498032-7cd9-c744-0555-52f9a03437a9@xs4all.nl>
References: <20180326214456.6655-1-niklas.soderlund+renesas@ragnatech.se> <66498032-7cd9-c744-0555-52f9a03437a9@xs4all.nl>
MIME-Version: 1.0
...
> On 26/03/18 23:44, Niklas S=F6derlund wrote:
> > Hi,
> >=20
> > This series adds Gen3 VIN support to rcar-vin driver for Renesas r8a779=
5,
...
There's just a handful of patchs I haven't acked (but I have reviewed previ=
ous=20
version) and I don't think there's any blocker there, small problems can=20
always be fixed later. I'll still try to review them, and if I notice any=20
issue I'll ask Niklas to submit follow-up patches. v13 can be merged upstre=
am=20
...
> >   driver into account.
> >=20
> > - Moved field !=3D V4L2_FIELD_ANY in 'rcar-vin: set a default field to
> >=20
...
> > time' - Add patch which renames four badly name functions. Some of the
> >=20
...
> >=20
> > * Changes since v2
> > - Do not try to control the subdevices in the media graph from the
> > rcar-vin
> >=20
