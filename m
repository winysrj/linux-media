...
Received: from lb1-smtp-cloud3.xs4all.net ([194.109.24.22]:39932 "EHLO
	...
	by vger.kernel.org with ESMTP id S1751821AbbEYLQD (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Mon, 25 May 2015 07:16:03 -0400
Message-ID: <5563046C.7020901@xs4all.nl>
Date: Mon, 25 May 2015 13:15:56 +0200
From: Hans Verkuil <hverkuil@xs4all.nl>
MIME-Version: 1.0
To: =?UTF-8?B?UmFmYWVsIExvdXJlbsOnbyBkZSBMaW1hIENoZWhhYg==?=
	<chehabrafael@gmail.com>,
	Linux Media Mailing List <linux-media@vger.kernel.org>
Subject: Re: [PATCH v2] au0828: Add support for media controller
References: <1432001804-4903-1-git-send-email-chehabrafael@gmail.com>
In-Reply-To: <1432001804-4903-1-git-send-email-chehabrafael@gmail.com>
...
I think we need core support for this. There are lots of usb and pci drivers
that all have card structs that determine the board layout. What we need is a
standard data structure that can be added to each card struct and that describes
how the various entities are linked together. And a core helper function can
then create the graph.

Usually it is just a simple pipeline, so start with easy cases like that. Very
complex drivers can still make their own media graph, but here I am more interested
in the 90% of easy cases.
...
Either store the decoder entity pointer or we need a simple 'find_entity'
helper function.
...
This also feels like it can be a helper function.
...
This too. Frankly, I wish that the MC could have a concept of mutually
exclusive links: i.e. setting one will break all the other links. You
might want to discuss that with Laurent.
...
I think it would be useful if you try to add the MC to a few drivers in order to get
a feeling of which helper functions are needed and where things can be improved to
make this easier.
