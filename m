...
Received: from mx1.redhat.com ([209.132.183.28]:58547 "EHLO mx1.redhat.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1757856Ab2BNQk7 (ORCPT <rfc822;linux-media@vger.kernel.org>);
	Tue, 14 Feb 2012 11:40:59 -0500
Message-ID: <4F3A8E8B.9080109@redhat.com>
Date: Tue, 14 Feb 2012 14:40:43 -0200
From: Mauro Carvalho Chehab <mchehab@redhat.com>
MIME-Version: 1.0
To: Stefan Ringel <linuxtv@stefanringel.de>
CC: linux-media@vger.kernel.org
Subject: Re: [PATCH] mt2063: rework tuner driver
References: <1326127054-12358-1-git-send-email-linuxtv@stefanringel.de> <4F21B1EF.3000000@redhat.com> <4F3A8C09.90607@stefanringel.de>
In-Reply-To: <4F3A8C09.90607@stefanringel.de>
Content-Type: text/plain; charset=ISO-8859-1
Content-Transfer-Encoding: 7bit
Sender: linux-media-owner@vger.kernel.org
List-ID: <linux-media.vger.kernel.org>

Em 14-02-2012 14:30, Stefan Ringel escreveu:
> Mauro,
> 
> I think you applied this patch, but I don't see it into media_tree.git ?

I applied on my test machine, but it broke the az6007 boards, so I
couldn't merge it upstream.

As I suggested, the better is to broke it into smaller patches, in order
to discover what change broke it.

I won't have anytime soon to test it again with az6007, as I'm currently
busy testing a bunch of patches I've made for another subsystem.
