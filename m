...
MIME-Version: 1.0
Date: Tue, 18 Mar 2008 19:34:19 -0500
Message-ID: <C82A808D35A16542ACB16AF56367E0580A796920@exchange01.nsighttel.com>
In-Reply-To: <1205876406.3385.140.camel@pc08.localdom.local>
...
Sent: Tuesday, March 18, 2008 4:40 PM
To: Mark A Jenks
...
> 
> The CVS that I grabbed that did not work, until I updated to 2.6.24
was
...
> > I put a comment about having to install a new kernel if dvbscan
hangs
> in
> > the WIKI.
> > 
...
> 
> Since you used previously v4l-dvb master and now again, you should
check
...
> > > 
> > > I maintain the driver on ubuntu 7.10, which I think has is
2.6.22-14
> -
> > 
> > > or close to.
> > > 
> > > I have another AMD system at home that the driver completely
freezes
> > on,
> > > 
> > > no idea why, total system lockup. I don't trust the PCIe chipset
on
> > it, 
...
> > > 
> > > Lots of noise recently on the mailing lists about video_buf
related 
> > > issues and potential race conditions.
> > > 
> > > Try running the system with a single cpu core and report back,
also,
> 
