...
Received: from perceval.ideasonboard.com ([213.167.242.64]:34718 "EHLO
        ...
        with ESMTP id S1751301AbeECNgA (ORCPT
        <rfc822;linux-media@vger.kernel.org>); Thu, 3 May 2018 09:36:00 -0400
From: Kieran Bingham <kieran.bingham+renesas@ideasonboard.com>
To: Laurent Pinchart <laurent.pinchart@ideasonboard.com>,
        linux-renesas-soc@vger.kernel.org, linux-media@vger.kernel.org
Cc: Kieran Bingham <kieran.bingham+renesas@ideasonboard.com>
Subject: [PATCH v9 7/8] media: vsp1: Adapt entities to configure into a body
Date: Thu,  3 May 2018 14:35:46 +0100
Message-Id: <17b49567300141edc849f55c39405d88aab3877e.1525354160.git-series.kieran.bingham+renesas@ideasonboard.com>
...
index 99db8a418f9d..ef0148082bf7 100644
...
index deb86cc235ef..8fae7c485642 100644
...
@@ -192,7 +195,6 @@ static void rpf_configure_partition(struct vsp1_entity *entity,
 	const struct vsp1_format_info *fmtinfo = rpf->fmtinfo;
...
-
 	 ...
 	 *
@@ -218,10 +220,10 @@ static void rpf_configure_partition(struct vsp1_entity *entity,
...
@@ -246,9 +248,9 @@ static void rpf_configure_partition(struct vsp1_entity *entity,
 	    fmtinfo->swap_uv)
...
index b96717f58a72..001223d0af4a 100644
...
index da287c27b324..2edea361eee4 100644
...
+				struct vsp1_dl_body *dlb)
 {
 	struct vsp1_rwpf *wpf = to_rwpf(&entity->subdev);
 	unsigned long flags;
@@ -346,12 +347,13 @@ static void wpf_configure_frame(struct vsp1_entity *entity,
...
+				    struct vsp1_dl_body *dlb)
 {
 	struct vsp1_rwpf *wpf = to_rwpf(&entity->subdev);
 	struct vsp1_device *vsp1 = wpf->entity.vsp1;
@@ -378,10 +380,10 @@ static void wpf_configure_partition(struct vsp1_entity *entity,
...
@@ -473,9 +475,9 @@ static void wpf_configure_partition(struct vsp1_entity *entity,
 	    fmtinfo->swap_uv)
 		swap(mem.addr[1], mem.addr[2]);
