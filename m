...
Received: from mail-fx0-f158.google.com ([209.85.220.158]:60942 "EHLO
	mail-fx0-f158.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S932316AbZDHNKV convert rfc822-to-8bit (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Wed, 8 Apr 2009 09:10:21 -0400
Received: by fxm2 with SMTP id 2so120750fxm.37
        for <linux-media@vger.kernel.org>; Wed, 08 Apr 2009 06:10:18 -0700 (PDT)
MIME-Version: 1.0
...
Date: Wed, 8 Apr 2009 17:10:18 +0400
Message-ID: <208cbae30904080610k6b4c0fbexaf5fb30c778f4d37@mail.gmail.com>
...
On Wed, Apr 8, 2009 at 3:18 PM, Chaithrika U S <chaithrika@ti.com> wrote:
...
vpif_obj.sd = kmalloc(sizeof(struct v4l2_subdev *) * subdev_count, GFP_KERNEL);

 fails and we do cleanup after this. We set err = -ENOMEM and go to probe_out;
In the cleanup we change err= -EBUSY; (see that?) before video_dev_alloc_exit
