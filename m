...
Received: from aer-iport-1.cisco.com ([173.38.203.51]:15475 "EHLO
	...
	with ESMTP id S1752621AbbHRIjO (ORCPT
	<rfc822;linux-media@vger.kernel.org>);
	Tue, 18 Aug 2015 04:39:14 -0400
...
Subject: [PATCHv8 00/15] HDMI CEC framework
Date: Tue, 18 Aug 2015 10:26:25 +0200
Message-Id: <cover.1439886203.git.hans.verkuil@cisco.com>
...
As far as I am concerned this version is code complete and the only thing
missing is that the documentation is out-of-sync with the current
implementation.

So there will be a v9 fixing this, but since this may take some time I
decided to post a v8 so people can look at this.
...
Kamil Debski (6):
 ...
 54 files changed, 8341 insertions(+), 47 deletions(-)
