...
Received: from comal.ext.ti.com ([198.47.26.152]:51991 "EHLO comal.ext.ti.com"
	rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
	id S1759039Ab0JFOOm convert rfc822-to-8bit (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Wed, 6 Oct 2010 10:14:42 -0400
From: "Hiremath, Vaibhav" <hvaibhav@ti.com>
To: "Taneja, Archit" <archit@ti.com>
CC: "linux-omap@vger.kernel.org" <linux-omap@vger.kernel.org>,
	"linux-media@vger.kernel.org" <linux-media@vger.kernel.org>
Date: Wed, 6 Oct 2010 19:44:37 +0530
Subject: RE: [PATCH v2 2/2] V4L/DVB: OMAP_VOUT: Use rotation_type to choose
 between vrfb and sdram buffers
Message-ID: <19F8576C6E063C45BE387C64729E739404AA21CDF6@dbde02.ent.ti.com>
References: <1285571807-23210-1-git-send-email-archit@ti.com>
 <1285571807-23210-3-git-send-email-archit@ti.com>
In-Reply-To: <1285571807-23210-3-git-send-email-archit@ti.com>
...
[Hiremath, Vaibhav] Till the time we don't come up with Tiler (for that matter any other way of rotating image) based rotation mechanism, I wouldn't want to change/introduce any new interface.
...
> @@ -409,52 +353,6 @@ void omap_vout_free_buffers(struct omap_vout_device
> *vout)
>  }
>
>  /*
...
>  }
>
> @@ -938,6 +750,7 @@ static int omap_vout_buffer_setup(struct
...
>       if (!vout)
>               return -EINVAL;
> @@ -950,13 +763,10 @@ static int omap_vout_buffer_setup(struct
> videobuf_queue *q, unsigned int *count,
...
>               return 0;
> @@ -972,8 +782,11 @@ static int omap_vout_buffer_setup(struct
> videobuf_queue *q, unsigned int *count,
...
>                       for (j = i; j < *count; j++) {
>                               omap_vout_free_buffer(
> @@ -981,6 +794,7 @@ static int omap_vout_buffer_setup(struct
> videobuf_queue *q, unsigned int *count,
>                                               vout->smsshado_size);
>                               vout->smsshado_virt_addr[j] = 0;
>                               vout->smsshado_phy_addr[j] = 0;
...
> @@ -993,9 +807,9 @@ static int omap_vout_buffer_setup(struct
> videobuf_queue *q, unsigned int *count,
>
>  /*
...
>       int num_buffers = 0, i;
>
> @@ -1010,20 +824,6 @@ static void omap_vout_free_allbuffers(struct
...
>  }
>
> @@ -1035,16 +835,11 @@ static void omap_vout_free_allbuffers(struct
> omap_vout_device *vout)
...
> @@ -1066,63 +861,10 @@ static int omap_vout_buffer_prepare(struct
> videobuf_queue *q,
...
> @@ -1693,9 +1437,18 @@ static int vidioc_s_ctrl(struct file *file, void
...
>                       mutex_unlock(&vout->lock);
> @@ -2196,7 +1949,8 @@ static int __init omap_vout_setup_video_data(struct
> omap_vout_device *vout)
>       vout->mirror = 0;
...
>       control[1].value = 0;
> @@ -2229,17 +1983,15 @@ static int __init
...
> video2_bufsize;
> @@ -2256,67 +2008,13 @@ static int __init
> omap_vout_setup_video_bufs(struct platform_device *pdev,
>               }
>       }
>
...
> @@ -2357,6 +2055,8 @@ static int __init
...
>                */
> @@ -2391,7 +2091,8 @@ static int __init
> omap_vout_create_video_devices(struct platform_device *pdev)
>                       goto success;
>
>  error2:
...
>                       /*
> @@ -2432,14 +2135,15 @@ static void omap_vout_cleanup_device(struct
> omap_vout_device *vout)
...
>       kfree(vout);
>  }
> @@ -2478,6 +2182,12 @@ static int __init omap_vout_probe(struct
