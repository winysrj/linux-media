...
Received: from mail-we0-f174.google.com ([74.125.82.174]:59742 "EHLO
	mail-we0-f174.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
	with ESMTP id S1754407Ab2IBSZY (ORCPT
	<rfc822;linux-media@vger.kernel.org>); Sun, 2 Sep 2012 14:25:24 -0400
From: Sylwester Nawrocki <sylvester.nawrocki@gmail.com>
To: linux-media@vger.kernel.org
Cc: tomasz.figa@gmail.com, oselas@community.pengutronix.de,
	linux-samsung-soc@vger.kernel.org,
	Sylwester Nawrocki <sylvester.nawrocki@gmail.com>
Subject: [PATCH v2] V4L: Add driver for S3C244X/S3C64XX SoC series camera interface
Date: Sun,  2 Sep 2012 20:25:09 +0200
Message-Id: <1346610309-15564-1-git-send-email-sylvester.nawrocki@gmail.com>
...
pixel resolution and crop control and two video nodes - for the
"codec" and "preview" data paths. This patch has been tested only
on S3C2440 SoC based system (Mini2440 board). Some minor corrections
may be needed for capture functionality on S3C64XX. mem-to-mem
features available in S3C64XX SoC series are not supported yet.

Signed-off-by: Sylwester Nawrocki <sylvester.nawrocki@gmail.com>
---

Changes since v1:
 - corrected supported pixel formats list to better reflect s3c64xx
   SoC capabilities;
 - some fixes after LKM tests:
    - added missing camport gpio free,
    - eliminate double kfree() on an error path;
 - minor change to struct s3c_camif_sensor_info;
 - switched to unified selection targets;
 - added support for V4L2_PIX_FMT_YVU420 pixel format;
 - fixed bytesperline and sizeimage calculation in vidioc_g_fmt.
...
from:
 ...
 drivers/media/platform/s3c-camif/camif-capture.c | 1607 ++++++++++++++++++++++
 drivers/media/platform/s3c-camif/camif-core.c    |  647 +++++++++
 drivers/media/platform/s3c-camif/camif-core.h    |  375 +++++
 drivers/media/platform/s3c-camif/camif-regs.c    |  497 +++++++
 drivers/media/platform/s3c-camif/camif-regs.h    |  262 ++++
 include/media/s3c_camif.h                        |   37 +
